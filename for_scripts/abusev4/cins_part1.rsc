...
:do { add dynamic=yes list=$AddressList comment=cins address=1.189.84.37/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=102.0.30.172/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=102.202.116.10/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=102.98.71.76/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=103.155.62.105/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=103.181.57.231/32 } on-error={}
