...
:do { add dynamic=yes list=$AddressList comment=cins address=157.100.136.210/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=157.230.91.50/32 } on-error={}
