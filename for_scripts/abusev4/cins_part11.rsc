...
:do { add dynamic=yes list=$AddressList comment=cins address=160.153.187.70/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=160.191.86.208/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=160.20.85.227/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=161.142.137.116/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=161.35.226.134/32 } on-error={}
