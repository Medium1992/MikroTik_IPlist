...
:do { add dynamic=yes list=$AddressList comment=cins address=157.100.198.51/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=157.230.131.241/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=157.245.102.37/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=157.245.85.167/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=157.85.198.53/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=158.173.3.131/32 } on-error={}
