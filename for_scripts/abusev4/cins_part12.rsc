...
:do { add dynamic=yes list=$AddressList comment=cins address=161.35.218.28/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=161.35.40.28/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=161.35.46.80/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=161.35.47.232/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=161.35.55.48/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=161.35.88.75/32 } on-error={}
