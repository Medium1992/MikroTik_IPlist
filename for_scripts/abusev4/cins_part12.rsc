...
:do { add dynamic=yes list=$AddressList comment=cins address=164.163.214.54/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=164.92.113.198/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=164.92.125.194/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=164.92.94.115/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=165.140.121.157/32 } on-error={}
