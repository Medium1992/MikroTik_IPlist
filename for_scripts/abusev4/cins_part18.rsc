...
:do { add dynamic=yes list=$AddressList comment=cins address=183.66.28.26/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=183.95.176.112/32 } on-error={}
