...
:do { add dynamic=yes list=$AddressList comment=cins address=183.92.26.181/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=184.153.1.179/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=184.180.131.219/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=184.68.169.10/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=185.229.159.116/32 } on-error={}
