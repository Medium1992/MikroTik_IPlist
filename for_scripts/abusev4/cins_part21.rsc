...
:do { add dynamic=yes list=$AddressList comment=cins address=193.24.211.239/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=194.0.157.155/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=194.183.176.226/32 } on-error={}
