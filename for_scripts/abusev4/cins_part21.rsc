...
:do { add dynamic=yes list=$AddressList comment=cins address=194.85.211.110/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=195.154.199.224/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=195.69.157.70/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=196.127.90.184/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=196.75.39.248/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=196.77.248.117/32 } on-error={}
