...
:do { add dynamic=yes list=$AddressList comment=cins address=193.43.145.33/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=193.93.17.67/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=194.187.178.101/32 } on-error={}
