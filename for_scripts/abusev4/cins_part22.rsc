...
:do { add dynamic=yes list=$AddressList comment=cins address=2.27.52.148/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=2.50.152.245/32 } on-error={}
