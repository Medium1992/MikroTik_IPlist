...
:do { add dynamic=yes list=$AddressList comment=cins address=196.250.185.72/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=199.247.4.215/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=2.50.225.20/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=2.88.108.203/32 } on-error={}
