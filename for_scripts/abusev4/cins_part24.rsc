...
:do { add dynamic=yes list=$AddressList comment=cins address=20.199.138.93/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=20.205.137.69/32 } on-error={}
