...
:do { add dynamic=yes list=$AddressList comment=cins address=201.138.214.70/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=201.79.48.67/32 } on-error={}
