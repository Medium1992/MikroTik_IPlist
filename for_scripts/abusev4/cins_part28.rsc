...
:do { add dynamic=yes list=$AddressList comment=cins address=213.177.207.3/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=213.199.38.216/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=213.230.78.6/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=213.230.86.50/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=216.234.193.247/32 } on-error={}
