...
:do { add dynamic=yes list=$AddressList comment=cins address=35.236.155.179/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=35.244.32.91/32 } on-error={}
