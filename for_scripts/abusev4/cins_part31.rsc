...
:do { add dynamic=yes list=$AddressList comment=cins address=35.205.103.26/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=35.205.225.38/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=35.205.229.190/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=35.229.150.197/32 } on-error={}
