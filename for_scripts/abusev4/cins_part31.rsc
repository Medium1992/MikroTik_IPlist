...
:if ([:len [find where list=$AddressList and address=185.188.217.216/32]] = 0) do={ add list=$AddressList comment=cins address=185.188.217.216/32 }
...
:if ([:len [find where list=$AddressList and address=185.191.165.58/32]] = 0) do={ add list=$AddressList comment=cins address=185.191.165.58/32 }
