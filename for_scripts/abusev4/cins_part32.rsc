...
:do { add dynamic=yes list=$AddressList comment=cins address=39.148.100.156/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=39.148.17.183/32 } on-error={}
