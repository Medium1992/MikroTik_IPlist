...
:do { add dynamic=yes list=$AddressList comment=cins address=41.10.83.0/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=41.25.29.84/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=42.82.239.4/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=43.106.50.238/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=43.110.69.246/32 } on-error={}
