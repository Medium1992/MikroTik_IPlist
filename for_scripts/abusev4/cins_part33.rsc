...
:do { add dynamic=yes list=$AddressList comment=cins address=41.82.207.21/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=43.133.61.11/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=45.143.198.130/32 } on-error={}
