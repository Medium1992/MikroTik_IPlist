...
:do { add dynamic=yes list=$AddressList comment=cins address=47.101.133.170/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=47.145.59.136/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=47.158.127.106/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=47.16.181.41/32 } on-error={}
