...
:do { add dynamic=yes list=$AddressList comment=cins address=47.239.3.124/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=47.242.197.5/32 } on-error={}
