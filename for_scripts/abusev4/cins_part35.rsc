...
:do { add dynamic=yes list=$AddressList comment=cins address=45.95.147.229/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=46.101.248.91/32 } on-error={}
