...
:do { add dynamic=yes list=$AddressList comment=cins address=47.254.174.101/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=47.45.157.249/32 } on-error={}
