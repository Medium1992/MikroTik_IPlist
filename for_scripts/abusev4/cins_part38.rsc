...
:do { add dynamic=yes list=$AddressList comment=cins address=47.32.128.247/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=47.35.233.5/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=47.59.172.187/32 } on-error={}
