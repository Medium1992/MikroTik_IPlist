...
:do { add dynamic=yes list=$AddressList comment=cins address=47.77.238.254/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=47.84.116.131/32 } on-error={}
