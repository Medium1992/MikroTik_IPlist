...
:do { add dynamic=yes list=$AddressList comment=cins address=47.76.74.20/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=47.76.77.138/32 } on-error={}
