...
:do { add dynamic=yes list=$AddressList comment=cins address=49.64.138.88/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=49.76.198.77/32 } on-error={}
