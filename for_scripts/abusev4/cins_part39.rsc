...
:do { add dynamic=yes list=$AddressList comment=cins address=47.84.97.198/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=47.92.121.247/32 } on-error={}
