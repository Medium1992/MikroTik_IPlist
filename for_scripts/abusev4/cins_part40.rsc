...
:do { add dynamic=yes list=$AddressList comment=cins address=47.88.66.37/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=47.93.20.165/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=49.66.126.204/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=5.188.206.38/32 } on-error={}
