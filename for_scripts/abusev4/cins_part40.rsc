...
:do { add dynamic=yes list=$AddressList comment=cins address=49.85.156.66/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=5.63.34.22/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=51.37.70.20/32 } on-error={}
