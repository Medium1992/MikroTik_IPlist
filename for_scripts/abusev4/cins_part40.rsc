...
:do { add dynamic=yes list=$AddressList comment=cins address=5.75.56.125/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=52.176.32.161/32 } on-error={}
