...
:do { add dynamic=yes list=$AddressList comment=cins address=5.252.83.71/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=50.234.108.8/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=58.152.146.200/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=59.103.158.95/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=60.179.17.7/32 } on-error={}
