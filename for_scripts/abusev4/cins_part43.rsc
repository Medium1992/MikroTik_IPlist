...
:do { add dynamic=yes list=$AddressList comment=cins address=66.129.50.65/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=66.172.119.3/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=66.235.16.129/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=66.9.171.104/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=67.163.7.92/32 } on-error={}
