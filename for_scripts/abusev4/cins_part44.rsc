...
:do { add dynamic=yes list=$AddressList comment=cins address=67.205.186.3/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=67.207.81.14/32 } on-error={}
