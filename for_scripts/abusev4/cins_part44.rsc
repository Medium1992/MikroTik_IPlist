...
:do { add dynamic=yes list=$AddressList comment=cins address=67.205.187.254/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=68.183.194.166/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=68.183.45.94/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=68.183.76.212/32 } on-error={}
