...
:do { add dynamic=yes list=$AddressList comment=cins address=66.163.115.174/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=66.206.12.187/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=66.9.164.49/32 } on-error={}
