...
:do { add dynamic=yes list=$AddressList comment=cins address=71.84.240.85/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=77.244.40.89/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=77.31.81.6/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=79.116.220.80/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=79.117.176.150/32 } on-error={}
