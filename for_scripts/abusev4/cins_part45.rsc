...
:do { add dynamic=yes list=$AddressList comment=cins address=72.14.179.125/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=72.66.75.164/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=74.0.48.55/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=74.249.178.165/32 } on-error={}
