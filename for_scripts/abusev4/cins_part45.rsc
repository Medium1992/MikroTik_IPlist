...
:do { add dynamic=yes list=$AddressList comment=cins address=69.33.211.35/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=69.73.136.211/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=70.79.137.86/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=71.167.144.216/32 } on-error={}
