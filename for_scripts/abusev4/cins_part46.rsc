...
:do { add dynamic=yes list=$AddressList comment=cins address=79.42.117.214/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=79.98.116.20/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=8.163.118.93/32 } on-error={}
