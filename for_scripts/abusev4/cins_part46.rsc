...
:do { add dynamic=yes list=$AddressList comment=cins address=79.125.155.75/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=79.13.75.145/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=79.156.81.84/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=8.160.161.155/32 } on-error={}
