...
:do { add dynamic=yes list=$AddressList comment=cins address=79.160.189.79/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=8.211.115.235/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=8.213.19.246/32 } on-error={}
