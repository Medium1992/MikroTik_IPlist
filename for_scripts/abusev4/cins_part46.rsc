...
:do { add dynamic=yes list=$AddressList comment=cins address=77.238.150.138/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=77.242.108.32/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=79.116.27.201/32 } on-error={}
