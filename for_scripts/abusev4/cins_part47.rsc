...
:do { add dynamic=yes list=$AddressList comment=cins address=8.229.227.179/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=80.73.14.68/32 } on-error={}
