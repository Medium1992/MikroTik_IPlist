...
:do { add dynamic=yes list=$AddressList comment=cins address=8.216.26.155/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=8.219.231.227/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=80.232.219.145/32 } on-error={}
