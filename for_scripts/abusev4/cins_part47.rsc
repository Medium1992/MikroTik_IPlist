...
:do { add dynamic=yes list=$AddressList comment=cins address=8.231.246.76/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=8.234.68.15/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=8.234.94.118/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=8.243.73.74/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=81.177.6.131/32 } on-error={}
