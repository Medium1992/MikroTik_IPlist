...
:do { add dynamic=yes list=$AddressList comment=cins address=8.228.123.33/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=81.129.229.16/32 } on-error={}
