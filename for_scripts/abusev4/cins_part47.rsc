...
:do { add dynamic=yes list=$AddressList comment=cins address=8.217.252.255/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=80.241.220.50/32 } on-error={}
