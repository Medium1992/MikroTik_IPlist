...
:do { add dynamic=yes list=$AddressList comment=cins address=8.216.27.202/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=8.243.169.254/32 } on-error={}
