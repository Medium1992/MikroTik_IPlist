...
:do { add dynamic=yes list=$AddressList comment=cins address=85.106.105.54/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=85.138.138.38/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=85.242.232.73/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=85.90.245.247/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=86.30.208.47/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=88.191.140.163/32 } on-error={}
