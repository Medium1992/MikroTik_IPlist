...
:do { add dynamic=yes list=$AddressList comment=cins address=90.148.222.123/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=90.163.145.85/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=90.17.5.255/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.156.165.31/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.207.115.232/32 } on-error={}
