...
:do { add dynamic=yes list=$AddressList comment=cins address=89.73.138.192/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=90.85.190.25/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.218.45.59/32 } on-error={}
