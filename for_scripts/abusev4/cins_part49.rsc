...
:do { add dynamic=yes list=$AddressList comment=cins address=89.37.117.105/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=89.37.117.17/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=89.58.74.144/32 } on-error={}
