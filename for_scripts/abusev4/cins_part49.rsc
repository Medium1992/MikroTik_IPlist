...
:do { add dynamic=yes list=$AddressList comment=cins address=9.246.45.228/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.230.56.60/32 } on-error={}
