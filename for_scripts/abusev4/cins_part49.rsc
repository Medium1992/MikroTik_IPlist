...
:do { add dynamic=yes list=$AddressList comment=cins address=89.226.223.49/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.211.251.37/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.225.162.143/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=91.226.43.216/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=91.228.122.86/32 } on-error={}
