...
:do { add dynamic=yes list=$AddressList comment=cins address=89.248.163.25/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=90.45.230.124/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.225.162.225/32 } on-error={}
