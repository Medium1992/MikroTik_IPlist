...
:do { add dynamic=yes list=$AddressList comment=cins address=90.92.34.126/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=90.94.108.137/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.221.75.104/32 } on-error={}
