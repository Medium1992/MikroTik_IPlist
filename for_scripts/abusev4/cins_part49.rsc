...
:do { add dynamic=yes list=$AddressList comment=cins address=90.25.200.132/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.112.75.91/32 } on-error={}
