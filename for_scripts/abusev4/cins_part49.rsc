...
:do { add dynamic=yes list=$AddressList comment=cins address=89.93.69.82/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=90.62.153.182/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.126.178.136/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=91.221.210.34/32 } on-error={}
