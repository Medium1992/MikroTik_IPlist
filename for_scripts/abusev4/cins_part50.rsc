...
:do { add dynamic=yes list=$AddressList comment=cins address=91.242.96.12/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=93.127.237.62/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=94.158.62.28/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=95.25.164.182/32 } on-error={}
