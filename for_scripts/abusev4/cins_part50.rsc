...
:do { add dynamic=yes list=$AddressList comment=cins address=92.118.206.62/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=93.245.73.220/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=98.97.129.101/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=99.233.140.59/32 } on-error={}
