...
:do { add dynamic=yes list=$AddressList comment=cins address=145.14.163.202/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=147.182.190.166/32 } on-error={}
