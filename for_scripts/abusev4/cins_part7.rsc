...
:do { add dynamic=yes list=$AddressList comment=cins address=147.182.248.191/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=147.182.253.31/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=147.182.253.70/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=147.182.255.65/32 } on-error={}
