...
:do { add dynamic=yes list=$AddressList comment=cins address=148.227.74.250/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=148.227.75.143/32 } on-error={}
