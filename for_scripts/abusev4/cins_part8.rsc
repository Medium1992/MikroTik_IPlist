...
:do { add dynamic=yes list=$AddressList comment=cins address=147.182.203.81/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=147.182.248.92/32 } on-error={}
