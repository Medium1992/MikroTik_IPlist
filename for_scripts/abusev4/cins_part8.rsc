...
:do { add dynamic=yes list=$AddressList comment=cins address=149.19.164.188/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=149.40.242.187/32 } on-error={}
