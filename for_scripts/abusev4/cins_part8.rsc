...
:do { add dynamic=yes list=$AddressList comment=cins address=148.227.86.23/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=148.227.90.4/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=148.244.171.152/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=149.102.79.90/32 } on-error={}
