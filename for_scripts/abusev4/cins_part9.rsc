...
:do { add dynamic=yes list=$AddressList comment=cins address=148.222.130.220/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=148.246.51.33/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=149.13.199.9/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=151.243.11.51/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=152.110.223.11/32 } on-error={}
