...
:do { add dynamic=yes list=$AddressList comment=cins address=148.222.152.164/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=148.227.86.182/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=148.3.255.226/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=148.56.129.73/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=152.245.70.152/32 } on-error={}
