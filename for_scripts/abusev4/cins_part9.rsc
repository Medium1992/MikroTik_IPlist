...
:do { add dynamic=yes list=$AddressList comment=cins address=148.163.69.145/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=148.227.67.208/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=148.255.243.51/32 } on-error={}
