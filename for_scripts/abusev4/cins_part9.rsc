...
:do { add dynamic=yes list=$AddressList comment=cins address=147.93.157.87/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=148.113.213.227/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=152.201.44.31/32 } on-error={}
