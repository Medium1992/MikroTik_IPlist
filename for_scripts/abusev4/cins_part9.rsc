...
:do { add dynamic=yes list=$AddressList comment=cins address=148.222.132.130/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=149.19.175.223/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=15.204.93.13/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=152.243.121.45/32 } on-error={}
