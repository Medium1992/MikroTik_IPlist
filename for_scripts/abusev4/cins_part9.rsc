...
:do { add dynamic=yes list=$AddressList comment=cins address=153.237.169.228/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=153.67.119.157/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=153.67.137.244/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=153.67.39.30/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=154.127.141.108/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=cins address=157.100.135.182/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=cins address=157.100.140.252/32 } on-error={}
