...
:do {add list=$AddressList comment=AS1008 address=134.195.37.0/24} on-error {}
:do {add list=$AddressList comment=AS1008 address=154.18.82.0/24} on-error {}
:do {add list=$AddressList comment=AS1008 address=160.22.202.0/24} on-error {}
