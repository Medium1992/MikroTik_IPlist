...
:do {add list=$AddressList comment=AS10217 address=202.171.0.0/21} on-error {}
:do {add list=$AddressList comment=AS10217 address=202.171.10.0/23} on-error {}
:do {add list=$AddressList comment=AS10217 address=202.171.12.0/22} on-error {}
:do {add list=$AddressList comment=AS10217 address=202.171.16.0/20} on-error {}
:do {add list=$AddressList comment=AS10217 address=202.171.9.0/24} on-error {}
