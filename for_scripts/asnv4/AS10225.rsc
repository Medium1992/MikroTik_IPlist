...
:if ([:len [find where list=$AddressList and address=202.53.80.0/23]] = 0) do={ add list=$AddressList comment=AS10225 address=202.53.80.0/23 }
:if ([:len [find where list=$AddressList and address=202.53.82.0/24]] = 0) do={ add list=$AddressList comment=AS10225 address=202.53.82.0/24 }
:if ([:len [find where list=$AddressList and address=202.53.84.0/22]] = 0) do={ add list=$AddressList comment=AS10225 address=202.53.84.0/22 }
:if ([:len [find where list=$AddressList and address=202.53.88.0/21]] = 0) do={ add list=$AddressList comment=AS10225 address=202.53.88.0/21 }
