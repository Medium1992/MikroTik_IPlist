...
:do {add list=$AddressList comment=AS10309 address=for_scripts/asnv4/AS10309.rsc} on-error {}
:do {add list=$AddressList comment=AS10309 address=107.0.46.0/23} on-error {}
:do {add list=$AddressList comment=AS10309 address=199.88.113.0/24} on-error {}
:do {add list=$AddressList comment=AS10309 address=199.88.114.0/23} on-error {}
...
:do {add list=$AddressList comment=AS10309 address=199.88.76.0/23} on-error {}
:do {add list=$AddressList comment=AS10309 address=199.88.79.0/24} on-error {}
