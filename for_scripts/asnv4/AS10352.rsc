...
:do {add list=$AddressList comment=AS10352 address=209.94.160.0/20} on-error {}
:do {add list=$AddressList comment=AS10352 address=209.94.176.0/21} on-error {}
:do {add list=$AddressList comment=AS10352 address=209.94.184.0/22} on-error {}
:do {add list=$AddressList comment=AS10352 address=209.94.188.0/23} on-error {}
