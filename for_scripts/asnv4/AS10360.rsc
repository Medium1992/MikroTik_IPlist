...
:do {add list=$AddressList comment=AS10360 address=for_scripts/asnv4/AS10360.rsc} on-error {}
...
:do {add list=$AddressList comment=AS10360 address=170.109.212.0/22} on-error {}
:do {add list=$AddressList comment=AS10360 address=170.109.216.0/21} on-error {}
:do {add list=$AddressList comment=AS10360 address=170.109.232.0/24} on-error {}
:do {add list=$AddressList comment=AS10360 address=170.109.248.0/21} on-error {}
