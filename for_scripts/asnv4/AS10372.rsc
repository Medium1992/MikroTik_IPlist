...
:if ([:len [find where list=$AddressList and address=159.37.106.0/24]] = 0) do={ add list=$AddressList comment=AS10372 address=159.37.106.0/24 }
:if ([:len [find where list=$AddressList and address=159.37.108.0/24]] = 0) do={ add list=$AddressList comment=AS10372 address=159.37.108.0/24 }
:if ([:len [find where list=$AddressList and address=159.37.110.0/23]] = 0) do={ add list=$AddressList comment=AS10372 address=159.37.110.0/23 }
...
:if ([:len [find where list=$AddressList and address=162.28.136.0/21]] = 0) do={ add list=$AddressList comment=AS10372 address=162.28.136.0/21 }
