...
:do {add list=$AddressList comment=AS10372 address=151.151.96.0/19} on-error {}
...
:do {add list=$AddressList comment=AS10372 address=162.111.136.0/24} on-error {}
...
:do {add list=$AddressList comment=AS10372 address=162.60.8.0/21} on-error {}
:do {add list=$AddressList comment=AS10372 address=169.200.44.0/22} on-error {}
:do {add list=$AddressList comment=AS10372 address=169.200.48.0/21} on-error {}
:do {add list=$AddressList comment=AS10372 address=169.200.56.0/23} on-error {}
:do {add list=$AddressList comment=AS10372 address=169.200.60.0/23} on-error {}
:do {add list=$AddressList comment=AS10372 address=169.200.82.0/23} on-error {}
:do {add list=$AddressList comment=AS10372 address=169.200.84.0/23} on-error {}
