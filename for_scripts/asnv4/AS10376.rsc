...
:do {add list=$AddressList comment=AS10376 address=168.175.132.0/22} on-error {}
:do {add list=$AddressList comment=AS10376 address=168.175.136.0/22} on-error {}
...
:do {add list=$AddressList comment=AS10376 address=171.72.236.0/22} on-error {}
