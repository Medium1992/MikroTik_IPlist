...
:do {add list=$AddressList comment=AS10436 address=for_scripts/asnv4/AS10436.rsc} on-error {}
...
:do {add list=$AddressList comment=AS10436 address=148.241.128.0/18} on-error {}
:do {add list=$AddressList comment=AS10436 address=148.241.192.0/20} on-error {}
:do {add list=$AddressList comment=AS10436 address=148.241.224.0/20} on-error {}
