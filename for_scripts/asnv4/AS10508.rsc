...
:do {add list=$AddressList comment=AS10508 address=130.184.0.0/20} on-error {}
:do {add list=$AddressList comment=AS10508 address=130.184.128.0/17} on-error {}
:do {add list=$AddressList comment=AS10508 address=130.184.16.0/21} on-error {}
:do {add list=$AddressList comment=AS10508 address=130.184.24.0/22} on-error {}
:do {add list=$AddressList comment=AS10508 address=130.184.28.0/23} on-error {}
:do {add list=$AddressList comment=AS10508 address=130.184.30.0/24} on-error {}
