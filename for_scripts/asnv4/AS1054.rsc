...
:do {add list=$AddressList comment=AS1054 address=198.29.254.0/24} on-error {}
:do {add list=$AddressList comment=AS1054 address=207.57.136.0/21} on-error {}
:do {add list=$AddressList comment=AS1054 address=207.57.144.0/23} on-error {}
:do {add list=$AddressList comment=AS1054 address=207.57.146.0/24} on-error {}
