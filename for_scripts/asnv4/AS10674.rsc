...
:if ([:len [find where list=$AddressList and address=209.251.142.0/23]] = 0) do={ add list=$AddressList comment=AS10674 address=209.251.142.0/23 }
:if ([:len [find where list=$AddressList and address=209.251.144.0/20]] = 0) do={ add list=$AddressList comment=AS10674 address=209.251.144.0/20 }
