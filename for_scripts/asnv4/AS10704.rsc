...
:do {add list=$AddressList comment=AS10704 address=200.239.192.0/20} on-error {}
:do {add list=$AddressList comment=AS10704 address=200.239.208.0/21} on-error {}
:do {add list=$AddressList comment=AS10704 address=200.239.220.0/22} on-error {}
:do {add list=$AddressList comment=AS10704 address=200.239.224.0/20} on-error {}
