...
:do {add list=$AddressList comment=AS10780 address=for_scripts/asnv4/AS10780.rsc} on-error {}
...
:do {add list=$AddressList comment=AS10780 address=37.0.114.0/24} on-error {}
