...
:if ([:len [find where list=$AddressList and address=66.129.157.0/24]] = 0) do={ add list=$AddressList comment=AS10865 address=66.129.157.0/24 }
:if ([:len [find where list=$AddressList and address=66.129.158.0/24]] = 0) do={ add list=$AddressList comment=AS10865 address=66.129.158.0/24 }
