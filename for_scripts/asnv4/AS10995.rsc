...
:if ([:len [find where list=$AddressList and address=161.150.144.0/20]] = 0) do={ add list=$AddressList comment=AS10995 address=161.150.144.0/20 }
...
:if ([:len [find where list=$AddressList and address=161.150.160.0/19]] = 0) do={ add list=$AddressList comment=AS10995 address=161.150.160.0/19 }
...
:if ([:len [find where list=$AddressList and address=161.150.240.0/20]] = 0) do={ add list=$AddressList comment=AS10995 address=161.150.240.0/20 }
