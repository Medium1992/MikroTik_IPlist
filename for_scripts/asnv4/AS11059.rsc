...
:do {add list=$AddressList comment=AS11059 address=178.83.0.0/22} on-error {}
:do {add list=$AddressList comment=AS11059 address=178.83.124.0/22} on-error {}
:do {add list=$AddressList comment=AS11059 address=178.83.128.0/22} on-error {}
:do {add list=$AddressList comment=AS11059 address=178.83.216.0/22} on-error {}
...
:do {add list=$AddressList comment=AS11059 address=69.33.128.0/19} on-error {}
