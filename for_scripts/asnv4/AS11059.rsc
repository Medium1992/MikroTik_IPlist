...
:do {add list=$AddressList comment=AS11059 address=136.162.128.0/17} on-error {}
...
:do {add list=$AddressList comment=AS11059 address=143.20.227.0/24} on-error {}
...
:do {add list=$AddressList comment=AS11059 address=68.166.196.0/22} on-error {}
:do {add list=$AddressList comment=AS11059 address=68.166.200.0/22} on-error {}
