...
:do {add list=$AddressList comment=AS11059 address=140.99.118.0/23} on-error {}
...
:do {add list=$AddressList comment=AS11059 address=192.102.96.0/19} on-error {}
:do {add list=$AddressList comment=AS11059 address=192.132.128.0/19} on-error {}
:do {add list=$AddressList comment=AS11059 address=192.132.160.0/20} on-error {}
:do {add list=$AddressList comment=AS11059 address=192.132.176.0/21} on-error {}
:do {add list=$AddressList comment=AS11059 address=192.132.184.0/22} on-error {}
