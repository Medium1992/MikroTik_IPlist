...
:do {add list=$AddressList comment=AS11078 address=128.148.0.0/20} on-error {}
...
:do {add list=$AddressList comment=AS11078 address=128.148.16.0/24} on-error {}
:do {add list=$AddressList comment=AS11078 address=128.148.160.0/19} on-error {}
:do {add list=$AddressList comment=AS11078 address=128.148.18.0/23} on-error {}
:do {add list=$AddressList comment=AS11078 address=128.148.192.0/18} on-error {}
:do {add list=$AddressList comment=AS11078 address=128.148.20.0/22} on-error {}
:do {add list=$AddressList comment=AS11078 address=128.148.24.0/21} on-error {}
:do {add list=$AddressList comment=AS11078 address=128.148.32.0/19} on-error {}
