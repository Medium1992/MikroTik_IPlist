...
:do {add list=$AddressList comment=AS11097 address=for_scripts/asnv4/AS11097.rsc} on-error {}
...
:do {add list=$AddressList comment=AS11097 address=200.136.111.0/24} on-error {}
