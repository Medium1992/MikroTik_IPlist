...
:do {add list=$AddressList comment=AS11123 address=206.251.80.0/21} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.88.0/22} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.92.0/24} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.0/29} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.10/31} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.12/30} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.128/25} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.16/28} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.32/27} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.64/26} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.93.8/32} on-error {}
:do {add list=$AddressList comment=AS11123 address=206.251.94.0/23} on-error {}
