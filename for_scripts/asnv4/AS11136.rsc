...
:if ([:len [find where list=$AddressList and address=200.36.224.0/20]] = 0) do={ add list=$AddressList comment=AS11136 address=200.36.224.0/20 }
:if ([:len [find where list=$AddressList and address=200.36.248.0/21]] = 0) do={ add list=$AddressList comment=AS11136 address=200.36.248.0/21 }
