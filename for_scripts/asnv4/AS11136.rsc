...
:do {add list=$AddressList comment=AS11136 address=132.254.192.0/20} on-error {}
:do {add list=$AddressList comment=AS11136 address=132.254.212.0/22} on-error {}
:do {add list=$AddressList comment=AS11136 address=132.254.216.0/21} on-error {}
