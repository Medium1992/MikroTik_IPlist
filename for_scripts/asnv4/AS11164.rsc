...
:if ([:len [find where list=$AddressList and address=163.253.76.0/23]] = 0) do={ add list=$AddressList comment=AS11164 address=163.253.76.0/23 }
:if ([:len [find where list=$AddressList and address=163.253.78.0/24]] = 0) do={ add list=$AddressList comment=AS11164 address=163.253.78.0/24 }
:if ([:len [find where list=$AddressList and address=163.253.82.0/24]] = 0) do={ add list=$AddressList comment=AS11164 address=163.253.82.0/24 }
