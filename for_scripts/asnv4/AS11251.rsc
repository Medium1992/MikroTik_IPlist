...
:do {add list=$AddressList comment=AS11251 address=139.104.192.0/24} on-error {}
:do {add list=$AddressList comment=AS11251 address=139.104.194.0/23} on-error {}
...
:do {add list=$AddressList comment=AS11251 address=139.104.204.0/24} on-error {}
