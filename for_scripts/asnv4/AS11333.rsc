...
:do {add list=$AddressList comment=AS11333 address=162.42.0.0/21} on-error {}
:do {add list=$AddressList comment=AS11333 address=162.42.128.0/17} on-error {}
:do {add list=$AddressList comment=AS11333 address=162.42.19.0/24} on-error {}
...
:do {add list=$AddressList comment=AS11333 address=162.42.8.0/22} on-error {}
