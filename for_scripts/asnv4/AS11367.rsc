...
:do {add list=$AddressList comment=AS11367 address=for_scripts/asnv4/AS11367.rsc} on-error {}
...
:do {add list=$AddressList comment=AS11367 address=23.181.240.0/24} on-error {}
