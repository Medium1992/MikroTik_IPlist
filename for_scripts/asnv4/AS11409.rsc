...
:do {add list=$AddressList comment=AS11409 address=147.146.140.0/23} on-error {}
:do {add list=$AddressList comment=AS11409 address=147.146.142.0/24} on-error {}
:do {add list=$AddressList comment=AS11409 address=147.146.176.0/23} on-error {}
:do {add list=$AddressList comment=AS11409 address=147.146.178.0/24} on-error {}
