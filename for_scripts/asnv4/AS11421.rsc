...
:if ([:len [find where list=$AddressList and address=77.67.18.0/24]] = 0) do={ add list=$AddressList comment=AS11421 address=77.67.18.0/24 }
:if ([:len [find where list=$AddressList and address=87.86.0.0/22]] = 0) do={ add list=$AddressList comment=AS11421 address=87.86.0.0/22 }
