...
:do {add list=$AddressList comment=AS11440 address=for_scripts/asnv4/AS11440.rsc} on-error {}
...
:do {add list=$AddressList comment=AS11440 address=69.55.72.0/21} on-error {}
