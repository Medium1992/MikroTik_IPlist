...
:do {add list=$AddressList comment=AS11468 address=for_scripts/asnv4/AS11468.rsc} on-error {}
:do {add list=$AddressList comment=AS11468 address=162.253.5.0/24} on-error {}
:do {add list=$AddressList comment=AS11468 address=199.83.136.0/22} on-error {}
