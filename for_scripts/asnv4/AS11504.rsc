...
:if ([:len [find where list=$AddressList and address=69.8.144.0/23]] = 0) do={ add list=$AddressList comment=AS11504 address=69.8.144.0/23 }
:if ([:len [find where list=$AddressList and address=69.8.146.0/24]] = 0) do={ add list=$AddressList comment=AS11504 address=69.8.146.0/24 }
