...
:if ([:len [find where list=$AddressList and address=163.253.80.0/23]] = 0) do={ add list=$AddressList comment=AS11537 address=163.253.80.0/23 }
:if ([:len [find where list=$AddressList and address=163.253.83.0/24]] = 0) do={ add list=$AddressList comment=AS11537 address=163.253.83.0/24 }
