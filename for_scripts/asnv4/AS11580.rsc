...
:if ([:len [find where list=$AddressList and address=74.116.56.0/24]] = 0) do={ add list=$AddressList comment=AS11580 address=74.116.56.0/24 }
:if ([:len [find where list=$AddressList and address=74.116.58.0/23]] = 0) do={ add list=$AddressList comment=AS11580 address=74.116.58.0/23 }
