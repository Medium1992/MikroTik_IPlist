...
:if ([:len [find where list=$AddressList and address=216.162.0.0/22]] = 0) do={ add list=$AddressList comment=AS11612 address=216.162.0.0/22 }
...
:if ([:len [find where list=$AddressList and address=69.84.224.0/23]] = 0) do={ add list=$AddressList comment=AS11612 address=69.84.224.0/23 }
...
:if ([:len [find where list=$AddressList and address=69.84.232.0/24]] = 0) do={ add list=$AddressList comment=AS11612 address=69.84.232.0/24 }
