...
:do {add list=$AddressList comment=AS11650 address=for_scripts/asnv4/AS11650.rsc} on-error {}
...
:do {add list=$AddressList comment=AS11650 address=198.46.16.0/20} on-error {}
:do {add list=$AddressList comment=AS11650 address=198.58.48.0/20} on-error {}
:do {add list=$AddressList comment=AS11650 address=199.96.96.0/21} on-error {}
:do {add list=$AddressList comment=AS11650 address=208.114.32.0/20} on-error {}
:do {add list=$AddressList comment=AS11650 address=216.176.160.0/20} on-error {}
:do {add list=$AddressList comment=AS11650 address=216.195.32.0/19} on-error {}
:do {add list=$AddressList comment=AS11650 address=216.71.64.0/20} on-error {}
