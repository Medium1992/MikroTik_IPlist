...
:if ([:len [find where list=$AddressList and address=157.23.249.0/24]] = 0) do={ add list=$AddressList comment=AS11749 address=157.23.249.0/24 }
:if ([:len [find where list=$AddressList and address=173.46.164.0/23]] = 0) do={ add list=$AddressList comment=AS11749 address=173.46.164.0/23 }
:if ([:len [find where list=$AddressList and address=207.190.0.0/19]] = 0) do={ add list=$AddressList comment=AS11749 address=207.190.0.0/19 }
...
:if ([:len [find where list=$AddressList and address=216.53.192.0/20]] = 0) do={ add list=$AddressList comment=AS11749 address=216.53.192.0/20 }
:if ([:len [find where list=$AddressList and address=216.53.208.0/21]] = 0) do={ add list=$AddressList comment=AS11749 address=216.53.208.0/21 }
:if ([:len [find where list=$AddressList and address=216.53.220.0/22]] = 0) do={ add list=$AddressList comment=AS11749 address=216.53.220.0/22 }
:if ([:len [find where list=$AddressList and address=216.53.224.0/19]] = 0) do={ add list=$AddressList comment=AS11749 address=216.53.224.0/19 }
...
:if ([:len [find where list=$AddressList and address=216.97.215.0/24]] = 0) do={ add list=$AddressList comment=AS11749 address=216.97.215.0/24 }
:if ([:len [find where list=$AddressList and address=216.97.216.0/21]] = 0) do={ add list=$AddressList comment=AS11749 address=216.97.216.0/21 }
:if ([:len [find where list=$AddressList and address=66.90.0.0/18]] = 0) do={ add list=$AddressList comment=AS11749 address=66.90.0.0/18 }
