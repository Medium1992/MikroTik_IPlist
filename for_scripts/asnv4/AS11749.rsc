...
:if ([:len [find where list=$AddressList and address=24.56.152.0/21]] = 0) do={ add list=$AddressList comment=AS11749 address=24.56.152.0/21 }
:if ([:len [find where list=$AddressList and address=24.75.248.0/21]] = 0) do={ add list=$AddressList comment=AS11749 address=24.75.248.0/21 }
