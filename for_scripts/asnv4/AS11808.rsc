...
:do {add list=$AddressList comment=AS11808 address=for_scripts/asnv4/AS11808.rsc} on-error {}
...
:do {add list=$AddressList comment=AS11808 address=129.101.64.0/18} on-error {}
