...
:if ([:len [find where list=$AddressList and address=129.101.192.0/20]] = 0) do={ add list=$AddressList comment=AS11808 address=129.101.192.0/20 }
:if ([:len [find where list=$AddressList and address=129.101.208.0/21]] = 0) do={ add list=$AddressList comment=AS11808 address=129.101.208.0/21 }
:if ([:len [find where list=$AddressList and address=129.101.216.0/22]] = 0) do={ add list=$AddressList comment=AS11808 address=129.101.216.0/22 }
:if ([:len [find where list=$AddressList and address=129.101.221.0/24]] = 0) do={ add list=$AddressList comment=AS11808 address=129.101.221.0/24 }
:if ([:len [find where list=$AddressList and address=129.101.222.0/23]] = 0) do={ add list=$AddressList comment=AS11808 address=129.101.222.0/23 }
