...
:do {add list=$AddressList comment=AS11870 address=for_scripts/asnv4/AS11870.rsc} on-error {}
:do {add list=$AddressList comment=AS11870 address=103.44.17.0/24} on-error {}
