...
:do {add list=$AddressList comment=AS11904 address=for_scripts/asnv4/AS11904.rsc} on-error {}
...
:do {add list=$AddressList comment=AS11904 address=154.27.32.0/19} on-error {}
