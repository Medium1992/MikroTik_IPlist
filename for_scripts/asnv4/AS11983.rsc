...
:if ([:len [find where list=$AddressList and address=147.160.177.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=147.160.177.0/24 }
...
:if ([:len [find where list=$AddressList and address=71.18.10.0/23]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.10.0/23 }
...
:if ([:len [find where list=$AddressList and address=71.18.162.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.162.0/24 }
...
:if ([:len [find where list=$AddressList and address=71.18.38.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.38.0/24 }
:if ([:len [find where list=$AddressList and address=71.18.43.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.43.0/24 }
:if ([:len [find where list=$AddressList and address=71.18.50.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.50.0/24 }
:if ([:len [find where list=$AddressList and address=71.18.52.0/23]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.52.0/23 }
...
:if ([:len [find where list=$AddressList and address=71.18.60.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.60.0/24 }
:if ([:len [find where list=$AddressList and address=71.18.8.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.8.0/24 }
:if ([:len [find where list=$AddressList and address=71.18.95.0/24]] = 0) do={ add list=$AddressList comment=AS11983 address=71.18.95.0/24 }
