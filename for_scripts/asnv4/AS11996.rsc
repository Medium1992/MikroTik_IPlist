...
:if ([:len [find where list=$AddressList and address=208.64.92.0/23]] = 0) do={ add list=$AddressList comment=AS11996 address=208.64.92.0/23 }
:if ([:len [find where list=$AddressList and address=208.64.95.0/24]] = 0) do={ add list=$AddressList comment=AS11996 address=208.64.95.0/24 }
