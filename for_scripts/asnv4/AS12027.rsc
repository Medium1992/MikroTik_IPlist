...
:do {add list=$AddressList comment=AS12027 address=for_scripts/asnv4/AS12027.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12027 address=95.134.117.0/24} on-error {}
