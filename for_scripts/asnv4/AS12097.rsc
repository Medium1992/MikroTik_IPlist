...
:do {add list=$AddressList comment=AS12097 address=for_scripts/asnv4/AS12097.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12097 address=24.140.0.0/17} on-error {}
