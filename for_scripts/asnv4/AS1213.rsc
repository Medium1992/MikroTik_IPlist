...
:if ([:len [find where list=$AddressList and address=87.32.0.0/14]] = 0) do={ add list=$AddressList comment=AS1213 address=87.32.0.0/14 }
...
:if ([:len [find where list=$AddressList and address=87.42.64.0/21]] = 0) do={ add list=$AddressList comment=AS1213 address=87.42.64.0/21 }
:if ([:len [find where list=$AddressList and address=87.42.72.0/24]] = 0) do={ add list=$AddressList comment=AS1213 address=87.42.72.0/24 }
:if ([:len [find where list=$AddressList and address=87.42.74.0/23]] = 0) do={ add list=$AddressList comment=AS1213 address=87.42.74.0/23 }
:if ([:len [find where list=$AddressList and address=87.42.76.0/22]] = 0) do={ add list=$AddressList comment=AS1213 address=87.42.76.0/22 }
:if ([:len [find where list=$AddressList and address=87.42.80.0/20]] = 0) do={ add list=$AddressList comment=AS1213 address=87.42.80.0/20 }
:if ([:len [find where list=$AddressList and address=87.42.96.0/19]] = 0) do={ add list=$AddressList comment=AS1213 address=87.42.96.0/19 }
:if ([:len [find where list=$AddressList and address=87.43.0.0/16]] = 0) do={ add list=$AddressList comment=AS1213 address=87.43.0.0/16 }
:if ([:len [find where list=$AddressList and address=87.44.0.0/14]] = 0) do={ add list=$AddressList comment=AS1213 address=87.44.0.0/14 }
