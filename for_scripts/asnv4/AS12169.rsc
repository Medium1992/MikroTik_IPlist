...
:do {add list=$AddressList comment=AS12169 address=for_scripts/asnv4/AS12169.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12169 address=63.115.140.0/24} on-error {}
