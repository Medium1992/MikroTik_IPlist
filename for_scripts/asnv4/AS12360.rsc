...
:do {add list=$AddressList comment=AS12360 address=212.7.160.0/20} on-error {}
:do {add list=$AddressList comment=AS12360 address=212.7.176.0/24} on-error {}
:do {add list=$AddressList comment=AS12360 address=212.7.178.0/23} on-error {}
:do {add list=$AddressList comment=AS12360 address=212.7.180.0/22} on-error {}
:do {add list=$AddressList comment=AS12360 address=212.7.184.0/21} on-error {}
