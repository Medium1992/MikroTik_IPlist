...
:do {add list=$AddressList comment=AS12481 address=for_scripts/asnv4/AS12481.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12481 address=5.100.232.0/24} on-error {}
:do {add list=$AddressList comment=AS12481 address=5.100.234.0/23} on-error {}
:do {add list=$AddressList comment=AS12481 address=5.100.236.0/22} on-error {}
