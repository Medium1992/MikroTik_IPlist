...
:if ([:len [find where list=$AddressList and address=212.85.48.0/21]] = 0) do={ add list=$AddressList comment=AS12521 address=212.85.48.0/21 }
...
:if ([:len [find where list=$AddressList and address=91.195.102.0/23]] = 0) do={ add list=$AddressList comment=AS12521 address=91.195.102.0/23 }
