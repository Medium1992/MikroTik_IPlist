...
:do {add list=$AddressList comment=AS12539 address=for_scripts/asnv4/AS12539.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12539 address=212.122.84.0/22} on-error {}
