...
:do {add list=$AddressList comment=AS12555 address=185.37.62.0/23} on-error {}
...
:do {add list=$AddressList comment=AS12555 address=81.29.140.0/23} on-error {}
:do {add list=$AddressList comment=AS12555 address=81.29.143.0/24} on-error {}
