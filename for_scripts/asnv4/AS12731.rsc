...
:if ([:len [find where list=$AddressList and address=194.113.42.0/23]] = 0) do={ add list=$AddressList comment=AS12731 address=194.113.42.0/23 }
...
:if ([:len [find where list=$AddressList and address=62.201.160.0/19]] = 0) do={ add list=$AddressList comment=AS12731 address=62.201.160.0/19 }
