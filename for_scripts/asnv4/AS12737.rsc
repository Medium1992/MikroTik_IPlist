...
:do {add list=$AddressList comment=AS12737 address=185.82.196.0/22} on-error {}
...
:do {add list=$AddressList comment=AS12737 address=45.15.112.0/23} on-error {}
:do {add list=$AddressList comment=AS12737 address=45.15.115.0/24} on-error {}
