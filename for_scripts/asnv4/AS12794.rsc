...
:if ([:len [find where list=$AddressList and address=217.169.204.0/23]] = 0) do={ add list=$AddressList comment=AS12794 address=217.169.204.0/23 }
:if ([:len [find where list=$AddressList and address=217.169.206.0/24]] = 0) do={ add list=$AddressList comment=AS12794 address=217.169.206.0/24 }
