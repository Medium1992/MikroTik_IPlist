...
:do {add list=$AddressList comment=AS12810 address=37.244.128.0/18} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.192.0/19} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.224.0/21} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.232.0/22} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.236.0/24} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.0/25} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.128/27} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.160/28} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.176/30} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.180/32} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.182/31} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.184/29} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.237.192/26} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.238.0/23} on-error {}
:do {add list=$AddressList comment=AS12810 address=37.244.240.0/20} on-error {}
