...
:do {add list=$AddressList comment=AS12883 address=for_scripts/asnv4/AS12883.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12883 address=62.221.58.0/23} on-error {}
