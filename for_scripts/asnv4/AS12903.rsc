...
:do {add list=$AddressList comment=AS12903 address=for_scripts/asnv4/AS12903.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12903 address=217.68.208.0/23} on-error {}
