...
:do {add list=$AddressList comment=AS12969 address=for_scripts/asnv4/AS12969.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12969 address=193.4.128.0/21} on-error {}
:do {add list=$AddressList comment=AS12969 address=193.4.136.0/22} on-error {}
:do {add list=$AddressList comment=AS12969 address=193.4.140.0/23} on-error {}
:do {add list=$AddressList comment=AS12969 address=193.4.143.0/24} on-error {}
:do {add list=$AddressList comment=AS12969 address=193.4.144.0/20} on-error {}
:do {add list=$AddressList comment=AS12969 address=193.4.160.0/19} on-error {}
:do {add list=$AddressList comment=AS12969 address=193.4.192.0/18} on-error {}
