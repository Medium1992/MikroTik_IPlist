...
:do {add list=$AddressList comment=AS12978 address=for_scripts/asnv4/AS12978.rsc} on-error {}
...
:do {add list=$AddressList comment=AS12978 address=213.243.49.0/24} on-error {}
:do {add list=$AddressList comment=AS12978 address=213.243.50.0/23} on-error {}
:do {add list=$AddressList comment=AS12978 address=213.243.52.0/22} on-error {}
:do {add list=$AddressList comment=AS12978 address=213.243.56.0/22} on-error {}
:do {add list=$AddressList comment=AS12978 address=213.243.60.0/24} on-error {}
:do {add list=$AddressList comment=AS12978 address=213.243.62.0/23} on-error {}
