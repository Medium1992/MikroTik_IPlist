...
:if ([:len [find where list=$AddressList and address=172.121.180.0/24]] = 0) do={ add list=$AddressList comment=AS12989 address=172.121.180.0/24 }
:if ([:len [find where list=$AddressList and address=172.84.78.0/24]] = 0) do={ add list=$AddressList comment=AS12989 address=172.84.78.0/24 }
