...
:if ([:len [find where list=$AddressList and address=213.180.136.0/22]] = 0) do={ add list=$AddressList comment=AS12990 address=213.180.136.0/22 }
...
:if ([:len [find where list=$AddressList and address=213.180.144.0/21]] = 0) do={ add list=$AddressList comment=AS12990 address=213.180.144.0/21 }
