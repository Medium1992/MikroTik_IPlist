...
:do {add list=$AddressList comment=AS12996 address=for_scripts/asnv4/AS12996.rsc} on-error {}
:do {add list=$AddressList comment=AS12996 address=151.249.120.0/24} on-error {}
:do {add list=$AddressList comment=AS12996 address=151.249.122.0/23} on-error {}
