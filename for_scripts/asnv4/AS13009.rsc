...
:do {add list=$AddressList comment=AS13009 address=91.213.208.0/24} on-error {}
:do {add list=$AddressList comment=AS13009 address=91.213.215.0/24} on-error {}
:do {add list=$AddressList comment=AS13009 address=91.213.217.0/24} on-error {}
:do {add list=$AddressList comment=AS13009 address=91.213.220.0/24} on-error {}
:do {add list=$AddressList comment=AS13009 address=91.232.104.0/24} on-error {}
