...
:do {add list=$AddressList comment=AS131127 address=for_scripts/asnv4/AS131127.rsc} on-error {}
:do {add list=$AddressList comment=AS131127 address=183.91.160.0/23} on-error {}
:do {add list=$AddressList comment=AS131127 address=183.91.166.0/23} on-error {}
