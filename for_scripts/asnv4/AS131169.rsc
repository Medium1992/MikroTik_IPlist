...
:do {add list=$AddressList comment=AS131169 address=182.23.136.0/23} on-error {}
:do {add list=$AddressList comment=AS131169 address=182.23.139.0/24} on-error {}
:do {add list=$AddressList comment=AS131169 address=182.23.140.0/22} on-error {}
