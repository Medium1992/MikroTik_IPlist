...
:if ([:len [find where list=$AddressList and address=45.201.160.0/24]] = 0) do={ add list=$AddressList comment=AS131178 address=45.201.160.0/24 }
:if ([:len [find where list=$AddressList and address=45.201.162.0/24]] = 0) do={ add list=$AddressList comment=AS131178 address=45.201.162.0/24 }
