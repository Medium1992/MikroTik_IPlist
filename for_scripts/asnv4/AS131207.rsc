...
:do {add list=$AddressList comment=AS131207 address=for_scripts/asnv4/AS131207.rsc} on-error {}
...
:do {add list=$AddressList comment=AS131207 address=136.228.148.0/22} on-error {}
