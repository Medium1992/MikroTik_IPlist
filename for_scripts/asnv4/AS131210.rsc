...
:if ([:len [find where list=$AddressList and address=103.2.232.0/23]] = 0) do={ add list=$AddressList comment=AS131210 address=103.2.232.0/23 }
...
:if ([:len [find where list=$AddressList and address=163.128.174.0/24]] = 0) do={ add list=$AddressList comment=AS131210 address=163.128.174.0/24 }
:if ([:len [find where list=$AddressList and address=49.238.50.0/23]] = 0) do={ add list=$AddressList comment=AS131210 address=49.238.50.0/23 }
:if ([:len [find where list=$AddressList and address=49.238.52.0/24]] = 0) do={ add list=$AddressList comment=AS131210 address=49.238.52.0/24 }
