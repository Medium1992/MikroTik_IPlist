...
:do {add list=$AddressList comment=AS131210 address=103.21.232.0/24} on-error {}
:do {add list=$AddressList comment=AS131210 address=103.21.234.0/23} on-error {}
...
:do {add list=$AddressList comment=AS131210 address=49.238.55.0/24} on-error {}
:do {add list=$AddressList comment=AS131210 address=49.238.56.0/23} on-error {}
