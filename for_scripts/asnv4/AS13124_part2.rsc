...
:if ([:len [find where list=$AddressList and address=89.253.162.0/24]] = 0) do={ add list=$AddressList comment=AS13124 address=89.253.162.0/24 }
:if ([:len [find where list=$AddressList and address=89.253.164.0/22]] = 0) do={ add list=$AddressList comment=AS13124 address=89.253.164.0/22 }
