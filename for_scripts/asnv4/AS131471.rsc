...
:if ([:len [find where list=$AddressList and address=180.178.136.0/24]] = 0) do={ add list=$AddressList comment=AS131471 address=180.178.136.0/24 }
:if ([:len [find where list=$AddressList and address=180.178.174.0/24]] = 0) do={ add list=$AddressList comment=AS131471 address=180.178.174.0/24 }
