...
:do {add list=$AddressList comment=AS131539 address=103.248.152.0/24} on-error {}
:do {add list=$AddressList comment=AS131539 address=103.60.164.0/24} on-error {}
...
:do {add list=$AddressList comment=AS131539 address=45.248.8.0/22} on-error {}
