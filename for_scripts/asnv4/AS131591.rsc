...
:do {add list=$AddressList comment=AS131591 address=223.22.232.0/22} on-error {}
:do {add list=$AddressList comment=AS131591 address=223.22.240.0/22} on-error {}
:do {add list=$AddressList comment=AS131591 address=223.22.245.0/24} on-error {}
:do {add list=$AddressList comment=AS131591 address=223.22.246.0/23} on-error {}
