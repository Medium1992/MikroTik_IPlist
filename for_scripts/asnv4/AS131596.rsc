...
:if ([:len [find where list=$AddressList and address=116.241.0.0/17]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.0.0/17 }
:if ([:len [find where list=$AddressList and address=116.241.128.0/19]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.128.0/19 }
:if ([:len [find where list=$AddressList and address=116.241.160.0/21]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.160.0/21 }
:if ([:len [find where list=$AddressList and address=116.241.168.0/22]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.168.0/22 }
:if ([:len [find where list=$AddressList and address=116.241.172.0/23]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.172.0/23 }
:if ([:len [find where list=$AddressList and address=116.241.175.0/24]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.175.0/24 }
:if ([:len [find where list=$AddressList and address=116.241.176.0/20]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.176.0/20 }
:if ([:len [find where list=$AddressList and address=116.241.192.0/18]] = 0) do={ add list=$AddressList comment=AS131596 address=116.241.192.0/18 }
...
:if ([:len [find where list=$AddressList and address=123.240.0.0/19]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.0.0/19 }
:if ([:len [find where list=$AddressList and address=123.240.128.0/17]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.128.0/17 }
:if ([:len [find where list=$AddressList and address=123.240.32.0/20]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.32.0/20 }
:if ([:len [find where list=$AddressList and address=123.240.48.0/21]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.48.0/21 }
:if ([:len [find where list=$AddressList and address=123.240.56.0/24]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.56.0/24 }
:if ([:len [find where list=$AddressList and address=123.240.58.0/23]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.58.0/23 }
:if ([:len [find where list=$AddressList and address=123.240.60.0/22]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.60.0/22 }
:if ([:len [find where list=$AddressList and address=123.240.64.0/18]] = 0) do={ add list=$AddressList comment=AS131596 address=123.240.64.0/18 }
