...
:do {add list=$AddressList comment=AS131596 address=59.102.128.0/22} on-error {}
:do {add list=$AddressList comment=AS131596 address=59.102.136.0/21} on-error {}
:do {add list=$AddressList comment=AS131596 address=59.102.144.0/20} on-error {}
:do {add list=$AddressList comment=AS131596 address=59.102.160.0/19} on-error {}
:do {add list=$AddressList comment=AS131596 address=59.102.192.0/18} on-error {}
