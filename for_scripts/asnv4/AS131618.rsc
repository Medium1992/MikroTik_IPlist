...
:do {add list=$AddressList comment=AS131618 address=for_scripts/asnv4/AS131618.rsc} on-error {}
:do {add list=$AddressList comment=AS131618 address=103.103.80.0/23} on-error {}
...
:do {add list=$AddressList comment=AS131618 address=103.129.136.0/22} on-error {}
:do {add list=$AddressList comment=AS131618 address=103.135.116.0/22} on-error {}
:do {add list=$AddressList comment=AS131618 address=103.161.6.0/23} on-error {}
