...
:do {add list=$AddressList comment=AS131644 address=for_scripts/asnv4/AS131644.rsc} on-error {}
...
:do {add list=$AddressList comment=AS131644 address=203.55.118.0/24} on-error {}
