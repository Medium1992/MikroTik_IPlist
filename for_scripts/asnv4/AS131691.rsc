...
:do {add list=$AddressList comment=AS131691 address=for_scripts/asnv4/AS131691.rsc} on-error {}
:do {add list=$AddressList comment=AS131691 address=116.213.54.0/23} on-error {}
:do {add list=$AddressList comment=AS131691 address=116.213.56.0/23} on-error {}
