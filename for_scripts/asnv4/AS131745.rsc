...
:do {add list=$AddressList comment=AS131745 address=210.247.245.0/24} on-error {}
:do {add list=$AddressList comment=AS131745 address=210.247.246.0/23} on-error {}
:do {add list=$AddressList comment=AS131745 address=210.247.248.0/21} on-error {}
