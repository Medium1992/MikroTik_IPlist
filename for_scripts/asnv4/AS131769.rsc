...
:do {add list=$AddressList comment=AS131769 address=for_scripts/asnv4/AS131769.rsc} on-error {}
...
:do {add list=$AddressList comment=AS131769 address=103.177.218.0/23} on-error {}
