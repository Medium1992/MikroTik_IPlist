...
:if ([:len [find where list=$AddressList and address=103.51.4.0/22]] = 0) do={ add list=$AddressList comment=AS131896 address=103.51.4.0/22 }
...
:if ([:len [find where list=$AddressList and address=219.100.240.0/22]] = 0) do={ add list=$AddressList comment=AS131896 address=219.100.240.0/22 }
