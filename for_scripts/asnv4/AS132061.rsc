...
:do {add list=$AddressList comment=AS132061 address=for_scripts/asnv4/AS132061.rsc} on-error {}
:do {add list=$AddressList comment=AS132061 address=223.24.144.0/20} on-error {}
:do {add list=$AddressList comment=AS132061 address=223.24.160.0/21} on-error {}
...
:do {add list=$AddressList comment=AS132061 address=27.55.64.0/19} on-error {}
