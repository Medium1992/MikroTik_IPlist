...
:do {add list=$AddressList comment=AS132061 address=223.24.188.0/22} on-error {}
...
:do {add list=$AddressList comment=AS132061 address=27.55.64.0/22} on-error {}
:do {add list=$AddressList comment=AS132061 address=27.55.84.0/22} on-error {}
:do {add list=$AddressList comment=AS132061 address=27.55.88.0/22} on-error {}
