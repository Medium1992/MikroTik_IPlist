...
:if ([:len [find where list=$AddressList and address=154.12.185.0/24]] = 0) do={ add list=$AddressList comment=AS132110 address=154.12.185.0/24 }
:if ([:len [find where list=$AddressList and address=154.12.186.0/23]] = 0) do={ add list=$AddressList comment=AS132110 address=154.12.186.0/23 }
