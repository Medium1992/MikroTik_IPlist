...
:do {add list=$AddressList comment=AS13214 address=for_scripts/asnv4/AS13214.rsc} on-error {}
...
:do {add list=$AddressList comment=AS13214 address=31.22.95.0/24} on-error {}
