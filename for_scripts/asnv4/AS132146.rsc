...
:do {add list=$AddressList comment=AS132146 address=for_scripts/asnv4/AS132146.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132146 address=154.19.24.0/24} on-error {}
