...
:do {add list=$AddressList comment=AS132300 address=for_scripts/asnv4/AS132300.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132300 address=139.5.144.0/23} on-error {}
