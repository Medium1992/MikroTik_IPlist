...
:do {add list=$AddressList comment=AS132420 address=151.185.32.0/22} on-error {}
...
:do {add list=$AddressList comment=AS132420 address=151.185.48.0/22} on-error {}
:do {add list=$AddressList comment=AS132420 address=164.52.192.0/19} on-error {}
:do {add list=$AddressList comment=AS132420 address=205.147.109.0/24} on-error {}
:do {add list=$AddressList comment=AS132420 address=205.147.110.0/23} on-error {}
...
:do {add list=$AddressList comment=AS132420 address=43.252.88.0/23} on-error {}
:do {add list=$AddressList comment=AS132420 address=43.252.90.0/24} on-error {}
