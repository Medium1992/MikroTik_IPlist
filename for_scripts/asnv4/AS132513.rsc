...
:do {add list=$AddressList comment=AS132513 address=for_scripts/asnv4/AS132513.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132513 address=45.196.208.0/24} on-error {}
