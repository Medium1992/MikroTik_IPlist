...
:do {add list=$AddressList comment=AS132536 address=123.151.88.0/24} on-error {}
:do {add list=$AddressList comment=AS132536 address=123.151.90.0/24} on-error {}
...
:do {add list=$AddressList comment=AS132536 address=221.238.247.0/24} on-error {}
