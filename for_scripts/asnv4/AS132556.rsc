...
:do {add list=$AddressList comment=AS132556 address=for_scripts/asnv4/AS132556.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132556 address=103.43.200.0/24} on-error {}
