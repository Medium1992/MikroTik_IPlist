...
:do {add list=$AddressList comment=AS132566 address=for_scripts/asnv4/AS132566.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132566 address=45.198.238.0/23} on-error {}
:do {add list=$AddressList comment=AS132566 address=45.198.240.0/22} on-error {}
:do {add list=$AddressList comment=AS132566 address=45.198.244.0/23} on-error {}
