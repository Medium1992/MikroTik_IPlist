...
:do {add list=$AddressList comment=AS132608 address=for_scripts/asnv4/AS132608.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132608 address=114.130.75.0/24} on-error {}
