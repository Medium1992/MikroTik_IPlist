...
:do {add list=$AddressList comment=AS132641 address=for_scripts/asnv4/AS132641.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132641 address=38.102.76.0/24} on-error {}
