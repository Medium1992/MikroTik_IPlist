...
:do {add list=$AddressList comment=AS132641 address=103.145.218.0/23} on-error {}
...
:do {add list=$AddressList comment=AS132641 address=103.41.120.0/24} on-error {}
:do {add list=$AddressList comment=AS132641 address=103.41.122.0/23} on-error {}
