...
:do {add list=$AddressList comment=AS132778 address=for_scripts/asnv4/AS132778.rsc} on-error {}
...
:do {add list=$AddressList comment=AS132778 address=165.99.136.0/23} on-error {}
