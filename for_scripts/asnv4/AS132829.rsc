...
:do {add list=$AddressList comment=AS132829 address=103.134.50.0/24} on-error {}
...
:do {add list=$AddressList comment=AS132829 address=103.248.132.0/24} on-error {}
:do {add list=$AddressList comment=AS132829 address=103.248.134.0/23} on-error {}
...
:do {add list=$AddressList comment=AS132829 address=119.42.48.0/24} on-error {}
