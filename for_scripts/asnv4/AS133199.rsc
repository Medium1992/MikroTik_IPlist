...
:if ([:len [find where list=$AddressList and address=109.66.112.0/20]] = 0) do={ add list=$AddressList comment=AS133199 address=109.66.112.0/20 }
...
:if ([:len [find where list=$AddressList and address=169.40.80.0/20]] = 0) do={ add list=$AddressList comment=AS133199 address=169.40.80.0/20 }
