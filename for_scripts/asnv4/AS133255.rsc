...
:do {add list=$AddressList comment=AS133255 address=for_scripts/asnv4/AS133255.rsc} on-error {}
...
:do {add list=$AddressList comment=AS133255 address=154.50.120.0/23} on-error {}
