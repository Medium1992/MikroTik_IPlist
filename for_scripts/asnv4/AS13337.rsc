...
:do {add list=$AddressList comment=AS13337 address=for_scripts/asnv4/AS13337.rsc} on-error {}
...
:do {add list=$AddressList comment=AS13337 address=199.5.193.0/24} on-error {}
