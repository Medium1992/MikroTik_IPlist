...
:do {add list=$AddressList comment=AS133398 address=for_scripts/asnv4/AS133398.rsc} on-error {}
...
:do {add list=$AddressList comment=AS133398 address=104.234.198.0/23} on-error {}
