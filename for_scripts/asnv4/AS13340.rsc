...
:if ([:len [find where list=$AddressList and address=208.65.74.0/24]] = 0) do={ add list=$AddressList comment=AS13340 address=208.65.74.0/24 }
:if ([:len [find where list=$AddressList and address=208.93.74.0/24]] = 0) do={ add list=$AddressList comment=AS13340 address=208.93.74.0/24 }
:if ([:len [find where list=$AddressList and address=208.93.76.0/23]] = 0) do={ add list=$AddressList comment=AS13340 address=208.93.76.0/23 }
