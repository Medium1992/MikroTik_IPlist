...
:do {add list=$AddressList comment=AS133495 address=for_scripts/asnv4/AS133495.rsc} on-error {}
...
:do {add list=$AddressList comment=AS133495 address=185.167.218.0/24} on-error {}
