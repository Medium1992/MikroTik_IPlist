...
:do {add list=$AddressList comment=AS133524 address=103.25.76.0/24} on-error {}
:do {add list=$AddressList comment=AS133524 address=103.25.78.0/23} on-error {}
...
:do {add list=$AddressList comment=AS133524 address=38.47.40.0/22} on-error {}
:do {add list=$AddressList comment=AS133524 address=38.47.44.0/23} on-error {}
:do {add list=$AddressList comment=AS133524 address=38.47.46.0/24} on-error {}
