...
:do {add list=$AddressList comment=AS133606 address=116.199.172.0/22} on-error {}
...
:do {add list=$AddressList comment=AS133606 address=223.29.230.0/23} on-error {}
:do {add list=$AddressList comment=AS133606 address=223.29.236.0/22} on-error {}
