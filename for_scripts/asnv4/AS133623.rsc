...
:do {add list=$AddressList comment=AS133623 address=for_scripts/asnv4/AS133623.rsc} on-error {}
...
:do {add list=$AddressList comment=AS133623 address=103.36.18.0/24} on-error {}
