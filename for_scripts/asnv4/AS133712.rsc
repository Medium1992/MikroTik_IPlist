...
:if ([:len [find where list=$AddressList and address=43.231.248.0/23]] = 0) do={ add list=$AddressList comment=AS133712 address=43.231.248.0/23 }
:if ([:len [find where list=$AddressList and address=43.231.250.0/24]] = 0) do={ add list=$AddressList comment=AS133712 address=43.231.250.0/24 }
