...
:do {add list=$AddressList comment=AS133712 address=103.119.56.0/24} on-error {}
:do {add list=$AddressList comment=AS133712 address=103.127.74.0/24} on-error {}
:do {add list=$AddressList comment=AS133712 address=103.129.112.0/23} on-error {}
:do {add list=$AddressList comment=AS133712 address=103.146.99.0/24} on-error {}
:do {add list=$AddressList comment=AS133712 address=103.170.106.0/23} on-error {}
:do {add list=$AddressList comment=AS133712 address=103.171.60.0/23} on-error {}
...
:do {add list=$AddressList comment=AS133712 address=43.231.248.0/22} on-error {}
