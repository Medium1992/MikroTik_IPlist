...
:do {add list=$AddressList comment=AS133731 address=103.231.12.0/22} on-error {}
...
:do {add list=$AddressList comment=AS133731 address=103.51.144.0/23} on-error {}
:do {add list=$AddressList comment=AS133731 address=103.51.147.0/24} on-error {}
