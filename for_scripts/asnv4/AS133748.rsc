...
:if ([:len [find where list=$AddressList and address=206.131.202.0/23]] = 0) do={ add list=$AddressList comment=AS133748 address=206.131.202.0/23 }
:if ([:len [find where list=$AddressList and address=206.131.204.0/22]] = 0) do={ add list=$AddressList comment=AS133748 address=206.131.204.0/22 }
