...
:if ([:len [find where list=$AddressList and address=200.112.232.0/23]] = 0) do={ add list=$AddressList comment=AS13381 address=200.112.232.0/23 }
...
:if ([:len [find where list=$AddressList and address=200.112.238.0/23]] = 0) do={ add list=$AddressList comment=AS13381 address=200.112.238.0/23 }
