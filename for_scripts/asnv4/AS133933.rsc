...
:do {add list=$AddressList comment=AS133933 address=111.92.128.0/24} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.130.0/23} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.132.0/22} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.136.0/21} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.144.0/22} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.148.0/23} on-error {}
...
:do {add list=$AddressList comment=AS133933 address=14.192.156.0/24} on-error {}
:do {add list=$AddressList comment=AS133933 address=14.192.158.0/23} on-error {}
