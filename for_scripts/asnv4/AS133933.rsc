...
:do {add list=$AddressList comment=AS133933 address=for_scripts/asnv4/AS133933.rsc} on-error {}
:do {add list=$AddressList comment=AS133933 address=103.104.84.0/23} on-error {}
:do {add list=$AddressList comment=AS133933 address=103.20.132.0/23} on-error {}
...
:do {add list=$AddressList comment=AS133933 address=111.92.128.0/20} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.144.0/21} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.152.0/23} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.154.0/24} on-error {}
:do {add list=$AddressList comment=AS133933 address=111.92.156.0/24} on-error {}
:do {add list=$AddressList comment=AS133933 address=14.192.128.0/23} on-error {}
:do {add list=$AddressList comment=AS133933 address=14.192.130.0/24} on-error {}
...
:do {add list=$AddressList comment=AS133933 address=14.192.152.0/21} on-error {}
