...
:do {add list=$AddressList comment=AS134014 address=103.59.200.0/23} on-error {}
:do {add list=$AddressList comment=AS134014 address=103.59.203.0/24} on-error {}
...
:do {add list=$AddressList comment=AS134014 address=182.54.148.0/22} on-error {}
