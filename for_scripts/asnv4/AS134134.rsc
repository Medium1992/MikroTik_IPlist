...
:if ([:len [find where list=$AddressList and address=103.53.24.0/24]] = 0) do={ add list=$AddressList comment=AS134134 address=103.53.24.0/24 }
:if ([:len [find where list=$AddressList and address=103.53.26.0/23]] = 0) do={ add list=$AddressList comment=AS134134 address=103.53.26.0/23 }
