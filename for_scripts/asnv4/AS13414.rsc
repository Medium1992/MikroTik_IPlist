...
:do {add list=$AddressList comment=AS13414 address=104.244.41.0/24} on-error {}
...
:do {add list=$AddressList comment=AS13414 address=209.237.192.0/20} on-error {}
:do {add list=$AddressList comment=AS13414 address=209.237.209.0/24} on-error {}
:do {add list=$AddressList comment=AS13414 address=209.237.210.0/23} on-error {}
:do {add list=$AddressList comment=AS13414 address=209.237.212.0/22} on-error {}
:do {add list=$AddressList comment=AS13414 address=209.237.216.0/21} on-error {}
