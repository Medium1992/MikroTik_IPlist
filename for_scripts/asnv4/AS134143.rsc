...
:do {add list=$AddressList comment=AS134143 address=14.102.164.0/23} on-error {}
:do {add list=$AddressList comment=AS134143 address=14.102.166.0/24} on-error {}
:do {add list=$AddressList comment=AS134143 address=157.85.72.0/21} on-error {}
...
:do {add list=$AddressList comment=AS134143 address=45.74.128.0/20} on-error {}
