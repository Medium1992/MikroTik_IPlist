...
:do {add list=$AddressList comment=AS134202 address=103.246.115.0/24} on-error {}
:do {add list=$AddressList comment=AS134202 address=103.58.16.0/22} on-error {}
:do {add list=$AddressList comment=AS134202 address=118.107.212.0/22} on-error {}
:do {add list=$AddressList comment=AS134202 address=202.9.37.0/24} on-error {}
:do {add list=$AddressList comment=AS134202 address=202.9.38.0/24} on-error {}
