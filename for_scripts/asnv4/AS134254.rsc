...
:if ([:len [find where list=$AddressList and address=144.48.176.0/22]] = 0) do={ add list=$AddressList comment=AS134254 address=144.48.176.0/22 }
:if ([:len [find where list=$AddressList and address=43.243.172.0/22]] = 0) do={ add list=$AddressList comment=AS134254 address=43.243.172.0/22 }
