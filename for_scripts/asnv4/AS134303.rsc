...
:do {add list=$AddressList comment=AS134303 address=103.100.12.0/22} on-error {}
...
:do {add list=$AddressList comment=AS134303 address=144.79.226.0/24} on-error {}
:do {add list=$AddressList comment=AS134303 address=160.25.110.0/24} on-error {}
:do {add list=$AddressList comment=AS134303 address=161.248.66.0/23} on-error {}
