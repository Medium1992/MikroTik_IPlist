...
:if ([:len [find where list=$AddressList and address=5.231.93.0/24]] = 0) do={ add list=$AddressList comment=AS134465 address=5.231.93.0/24 }
:if ([:len [find where list=$AddressList and address=94.249.151.0/24]] = 0) do={ add list=$AddressList comment=AS134465 address=94.249.151.0/24 }
