...
:if ([:len [find where list=$AddressList and address=103.238.114.0/24]] = 0) do={ add list=$AddressList comment=AS134562 address=103.238.114.0/24 }
...
:if ([:len [find where list=$AddressList and address=151.158.16.0/24]] = 0) do={ add list=$AddressList comment=AS134562 address=151.158.16.0/24 }
