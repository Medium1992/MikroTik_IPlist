...
:if ([:len [find where list=$AddressList and address=103.76.100.0/22]] = 0) do={ add list=$AddressList comment=AS134674 address=103.76.100.0/22 }
...
:if ([:len [find where list=$AddressList and address=45.127.44.0/22]] = 0) do={ add list=$AddressList comment=AS134674 address=45.127.44.0/22 }
