...
:do {add list=$AddressList comment=AS13480 address=63.143.0.0/21} on-error {}
:do {add list=$AddressList comment=AS13480 address=63.143.11.0/24} on-error {}
:do {add list=$AddressList comment=AS13480 address=63.143.12.0/22} on-error {}
:do {add list=$AddressList comment=AS13480 address=63.143.8.0/24} on-error {}
