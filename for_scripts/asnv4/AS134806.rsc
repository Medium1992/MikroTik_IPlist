...
:if ([:len [find where list=$AddressList and address=103.132.43.0/24]] = 0) do={ add list=$AddressList comment=AS134806 address=103.132.43.0/24 }
...
:if ([:len [find where list=$AddressList and address=160.238.0.0/24]] = 0) do={ add list=$AddressList comment=AS134806 address=160.238.0.0/24 }
