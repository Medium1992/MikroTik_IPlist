...
:do {add list=$AddressList comment=AS134912 address=for_scripts/asnv4/AS134912.rsc} on-error {}
...
:do {add list=$AddressList comment=AS134912 address=165.101.174.0/23} on-error {}
