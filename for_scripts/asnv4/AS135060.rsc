...
:do {add list=$AddressList comment=AS135060 address=103.134.53.0/24} on-error {}
...
:do {add list=$AddressList comment=AS135060 address=123.253.192.0/23} on-error {}
:do {add list=$AddressList comment=AS135060 address=123.253.194.0/24} on-error {}
