...
:if ([:len [find where list=$AddressList and address=203.210.16.0/22]] = 0) do={ add list=$AddressList comment=AS135120 address=203.210.16.0/22 }
:if ([:len [find where list=$AddressList and address=203.210.20.0/24]] = 0) do={ add list=$AddressList comment=AS135120 address=203.210.20.0/24 }
:if ([:len [find where list=$AddressList and address=203.210.22.0/23]] = 0) do={ add list=$AddressList comment=AS135120 address=203.210.22.0/23 }
...
:if ([:len [find where list=$AddressList and address=210.87.204.0/23]] = 0) do={ add list=$AddressList comment=AS135120 address=210.87.204.0/23 }
:if ([:len [find where list=$AddressList and address=210.87.207.0/24]] = 0) do={ add list=$AddressList comment=AS135120 address=210.87.207.0/24 }
