...
:if ([:len [find where list=$AddressList and address=142.249.59.0/24]] = 0) do={ add list=$AddressList comment=AS135120 address=142.249.59.0/24 }
...
:if ([:len [find where list=$AddressList and address=182.237.54.0/24]] = 0) do={ add list=$AddressList comment=AS135120 address=182.237.54.0/24 }
