...
:do {add list=$AddressList comment=AS135300 address=45.192.136.0/22} on-error {}
:do {add list=$AddressList comment=AS135300 address=45.192.140.0/23} on-error {}
:do {add list=$AddressList comment=AS135300 address=45.192.143.0/24} on-error {}
