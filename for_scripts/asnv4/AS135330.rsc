...
:if ([:len [find where list=$AddressList and address=139.28.168.0/23]] = 0) do={ add list=$AddressList comment=AS135330 address=139.28.168.0/23 }
:if ([:len [find where list=$AddressList and address=139.28.171.0/24]] = 0) do={ add list=$AddressList comment=AS135330 address=139.28.171.0/24 }
