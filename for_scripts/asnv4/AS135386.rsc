...
:do {add list=$AddressList comment=AS135386 address=103.216.216.0/22} on-error {}
...
:do {add list=$AddressList comment=AS135386 address=103.9.194.0/24} on-error {}
...
:do {add list=$AddressList comment=AS135386 address=45.248.68.0/22} on-error {}
