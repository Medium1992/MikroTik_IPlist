...
:do {add list=$AddressList comment=AS135451 address=for_scripts/asnv4/AS135451.rsc} on-error {}
...
:do {add list=$AddressList comment=AS135451 address=157.10.213.0/24} on-error {}
