...
:if ([:len [find where list=$AddressList and address=141.140.34.0/24]] = 0) do={ add list=$AddressList comment=AS135566 address=141.140.34.0/24 }
:if ([:len [find where list=$AddressList and address=141.140.39.0/24]] = 0) do={ add list=$AddressList comment=AS135566 address=141.140.39.0/24 }
