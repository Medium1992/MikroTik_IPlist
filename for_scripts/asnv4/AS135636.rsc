...
:do {add list=$AddressList comment=AS135636 address=for_scripts/asnv4/AS135636.rsc} on-error {}
...
:do {add list=$AddressList comment=AS135636 address=103.139.120.0/23} on-error {}
