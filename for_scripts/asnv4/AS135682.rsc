...
:if ([:len [find where list=$AddressList and address=103.98.194.0/24]] = 0) do={ add list=$AddressList comment=AS135682 address=103.98.194.0/24 }
:if ([:len [find where list=$AddressList and address=145.79.134.0/24]] = 0) do={ add list=$AddressList comment=AS135682 address=145.79.134.0/24 }
