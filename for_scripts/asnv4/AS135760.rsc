...
:do {add list=$AddressList comment=AS135760 address=for_scripts/asnv4/AS135760.rsc} on-error {}
:do {add list=$AddressList comment=AS135760 address=103.155.194.0/24} on-error {}
