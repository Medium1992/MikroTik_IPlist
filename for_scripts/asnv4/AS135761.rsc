...
:do {add list=$AddressList comment=AS135761 address=for_scripts/asnv4/AS135761.rsc} on-error {}
...
:do {add list=$AddressList comment=AS135761 address=103.158.174.0/23} on-error {}
