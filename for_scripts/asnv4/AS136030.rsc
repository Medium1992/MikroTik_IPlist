...
:do {add list=$AddressList comment=AS136030 address=103.101.232.0/24} on-error {}
:do {add list=$AddressList comment=AS136030 address=103.104.192.0/22} on-error {}
:do {add list=$AddressList comment=AS136030 address=103.125.71.0/24} on-error {}
:do {add list=$AddressList comment=AS136030 address=103.127.36.0/22} on-error {}
:do {add list=$AddressList comment=AS136030 address=103.165.176.0/24} on-error {}
:do {add list=$AddressList comment=AS136030 address=103.235.78.0/24} on-error {}
:do {add list=$AddressList comment=AS136030 address=103.255.150.0/24} on-error {}
...
:do {add list=$AddressList comment=AS136030 address=180.149.216.0/23} on-error {}
:do {add list=$AddressList comment=AS136030 address=180.149.218.0/24} on-error {}
