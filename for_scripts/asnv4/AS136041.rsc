...
:do {add list=$AddressList comment=AS136041 address=for_scripts/asnv4/AS136041.rsc} on-error {}
...
:do {add list=$AddressList comment=AS136041 address=119.234.236.0/23} on-error {}
