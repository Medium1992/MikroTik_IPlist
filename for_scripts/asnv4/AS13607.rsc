...
:do {add list=$AddressList comment=AS13607 address=for_scripts/asnv4/AS13607.rsc} on-error {}
...
:do {add list=$AddressList comment=AS13607 address=74.217.71.0/24} on-error {}
:do {add list=$AddressList comment=AS13607 address=74.217.97.0/24} on-error {}
