...
:if ([:len [find where list=$AddressList and address=103.111.92.0/23]] = 0) do={ add list=$AddressList comment=AS136093 address=103.111.92.0/23 }
:if ([:len [find where list=$AddressList and address=103.111.95.0/24]] = 0) do={ add list=$AddressList comment=AS136093 address=103.111.95.0/24 }
