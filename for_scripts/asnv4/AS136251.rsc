...
:if ([:len [find where list=$AddressList and address=202.181.1.0/24]] = 0) do={ add list=$AddressList comment=AS136251 address=202.181.1.0/24 }
:if ([:len [find where list=$AddressList and address=202.181.2.0/23]] = 0) do={ add list=$AddressList comment=AS136251 address=202.181.2.0/23 }
