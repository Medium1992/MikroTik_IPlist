...
:do {add list=$AddressList comment=AS136374 address=for_scripts/asnv4/AS136374.rsc} on-error {}
:do {add list=$AddressList comment=AS136374 address=103.228.250.0/23} on-error {}
...
:do {add list=$AddressList comment=AS136374 address=103.94.84.0/24} on-error {}
:do {add list=$AddressList comment=AS136374 address=103.94.86.0/23} on-error {}
