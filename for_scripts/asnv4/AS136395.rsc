...
:if ([:len [find where list=$AddressList and address=202.181.4.0/24]] = 0) do={ add list=$AddressList comment=AS136395 address=202.181.4.0/24 }
:if ([:len [find where list=$AddressList and address=202.181.6.0/23]] = 0) do={ add list=$AddressList comment=AS136395 address=202.181.6.0/23 }
