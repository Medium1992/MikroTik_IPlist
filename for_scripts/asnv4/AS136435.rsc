...
:do {add list=$AddressList comment=AS136435 address=for_scripts/asnv4/AS136435.rsc} on-error {}
:do {add list=$AddressList comment=AS136435 address=103.172.115.0/24} on-error {}
