...
:do {add list=$AddressList comment=AS13654 address=68.171.16.0/22} on-error {}
:do {add list=$AddressList comment=AS13654 address=68.171.21.0/24} on-error {}
:do {add list=$AddressList comment=AS13654 address=68.171.22.0/23} on-error {}
