...
:do {add list=$AddressList comment=AS13657 address=for_scripts/asnv4/AS13657.rsc} on-error {}
...
:do {add list=$AddressList comment=AS13657 address=65.22.14.0/24} on-error {}
