...
:do {add list=$AddressList comment=AS136696 address=for_scripts/asnv4/AS136696.rsc} on-error {}
:do {add list=$AddressList comment=AS136696 address=103.103.56.0/22} on-error {}
:do {add list=$AddressList comment=AS136696 address=103.107.92.0/22} on-error {}
