...
:do {add list=$AddressList comment=AS136841 address=103.41.248.0/24} on-error {}
...
:do {add list=$AddressList comment=AS136841 address=38.86.221.0/24} on-error {}
:do {add list=$AddressList comment=AS136841 address=67.216.24.0/22} on-error {}
