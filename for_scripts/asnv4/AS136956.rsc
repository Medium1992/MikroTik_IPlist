...
:do {add list=$AddressList comment=AS136956 address=for_scripts/asnv4/AS136956.rsc} on-error {}
...
:do {add list=$AddressList comment=AS136956 address=103.210.132.0/22} on-error {}
