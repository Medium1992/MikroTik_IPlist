...
:do {add list=$AddressList comment=AS137000 address=for_scripts/asnv4/AS137000.rsc} on-error {}
...
:do {add list=$AddressList comment=AS137000 address=45.117.85.0/24} on-error {}
