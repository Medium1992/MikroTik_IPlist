...
:do {add list=$AddressList comment=AS13720 address=for_scripts/asnv4/AS13720.rsc} on-error {}
:do {add list=$AddressList comment=AS13720 address=209.0.234.0/23} on-error {}
...
:do {add list=$AddressList comment=AS13720 address=69.174.216.0/23} on-error {}
