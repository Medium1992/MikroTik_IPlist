...
:if ([:len [find where list=$AddressList and address=192.184.2.0/24]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.2.0/24 }
:if ([:len [find where list=$AddressList and address=192.184.3.0/26]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.0/26 }
:if ([:len [find where list=$AddressList and address=192.184.3.128/25]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.128/25 }
:if ([:len [find where list=$AddressList and address=192.184.3.64/30]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.64/30 }
:if ([:len [find where list=$AddressList and address=192.184.3.68/31]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.68/31 }
:if ([:len [find where list=$AddressList and address=192.184.3.70/32]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.70/32 }
:if ([:len [find where list=$AddressList and address=192.184.3.72/29]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.72/29 }
:if ([:len [find where list=$AddressList and address=192.184.3.80/28]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.80/28 }
:if ([:len [find where list=$AddressList and address=192.184.3.96/27]] = 0) do={ add list=$AddressList comment=AS13739 address=192.184.3.96/27 }
