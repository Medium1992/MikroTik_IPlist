...
:if ([:len [find where list=$AddressList and address=178.93.98.0/24]] = 0) do={ add list=$AddressList comment=AS137410 address=178.93.98.0/24 }
:if ([:len [find where list=$AddressList and address=185.172.174.0/24]] = 0) do={ add list=$AddressList comment=AS137410 address=185.172.174.0/24 }
