...
:do {add list=$AddressList comment=AS137427 address=for_scripts/asnv4/AS137427.rsc} on-error {}
...
:do {add list=$AddressList comment=AS137427 address=194.126.215.0/24} on-error {}
