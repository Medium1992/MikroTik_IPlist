...
:do {add list=$AddressList comment=AS137535 address=103.127.241.0/24} on-error {}
:do {add list=$AddressList comment=AS137535 address=103.127.242.0/23} on-error {}
:do {add list=$AddressList comment=AS137535 address=142.248.136.0/23} on-error {}
:do {add list=$AddressList comment=AS137535 address=142.248.139.0/24} on-error {}
...
:do {add list=$AddressList comment=AS137535 address=38.47.198.0/23} on-error {}
