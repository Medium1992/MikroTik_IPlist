...
:do {add list=$AddressList comment=AS137535 address=38.181.48.0/24} on-error {}
:do {add list=$AddressList comment=AS137535 address=38.181.50.0/23} on-error {}
:do {add list=$AddressList comment=AS137535 address=38.181.52.0/22} on-error {}
