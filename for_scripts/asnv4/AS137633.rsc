...
:if ([:len [find where list=$AddressList and address=103.115.129.0/24]] = 0) do={ add list=$AddressList comment=AS137633 address=103.115.129.0/24 }
:if ([:len [find where list=$AddressList and address=103.115.130.0/23]] = 0) do={ add list=$AddressList comment=AS137633 address=103.115.130.0/23 }
