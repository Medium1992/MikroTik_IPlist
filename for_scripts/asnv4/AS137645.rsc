...
:do {add list=$AddressList comment=AS137645 address=for_scripts/asnv4/AS137645.rsc} on-error {}
...
:do {add list=$AddressList comment=AS137645 address=157.15.88.0/23} on-error {}
