...
:do {add list=$AddressList comment=AS138004 address=103.10.194.0/23} on-error {}
...
:do {add list=$AddressList comment=AS138004 address=202.125.64.0/24} on-error {}
:do {add list=$AddressList comment=AS138004 address=202.125.66.0/23} on-error {}
:do {add list=$AddressList comment=AS138004 address=202.125.68.0/24} on-error {}
:do {add list=$AddressList comment=AS138004 address=202.125.79.0/24} on-error {}
