...
:do {add list=$AddressList comment=AS138156 address=for_scripts/asnv4/AS138156.rsc} on-error {}
...
:do {add list=$AddressList comment=AS138156 address=89.213.57.0/24} on-error {}
