...
:if ([:len [find where list=$AddressList and address=141.11.156.0/22]] = 0) do={ add list=$AddressList comment=AS138156 address=141.11.156.0/22 }
:if ([:len [find where list=$AddressList and address=147.79.55.0/24]] = 0) do={ add list=$AddressList comment=AS138156 address=147.79.55.0/24 }
