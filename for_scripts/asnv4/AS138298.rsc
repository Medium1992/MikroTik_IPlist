...
:do {add list=$AddressList comment=AS138298 address=for_scripts/asnv4/AS138298.rsc} on-error {}
...
:do {add list=$AddressList comment=AS138298 address=103.158.231.0/24} on-error {}
