...
:do {add list=$AddressList comment=AS138322 address=for_scripts/asnv4/AS138322.rsc} on-error {}
...
:do {add list=$AddressList comment=AS138322 address=152.36.212.0/22} on-error {}
