...
:do {add list=$AddressList comment=AS138346 address=103.114.93.0/24} on-error {}
:do {add list=$AddressList comment=AS138346 address=103.123.169.0/24} on-error {}
:do {add list=$AddressList comment=AS138346 address=103.123.170.0/23} on-error {}
...
:do {add list=$AddressList comment=AS138346 address=138.252.41.0/24} on-error {}
