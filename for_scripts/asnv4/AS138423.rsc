...
:do {add list=$AddressList comment=AS138423 address=117.134.192.0/23} on-error {}
:do {add list=$AddressList comment=AS138423 address=117.134.194.0/24} on-error {}
:do {add list=$AddressList comment=AS138423 address=117.134.196.0/22} on-error {}
:do {add list=$AddressList comment=AS138423 address=117.134.200.0/23} on-error {}
:do {add list=$AddressList comment=AS138423 address=117.134.202.0/24} on-error {}
...
:do {add list=$AddressList comment=AS138423 address=223.123.48.0/23} on-error {}
:do {add list=$AddressList comment=AS138423 address=223.123.66.0/23} on-error {}
:do {add list=$AddressList comment=AS138423 address=223.123.76.0/22} on-error {}
