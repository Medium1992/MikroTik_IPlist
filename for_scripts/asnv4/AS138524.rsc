...
:do {add list=$AddressList comment=AS138524 address=180.183.0.0/22} on-error {}
:do {add list=$AddressList comment=AS138524 address=180.183.10.0/23} on-error {}
:do {add list=$AddressList comment=AS138524 address=180.183.12.0/23} on-error {}
:do {add list=$AddressList comment=AS138524 address=180.183.14.0/24} on-error {}
