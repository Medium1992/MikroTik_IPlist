...
:do {add list=$AddressList comment=AS138590 address=151.123.156.0/24} on-error {}
:do {add list=$AddressList comment=AS138590 address=151.123.159.0/24} on-error {}
:do {add list=$AddressList comment=AS138590 address=160.191.208.0/23} on-error {}
:do {add list=$AddressList comment=AS138590 address=163.128.8.0/23} on-error {}
...
:do {add list=$AddressList comment=AS138590 address=45.194.88.0/23} on-error {}
