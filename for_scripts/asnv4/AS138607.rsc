...
:do {add list=$AddressList comment=AS138607 address=for_scripts/asnv4/AS138607.rsc} on-error {}
:do {add list=$AddressList comment=AS138607 address=103.134.140.0/23} on-error {}
:do {add list=$AddressList comment=AS138607 address=103.134.142.0/24} on-error {}
