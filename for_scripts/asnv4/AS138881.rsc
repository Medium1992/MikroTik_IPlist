...
:do {add list=$AddressList comment=AS138881 address=for_scripts/asnv4/AS138881.rsc} on-error {}
...
:do {add list=$AddressList comment=AS138881 address=103.52.60.0/24} on-error {}
