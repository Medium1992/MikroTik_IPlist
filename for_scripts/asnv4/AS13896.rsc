...
:do {add list=$AddressList comment=AS13896 address=162.223.96.0/22} on-error {}
...
:do {add list=$AddressList comment=AS13896 address=206.81.176.0/22} on-error {}
...
:do {add list=$AddressList comment=AS13896 address=209.94.74.0/23} on-error {}
