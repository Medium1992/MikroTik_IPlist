...
:if ([:len [find where list=$AddressList and address=103.252.32.0/24]] = 0) do={ add list=$AddressList comment=AS138965 address=103.252.32.0/24 }
...
:if ([:len [find where list=$AddressList and address=103.36.17.0/24]] = 0) do={ add list=$AddressList comment=AS138965 address=103.36.17.0/24 }
