...
:do {add list=$AddressList comment=AS13900 address=159.26.229.0/24} on-error {}
:do {add list=$AddressList comment=AS13900 address=159.26.230.0/23} on-error {}
...
:do {add list=$AddressList comment=AS13900 address=159.26.246.0/23} on-error {}
