...
:do {add list=$AddressList comment=AS139203 address=106.108.56.0/21} on-error {}
:do {add list=$AddressList comment=AS139203 address=106.108.72.0/21} on-error {}
:do {add list=$AddressList comment=AS139203 address=106.108.88.0/21} on-error {}
...
:do {add list=$AddressList comment=AS139203 address=111.124.144.0/24} on-error {}
