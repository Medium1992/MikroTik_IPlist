...
:do {add list=$AddressList comment=AS139390 address=for_scripts/asnv4/AS139390.rsc} on-error {}
:do {add list=$AddressList comment=AS139390 address=103.143.62.0/23} on-error {}
:do {add list=$AddressList comment=AS139390 address=204.157.164.0/24} on-error {}
