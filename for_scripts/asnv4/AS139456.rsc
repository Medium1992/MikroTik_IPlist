...
:do {add list=$AddressList comment=AS139456 address=103.152.242.0/23} on-error {}
...
:do {add list=$AddressList comment=AS139456 address=103.185.38.0/23} on-error {}
:do {add list=$AddressList comment=AS139456 address=103.185.44.0/23} on-error {}
