...
:do {add list=$AddressList comment=AS139456 address=for_scripts/asnv4/AS139456.rsc} on-error {}
:do {add list=$AddressList comment=AS139456 address=103.145.226.0/24} on-error {}
