...
:if ([:len [find where list=$AddressList and address=130.117.183.0/24]] = 0) do={ add list=$AddressList comment=AS139482 address=130.117.183.0/24 }
:if ([:len [find where list=$AddressList and address=149.7.156.0/23]] = 0) do={ add list=$AddressList comment=AS139482 address=149.7.156.0/23 }
