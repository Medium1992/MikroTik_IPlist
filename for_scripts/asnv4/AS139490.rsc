...
:do {add list=$AddressList comment=AS139490 address=for_scripts/asnv4/AS139490.rsc} on-error {}
...
:do {add list=$AddressList comment=AS139490 address=103.171.76.0/24} on-error {}
...
:do {add list=$AddressList comment=AS139490 address=14.192.13.0/24} on-error {}
:do {add list=$AddressList comment=AS139490 address=14.192.14.0/23} on-error {}
