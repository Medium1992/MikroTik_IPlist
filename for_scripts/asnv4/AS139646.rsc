...
:if ([:len [find where list=$AddressList and address=156.240.0.0/23]] = 0) do={ add list=$AddressList comment=AS139646 address=156.240.0.0/23 }
:if ([:len [find where list=$AddressList and address=156.240.16.0/20]] = 0) do={ add list=$AddressList comment=AS139646 address=156.240.16.0/20 }
:if ([:len [find where list=$AddressList and address=156.240.2.0/24]] = 0) do={ add list=$AddressList comment=AS139646 address=156.240.2.0/24 }
...
:if ([:len [find where list=$AddressList and address=156.240.4.0/22]] = 0) do={ add list=$AddressList comment=AS139646 address=156.240.4.0/22 }
...
:if ([:len [find where list=$AddressList and address=156.240.8.0/21]] = 0) do={ add list=$AddressList comment=AS139646 address=156.240.8.0/21 }
...
:if ([:len [find where list=$AddressList and address=45.200.14.0/23]] = 0) do={ add list=$AddressList comment=AS139646 address=45.200.14.0/23 }
:if ([:len [find where list=$AddressList and address=45.200.18.0/23]] = 0) do={ add list=$AddressList comment=AS139646 address=45.200.18.0/23 }
