...
:do {add list=$AddressList comment=AS139820 address=for_scripts/asnv4/AS139820.rsc} on-error {}
...
:do {add list=$AddressList comment=AS139820 address=59.103.44.0/23} on-error {}
:do {add list=$AddressList comment=AS139820 address=59.103.47.0/24} on-error {}
