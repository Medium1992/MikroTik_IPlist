...
:do {add list=$AddressList comment=AS139879 address=110.38.240.0/21} on-error {}
:do {add list=$AddressList comment=AS139879 address=110.38.248.0/24} on-error {}
:do {add list=$AddressList comment=AS139879 address=110.38.250.0/23} on-error {}
:do {add list=$AddressList comment=AS139879 address=110.38.252.0/22} on-error {}
