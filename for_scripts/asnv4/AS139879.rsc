...
:if ([:len [find where list=$AddressList and address=110.38.240.0/23]] = 0) do={ add list=$AddressList comment=AS139879 address=110.38.240.0/23 }
:if ([:len [find where list=$AddressList and address=110.38.243.0/24]] = 0) do={ add list=$AddressList comment=AS139879 address=110.38.243.0/24 }
:if ([:len [find where list=$AddressList and address=110.38.244.0/22]] = 0) do={ add list=$AddressList comment=AS139879 address=110.38.244.0/22 }
:if ([:len [find where list=$AddressList and address=110.38.248.0/21]] = 0) do={ add list=$AddressList comment=AS139879 address=110.38.248.0/21 }
