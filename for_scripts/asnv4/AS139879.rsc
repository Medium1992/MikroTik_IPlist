...
:do {add list=$AddressList comment=AS139879 address=110.38.240.0/23} on-error {}
:do {add list=$AddressList comment=AS139879 address=110.38.243.0/24} on-error {}
...
:do {add list=$AddressList comment=AS139879 address=14.192.137.0/24} on-error {}
:do {add list=$AddressList comment=AS139879 address=157.10.30.0/23} on-error {}
