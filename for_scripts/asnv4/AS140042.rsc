...
:do {add list=$AddressList comment=AS140042 address=104.251.224.0/22} on-error {}
:do {add list=$AddressList comment=AS140042 address=104.251.228.0/23} on-error {}
:do {add list=$AddressList comment=AS140042 address=104.251.230.0/24} on-error {}
...
:do {add list=$AddressList comment=AS140042 address=172.81.103.0/24} on-error {}
...
:do {add list=$AddressList comment=AS140042 address=177.0.132.0/23} on-error {}
