...
:do {add list=$AddressList comment=AS140042 address=for_scripts/asnv4/AS140042.rsc} on-error {}
...
:do {add list=$AddressList comment=AS140042 address=172.81.110.0/24} on-error {}
