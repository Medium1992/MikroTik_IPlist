...
:do {add list=$AddressList comment=AS140096 address=for_scripts/asnv4/AS140096.rsc} on-error {}
...
:do {add list=$AddressList comment=AS140096 address=103.186.142.0/24} on-error {}
:do {add list=$AddressList comment=AS140096 address=103.200.112.0/23} on-error {}
:do {add list=$AddressList comment=AS140096 address=103.55.4.0/23} on-error {}
:do {add list=$AddressList comment=AS140096 address=124.108.20.0/23} on-error {}
