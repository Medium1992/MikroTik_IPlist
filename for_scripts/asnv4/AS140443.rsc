...
:if ([:len [find where list=$AddressList and address=38.47.188.0/23]] = 0) do={ add list=$AddressList comment=AS140443 address=38.47.188.0/23 }
:if ([:len [find where list=$AddressList and address=38.47.191.0/24]] = 0) do={ add list=$AddressList comment=AS140443 address=38.47.191.0/24 }
