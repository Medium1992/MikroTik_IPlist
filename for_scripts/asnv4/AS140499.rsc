...
:do {add list=$AddressList comment=AS140499 address=for_scripts/asnv4/AS140499.rsc} on-error {}
...
:do {add list=$AddressList comment=AS140499 address=111.92.155.0/24} on-error {}
