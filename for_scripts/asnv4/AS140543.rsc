...
:do {add list=$AddressList comment=AS140543 address=103.110.39.0/24} on-error {}
...
:do {add list=$AddressList comment=AS140543 address=151.243.168.0/24} on-error {}
:do {add list=$AddressList comment=AS140543 address=165.140.164.0/23} on-error {}
:do {add list=$AddressList comment=AS140543 address=170.205.54.0/24} on-error {}
:do {add list=$AddressList comment=AS140543 address=193.25.253.0/24} on-error {}
