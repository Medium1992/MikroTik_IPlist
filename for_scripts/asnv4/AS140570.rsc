...
:do {add list=$AddressList comment=AS140570 address=for_scripts/asnv4/AS140570.rsc} on-error {}
...
:do {add list=$AddressList comment=AS140570 address=156.230.6.0/23} on-error {}
:do {add list=$AddressList comment=AS140570 address=203.168.224.0/24} on-error {}
:do {add list=$AddressList comment=AS140570 address=203.168.226.0/23} on-error {}
...
:do {add list=$AddressList comment=AS140570 address=38.150.74.0/24} on-error {}
:do {add list=$AddressList comment=AS140570 address=38.150.78.0/24} on-error {}
:do {add list=$AddressList comment=AS140570 address=38.47.62.0/24} on-error {}
