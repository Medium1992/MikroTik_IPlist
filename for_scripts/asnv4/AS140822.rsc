...
:if ([:len [find where list=$AddressList and address=161.248.182.0/23]] = 0) do={ add list=$AddressList comment=AS140822 address=161.248.182.0/23 }
:if ([:len [find where list=$AddressList and address=161.248.236.0/23]] = 0) do={ add list=$AddressList comment=AS140822 address=161.248.236.0/23 }
:if ([:len [find where list=$AddressList and address=161.248.34.0/23]] = 0) do={ add list=$AddressList comment=AS140822 address=161.248.34.0/23 }
:if ([:len [find where list=$AddressList and address=161.248.72.0/23]] = 0) do={ add list=$AddressList comment=AS140822 address=161.248.72.0/23 }
:if ([:len [find where list=$AddressList and address=161.248.76.0/23]] = 0) do={ add list=$AddressList comment=AS140822 address=161.248.76.0/23 }
