...
:do {add list=$AddressList comment=AS140869 address=for_scripts/asnv4/AS140869.rsc} on-error {}
...
:do {add list=$AddressList comment=AS140869 address=117.120.192.0/20} on-error {}
:do {add list=$AddressList comment=AS140869 address=117.120.208.0/21} on-error {}
:do {add list=$AddressList comment=AS140869 address=117.120.216.0/22} on-error {}
