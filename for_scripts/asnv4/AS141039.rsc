...
:do {add list=$AddressList comment=AS141039 address=186.247.172.0/23} on-error {}
:do {add list=$AddressList comment=AS141039 address=186.247.174.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.13.181.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.13.182.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.13.206.0/23} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.13.208.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.13.31.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.115.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.224.0/23} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.230.0/23} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.237.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.238.0/23} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.253.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.254.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.55.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.14.56.0/24} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.15.174.0/23} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.15.80.0/23} on-error {}
:do {add list=$AddressList comment=AS141039 address=187.15.82.0/24} on-error {}
