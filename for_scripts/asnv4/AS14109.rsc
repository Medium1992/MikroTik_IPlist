...
:do {add list=$AddressList comment=AS14109 address=for_scripts/asnv4/AS14109.rsc} on-error {}
...
:do {add list=$AddressList comment=AS14109 address=8.38.252.0/24} on-error {}
