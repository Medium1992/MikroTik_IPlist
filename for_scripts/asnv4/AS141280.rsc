...
:if ([:len [find where list=$AddressList and address=160.30.84.0/24]] = 0) do={ add list=$AddressList comment=AS141280 address=160.30.84.0/24 }
...
:if ([:len [find where list=$AddressList and address=198.15.24.0/24]] = 0) do={ add list=$AddressList comment=AS141280 address=198.15.24.0/24 }
