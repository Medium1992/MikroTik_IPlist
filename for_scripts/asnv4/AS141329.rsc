...
:do {add list=$AddressList comment=AS141329 address=103.172.84.0/24} on-error {}
...
:do {add list=$AddressList comment=AS141329 address=103.200.74.0/23} on-error {}
:do {add list=$AddressList comment=AS141329 address=103.210.0.0/24} on-error {}
...
:do {add list=$AddressList comment=AS141329 address=38.224.125.0/24} on-error {}
