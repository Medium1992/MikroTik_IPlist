...
:if ([:len [find where list=$AddressList and address=103.12.120.0/23]] = 0) do={ add list=$AddressList comment=AS141711 address=103.12.120.0/23 }
:if ([:len [find where list=$AddressList and address=103.12.122.0/24]] = 0) do={ add list=$AddressList comment=AS141711 address=103.12.122.0/24 }
...
:if ([:len [find where list=$AddressList and address=113.203.202.0/23]] = 0) do={ add list=$AddressList comment=AS141711 address=113.203.202.0/23 }
