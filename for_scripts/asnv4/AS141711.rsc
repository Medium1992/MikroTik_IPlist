...
:if ([:len [find where list=$AddressList and address=43.246.224.0/23]] = 0) do={ add list=$AddressList comment=AS141711 address=43.246.224.0/23 }
:if ([:len [find where list=$AddressList and address=43.246.227.0/24]] = 0) do={ add list=$AddressList comment=AS141711 address=43.246.227.0/24 }
