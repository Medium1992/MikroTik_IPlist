...
:do {add list=$AddressList comment=AS141968 address=162.4.17.0/24} on-error {}
:do {add list=$AddressList comment=AS141968 address=178.248.73.0/24} on-error {}
:do {add list=$AddressList comment=AS141968 address=185.205.222.0/24} on-error {}
...
:do {add list=$AddressList comment=AS141968 address=45.198.36.0/22} on-error {}
