...
:do {add list=$AddressList comment=AS142002 address=103.43.87.0/24} on-error {}
:do {add list=$AddressList comment=AS142002 address=134.168.240.0/24} on-error {}
:do {add list=$AddressList comment=AS142002 address=134.168.242.0/23} on-error {}
:do {add list=$AddressList comment=AS142002 address=134.168.244.0/24} on-error {}
:do {add list=$AddressList comment=AS142002 address=139.5.108.0/22} on-error {}
