...
:do {add list=$AddressList comment=AS142002 address=for_scripts/asnv4/AS142002.rsc} on-error {}
...
:do {add list=$AddressList comment=AS142002 address=154.198.162.0/24} on-error {}
