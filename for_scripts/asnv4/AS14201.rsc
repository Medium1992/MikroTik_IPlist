...
:do {add list=$AddressList comment=AS14201 address=for_scripts/asnv4/AS14201.rsc} on-error {}
...
:do {add list=$AddressList comment=AS14201 address=170.65.150.0/24} on-error {}
:do {add list=$AddressList comment=AS14201 address=170.65.160.0/24} on-error {}
:do {add list=$AddressList comment=AS14201 address=170.65.170.0/24} on-error {}
:do {add list=$AddressList comment=AS14201 address=170.65.172.0/22} on-error {}
:do {add list=$AddressList comment=AS14201 address=170.65.217.0/24} on-error {}
:do {add list=$AddressList comment=AS14201 address=170.65.218.0/24} on-error {}
