...
:do {add list=$AddressList comment=AS142382 address=151.244.229.0/24} on-error {}
:do {add list=$AddressList comment=AS142382 address=151.244.230.0/24} on-error {}
:do {add list=$AddressList comment=AS142382 address=151.244.238.0/23} on-error {}
