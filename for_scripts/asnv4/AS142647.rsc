...
:do {add list=$AddressList comment=AS142647 address=for_scripts/asnv4/AS142647.rsc} on-error {}
...
:do {add list=$AddressList comment=AS142647 address=165.101.118.0/24} on-error {}
