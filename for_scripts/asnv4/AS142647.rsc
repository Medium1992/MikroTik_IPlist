...
:if ([:len [find where list=$AddressList and address=151.158.47.0/24]] = 0) do={ add list=$AddressList comment=AS142647 address=151.158.47.0/24 }
:if ([:len [find where list=$AddressList and address=160.30.142.0/24]] = 0) do={ add list=$AddressList comment=AS142647 address=160.30.142.0/24 }
