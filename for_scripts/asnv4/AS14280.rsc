...
:do {add list=$AddressList comment=AS14280 address=64.40.112.0/21} on-error {}
:do {add list=$AddressList comment=AS14280 address=64.40.120.0/22} on-error {}
:do {add list=$AddressList comment=AS14280 address=64.40.124.0/23} on-error {}
:do {add list=$AddressList comment=AS14280 address=64.40.127.0/24} on-error {}
