...
:do {add list=$AddressList comment=AS14349 address=for_scripts/asnv4/AS14349.rsc} on-error {}
...
:do {add list=$AddressList comment=AS14349 address=144.73.228.0/23} on-error {}
