...
:do {add list=$AddressList comment=AS14398 address=132.188.104.0/21} on-error {}
:do {add list=$AddressList comment=AS14398 address=132.188.112.0/20} on-error {}
:do {add list=$AddressList comment=AS14398 address=132.188.128.0/22} on-error {}
:do {add list=$AddressList comment=AS14398 address=132.188.16.0/23} on-error {}
