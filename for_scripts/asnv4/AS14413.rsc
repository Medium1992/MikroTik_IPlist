...
:do {add list=$AddressList comment=AS14413 address=for_scripts/asnv4/AS14413.rsc} on-error {}
...
:do {add list=$AddressList comment=AS14413 address=108.174.12.0/23} on-error {}
