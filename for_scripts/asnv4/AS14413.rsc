...
:do {add list=$AddressList comment=AS14413 address=108.174.10.0/23} on-error {}
...
:do {add list=$AddressList comment=AS14413 address=144.2.178.0/23} on-error {}
...
:do {add list=$AddressList comment=AS14413 address=144.2.9.0/24} on-error {}
:do {add list=$AddressList comment=AS14413 address=216.200.149.0/24} on-error {}
