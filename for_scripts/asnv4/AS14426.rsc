...
:do {add list=$AddressList comment=AS14426 address=192.139.26.0/24} on-error {}
:do {add list=$AddressList comment=AS14426 address=192.139.29.0/24} on-error {}
...
:do {add list=$AddressList comment=AS14426 address=204.209.22.0/23} on-error {}
