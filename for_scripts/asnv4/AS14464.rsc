...
:do {add list=$AddressList comment=AS14464 address=131.109.0.0/20} on-error {}
...
:do {add list=$AddressList comment=AS14464 address=131.109.16.0/21} on-error {}
...
:do {add list=$AddressList comment=AS14464 address=131.109.24.0/22} on-error {}
:do {add list=$AddressList comment=AS14464 address=131.109.28.0/23} on-error {}
:do {add list=$AddressList comment=AS14464 address=131.109.31.0/24} on-error {}
