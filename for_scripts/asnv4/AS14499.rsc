...
:if ([:len [find where list=$AddressList and address=208.90.64.0/24]] = 0) do={ add list=$AddressList comment=AS14499 address=208.90.64.0/24 }
...
:if ([:len [find where list=$AddressList and address=222.127.141.0/24]] = 0) do={ add list=$AddressList comment=AS14499 address=222.127.141.0/24 }
