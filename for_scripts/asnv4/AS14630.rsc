...
:do {add list=$AddressList comment=AS14630 address=205.174.0.0/22} on-error {}
:do {add list=$AddressList comment=AS14630 address=205.174.4.0/23} on-error {}
:do {add list=$AddressList comment=AS14630 address=205.174.6.0/24} on-error {}
:do {add list=$AddressList comment=AS14630 address=205.174.8.0/23} on-error {}
