...
:do {add list=$AddressList comment=AS146834 address=103.139.136.0/23} on-error {}
:do {add list=$AddressList comment=AS146834 address=116.199.156.0/22} on-error {}
...
:do {add list=$AddressList comment=AS146834 address=202.165.208.0/21} on-error {}
