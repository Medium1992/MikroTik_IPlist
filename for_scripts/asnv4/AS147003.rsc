...
:do {add list=$AddressList comment=AS147003 address=for_scripts/asnv4/AS147003.rsc} on-error {}
:do {add list=$AddressList comment=AS147003 address=103.97.200.0/23} on-error {}
