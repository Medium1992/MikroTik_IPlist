...
:do {add list=$AddressList comment=AS147019 address=38.47.144.0/21} on-error {}
:do {add list=$AddressList comment=AS147019 address=38.47.154.0/23} on-error {}
:do {add list=$AddressList comment=AS147019 address=38.47.158.0/23} on-error {}
