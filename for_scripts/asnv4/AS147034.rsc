...
:if ([:len [find where list=$AddressList and address=205.196.152.0/22]] = 0) do={ add list=$AddressList comment=AS147034 address=205.196.152.0/22 }
:if ([:len [find where list=$AddressList and address=205.196.156.0/23]] = 0) do={ add list=$AddressList comment=AS147034 address=205.196.156.0/23 }
