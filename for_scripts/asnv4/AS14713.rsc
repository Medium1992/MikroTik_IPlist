...
:do {add list=$AddressList comment=AS14713 address=142.202.232.0/24} on-error {}
:do {add list=$AddressList comment=AS14713 address=142.202.234.0/23} on-error {}
...
:do {add list=$AddressList comment=AS14713 address=204.150.247.0/24} on-error {}
