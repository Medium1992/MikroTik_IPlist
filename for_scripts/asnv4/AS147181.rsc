...
:do {add list=$AddressList comment=AS147181 address=for_scripts/asnv4/AS147181.rsc} on-error {}
...
:do {add list=$AddressList comment=AS147181 address=163.223.240.0/23} on-error {}
