...
:if ([:len [find where list=$AddressList and address=103.105.224.0/22]] = 0) do={ add list=$AddressList comment=AS147185 address=103.105.224.0/22 }
...
:if ([:len [find where list=$AddressList and address=103.189.216.0/23]] = 0) do={ add list=$AddressList comment=AS147185 address=103.189.216.0/23 }
