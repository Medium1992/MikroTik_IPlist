...
:if ([:len [find where list=$AddressList and address=103.178.1.0/24]] = 0) do={ add list=$AddressList comment=AS147224 address=103.178.1.0/24 }
:if ([:len [find where list=$AddressList and address=103.207.181.0/24]] = 0) do={ add list=$AddressList comment=AS147224 address=103.207.181.0/24 }
