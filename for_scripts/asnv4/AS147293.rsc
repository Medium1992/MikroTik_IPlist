...
:do {add list=$AddressList comment=AS147293 address=178.214.220.0/24} on-error {}
...
:do {add list=$AddressList comment=AS147293 address=82.22.78.0/24} on-error {}
:do {add list=$AddressList comment=AS147293 address=88.80.139.0/24} on-error {}
