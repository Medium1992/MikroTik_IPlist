...
:do {add list=$AddressList comment=AS147314 address=103.178.221.0/24} on-error {}
...
:do {add list=$AddressList comment=AS147314 address=160.20.116.0/24} on-error {}
:do {add list=$AddressList comment=AS147314 address=165.101.223.0/24} on-error {}
