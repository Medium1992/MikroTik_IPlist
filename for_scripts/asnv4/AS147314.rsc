...
:if ([:len [find where list=$AddressList and address=103.123.32.0/24]] = 0) do={ add list=$AddressList comment=AS147314 address=103.123.32.0/24 }
:if ([:len [find where list=$AddressList and address=103.123.34.0/24]] = 0) do={ add list=$AddressList comment=AS147314 address=103.123.34.0/24 }
...
:if ([:len [find where list=$AddressList and address=103.66.169.0/24]] = 0) do={ add list=$AddressList comment=AS147314 address=103.66.169.0/24 }
...
:if ([:len [find where list=$AddressList and address=160.20.116.0/23]] = 0) do={ add list=$AddressList comment=AS147314 address=160.20.116.0/23 }
