...
:if ([:len [find where list=$AddressList and address=65.19.0.0/24]] = 0) do={ add list=$AddressList comment=AS14818 address=65.19.0.0/24 }
...
:if ([:len [find where list=$AddressList and address=65.19.2.0/23]] = 0) do={ add list=$AddressList comment=AS14818 address=65.19.2.0/23 }
...
:if ([:len [find where list=$AddressList and address=65.19.5.0/24]] = 0) do={ add list=$AddressList comment=AS14818 address=65.19.5.0/24 }
:if ([:len [find where list=$AddressList and address=65.19.6.0/23]] = 0) do={ add list=$AddressList comment=AS14818 address=65.19.6.0/23 }
