...
:do {add list=$AddressList comment=AS14860 address=216.194.178.0/23} on-error {}
:do {add list=$AddressList comment=AS14860 address=216.194.180.0/22} on-error {}
:do {add list=$AddressList comment=AS14860 address=216.194.184.0/22} on-error {}
:do {add list=$AddressList comment=AS14860 address=216.194.188.0/23} on-error {}
:do {add list=$AddressList comment=AS14860 address=216.194.191.0/24} on-error {}
