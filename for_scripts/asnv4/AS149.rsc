...
:do {add list=$AddressList comment=AS149 address=215.69.130.0/23} on-error {}
:do {add list=$AddressList comment=AS149 address=215.69.160.0/23} on-error {}
:do {add list=$AddressList comment=AS149 address=215.69.221.0/24} on-error {}
