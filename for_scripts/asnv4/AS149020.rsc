...
:do {add list=$AddressList comment=AS149020 address=for_scripts/asnv4/AS149020.rsc} on-error {}
...
:do {add list=$AddressList comment=AS149020 address=160.30.84.0/24} on-error {}
