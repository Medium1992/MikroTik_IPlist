...
:if ([:len [find where list=$AddressList and address=103.212.160.0/24]] = 0) do={ add list=$AddressList comment=AS149173 address=103.212.160.0/24 }
:if ([:len [find where list=$AddressList and address=103.53.25.0/24]] = 0) do={ add list=$AddressList comment=AS149173 address=103.53.25.0/24 }
