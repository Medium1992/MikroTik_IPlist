...
:do {add list=$AddressList comment=AS149240 address=103.184.236.0/24} on-error {}
:do {add list=$AddressList comment=AS149240 address=103.82.96.0/24} on-error {}
:do {add list=$AddressList comment=AS149240 address=103.88.56.0/23} on-error {}
:do {add list=$AddressList comment=AS149240 address=160.187.48.0/24} on-error {}
