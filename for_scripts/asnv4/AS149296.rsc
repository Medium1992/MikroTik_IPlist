...
:do {add list=$AddressList comment=AS149296 address=for_scripts/asnv4/AS149296.rsc} on-error {}
...
:do {add list=$AddressList comment=AS149296 address=43.255.52.0/22} on-error {}
