...
:do {add list=$AddressList comment=AS149457 address=185.142.29.0/24} on-error {}
...
:do {add list=$AddressList comment=AS149457 address=194.150.74.0/24} on-error {}
...
:do {add list=$AddressList comment=AS149457 address=45.157.37.0/24} on-error {}
