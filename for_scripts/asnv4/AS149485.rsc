...
:do {add list=$AddressList comment=AS149485 address=for_scripts/asnv4/AS149485.rsc} on-error {}
...
:do {add list=$AddressList comment=AS149485 address=45.138.210.0/24} on-error {}
