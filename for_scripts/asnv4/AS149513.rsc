...
:if ([:len [find where list=$AddressList and address=144.225.255.0/24]] = 0) do={ add list=$AddressList comment=AS149513 address=144.225.255.0/24 }
:if ([:len [find where list=$AddressList and address=206.109.68.0/24]] = 0) do={ add list=$AddressList comment=AS149513 address=206.109.68.0/24 }
