...
:do {add list=$AddressList comment=AS149535 address=for_scripts/asnv4/AS149535.rsc} on-error {}
:do {add list=$AddressList comment=AS149535 address=103.103.90.0/23} on-error {}
