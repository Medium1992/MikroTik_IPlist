...
:if ([:len [find where list=$AddressList and address=103.187.86.0/24]] = 0) do={ add list=$AddressList comment=AS149718 address=103.187.86.0/24 }
...
:if ([:len [find where list=$AddressList and address=38.191.122.0/24]] = 0) do={ add list=$AddressList comment=AS149718 address=38.191.122.0/24 }
