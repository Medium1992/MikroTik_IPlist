...
:do {add list=$AddressList comment=AS149746 address=116.254.115.0/24} on-error {}
:do {add list=$AddressList comment=AS149746 address=119.2.48.0/23} on-error {}
...
:do {add list=$AddressList comment=AS149746 address=43.252.156.0/22} on-error {}
