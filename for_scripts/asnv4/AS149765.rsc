...
:do {add list=$AddressList comment=AS149765 address=103.159.128.0/24} on-error {}
...
:do {add list=$AddressList comment=AS149765 address=157.15.121.0/24} on-error {}
:do {add list=$AddressList comment=AS149765 address=220.152.114.0/24} on-error {}
