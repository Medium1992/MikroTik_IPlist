...
:if ([:len [find where list=$AddressList and address=153.60.128.0/23]] = 0) do={ add list=$AddressList comment=AS149877 address=153.60.128.0/23 }
:if ([:len [find where list=$AddressList and address=153.60.188.0/22]] = 0) do={ add list=$AddressList comment=AS149877 address=153.60.188.0/22 }
