...
:do {add list=$AddressList comment=AS149946 address=for_scripts/asnv4/AS149946.rsc} on-error {}
...
:do {add list=$AddressList comment=AS149946 address=117.102.160.0/23} on-error {}
