...
:do {add list=$AddressList comment=AS150027 address=for_scripts/asnv4/AS150027.rsc} on-error {}
:do {add list=$AddressList comment=AS150027 address=103.120.248.0/23} on-error {}
:do {add list=$AddressList comment=AS150027 address=103.120.251.0/24} on-error {}
:do {add list=$AddressList comment=AS150027 address=103.131.92.0/24} on-error {}
:do {add list=$AddressList comment=AS150027 address=103.150.138.0/23} on-error {}
...
:do {add list=$AddressList comment=AS150027 address=103.17.156.0/23} on-error {}
:do {add list=$AddressList comment=AS150027 address=103.175.116.0/23} on-error {}
:do {add list=$AddressList comment=AS150027 address=103.185.10.0/24} on-error {}
...
:do {add list=$AddressList comment=AS150027 address=103.26.224.0/24} on-error {}
...
:do {add list=$AddressList comment=AS150027 address=150.107.25.0/24} on-error {}
:do {add list=$AddressList comment=AS150027 address=150.107.26.0/24} on-error {}
:do {add list=$AddressList comment=AS150027 address=157.119.87.0/24} on-error {}
:do {add list=$AddressList comment=AS150027 address=163.61.99.0/24} on-error {}
