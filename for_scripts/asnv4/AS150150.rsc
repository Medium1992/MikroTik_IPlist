...
:do {add list=$AddressList comment=AS150150 address=206.238.226.0/24} on-error {}
:do {add list=$AddressList comment=AS150150 address=38.110.230.0/23} on-error {}
:do {add list=$AddressList comment=AS150150 address=38.123.160.0/24} on-error {}
:do {add list=$AddressList comment=AS150150 address=38.67.211.0/24} on-error {}
