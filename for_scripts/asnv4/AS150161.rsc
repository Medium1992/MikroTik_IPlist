...
:do {add list=$AddressList comment=AS150161 address=38.175.16.0/21} on-error {}
:do {add list=$AddressList comment=AS150161 address=38.175.24.0/22} on-error {}
:do {add list=$AddressList comment=AS150161 address=38.175.28.0/23} on-error {}
