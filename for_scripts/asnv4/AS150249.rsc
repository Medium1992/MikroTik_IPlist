...
:do {add list=$AddressList comment=AS150249 address=for_scripts/asnv4/AS150249.rsc} on-error {}
...
:do {add list=$AddressList comment=AS150249 address=151.242.24.0/24} on-error {}
