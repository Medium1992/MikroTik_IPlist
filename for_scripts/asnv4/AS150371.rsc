...
:do {add list=$AddressList comment=AS150371 address=for_scripts/asnv4/AS150371.rsc} on-error {}
...
:do {add list=$AddressList comment=AS150371 address=163.61.129.0/24} on-error {}
