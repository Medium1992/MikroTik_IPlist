...
:if ([:len [find where list=$AddressList and address=63.246.48.0/22]] = 0) do={ add list=$AddressList comment=AS15054 address=63.246.48.0/22 }
:if ([:len [find where list=$AddressList and address=63.246.54.0/23]] = 0) do={ add list=$AddressList comment=AS15054 address=63.246.54.0/23 }
:if ([:len [find where list=$AddressList and address=63.246.56.0/21]] = 0) do={ add list=$AddressList comment=AS15054 address=63.246.56.0/21 }
