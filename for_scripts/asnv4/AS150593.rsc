...
:do {add list=$AddressList comment=AS150593 address=for_scripts/asnv4/AS150593.rsc} on-error {}
...
:do {add list=$AddressList comment=AS150593 address=103.182.113.0/24} on-error {}
:do {add list=$AddressList comment=AS150593 address=103.85.180.0/23} on-error {}
:do {add list=$AddressList comment=AS150593 address=160.19.35.0/24} on-error {}
