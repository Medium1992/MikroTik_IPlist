...
:do {add list=$AddressList comment=AS150596 address=103.110.16.0/24} on-error {}
:do {add list=$AddressList comment=AS150596 address=103.110.18.0/23} on-error {}
:do {add list=$AddressList comment=AS150596 address=103.110.181.0/24} on-error {}
