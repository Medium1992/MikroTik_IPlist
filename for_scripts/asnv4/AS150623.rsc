...
:do {add list=$AddressList comment=AS150623 address=for_scripts/asnv4/AS150623.rsc} on-error {}
...
:do {add list=$AddressList comment=AS150623 address=103.243.118.0/24} on-error {}
