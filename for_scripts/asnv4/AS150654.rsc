...
:if ([:len [find where list=$AddressList and address=38.225.204.0/23]] = 0) do={ add list=$AddressList comment=AS150654 address=38.225.204.0/23 }
:if ([:len [find where list=$AddressList and address=38.225.206.0/24]] = 0) do={ add list=$AddressList comment=AS150654 address=38.225.206.0/24 }
