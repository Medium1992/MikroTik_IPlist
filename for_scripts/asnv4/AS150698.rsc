...
:do {add list=$AddressList comment=AS150698 address=for_scripts/asnv4/AS150698.rsc} on-error {}
...
:do {add list=$AddressList comment=AS150698 address=154.196.92.0/22} on-error {}
:do {add list=$AddressList comment=AS150698 address=154.197.119.0/24} on-error {}
:do {add list=$AddressList comment=AS150698 address=154.197.72.0/23} on-error {}
...
:do {add list=$AddressList comment=AS150698 address=23.155.184.0/24} on-error {}
