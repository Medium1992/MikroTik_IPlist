...
:if ([:len [find where list=$AddressList and address=103.155.224.0/23]] = 0) do={ add list=$AddressList comment=AS151000 address=103.155.224.0/23 }
...
:if ([:len [find where list=$AddressList and address=103.190.0.0/23]] = 0) do={ add list=$AddressList comment=AS151000 address=103.190.0.0/23 }
