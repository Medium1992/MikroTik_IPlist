...
:do {add list=$AddressList comment=AS151133 address=for_scripts/asnv4/AS151133.rsc} on-error {}
:do {add list=$AddressList comment=AS151133 address=157.15.176.0/23} on-error {}
:do {add list=$AddressList comment=AS151133 address=160.191.184.0/23} on-error {}
