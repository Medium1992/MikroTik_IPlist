...
:if ([:len [find where list=$AddressList and address=209.163.64.0/22]] = 0) do={ add list=$AddressList comment=AS15128 address=209.163.64.0/22 }
:if ([:len [find where list=$AddressList and address=209.163.68.0/24]] = 0) do={ add list=$AddressList comment=AS15128 address=209.163.68.0/24 }
:if ([:len [find where list=$AddressList and address=209.163.70.0/23]] = 0) do={ add list=$AddressList comment=AS15128 address=209.163.70.0/23 }
:if ([:len [find where list=$AddressList and address=209.163.72.0/21]] = 0) do={ add list=$AddressList comment=AS15128 address=209.163.72.0/21 }
:if ([:len [find where list=$AddressList and address=209.163.80.0/20]] = 0) do={ add list=$AddressList comment=AS15128 address=209.163.80.0/20 }
