...
:if ([:len [find where list=$AddressList and address=103.49.61.0/24]] = 0) do={ add list=$AddressList comment=AS151338 address=103.49.61.0/24 }
...
:if ([:len [find where list=$AddressList and address=141.11.238.0/23]] = 0) do={ add list=$AddressList comment=AS151338 address=141.11.238.0/23 }
...
:if ([:len [find where list=$AddressList and address=212.60.156.0/24]] = 0) do={ add list=$AddressList comment=AS151338 address=212.60.156.0/24 }
:if ([:len [find where list=$AddressList and address=212.60.158.0/24]] = 0) do={ add list=$AddressList comment=AS151338 address=212.60.158.0/24 }
...
:if ([:len [find where list=$AddressList and address=82.139.224.0/23]] = 0) do={ add list=$AddressList comment=AS151338 address=82.139.224.0/23 }
