...
:do {add list=$AddressList comment=AS151397 address=193.119.0.0/24} on-error {}
...
:do {add list=$AddressList comment=AS151397 address=193.119.6.0/23} on-error {}
:do {add list=$AddressList comment=AS151397 address=193.119.8.0/22} on-error {}
