...
:do {add list=$AddressList comment=AS15149 address=for_scripts/asnv4/AS15149.rsc} on-error {}
...
:do {add list=$AddressList comment=AS15149 address=216.169.115.0/24} on-error {}
