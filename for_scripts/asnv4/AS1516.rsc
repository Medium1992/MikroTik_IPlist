...
:do {add list=$AddressList comment=AS1516 address=150.149.0.0/24} on-error {}
:do {add list=$AddressList comment=AS1516 address=150.149.16.0/20} on-error {}
:do {add list=$AddressList comment=AS1516 address=150.149.2.0/23} on-error {}
:do {add list=$AddressList comment=AS1516 address=150.149.4.0/22} on-error {}
:do {add list=$AddressList comment=AS1516 address=150.149.8.0/21} on-error {}
