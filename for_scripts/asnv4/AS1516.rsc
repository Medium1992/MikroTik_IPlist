...
:do {add list=$AddressList comment=AS1516 address=143.74.10.0/24} on-error {}
:do {add list=$AddressList comment=AS1516 address=143.74.14.0/24} on-error {}
...
:do {add list=$AddressList comment=AS1516 address=155.20.111.0/24} on-error {}
:do {add list=$AddressList comment=AS1516 address=155.28.0.0/19} on-error {}
:do {add list=$AddressList comment=AS1516 address=155.28.128.0/23} on-error {}
:do {add list=$AddressList comment=AS1516 address=155.28.131.0/24} on-error {}
:do {add list=$AddressList comment=AS1516 address=160.140.88.0/22} on-error {}
:do {add list=$AddressList comment=AS1516 address=160.140.94.0/24} on-error {}
