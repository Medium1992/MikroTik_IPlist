...
:if ([:len [find where list=$AddressList and address=155.28.0.0/23]] = 0) do={ add list=$AddressList comment=AS1516 address=155.28.0.0/23 }
...
:if ([:len [find where list=$AddressList and address=155.28.130.0/24]] = 0) do={ add list=$AddressList comment=AS1516 address=155.28.130.0/24 }
:if ([:len [find where list=$AddressList and address=155.28.16.0/20]] = 0) do={ add list=$AddressList comment=AS1516 address=155.28.16.0/20 }
:if ([:len [find where list=$AddressList and address=155.28.3.0/24]] = 0) do={ add list=$AddressList comment=AS1516 address=155.28.3.0/24 }
:if ([:len [find where list=$AddressList and address=155.28.4.0/22]] = 0) do={ add list=$AddressList comment=AS1516 address=155.28.4.0/22 }
:if ([:len [find where list=$AddressList and address=155.28.8.0/21]] = 0) do={ add list=$AddressList comment=AS1516 address=155.28.8.0/21 }
