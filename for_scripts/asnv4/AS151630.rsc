...
:do {add list=$AddressList comment=AS151630 address=38.12.248.0/24} on-error {}
:do {add list=$AddressList comment=AS151630 address=38.12.250.0/23} on-error {}
:do {add list=$AddressList comment=AS151630 address=38.12.252.0/23} on-error {}
:do {add list=$AddressList comment=AS151630 address=38.12.254.0/24} on-error {}
