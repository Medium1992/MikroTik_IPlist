...
:if ([:len [find where list=$AddressList and address=38.12.248.0/24]] = 0) do={ add list=$AddressList comment=AS151630 address=38.12.248.0/24 }
:if ([:len [find where list=$AddressList and address=38.12.250.0/23]] = 0) do={ add list=$AddressList comment=AS151630 address=38.12.250.0/23 }
:if ([:len [find where list=$AddressList and address=38.12.252.0/22]] = 0) do={ add list=$AddressList comment=AS151630 address=38.12.252.0/22 }
