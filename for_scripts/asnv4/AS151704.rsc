...
:if ([:len [find where list=$AddressList and address=103.243.119.0/24]] = 0) do={ add list=$AddressList comment=AS151704 address=103.243.119.0/24 }
:if ([:len [find where list=$AddressList and address=103.72.102.0/24]] = 0) do={ add list=$AddressList comment=AS151704 address=103.72.102.0/24 }
...
:if ([:len [find where list=$AddressList and address=151.247.13.0/24]] = 0) do={ add list=$AddressList comment=AS151704 address=151.247.13.0/24 }
...
:if ([:len [find where list=$AddressList and address=191.44.86.0/24]] = 0) do={ add list=$AddressList comment=AS151704 address=191.44.86.0/24 }
...
:if ([:len [find where list=$AddressList and address=85.239.154.0/24]] = 0) do={ add list=$AddressList comment=AS151704 address=85.239.154.0/24 }
