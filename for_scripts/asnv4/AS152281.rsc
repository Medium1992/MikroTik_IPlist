...
:if ([:len [find where list=$AddressList and address=101.55.10.0/24]] = 0) do={ add list=$AddressList comment=AS152281 address=101.55.10.0/24 }
:if ([:len [find where list=$AddressList and address=101.55.35.0/24]] = 0) do={ add list=$AddressList comment=AS152281 address=101.55.35.0/24 }
...
:if ([:len [find where list=$AddressList and address=101.55.9.0/24]] = 0) do={ add list=$AddressList comment=AS152281 address=101.55.9.0/24 }
...
:if ([:len [find where list=$AddressList and address=103.7.33.0/24]] = 0) do={ add list=$AddressList comment=AS152281 address=103.7.33.0/24 }
...
:if ([:len [find where list=$AddressList and address=49.128.220.0/24]] = 0) do={ add list=$AddressList comment=AS152281 address=49.128.220.0/24 }
