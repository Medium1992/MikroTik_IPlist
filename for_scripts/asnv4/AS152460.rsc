...
:if ([:len [find where list=$AddressList and address=151.242.145.0/24]] = 0) do={ add list=$AddressList comment=AS152460 address=151.242.145.0/24 }
...
:if ([:len [find where list=$AddressList and address=217.79.112.0/24]] = 0) do={ add list=$AddressList comment=AS152460 address=217.79.112.0/24 }
