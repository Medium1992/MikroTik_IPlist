...
:do {add list=$AddressList comment=AS152475 address=for_scripts/asnv4/AS152475.rsc} on-error {}
...
:do {add list=$AddressList comment=AS152475 address=103.40.9.0/24} on-error {}
