...
:do {add list=$AddressList comment=AS15250 address=for_scripts/asnv4/AS15250.rsc} on-error {}
...
:do {add list=$AddressList comment=AS15250 address=209.173.192.0/23} on-error {}
