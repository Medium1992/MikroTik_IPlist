...
:do {add list=$AddressList comment=AS152699 address=157.85.80.0/21} on-error {}
:do {add list=$AddressList comment=AS152699 address=157.85.88.0/23} on-error {}
:do {add list=$AddressList comment=AS152699 address=157.85.90.0/24} on-error {}
:do {add list=$AddressList comment=AS152699 address=157.85.92.0/22} on-error {}
