...
:do {add list=$AddressList comment=AS153038 address=for_scripts/asnv4/AS153038.rsc} on-error {}
...
:do {add list=$AddressList comment=AS153038 address=103.214.216.0/24} on-error {}
