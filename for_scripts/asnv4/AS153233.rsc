...
:if ([:len [find where list=$AddressList and address=103.109.76.0/24]] = 0) do={ add list=$AddressList comment=AS153233 address=103.109.76.0/24 }
...
:if ([:len [find where list=$AddressList and address=103.151.199.0/24]] = 0) do={ add list=$AddressList comment=AS153233 address=103.151.199.0/24 }
