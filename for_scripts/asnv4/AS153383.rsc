...
:do {add list=$AddressList comment=AS153383 address=82.139.208.0/22} on-error {}
:do {add list=$AddressList comment=AS153383 address=82.139.212.0/23} on-error {}
:do {add list=$AddressList comment=AS153383 address=82.139.240.0/24} on-error {}
:do {add list=$AddressList comment=AS153383 address=82.163.24.0/22} on-error {}
