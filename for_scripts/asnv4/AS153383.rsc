...
:if ([:len [find where list=$AddressList and address=64.69.109.0/24]] = 0) do={ add list=$AddressList comment=AS153383 address=64.69.109.0/24 }
:if ([:len [find where list=$AddressList and address=64.69.110.0/23]] = 0) do={ add list=$AddressList comment=AS153383 address=64.69.110.0/23 }
