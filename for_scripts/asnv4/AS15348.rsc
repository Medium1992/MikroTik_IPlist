...
:do {add list=$AddressList comment=AS15348 address=64.99.208.0/21} on-error {}
...
:do {add list=$AddressList comment=AS15348 address=64.99.89.0/24} on-error {}
:do {add list=$AddressList comment=AS15348 address=64.99.90.0/23} on-error {}
:do {add list=$AddressList comment=AS15348 address=64.99.92.0/22} on-error {}
