...
:do {add list=$AddressList comment=AS153526 address=for_scripts/asnv4/AS153526.rsc} on-error {}
...
:do {add list=$AddressList comment=AS153526 address=209.209.84.0/24} on-error {}
:do {add list=$AddressList comment=AS153526 address=209.209.86.0/24} on-error {}
