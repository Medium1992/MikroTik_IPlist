...
:do {add list=$AddressList comment=AS15364 address=for_scripts/asnv4/AS15364.rsc} on-error {}
:do {add list=$AddressList comment=AS15364 address=192.166.148.0/22} on-error {}
