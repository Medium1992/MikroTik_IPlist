...
:if ([:len [find where list=$AddressList and address=103.72.84.0/22]] = 0) do={ add list=$AddressList comment=AS153844 address=103.72.84.0/22 }
...
:if ([:len [find where list=$AddressList and address=203.11.65.0/24]] = 0) do={ add list=$AddressList comment=AS153844 address=203.11.65.0/24 }
:if ([:len [find where list=$AddressList and address=203.142.218.0/24]] = 0) do={ add list=$AddressList comment=AS153844 address=203.142.218.0/24 }
:if ([:len [find where list=$AddressList and address=203.161.179.0/24]] = 0) do={ add list=$AddressList comment=AS153844 address=203.161.179.0/24 }
:if ([:len [find where list=$AddressList and address=203.3.132.0/24]] = 0) do={ add list=$AddressList comment=AS153844 address=203.3.132.0/24 }
