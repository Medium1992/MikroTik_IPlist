...
:do {add list=$AddressList comment=AS153911 address=43.226.56.0/22} on-error {}
:do {add list=$AddressList comment=AS153911 address=43.226.60.0/24} on-error {}
:do {add list=$AddressList comment=AS153911 address=43.226.63.0/24} on-error {}
