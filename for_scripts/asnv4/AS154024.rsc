...
:do {add list=$AddressList comment=AS154024 address=103.124.208.0/24} on-error {}
:do {add list=$AddressList comment=AS154024 address=103.148.118.0/24} on-error {}
...
:do {add list=$AddressList comment=AS154024 address=151.158.170.0/24} on-error {}
...
:do {add list=$AddressList comment=AS154024 address=202.71.184.0/24} on-error {}
