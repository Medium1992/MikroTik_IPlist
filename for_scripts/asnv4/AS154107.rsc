...
:if ([:len [find where list=$AddressList and address=69.33.210.0/23]] = 0) do={ add list=$AddressList comment=AS154107 address=69.33.210.0/23 }
:if ([:len [find where list=$AddressList and address=69.33.212.0/23]] = 0) do={ add list=$AddressList comment=AS154107 address=69.33.212.0/23 }
