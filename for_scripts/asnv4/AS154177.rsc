...
:do {add list=$AddressList comment=AS154177 address=for_scripts/asnv4/AS154177.rsc} on-error {}
:do {add list=$AddressList comment=AS154177 address=130.94.0.0/19} on-error {}
:do {add list=$AddressList comment=AS154177 address=130.94.100.0/22} on-error {}
...
:do {add list=$AddressList comment=AS154177 address=130.94.36.0/23} on-error {}
...
:do {add list=$AddressList comment=AS154177 address=130.94.72.0/23} on-error {}
:do {add list=$AddressList comment=AS154177 address=130.94.74.0/24} on-error {}
...
:do {add list=$AddressList comment=AS154177 address=130.94.96.0/24} on-error {}
:do {add list=$AddressList comment=AS154177 address=130.94.99.0/24} on-error {}
