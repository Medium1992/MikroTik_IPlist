...
:do {add list=$AddressList comment=AS154177 address=130.94.80.0/23} on-error {}
:do {add list=$AddressList comment=AS154177 address=130.94.83.0/24} on-error {}
:do {add list=$AddressList comment=AS154177 address=130.94.84.0/22} on-error {}
