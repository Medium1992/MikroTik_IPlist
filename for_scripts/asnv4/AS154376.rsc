...
:do {add list=$AddressList comment=AS154376 address=154.193.240.0/21} on-error {}
...
:do {add list=$AddressList comment=AS154376 address=186.244.224.0/21} on-error {}
:do {add list=$AddressList comment=AS154376 address=186.244.232.0/23} on-error {}
:do {add list=$AddressList comment=AS154376 address=186.244.234.0/24} on-error {}
:do {add list=$AddressList comment=AS154376 address=186.244.236.0/22} on-error {}
