...
:do {add list=$AddressList comment=AS15612 address=for_scripts/asnv4/AS15612.rsc} on-error {}
...
:do {add list=$AddressList comment=AS15612 address=212.147.224.0/19} on-error {}
