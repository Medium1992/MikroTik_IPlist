...
:do {add list=$AddressList comment=AS15753 address=for_scripts/asnv4/AS15753.rsc} on-error {}
...
:do {add list=$AddressList comment=AS15753 address=164.63.253.0/24} on-error {}
