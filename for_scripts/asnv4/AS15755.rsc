...
:do {add list=$AddressList comment=AS15755 address=185.203.33.0/24} on-error {}
:do {add list=$AddressList comment=AS15755 address=185.203.34.0/23} on-error {}
...
:do {add list=$AddressList comment=AS15755 address=94.103.38.0/24} on-error {}
