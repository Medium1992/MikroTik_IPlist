...
:if ([:len [find where list=$AddressList and address=87.255.64.0/21]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.64.0/21 }
:if ([:len [find where list=$AddressList and address=87.255.72.0/22]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.72.0/22 }
:if ([:len [find where list=$AddressList and address=87.255.77.0/24]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.77.0/24 }
:if ([:len [find where list=$AddressList and address=87.255.78.0/23]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.78.0/23 }
:if ([:len [find where list=$AddressList and address=87.255.80.0/23]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.80.0/23 }
:if ([:len [find where list=$AddressList and address=87.255.83.0/24]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.83.0/24 }
:if ([:len [find where list=$AddressList and address=87.255.84.0/22]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.84.0/22 }
:if ([:len [find where list=$AddressList and address=87.255.88.0/21]] = 0) do={ add list=$AddressList comment=AS15836 address=87.255.88.0/21 }
