...
:if ([:len [find where list=$AddressList and address=194.46.4.0/22]] = 0) do={ add list=$AddressList comment=AS16032 address=194.46.4.0/22 }
:if ([:len [find where list=$AddressList and address=194.46.8.0/22]] = 0) do={ add list=$AddressList comment=AS16032 address=194.46.8.0/22 }
