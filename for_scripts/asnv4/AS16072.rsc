...
:do {add list=$AddressList comment=AS16072 address=for_scripts/asnv4/AS16072.rsc} on-error {}
...
:do {add list=$AddressList comment=AS16072 address=217.73.40.0/24} on-error {}
