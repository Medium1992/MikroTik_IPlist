...
:do {add list=$AddressList comment=AS16399 address=168.92.0.0/19} on-error {}
:do {add list=$AddressList comment=AS16399 address=168.93.128.0/18} on-error {}
:do {add list=$AddressList comment=AS16399 address=168.93.64.0/18} on-error {}
:do {add list=$AddressList comment=AS16399 address=198.163.183.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16399 address=67.206.64.0/23} on-error {}
:do {add list=$AddressList comment=AS16399 address=67.206.67.0/24} on-error {}
:do {add list=$AddressList comment=AS16399 address=67.206.68.0/22} on-error {}
:do {add list=$AddressList comment=AS16399 address=67.206.72.0/21} on-error {}
:do {add list=$AddressList comment=AS16399 address=67.206.80.0/20} on-error {}
