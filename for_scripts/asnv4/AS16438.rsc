...
:if ([:len [find where list=$AddressList and address=199.58.232.0/23]] = 0) do={ add list=$AddressList comment=AS16438 address=199.58.232.0/23 }
:if ([:len [find where list=$AddressList and address=199.58.237.0/24]] = 0) do={ add list=$AddressList comment=AS16438 address=199.58.237.0/24 }
:if ([:len [find where list=$AddressList and address=199.58.238.0/23]] = 0) do={ add list=$AddressList comment=AS16438 address=199.58.238.0/23 }
