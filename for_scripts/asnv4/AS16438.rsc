...
:if ([:len [find where list=$AddressList and address=204.80.2.0/23]] = 0) do={ add list=$AddressList comment=AS16438 address=204.80.2.0/23 }
:if ([:len [find where list=$AddressList and address=204.80.4.0/22]] = 0) do={ add list=$AddressList comment=AS16438 address=204.80.4.0/22 }
