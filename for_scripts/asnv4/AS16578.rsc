...
:do {add list=$AddressList comment=AS16578 address=63.83.72.0/21} on-error {}
:do {add list=$AddressList comment=AS16578 address=69.94.128.0/21} on-error {}
:do {add list=$AddressList comment=AS16578 address=69.94.136.0/22} on-error {}
:do {add list=$AddressList comment=AS16578 address=69.94.140.0/23} on-error {}
:do {add list=$AddressList comment=AS16578 address=69.94.142.0/24} on-error {}
:do {add list=$AddressList comment=AS16578 address=69.94.144.0/20} on-error {}
