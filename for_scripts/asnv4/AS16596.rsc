...
:do {add list=$AddressList comment=AS16596 address=148.231.32.0/22} on-error {}
:do {add list=$AddressList comment=AS16596 address=148.231.36.0/23} on-error {}
:do {add list=$AddressList comment=AS16596 address=148.231.40.0/23} on-error {}
:do {add list=$AddressList comment=AS16596 address=148.231.43.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16596 address=148.231.96.0/22} on-error {}
