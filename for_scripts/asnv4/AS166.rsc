...
:do {add list=$AddressList comment=AS166 address=for_scripts/asnv4/AS166.rsc} on-error {}
...
:do {add list=$AddressList comment=AS166 address=198.97.168.0/24} on-error {}
