...
:do {add list=$AddressList comment=AS1661 address=152.189.117.0/24} on-error {}
:do {add list=$AddressList comment=AS1661 address=152.189.118.0/24} on-error {}
:do {add list=$AddressList comment=AS1661 address=152.189.95.0/24} on-error {}
:do {add list=$AddressList comment=AS1661 address=152.189.96.0/24} on-error {}
