...
:do {add list=$AddressList comment=AS16610 address=208.88.64.0/23} on-error {}
:do {add list=$AddressList comment=AS16610 address=208.88.66.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16610 address=68.67.119.0/24} on-error {}
