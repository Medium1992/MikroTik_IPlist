...
:do {add list=$AddressList comment=AS16618 address=67.210.80.0/23} on-error {}
:do {add list=$AddressList comment=AS16618 address=67.210.83.0/24} on-error {}
:do {add list=$AddressList comment=AS16618 address=67.210.84.0/22} on-error {}
