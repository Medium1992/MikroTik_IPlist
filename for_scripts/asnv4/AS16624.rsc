...
:do {add list=$AddressList comment=AS16624 address=199.22.55.0/24} on-error {}
:do {add list=$AddressList comment=AS16624 address=199.22.56.0/22} on-error {}
:do {add list=$AddressList comment=AS16624 address=199.22.60.0/23} on-error {}
