...
:do {add list=$AddressList comment=AS16664 address=for_scripts/asnv4/AS16664.rsc} on-error {}
...
:do {add list=$AddressList comment=AS16664 address=207.190.144.0/24} on-error {}
