...
:do {add list=$AddressList comment=AS16681 address=for_scripts/asnv4/AS16681.rsc} on-error {}
:do {add list=$AddressList comment=AS16681 address=144.81.10.0/23} on-error {}
