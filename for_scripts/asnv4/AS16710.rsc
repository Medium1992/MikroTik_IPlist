...
:do {add list=$AddressList comment=AS16710 address=for_scripts/asnv4/AS16710.rsc} on-error {}
:do {add list=$AddressList comment=AS16710 address=149.48.160.0/20} on-error {}
