...
:do {add list=$AddressList comment=AS16740 address=74.126.144.0/21} on-error {}
:do {add list=$AddressList comment=AS16740 address=74.126.152.0/24} on-error {}
:do {add list=$AddressList comment=AS16740 address=74.126.154.0/24} on-error {}
:do {add list=$AddressList comment=AS16740 address=74.188.248.0/21} on-error {}
