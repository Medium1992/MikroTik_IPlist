...
:do {add list=$AddressList comment=AS16758 address=151.114.111.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16758 address=205.145.1.0/24} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.12.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16758 address=205.145.18.0/24} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.2.0/23} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.22.0/23} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.25.0/24} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.26.0/24} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.31.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16758 address=205.145.4.0/23} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.50.0/24} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.58.0/23} on-error {}
:do {add list=$AddressList comment=AS16758 address=205.145.6.0/24} on-error {}
