...
:do {add list=$AddressList comment=AS16795 address=for_scripts/asnv4/AS16795.rsc} on-error {}
...
:do {add list=$AddressList comment=AS16795 address=64.136.172.0/23} on-error {}
