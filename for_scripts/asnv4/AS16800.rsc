...
:do {add list=$AddressList comment=AS16800 address=163.201.1.0/24} on-error {}
:do {add list=$AddressList comment=AS16800 address=163.201.100.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16800 address=163.201.150.0/24} on-error {}
