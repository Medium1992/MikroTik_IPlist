...
:do {add list=$AddressList comment=AS16811 address=for_scripts/asnv4/AS16811.rsc} on-error {}
...
:do {add list=$AddressList comment=AS16811 address=148.78.246.0/23} on-error {}
:do {add list=$AddressList comment=AS16811 address=148.78.248.0/23} on-error {}
