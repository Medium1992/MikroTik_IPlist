...
:do {add list=$AddressList comment=AS16851 address=104.218.81.0/24} on-error {}
:do {add list=$AddressList comment=AS16851 address=104.218.82.0/24} on-error {}
...
:do {add list=$AddressList comment=AS16851 address=199.36.116.0/23} on-error {}
:do {add list=$AddressList comment=AS16851 address=199.36.119.0/24} on-error {}
