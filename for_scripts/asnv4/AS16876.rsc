...
:do {add list=$AddressList comment=AS16876 address=for_scripts/asnv4/AS16876.rsc} on-error {}
...
:do {add list=$AddressList comment=AS16876 address=208.77.189.0/24} on-error {}
