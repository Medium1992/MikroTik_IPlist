...
:do {add list=$AddressList comment=AS17133 address=64.13.32.0/20} on-error {}
:do {add list=$AddressList comment=AS17133 address=64.13.48.0/21} on-error {}
:do {add list=$AddressList comment=AS17133 address=64.13.6.0/23} on-error {}
:do {add list=$AddressList comment=AS17133 address=64.13.64.0/22} on-error {}
:do {add list=$AddressList comment=AS17133 address=64.13.70.0/23} on-error {}
