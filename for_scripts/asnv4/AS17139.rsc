...
:do {add list=$AddressList comment=AS17139 address=for_scripts/asnv4/AS17139.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17139 address=173.247.228.0/22} on-error {}
:do {add list=$AddressList comment=AS17139 address=173.247.232.0/23} on-error {}
