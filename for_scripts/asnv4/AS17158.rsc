...
:do {add list=$AddressList comment=AS17158 address=139.28.146.0/23} on-error {}
...
:do {add list=$AddressList comment=AS17158 address=185.217.56.0/22} on-error {}
:do {add list=$AddressList comment=AS17158 address=185.252.164.0/23} on-error {}
...
:do {add list=$AddressList comment=AS17158 address=76.77.98.0/24} on-error {}
