...
:if ([:len [find where list=$AddressList and address=216.69.104.0/23]] = 0) do={ add list=$AddressList comment=AS17242 address=216.69.104.0/23 }
:if ([:len [find where list=$AddressList and address=216.69.106.0/24]] = 0) do={ add list=$AddressList comment=AS17242 address=216.69.106.0/24 }
:if ([:len [find where list=$AddressList and address=216.69.108.0/22]] = 0) do={ add list=$AddressList comment=AS17242 address=216.69.108.0/22 }
