...
:do {add list=$AddressList comment=AS17293 address=for_scripts/asnv4/AS17293.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17293 address=50.30.80.0/25} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.80.128/28} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.80.144/29} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.80.152/30} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.80.156/31} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.80.158/32} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.80.160/27} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.80.192/26} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.81.0/24} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.82.0/23} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.84.0/22} on-error {}
:do {add list=$AddressList comment=AS17293 address=50.30.88.0/21} on-error {}
