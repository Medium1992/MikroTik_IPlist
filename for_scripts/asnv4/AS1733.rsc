...
:do {add list=$AddressList comment=AS1733 address=for_scripts/asnv4/AS1733.rsc} on-error {}
...
:do {add list=$AddressList comment=AS1733 address=214.48.7.0/24} on-error {}
...
:do {add list=$AddressList comment=AS1733 address=215.1.42.0/23} on-error {}
:do {add list=$AddressList comment=AS1733 address=215.65.119.0/24} on-error {}
:do {add list=$AddressList comment=AS1733 address=215.65.50.0/23} on-error {}
