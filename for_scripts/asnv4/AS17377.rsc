...
:do {add list=$AddressList comment=AS17377 address=for_scripts/asnv4/AS17377.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17377 address=198.162.82.0/23} on-error {}
