...
:do {add list=$AddressList comment=AS17390 address=129.41.56.0/23} on-error {}
:do {add list=$AddressList comment=AS17390 address=129.41.58.0/24} on-error {}
:do {add list=$AddressList comment=AS17390 address=129.41.8.0/24} on-error {}
...
:do {add list=$AddressList comment=AS17390 address=170.224.152.0/24} on-error {}
