...
:if ([:len [find where list=$AddressList and address=205.205.147.0/24]] = 0) do={ add list=$AddressList comment=AS17397 address=205.205.147.0/24 }
:if ([:len [find where list=$AddressList and address=205.205.62.0/24]] = 0) do={ add list=$AddressList comment=AS17397 address=205.205.62.0/24 }
:if ([:len [find where list=$AddressList and address=205.205.71.0/24]] = 0) do={ add list=$AddressList comment=AS17397 address=205.205.71.0/24 }
