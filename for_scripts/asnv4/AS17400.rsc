...
:do {add list=$AddressList comment=AS17400 address=for_scripts/asnv4/AS17400.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17400 address=196.249.200.0/22} on-error {}
