...
:do {add list=$AddressList comment=AS17426 address=38.134.143.0/24} on-error {}
:do {add list=$AddressList comment=AS17426 address=38.188.108.0/22} on-error {}
:do {add list=$AddressList comment=AS17426 address=38.9.60.0/22} on-error {}
