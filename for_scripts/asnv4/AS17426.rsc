...
:do {add list=$AddressList comment=AS17426 address=for_scripts/asnv4/AS17426.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17426 address=38.134.140.0/24} on-error {}
:do {add list=$AddressList comment=AS17426 address=38.188.108.0/24} on-error {}
:do {add list=$AddressList comment=AS17426 address=38.188.110.0/24} on-error {}
