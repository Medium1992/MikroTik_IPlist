...
:do {add list=$AddressList comment=AS17436 address=103.147.155.0/24} on-error {}
...
:do {add list=$AddressList comment=AS17436 address=103.217.73.0/24} on-error {}
:do {add list=$AddressList comment=AS17436 address=103.60.4.0/23} on-error {}
:do {add list=$AddressList comment=AS17436 address=103.83.12.0/23} on-error {}
