...
:do {add list=$AddressList comment=AS17470 address=for_scripts/asnv4/AS17470.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17470 address=203.189.188.0/23} on-error {}
:do {add list=$AddressList comment=AS17470 address=203.189.190.0/24} on-error {}
