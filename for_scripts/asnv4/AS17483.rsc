...
:if ([:len [find where list=$AddressList and address=49.156.153.0/24]] = 0) do={ add list=$AddressList comment=AS17483 address=49.156.153.0/24 }
:if ([:len [find where list=$AddressList and address=49.156.155.0/24]] = 0) do={ add list=$AddressList comment=AS17483 address=49.156.155.0/24 }
