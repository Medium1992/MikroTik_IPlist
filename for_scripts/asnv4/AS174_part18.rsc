...
:do {add list=$AddressList comment=AS174 address=38.224.44.0/25} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.44.128/31} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.44.130/32} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.44.132/30} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.44.136/29} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.44.144/28} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.44.160/27} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.44.192/26} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.45.0/24} on-error {}
:do {add list=$AddressList comment=AS174 address=38.224.46.0/23} on-error {}
