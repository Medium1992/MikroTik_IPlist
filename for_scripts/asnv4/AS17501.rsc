...
:if ([:len [find where list=$AddressList and address=124.41.192.0/18]] = 0) do={ add list=$AddressList comment=AS17501 address=124.41.192.0/18 }
...
:if ([:len [find where list=$AddressList and address=212.32.30.0/23]] = 0) do={ add list=$AddressList comment=AS17501 address=212.32.30.0/23 }
