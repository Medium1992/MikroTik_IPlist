...
:do {add list=$AddressList comment=AS1757 address=for_scripts/asnv4/AS1757.rsc} on-error {}
...
:do {add list=$AddressList comment=AS1757 address=198.185.16.0/22} on-error {}
:do {add list=$AddressList comment=AS1757 address=198.185.21.0/24} on-error {}
:do {add list=$AddressList comment=AS1757 address=198.185.23.0/24} on-error {}
:do {add list=$AddressList comment=AS1757 address=198.185.25.0/24} on-error {}
