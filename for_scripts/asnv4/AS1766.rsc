...
:do {add list=$AddressList comment=AS1766 address=for_scripts/asnv4/AS1766.rsc} on-error {}
...
:do {add list=$AddressList comment=AS1766 address=158.26.96.0/24} on-error {}
