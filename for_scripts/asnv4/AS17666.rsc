...
:do {add list=$AddressList comment=AS17666 address=for_scripts/asnv4/AS17666.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17666 address=202.87.116.0/22} on-error {}
