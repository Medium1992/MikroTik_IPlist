...
:do {add list=$AddressList comment=AS17771 address=202.63.105.0/24} on-error {}
:do {add list=$AddressList comment=AS17771 address=202.63.106.0/23} on-error {}
:do {add list=$AddressList comment=AS17771 address=202.63.109.0/24} on-error {}
:do {add list=$AddressList comment=AS17771 address=202.63.110.0/23} on-error {}
:do {add list=$AddressList comment=AS17771 address=202.63.113.0/24} on-error {}
:do {add list=$AddressList comment=AS17771 address=202.63.114.0/24} on-error {}
:do {add list=$AddressList comment=AS17771 address=202.63.116.0/23} on-error {}
:do {add list=$AddressList comment=AS17771 address=202.63.124.0/22} on-error {}
