...
:do {add list=$AddressList comment=AS17781 address=for_scripts/asnv4/AS17781.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17781 address=203.192.3.0/24} on-error {}
