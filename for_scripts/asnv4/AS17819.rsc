...
:do {add list=$AddressList comment=AS17819 address=for_scripts/asnv4/AS17819.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17819 address=203.190.224.0/24} on-error {}
