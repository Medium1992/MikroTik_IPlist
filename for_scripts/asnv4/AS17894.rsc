...
:do {add list=$AddressList comment=AS17894 address=for_scripts/asnv4/AS17894.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17894 address=203.127.225.0/24} on-error {}
