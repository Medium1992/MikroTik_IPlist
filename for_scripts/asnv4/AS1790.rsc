...
:do {add list=$AddressList comment=AS1790 address=for_scripts/asnv4/AS1790.rsc} on-error {}
...
:do {add list=$AddressList comment=AS1790 address=63.160.84.0/24} on-error {}
