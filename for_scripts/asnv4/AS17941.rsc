...
:do {add list=$AddressList comment=AS17941 address=for_scripts/asnv4/AS17941.rsc} on-error {}
:do {add list=$AddressList comment=AS17941 address=103.100.108.0/22} on-error {}
:do {add list=$AddressList comment=AS17941 address=103.102.124.0/23} on-error {}
:do {add list=$AddressList comment=AS17941 address=103.109.252.0/22} on-error {}
:do {add list=$AddressList comment=AS17941 address=103.120.13.0/24} on-error {}
