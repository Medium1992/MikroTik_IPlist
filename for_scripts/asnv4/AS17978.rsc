...
:do {add list=$AddressList comment=AS17978 address=for_scripts/asnv4/AS17978.rsc} on-error {}
...
:do {add list=$AddressList comment=AS17978 address=203.215.144.0/21} on-error {}
