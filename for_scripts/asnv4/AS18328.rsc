...
:do {add list=$AddressList comment=AS18328 address=103.31.180.0/24} on-error {}
:do {add list=$AddressList comment=AS18328 address=103.31.182.0/23} on-error {}
...
:do {add list=$AddressList comment=AS18328 address=121.0.112.0/20} on-error {}
...
:do {add list=$AddressList comment=AS18328 address=203.210.16.0/24} on-error {}
:do {add list=$AddressList comment=AS18328 address=203.210.20.0/22} on-error {}
:do {add list=$AddressList comment=AS18328 address=203.210.26.0/23} on-error {}
:do {add list=$AddressList comment=AS18328 address=203.210.31.0/24} on-error {}
...
:do {add list=$AddressList comment=AS18328 address=210.87.205.0/24} on-error {}
:do {add list=$AddressList comment=AS18328 address=210.87.206.0/23} on-error {}
