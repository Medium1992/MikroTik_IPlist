...
:if ([:len [find where list=$AddressList and address=203.81.164.0/24]] = 0) do={ add list=$AddressList comment=AS18399 address=203.81.164.0/24 }
...
:if ([:len [find where list=$AddressList and address=61.4.72.0/22]] = 0) do={ add list=$AddressList comment=AS18399 address=61.4.72.0/22 }
:if ([:len [find where list=$AddressList and address=61.4.76.0/23]] = 0) do={ add list=$AddressList comment=AS18399 address=61.4.76.0/23 }
:if ([:len [find where list=$AddressList and address=61.4.78.0/24]] = 0) do={ add list=$AddressList comment=AS18399 address=61.4.78.0/24 }
