...
:do {add list=$AddressList comment=AS18403 address=113.22.0.0/18} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.100.0/22} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.104.0/21} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.112.0/20} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.128.0/17} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.64.0/19} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.0/25} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.128/30} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.132/31} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.134/32} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.136/29} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.144/28} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.160/27} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.96.192/26} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.97.0/24} on-error {}
:do {add list=$AddressList comment=AS18403 address=113.22.98.0/23} on-error {}
