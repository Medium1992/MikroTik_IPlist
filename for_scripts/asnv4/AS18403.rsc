...
:do {add list=$AddressList comment=AS18403 address=118.68.0.0/16} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.0.0/17} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.128.0/19} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.0/27} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.128/25} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.32/28} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.49/32} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.50/31} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.52/30} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.56/29} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.160.64/26} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.161.0/24} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.162.0/23} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.164.0/22} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.168.0/21} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.176.0/20} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.69.192.0/18} on-error {}
:do {add list=$AddressList comment=AS18403 address=118.70.0.0/15} on-error {}
