...
:do {add list=$AddressList comment=AS18577 address=for_scripts/asnv4/AS18577.rsc} on-error {}
...
:do {add list=$AddressList comment=AS18577 address=108.174.248.0/23} on-error {}
