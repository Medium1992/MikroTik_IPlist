...
:do {add list=$AddressList comment=AS18672 address=for_scripts/asnv4/AS18672.rsc} on-error {}
...
:do {add list=$AddressList comment=AS18672 address=72.172.88.0/23} on-error {}
