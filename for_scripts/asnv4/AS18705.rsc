...
:if ([:len [find where list=$AddressList and address=208.93.72.0/22]] = 0) do={ add list=$AddressList comment=AS18705 address=208.93.72.0/22 }
:if ([:len [find where list=$AddressList and address=208.93.76.0/24]] = 0) do={ add list=$AddressList comment=AS18705 address=208.93.76.0/24 }
