...
:if ([:len [find where list=$AddressList and address=206.53.144.0/20]] = 0) do={ add list=$AddressList comment=AS18705 address=206.53.144.0/20 }
:if ([:len [find where list=$AddressList and address=208.65.72.0/23]] = 0) do={ add list=$AddressList comment=AS18705 address=208.65.72.0/23 }
:if ([:len [find where list=$AddressList and address=208.65.75.0/24]] = 0) do={ add list=$AddressList comment=AS18705 address=208.65.75.0/24 }
:if ([:len [find where list=$AddressList and address=208.65.76.0/22]] = 0) do={ add list=$AddressList comment=AS18705 address=208.65.76.0/22 }
:if ([:len [find where list=$AddressList and address=208.93.72.0/23]] = 0) do={ add list=$AddressList comment=AS18705 address=208.93.72.0/23 }
:if ([:len [find where list=$AddressList and address=208.93.75.0/24]] = 0) do={ add list=$AddressList comment=AS18705 address=208.93.75.0/24 }
:if ([:len [find where list=$AddressList and address=208.93.78.0/23]] = 0) do={ add list=$AddressList comment=AS18705 address=208.93.78.0/23 }
