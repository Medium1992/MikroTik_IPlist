...
:do {add list=$AddressList comment=AS18862 address=152.145.176.0/22} on-error {}
:do {add list=$AddressList comment=AS18862 address=152.145.182.0/24} on-error {}
...
:do {add list=$AddressList comment=AS18862 address=152.145.241.0/24} on-error {}
...
:do {add list=$AddressList comment=AS18862 address=74.116.80.0/22} on-error {}
