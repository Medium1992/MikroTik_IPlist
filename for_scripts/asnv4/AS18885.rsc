...
:do {add list=$AddressList comment=AS18885 address=for_scripts/asnv4/AS18885.rsc} on-error {}
...
:do {add list=$AddressList comment=AS18885 address=209.178.205.0/24} on-error {}
