...
:do {add list=$AddressList comment=AS19031 address=for_scripts/asnv4/AS19031.rsc} on-error {}
:do {add list=$AddressList comment=AS19031 address=104.36.52.0/22} on-error {}
