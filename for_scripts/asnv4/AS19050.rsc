...
:do {add list=$AddressList comment=AS19050 address=156.40.246.0/24} on-error {}
...
:do {add list=$AddressList comment=AS19050 address=158.73.183.0/24} on-error {}
:do {add list=$AddressList comment=AS19050 address=158.73.196.0/24} on-error {}
:do {add list=$AddressList comment=AS19050 address=158.73.30.0/24} on-error {}
