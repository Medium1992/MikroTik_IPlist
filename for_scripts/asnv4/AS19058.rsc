...
:do {add list=$AddressList comment=AS19058 address=for_scripts/asnv4/AS19058.rsc} on-error {}
...
:do {add list=$AddressList comment=AS19058 address=216.8.84.0/24} on-error {}
