...
:do {add list=$AddressList comment=AS19215 address=208.82.44.0/23} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.0/27} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.128/25} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.32/30} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.37/32} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.38/31} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.40/29} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.48/28} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.46.64/26} on-error {}
:do {add list=$AddressList comment=AS19215 address=208.82.47.0/24} on-error {}
