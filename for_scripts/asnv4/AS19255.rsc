...
:do {add list=$AddressList comment=AS19255 address=for_scripts/asnv4/AS19255.rsc} on-error {}
...
:do {add list=$AddressList comment=AS19255 address=192.203.32.0/22} on-error {}
