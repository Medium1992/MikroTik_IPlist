...
:if ([:len [find where list=$AddressList and address=142.214.32.0/20]] = 0) do={ add list=$AddressList comment=AS19256 address=142.214.32.0/20 }
:if ([:len [find where list=$AddressList and address=142.214.48.0/23]] = 0) do={ add list=$AddressList comment=AS19256 address=142.214.48.0/23 }
...
:if ([:len [find where list=$AddressList and address=142.214.51.0/24]] = 0) do={ add list=$AddressList comment=AS19256 address=142.214.51.0/24 }
:if ([:len [find where list=$AddressList and address=142.214.52.0/22]] = 0) do={ add list=$AddressList comment=AS19256 address=142.214.52.0/22 }
:if ([:len [find where list=$AddressList and address=142.214.56.0/21]] = 0) do={ add list=$AddressList comment=AS19256 address=142.214.56.0/21 }
...
:if ([:len [find where list=$AddressList and address=199.115.132.0/24]] = 0) do={ add list=$AddressList comment=AS19256 address=199.115.132.0/24 }
