...
:do {add list=$AddressList comment=AS19324 address=for_scripts/asnv4/AS19324.rsc} on-error {}
...
:do {add list=$AddressList comment=AS19324 address=199.184.144.0/21} on-error {}
