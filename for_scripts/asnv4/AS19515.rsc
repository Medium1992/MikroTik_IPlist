...
:if ([:len [find where list=$AddressList and address=208.111.64.0/22]] = 0) do={ add list=$AddressList comment=AS19515 address=208.111.64.0/22 }
...
:if ([:len [find where list=$AddressList and address=69.67.0.0/20]] = 0) do={ add list=$AddressList comment=AS19515 address=69.67.0.0/20 }
