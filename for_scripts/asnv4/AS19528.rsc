...
:do {add list=$AddressList comment=AS19528 address=for_scripts/asnv4/AS19528.rsc} on-error {}
...
:do {add list=$AddressList comment=AS19528 address=74.209.164.0/23} on-error {}
