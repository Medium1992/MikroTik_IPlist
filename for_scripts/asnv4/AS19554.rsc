...
:do {add list=$AddressList comment=AS19554 address=67.202.168.0/22} on-error {}
:do {add list=$AddressList comment=AS19554 address=67.202.173.0/24} on-error {}
:do {add list=$AddressList comment=AS19554 address=67.202.174.0/23} on-error {}
