...
:do {add list=$AddressList comment=AS196983 address=185.109.184.0/22} on-error {}
:do {add list=$AddressList comment=AS196983 address=185.5.112.0/22} on-error {}
:do {add list=$AddressList comment=AS196983 address=185.72.76.0/22} on-error {}
:do {add list=$AddressList comment=AS196983 address=193.105.228.0/24} on-error {}
:do {add list=$AddressList comment=AS196983 address=5.28.8.0/21} on-error {}
