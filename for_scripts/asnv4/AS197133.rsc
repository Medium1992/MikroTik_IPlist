...
:if ([:len [find where list=$AddressList and address=185.114.129.0/24]] = 0) do={ add list=$AddressList comment=AS197133 address=185.114.129.0/24 }
:if ([:len [find where list=$AddressList and address=185.114.130.0/23]] = 0) do={ add list=$AddressList comment=AS197133 address=185.114.130.0/23 }
