...
:do {add list=$AddressList comment=AS197177 address=for_scripts/asnv4/AS197177.rsc} on-error {}
...
:do {add list=$AddressList comment=AS197177 address=94.240.39.0/24} on-error {}
