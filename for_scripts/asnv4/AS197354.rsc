...
:if ([:len [find where list=$AddressList and address=194.62.30.0/24]] = 0) do={ add list=$AddressList comment=AS197354 address=194.62.30.0/24 }
...
:if ([:len [find where list=$AddressList and address=45.95.98.0/24]] = 0) do={ add list=$AddressList comment=AS197354 address=45.95.98.0/24 }
