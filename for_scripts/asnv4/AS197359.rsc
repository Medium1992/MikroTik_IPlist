...
:if ([:len [find where list=$AddressList and address=46.202.207.0/24]] = 0) do={ add list=$AddressList comment=AS197359 address=46.202.207.0/24 }
:if ([:len [find where list=$AddressList and address=46.202.220.0/24]] = 0) do={ add list=$AddressList comment=AS197359 address=46.202.220.0/24 }
