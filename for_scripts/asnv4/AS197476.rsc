...
:do {add list=$AddressList comment=AS197476 address=for_scripts/asnv4/AS197476.rsc} on-error {}
:do {add list=$AddressList comment=AS197476 address=178.157.104.0/22} on-error {}
