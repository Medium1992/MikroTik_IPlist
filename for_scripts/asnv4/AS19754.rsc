...
:do {add list=$AddressList comment=AS19754 address=154.51.34.0/24} on-error {}
:do {add list=$AddressList comment=AS19754 address=154.51.39.0/24} on-error {}
...
:do {add list=$AddressList comment=AS19754 address=199.66.152.0/21} on-error {}
...
:do {add list=$AddressList comment=AS19754 address=38.98.108.0/24} on-error {}
:do {add list=$AddressList comment=AS19754 address=38.98.126.0/24} on-error {}
