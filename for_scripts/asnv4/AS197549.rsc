...
:do {add list=$AddressList comment=AS197549 address=for_scripts/asnv4/AS197549.rsc} on-error {}
...
:do {add list=$AddressList comment=AS197549 address=89.144.0.0/23} on-error {}
...
:do {add list=$AddressList comment=AS197549 address=89.144.40.0/24} on-error {}
:do {add list=$AddressList comment=AS197549 address=89.144.43.0/24} on-error {}
