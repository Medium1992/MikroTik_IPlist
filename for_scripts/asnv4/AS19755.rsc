...
:if ([:len [find where list=$AddressList and address=162.223.178.0/24]] = 0) do={ add list=$AddressList comment=AS19755 address=162.223.178.0/24 }
...
:if ([:len [find where list=$AddressList and address=199.73.127.0/24]] = 0) do={ add list=$AddressList comment=AS19755 address=199.73.127.0/24 }
