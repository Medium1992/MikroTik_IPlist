...
:if ([:len [find where list=$AddressList and address=217.60.178.0/23]] = 0) do={ add list=$AddressList comment=AS197574 address=217.60.178.0/23 }
...
:if ([:len [find where list=$AddressList and address=31.56.189.0/24]] = 0) do={ add list=$AddressList comment=AS197574 address=31.56.189.0/24 }
