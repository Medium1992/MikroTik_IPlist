...
:do {add list=$AddressList comment=AS197715 address=for_scripts/asnv4/AS197715.rsc} on-error {}
...
:do {add list=$AddressList comment=AS197715 address=62.106.89.0/24} on-error {}
