...
:do {add list=$AddressList comment=AS197727 address=for_scripts/asnv4/AS197727.rsc} on-error {}
...
:do {add list=$AddressList comment=AS197727 address=194.151.86.0/24} on-error {}
