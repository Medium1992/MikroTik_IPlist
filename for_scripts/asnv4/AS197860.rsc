...
:if ([:len [find where list=$AddressList and address=103.76.86.0/24]] = 0) do={ add list=$AddressList comment=AS197860 address=103.76.86.0/24 }
...
:if ([:len [find where list=$AddressList and address=74.2.4.0/24]] = 0) do={ add list=$AddressList comment=AS197860 address=74.2.4.0/24 }
