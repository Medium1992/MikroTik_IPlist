...
:do {add list=$AddressList comment=AS197949 address=for_scripts/asnv4/AS197949.rsc} on-error {}
...
:do {add list=$AddressList comment=AS197949 address=145.60.252.0/22} on-error {}
