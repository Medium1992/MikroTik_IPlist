...
:do {add list=$AddressList comment=AS198037 address=150.251.138.0/24} on-error {}
...
:do {add list=$AddressList comment=AS198037 address=78.17.132.0/23} on-error {}
:do {add list=$AddressList comment=AS198037 address=78.17.147.0/24} on-error {}
