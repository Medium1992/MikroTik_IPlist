...
:do {add list=$AddressList comment=AS198394 address=for_scripts/asnv4/AS198394.rsc} on-error {}
:do {add list=$AddressList comment=AS198394 address=141.105.164.0/23} on-error {}
:do {add list=$AddressList comment=AS198394 address=185.12.24.0/24} on-error {}
...
:do {add list=$AddressList comment=AS198394 address=197.211.15.0/24} on-error {}
