...
:do {add list=$AddressList comment=AS19842 address=for_scripts/asnv4/AS19842.rsc} on-error {}
...
:do {add list=$AddressList comment=AS19842 address=206.130.240.0/24} on-error {}
