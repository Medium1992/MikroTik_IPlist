...
:if ([:len [find where list=$AddressList and address=162.222.163.0/24]] = 0) do={ add list=$AddressList comment=AS19842 address=162.222.163.0/24 }
...
:if ([:len [find where list=$AddressList and address=216.105.89.0/24]] = 0) do={ add list=$AddressList comment=AS19842 address=216.105.89.0/24 }
