...
:if ([:len [find where list=$AddressList and address=216.105.82.0/23]] = 0) do={ add list=$AddressList comment=AS19842 address=216.105.82.0/23 }
:if ([:len [find where list=$AddressList and address=216.105.84.0/22]] = 0) do={ add list=$AddressList comment=AS19842 address=216.105.84.0/22 }
...
:if ([:len [find where list=$AddressList and address=216.105.94.0/24]] = 0) do={ add list=$AddressList comment=AS19842 address=216.105.94.0/24 }
...
:if ([:len [find where list=$AddressList and address=98.158.136.0/21]] = 0) do={ add list=$AddressList comment=AS19842 address=98.158.136.0/21 }
