...
:if ([:len [find where list=$AddressList and address=140.233.160.0/24]] = 0) do={ add list=$AddressList comment=AS198420 address=140.233.160.0/24 }
...
:if ([:len [find where list=$AddressList and address=84.75.161.0/24]] = 0) do={ add list=$AddressList comment=AS198420 address=84.75.161.0/24 }
