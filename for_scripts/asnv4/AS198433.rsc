...
:do {add list=$AddressList comment=AS198433 address=195.225.60.0/24} on-error {}
...
:do {add list=$AddressList comment=AS198433 address=37.128.176.0/23} on-error {}
:do {add list=$AddressList comment=AS198433 address=37.128.179.0/24} on-error {}
:do {add list=$AddressList comment=AS198433 address=37.128.180.0/22} on-error {}
