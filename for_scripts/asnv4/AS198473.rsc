...
:do {add list=$AddressList comment=AS198473 address=185.126.53.0/24} on-error {}
:do {add list=$AddressList comment=AS198473 address=185.126.54.0/23} on-error {}
...
:do {add list=$AddressList comment=AS198473 address=185.20.140.0/22} on-error {}
