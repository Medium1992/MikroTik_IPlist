...
:do {add list=$AddressList comment=AS198541 address=for_scripts/asnv4/AS198541.rsc} on-error {}
:do {add list=$AddressList comment=AS198541 address=176.110.160.0/19} on-error {}
