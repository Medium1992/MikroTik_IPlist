...
:do {add list=$AddressList comment=AS198760 address=185.228.116.0/22} on-error {}
...
:do {add list=$AddressList comment=AS198760 address=81.172.80.0/21} on-error {}
:do {add list=$AddressList comment=AS198760 address=87.236.162.0/24} on-error {}
