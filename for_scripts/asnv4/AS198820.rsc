...
:if ([:len [find where list=$AddressList and address=193.176.25.0/24]] = 0) do={ add list=$AddressList comment=AS198820 address=193.176.25.0/24 }
:if ([:len [find where list=$AddressList and address=193.176.26.0/23]] = 0) do={ add list=$AddressList comment=AS198820 address=193.176.26.0/23 }
