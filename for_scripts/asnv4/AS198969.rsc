...
:if ([:len [find where list=$AddressList and address=153.51.160.0/22]] = 0) do={ add list=$AddressList comment=AS198969 address=153.51.160.0/22 }
:if ([:len [find where list=$AddressList and address=153.51.171.0/24]] = 0) do={ add list=$AddressList comment=AS198969 address=153.51.171.0/24 }
...
:if ([:len [find where list=$AddressList and address=94.192.128.0/24]] = 0) do={ add list=$AddressList comment=AS198969 address=94.192.128.0/24 }
