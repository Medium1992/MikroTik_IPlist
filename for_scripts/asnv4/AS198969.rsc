...
:if ([:len [find where list=$AddressList and address=130.254.32.0/22]] = 0) do={ add list=$AddressList comment=AS198969 address=130.254.32.0/22 }
:if ([:len [find where list=$AddressList and address=130.254.36.0/23]] = 0) do={ add list=$AddressList comment=AS198969 address=130.254.36.0/23 }
:if ([:len [find where list=$AddressList and address=141.0.196.0/23]] = 0) do={ add list=$AddressList comment=AS198969 address=141.0.196.0/23 }
...
:if ([:len [find where list=$AddressList and address=94.192.140.0/24]] = 0) do={ add list=$AddressList comment=AS198969 address=94.192.140.0/24 }
