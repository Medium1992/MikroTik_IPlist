...
:if ([:len [find where list=$AddressList and address=5.158.216.0/22]] = 0) do={ add list=$AddressList comment=AS199143 address=5.158.216.0/22 }
:if ([:len [find where list=$AddressList and address=5.158.220.0/24]] = 0) do={ add list=$AddressList comment=AS199143 address=5.158.220.0/24 }
