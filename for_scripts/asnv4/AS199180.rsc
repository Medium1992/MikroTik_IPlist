...
:do {add list=$AddressList comment=AS199180 address=177.1.193.0/24} on-error {}
:do {add list=$AddressList comment=AS199180 address=2.26.12.0/22} on-error {}
:do {add list=$AddressList comment=AS199180 address=2.26.144.0/24} on-error {}
...
:do {add list=$AddressList comment=AS199180 address=31.76.36.0/24} on-error {}
