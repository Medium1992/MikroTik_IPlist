...
:do {add list=$AddressList comment=AS199221 address=for_scripts/asnv4/AS199221.rsc} on-error {}
...
:do {add list=$AddressList comment=AS199221 address=38.172.202.0/24} on-error {}
