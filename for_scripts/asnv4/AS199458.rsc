...
:do {add list=$AddressList comment=AS199458 address=for_scripts/asnv4/AS199458.rsc} on-error {}
:do {add list=$AddressList comment=AS199458 address=149.18.66.0/23} on-error {}
:do {add list=$AddressList comment=AS199458 address=149.57.4.0/24} on-error {}
