...
:if ([:len [find where list=$AddressList and address=104.233.247.0/24]] = 0) do={ add list=$AddressList comment=AS19949 address=104.233.247.0/24 }
...
:if ([:len [find where list=$AddressList and address=107.149.6.0/24]] = 0) do={ add list=$AddressList comment=AS19949 address=107.149.6.0/24 }
