...
:do {add list=$AddressList comment=AS199550 address=188.220.140.0/22} on-error {}
...
:do {add list=$AddressList comment=AS199550 address=46.29.36.0/24} on-error {}
...
:do {add list=$AddressList comment=AS199550 address=79.172.204.0/24} on-error {}
:do {add list=$AddressList comment=AS199550 address=91.206.2.0/24} on-error {}
