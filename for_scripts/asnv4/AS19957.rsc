...
:do {add list=$AddressList comment=AS19957 address=12.204.192.0/21} on-error {}
:do {add list=$AddressList comment=AS19957 address=12.204.201.0/24} on-error {}
:do {add list=$AddressList comment=AS19957 address=12.204.202.0/23} on-error {}
:do {add list=$AddressList comment=AS19957 address=12.204.204.0/22} on-error {}
:do {add list=$AddressList comment=AS19957 address=12.204.208.0/20} on-error {}
...
:do {add list=$AddressList comment=AS19957 address=64.79.176.0/21} on-error {}
