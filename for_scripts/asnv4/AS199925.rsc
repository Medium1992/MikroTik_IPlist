...
:do {add list=$AddressList comment=AS199925 address=for_scripts/asnv4/AS199925.rsc} on-error {}
...
:do {add list=$AddressList comment=AS199925 address=173.211.86.0/24} on-error {}
