...
:do {add list=$AddressList comment=AS199927 address=for_scripts/asnv4/AS199927.rsc} on-error {}
...
:do {add list=$AddressList comment=AS199927 address=193.247.199.0/24} on-error {}
