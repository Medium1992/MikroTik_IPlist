...
:do {add list=$AddressList comment=AS200040 address=for_scripts/asnv4/AS200040.rsc} on-error {}
:do {add list=$AddressList comment=AS200040 address=188.124.0.0/24} on-error {}
:do {add list=$AddressList comment=AS200040 address=188.124.31.0/24} on-error {}
