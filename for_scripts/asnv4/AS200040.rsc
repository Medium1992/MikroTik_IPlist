...
:if ([:len [find where list=$AddressList and address=131.222.242.0/24]] = 0) do={ add list=$AddressList comment=AS200040 address=131.222.242.0/24 }
:if ([:len [find where list=$AddressList and address=185.190.16.0/24]] = 0) do={ add list=$AddressList comment=AS200040 address=185.190.16.0/24 }
