...
:do {add list=$AddressList comment=AS200044 address=for_scripts/asnv4/AS200044.rsc} on-error {}
...
:do {add list=$AddressList comment=AS200044 address=194.156.28.0/22} on-error {}
