...
:do {add list=$AddressList comment=AS200107 address=185.201.0.0/24} on-error {}
:do {add list=$AddressList comment=AS200107 address=185.201.2.0/23} on-error {}
...
:do {add list=$AddressList comment=AS200107 address=185.85.14.0/24} on-error {}
:do {add list=$AddressList comment=AS200107 address=193.238.132.0/23} on-error {}
