...
:do {add list=$AddressList comment=AS200107 address=for_scripts/asnv4/AS200107.rsc} on-error {}
:do {add list=$AddressList comment=AS200107 address=185.201.1.0/24} on-error {}
