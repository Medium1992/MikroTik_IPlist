...
:if ([:len [find where list=$AddressList and address=95.86.158.0/23]] = 0) do={ add list=$AddressList comment=AS200154 address=95.86.158.0/23 }
:if ([:len [find where list=$AddressList and address=95.86.160.0/23]] = 0) do={ add list=$AddressList comment=AS200154 address=95.86.160.0/23 }
:if ([:len [find where list=$AddressList and address=95.86.162.0/24]] = 0) do={ add list=$AddressList comment=AS200154 address=95.86.162.0/24 }
