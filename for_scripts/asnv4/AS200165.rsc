...
:do {add list=$AddressList comment=AS200165 address=181.224.166.0/24} on-error {}
...
:do {add list=$AddressList comment=AS200165 address=195.235.164.0/24} on-error {}
:do {add list=$AddressList comment=AS200165 address=213.0.45.0/24} on-error {}
