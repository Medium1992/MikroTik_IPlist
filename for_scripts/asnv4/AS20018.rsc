...
:do {add list=$AddressList comment=AS20018 address=130.250.110.0/27} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.110.128/25} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.110.32/28} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.110.48/29} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.110.56/30} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.110.61/32} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.110.62/31} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.110.64/26} on-error {}
:do {add list=$AddressList comment=AS20018 address=130.250.111.0/24} on-error {}
