...
:do {add list=$AddressList comment=AS200370 address=for_scripts/asnv4/AS200370.rsc} on-error {}
...
:do {add list=$AddressList comment=AS200370 address=95.142.238.0/23} on-error {}
