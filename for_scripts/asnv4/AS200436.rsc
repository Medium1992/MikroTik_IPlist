...
:do {add list=$AddressList comment=AS200436 address=176.117.107.0/24} on-error {}
:do {add list=$AddressList comment=AS200436 address=188.212.96.0/24} on-error {}
:do {add list=$AddressList comment=AS200436 address=194.180.224.0/24} on-error {}
:do {add list=$AddressList comment=AS200436 address=195.18.10.0/24} on-error {}
