...
:do {add list=$AddressList comment=AS200454 address=199.16.240.0/24} on-error {}
:do {add list=$AddressList comment=AS200454 address=199.16.242.0/23} on-error {}
:do {add list=$AddressList comment=AS200454 address=208.85.11.0/24} on-error {}
:do {add list=$AddressList comment=AS200454 address=208.85.8.0/24} on-error {}
