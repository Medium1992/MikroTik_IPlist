...
:do {add list=$AddressList comment=AS200555 address=194.146.55.0/24} on-error {}
:do {add list=$AddressList comment=AS200555 address=194.146.63.0/24} on-error {}
:do {add list=$AddressList comment=AS200555 address=194.146.70.0/24} on-error {}
