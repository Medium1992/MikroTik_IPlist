...
:if ([:len [find where list=$AddressList and address=178.83.99.0/24]] = 0) do={ add list=$AddressList comment=AS200651 address=178.83.99.0/24 }
...
:if ([:len [find where list=$AddressList and address=195.58.146.0/24]] = 0) do={ add list=$AddressList comment=AS200651 address=195.58.146.0/24 }
