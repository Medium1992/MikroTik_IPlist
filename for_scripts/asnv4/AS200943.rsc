...
:do {add list=$AddressList comment=AS200943 address=153.96.160.0/24} on-error {}
:do {add list=$AddressList comment=AS200943 address=153.96.162.0/23} on-error {}
:do {add list=$AddressList comment=AS200943 address=153.96.164.0/22} on-error {}
