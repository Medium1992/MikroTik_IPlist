...
:if ([:len [find where list=$AddressList and address=198.244.14.0/24]] = 0) do={ add list=$AddressList comment=AS201002 address=198.244.14.0/24 }
...
:if ([:len [find where list=$AddressList and address=45.138.182.0/24]] = 0) do={ add list=$AddressList comment=AS201002 address=45.138.182.0/24 }
