...
:if ([:len [find where list=$AddressList and address=185.63.92.0/22]] = 0) do={ add list=$AddressList comment=AS201188 address=185.63.92.0/22 }
:if ([:len [find where list=$AddressList and address=45.151.184.0/23]] = 0) do={ add list=$AddressList comment=AS201188 address=45.151.184.0/23 }
