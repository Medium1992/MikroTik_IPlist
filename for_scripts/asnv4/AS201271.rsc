...
:do {add list=$AddressList comment=AS201271 address=for_scripts/asnv4/AS201271.rsc} on-error {}
...
:do {add list=$AddressList comment=AS201271 address=158.233.228.0/23} on-error {}
