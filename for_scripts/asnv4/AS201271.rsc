...
:do {add list=$AddressList comment=AS201271 address=158.233.232.0/24} on-error {}
:do {add list=$AddressList comment=AS201271 address=158.233.242.0/23} on-error {}
:do {add list=$AddressList comment=AS201271 address=158.233.245.0/24} on-error {}
:do {add list=$AddressList comment=AS201271 address=158.233.246.0/23} on-error {}
