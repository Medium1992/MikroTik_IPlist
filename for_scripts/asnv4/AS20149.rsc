...
:do {add list=$AddressList comment=AS20149 address=69.72.16.0/22} on-error {}
:do {add list=$AddressList comment=AS20149 address=69.72.21.0/24} on-error {}
:do {add list=$AddressList comment=AS20149 address=69.72.22.0/23} on-error {}
:do {add list=$AddressList comment=AS20149 address=98.97.192.0/23} on-error {}
:do {add list=$AddressList comment=AS20149 address=98.97.195.0/24} on-error {}
