...
:if ([:len [find where list=$AddressList and address=193.124.216.0/21]] = 0) do={ add list=$AddressList comment=AS201550 address=193.124.216.0/21 }
...
:if ([:len [find where list=$AddressList and address=194.58.0.0/21]] = 0) do={ add list=$AddressList comment=AS201550 address=194.58.0.0/21 }
:if ([:len [find where list=$AddressList and address=194.58.11.0/24]] = 0) do={ add list=$AddressList comment=AS201550 address=194.58.11.0/24 }
:if ([:len [find where list=$AddressList and address=194.58.12.0/22]] = 0) do={ add list=$AddressList comment=AS201550 address=194.58.12.0/22 }
:if ([:len [find where list=$AddressList and address=194.58.8.0/23]] = 0) do={ add list=$AddressList comment=AS201550 address=194.58.8.0/23 }
