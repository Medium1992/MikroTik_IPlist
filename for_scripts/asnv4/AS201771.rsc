...
:do {add list=$AddressList comment=AS201771 address=for_scripts/asnv4/AS201771.rsc} on-error {}
...
:do {add list=$AddressList comment=AS201771 address=134.239.64.0/19} on-error {}
...
:do {add list=$AddressList comment=AS201771 address=46.49.160.0/24} on-error {}
