...
:do {add list=$AddressList comment=AS201868 address=for_scripts/asnv4/AS201868.rsc} on-error {}
...
:do {add list=$AddressList comment=AS201868 address=185.61.116.0/23} on-error {}
:do {add list=$AddressList comment=AS201868 address=185.61.118.0/24} on-error {}
