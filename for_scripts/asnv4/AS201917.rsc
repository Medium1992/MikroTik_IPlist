...
:do {add list=$AddressList comment=AS201917 address=139.47.179.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=139.47.196.0/22} on-error {}
...
:do {add list=$AddressList comment=AS201917 address=37.25.147.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=37.25.148.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=37.25.168.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=37.25.171.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=37.25.244.0/24} on-error {}
...
:do {add list=$AddressList comment=AS201917 address=46.190.223.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=47.73.114.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=47.73.141.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=47.73.146.0/24} on-error {}
:do {add list=$AddressList comment=AS201917 address=47.73.212.0/24} on-error {}
