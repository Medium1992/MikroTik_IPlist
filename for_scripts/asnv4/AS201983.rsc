...
:do {add list=$AddressList comment=AS201983 address=192.165.46.0/24} on-error {}
:do {add list=$AddressList comment=AS201983 address=193.235.198.0/23} on-error {}
...
:do {add list=$AddressList comment=AS201983 address=194.103.134.0/23} on-error {}
