...
:if ([:len [find where list=$AddressList and address=31.179.229.0/24]] = 0) do={ add list=$AddressList comment=AS201990 address=31.179.229.0/24 }
...
:if ([:len [find where list=$AddressList and address=94.75.82.0/23]] = 0) do={ add list=$AddressList comment=AS201990 address=94.75.82.0/23 }
