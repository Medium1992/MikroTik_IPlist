...
:if ([:len [find where list=$AddressList and address=169.128.224.0/23]] = 0) do={ add list=$AddressList comment=AS20200 address=169.128.224.0/23 }
:if ([:len [find where list=$AddressList and address=169.128.227.0/24]] = 0) do={ add list=$AddressList comment=AS20200 address=169.128.227.0/24 }
