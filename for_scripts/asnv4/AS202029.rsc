...
:do {add list=$AddressList comment=AS202029 address=195.8.110.0/24} on-error {}
...
:do {add list=$AddressList comment=AS202029 address=91.213.157.0/24} on-error {}
:do {add list=$AddressList comment=AS202029 address=91.213.167.0/24} on-error {}
