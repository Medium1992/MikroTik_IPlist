...
:if ([:len [find where list=$AddressList and address=104.255.129.0/24]] = 0) do={ add list=$AddressList comment=AS202087 address=104.255.129.0/24 }
:if ([:len [find where list=$AddressList and address=104.255.130.0/23]] = 0) do={ add list=$AddressList comment=AS202087 address=104.255.130.0/23 }
:if ([:len [find where list=$AddressList and address=104.255.132.0/22]] = 0) do={ add list=$AddressList comment=AS202087 address=104.255.132.0/22 }
