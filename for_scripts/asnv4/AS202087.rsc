...
:do {add list=$AddressList comment=AS202087 address=for_scripts/asnv4/AS202087.rsc} on-error {}
:do {add list=$AddressList comment=AS202087 address=104.255.129.0/24} on-error {}
:do {add list=$AddressList comment=AS202087 address=104.255.130.0/23} on-error {}
:do {add list=$AddressList comment=AS202087 address=104.255.132.0/22} on-error {}
