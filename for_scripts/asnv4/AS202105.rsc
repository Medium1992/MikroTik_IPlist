...
:do {add list=$AddressList comment=AS202105 address=for_scripts/asnv4/AS202105.rsc} on-error {}
...
:do {add list=$AddressList comment=AS202105 address=185.164.24.0/21} on-error {}
