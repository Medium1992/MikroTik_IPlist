...
:do {add list=$AddressList comment=AS202161 address=80.247.48.0/24} on-error {}
:do {add list=$AddressList comment=AS202161 address=80.247.50.0/23} on-error {}
:do {add list=$AddressList comment=AS202161 address=80.247.52.0/22} on-error {}
