...
:do {add list=$AddressList comment=AS202228 address=for_scripts/asnv4/AS202228.rsc} on-error {}
...
:do {add list=$AddressList comment=AS202228 address=91.106.26.0/23} on-error {}
...
:do {add list=$AddressList comment=AS202228 address=94.240.60.0/23} on-error {}
