...
:do {add list=$AddressList comment=AS20238 address=for_scripts/asnv4/AS20238.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20238 address=65.182.122.0/23} on-error {}
