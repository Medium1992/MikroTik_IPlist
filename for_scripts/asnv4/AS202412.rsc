...
:if ([:len [find where list=$AddressList and address=45.74.20.0/24]] = 0) do={ add list=$AddressList comment=AS202412 address=45.74.20.0/24 }
...
:if ([:len [find where list=$AddressList and address=94.154.40.0/24]] = 0) do={ add list=$AddressList comment=AS202412 address=94.154.40.0/24 }
