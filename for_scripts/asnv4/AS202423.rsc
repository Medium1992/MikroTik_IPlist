...
:if ([:len [find where list=$AddressList and address=185.180.108.0/23]] = 0) do={ add list=$AddressList comment=AS202423 address=185.180.108.0/23 }
...
:if ([:len [find where list=$AddressList and address=193.233.72.0/24]] = 0) do={ add list=$AddressList comment=AS202423 address=193.233.72.0/24 }
...
:if ([:len [find where list=$AddressList and address=45.151.232.0/24]] = 0) do={ add list=$AddressList comment=AS202423 address=45.151.232.0/24 }
