...
:do {add list=$AddressList comment=AS20249 address=for_scripts/asnv4/AS20249.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20249 address=169.196.240.0/20} on-error {}
