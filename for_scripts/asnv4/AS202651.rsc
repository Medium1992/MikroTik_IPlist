...
:do {add list=$AddressList comment=AS202651 address=151.246.136.0/21} on-error {}
:do {add list=$AddressList comment=AS202651 address=176.105.236.0/24} on-error {}
...
:do {add list=$AddressList comment=AS202651 address=37.205.117.0/24} on-error {}
:do {add list=$AddressList comment=AS202651 address=37.205.118.0/23} on-error {}
