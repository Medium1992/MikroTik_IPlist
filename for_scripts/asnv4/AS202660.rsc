...
:if ([:len [find where list=$AddressList and address=109.94.172.0/23]] = 0) do={ add list=$AddressList comment=AS202660 address=109.94.172.0/23 }
...
:if ([:len [find where list=$AddressList and address=89.126.208.0/22]] = 0) do={ add list=$AddressList comment=AS202660 address=89.126.208.0/22 }
