...
:do {add list=$AddressList comment=AS202662 address=for_scripts/asnv4/AS202662.rsc} on-error {}
...
:do {add list=$AddressList comment=AS202662 address=89.185.24.0/21} on-error {}
