...
:do {add list=$AddressList comment=AS202662 address=222.167.198.0/24} on-error {}
:do {add list=$AddressList comment=AS202662 address=31.56.31.0/24} on-error {}
:do {add list=$AddressList comment=AS202662 address=38.150.12.0/22} on-error {}
:do {add list=$AddressList comment=AS202662 address=45.207.40.0/24} on-error {}
