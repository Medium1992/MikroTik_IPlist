...
:do {add list=$AddressList comment=AS202673 address=for_scripts/asnv4/AS202673.rsc} on-error {}
...
:do {add list=$AddressList comment=AS202673 address=191.101.251.0/24} on-error {}
