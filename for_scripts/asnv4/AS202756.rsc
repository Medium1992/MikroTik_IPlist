...
:do {add list=$AddressList comment=AS202756 address=62.4.112.0/23} on-error {}
:do {add list=$AddressList comment=AS202756 address=62.4.114.0/24} on-error {}
:do {add list=$AddressList comment=AS202756 address=62.4.117.0/24} on-error {}
:do {add list=$AddressList comment=AS202756 address=62.4.118.0/24} on-error {}
