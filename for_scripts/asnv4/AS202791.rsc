...
:if ([:len [find where list=$AddressList and address=178.95.242.0/24]] = 0) do={ add list=$AddressList comment=AS202791 address=178.95.242.0/24 }
...
:if ([:len [find where list=$AddressList and address=46.203.35.0/24]] = 0) do={ add list=$AddressList comment=AS202791 address=46.203.35.0/24 }
:if ([:len [find where list=$AddressList and address=92.113.136.0/24]] = 0) do={ add list=$AddressList comment=AS202791 address=92.113.136.0/24 }
:if ([:len [find where list=$AddressList and address=92.113.187.0/24]] = 0) do={ add list=$AddressList comment=AS202791 address=92.113.187.0/24 }
