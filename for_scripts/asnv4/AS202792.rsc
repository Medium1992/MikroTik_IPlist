...
:if ([:len [find where list=$AddressList and address=92.113.107.0/24]] = 0) do={ add list=$AddressList comment=AS202792 address=92.113.107.0/24 }
:if ([:len [find where list=$AddressList and address=92.113.175.0/24]] = 0) do={ add list=$AddressList comment=AS202792 address=92.113.175.0/24 }
