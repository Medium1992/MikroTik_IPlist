...
:if ([:len [find where list=$AddressList and address=192.145.55.0/24]] = 0) do={ add list=$AddressList comment=AS202831 address=192.145.55.0/24 }
...
:if ([:len [find where list=$AddressList and address=31.77.209.0/24]] = 0) do={ add list=$AddressList comment=AS202831 address=31.77.209.0/24 }
