...
:if ([:len [find where list=$AddressList and address=103.135.20.0/23]] = 0) do={ add list=$AddressList comment=AS203013 address=103.135.20.0/23 }
:if ([:len [find where list=$AddressList and address=103.135.22.0/24]] = 0) do={ add list=$AddressList comment=AS203013 address=103.135.22.0/24 }
