...
:do {add list=$AddressList comment=AS20303 address=for_scripts/asnv4/AS20303.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20303 address=38.143.240.0/26} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.240.112/29} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.240.120/30} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.240.125/32} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.240.126/31} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.240.128/25} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.240.64/27} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.240.96/28} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.241.0/24} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.242.0/23} on-error {}
:do {add list=$AddressList comment=AS20303 address=38.143.244.0/22} on-error {}
