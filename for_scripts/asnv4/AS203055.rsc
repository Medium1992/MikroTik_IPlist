...
:if ([:len [find where list=$AddressList and address=31.216.144.0/23]] = 0) do={ add list=$AddressList comment=AS203055 address=31.216.144.0/23 }
:if ([:len [find where list=$AddressList and address=31.216.147.0/24]] = 0) do={ add list=$AddressList comment=AS203055 address=31.216.147.0/24 }
