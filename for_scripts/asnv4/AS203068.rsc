...
:do {add list=$AddressList comment=AS203068 address=for_scripts/asnv4/AS203068.rsc} on-error {}
...
:do {add list=$AddressList comment=AS203068 address=5.59.77.0/24} on-error {}
