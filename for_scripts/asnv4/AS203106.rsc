...
:do {add list=$AddressList comment=AS203106 address=46.203.251.0/24} on-error {}
...
:do {add list=$AddressList comment=AS203106 address=84.75.133.0/24} on-error {}
:do {add list=$AddressList comment=AS203106 address=91.124.13.0/24} on-error {}
