...
:do {add list=$AddressList comment=AS20312 address=for_scripts/asnv4/AS20312.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20312 address=150.186.64.0/18} on-error {}
