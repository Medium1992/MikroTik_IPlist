...
:do {add list=$AddressList comment=AS203273 address=213.176.92.0/24} on-error {}
:do {add list=$AddressList comment=AS203273 address=213.176.95.0/24} on-error {}
...
:do {add list=$AddressList comment=AS203273 address=83.147.222.0/24} on-error {}
