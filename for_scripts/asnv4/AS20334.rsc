...
:if ([:len [find where list=$AddressList and address=50.21.212.0/22]] = 0) do={ add list=$AddressList comment=AS20334 address=50.21.212.0/22 }
:if ([:len [find where list=$AddressList and address=50.21.220.0/23]] = 0) do={ add list=$AddressList comment=AS20334 address=50.21.220.0/23 }
