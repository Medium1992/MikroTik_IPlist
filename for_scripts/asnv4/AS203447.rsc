...
:do {add list=$AddressList comment=AS203447 address=185.32.63.0/24} on-error {}
:do {add list=$AddressList comment=AS203447 address=91.210.117.0/24} on-error {}
:do {add list=$AddressList comment=AS203447 address=91.210.118.0/23} on-error {}
...
:do {add list=$AddressList comment=AS203447 address=91.237.126.0/23} on-error {}
