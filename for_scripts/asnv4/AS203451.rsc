...
:do {add list=$AddressList comment=AS203451 address=194.147.50.0/24} on-error {}
:do {add list=$AddressList comment=AS203451 address=194.50.170.0/23} on-error {}
:do {add list=$AddressList comment=AS203451 address=2.56.24.0/23} on-error {}
:do {add list=$AddressList comment=AS203451 address=2.56.26.0/24} on-error {}
...
:do {add list=$AddressList comment=AS203451 address=85.193.64.0/22} on-error {}
:do {add list=$AddressList comment=AS203451 address=95.81.88.0/24} on-error {}
