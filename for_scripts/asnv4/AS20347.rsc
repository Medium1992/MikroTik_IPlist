...
:do {add list=$AddressList comment=AS20347 address=for_scripts/asnv4/AS20347.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20347 address=24.51.30.0/24} on-error {}
...
:do {add list=$AddressList comment=AS20347 address=66.22.136.0/23} on-error {}
:do {add list=$AddressList comment=AS20347 address=66.22.138.0/24} on-error {}
:do {add list=$AddressList comment=AS20347 address=66.22.140.0/22} on-error {}
