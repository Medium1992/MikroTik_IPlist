...
:do {add list=$AddressList comment=AS20347 address=66.22.132.0/23} on-error {}
:do {add list=$AddressList comment=AS20347 address=66.22.135.0/24} on-error {}
...
:do {add list=$AddressList comment=AS20347 address=66.22.152.0/24} on-error {}
