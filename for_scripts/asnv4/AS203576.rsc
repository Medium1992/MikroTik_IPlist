...
:do {add list=$AddressList comment=AS203576 address=for_scripts/asnv4/AS203576.rsc} on-error {}
...
:do {add list=$AddressList comment=AS203576 address=185.173.145.0/24} on-error {}
