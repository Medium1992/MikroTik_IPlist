...
:do {add list=$AddressList comment=AS203758 address=108.186.202.0/24} on-error {}
...
:do {add list=$AddressList comment=AS203758 address=178.214.209.0/24} on-error {}
:do {add list=$AddressList comment=AS203758 address=178.214.223.0/24} on-error {}
...
:do {add list=$AddressList comment=AS203758 address=195.58.134.0/24} on-error {}
:do {add list=$AddressList comment=AS203758 address=195.72.166.0/24} on-error {}
...
:do {add list=$AddressList comment=AS203758 address=62.141.62.0/24} on-error {}
:do {add list=$AddressList comment=AS203758 address=82.153.70.0/24} on-error {}
:do {add list=$AddressList comment=AS203758 address=82.38.2.0/24} on-error {}
