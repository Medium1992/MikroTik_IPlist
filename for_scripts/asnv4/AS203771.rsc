...
:if ([:len [find where list=$AddressList and address=176.53.35.0/24]] = 0) do={ add list=$AddressList comment=AS203771 address=176.53.35.0/24 }
:if ([:len [find where list=$AddressList and address=176.53.36.0/24]] = 0) do={ add list=$AddressList comment=AS203771 address=176.53.36.0/24 }
