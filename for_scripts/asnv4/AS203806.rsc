...
:do {add list=$AddressList comment=AS203806 address=195.209.50.0/24} on-error {}
:do {add list=$AddressList comment=AS203806 address=46.22.50.0/23} on-error {}
:do {add list=$AddressList comment=AS203806 address=46.22.52.0/24} on-error {}
:do {add list=$AddressList comment=AS203806 address=46.22.54.0/24} on-error {}
