...
:if ([:len [find where list=$AddressList and address=64.28.113.0/24]] = 0) do={ add list=$AddressList comment=AS20385 address=64.28.113.0/24 }
...
:if ([:len [find where list=$AddressList and address=64.28.118.0/23]] = 0) do={ add list=$AddressList comment=AS20385 address=64.28.118.0/23 }
