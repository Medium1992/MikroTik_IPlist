...
:if ([:len [find where list=$AddressList and address=64.28.112.0/23]] = 0) do={ add list=$AddressList comment=AS20385 address=64.28.112.0/23 }
...
:if ([:len [find where list=$AddressList and address=64.28.116.0/22]] = 0) do={ add list=$AddressList comment=AS20385 address=64.28.116.0/22 }
...
:if ([:len [find where list=$AddressList and address=64.28.125.0/24]] = 0) do={ add list=$AddressList comment=AS20385 address=64.28.125.0/24 }
