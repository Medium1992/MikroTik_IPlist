...
:if ([:len [find where list=$AddressList and address=154.13.149.0/24]] = 0) do={ add list=$AddressList comment=AS203919 address=154.13.149.0/24 }
...
:if ([:len [find where list=$AddressList and address=154.46.30.0/24]] = 0) do={ add list=$AddressList comment=AS203919 address=154.46.30.0/24 }
...
:if ([:len [find where list=$AddressList and address=217.217.225.0/24]] = 0) do={ add list=$AddressList comment=AS203919 address=217.217.225.0/24 }
...
:if ([:len [find where list=$AddressList and address=5.10.250.0/23]] = 0) do={ add list=$AddressList comment=AS203919 address=5.10.250.0/23 }
...
:if ([:len [find where list=$AddressList and address=80.91.79.0/24]] = 0) do={ add list=$AddressList comment=AS203919 address=80.91.79.0/24 }
