...
:do {add list=$AddressList comment=AS20398 address=for_scripts/asnv4/AS20398.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20398 address=23.235.48.0/23} on-error {}
