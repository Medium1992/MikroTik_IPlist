...
:do {add list=$AddressList comment=AS204044 address=164.37.96.0/20} on-error {}
...
:do {add list=$AddressList comment=AS204044 address=213.193.252.0/22} on-error {}
:do {add list=$AddressList comment=AS204044 address=213.210.58.0/24} on-error {}
:do {add list=$AddressList comment=AS204044 address=217.179.220.0/22} on-error {}
