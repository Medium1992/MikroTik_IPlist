...
:do {add list=$AddressList comment=AS204044 address=for_scripts/asnv4/AS204044.rsc} on-error {}
...
:do {add list=$AddressList comment=AS204044 address=79.99.146.0/24} on-error {}
