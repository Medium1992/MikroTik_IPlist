...
:do {add list=$AddressList comment=AS204044 address=212.134.175.0/24} on-error {}
...
:do {add list=$AddressList comment=AS204044 address=45.206.3.0/24} on-error {}
:do {add list=$AddressList comment=AS204044 address=45.206.5.0/24} on-error {}
