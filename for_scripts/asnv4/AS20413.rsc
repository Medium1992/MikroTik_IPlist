...
:do {add list=$AddressList comment=AS20413 address=204.108.192.0/22} on-error {}
:do {add list=$AddressList comment=AS20413 address=204.108.196.0/24} on-error {}
:do {add list=$AddressList comment=AS20413 address=204.108.198.0/23} on-error {}
:do {add list=$AddressList comment=AS20413 address=204.108.200.0/21} on-error {}
