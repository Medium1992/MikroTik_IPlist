...
:if ([:len [find where list=$AddressList and address=153.79.180.0/23]] = 0) do={ add list=$AddressList comment=AS204490 address=153.79.180.0/23 }
...
:if ([:len [find where list=$AddressList and address=161.104.88.0/23]] = 0) do={ add list=$AddressList comment=AS204490 address=161.104.88.0/23 }
:if ([:len [find where list=$AddressList and address=161.104.90.0/24]] = 0) do={ add list=$AddressList comment=AS204490 address=161.104.90.0/24 }
