...
:do {add list=$AddressList comment=AS204607 address=for_scripts/asnv4/AS204607.rsc} on-error {}
:do {add list=$AddressList comment=AS204607 address=193.26.218.0/24} on-error {}
