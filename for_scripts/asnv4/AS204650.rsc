...
:do {add list=$AddressList comment=AS204650 address=178.239.155.0/24} on-error {}
...
:do {add list=$AddressList comment=AS204650 address=185.215.228.0/24} on-error {}
...
:do {add list=$AddressList comment=AS204650 address=37.32.40.0/23} on-error {}
