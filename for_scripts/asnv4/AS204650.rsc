...
:do {add list=$AddressList comment=AS204650 address=for_scripts/asnv4/AS204650.rsc} on-error {}
:do {add list=$AddressList comment=AS204650 address=178.239.156.0/24} on-error {}
:do {add list=$AddressList comment=AS204650 address=178.239.159.0/24} on-error {}
...
:do {add list=$AddressList comment=AS204650 address=185.124.173.0/24} on-error {}
...
:do {add list=$AddressList comment=AS204650 address=185.26.34.0/23} on-error {}
:do {add list=$AddressList comment=AS204650 address=185.82.136.0/22} on-error {}
:do {add list=$AddressList comment=AS204650 address=2.189.96.0/19} on-error {}
