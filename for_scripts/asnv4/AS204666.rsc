...
:do {add list=$AddressList comment=AS204666 address=185.64.220.0/22} on-error {}
...
:do {add list=$AddressList comment=AS204666 address=85.255.88.0/22} on-error {}
:do {add list=$AddressList comment=AS204666 address=91.224.90.0/23} on-error {}
