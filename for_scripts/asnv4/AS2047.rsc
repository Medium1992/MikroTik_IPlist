...
:if ([:len [find where list=$AddressList and address=192.104.72.0/24]] = 0) do={ add list=$AddressList comment=AS2047 address=192.104.72.0/24 }
...
:if ([:len [find where list=$AddressList and address=194.147.45.0/24]] = 0) do={ add list=$AddressList comment=AS2047 address=194.147.45.0/24 }
...
:if ([:len [find where list=$AddressList and address=203.135.189.0/24]] = 0) do={ add list=$AddressList comment=AS2047 address=203.135.189.0/24 }
:if ([:len [find where list=$AddressList and address=204.17.168.0/24]] = 0) do={ add list=$AddressList comment=AS2047 address=204.17.168.0/24 }
:if ([:len [find where list=$AddressList and address=206.53.226.0/23]] = 0) do={ add list=$AddressList comment=AS2047 address=206.53.226.0/23 }
