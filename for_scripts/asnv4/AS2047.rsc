...
:do {add list=$AddressList comment=AS2047 address=141.167.1.0/24} on-error {}
:do {add list=$AddressList comment=AS2047 address=141.167.128.0/17} on-error {}
:do {add list=$AddressList comment=AS2047 address=141.167.16.0/20} on-error {}
:do {add list=$AddressList comment=AS2047 address=141.167.2.0/23} on-error {}
:do {add list=$AddressList comment=AS2047 address=141.167.32.0/19} on-error {}
:do {add list=$AddressList comment=AS2047 address=141.167.4.0/22} on-error {}
:do {add list=$AddressList comment=AS2047 address=141.167.64.0/18} on-error {}
:do {add list=$AddressList comment=AS2047 address=141.167.8.0/21} on-error {}
