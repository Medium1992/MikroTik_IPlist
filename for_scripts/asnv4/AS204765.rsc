...
:if ([:len [find where list=$AddressList and address=119.59.136.0/22]] = 0) do={ add list=$AddressList comment=AS204765 address=119.59.136.0/22 }
:if ([:len [find where list=$AddressList and address=123.98.68.0/22]] = 0) do={ add list=$AddressList comment=AS204765 address=123.98.68.0/22 }
:if ([:len [find where list=$AddressList and address=123.98.72.0/22]] = 0) do={ add list=$AddressList comment=AS204765 address=123.98.72.0/22 }
...
:if ([:len [find where list=$AddressList and address=143.20.121.0/24]] = 0) do={ add list=$AddressList comment=AS204765 address=143.20.121.0/24 }
:if ([:len [find where list=$AddressList and address=151.247.139.0/24]] = 0) do={ add list=$AddressList comment=AS204765 address=151.247.139.0/24 }
...
:if ([:len [find where list=$AddressList and address=162.223.195.0/24]] = 0) do={ add list=$AddressList comment=AS204765 address=162.223.195.0/24 }
...
:if ([:len [find where list=$AddressList and address=167.148.197.0/24]] = 0) do={ add list=$AddressList comment=AS204765 address=167.148.197.0/24 }
...
:if ([:len [find where list=$AddressList and address=178.95.190.0/24]] = 0) do={ add list=$AddressList comment=AS204765 address=178.95.190.0/24 }
...
:if ([:len [find where list=$AddressList and address=66.92.24.0/24]] = 0) do={ add list=$AddressList comment=AS204765 address=66.92.24.0/24 }
