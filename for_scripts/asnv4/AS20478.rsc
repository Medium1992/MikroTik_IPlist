...
:do {add list=$AddressList comment=AS20478 address=for_scripts/asnv4/AS20478.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20478 address=153.13.32.0/22} on-error {}
:do {add list=$AddressList comment=AS20478 address=153.13.36.0/24} on-error {}
:do {add list=$AddressList comment=AS20478 address=153.13.38.0/23} on-error {}
:do {add list=$AddressList comment=AS20478 address=153.13.40.0/21} on-error {}
:do {add list=$AddressList comment=AS20478 address=153.13.48.0/20} on-error {}
