...
:if ([:len [find where list=$AddressList and address=114.128.16.0/23]] = 0) do={ add list=$AddressList comment=AS204889 address=114.128.16.0/23 }
...
:if ([:len [find where list=$AddressList and address=204.187.248.0/23]] = 0) do={ add list=$AddressList comment=AS204889 address=204.187.248.0/23 }
