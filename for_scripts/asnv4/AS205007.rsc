...
:do {add list=$AddressList comment=AS205007 address=for_scripts/asnv4/AS205007.rsc} on-error {}
:do {add list=$AddressList comment=AS205007 address=185.48.250.0/24} on-error {}
