...
:do {add list=$AddressList comment=AS205080 address=for_scripts/asnv4/AS205080.rsc} on-error {}
...
:do {add list=$AddressList comment=AS205080 address=57.188.19.0/24} on-error {}
