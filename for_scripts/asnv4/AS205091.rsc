...
:if ([:len [find where list=$AddressList and address=103.41.44.0/23]] = 0) do={ add list=$AddressList comment=AS205091 address=103.41.44.0/23 }
:if ([:len [find where list=$AddressList and address=103.47.56.0/24]] = 0) do={ add list=$AddressList comment=AS205091 address=103.47.56.0/24 }
:if ([:len [find where list=$AddressList and address=124.158.100.0/24]] = 0) do={ add list=$AddressList comment=AS205091 address=124.158.100.0/24 }
