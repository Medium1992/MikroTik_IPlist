...
:do {add list=$AddressList comment=AS205185 address=91.231.4.0/23} on-error {}
:do {add list=$AddressList comment=AS205185 address=91.231.6.0/24} on-error {}
:do {add list=$AddressList comment=AS205185 address=93.187.48.0/24} on-error {}
