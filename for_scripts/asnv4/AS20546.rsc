...
:do {add list=$AddressList comment=AS20546 address=195.94.88.0/24} on-error {}
:do {add list=$AddressList comment=AS20546 address=195.94.90.0/24} on-error {}
:do {add list=$AddressList comment=AS20546 address=217.26.63.0/24} on-error {}
...
:do {add list=$AddressList comment=AS20546 address=62.40.0.0/24} on-error {}
