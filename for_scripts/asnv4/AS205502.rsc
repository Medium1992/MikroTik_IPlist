...
:if ([:len [find where list=$AddressList and address=92.112.106.0/23]] = 0) do={ add list=$AddressList comment=AS205502 address=92.112.106.0/23 }
:if ([:len [find where list=$AddressList and address=92.113.173.0/24]] = 0) do={ add list=$AddressList comment=AS205502 address=92.113.173.0/24 }
