...
:if ([:len [find where list=$AddressList and address=216.23.104.0/24]] = 0) do={ add list=$AddressList comment=AS205548 address=216.23.104.0/24 }
...
:if ([:len [find where list=$AddressList and address=216.23.81.0/24]] = 0) do={ add list=$AddressList comment=AS205548 address=216.23.81.0/24 }
