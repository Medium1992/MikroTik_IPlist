...
:if ([:len [find where list=$AddressList and address=216.23.104.0/22]] = 0) do={ add list=$AddressList comment=AS205548 address=216.23.104.0/22 }
...
:if ([:len [find where list=$AddressList and address=216.23.96.0/22]] = 0) do={ add list=$AddressList comment=AS205548 address=216.23.96.0/22 }
