...
:do {add list=$AddressList comment=AS205638 address=157.22.224.0/24} on-error {}
:do {add list=$AddressList comment=AS205638 address=157.22.226.0/24} on-error {}
:do {add list=$AddressList comment=AS205638 address=185.211.156.0/22} on-error {}
:do {add list=$AddressList comment=AS205638 address=193.143.64.0/22} on-error {}
