...
:do {add list=$AddressList comment=AS205647 address=for_scripts/asnv4/AS205647.rsc} on-error {}
...
:do {add list=$AddressList comment=AS205647 address=37.148.88.0/22} on-error {}
