...
:if ([:len [find where list=$AddressList and address=153.79.168.0/24]] = 0) do={ add list=$AddressList comment=AS205719 address=153.79.168.0/24 }
:if ([:len [find where list=$AddressList and address=153.79.170.0/24]] = 0) do={ add list=$AddressList comment=AS205719 address=153.79.170.0/24 }
