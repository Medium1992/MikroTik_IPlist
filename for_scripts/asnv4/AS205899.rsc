...
:do {add list=$AddressList comment=AS205899 address=178.239.150.0/24} on-error {}
:do {add list=$AddressList comment=AS205899 address=185.113.10.0/24} on-error {}
:do {add list=$AddressList comment=AS205899 address=185.124.174.0/24} on-error {}
...
:do {add list=$AddressList comment=AS205899 address=185.26.33.0/24} on-error {}
:do {add list=$AddressList comment=AS205899 address=194.117.64.0/24} on-error {}
...
:do {add list=$AddressList comment=AS205899 address=45.135.195.0/24} on-error {}
