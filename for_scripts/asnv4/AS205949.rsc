...
:do {add list=$AddressList comment=AS205949 address=for_scripts/asnv4/AS205949.rsc} on-error {}
...
:do {add list=$AddressList comment=AS205949 address=143.20.11.0/24} on-error {}
...
:do {add list=$AddressList comment=AS205949 address=23.168.88.0/24} on-error {}
