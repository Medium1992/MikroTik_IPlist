...
:if ([:len [find where list=$AddressList and address=103.254.74.0/24]] = 0) do={ add list=$AddressList comment=AS205960 address=103.254.74.0/24 }
...
:if ([:len [find where list=$AddressList and address=193.239.151.0/24]] = 0) do={ add list=$AddressList comment=AS205960 address=193.239.151.0/24 }
...
:if ([:len [find where list=$AddressList and address=194.150.73.0/24]] = 0) do={ add list=$AddressList comment=AS205960 address=194.150.73.0/24 }
:if ([:len [find where list=$AddressList and address=2.59.153.0/24]] = 0) do={ add list=$AddressList comment=AS205960 address=2.59.153.0/24 }
...
:if ([:len [find where list=$AddressList and address=91.108.247.0/24]] = 0) do={ add list=$AddressList comment=AS205960 address=91.108.247.0/24 }
