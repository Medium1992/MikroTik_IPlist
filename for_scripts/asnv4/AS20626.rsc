...
:do {add list=$AddressList comment=AS20626 address=for_scripts/asnv4/AS20626.rsc} on-error {}
:do {add list=$AddressList comment=AS20626 address=185.75.40.0/22} on-error {}
:do {add list=$AddressList comment=AS20626 address=192.165.46.0/23} on-error {}
:do {add list=$AddressList comment=AS20626 address=193.183.240.0/21} on-error {}
:do {add list=$AddressList comment=AS20626 address=193.235.236.0/24} on-error {}
