...
:if ([:len [find where list=$AddressList and address=188.119.156.0/23]] = 0) do={ add list=$AddressList comment=AS206273 address=188.119.156.0/23 }
...
:if ([:len [find where list=$AddressList and address=64.43.77.0/24]] = 0) do={ add list=$AddressList comment=AS206273 address=64.43.77.0/24 }
:if ([:len [find where list=$AddressList and address=64.43.98.0/23]] = 0) do={ add list=$AddressList comment=AS206273 address=64.43.98.0/23 }
