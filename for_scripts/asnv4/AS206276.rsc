...
:do {add list=$AddressList comment=AS206276 address=193.38.144.0/23} on-error {}
:do {add list=$AddressList comment=AS206276 address=193.38.146.0/24} on-error {}
...
:do {add list=$AddressList comment=AS206276 address=81.172.37.0/24} on-error {}
:do {add list=$AddressList comment=AS206276 address=81.172.38.0/23} on-error {}
