...
:do {add list=$AddressList comment=AS206320 address=for_scripts/asnv4/AS206320.rsc} on-error {}
...
:do {add list=$AddressList comment=AS206320 address=94.246.127.0/24} on-error {}
