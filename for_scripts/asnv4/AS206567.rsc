...
:do {add list=$AddressList comment=AS206567 address=for_scripts/asnv4/AS206567.rsc} on-error {}
...
:do {add list=$AddressList comment=AS206567 address=194.124.242.0/24} on-error {}
