...
:do {add list=$AddressList comment=AS20661 address=for_scripts/asnv4/AS20661.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20661 address=95.85.120.0/21} on-error {}
