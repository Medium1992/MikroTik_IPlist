...
:if ([:len [find where list=$AddressList and address=103.140.186.0/23]] = 0) do={ add list=$AddressList comment=AS206804 address=103.140.186.0/23 }
:if ([:len [find where list=$AddressList and address=141.98.212.0/22]] = 0) do={ add list=$AddressList comment=AS206804 address=141.98.212.0/22 }
...
:if ([:len [find where list=$AddressList and address=195.80.148.0/22]] = 0) do={ add list=$AddressList comment=AS206804 address=195.80.148.0/22 }
:if ([:len [find where list=$AddressList and address=198.181.163.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=198.181.163.0/24 }
:if ([:len [find where list=$AddressList and address=199.33.70.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=199.33.70.0/24 }
:if ([:len [find where list=$AddressList and address=203.0.9.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=203.0.9.0/24 }
:if ([:len [find where list=$AddressList and address=216.131.121.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=216.131.121.0/24 }
:if ([:len [find where list=$AddressList and address=37.0.12.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=37.0.12.0/24 }
:if ([:len [find where list=$AddressList and address=37.77.56.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=37.77.56.0/24 }
:if ([:len [find where list=$AddressList and address=37.77.60.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=37.77.60.0/24 }
:if ([:len [find where list=$AddressList and address=37.77.62.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=37.77.62.0/24 }
:if ([:len [find where list=$AddressList and address=45.128.132.0/22]] = 0) do={ add list=$AddressList comment=AS206804 address=45.128.132.0/22 }
...
:if ([:len [find where list=$AddressList and address=85.203.39.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=85.203.39.0/24 }
:if ([:len [find where list=$AddressList and address=91.196.68.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=91.196.68.0/24 }
:if ([:len [find where list=$AddressList and address=91.196.70.0/24]] = 0) do={ add list=$AddressList comment=AS206804 address=91.196.70.0/24 }
