...
:do {add list=$AddressList comment=AS206854 address=93.126.27.0/24} on-error {}
...
:do {add list=$AddressList comment=AS206854 address=94.139.184.0/23} on-error {}
:do {add list=$AddressList comment=AS206854 address=94.139.186.0/24} on-error {}
:do {add list=$AddressList comment=AS206854 address=94.139.188.0/24} on-error {}
