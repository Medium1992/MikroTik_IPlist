...
:do {add list=$AddressList comment=AS207019 address=151.246.156.0/24} on-error {}
:do {add list=$AddressList comment=AS207019 address=151.246.158.0/24} on-error {}
...
:do {add list=$AddressList comment=AS207019 address=51.241.137.0/24} on-error {}
