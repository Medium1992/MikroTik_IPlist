...
:do {add list=$AddressList comment=AS207083 address=for_scripts/asnv4/AS207083.rsc} on-error {}
...
:do {add list=$AddressList comment=AS207083 address=69.174.98.0/23} on-error {}
