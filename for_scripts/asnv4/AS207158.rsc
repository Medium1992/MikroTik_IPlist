...
:if ([:len [find where list=$AddressList and address=178.92.234.0/24]] = 0) do={ add list=$AddressList comment=AS207158 address=178.92.234.0/24 }
...
:if ([:len [find where list=$AddressList and address=46.202.226.0/24]] = 0) do={ add list=$AddressList comment=AS207158 address=46.202.226.0/24 }
