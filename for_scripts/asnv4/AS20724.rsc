...
:do {add list=$AddressList comment=AS20724 address=185.130.89.0/24} on-error {}
:do {add list=$AddressList comment=AS20724 address=185.244.104.0/24} on-error {}
...
:do {add list=$AddressList comment=AS20724 address=195.182.25.0/24} on-error {}
