...
:do {add list=$AddressList comment=AS207326 address=for_scripts/asnv4/AS207326.rsc} on-error {}
...
:do {add list=$AddressList comment=AS207326 address=78.135.67.0/24} on-error {}
