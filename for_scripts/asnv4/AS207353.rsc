...
:do {add list=$AddressList comment=AS207353 address=for_scripts/asnv4/AS207353.rsc} on-error {}
...
:do {add list=$AddressList comment=AS207353 address=77.220.217.0/24} on-error {}
