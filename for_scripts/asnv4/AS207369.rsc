...
:do {add list=$AddressList comment=AS207369 address=178.216.208.0/21} on-error {}
...
:do {add list=$AddressList comment=AS207369 address=91.205.48.0/22} on-error {}
:do {add list=$AddressList comment=AS207369 address=95.215.244.0/22} on-error {}
