...
:do {add list=$AddressList comment=AS207483 address=185.229.222.0/24} on-error {}
...
:do {add list=$AddressList comment=AS207483 address=89.33.12.0/24} on-error {}
:do {add list=$AddressList comment=AS207483 address=89.46.1.0/24} on-error {}
...
:do {add list=$AddressList comment=AS207483 address=94.177.122.0/24} on-error {}
