...
:do {add list=$AddressList comment=AS207483 address=87.76.143.0/24} on-error {}
:do {add list=$AddressList comment=AS207483 address=87.76.154.0/24} on-error {}
:do {add list=$AddressList comment=AS207483 address=87.76.156.0/24} on-error {}
