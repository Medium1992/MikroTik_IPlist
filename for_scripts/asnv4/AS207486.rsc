...
:do {add list=$AddressList comment=AS207486 address=for_scripts/asnv4/AS207486.rsc} on-error {}
...
:do {add list=$AddressList comment=AS207486 address=193.28.30.0/23} on-error {}
