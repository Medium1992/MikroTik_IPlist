...
:if ([:len [find where list=$AddressList and address=81.27.249.0/24]] = 0) do={ add list=$AddressList comment=AS20764 address=81.27.249.0/24 }
:if ([:len [find where list=$AddressList and address=81.27.250.0/23]] = 0) do={ add list=$AddressList comment=AS20764 address=81.27.250.0/23 }
:if ([:len [find where list=$AddressList and address=81.27.252.0/22]] = 0) do={ add list=$AddressList comment=AS20764 address=81.27.252.0/22 }
