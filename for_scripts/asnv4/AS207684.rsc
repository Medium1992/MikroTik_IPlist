...
:do {add list=$AddressList comment=AS207684 address=for_scripts/asnv4/AS207684.rsc} on-error {}
:do {add list=$AddressList comment=AS207684 address=193.59.14.0/23} on-error {}
