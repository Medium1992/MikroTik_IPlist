...
:if ([:len [find where list=$AddressList and address=167.17.36.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=167.17.36.0/23 }
:if ([:len [find where list=$AddressList and address=167.17.42.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=167.17.42.0/23 }
...
:if ([:len [find where list=$AddressList and address=206.245.140.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=206.245.140.0/23 }
:if ([:len [find where list=$AddressList and address=206.245.148.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=206.245.148.0/23 }
:if ([:len [find where list=$AddressList and address=78.17.174.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=78.17.174.0/23 }
:if ([:len [find where list=$AddressList and address=78.17.210.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=78.17.210.0/23 }
...
:if ([:len [find where list=$AddressList and address=78.17.94.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=78.17.94.0/23 }
:if ([:len [find where list=$AddressList and address=89.125.132.0/22]] = 0) do={ add list=$AddressList comment=AS207700 address=89.125.132.0/22 }
:if ([:len [find where list=$AddressList and address=89.125.182.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=89.125.182.0/23 }
...
:if ([:len [find where list=$AddressList and address=89.125.228.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=89.125.228.0/23 }
:if ([:len [find where list=$AddressList and address=89.125.232.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=89.125.232.0/23 }
:if ([:len [find where list=$AddressList and address=89.125.46.0/23]] = 0) do={ add list=$AddressList comment=AS207700 address=89.125.46.0/23 }
