...
:if ([:len [find where list=$AddressList and address=103.65.231.0/24]] = 0) do={ add list=$AddressList comment=AS207728 address=103.65.231.0/24 }
...
:if ([:len [find where list=$AddressList and address=138.226.220.0/24]] = 0) do={ add list=$AddressList comment=AS207728 address=138.226.220.0/24 }
:if ([:len [find where list=$AddressList and address=138.226.222.0/23]] = 0) do={ add list=$AddressList comment=AS207728 address=138.226.222.0/23 }
...
:if ([:len [find where list=$AddressList and address=185.204.55.0/24]] = 0) do={ add list=$AddressList comment=AS207728 address=185.204.55.0/24 }
