...
:do {add list=$AddressList comment=AS207728 address=138.226.220.0/23} on-error {}
:do {add list=$AddressList comment=AS207728 address=138.226.222.0/24} on-error {}
...
:do {add list=$AddressList comment=AS207728 address=62.171.228.0/24} on-error {}
:do {add list=$AddressList comment=AS207728 address=62.204.42.0/24} on-error {}
:do {add list=$AddressList comment=AS207728 address=85.136.112.0/24} on-error {}
:do {add list=$AddressList comment=AS207728 address=85.136.180.0/23} on-error {}
