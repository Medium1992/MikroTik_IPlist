...
:do {add list=$AddressList comment=AS207821 address=147.79.11.0/24} on-error {}
:do {add list=$AddressList comment=AS207821 address=147.79.12.0/23} on-error {}
:do {add list=$AddressList comment=AS207821 address=147.79.15.0/24} on-error {}
...
:do {add list=$AddressList comment=AS207821 address=82.139.214.0/24} on-error {}
:do {add list=$AddressList comment=AS207821 address=94.142.230.0/23} on-error {}
