...
:do {add list=$AddressList comment=AS208185 address=104.243.249.0/24} on-error {}
:do {add list=$AddressList comment=AS208185 address=104.250.171.0/24} on-error {}
:do {add list=$AddressList comment=AS208185 address=104.250.176.0/24} on-error {}
:do {add list=$AddressList comment=AS208185 address=104.250.178.0/24} on-error {}
...
:do {add list=$AddressList comment=AS208185 address=206.123.136.0/24} on-error {}
