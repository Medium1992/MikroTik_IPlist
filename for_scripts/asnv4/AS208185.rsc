...
:do {add list=$AddressList comment=AS208185 address=13.143.137.0/24} on-error {}
...
:do {add list=$AddressList comment=AS208185 address=213.209.157.0/24} on-error {}
...
:do {add list=$AddressList comment=AS208185 address=89.43.41.0/24} on-error {}
