...
:do {add list=$AddressList comment=AS208208 address=for_scripts/asnv4/AS208208.rsc} on-error {}
...
:do {add list=$AddressList comment=AS208208 address=77.90.46.0/24} on-error {}
