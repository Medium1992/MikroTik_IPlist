...
:do {add list=$AddressList comment=AS208259 address=16.5.2.0/23} on-error {}
:do {add list=$AddressList comment=AS208259 address=16.5.200.0/23} on-error {}
...
:do {add list=$AddressList comment=AS208259 address=74.1.248.0/23} on-error {}
