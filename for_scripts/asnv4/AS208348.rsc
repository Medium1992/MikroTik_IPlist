...
:do {add list=$AddressList comment=AS208348 address=for_scripts/asnv4/AS208348.rsc} on-error {}
...
:do {add list=$AddressList comment=AS208348 address=195.88.180.0/24} on-error {}
