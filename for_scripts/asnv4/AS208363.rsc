...
:do {add list=$AddressList comment=AS208363 address=2.152.176.0/22} on-error {}
...
:do {add list=$AddressList comment=AS208363 address=45.144.92.0/23} on-error {}
:do {add list=$AddressList comment=AS208363 address=78.41.42.0/24} on-error {}
:do {add list=$AddressList comment=AS208363 address=89.37.232.0/23} on-error {}
:do {add list=$AddressList comment=AS208363 address=92.53.162.0/23} on-error {}
