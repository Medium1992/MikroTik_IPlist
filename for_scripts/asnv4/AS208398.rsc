...
:do {add list=$AddressList comment=AS208398 address=for_scripts/asnv4/AS208398.rsc} on-error {}
...
:do {add list=$AddressList comment=AS208398 address=5.45.213.0/24} on-error {}
