...
:do {add list=$AddressList comment=AS208570 address=195.69.228.0/24} on-error {}
:do {add list=$AddressList comment=AS208570 address=45.128.120.0/24} on-error {}
:do {add list=$AddressList comment=AS208570 address=45.128.122.0/24} on-error {}
:do {add list=$AddressList comment=AS208570 address=87.236.149.0/24} on-error {}
