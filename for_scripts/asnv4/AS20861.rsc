...
:do {add list=$AddressList comment=AS20861 address=for_scripts/asnv4/AS20861.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20861 address=80.67.192.0/21} on-error {}
