...
:if ([:len [find where list=$AddressList and address=178.214.110.0/24]] = 0) do={ add list=$AddressList comment=AS208673 address=178.214.110.0/24 }
...
:if ([:len [find where list=$AddressList and address=194.117.64.0/24]] = 0) do={ add list=$AddressList comment=AS208673 address=194.117.64.0/24 }
