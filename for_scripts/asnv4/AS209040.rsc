...
:do {add list=$AddressList comment=AS209040 address=for_scripts/asnv4/AS209040.rsc} on-error {}
...
:do {add list=$AddressList comment=AS209040 address=5.159.80.0/22} on-error {}
