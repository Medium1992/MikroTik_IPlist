...
:do {add list=$AddressList comment=AS20915 address=217.25.2.0/23} on-error {}
...
:do {add list=$AddressList comment=AS20915 address=87.254.10.0/24} on-error {}
:do {add list=$AddressList comment=AS20915 address=87.254.12.0/22} on-error {}
:do {add list=$AddressList comment=AS20915 address=87.254.2.0/24} on-error {}
:do {add list=$AddressList comment=AS20915 address=87.254.20.0/23} on-error {}
:do {add list=$AddressList comment=AS20915 address=87.254.22.0/24} on-error {}
