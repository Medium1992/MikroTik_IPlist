...
:do {add list=$AddressList comment=AS20915 address=for_scripts/asnv4/AS20915.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20915 address=87.254.14.0/23} on-error {}
