...
:do {add list=$AddressList comment=AS209155 address=158.173.161.0/24} on-error {}
...
:do {add list=$AddressList comment=AS209155 address=199.177.192.0/24} on-error {}
...
:do {add list=$AddressList comment=AS209155 address=91.211.88.0/22} on-error {}
