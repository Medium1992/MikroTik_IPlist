...
:if ([:len [find where list=$AddressList and address=185.147.100.0/24]] = 0) do={ add list=$AddressList comment=AS209193 address=185.147.100.0/24 }
:if ([:len [find where list=$AddressList and address=185.147.102.0/23]] = 0) do={ add list=$AddressList comment=AS209193 address=185.147.102.0/23 }
...
:if ([:len [find where list=$AddressList and address=5.231.246.0/23]] = 0) do={ add list=$AddressList comment=AS209193 address=5.231.246.0/23 }
