...
:do {add list=$AddressList comment=AS209207 address=147.45.39.0/24} on-error {}
:do {add list=$AddressList comment=AS209207 address=147.45.61.0/24} on-error {}
:do {add list=$AddressList comment=AS209207 address=147.45.63.0/24} on-error {}
:do {add list=$AddressList comment=AS209207 address=153.80.249.0/24} on-error {}
