...
:do {add list=$AddressList comment=AS20940 address=for_scripts/asnv4/AS20940_part11.rsc} on-error {}
...
:do {add list=$AddressList comment=AS20940 address=96.6.42.0/24} on-error {}
