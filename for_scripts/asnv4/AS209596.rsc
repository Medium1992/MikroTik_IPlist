...
:if ([:len [find where list=$AddressList and address=87.107.224.0/23]] = 0) do={ add list=$AddressList comment=AS209596 address=87.107.224.0/23 }
:if ([:len [find where list=$AddressList and address=87.107.226.0/24]] = 0) do={ add list=$AddressList comment=AS209596 address=87.107.226.0/24 }
