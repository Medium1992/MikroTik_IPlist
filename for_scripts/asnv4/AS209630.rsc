...
:if ([:len [find where list=$AddressList and address=185.218.138.0/24]] = 0) do={ add list=$AddressList comment=AS209630 address=185.218.138.0/24 }
:if ([:len [find where list=$AddressList and address=31.57.208.0/24]] = 0) do={ add list=$AddressList comment=AS209630 address=31.57.208.0/24 }
