...
:do {add list=$AddressList comment=AS209805 address=171.22.180.0/24} on-error {}
:do {add list=$AddressList comment=AS209805 address=185.120.56.0/24} on-error {}
:do {add list=$AddressList comment=AS209805 address=185.65.200.0/23} on-error {}
...
:do {add list=$AddressList comment=AS209805 address=212.22.78.0/24} on-error {}
