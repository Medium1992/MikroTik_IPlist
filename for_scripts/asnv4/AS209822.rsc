...
:do {add list=$AddressList comment=AS209822 address=for_scripts/asnv4/AS209822.rsc} on-error {}
:do {add list=$AddressList comment=AS209822 address=159.232.212.0/22} on-error {}
