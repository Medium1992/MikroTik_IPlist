...
:do {add list=$AddressList comment=AS209824 address=for_scripts/asnv4/AS209824.rsc} on-error {}
:do {add list=$AddressList comment=AS209824 address=154.197.70.0/24} on-error {}
:do {add list=$AddressList comment=AS209824 address=217.113.54.0/23} on-error {}
