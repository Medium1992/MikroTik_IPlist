...
:do {add list=$AddressList comment=AS210000 address=for_scripts/asnv4/AS210000.rsc} on-error {}
:do {add list=$AddressList comment=AS210000 address=160.250.164.0/23} on-error {}
:do {add list=$AddressList comment=AS210000 address=163.61.42.0/24} on-error {}
