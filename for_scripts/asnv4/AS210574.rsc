...
:if ([:len [find where list=$AddressList and address=141.98.112.0/24]] = 0) do={ add list=$AddressList comment=AS210574 address=141.98.112.0/24 }
:if ([:len [find where list=$AddressList and address=141.98.115.0/24]] = 0) do={ add list=$AddressList comment=AS210574 address=141.98.115.0/24 }
