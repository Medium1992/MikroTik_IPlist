...
:do {add list=$AddressList comment=AS21058 address=80.83.160.0/22} on-error {}
:do {add list=$AddressList comment=AS21058 address=80.83.164.0/23} on-error {}
:do {add list=$AddressList comment=AS21058 address=80.83.167.0/24} on-error {}
