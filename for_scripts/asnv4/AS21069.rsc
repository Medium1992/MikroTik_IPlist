...
:do {add list=$AddressList comment=AS21069 address=80.74.144.0/23} on-error {}
:do {add list=$AddressList comment=AS21069 address=80.74.147.0/24} on-error {}
:do {add list=$AddressList comment=AS21069 address=80.74.148.0/22} on-error {}
