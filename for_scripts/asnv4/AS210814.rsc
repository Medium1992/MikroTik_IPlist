...
:do {add list=$AddressList comment=AS210814 address=136.148.148.0/23} on-error {}
:do {add list=$AddressList comment=AS210814 address=136.148.150.0/24} on-error {}
...
:do {add list=$AddressList comment=AS210814 address=82.29.79.0/24} on-error {}
:do {add list=$AddressList comment=AS210814 address=87.83.84.0/24} on-error {}
