...
:do {add list=$AddressList comment=AS210873 address=for_scripts/asnv4/AS210873.rsc} on-error {}
:do {add list=$AddressList comment=AS210873 address=16.1.70.0/24} on-error {}
:do {add list=$AddressList comment=AS210873 address=16.10.1.0/24} on-error {}
