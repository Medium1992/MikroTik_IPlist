...
:do {add list=$AddressList comment=AS211077 address=for_scripts/asnv4/AS211077.rsc} on-error {}
:do {add list=$AddressList comment=AS211077 address=51.64.0.0/17} on-error {}
