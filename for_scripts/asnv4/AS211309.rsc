...
:do {add list=$AddressList comment=AS211309 address=for_scripts/asnv4/AS211309.rsc} on-error {}
...
:do {add list=$AddressList comment=AS211309 address=46.252.7.0/24} on-error {}
