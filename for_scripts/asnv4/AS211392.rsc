...
:if ([:len [find where list=$AddressList and address=203.168.130.0/23]] = 0) do={ add list=$AddressList comment=AS211392 address=203.168.130.0/23 }
:if ([:len [find where list=$AddressList and address=222.167.35.0/24]] = 0) do={ add list=$AddressList comment=AS211392 address=222.167.35.0/24 }
