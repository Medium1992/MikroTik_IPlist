...
:do {add list=$AddressList comment=AS211407 address=143.14.111.0/24} on-error {}
...
:do {add list=$AddressList comment=AS211407 address=38.109.212.0/24} on-error {}
...
:do {add list=$AddressList comment=AS211407 address=45.158.10.0/24} on-error {}
