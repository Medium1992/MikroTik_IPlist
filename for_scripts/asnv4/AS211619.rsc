...
:if ([:len [find where list=$AddressList and address=150.40.104.0/22]] = 0) do={ add list=$AddressList comment=AS211619 address=150.40.104.0/22 }
:if ([:len [find where list=$AddressList and address=150.40.108.0/24]] = 0) do={ add list=$AddressList comment=AS211619 address=150.40.108.0/24 }
...
:if ([:len [find where list=$AddressList and address=150.40.120.0/23]] = 0) do={ add list=$AddressList comment=AS211619 address=150.40.120.0/23 }
:if ([:len [find where list=$AddressList and address=150.40.123.0/24]] = 0) do={ add list=$AddressList comment=AS211619 address=150.40.123.0/24 }
:if ([:len [find where list=$AddressList and address=150.40.124.0/22]] = 0) do={ add list=$AddressList comment=AS211619 address=150.40.124.0/22 }
