...
:if ([:len [find where list=$AddressList and address=143.246.48.0/23]] = 0) do={ add list=$AddressList comment=AS211759 address=143.246.48.0/23 }
...
:if ([:len [find where list=$AddressList and address=74.52.20.0/24]] = 0) do={ add list=$AddressList comment=AS211759 address=74.52.20.0/24 }
