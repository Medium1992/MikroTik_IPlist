...
:do {add list=$AddressList comment=AS211871 address=for_scripts/asnv4/AS211871.rsc} on-error {}
...
:do {add list=$AddressList comment=AS211871 address=45.195.25.0/24} on-error {}
