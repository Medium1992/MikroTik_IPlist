...
:do {add list=$AddressList comment=AS211908 address=for_scripts/asnv4/AS211908.rsc} on-error {}
...
:do {add list=$AddressList comment=AS211908 address=204.157.176.0/23} on-error {}
...
:do {add list=$AddressList comment=AS211908 address=93.180.222.0/24} on-error {}
