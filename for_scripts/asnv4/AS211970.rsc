...
:do {add list=$AddressList comment=AS211970 address=for_scripts/asnv4/AS211970.rsc} on-error {}
...
:do {add list=$AddressList comment=AS211970 address=188.72.56.0/23} on-error {}
