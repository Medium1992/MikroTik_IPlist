...
:do {add list=$AddressList comment=AS21207 address=for_scripts/asnv4/AS21207.rsc} on-error {}
:do {add list=$AddressList comment=AS21207 address=153.100.0.0/17} on-error {}
:do {add list=$AddressList comment=AS21207 address=153.100.128.0/19} on-error {}
