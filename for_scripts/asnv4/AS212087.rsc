...
:do {add list=$AddressList comment=AS212087 address=149.71.40.0/24} on-error {}
...
:do {add list=$AddressList comment=AS212087 address=154.56.152.0/23} on-error {}
:do {add list=$AddressList comment=AS212087 address=154.56.156.0/22} on-error {}
