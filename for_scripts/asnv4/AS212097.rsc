...
:do {add list=$AddressList comment=AS212097 address=for_scripts/asnv4/AS212097.rsc} on-error {}
...
:do {add list=$AddressList comment=AS212097 address=45.81.88.0/22} on-error {}
