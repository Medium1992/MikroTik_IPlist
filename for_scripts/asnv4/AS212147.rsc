...
:if ([:len [find where list=$AddressList and address=194.26.137.0/24]] = 0) do={ add list=$AddressList comment=AS212147 address=194.26.137.0/24 }
:if ([:len [find where list=$AddressList and address=195.43.134.0/24]] = 0) do={ add list=$AddressList comment=AS212147 address=195.43.134.0/24 }
