...
:if ([:len [find where list=$AddressList and address=2.26.200.0/22]] = 0) do={ add list=$AddressList comment=AS212194 address=2.26.200.0/22 }
:if ([:len [find where list=$AddressList and address=2.26.204.0/23]] = 0) do={ add list=$AddressList comment=AS212194 address=2.26.204.0/23 }
:if ([:len [find where list=$AddressList and address=2.26.206.0/24]] = 0) do={ add list=$AddressList comment=AS212194 address=2.26.206.0/24 }
