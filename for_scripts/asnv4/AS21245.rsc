...
:do {add list=$AddressList comment=AS21245 address=for_scripts/asnv4/AS21245.rsc} on-error {}
:do {add list=$AddressList comment=AS21245 address=103.199.232.0/24} on-error {}
...
:do {add list=$AddressList comment=AS21245 address=185.201.196.0/23} on-error {}
:do {add list=$AddressList comment=AS21245 address=185.201.198.0/24} on-error {}
