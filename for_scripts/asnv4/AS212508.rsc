...
:do {add list=$AddressList comment=AS212508 address=for_scripts/asnv4/AS212508.rsc} on-error {}
:do {add list=$AddressList comment=AS212508 address=152.89.254.0/23} on-error {}
:do {add list=$AddressList comment=AS212508 address=176.97.212.0/24} on-error {}
