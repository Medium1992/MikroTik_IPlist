...
:do {add list=$AddressList comment=AS212628 address=38.207.152.0/22} on-error {}
:do {add list=$AddressList comment=AS212628 address=66.51.64.0/22} on-error {}
:do {add list=$AddressList comment=AS212628 address=66.51.68.0/23} on-error {}
:do {add list=$AddressList comment=AS212628 address=66.51.70.0/24} on-error {}
