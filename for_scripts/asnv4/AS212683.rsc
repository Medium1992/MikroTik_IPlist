...
:do {add list=$AddressList comment=AS212683 address=188.220.87.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=188.221.106.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=188.221.111.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=188.221.17.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=188.221.186.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=188.221.52.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=5.182.115.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=51.146.19.0/24} on-error {}
:do {add list=$AddressList comment=AS212683 address=51.194.132.0/23} on-error {}
:do {add list=$AddressList comment=AS212683 address=51.241.192.0/23} on-error {}
:do {add list=$AddressList comment=AS212683 address=51.241.195.0/24} on-error {}
...
:do {add list=$AddressList comment=AS212683 address=51.241.253.0/24} on-error {}
...
:do {add list=$AddressList comment=AS212683 address=94.193.32.0/20} on-error {}
