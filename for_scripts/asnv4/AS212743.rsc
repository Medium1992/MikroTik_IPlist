...
:do {add list=$AddressList comment=AS212743 address=31.59.161.0/24} on-error {}
:do {add list=$AddressList comment=AS212743 address=31.59.162.0/24} on-error {}
:do {add list=$AddressList comment=AS212743 address=31.59.164.0/24} on-error {}
