...
:if ([:len [find where list=$AddressList and address=2.27.249.0/24]] = 0) do={ add list=$AddressList comment=AS212743 address=2.27.249.0/24 }
...
:if ([:len [find where list=$AddressList and address=31.59.209.0/24]] = 0) do={ add list=$AddressList comment=AS212743 address=31.59.209.0/24 }
...
:if ([:len [find where list=$AddressList and address=94.183.198.0/24]] = 0) do={ add list=$AddressList comment=AS212743 address=94.183.198.0/24 }
