...
:if ([:len [find where list=$AddressList and address=79.175.70.0/24]] = 0) do={ add list=$AddressList comment=AS212895 address=79.175.70.0/24 }
:if ([:len [find where list=$AddressList and address=81.168.111.0/24]] = 0) do={ add list=$AddressList comment=AS212895 address=81.168.111.0/24 }
