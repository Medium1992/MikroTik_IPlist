...
:do {add list=$AddressList comment=AS212913 address=130.49.186.0/24} on-error {}
:do {add list=$AddressList comment=AS212913 address=170.168.89.0/24} on-error {}
...
:do {add list=$AddressList comment=AS212913 address=91.242.236.0/24} on-error {}
