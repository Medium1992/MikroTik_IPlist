...
:do {add list=$AddressList comment=AS213001 address=45.137.117.0/24} on-error {}
:do {add list=$AddressList comment=AS213001 address=45.146.160.0/23} on-error {}
:do {add list=$AddressList comment=AS213001 address=82.27.90.0/23} on-error {}
:do {add list=$AddressList comment=AS213001 address=82.41.245.0/24} on-error {}
