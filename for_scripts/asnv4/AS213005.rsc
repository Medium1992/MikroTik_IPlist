...
:do {add list=$AddressList comment=AS213005 address=for_scripts/asnv4/AS213005.rsc} on-error {}
...
:do {add list=$AddressList comment=AS213005 address=185.245.34.0/23} on-error {}
