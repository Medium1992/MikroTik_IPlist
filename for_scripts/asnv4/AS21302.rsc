...
:do {add list=$AddressList comment=AS21302 address=15.20.75.0/24} on-error {}
:do {add list=$AddressList comment=AS21302 address=15.20.76.0/22} on-error {}
:do {add list=$AddressList comment=AS21302 address=15.20.80.0/24} on-error {}
:do {add list=$AddressList comment=AS21302 address=15.20.82.0/23} on-error {}
