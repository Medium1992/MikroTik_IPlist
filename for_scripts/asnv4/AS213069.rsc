...
:if ([:len [find where list=$AddressList and address=195.234.191.0/24]] = 0) do={ add list=$AddressList comment=AS213069 address=195.234.191.0/24 }
:if ([:len [find where list=$AddressList and address=195.238.240.0/24]] = 0) do={ add list=$AddressList comment=AS213069 address=195.238.240.0/24 }
...
:if ([:len [find where list=$AddressList and address=91.192.160.0/24]] = 0) do={ add list=$AddressList comment=AS213069 address=91.192.160.0/24 }
...
:if ([:len [find where list=$AddressList and address=91.231.144.0/24]] = 0) do={ add list=$AddressList comment=AS213069 address=91.231.144.0/24 }
