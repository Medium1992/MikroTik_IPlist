...
:if ([:len [find where list=$AddressList and address=141.226.121.0/24]] = 0) do={ add list=$AddressList comment=AS213168 address=141.226.121.0/24 }
:if ([:len [find where list=$AddressList and address=141.226.122.0/24]] = 0) do={ add list=$AddressList comment=AS213168 address=141.226.122.0/24 }
