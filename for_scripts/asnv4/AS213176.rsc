...
:do {add list=$AddressList comment=AS213176 address=for_scripts/asnv4/AS213176.rsc} on-error {}
...
:do {add list=$AddressList comment=AS213176 address=209.35.240.0/21} on-error {}
:do {add list=$AddressList comment=AS213176 address=209.35.248.0/22} on-error {}
:do {add list=$AddressList comment=AS213176 address=209.35.252.0/24} on-error {}
