...
:do {add list=$AddressList comment=AS213176 address=209.35.231.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213176 address=209.35.236.0/24} on-error {}
:do {add list=$AddressList comment=AS213176 address=209.35.238.0/23} on-error {}
...
:do {add list=$AddressList comment=AS213176 address=85.155.128.0/23} on-error {}
