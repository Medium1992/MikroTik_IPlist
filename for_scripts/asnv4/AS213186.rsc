...
:do {add list=$AddressList comment=AS213186 address=for_scripts/asnv4/AS213186.rsc} on-error {}
...
:do {add list=$AddressList comment=AS213186 address=23.154.80.0/24} on-error {}
