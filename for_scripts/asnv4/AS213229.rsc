...
:if ([:len [find where list=$AddressList and address=144.31.31.0/24]] = 0) do={ add list=$AddressList comment=AS213229 address=144.31.31.0/24 }
...
:if ([:len [find where list=$AddressList and address=31.76.26.0/24]] = 0) do={ add list=$AddressList comment=AS213229 address=31.76.26.0/24 }
:if ([:len [find where list=$AddressList and address=64.188.88.0/24]] = 0) do={ add list=$AddressList comment=AS213229 address=64.188.88.0/24 }
