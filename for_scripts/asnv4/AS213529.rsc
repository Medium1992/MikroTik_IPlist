...
:do {add list=$AddressList comment=AS213529 address=140.235.130.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=147.45.216.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=193.5.251.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213529 address=216.162.44.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213529 address=31.76.126.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=31.77.67.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=50.114.102.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=50.114.115.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=50.114.58.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=77.90.158.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=77.90.183.0/24} on-error {}
:do {add list=$AddressList comment=AS213529 address=96.126.129.0/24} on-error {}
