...
:do {add list=$AddressList comment=AS213671 address=149.119.0.0/22} on-error {}
...
:do {add list=$AddressList comment=AS213671 address=38.44.104.0/22} on-error {}
:do {add list=$AddressList comment=AS213671 address=38.49.104.0/21} on-error {}
...
:do {add list=$AddressList comment=AS213671 address=95.142.148.0/24} on-error {}
