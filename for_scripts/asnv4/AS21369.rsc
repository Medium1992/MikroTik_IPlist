...
:do {add list=$AddressList comment=AS21369 address=for_scripts/asnv4/AS21369.rsc} on-error {}
:do {add list=$AddressList comment=AS21369 address=157.203.120.0/24} on-error {}
:do {add list=$AddressList comment=AS21369 address=157.203.142.0/24} on-error {}
