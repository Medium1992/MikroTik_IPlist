...
:do {add list=$AddressList comment=AS213690 address=104.234.25.0/24} on-error {}
:do {add list=$AddressList comment=AS213690 address=144.225.126.0/24} on-error {}
:do {add list=$AddressList comment=AS213690 address=146.103.34.0/24} on-error {}
:do {add list=$AddressList comment=AS213690 address=151.242.58.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213690 address=151.245.94.0/24} on-error {}
:do {add list=$AddressList comment=AS213690 address=151.247.146.0/24} on-error {}
:do {add list=$AddressList comment=AS213690 address=156.249.64.0/22} on-error {}
:do {add list=$AddressList comment=AS213690 address=168.222.81.0/24} on-error {}
:do {add list=$AddressList comment=AS213690 address=168.222.83.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213690 address=195.162.242.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213690 address=79.172.251.0/24} on-error {}
:do {add list=$AddressList comment=AS213690 address=89.213.134.0/24} on-error {}
