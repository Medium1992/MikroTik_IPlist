...
:do {add list=$AddressList comment=AS213702 address=168.222.254.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213702 address=194.238.57.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213702 address=89.125.171.0/24} on-error {}
