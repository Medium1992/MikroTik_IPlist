...
:do {add list=$AddressList comment=AS213705 address=206.15.48.0/20} on-error {}
:do {add list=$AddressList comment=AS213705 address=209.191.168.0/22} on-error {}
:do {add list=$AddressList comment=AS213705 address=211.149.36.0/22} on-error {}
:do {add list=$AddressList comment=AS213705 address=64.74.118.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=64.74.197.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=64.95.148.0/24} on-error {}
:do {add list=$AddressList comment=AS213705 address=64.95.48.0/24} on-error {}
