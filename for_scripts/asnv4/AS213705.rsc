...
:if ([:len [find where list=$AddressList and address=89.32.172.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=89.32.172.0/22 }
:if ([:len [find where list=$AddressList and address=93.118.176.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=93.118.176.0/22 }
:if ([:len [find where list=$AddressList and address=93.118.188.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=93.118.188.0/22 }
