...
:do {add list=$AddressList comment=AS213705 address=153.51.188.0/23} on-error {}
...
:do {add list=$AddressList comment=AS213705 address=153.51.40.0/22} on-error {}
:do {add list=$AddressList comment=AS213705 address=153.51.44.0/23} on-error {}
