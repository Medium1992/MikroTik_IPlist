...
:if ([:len [find where list=$AddressList and address=131.123.13.0/24]] = 0) do={ add list=$AddressList comment=AS213705 address=131.123.13.0/24 }
...
:if ([:len [find where list=$AddressList and address=131.123.22.0/24]] = 0) do={ add list=$AddressList comment=AS213705 address=131.123.22.0/24 }
...
:if ([:len [find where list=$AddressList and address=188.212.8.0/21]] = 0) do={ add list=$AddressList comment=AS213705 address=188.212.8.0/21 }
:if ([:len [find where list=$AddressList and address=188.213.220.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=188.213.220.0/22 }
:if ([:len [find where list=$AddressList and address=188.213.236.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=188.213.236.0/22 }
:if ([:len [find where list=$AddressList and address=188.213.244.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=188.213.244.0/22 }
:if ([:len [find where list=$AddressList and address=188.213.36.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=188.213.36.0/22 }
:if ([:len [find where list=$AddressList and address=188.213.52.0/22]] = 0) do={ add list=$AddressList comment=AS213705 address=188.213.52.0/22 }
