...
:do {add list=$AddressList comment=AS213784 address=for_scripts/asnv4/AS213784.rsc} on-error {}
:do {add list=$AddressList comment=AS213784 address=142.214.144.0/22} on-error {}
...
:do {add list=$AddressList comment=AS213784 address=83.147.232.0/22} on-error {}
:do {add list=$AddressList comment=AS213784 address=91.124.92.0/22} on-error {}
:do {add list=$AddressList comment=AS213784 address=91.124.96.0/22} on-error {}
