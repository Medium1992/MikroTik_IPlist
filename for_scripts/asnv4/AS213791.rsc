...
:do {add list=$AddressList comment=AS213791 address=109.122.27.0/24} on-error {}
:do {add list=$AddressList comment=AS213791 address=116.204.166.0/24} on-error {}
:do {add list=$AddressList comment=AS213791 address=141.11.95.0/24} on-error {}
...
:do {add list=$AddressList comment=AS213791 address=2.27.158.0/24} on-error {}
:do {add list=$AddressList comment=AS213791 address=2.58.84.0/24} on-error {}
:do {add list=$AddressList comment=AS213791 address=217.60.99.0/24} on-error {}
