...
:if ([:len [find where list=$AddressList and address=136.0.34.0/24]] = 0) do={ add list=$AddressList comment=AS213840 address=136.0.34.0/24 }
:if ([:len [find where list=$AddressList and address=192.6.120.0/24]] = 0) do={ add list=$AddressList comment=AS213840 address=192.6.120.0/24 }
