...
:do {add list=$AddressList comment=AS213953 address=217.114.46.0/24} on-error {}
:do {add list=$AddressList comment=AS213953 address=77.104.108.0/24} on-error {}
:do {add list=$AddressList comment=AS213953 address=88.218.16.0/24} on-error {}
:do {add list=$AddressList comment=AS213953 address=88.218.18.0/23} on-error {}
