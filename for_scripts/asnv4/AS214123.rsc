...
:if ([:len [find where list=$AddressList and address=192.140.230.0/24]] = 0) do={ add list=$AddressList comment=AS214123 address=192.140.230.0/24 }
:if ([:len [find where list=$AddressList and address=38.225.118.0/24]] = 0) do={ add list=$AddressList comment=AS214123 address=38.225.118.0/24 }
