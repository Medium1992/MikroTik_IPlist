...
:do {add list=$AddressList comment=AS214124 address=for_scripts/asnv4/AS214124.rsc} on-error {}
...
:do {add list=$AddressList comment=AS214124 address=46.247.97.0/24} on-error {}
:do {add list=$AddressList comment=AS214124 address=46.247.98.0/23} on-error {}
