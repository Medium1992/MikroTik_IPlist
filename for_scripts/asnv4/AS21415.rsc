...
:do {add list=$AddressList comment=AS21415 address=for_scripts/asnv4/AS21415.rsc} on-error {}
...
:do {add list=$AddressList comment=AS21415 address=109.121.254.0/23} on-error {}
:do {add list=$AddressList comment=AS21415 address=178.169.142.0/23} on-error {}
:do {add list=$AddressList comment=AS21415 address=178.169.162.0/24} on-error {}
