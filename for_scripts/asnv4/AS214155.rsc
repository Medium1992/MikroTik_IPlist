...
:if ([:len [find where list=$AddressList and address=217.216.70.0/23]] = 0) do={ add list=$AddressList comment=AS214155 address=217.216.70.0/23 }
...
:if ([:len [find where list=$AddressList and address=94.156.228.0/22]] = 0) do={ add list=$AddressList comment=AS214155 address=94.156.228.0/22 }
