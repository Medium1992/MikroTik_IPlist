...
:if ([:len [find where list=$AddressList and address=136.148.72.0/24]] = 0) do={ add list=$AddressList comment=AS214456 address=136.148.72.0/24 }
...
:if ([:len [find where list=$AddressList and address=217.60.174.0/23]] = 0) do={ add list=$AddressList comment=AS214456 address=217.60.174.0/23 }
