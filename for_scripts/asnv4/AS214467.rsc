...
:if ([:len [find where list=$AddressList and address=147.90.17.0/24]] = 0) do={ add list=$AddressList comment=AS214467 address=147.90.17.0/24 }
...
:if ([:len [find where list=$AddressList and address=164.37.230.0/24]] = 0) do={ add list=$AddressList comment=AS214467 address=164.37.230.0/24 }
