...
:if ([:len [find where list=$AddressList and address=80.246.138.0/23]] = 0) do={ add list=$AddressList comment=AS21450 address=80.246.138.0/23 }
:if ([:len [find where list=$AddressList and address=80.246.140.0/24]] = 0) do={ add list=$AddressList comment=AS21450 address=80.246.140.0/24 }
