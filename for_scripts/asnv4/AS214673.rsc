...
:if ([:len [find where list=$AddressList and address=62.129.140.0/24]] = 0) do={ add list=$AddressList comment=AS214673 address=62.129.140.0/24 }
:if ([:len [find where list=$AddressList and address=62.129.142.0/23]] = 0) do={ add list=$AddressList comment=AS214673 address=62.129.142.0/23 }
