...
:if ([:len [find where list=$AddressList and address=185.205.194.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=185.205.194.0/24 }
:if ([:len [find where list=$AddressList and address=195.206.234.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=195.206.234.0/24 }
:if ([:len [find where list=$AddressList and address=213.218.210.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=213.218.210.0/24 }
:if ([:len [find where list=$AddressList and address=217.217.243.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=217.217.243.0/24 }
:if ([:len [find where list=$AddressList and address=31.56.233.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=31.56.233.0/24 }
:if ([:len [find where list=$AddressList and address=31.56.7.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=31.56.7.0/24 }
:if ([:len [find where list=$AddressList and address=31.58.156.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=31.58.156.0/24 }
...
:if ([:len [find where list=$AddressList and address=87.229.95.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=87.229.95.0/24 }
:if ([:len [find where list=$AddressList and address=92.112.124.0/22]] = 0) do={ add list=$AddressList comment=AS214677 address=92.112.124.0/22 }
:if ([:len [find where list=$AddressList and address=95.135.208.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=95.135.208.0/24 }
:if ([:len [find where list=$AddressList and address=96.62.250.0/24]] = 0) do={ add list=$AddressList comment=AS214677 address=96.62.250.0/24 }
