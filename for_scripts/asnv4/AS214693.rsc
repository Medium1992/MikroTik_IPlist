...
:if ([:len [find where list=$AddressList and address=169.128.70.0/24]] = 0) do={ add list=$AddressList comment=AS214693 address=169.128.70.0/24 }
...
:if ([:len [find where list=$AddressList and address=81.5.141.0/24]] = 0) do={ add list=$AddressList comment=AS214693 address=81.5.141.0/24 }
