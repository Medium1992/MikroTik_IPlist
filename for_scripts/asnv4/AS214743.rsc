...
:do {add list=$AddressList comment=AS214743 address=for_scripts/asnv4/AS214743.rsc} on-error {}
:do {add list=$AddressList comment=AS214743 address=178.236.46.0/24} on-error {}
