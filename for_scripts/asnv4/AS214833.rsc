...
:do {add list=$AddressList comment=AS214833 address=185.17.0.0/24} on-error {}
...
:do {add list=$AddressList comment=AS214833 address=45.129.237.0/24} on-error {}
...
:do {add list=$AddressList comment=AS214833 address=95.181.158.0/24} on-error {}
