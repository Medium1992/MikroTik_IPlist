...
:do {add list=$AddressList comment=AS214875 address=188.228.80.0/22} on-error {}
...
:do {add list=$AddressList comment=AS214875 address=188.228.96.0/22} on-error {}
...
:do {add list=$AddressList comment=AS214875 address=37.97.57.0/24} on-error {}
