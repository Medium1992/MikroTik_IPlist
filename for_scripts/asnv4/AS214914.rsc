...
:do {add list=$AddressList comment=AS214914 address=for_scripts/asnv4/AS214914.rsc} on-error {}
...
:do {add list=$AddressList comment=AS214914 address=31.57.66.0/24} on-error {}
