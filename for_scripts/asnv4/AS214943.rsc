...
:do {add list=$AddressList comment=AS214943 address=for_scripts/asnv4/AS214943.rsc} on-error {}
...
:do {add list=$AddressList comment=AS214943 address=213.209.150.0/24} on-error {}
