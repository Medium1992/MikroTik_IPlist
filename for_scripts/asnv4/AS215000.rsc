...
:if ([:len [find where list=$AddressList and address=185.61.112.0/23]] = 0) do={ add list=$AddressList comment=AS215000 address=185.61.112.0/23 }
:if ([:len [find where list=$AddressList and address=185.61.114.0/24]] = 0) do={ add list=$AddressList comment=AS215000 address=185.61.114.0/24 }
