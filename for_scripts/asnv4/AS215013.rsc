...
:if ([:len [find where list=$AddressList and address=188.72.104.0/23]] = 0) do={ add list=$AddressList comment=AS215013 address=188.72.104.0/23 }
...
:if ([:len [find where list=$AddressList and address=188.72.112.0/23]] = 0) do={ add list=$AddressList comment=AS215013 address=188.72.112.0/23 }
