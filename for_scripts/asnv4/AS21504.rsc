...
:do {add list=$AddressList comment=AS21504 address=for_scripts/asnv4/AS21504.rsc} on-error {}
...
:do {add list=$AddressList comment=AS21504 address=198.160.38.0/23} on-error {}
