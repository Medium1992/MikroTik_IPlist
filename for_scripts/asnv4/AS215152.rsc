...
:do {add list=$AddressList comment=AS215152 address=166.88.237.0/24} on-error {}
:do {add list=$AddressList comment=AS215152 address=168.222.13.0/24} on-error {}
:do {add list=$AddressList comment=AS215152 address=205.196.148.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215152 address=79.99.146.0/24} on-error {}
