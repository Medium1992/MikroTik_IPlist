...
:do {add list=$AddressList comment=AS215228 address=196.2.128.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215228 address=217.60.193.0/24} on-error {}
:do {add list=$AddressList comment=AS215228 address=217.60.194.0/24} on-error {}
