...
:if ([:len [find where list=$AddressList and address=142.249.111.0/24]] = 0) do={ add list=$AddressList comment=AS215238 address=142.249.111.0/24 }
...
:if ([:len [find where list=$AddressList and address=31.42.121.0/24]] = 0) do={ add list=$AddressList comment=AS215238 address=31.42.121.0/24 }
