...
:do {add list=$AddressList comment=AS215261 address=167.148.167.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215261 address=222.167.192.0/24} on-error {}
:do {add list=$AddressList comment=AS215261 address=45.146.6.0/24} on-error {}
