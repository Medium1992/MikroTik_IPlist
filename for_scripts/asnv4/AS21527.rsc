...
:do {add list=$AddressList comment=AS21527 address=for_scripts/asnv4/AS21527.rsc} on-error {}
...
:do {add list=$AddressList comment=AS21527 address=69.41.0.0/20} on-error {}
