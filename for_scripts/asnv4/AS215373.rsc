...
:do {add list=$AddressList comment=AS215373 address=89.111.10.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215373 address=89.111.30.0/23} on-error {}
:do {add list=$AddressList comment=AS215373 address=89.111.9.0/24} on-error {}
