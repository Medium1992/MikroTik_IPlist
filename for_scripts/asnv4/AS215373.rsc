...
:do {add list=$AddressList comment=AS215373 address=185.219.156.0/22} on-error {}
:do {add list=$AddressList comment=AS215373 address=185.84.44.0/24} on-error {}
:do {add list=$AddressList comment=AS215373 address=193.164.210.0/23} on-error {}
...
:do {add list=$AddressList comment=AS215373 address=89.111.19.0/24} on-error {}
