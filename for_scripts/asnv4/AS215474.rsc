...
:do {add list=$AddressList comment=AS215474 address=108.165.76.0/24} on-error {}
:do {add list=$AddressList comment=AS215474 address=136.0.123.0/24} on-error {}
:do {add list=$AddressList comment=AS215474 address=136.0.155.0/24} on-error {}
:do {add list=$AddressList comment=AS215474 address=136.0.159.0/24} on-error {}
