...
:do {add list=$AddressList comment=AS215496 address=185.118.12.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215496 address=185.238.167.0/24} on-error {}
:do {add list=$AddressList comment=AS215496 address=194.117.64.0/24} on-error {}
:do {add list=$AddressList comment=AS215496 address=81.12.82.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215496 address=91.234.147.0/24} on-error {}
:do {add list=$AddressList comment=AS215496 address=94.183.211.0/24} on-error {}
