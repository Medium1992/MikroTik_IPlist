...
:do {add list=$AddressList comment=AS215628 address=194.62.113.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215628 address=66.203.252.0/24} on-error {}
:do {add list=$AddressList comment=AS215628 address=66.228.90.0/23} on-error {}
