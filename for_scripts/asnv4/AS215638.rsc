...
:do {add list=$AddressList comment=AS215638 address=for_scripts/asnv4/AS215638.rsc} on-error {}
...
:do {add list=$AddressList comment=AS215638 address=151.247.211.0/24} on-error {}
