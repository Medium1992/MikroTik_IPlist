...
:do {add list=$AddressList comment=AS215727 address=163.5.214.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215727 address=31.57.160.0/24} on-error {}
...
:do {add list=$AddressList comment=AS215727 address=82.21.150.0/24} on-error {}
