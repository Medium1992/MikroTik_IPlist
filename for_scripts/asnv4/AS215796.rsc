...
:do {add list=$AddressList comment=AS215796 address=for_scripts/asnv4/AS215796.rsc} on-error {}
:do {add list=$AddressList comment=AS215796 address=147.45.100.0/24} on-error {}
:do {add list=$AddressList comment=AS215796 address=147.45.96.0/22} on-error {}
