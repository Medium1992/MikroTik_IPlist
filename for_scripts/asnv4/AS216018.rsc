...
:do {add list=$AddressList comment=AS216018 address=for_scripts/asnv4/AS216018.rsc} on-error {}
:do {add list=$AddressList comment=AS216018 address=185.23.72.0/24} on-error {}
:do {add list=$AddressList comment=AS216018 address=185.23.74.0/24} on-error {}
