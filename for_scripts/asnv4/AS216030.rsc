...
:do {add list=$AddressList comment=AS216030 address=for_scripts/asnv4/AS216030.rsc} on-error {}
...
:do {add list=$AddressList comment=AS216030 address=192.41.102.0/24} on-error {}
