...
:do {add list=$AddressList comment=AS216047 address=for_scripts/asnv4/AS216047.rsc} on-error {}
...
:do {add list=$AddressList comment=AS216047 address=156.246.69.0/24} on-error {}
...
:do {add list=$AddressList comment=AS216047 address=45.248.88.0/24} on-error {}
:do {add list=$AddressList comment=AS216047 address=45.248.91.0/24} on-error {}
