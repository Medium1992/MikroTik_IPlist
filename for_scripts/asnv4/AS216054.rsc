...
:if ([:len [find where list=$AddressList and address=185.10.240.0/24]] = 0) do={ add list=$AddressList comment=AS216054 address=185.10.240.0/24 }
...
:if ([:len [find where list=$AddressList and address=45.144.17.0/24]] = 0) do={ add list=$AddressList comment=AS216054 address=45.144.17.0/24 }
