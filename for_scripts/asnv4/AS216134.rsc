...
:do {add list=$AddressList comment=AS216134 address=for_scripts/asnv4/AS216134.rsc} on-error {}
...
:do {add list=$AddressList comment=AS216134 address=149.238.0.0/18} on-error {}
:do {add list=$AddressList comment=AS216134 address=149.238.118.0/23} on-error {}
:do {add list=$AddressList comment=AS216134 address=149.238.128.0/17} on-error {}
:do {add list=$AddressList comment=AS216134 address=149.238.64.0/19} on-error {}
:do {add list=$AddressList comment=AS216134 address=149.238.96.0/20} on-error {}
