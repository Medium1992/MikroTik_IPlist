...
:if ([:len [find where list=$AddressList and address=63.236.100.0/24]] = 0) do={ add list=$AddressList comment=AS21622 address=63.236.100.0/24 }
...
:if ([:len [find where list=$AddressList and address=66.77.16.0/24]] = 0) do={ add list=$AddressList comment=AS21622 address=66.77.16.0/24 }
