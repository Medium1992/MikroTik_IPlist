...
:do {add list=$AddressList comment=AS216383 address=for_scripts/asnv4/AS216383.rsc} on-error {}
...
:do {add list=$AddressList comment=AS216383 address=23.90.51.0/24} on-error {}
