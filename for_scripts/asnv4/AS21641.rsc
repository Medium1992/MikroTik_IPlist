...
:do {add list=$AddressList comment=AS21641 address=151.243.240.0/24} on-error {}
...
:do {add list=$AddressList comment=AS21641 address=84.75.44.0/22} on-error {}
:do {add list=$AddressList comment=AS21641 address=84.75.56.0/22} on-error {}
