...
:if ([:len [find where list=$AddressList and address=77.111.103.0/24]] = 0) do={ add list=$AddressList comment=AS21769 address=77.111.103.0/24 }
...
:if ([:len [find where list=$AddressList and address=89.106.28.0/22]] = 0) do={ add list=$AddressList comment=AS21769 address=89.106.28.0/22 }
