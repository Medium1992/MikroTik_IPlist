...
:do {add list=$AddressList comment=AS21803 address=209.140.12.0/23} on-error {}
:do {add list=$AddressList comment=AS21803 address=209.140.14.0/24} on-error {}
...
:do {add list=$AddressList comment=AS21803 address=67.223.160.0/23} on-error {}
:do {add list=$AddressList comment=AS21803 address=67.223.162.0/24} on-error {}
