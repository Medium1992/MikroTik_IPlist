...
:do {add list=$AddressList comment=AS21804 address=for_scripts/asnv4/AS21804.rsc} on-error {}
...
:do {add list=$AddressList comment=AS21804 address=24.89.100.0/23} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.102.0/24} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.0/27} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.128/25} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.32/30} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.36/31} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.38/32} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.40/29} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.48/28} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.103.64/26} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.104.0/21} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.112.0/20} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.64.0/19} on-error {}
:do {add list=$AddressList comment=AS21804 address=24.89.96.0/22} on-error {}
