...
:if ([:len [find where list=$AddressList and address=143.20.178.0/24]] = 0) do={ add list=$AddressList comment=AS218943 address=143.20.178.0/24 }
:if ([:len [find where list=$AddressList and address=178.95.124.0/24]] = 0) do={ add list=$AddressList comment=AS218943 address=178.95.124.0/24 }
...
:if ([:len [find where list=$AddressList and address=91.124.99.0/24]] = 0) do={ add list=$AddressList comment=AS218943 address=91.124.99.0/24 }
