...
:if ([:len [find where list=$AddressList and address=104.250.252.0/24]] = 0) do={ add list=$AddressList comment=AS218964 address=104.250.252.0/24 }
...
:if ([:len [find where list=$AddressList and address=179.254.78.0/24]] = 0) do={ add list=$AddressList comment=AS218964 address=179.254.78.0/24 }
...
:if ([:len [find where list=$AddressList and address=31.77.3.0/24]] = 0) do={ add list=$AddressList comment=AS218964 address=31.77.3.0/24 }
...
:if ([:len [find where list=$AddressList and address=89.125.142.0/24]] = 0) do={ add list=$AddressList comment=AS218964 address=89.125.142.0/24 }
