...
:if ([:len [find where list=$AddressList and address=188.220.33.0/24]] = 0) do={ add list=$AddressList comment=AS218979 address=188.220.33.0/24 }
:if ([:len [find where list=$AddressList and address=82.119.204.0/24]] = 0) do={ add list=$AddressList comment=AS218979 address=82.119.204.0/24 }
