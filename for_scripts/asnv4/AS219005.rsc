...
:if ([:len [find where list=$AddressList and address=147.90.72.0/24]] = 0) do={ add list=$AddressList comment=AS219005 address=147.90.72.0/24 }
...
:if ([:len [find where list=$AddressList and address=188.220.250.0/23]] = 0) do={ add list=$AddressList comment=AS219005 address=188.220.250.0/23 }
