...
:if ([:len [find where list=$AddressList and address=179.254.115.0/24]] = 0) do={ add list=$AddressList comment=AS219095 address=179.254.115.0/24 }
:if ([:len [find where list=$AddressList and address=179.254.126.0/23]] = 0) do={ add list=$AddressList comment=AS219095 address=179.254.126.0/23 }
:if ([:len [find where list=$AddressList and address=185.70.223.0/24]] = 0) do={ add list=$AddressList comment=AS219095 address=185.70.223.0/24 }
...
:if ([:len [find where list=$AddressList and address=93.89.218.0/24]] = 0) do={ add list=$AddressList comment=AS219095 address=93.89.218.0/24 }
