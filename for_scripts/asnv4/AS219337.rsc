...
:if ([:len [find where list=$AddressList and address=2.27.200.0/22]] = 0) do={ add list=$AddressList comment=AS219337 address=2.27.200.0/22 }
:if ([:len [find where list=$AddressList and address=2.27.204.0/23]] = 0) do={ add list=$AddressList comment=AS219337 address=2.27.204.0/23 }
:if ([:len [find where list=$AddressList and address=2.27.206.0/24]] = 0) do={ add list=$AddressList comment=AS219337 address=2.27.206.0/24 }
