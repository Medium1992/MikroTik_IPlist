...
:if ([:len [find where list=$AddressList and address=132.243.163.0/24]] = 0) do={ add list=$AddressList comment=AS219359 address=132.243.163.0/24 }
...
:if ([:len [find where list=$AddressList and address=157.228.64.0/22]] = 0) do={ add list=$AddressList comment=AS219359 address=157.228.64.0/22 }
...
:if ([:len [find where list=$AddressList and address=157.228.71.0/24]] = 0) do={ add list=$AddressList comment=AS219359 address=157.228.71.0/24 }
:if ([:len [find where list=$AddressList and address=185.113.8.0/24]] = 0) do={ add list=$AddressList comment=AS219359 address=185.113.8.0/24 }
