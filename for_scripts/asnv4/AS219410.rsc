...
:if ([:len [find where list=$AddressList and address=82.47.152.0/23]] = 0) do={ add list=$AddressList comment=AS219410 address=82.47.152.0/23 }
:if ([:len [find where list=$AddressList and address=82.47.154.0/24]] = 0) do={ add list=$AddressList comment=AS219410 address=82.47.154.0/24 }
