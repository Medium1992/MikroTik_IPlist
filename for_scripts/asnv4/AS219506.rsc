...
:if ([:len [find where list=$AddressList and address=31.59.210.0/24]] = 0) do={ add list=$AddressList comment=AS219506 address=31.59.210.0/24 }
:if ([:len [find where list=$AddressList and address=94.183.167.0/24]] = 0) do={ add list=$AddressList comment=AS219506 address=94.183.167.0/24 }
