...
:do {add list=$AddressList comment=AS22062 address=for_scripts/asnv4/AS22062.rsc} on-error {}
...
:do {add list=$AddressList comment=AS22062 address=74.207.216.0/24} on-error {}
