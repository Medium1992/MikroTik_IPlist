...
:do {add list=$AddressList comment=AS22115 address=155.254.224.0/24} on-error {}
:do {add list=$AddressList comment=AS22115 address=155.254.226.0/23} on-error {}
:do {add list=$AddressList comment=AS22115 address=172.111.22.0/23} on-error {}
