...
:if ([:len [find where list=$AddressList and address=161.150.128.0/20]] = 0) do={ add list=$AddressList comment=AS22125 address=161.150.128.0/20 }
...
:if ([:len [find where list=$AddressList and address=161.150.224.0/20]] = 0) do={ add list=$AddressList comment=AS22125 address=161.150.224.0/20 }
