...
:do {add list=$AddressList comment=AS22439 address=70.36.112.0/22} on-error {}
:do {add list=$AddressList comment=AS22439 address=70.36.116.0/23} on-error {}
:do {add list=$AddressList comment=AS22439 address=70.36.119.0/24} on-error {}
