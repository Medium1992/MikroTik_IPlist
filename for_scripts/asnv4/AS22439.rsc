...
:if ([:len [find where list=$AddressList and address=70.36.112.0/22]] = 0) do={ add list=$AddressList comment=AS22439 address=70.36.112.0/22 }
:if ([:len [find where list=$AddressList and address=70.36.116.0/23]] = 0) do={ add list=$AddressList comment=AS22439 address=70.36.116.0/23 }
:if ([:len [find where list=$AddressList and address=70.36.119.0/24]] = 0) do={ add list=$AddressList comment=AS22439 address=70.36.119.0/24 }
