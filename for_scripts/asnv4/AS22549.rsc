...
:do {add list=$AddressList comment=AS22549 address=68.65.16.0/21} on-error {}
:do {add list=$AddressList comment=AS22549 address=68.65.24.0/23} on-error {}
:do {add list=$AddressList comment=AS22549 address=68.65.26.0/24} on-error {}
:do {add list=$AddressList comment=AS22549 address=68.65.28.0/22} on-error {}
