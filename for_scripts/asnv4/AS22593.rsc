...
:do {add list=$AddressList comment=AS22593 address=for_scripts/asnv4/AS22593.rsc} on-error {}
:do {add list=$AddressList comment=AS22593 address=170.69.0.0/18} on-error {}
:do {add list=$AddressList comment=AS22593 address=170.69.253.0/24} on-error {}
