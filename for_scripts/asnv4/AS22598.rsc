...
:do {add list=$AddressList comment=AS22598 address=for_scripts/asnv4/AS22598.rsc} on-error {}
...
:do {add list=$AddressList comment=AS22598 address=108.160.184.0/22} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.188.0/24} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.0/28} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.128/25} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.16/29} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.24/31} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.26/32} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.28/30} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.32/27} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.189.64/26} on-error {}
:do {add list=$AddressList comment=AS22598 address=108.160.190.0/23} on-error {}
