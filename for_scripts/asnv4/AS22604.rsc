...
:do {add list=$AddressList comment=AS22604 address=139.104.210.0/23} on-error {}
...
:do {add list=$AddressList comment=AS22604 address=139.104.216.0/22} on-error {}
:do {add list=$AddressList comment=AS22604 address=139.104.220.0/23} on-error {}
:do {add list=$AddressList comment=AS22604 address=139.104.222.0/24} on-error {}
:do {add list=$AddressList comment=AS22604 address=157.23.232.0/22} on-error {}
:do {add list=$AddressList comment=AS22604 address=157.23.236.0/24} on-error {}
