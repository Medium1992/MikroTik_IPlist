...
:do {add list=$AddressList comment=AS22608 address=63.142.192.0/22} on-error {}
:do {add list=$AddressList comment=AS22608 address=63.142.196.0/23} on-error {}
:do {add list=$AddressList comment=AS22608 address=63.142.198.0/24} on-error {}
