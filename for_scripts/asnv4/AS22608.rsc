...
:do {add list=$AddressList comment=AS22608 address=for_scripts/asnv4/AS22608.rsc} on-error {}
...
:do {add list=$AddressList comment=AS22608 address=63.142.204.0/22} on-error {}
