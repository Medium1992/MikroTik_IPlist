...
:do {add list=$AddressList comment=AS22639 address=for_scripts/asnv4/AS22639.rsc} on-error {}
...
:do {add list=$AddressList comment=AS22639 address=98.143.216.0/21} on-error {}
