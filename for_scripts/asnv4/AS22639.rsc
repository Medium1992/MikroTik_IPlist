...
:if ([:len [find where list=$AddressList and address=216.144.112.0/20]] = 0) do={ add list=$AddressList comment=AS22639 address=216.144.112.0/20 }
...
:if ([:len [find where list=$AddressList and address=98.143.208.0/20]] = 0) do={ add list=$AddressList comment=AS22639 address=98.143.208.0/20 }
