...
:do {add list=$AddressList comment=AS22689 address=187.121.129.0/24} on-error {}
:do {add list=$AddressList comment=AS22689 address=187.121.130.0/24} on-error {}
:do {add list=$AddressList comment=AS22689 address=187.121.132.0/22} on-error {}
