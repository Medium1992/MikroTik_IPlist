...
:if ([:len [find where list=$AddressList and address=179.49.0.0/20]] = 0) do={ add list=$AddressList comment=AS22724 address=179.49.0.0/20 }
:if ([:len [find where list=$AddressList and address=179.49.16.0/21]] = 0) do={ add list=$AddressList comment=AS22724 address=179.49.16.0/21 }
:if ([:len [find where list=$AddressList and address=179.49.24.0/22]] = 0) do={ add list=$AddressList comment=AS22724 address=179.49.24.0/22 }
:if ([:len [find where list=$AddressList and address=179.49.28.0/23]] = 0) do={ add list=$AddressList comment=AS22724 address=179.49.28.0/23 }
:if ([:len [find where list=$AddressList and address=179.49.31.0/24]] = 0) do={ add list=$AddressList comment=AS22724 address=179.49.31.0/24 }
:if ([:len [find where list=$AddressList and address=179.49.32.0/19]] = 0) do={ add list=$AddressList comment=AS22724 address=179.49.32.0/19 }
...
:if ([:len [find where list=$AddressList and address=38.4.0.0/23]] = 0) do={ add list=$AddressList comment=AS22724 address=38.4.0.0/23 }
