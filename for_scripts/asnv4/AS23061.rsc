...
:if ([:len [find where list=$AddressList and address=161.114.224.0/20]] = 0) do={ add list=$AddressList comment=AS23061 address=161.114.224.0/20 }
...
:if ([:len [find where list=$AddressList and address=77.216.0.0/19]] = 0) do={ add list=$AddressList comment=AS23061 address=77.216.0.0/19 }
:if ([:len [find where list=$AddressList and address=77.216.128.0/19]] = 0) do={ add list=$AddressList comment=AS23061 address=77.216.128.0/19 }
