...
:if ([:len [find where list=$AddressList and address=205.144.102.0/24]] = 0) do={ add list=$AddressList comment=AS23152 address=205.144.102.0/24 }
...
:if ([:len [find where list=$AddressList and address=205.144.97.0/24]] = 0) do={ add list=$AddressList comment=AS23152 address=205.144.97.0/24 }
