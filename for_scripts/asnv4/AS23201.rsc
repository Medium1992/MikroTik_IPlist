...
:do {add list=$AddressList comment=AS23201 address=for_scripts/asnv4/AS23201.rsc} on-error {}
...
:do {add list=$AddressList comment=AS23201 address=190.2.193.0/24} on-error {}
:do {add list=$AddressList comment=AS23201 address=190.2.194.0/23} on-error {}
:do {add list=$AddressList comment=AS23201 address=190.2.196.0/22} on-error {}
:do {add list=$AddressList comment=AS23201 address=190.2.200.0/21} on-error {}
