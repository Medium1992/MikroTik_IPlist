...
:do {add list=$AddressList comment=AS23252 address=45.62.84.0/24} on-error {}
:do {add list=$AddressList comment=AS23252 address=45.62.86.0/23} on-error {}
:do {add list=$AddressList comment=AS23252 address=45.62.88.0/24} on-error {}
