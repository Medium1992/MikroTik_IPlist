...
:if ([:len [find where list=$AddressList and address=139.104.193.0/24]] = 0) do={ add list=$AddressList comment=AS23344 address=139.104.193.0/24 }
...
:if ([:len [find where list=$AddressList and address=139.104.222.0/24]] = 0) do={ add list=$AddressList comment=AS23344 address=139.104.222.0/24 }
:if ([:len [find where list=$AddressList and address=139.104.96.0/21]] = 0) do={ add list=$AddressList comment=AS23344 address=139.104.96.0/21 }
