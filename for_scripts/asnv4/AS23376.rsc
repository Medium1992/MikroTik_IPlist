...
:do {add list=$AddressList comment=AS23376 address=for_scripts/asnv4/AS23376.rsc} on-error {}
:do {add list=$AddressList comment=AS23376 address=198.235.128.0/24} on-error {}
