...
:do {add list=$AddressList comment=AS23467 address=for_scripts/asnv4/AS23467.rsc} on-error {}
...
:do {add list=$AddressList comment=AS23467 address=152.38.156.0/23} on-error {}
...
:do {add list=$AddressList comment=AS23467 address=64.251.194.0/23} on-error {}
