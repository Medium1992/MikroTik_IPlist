...
:do {add list=$AddressList comment=AS23486 address=for_scripts/asnv4/AS23486.rsc} on-error {}
:do {add list=$AddressList comment=AS23486 address=170.124.0.0/23} on-error {}
