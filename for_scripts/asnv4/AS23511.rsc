...
:do {add list=$AddressList comment=AS23511 address=142.252.251.0/24} on-error {}
:do {add list=$AddressList comment=AS23511 address=142.252.54.0/23} on-error {}
...
:do {add list=$AddressList comment=AS23511 address=45.38.8.0/24} on-error {}
