...
:do {add list=$AddressList comment=AS23554 address=for_scripts/asnv4/AS23554.rsc} on-error {}
...
:do {add list=$AddressList comment=AS23554 address=59.7.252.0/24} on-error {}
