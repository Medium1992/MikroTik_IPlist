...
:do {add list=$AddressList comment=AS23657 address=for_scripts/asnv4/AS23657.rsc} on-error {}
:do {add list=$AddressList comment=AS23657 address=198.52.28.0/22} on-error {}
:do {add list=$AddressList comment=AS23657 address=202.4.47.0/24} on-error {}
