...
:if ([:len [find where list=$AddressList and address=111.92.172.0/24]] = 0) do={ add list=$AddressList comment=AS23671 address=111.92.172.0/24 }
:if ([:len [find where list=$AddressList and address=111.92.174.0/23]] = 0) do={ add list=$AddressList comment=AS23671 address=111.92.174.0/23 }
