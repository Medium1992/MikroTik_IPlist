...
:do {add list=$AddressList comment=AS23693 address=202.158.129.0/24} on-error {}
:do {add list=$AddressList comment=AS23693 address=202.158.130.0/23} on-error {}
...
:do {add list=$AddressList comment=AS23693 address=39.194.4.0/22} on-error {}
