...
:if ([:len [find where list=$AddressList and address=39.194.1.0/24]] = 0) do={ add list=$AddressList comment=AS23693 address=39.194.1.0/24 }
...
:if ([:len [find where list=$AddressList and address=39.194.2.0/23]] = 0) do={ add list=$AddressList comment=AS23693 address=39.194.2.0/23 }
