...
:if ([:len [find where list=$AddressList and address=39.194.12.0/23]] = 0) do={ add list=$AddressList comment=AS23693 address=39.194.12.0/23 }
:if ([:len [find where list=$AddressList and address=39.194.14.0/24]] = 0) do={ add list=$AddressList comment=AS23693 address=39.194.14.0/24 }
:if ([:len [find where list=$AddressList and address=39.194.19.0/24]] = 0) do={ add list=$AddressList comment=AS23693 address=39.194.19.0/24 }
