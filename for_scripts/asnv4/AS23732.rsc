...
:do {add list=$AddressList comment=AS23732 address=202.162.160.0/23} on-error {}
...
:do {add list=$AddressList comment=AS23732 address=202.162.173.0/24} on-error {}
:do {add list=$AddressList comment=AS23732 address=202.162.174.0/23} on-error {}
