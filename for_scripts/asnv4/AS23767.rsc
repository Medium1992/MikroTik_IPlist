...
:do {add list=$AddressList comment=AS23767 address=123.136.64.0/24} on-error {}
:do {add list=$AddressList comment=AS23767 address=123.136.67.0/24} on-error {}
:do {add list=$AddressList comment=AS23767 address=123.136.68.0/22} on-error {}
