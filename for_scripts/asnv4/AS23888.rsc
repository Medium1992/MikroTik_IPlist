...
:do {add list=$AddressList comment=AS23888 address=for_scripts/asnv4/AS23888.rsc} on-error {}
...
:do {add list=$AddressList comment=AS23888 address=175.107.0.0/21} on-error {}
:do {add list=$AddressList comment=AS23888 address=175.107.12.0/24} on-error {}
:do {add list=$AddressList comment=AS23888 address=175.107.14.0/23} on-error {}
:do {add list=$AddressList comment=AS23888 address=175.107.16.0/20} on-error {}
...
:do {add list=$AddressList comment=AS23888 address=175.107.8.0/22} on-error {}
