...
:do {add list=$AddressList comment=AS23932 address=for_scripts/asnv4/AS23932.rsc} on-error {}
...
:do {add list=$AddressList comment=AS23932 address=202.44.53.0/24} on-error {}
:do {add list=$AddressList comment=AS23932 address=202.44.54.0/23} on-error {}
