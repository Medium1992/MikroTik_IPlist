...
:if ([:len [find where list=$AddressList and address=180.128.24.0/23]] = 0) do={ add list=$AddressList comment=AS23932 address=180.128.24.0/23 }
...
:if ([:len [find where list=$AddressList and address=180.128.27.0/24]] = 0) do={ add list=$AddressList comment=AS23932 address=180.128.27.0/24 }
:if ([:len [find where list=$AddressList and address=180.128.28.0/22]] = 0) do={ add list=$AddressList comment=AS23932 address=180.128.28.0/22 }
