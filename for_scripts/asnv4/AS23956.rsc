...
:if ([:len [find where list=$AddressList and address=118.179.100.0/23]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.100.0/23 }
:if ([:len [find where list=$AddressList and address=118.179.102.0/24]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.102.0/24 }
:if ([:len [find where list=$AddressList and address=118.179.104.0/22]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.104.0/22 }
:if ([:len [find where list=$AddressList and address=118.179.108.0/24]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.108.0/24 }
:if ([:len [find where list=$AddressList and address=118.179.110.0/24]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.110.0/24 }
:if ([:len [find where list=$AddressList and address=118.179.112.0/23]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.112.0/23 }
:if ([:len [find where list=$AddressList and address=118.179.115.0/24]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.115.0/24 }
:if ([:len [find where list=$AddressList and address=118.179.116.0/22]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.116.0/22 }
:if ([:len [find where list=$AddressList and address=118.179.120.0/21]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.120.0/21 }
...
:if ([:len [find where list=$AddressList and address=118.179.64.0/19]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.64.0/19 }
:if ([:len [find where list=$AddressList and address=118.179.96.0/22]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.96.0/22 }
