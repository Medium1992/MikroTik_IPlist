...
:if ([:len [find where list=$AddressList and address=118.179.160.0/21]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.160.0/21 }
:if ([:len [find where list=$AddressList and address=118.179.168.0/24]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.168.0/24 }
:if ([:len [find where list=$AddressList and address=118.179.170.0/23]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.170.0/23 }
:if ([:len [find where list=$AddressList and address=118.179.172.0/22]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.172.0/22 }
:if ([:len [find where list=$AddressList and address=118.179.176.0/20]] = 0) do={ add list=$AddressList comment=AS23956 address=118.179.176.0/20 }
