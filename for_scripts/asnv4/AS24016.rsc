...
:do {add list=$AddressList comment=AS24016 address=for_scripts/asnv4/AS24016.rsc} on-error {}
...
:do {add list=$AddressList comment=AS24016 address=202.21.184.0/23} on-error {}
:do {add list=$AddressList comment=AS24016 address=202.21.187.0/24} on-error {}
