...
:do {add list=$AddressList comment=AS24028 address=for_scripts/asnv4/AS24028.rsc} on-error {}
...
:do {add list=$AddressList comment=AS24028 address=202.171.60.0/24} on-error {}
