...
:do {add list=$AddressList comment=AS24247 address=202.58.13.0/24} on-error {}
:do {add list=$AddressList comment=AS24247 address=202.58.14.0/23} on-error {}
:do {add list=$AddressList comment=AS24247 address=202.58.8.0/22} on-error {}
