...
:if ([:len [find where list=$AddressList and address=210.229.224.0/19]] = 0) do={ add list=$AddressList comment=AS24296 address=210.229.224.0/19 }
...
:if ([:len [find where list=$AddressList and address=210.252.64.0/19]] = 0) do={ add list=$AddressList comment=AS24296 address=210.252.64.0/19 }
