...
:do {add list=$AddressList comment=AS24323 address=for_scripts/asnv4/AS24323.rsc} on-error {}
:do {add list=$AddressList comment=AS24323 address=103.125.137.0/24} on-error {}
...
:do {add list=$AddressList comment=AS24323 address=150.107.52.0/24} on-error {}
:do {add list=$AddressList comment=AS24323 address=150.107.54.0/24} on-error {}
