...
:do {add list=$AddressList comment=AS24342 address=115.127.216.0/23} on-error {}
:do {add list=$AddressList comment=AS24342 address=115.127.218.0/24} on-error {}
:do {add list=$AddressList comment=AS24342 address=115.127.221.0/24} on-error {}
