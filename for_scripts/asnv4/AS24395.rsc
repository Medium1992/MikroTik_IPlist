...
:if ([:len [find where list=$AddressList and address=203.168.52.0/23]] = 0) do={ add list=$AddressList comment=AS24395 address=203.168.52.0/23 }
:if ([:len [find where list=$AddressList and address=203.168.55.0/24]] = 0) do={ add list=$AddressList comment=AS24395 address=203.168.55.0/24 }
