...
:do {add list=$AddressList comment=AS24525 address=for_scripts/asnv4/AS24525.rsc} on-error {}
:do {add list=$AddressList comment=AS24525 address=114.199.116.0/24} on-error {}
