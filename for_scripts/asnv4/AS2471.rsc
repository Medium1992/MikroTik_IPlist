...
:do {add list=$AddressList comment=AS2471 address=for_scripts/asnv4/AS2471.rsc} on-error {}
:do {add list=$AddressList comment=AS2471 address=147.99.88.0/21} on-error {}
