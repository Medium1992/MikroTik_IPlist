...
:if ([:len [find where list=$AddressList and address=193.48.161.0/24]] = 0) do={ add list=$AddressList comment=AS2472 address=193.48.161.0/24 }
:if ([:len [find where list=$AddressList and address=193.48.162.0/24]] = 0) do={ add list=$AddressList comment=AS2472 address=193.48.162.0/24 }
