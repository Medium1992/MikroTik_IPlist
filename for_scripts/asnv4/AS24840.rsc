...
:if ([:len [find where list=$AddressList and address=193.93.0.0/23]] = 0) do={ add list=$AddressList comment=AS24840 address=193.93.0.0/23 }
:if ([:len [find where list=$AddressList and address=193.93.2.0/24]] = 0) do={ add list=$AddressList comment=AS24840 address=193.93.2.0/24 }
