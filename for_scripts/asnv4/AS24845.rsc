...
:do {add list=$AddressList comment=AS24845 address=for_scripts/asnv4/AS24845.rsc} on-error {}
:do {add list=$AddressList comment=AS24845 address=194.113.40.0/23} on-error {}
