...
:do {add list=$AddressList comment=AS24845 address=194.246.129.0/24} on-error {}
:do {add list=$AddressList comment=AS24845 address=194.246.130.0/23} on-error {}
:do {add list=$AddressList comment=AS24845 address=194.246.132.0/22} on-error {}
:do {add list=$AddressList comment=AS24845 address=194.246.136.0/21} on-error {}
