...
:do {add list=$AddressList comment=AS25037 address=77.80.128.0/19} on-error {}
:do {add list=$AddressList comment=AS25037 address=77.80.216.0/21} on-error {}
:do {add list=$AddressList comment=AS25037 address=77.80.224.0/21} on-error {}
