...
:do {add list=$AddressList comment=AS25091 address=46.102.238.0/24} on-error {}
:do {add list=$AddressList comment=AS25091 address=46.174.132.0/24} on-error {}
...
:do {add list=$AddressList comment=AS25091 address=5.144.38.0/23} on-error {}
