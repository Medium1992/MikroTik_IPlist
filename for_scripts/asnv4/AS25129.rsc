...
:do {add list=$AddressList comment=AS25129 address=89.187.56.0/23} on-error {}
:do {add list=$AddressList comment=AS25129 address=89.187.58.0/24} on-error {}
:do {add list=$AddressList comment=AS25129 address=89.187.60.0/22} on-error {}
