...
:do {add list=$AddressList comment=AS25129 address=for_scripts/asnv4/AS25129.rsc} on-error {}
...
:do {add list=$AddressList comment=AS25129 address=89.187.56.0/21} on-error {}
