...
:do {add list=$AddressList comment=AS25145 address=185.231.108.0/24} on-error {}
...
:do {add list=$AddressList comment=AS25145 address=213.144.112.0/22} on-error {}
:do {add list=$AddressList comment=AS25145 address=213.144.116.0/23} on-error {}
:do {add list=$AddressList comment=AS25145 address=213.144.119.0/24} on-error {}
:do {add list=$AddressList comment=AS25145 address=213.144.121.0/24} on-error {}
:do {add list=$AddressList comment=AS25145 address=213.144.122.0/23} on-error {}
:do {add list=$AddressList comment=AS25145 address=213.144.124.0/22} on-error {}
...
:do {add list=$AddressList comment=AS25145 address=77.92.112.0/22} on-error {}
:do {add list=$AddressList comment=AS25145 address=77.92.117.0/24} on-error {}
:do {add list=$AddressList comment=AS25145 address=77.92.118.0/23} on-error {}
