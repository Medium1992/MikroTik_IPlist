...
:do {add list=$AddressList comment=AS25184 address=for_scripts/asnv4/AS25184.rsc} on-error {}
...
:do {add list=$AddressList comment=AS25184 address=46.38.139.0/24} on-error {}
