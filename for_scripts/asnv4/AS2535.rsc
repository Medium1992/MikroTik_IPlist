...
:do {add list=$AddressList comment=AS2535 address=for_scripts/asnv4/AS2535.rsc} on-error {}
...
:do {add list=$AddressList comment=AS2535 address=129.230.224.0/22} on-error {}
