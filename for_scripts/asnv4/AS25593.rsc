...
:do {add list=$AddressList comment=AS25593 address=212.67.32.0/22} on-error {}
:do {add list=$AddressList comment=AS25593 address=212.67.36.0/23} on-error {}
:do {add list=$AddressList comment=AS25593 address=212.67.38.0/24} on-error {}
:do {add list=$AddressList comment=AS25593 address=212.67.40.0/21} on-error {}
:do {add list=$AddressList comment=AS25593 address=217.19.48.0/20} on-error {}
:do {add list=$AddressList comment=AS25593 address=46.19.180.0/22} on-error {}
