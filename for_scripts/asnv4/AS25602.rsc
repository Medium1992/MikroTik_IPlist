...
:do {add list=$AddressList comment=AS25602 address=for_scripts/asnv4/AS25602.rsc} on-error {}
...
:do {add list=$AddressList comment=AS25602 address=204.117.78.0/24} on-error {}
