...
:do {add list=$AddressList comment=AS25660 address=192.241.48.0/22} on-error {}
:do {add list=$AddressList comment=AS25660 address=192.241.52.0/23} on-error {}
:do {add list=$AddressList comment=AS25660 address=192.241.55.0/24} on-error {}
