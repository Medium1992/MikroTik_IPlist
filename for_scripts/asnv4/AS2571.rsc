...
:do {add list=$AddressList comment=AS2571 address=for_scripts/asnv4/AS2571.rsc} on-error {}
...
:do {add list=$AddressList comment=AS2571 address=198.176.170.0/24} on-error {}
