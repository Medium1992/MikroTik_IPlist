...
:do {add list=$AddressList comment=AS25764 address=172.86.130.0/23} on-error {}
:do {add list=$AddressList comment=AS25764 address=172.86.140.0/22} on-error {}
...
:do {add list=$AddressList comment=AS25764 address=216.215.8.0/24} on-error {}
