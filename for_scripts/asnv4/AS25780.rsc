...
:do {add list=$AddressList comment=AS25780 address=for_scripts/asnv4/AS25780.rsc} on-error {}
...
:do {add list=$AddressList comment=AS25780 address=198.203.28.0/24} on-error {}
