...
:do {add list=$AddressList comment=AS25787 address=74.123.208.0/23} on-error {}
:do {add list=$AddressList comment=AS25787 address=74.123.210.0/24} on-error {}
:do {add list=$AddressList comment=AS25787 address=74.123.215.0/24} on-error {}
