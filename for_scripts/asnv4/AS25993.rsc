...
:do {add list=$AddressList comment=AS25993 address=144.60.190.0/23} on-error {}
:do {add list=$AddressList comment=AS25993 address=144.60.192.0/19} on-error {}
...
:do {add list=$AddressList comment=AS25993 address=32.139.208.0/22} on-error {}
