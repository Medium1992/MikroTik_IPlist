...
:do {add list=$AddressList comment=AS2602 address=185.149.137.0/24} on-error {}
:do {add list=$AddressList comment=AS2602 address=185.149.138.0/23} on-error {}
:do {add list=$AddressList comment=AS2602 address=192.103.2.0/24} on-error {}
:do {add list=$AddressList comment=AS2602 address=192.172.253.0/24} on-error {}
