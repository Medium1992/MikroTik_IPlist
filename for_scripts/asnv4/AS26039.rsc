...
:do {add list=$AddressList comment=AS26039 address=for_scripts/asnv4/AS26039.rsc} on-error {}
...
:do {add list=$AddressList comment=AS26039 address=170.17.8.0/24} on-error {}
