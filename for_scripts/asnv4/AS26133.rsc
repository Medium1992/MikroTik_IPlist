...
:do {add list=$AddressList comment=AS26133 address=for_scripts/asnv4/AS26133.rsc} on-error {}
...
:do {add list=$AddressList comment=AS26133 address=158.247.174.0/28} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.174.128/25} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.174.16/29} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.174.24/30} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.174.28/31} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.174.30/32} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.174.32/27} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.174.64/26} on-error {}
:do {add list=$AddressList comment=AS26133 address=158.247.175.0/24} on-error {}
