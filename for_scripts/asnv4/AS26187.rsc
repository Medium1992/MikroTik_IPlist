...
:if ([:len [find where list=$AddressList and address=23.153.236.0/24]] = 0) do={ add list=$AddressList comment=AS26187 address=23.153.236.0/24 }
:if ([:len [find where list=$AddressList and address=23.162.124.0/24]] = 0) do={ add list=$AddressList comment=AS26187 address=23.162.124.0/24 }
