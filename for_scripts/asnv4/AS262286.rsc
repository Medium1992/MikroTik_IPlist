...
:if ([:len [find where list=$AddressList and address=177.52.252.0/23]] = 0) do={ add list=$AddressList comment=AS262286 address=177.52.252.0/23 }
:if ([:len [find where list=$AddressList and address=177.52.254.0/24]] = 0) do={ add list=$AddressList comment=AS262286 address=177.52.254.0/24 }
