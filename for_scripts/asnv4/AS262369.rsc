...
:if ([:len [find where list=$AddressList and address=138.0.44.0/22]] = 0) do={ add list=$AddressList comment=AS262369 address=138.0.44.0/22 }
:if ([:len [find where list=$AddressList and address=143.137.68.0/22]] = 0) do={ add list=$AddressList comment=AS262369 address=143.137.68.0/22 }
:if ([:len [find where list=$AddressList and address=170.247.244.0/24]] = 0) do={ add list=$AddressList comment=AS262369 address=170.247.244.0/24 }
:if ([:len [find where list=$AddressList and address=170.247.246.0/23]] = 0) do={ add list=$AddressList comment=AS262369 address=170.247.246.0/23 }
