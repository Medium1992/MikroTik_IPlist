...
:do {add list=$AddressList comment=AS26241 address=for_scripts/asnv4/AS26241.rsc} on-error {}
:do {add list=$AddressList comment=AS26241 address=100.42.17.0/24} on-error {}
