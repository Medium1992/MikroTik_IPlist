...
:do {add list=$AddressList comment=AS262417 address=177.125.181.0/24} on-error {}
...
:do {add list=$AddressList comment=AS262417 address=186.209.244.0/22} on-error {}
:do {add list=$AddressList comment=AS262417 address=186.209.248.0/21} on-error {}
:do {add list=$AddressList comment=AS262417 address=186.219.56.0/22} on-error {}
:do {add list=$AddressList comment=AS262417 address=45.164.206.0/24} on-error {}
