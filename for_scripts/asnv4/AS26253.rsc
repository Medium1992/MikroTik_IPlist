...
:do {add list=$AddressList comment=AS26253 address=for_scripts/asnv4/AS26253.rsc} on-error {}
...
:do {add list=$AddressList comment=AS26253 address=199.101.204.0/24} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.0/25} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.128/27} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.160/28} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.176/29} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.184/30} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.188/31} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.190/32} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.205.192/26} on-error {}
:do {add list=$AddressList comment=AS26253 address=199.101.206.0/23} on-error {}
