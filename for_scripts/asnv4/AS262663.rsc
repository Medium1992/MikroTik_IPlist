...
:if ([:len [find where list=$AddressList and address=186.216.17.0/24]] = 0) do={ add list=$AddressList comment=AS262663 address=186.216.17.0/24 }
:if ([:len [find where list=$AddressList and address=186.216.18.0/23]] = 0) do={ add list=$AddressList comment=AS262663 address=186.216.18.0/23 }
:if ([:len [find where list=$AddressList and address=186.216.20.0/23]] = 0) do={ add list=$AddressList comment=AS262663 address=186.216.20.0/23 }
:if ([:len [find where list=$AddressList and address=186.216.23.0/24]] = 0) do={ add list=$AddressList comment=AS262663 address=186.216.23.0/24 }
:if ([:len [find where list=$AddressList and address=186.216.24.0/21]] = 0) do={ add list=$AddressList comment=AS262663 address=186.216.24.0/21 }
