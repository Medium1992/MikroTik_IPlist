...
:do {add list=$AddressList comment=AS262832 address=191.5.208.0/23} on-error {}
:do {add list=$AddressList comment=AS262832 address=191.5.211.0/24} on-error {}
:do {add list=$AddressList comment=AS262832 address=191.5.212.0/22} on-error {}
