...
:if ([:len [find where list=$AddressList and address=190.83.80.0/24]] = 0) do={ add list=$AddressList comment=AS262913 address=190.83.80.0/24 }
...
:if ([:len [find where list=$AddressList and address=190.9.48.0/23]] = 0) do={ add list=$AddressList comment=AS262913 address=190.9.48.0/23 }
:if ([:len [find where list=$AddressList and address=190.9.51.0/24]] = 0) do={ add list=$AddressList comment=AS262913 address=190.9.51.0/24 }
...
:if ([:len [find where list=$AddressList and address=201.159.17.0/24]] = 0) do={ add list=$AddressList comment=AS262913 address=201.159.17.0/24 }
:if ([:len [find where list=$AddressList and address=201.159.18.0/23]] = 0) do={ add list=$AddressList comment=AS262913 address=201.159.18.0/23 }
:if ([:len [find where list=$AddressList and address=201.159.20.0/22]] = 0) do={ add list=$AddressList comment=AS262913 address=201.159.20.0/22 }
