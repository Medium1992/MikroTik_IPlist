...
:do {add list=$AddressList comment=AS262979 address=for_scripts/asnv4/AS262979.rsc} on-error {}
:do {add list=$AddressList comment=AS262979 address=131.255.208.0/22} on-error {}
