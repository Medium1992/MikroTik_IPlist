...
:do {add list=$AddressList comment=AS263162 address=187.16.1.0/24} on-error {}
:do {add list=$AddressList comment=AS263162 address=187.16.10.0/24} on-error {}
...
:do {add list=$AddressList comment=AS263162 address=187.16.8.0/23} on-error {}
