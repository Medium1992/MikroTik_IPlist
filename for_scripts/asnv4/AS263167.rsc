...
:do {add list=$AddressList comment=AS263167 address=185.75.14.0/24} on-error {}
...
:do {add list=$AddressList comment=AS263167 address=38.123.216.0/24} on-error {}
:do {add list=$AddressList comment=AS263167 address=38.123.218.0/23} on-error {}
