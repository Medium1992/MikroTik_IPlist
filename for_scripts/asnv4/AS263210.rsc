...
:do {add list=$AddressList comment=AS263210 address=179.51.100.0/23} on-error {}
:do {add list=$AddressList comment=AS263210 address=179.51.103.0/24} on-error {}
:do {add list=$AddressList comment=AS263210 address=179.51.107.0/24} on-error {}
:do {add list=$AddressList comment=AS263210 address=179.51.110.0/23} on-error {}
...
:do {add list=$AddressList comment=AS263210 address=179.51.96.0/22} on-error {}
