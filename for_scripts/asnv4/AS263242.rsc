...
:do {add list=$AddressList comment=AS263242 address=201.150.162.0/23} on-error {}
...
:do {add list=$AddressList comment=AS263242 address=45.192.133.0/24} on-error {}
:do {add list=$AddressList comment=AS263242 address=45.196.164.0/24} on-error {}
