...
:do {add list=$AddressList comment=AS263320 address=191.7.152.0/22} on-error {}
:do {add list=$AddressList comment=AS263320 address=191.7.156.0/23} on-error {}
:do {add list=$AddressList comment=AS263320 address=191.7.159.0/24} on-error {}
