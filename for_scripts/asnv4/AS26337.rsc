...
:do {add list=$AddressList comment=AS26337 address=192.185.35.0/24} on-error {}
:do {add list=$AddressList comment=AS26337 address=192.185.5.0/24} on-error {}
...
:do {add list=$AddressList comment=AS26337 address=192.232.213.0/24} on-error {}
