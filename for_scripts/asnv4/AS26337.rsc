...
:do {add list=$AddressList comment=AS26337 address=108.179.194.0/24} on-error {}
...
:do {add list=$AddressList comment=AS26337 address=192.185.209.0/24} on-error {}
:do {add list=$AddressList comment=AS26337 address=192.185.210.0/24} on-error {}
:do {add list=$AddressList comment=AS26337 address=192.185.223.0/24} on-error {}
