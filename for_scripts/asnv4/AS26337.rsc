...
:if ([:len [find where list=$AddressList and address=129.121.100.0/24]] = 0) do={ add list=$AddressList comment=AS26337 address=129.121.100.0/24 }
...
:if ([:len [find where list=$AddressList and address=129.121.74.0/24]] = 0) do={ add list=$AddressList comment=AS26337 address=129.121.74.0/24 }
:if ([:len [find where list=$AddressList and address=129.121.79.0/24]] = 0) do={ add list=$AddressList comment=AS26337 address=129.121.79.0/24 }
