...
:do {add list=$AddressList comment=AS26347 address=for_scripts/asnv4/AS26347.rsc} on-error {}
...
:do {add list=$AddressList comment=AS26347 address=64.111.112.0/21} on-error {}
