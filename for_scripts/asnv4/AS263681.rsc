...
:do {add list=$AddressList comment=AS263681 address=for_scripts/asnv4/AS263681.rsc} on-error {}
...
:do {add list=$AddressList comment=AS263681 address=156.227.246.0/23} on-error {}
