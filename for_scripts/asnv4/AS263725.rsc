...
:do {add list=$AddressList comment=AS263725 address=for_scripts/asnv4/AS263725.rsc} on-error {}
...
:do {add list=$AddressList comment=AS263725 address=45.166.92.0/22} on-error {}
