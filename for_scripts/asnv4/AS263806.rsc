...
:do {add list=$AddressList comment=AS263806 address=38.74.239.0/24} on-error {}
:do {add list=$AddressList comment=AS263806 address=38.74.240.0/22} on-error {}
:do {add list=$AddressList comment=AS263806 address=38.74.244.0/23} on-error {}
:do {add list=$AddressList comment=AS263806 address=38.74.247.0/24} on-error {}
