...
:do {add list=$AddressList comment=AS263806 address=38.74.224.0/24} on-error {}
:do {add list=$AddressList comment=AS263806 address=38.74.226.0/24} on-error {}
:do {add list=$AddressList comment=AS263806 address=38.74.228.0/23} on-error {}
