...
:if ([:len [find where list=$AddressList and address=38.74.233.0/24]] = 0) do={ add list=$AddressList comment=AS263806 address=38.74.233.0/24 }
:if ([:len [find where list=$AddressList and address=38.74.235.0/24]] = 0) do={ add list=$AddressList comment=AS263806 address=38.74.235.0/24 }
