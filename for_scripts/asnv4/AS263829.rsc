...
:do {add list=$AddressList comment=AS263829 address=for_scripts/asnv4/AS263829.rsc} on-error {}
:do {add list=$AddressList comment=AS263829 address=138.219.72.0/22} on-error {}
