...
:if ([:len [find where list=$AddressList and address=136.143.160.0/22]] = 0) do={ add list=$AddressList comment=AS2639 address=136.143.160.0/22 }
...
:if ([:len [find where list=$AddressList and address=165.173.128.0/23]] = 0) do={ add list=$AddressList comment=AS2639 address=165.173.128.0/23 }
:if ([:len [find where list=$AddressList and address=165.173.174.0/23]] = 0) do={ add list=$AddressList comment=AS2639 address=165.173.174.0/23 }
:if ([:len [find where list=$AddressList and address=165.173.178.0/23]] = 0) do={ add list=$AddressList comment=AS2639 address=165.173.178.0/23 }
:if ([:len [find where list=$AddressList and address=165.173.180.0/22]] = 0) do={ add list=$AddressList comment=AS2639 address=165.173.180.0/22 }
