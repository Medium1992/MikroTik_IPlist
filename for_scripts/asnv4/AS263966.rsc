...
:do {add list=$AddressList comment=AS263966 address=for_scripts/asnv4/AS263966.rsc} on-error {}
...
:do {add list=$AddressList comment=AS263966 address=209.14.18.0/24} on-error {}
