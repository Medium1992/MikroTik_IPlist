...
:do {add list=$AddressList comment=AS263980 address=191.37.0.0/22} on-error {}
:do {add list=$AddressList comment=AS263980 address=191.37.4.0/23} on-error {}
:do {add list=$AddressList comment=AS263980 address=191.37.7.0/24} on-error {}
