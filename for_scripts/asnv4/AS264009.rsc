...
:do {add list=$AddressList comment=AS264009 address=for_scripts/asnv4/AS264009.rsc} on-error {}
...
:do {add list=$AddressList comment=AS264009 address=206.84.208.0/20} on-error {}
