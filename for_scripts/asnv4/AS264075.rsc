...
:if ([:len [find where list=$AddressList and address=45.166.164.0/24]] = 0) do={ add list=$AddressList comment=AS264075 address=45.166.164.0/24 }
:if ([:len [find where list=$AddressList and address=45.166.166.0/23]] = 0) do={ add list=$AddressList comment=AS264075 address=45.166.166.0/23 }
