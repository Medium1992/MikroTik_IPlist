...
:if ([:len [find where list=$AddressList and address=45.166.0.0/24]] = 0) do={ add list=$AddressList comment=AS264275 address=45.166.0.0/24 }
:if ([:len [find where list=$AddressList and address=45.166.3.0/24]] = 0) do={ add list=$AddressList comment=AS264275 address=45.166.3.0/24 }
