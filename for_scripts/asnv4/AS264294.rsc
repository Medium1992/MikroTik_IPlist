...
:do {add list=$AddressList comment=AS264294 address=for_scripts/asnv4/AS264294.rsc} on-error {}
...
:do {add list=$AddressList comment=AS264294 address=177.107.24.0/24} on-error {}
:do {add list=$AddressList comment=AS264294 address=177.107.27.0/24} on-error {}
