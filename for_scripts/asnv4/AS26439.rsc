...
:do {add list=$AddressList comment=AS26439 address=143.120.128.0/17} on-error {}
:do {add list=$AddressList comment=AS26439 address=143.120.16.0/20} on-error {}
:do {add list=$AddressList comment=AS26439 address=143.120.32.0/19} on-error {}
:do {add list=$AddressList comment=AS26439 address=143.120.64.0/18} on-error {}
