...
:do {add list=$AddressList comment=AS264780 address=200.12.28.0/22} on-error {}
...
:do {add list=$AddressList comment=AS264780 address=200.126.44.0/23} on-error {}
:do {add list=$AddressList comment=AS264780 address=200.126.46.0/24} on-error {}
