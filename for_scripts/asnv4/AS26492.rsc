...
:do {add list=$AddressList comment=AS26492 address=207.233.103.0/24} on-error {}
:do {add list=$AddressList comment=AS26492 address=207.233.105.0/24} on-error {}
:do {add list=$AddressList comment=AS26492 address=207.233.106.0/24} on-error {}
:do {add list=$AddressList comment=AS26492 address=207.233.108.0/23} on-error {}
:do {add list=$AddressList comment=AS26492 address=207.233.110.0/24} on-error {}
...
:do {add list=$AddressList comment=AS26492 address=207.62.4.0/24} on-error {}
