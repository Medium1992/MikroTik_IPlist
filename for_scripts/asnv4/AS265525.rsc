...
:do {add list=$AddressList comment=AS265525 address=38.224.25.0/24} on-error {}
:do {add list=$AddressList comment=AS265525 address=38.255.10.0/24} on-error {}
:do {add list=$AddressList comment=AS265525 address=38.255.5.0/24} on-error {}
