...
:do {add list=$AddressList comment=AS265535 address=for_scripts/asnv4/AS265535.rsc} on-error {}
:do {add list=$AddressList comment=AS265535 address=190.113.52.0/23} on-error {}
