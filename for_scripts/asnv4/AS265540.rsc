...
:do {add list=$AddressList comment=AS265540 address=152.55.160.0/21} on-error {}
:do {add list=$AddressList comment=AS265540 address=152.55.168.0/22} on-error {}
:do {add list=$AddressList comment=AS265540 address=152.55.172.0/23} on-error {}
