...
:if ([:len [find where list=$AddressList and address=38.59.128.0/24]] = 0) do={ add list=$AddressList comment=AS265605 address=38.59.128.0/24 }
:if ([:len [find where list=$AddressList and address=38.59.130.0/23]] = 0) do={ add list=$AddressList comment=AS265605 address=38.59.130.0/23 }
:if ([:len [find where list=$AddressList and address=38.59.132.0/22]] = 0) do={ add list=$AddressList comment=AS265605 address=38.59.132.0/22 }
