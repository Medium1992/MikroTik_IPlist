...
:do {add list=$AddressList comment=AS265622 address=for_scripts/asnv4/AS265622.rsc} on-error {}
:do {add list=$AddressList comment=AS265622 address=190.93.89.0/24} on-error {}
