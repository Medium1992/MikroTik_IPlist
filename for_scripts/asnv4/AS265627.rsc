...
:do {add list=$AddressList comment=AS265627 address=200.219.45.0/24} on-error {}
:do {add list=$AddressList comment=AS265627 address=200.219.47.0/24} on-error {}
...
:do {add list=$AddressList comment=AS265627 address=45.174.76.0/22} on-error {}
