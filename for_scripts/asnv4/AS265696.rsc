...
:if ([:len [find where list=$AddressList and address=45.5.186.0/23]] = 0) do={ add list=$AddressList comment=AS265696 address=45.5.186.0/23 }
:if ([:len [find where list=$AddressList and address=45.5.188.0/22]] = 0) do={ add list=$AddressList comment=AS265696 address=45.5.188.0/22 }
