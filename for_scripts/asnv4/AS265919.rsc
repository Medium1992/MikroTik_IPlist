...
:do {add list=$AddressList comment=AS265919 address=143.14.163.0/24} on-error {}
:do {add list=$AddressList comment=AS265919 address=143.14.168.0/24} on-error {}
...
:do {add list=$AddressList comment=AS265919 address=82.40.22.0/24} on-error {}
:do {add list=$AddressList comment=AS265919 address=87.76.215.0/24} on-error {}
