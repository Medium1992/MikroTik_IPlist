...
:do {add list=$AddressList comment=AS266500 address=for_scripts/asnv4/AS266500.rsc} on-error {}
:do {add list=$AddressList comment=AS266500 address=170.244.196.0/22} on-error {}
:do {add list=$AddressList comment=AS266500 address=185.164.57.0/24} on-error {}
