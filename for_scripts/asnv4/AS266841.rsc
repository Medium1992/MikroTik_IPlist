...
:do {add list=$AddressList comment=AS266841 address=38.121.208.0/23} on-error {}
:do {add list=$AddressList comment=AS266841 address=38.121.210.0/24} on-error {}
:do {add list=$AddressList comment=AS266841 address=38.121.212.0/22} on-error {}
