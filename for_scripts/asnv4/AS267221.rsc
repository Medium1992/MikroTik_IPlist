...
:do {add list=$AddressList comment=AS267221 address=177.52.241.0/24} on-error {}
:do {add list=$AddressList comment=AS267221 address=179.189.84.0/22} on-error {}
:do {add list=$AddressList comment=AS267221 address=179.189.92.0/23} on-error {}
:do {add list=$AddressList comment=AS267221 address=45.191.228.0/24} on-error {}
