...
:do {add list=$AddressList comment=AS26739 address=144.225.251.0/24} on-error {}
...
:do {add list=$AddressList comment=AS26739 address=178.83.34.0/24} on-error {}
...
:do {add list=$AddressList comment=AS26739 address=89.167.129.0/24} on-error {}
