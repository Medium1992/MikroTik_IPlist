...
:do {add list=$AddressList comment=AS26753 address=for_scripts/asnv4/AS26753.rsc} on-error {}
:do {add list=$AddressList comment=AS26753 address=108.60.0.0/20} on-error {}
