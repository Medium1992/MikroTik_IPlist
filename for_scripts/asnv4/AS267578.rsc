...
:if ([:len [find where list=$AddressList and address=170.82.52.0/23]] = 0) do={ add list=$AddressList comment=AS267578 address=170.82.52.0/23 }
:if ([:len [find where list=$AddressList and address=170.82.54.0/24]] = 0) do={ add list=$AddressList comment=AS267578 address=170.82.54.0/24 }
