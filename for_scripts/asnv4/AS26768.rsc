...
:do {add list=$AddressList comment=AS26768 address=for_scripts/asnv4/AS26768.rsc} on-error {}
...
:do {add list=$AddressList comment=AS26768 address=140.235.9.0/24} on-error {}
