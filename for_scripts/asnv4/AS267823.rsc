...
:if ([:len [find where list=$AddressList and address=194.30.183.0/24]] = 0) do={ add list=$AddressList comment=AS267823 address=194.30.183.0/24 }
:if ([:len [find where list=$AddressList and address=194.31.1.0/24]] = 0) do={ add list=$AddressList comment=AS267823 address=194.31.1.0/24 }
