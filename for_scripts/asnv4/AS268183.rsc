...
:do {add list=$AddressList comment=AS268183 address=for_scripts/asnv4/AS268183.rsc} on-error {}
:do {add list=$AddressList comment=AS268183 address=45.171.24.0/23} on-error {}
