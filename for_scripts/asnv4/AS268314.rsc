...
:do {add list=$AddressList comment=AS268314 address=149.78.12.0/23} on-error {}
:do {add list=$AddressList comment=AS268314 address=149.78.15.0/24} on-error {}
...
:do {add list=$AddressList comment=AS268314 address=181.233.83.0/24} on-error {}
...
:do {add list=$AddressList comment=AS268314 address=38.250.212.0/24} on-error {}
:do {add list=$AddressList comment=AS268314 address=38.250.214.0/23} on-error {}
