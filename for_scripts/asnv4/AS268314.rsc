...
:if ([:len [find where list=$AddressList and address=38.250.208.0/22]] = 0) do={ add list=$AddressList comment=AS268314 address=38.250.208.0/22 }
:if ([:len [find where list=$AddressList and address=38.250.212.0/23]] = 0) do={ add list=$AddressList comment=AS268314 address=38.250.212.0/23 }
:if ([:len [find where list=$AddressList and address=38.250.215.0/24]] = 0) do={ add list=$AddressList comment=AS268314 address=38.250.215.0/24 }
:if ([:len [find where list=$AddressList and address=38.250.216.0/21]] = 0) do={ add list=$AddressList comment=AS268314 address=38.250.216.0/21 }
