...
:do {add list=$AddressList comment=AS26832 address=104.241.180.0/24} on-error {}
...
:do {add list=$AddressList comment=AS26832 address=38.9.96.0/20} on-error {}
:do {add list=$AddressList comment=AS26832 address=78.17.93.0/24} on-error {}
