...
:do {add list=$AddressList comment=AS26891 address=162.210.179.0/24} on-error {}
:do {add list=$AddressList comment=AS26891 address=64.25.224.0/24} on-error {}
:do {add list=$AddressList comment=AS26891 address=64.25.227.0/24} on-error {}
:do {add list=$AddressList comment=AS26891 address=64.25.238.0/23} on-error {}
