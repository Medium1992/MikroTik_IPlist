...
:do {add list=$AddressList comment=AS26891 address=for_scripts/asnv4/AS26891.rsc} on-error {}
...
:do {add list=$AddressList comment=AS26891 address=216.241.161.0/24} on-error {}
...
:do {add list=$AddressList comment=AS26891 address=66.110.188.0/22} on-error {}
:do {add list=$AddressList comment=AS26891 address=97.64.1.0/24} on-error {}
:do {add list=$AddressList comment=AS26891 address=97.64.2.0/23} on-error {}
