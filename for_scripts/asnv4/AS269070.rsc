...
:do {add list=$AddressList comment=AS269070 address=for_scripts/asnv4/AS269070.rsc} on-error {}
...
:do {add list=$AddressList comment=AS269070 address=190.93.67.0/24} on-error {}
