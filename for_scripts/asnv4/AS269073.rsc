...
:do {add list=$AddressList comment=AS269073 address=for_scripts/asnv4/AS269073.rsc} on-error {}
...
:do {add list=$AddressList comment=AS269073 address=187.17.33.0/24} on-error {}
:do {add list=$AddressList comment=AS269073 address=187.17.34.0/23} on-error {}
:do {add list=$AddressList comment=AS269073 address=187.17.36.0/22} on-error {}
:do {add list=$AddressList comment=AS269073 address=187.17.40.0/21} on-error {}
