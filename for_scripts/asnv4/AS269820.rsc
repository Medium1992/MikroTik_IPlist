...
:do {add list=$AddressList comment=AS269820 address=154.41.176.0/22} on-error {}
:do {add list=$AddressList comment=AS269820 address=154.41.180.0/23} on-error {}
...
:do {add list=$AddressList comment=AS269820 address=38.43.251.0/24} on-error {}
