...
:do {add list=$AddressList comment=AS269822 address=185.104.164.0/24} on-error {}
:do {add list=$AddressList comment=AS269822 address=185.104.166.0/23} on-error {}
:do {add list=$AddressList comment=AS269822 address=185.91.192.0/23} on-error {}
:do {add list=$AddressList comment=AS269822 address=190.102.123.0/24} on-error {}
