...
:do {add list=$AddressList comment=AS269909 address=149.78.84.0/24} on-error {}
:do {add list=$AddressList comment=AS269909 address=149.78.87.0/24} on-error {}
...
:do {add list=$AddressList comment=AS269909 address=206.0.80.0/21} on-error {}
