...
:do {add list=$AddressList comment=AS270026 address=38.172.160.0/22} on-error {}
:do {add list=$AddressList comment=AS270026 address=38.172.168.0/21} on-error {}
:do {add list=$AddressList comment=AS270026 address=38.172.176.0/21} on-error {}
:do {add list=$AddressList comment=AS270026 address=38.172.188.0/23} on-error {}
