...
:do {add list=$AddressList comment=AS270158 address=for_scripts/asnv4/AS270158.rsc} on-error {}
...
:do {add list=$AddressList comment=AS270158 address=69.171.212.0/22} on-error {}
