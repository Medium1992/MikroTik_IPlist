...
:do {add list=$AddressList comment=AS27016 address=148.184.180.0/22} on-error {}
...
:do {add list=$AddressList comment=AS27016 address=148.184.230.0/23} on-error {}
:do {add list=$AddressList comment=AS27016 address=148.184.235.0/24} on-error {}
