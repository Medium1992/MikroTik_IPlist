...
:if ([:len [find where list=$AddressList and address=38.108.81.0/24]] = 0) do={ add list=$AddressList comment=AS27020 address=38.108.81.0/24 }
:if ([:len [find where list=$AddressList and address=38.109.156.0/24]] = 0) do={ add list=$AddressList comment=AS27020 address=38.109.156.0/24 }
