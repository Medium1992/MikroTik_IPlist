...
:if ([:len [find where list=$AddressList and address=154.27.200.0/23]] = 0) do={ add list=$AddressList comment=AS270207 address=154.27.200.0/23 }
...
:if ([:len [find where list=$AddressList and address=154.27.216.0/24]] = 0) do={ add list=$AddressList comment=AS270207 address=154.27.216.0/24 }
