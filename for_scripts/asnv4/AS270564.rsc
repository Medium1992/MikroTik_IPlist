...
:do {add list=$AddressList comment=AS270564 address=for_scripts/asnv4/AS270564.rsc} on-error {}
...
:do {add list=$AddressList comment=AS270564 address=89.213.142.0/24} on-error {}
