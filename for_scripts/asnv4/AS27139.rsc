...
:if ([:len [find where list=$AddressList and address=128.26.90.0/24]] = 0) do={ add list=$AddressList comment=AS27139 address=128.26.90.0/24 }
...
:if ([:len [find where list=$AddressList and address=205.61.254.0/23]] = 0) do={ add list=$AddressList comment=AS27139 address=205.61.254.0/23 }
