...
:do {add list=$AddressList comment=AS271627 address=38.188.40.0/24} on-error {}
:do {add list=$AddressList comment=AS271627 address=38.188.42.0/23} on-error {}
...
:do {add list=$AddressList comment=AS271627 address=45.178.80.0/24} on-error {}
