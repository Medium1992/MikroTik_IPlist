...
:if ([:len [find where list=$AddressList and address=82.86.104.0/22]] = 0) do={ add list=$AddressList comment=AS271791 address=82.86.104.0/22 }
:if ([:len [find where list=$AddressList and address=82.86.108.0/23]] = 0) do={ add list=$AddressList comment=AS271791 address=82.86.108.0/23 }
:if ([:len [find where list=$AddressList and address=82.86.111.0/24]] = 0) do={ add list=$AddressList comment=AS271791 address=82.86.111.0/24 }
