...
:do {add list=$AddressList comment=AS27185 address=170.77.192.0/22} on-error {}
:do {add list=$AddressList comment=AS27185 address=170.77.200.0/21} on-error {}
:do {add list=$AddressList comment=AS27185 address=170.77.208.0/20} on-error {}
:do {add list=$AddressList comment=AS27185 address=170.77.224.0/19} on-error {}
