...
:do {add list=$AddressList comment=AS272027 address=190.112.200.0/24} on-error {}
:do {add list=$AddressList comment=AS272027 address=190.112.202.0/23} on-error {}
:do {add list=$AddressList comment=AS272027 address=190.93.113.0/24} on-error {}
:do {add list=$AddressList comment=AS272027 address=190.93.120.0/24} on-error {}
:do {add list=$AddressList comment=AS272027 address=190.93.122.0/23} on-error {}
