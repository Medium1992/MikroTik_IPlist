...
:if ([:len [find where list=$AddressList and address=141.171.100.0/23]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.100.0/23 }
...
:if ([:len [find where list=$AddressList and address=141.171.83.0/24]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.83.0/24 }
:if ([:len [find where list=$AddressList and address=141.171.85.0/24]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.85.0/24 }
:if ([:len [find where list=$AddressList and address=141.171.86.0/23]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.86.0/23 }
:if ([:len [find where list=$AddressList and address=141.171.88.0/24]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.88.0/24 }
:if ([:len [find where list=$AddressList and address=141.171.90.0/23]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.90.0/23 }
:if ([:len [find where list=$AddressList and address=141.171.92.0/22]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.92.0/22 }
:if ([:len [find where list=$AddressList and address=141.171.96.0/22]] = 0) do={ add list=$AddressList comment=AS272096 address=141.171.96.0/22 }
