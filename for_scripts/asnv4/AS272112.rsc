...
:do {add list=$AddressList comment=AS272112 address=for_scripts/asnv4/AS272112.rsc} on-error {}
...
:do {add list=$AddressList comment=AS272112 address=38.7.137.0/24} on-error {}
