...
:if ([:len [find where list=$AddressList and address=66.84.112.0/21]] = 0) do={ add list=$AddressList comment=AS27216 address=66.84.112.0/21 }
:if ([:len [find where list=$AddressList and address=66.84.121.0/24]] = 0) do={ add list=$AddressList comment=AS27216 address=66.84.121.0/24 }
:if ([:len [find where list=$AddressList and address=66.84.122.0/23]] = 0) do={ add list=$AddressList comment=AS27216 address=66.84.122.0/23 }
:if ([:len [find where list=$AddressList and address=66.84.124.0/22]] = 0) do={ add list=$AddressList comment=AS27216 address=66.84.124.0/22 }
:if ([:len [find where list=$AddressList and address=66.84.96.0/20]] = 0) do={ add list=$AddressList comment=AS27216 address=66.84.96.0/20 }
