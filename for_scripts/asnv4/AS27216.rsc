...
:if ([:len [find where list=$AddressList and address=64.90.208.0/23]] = 0) do={ add list=$AddressList comment=AS27216 address=64.90.208.0/23 }
:if ([:len [find where list=$AddressList and address=64.90.210.0/24]] = 0) do={ add list=$AddressList comment=AS27216 address=64.90.210.0/24 }
