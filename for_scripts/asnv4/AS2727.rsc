...
:do {add list=$AddressList comment=AS2727 address=for_scripts/asnv4/AS2727.rsc} on-error {}
...
:do {add list=$AddressList comment=AS2727 address=66.115.80.0/20} on-error {}
