...
:do {add list=$AddressList comment=AS27277 address=135.136.160.0/24} on-error {}
:do {add list=$AddressList comment=AS27277 address=135.136.162.0/24} on-error {}
...
:do {add list=$AddressList comment=AS27277 address=198.13.248.0/23} on-error {}
