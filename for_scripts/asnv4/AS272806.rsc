...
:do {add list=$AddressList comment=AS272806 address=for_scripts/asnv4/AS272806.rsc} on-error {}
...
:do {add list=$AddressList comment=AS272806 address=45.68.29.0/24} on-error {}
