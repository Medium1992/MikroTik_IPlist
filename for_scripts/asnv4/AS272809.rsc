...
:do {add list=$AddressList comment=AS272809 address=154.45.130.0/23} on-error {}
:do {add list=$AddressList comment=AS272809 address=154.45.132.0/22} on-error {}
:do {add list=$AddressList comment=AS272809 address=154.45.136.0/21} on-error {}
:do {add list=$AddressList comment=AS272809 address=154.45.144.0/20} on-error {}
:do {add list=$AddressList comment=AS272809 address=154.45.160.0/19} on-error {}
