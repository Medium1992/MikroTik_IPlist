...
:do {add list=$AddressList comment=AS273057 address=for_scripts/asnv4/AS273057.rsc} on-error {}
:do {add list=$AddressList comment=AS273057 address=200.41.112.0/24} on-error {}
:do {add list=$AddressList comment=AS273057 address=38.10.92.0/23} on-error {}
