...
:if ([:len [find where list=$AddressList and address=38.188.232.0/23]] = 0) do={ add list=$AddressList comment=AS273173 address=38.188.232.0/23 }
:if ([:len [find where list=$AddressList and address=38.188.234.0/24]] = 0) do={ add list=$AddressList comment=AS273173 address=38.188.234.0/24 }
