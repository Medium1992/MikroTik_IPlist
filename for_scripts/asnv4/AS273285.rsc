...
:if ([:len [find where list=$AddressList and address=204.157.135.0/24]] = 0) do={ add list=$AddressList comment=AS273285 address=204.157.135.0/24 }
:if ([:len [find where list=$AddressList and address=204.157.160.0/24]] = 0) do={ add list=$AddressList comment=AS273285 address=204.157.160.0/24 }
