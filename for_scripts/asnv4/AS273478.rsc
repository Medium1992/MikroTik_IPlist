...
:do {add list=$AddressList comment=AS273478 address=for_scripts/asnv4/AS273478.rsc} on-error {}
...
:do {add list=$AddressList comment=AS273478 address=156.232.104.0/24} on-error {}
