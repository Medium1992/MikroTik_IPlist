...
:if ([:len [find where list=$AddressList and address=64.146.132.0/23]] = 0) do={ add list=$AddressList comment=AS27373 address=64.146.132.0/23 }
...
:if ([:len [find where list=$AddressList and address=64.239.232.0/22]] = 0) do={ add list=$AddressList comment=AS27373 address=64.239.232.0/22 }
