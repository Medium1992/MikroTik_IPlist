...
:do {add list=$AddressList comment=AS273824 address=for_scripts/asnv4/AS273824.rsc} on-error {}
:do {add list=$AddressList comment=AS273824 address=190.93.118.0/24} on-error {}
