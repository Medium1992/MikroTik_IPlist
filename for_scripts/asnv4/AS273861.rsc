...
:if ([:len [find where list=$AddressList and address=38.127.151.0/24]] = 0) do={ add list=$AddressList comment=AS273861 address=38.127.151.0/24 }
...
:if ([:len [find where list=$AddressList and address=38.247.46.0/23]] = 0) do={ add list=$AddressList comment=AS273861 address=38.247.46.0/23 }
