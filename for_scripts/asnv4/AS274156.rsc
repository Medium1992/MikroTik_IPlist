...
:if ([:len [find where list=$AddressList and address=132.255.236.0/24]] = 0) do={ add list=$AddressList comment=AS274156 address=132.255.236.0/24 }
:if ([:len [find where list=$AddressList and address=132.255.238.0/23]] = 0) do={ add list=$AddressList comment=AS274156 address=132.255.238.0/23 }
