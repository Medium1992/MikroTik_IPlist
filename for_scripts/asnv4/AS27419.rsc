...
:if ([:len [find where list=$AddressList and address=64.82.192.0/20]] = 0) do={ add list=$AddressList comment=AS27419 address=64.82.192.0/20 }
:if ([:len [find where list=$AddressList and address=64.82.208.0/21]] = 0) do={ add list=$AddressList comment=AS27419 address=64.82.208.0/21 }
:if ([:len [find where list=$AddressList and address=64.82.220.0/22]] = 0) do={ add list=$AddressList comment=AS27419 address=64.82.220.0/22 }
:if ([:len [find where list=$AddressList and address=64.82.224.0/19]] = 0) do={ add list=$AddressList comment=AS27419 address=64.82.224.0/19 }
