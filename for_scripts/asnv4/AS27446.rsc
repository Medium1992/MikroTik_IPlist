...
:if ([:len [find where list=$AddressList and address=72.250.240.0/20]] = 0) do={ add list=$AddressList comment=AS27446 address=72.250.240.0/20 }
...
:if ([:len [find where list=$AddressList and address=72.27.249.0/24]] = 0) do={ add list=$AddressList comment=AS27446 address=72.27.249.0/24 }
