...
:do {add list=$AddressList comment=AS27483 address=for_scripts/asnv4/AS27483.rsc} on-error {}
:do {add list=$AddressList comment=AS27483 address=198.203.32.0/22} on-error {}
:do {add list=$AddressList comment=AS27483 address=198.203.36.0/24} on-error {}
