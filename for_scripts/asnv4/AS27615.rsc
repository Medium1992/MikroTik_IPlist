...
:if ([:len [find where list=$AddressList and address=67.23.84.0/24]] = 0) do={ add list=$AddressList comment=AS27615 address=67.23.84.0/24 }
:if ([:len [find where list=$AddressList and address=67.23.86.0/23]] = 0) do={ add list=$AddressList comment=AS27615 address=67.23.86.0/23 }
