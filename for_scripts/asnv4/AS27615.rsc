...
:do {add list=$AddressList comment=AS27615 address=67.23.84.0/24} on-error {}
:do {add list=$AddressList comment=AS27615 address=67.23.86.0/23} on-error {}
:do {add list=$AddressList comment=AS27615 address=67.23.88.0/24} on-error {}
