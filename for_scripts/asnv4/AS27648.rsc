...
:if ([:len [find where list=$AddressList and address=201.222.12.0/23]] = 0) do={ add list=$AddressList comment=AS27648 address=201.222.12.0/23 }
:if ([:len [find where list=$AddressList and address=201.222.14.0/24]] = 0) do={ add list=$AddressList comment=AS27648 address=201.222.14.0/24 }
