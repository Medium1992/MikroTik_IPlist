...
:do {add list=$AddressList comment=AS27735 address=for_scripts/asnv4/AS27735.rsc} on-error {}
...
:do {add list=$AddressList comment=AS27735 address=200.14.89.0/24} on-error {}
