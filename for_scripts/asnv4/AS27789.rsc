...
:do {add list=$AddressList comment=AS27789 address=for_scripts/asnv4/AS27789.rsc} on-error {}
:do {add list=$AddressList comment=AS27789 address=190.93.0.0/22} on-error {}
:do {add list=$AddressList comment=AS27789 address=190.93.110.0/23} on-error {}
