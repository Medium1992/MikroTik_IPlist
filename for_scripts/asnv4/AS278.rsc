...
:do {add list=$AddressList comment=AS278 address=for_scripts/asnv4/AS278.rsc} on-error {}
...
:do {add list=$AddressList comment=AS278 address=192.100.200.0/24} on-error {}
