...
:if ([:len [find where list=$AddressList and address=38.254.64.0/21]] = 0) do={ add list=$AddressList comment=AS27813 address=38.254.64.0/21 }
:if ([:len [find where list=$AddressList and address=38.254.72.0/24]] = 0) do={ add list=$AddressList comment=AS27813 address=38.254.72.0/24 }
