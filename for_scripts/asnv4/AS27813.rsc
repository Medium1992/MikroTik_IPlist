...
:if ([:len [find where list=$AddressList and address=38.254.68.0/23]] = 0) do={ add list=$AddressList comment=AS27813 address=38.254.68.0/23 }
:if ([:len [find where list=$AddressList and address=38.254.70.0/24]] = 0) do={ add list=$AddressList comment=AS27813 address=38.254.70.0/24 }
