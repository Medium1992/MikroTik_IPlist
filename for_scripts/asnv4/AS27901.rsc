...
:if ([:len [find where list=$AddressList and address=179.60.64.0/19]] = 0) do={ add list=$AddressList comment=AS27901 address=179.60.64.0/19 }
...
:if ([:len [find where list=$AddressList and address=190.5.32.0/19]] = 0) do={ add list=$AddressList comment=AS27901 address=190.5.32.0/19 }
