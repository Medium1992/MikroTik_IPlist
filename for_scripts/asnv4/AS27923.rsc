...
:if ([:len [find where list=$AddressList and address=152.231.0.0/20]] = 0) do={ add list=$AddressList comment=AS27923 address=152.231.0.0/20 }
...
:if ([:len [find where list=$AddressList and address=190.97.176.0/20]] = 0) do={ add list=$AddressList comment=AS27923 address=190.97.176.0/20 }
