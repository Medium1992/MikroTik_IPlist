...
:do {add list=$AddressList comment=AS27987 address=168.227.206.0/24} on-error {}
...
:do {add list=$AddressList comment=AS27987 address=190.103.192.0/22} on-error {}
:do {add list=$AddressList comment=AS27987 address=190.103.198.0/23} on-error {}
:do {add list=$AddressList comment=AS27987 address=190.103.200.0/22} on-error {}
:do {add list=$AddressList comment=AS27987 address=190.103.204.0/24} on-error {}
:do {add list=$AddressList comment=AS27987 address=190.103.207.0/24} on-error {}
