...
:do {add list=$AddressList comment=AS27988 address=for_scripts/asnv4/AS27988.rsc} on-error {}
...
:do {add list=$AddressList comment=AS27988 address=190.122.91.0/24} on-error {}
:do {add list=$AddressList comment=AS27988 address=190.122.94.0/23} on-error {}
