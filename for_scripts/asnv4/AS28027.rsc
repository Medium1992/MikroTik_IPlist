...
:do {add list=$AddressList comment=AS28027 address=for_scripts/asnv4/AS28027.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28027 address=200.10.148.0/22} on-error {}
