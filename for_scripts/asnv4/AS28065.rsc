...
:do {add list=$AddressList comment=AS28065 address=for_scripts/asnv4/AS28065.rsc} on-error {}
:do {add list=$AddressList comment=AS28065 address=200.114.82.0/23} on-error {}
:do {add list=$AddressList comment=AS28065 address=200.114.84.0/22} on-error {}
