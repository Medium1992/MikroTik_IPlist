...
:do {add list=$AddressList comment=AS28136 address=for_scripts/asnv4/AS28136.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28136 address=187.45.137.0/24} on-error {}
