...
:do {add list=$AddressList comment=AS28165 address=for_scripts/asnv4/AS28165.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28165 address=177.184.192.0/20} on-error {}
