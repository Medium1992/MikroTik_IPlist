...
:if ([:len [find where list=$AddressList and address=189.90.4.0/23]] = 0) do={ add list=$AddressList comment=AS28189 address=189.90.4.0/23 }
:if ([:len [find where list=$AddressList and address=189.90.7.0/24]] = 0) do={ add list=$AddressList comment=AS28189 address=189.90.7.0/24 }
