...
:do {add list=$AddressList comment=AS28189 address=186.224.192.0/23} on-error {}
:do {add list=$AddressList comment=AS28189 address=186.224.194.0/24} on-error {}
...
:do {add list=$AddressList comment=AS28189 address=189.90.4.0/23} on-error {}
:do {add list=$AddressList comment=AS28189 address=189.90.7.0/24} on-error {}
