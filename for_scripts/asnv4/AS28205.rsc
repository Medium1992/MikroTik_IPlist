...
:do {add list=$AddressList comment=AS28205 address=187.85.240.0/23} on-error {}
:do {add list=$AddressList comment=AS28205 address=187.85.242.0/24} on-error {}
:do {add list=$AddressList comment=AS28205 address=187.85.244.0/24} on-error {}
