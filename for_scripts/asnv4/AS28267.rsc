...
:do {add list=$AddressList comment=AS28267 address=190.102.48.0/24} on-error {}
:do {add list=$AddressList comment=AS28267 address=190.102.50.0/23} on-error {}
:do {add list=$AddressList comment=AS28267 address=45.175.1.0/24} on-error {}
:do {add list=$AddressList comment=AS28267 address=45.175.3.0/24} on-error {}
