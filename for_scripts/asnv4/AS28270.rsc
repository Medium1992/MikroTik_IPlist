...
:do {add list=$AddressList comment=AS28270 address=187.18.128.0/21} on-error {}
:do {add list=$AddressList comment=AS28270 address=187.18.137.0/24} on-error {}
:do {add list=$AddressList comment=AS28270 address=187.18.138.0/23} on-error {}
:do {add list=$AddressList comment=AS28270 address=187.18.140.0/22} on-error {}
...
:do {add list=$AddressList comment=AS28270 address=187.18.176.0/20} on-error {}
...
:do {add list=$AddressList comment=AS28270 address=189.45.100.0/22} on-error {}
:do {add list=$AddressList comment=AS28270 address=189.45.68.0/22} on-error {}
:do {add list=$AddressList comment=AS28270 address=189.45.72.0/21} on-error {}
:do {add list=$AddressList comment=AS28270 address=189.45.80.0/21} on-error {}
