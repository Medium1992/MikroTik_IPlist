...
:do {add list=$AddressList comment=AS28273 address=for_scripts/asnv4/AS28273.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28273 address=201.33.13.0/24} on-error {}
