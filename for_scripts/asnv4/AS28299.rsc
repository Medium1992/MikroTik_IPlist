...
:if ([:len [find where list=$AddressList and address=189.38.95.0/24]] = 0) do={ add list=$AddressList comment=AS28299 address=189.38.95.0/24 }
...
:if ([:len [find where list=$AddressList and address=191.6.208.0/21]] = 0) do={ add list=$AddressList comment=AS28299 address=191.6.208.0/21 }
:if ([:len [find where list=$AddressList and address=191.6.216.0/22]] = 0) do={ add list=$AddressList comment=AS28299 address=191.6.216.0/22 }
:if ([:len [find where list=$AddressList and address=191.6.220.0/23]] = 0) do={ add list=$AddressList comment=AS28299 address=191.6.220.0/23 }
:if ([:len [find where list=$AddressList and address=191.6.223.0/24]] = 0) do={ add list=$AddressList comment=AS28299 address=191.6.223.0/24 }
