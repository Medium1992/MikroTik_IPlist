...
:do {add list=$AddressList comment=AS28329 address=for_scripts/asnv4/AS28329.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28329 address=179.96.120.0/22} on-error {}
...
:do {add list=$AddressList comment=AS28329 address=186.226.92.0/22} on-error {}
