...
:do {add list=$AddressList comment=AS28329 address=179.96.0.0/19} on-error {}
...
:do {add list=$AddressList comment=AS28329 address=179.96.32.0/21} on-error {}
:do {add list=$AddressList comment=AS28329 address=179.96.48.0/20} on-error {}
