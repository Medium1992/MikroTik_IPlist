...
:if ([:len [find where list=$AddressList and address=189.84.232.0/22]] = 0) do={ add list=$AddressList comment=AS28338 address=189.84.232.0/22 }
...
:if ([:len [find where list=$AddressList and address=189.84.239.0/24]] = 0) do={ add list=$AddressList comment=AS28338 address=189.84.239.0/24 }
