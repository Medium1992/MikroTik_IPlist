...
:do {add list=$AddressList comment=AS28378 address=201.150.224.0/20} on-error {}
:do {add list=$AddressList comment=AS28378 address=201.150.240.0/21} on-error {}
...
:do {add list=$AddressList comment=AS28378 address=201.150.255.0/24} on-error {}
