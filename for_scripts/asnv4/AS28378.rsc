...
:if ([:len [find where list=$AddressList and address=168.227.68.0/22]] = 0) do={ add list=$AddressList comment=AS28378 address=168.227.68.0/22 }
...
:if ([:len [find where list=$AddressList and address=201.150.224.0/19]] = 0) do={ add list=$AddressList comment=AS28378 address=201.150.224.0/19 }
