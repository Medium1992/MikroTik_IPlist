...
:if ([:len [find where list=$AddressList and address=38.65.164.0/23]] = 0) do={ add list=$AddressList comment=AS28409 address=38.65.164.0/23 }
:if ([:len [find where list=$AddressList and address=38.65.166.0/24]] = 0) do={ add list=$AddressList comment=AS28409 address=38.65.166.0/24 }
