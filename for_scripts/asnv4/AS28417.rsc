...
:do {add list=$AddressList comment=AS28417 address=for_scripts/asnv4/AS28417.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28417 address=148.222.140.0/22} on-error {}
...
:do {add list=$AddressList comment=AS28417 address=148.222.252.0/22} on-error {}
