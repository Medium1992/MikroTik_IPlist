...
:do {add list=$AddressList comment=AS28423 address=45.170.251.0/24} on-error {}
:do {add list=$AddressList comment=AS28423 address=45.170.252.0/24} on-error {}
:do {add list=$AddressList comment=AS28423 address=45.170.254.0/23} on-error {}
