...
:do {add list=$AddressList comment=AS2843 address=130.236.224.0/22} on-error {}
:do {add list=$AddressList comment=AS2843 address=130.236.230.0/23} on-error {}
:do {add list=$AddressList comment=AS2843 address=130.236.232.0/21} on-error {}
