...
:if ([:len [find where list=$AddressList and address=63.245.61.0/24]] = 0) do={ add list=$AddressList comment=AS28506 address=63.245.61.0/24 }
:if ([:len [find where list=$AddressList and address=63.245.62.0/24]] = 0) do={ add list=$AddressList comment=AS28506 address=63.245.62.0/24 }
