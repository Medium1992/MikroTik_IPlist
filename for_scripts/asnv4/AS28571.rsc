...
:do {add list=$AddressList comment=AS28571 address=for_scripts/asnv4/AS28571.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28571 address=200.144.83.0/24} on-error {}
