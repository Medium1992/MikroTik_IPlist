...
:if ([:len [find where list=$AddressList and address=189.38.16.0/23]] = 0) do={ add list=$AddressList comment=AS28576 address=189.38.16.0/23 }
:if ([:len [find where list=$AddressList and address=189.38.19.0/24]] = 0) do={ add list=$AddressList comment=AS28576 address=189.38.19.0/24 }
