...
:do {add list=$AddressList comment=AS28676 address=217.19.176.0/21} on-error {}
:do {add list=$AddressList comment=AS28676 address=217.19.184.0/24} on-error {}
:do {add list=$AddressList comment=AS28676 address=217.19.186.0/23} on-error {}
:do {add list=$AddressList comment=AS28676 address=217.19.188.0/22} on-error {}
