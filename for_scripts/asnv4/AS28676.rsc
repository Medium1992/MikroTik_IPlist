...
:if ([:len [find where list=$AddressList and address=185.158.157.0/24]] = 0) do={ add list=$AddressList comment=AS28676 address=185.158.157.0/24 }
:if ([:len [find where list=$AddressList and address=185.158.158.0/23]] = 0) do={ add list=$AddressList comment=AS28676 address=185.158.158.0/23 }
