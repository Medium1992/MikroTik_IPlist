...
:do {add list=$AddressList comment=AS28686 address=103.55.232.0/22} on-error {}
:do {add list=$AddressList comment=AS28686 address=159.168.0.0/16} on-error {}
:do {add list=$AddressList comment=AS28686 address=185.130.140.0/22} on-error {}
:do {add list=$AddressList comment=AS28686 address=185.184.116.0/22} on-error {}
:do {add list=$AddressList comment=AS28686 address=185.196.104.0/22} on-error {}
...
:do {add list=$AddressList comment=AS28686 address=193.222.224.0/20} on-error {}
:do {add list=$AddressList comment=AS28686 address=193.222.240.0/24} on-error {}
