...
:do {add list=$AddressList comment=AS28723 address=for_scripts/asnv4/AS28723.rsc} on-error {}
...
:do {add list=$AddressList comment=AS28723 address=135.250.113.0/24} on-error {}
