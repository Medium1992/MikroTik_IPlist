...
:do {add list=$AddressList comment=AS29032 address=41.220.0.0/21} on-error {}
:do {add list=$AddressList comment=AS29032 address=41.220.10.0/23} on-error {}
:do {add list=$AddressList comment=AS29032 address=41.220.12.0/23} on-error {}
:do {add list=$AddressList comment=AS29032 address=41.220.14.0/24} on-error {}
