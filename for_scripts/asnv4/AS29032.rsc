...
:if ([:len [find where list=$AddressList and address=41.220.2.0/23]] = 0) do={ add list=$AddressList comment=AS29032 address=41.220.2.0/23 }
:if ([:len [find where list=$AddressList and address=41.220.208.0/24]] = 0) do={ add list=$AddressList comment=AS29032 address=41.220.208.0/24 }
:if ([:len [find where list=$AddressList and address=41.220.210.0/23]] = 0) do={ add list=$AddressList comment=AS29032 address=41.220.210.0/23 }
...
:if ([:len [find where list=$AddressList and address=41.220.7.0/24]] = 0) do={ add list=$AddressList comment=AS29032 address=41.220.7.0/24 }
:if ([:len [find where list=$AddressList and address=41.220.9.0/24]] = 0) do={ add list=$AddressList comment=AS29032 address=41.220.9.0/24 }
