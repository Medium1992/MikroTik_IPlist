...
:do {add list=$AddressList comment=AS29108 address=185.103.44.0/22} on-error {}
...
:do {add list=$AddressList comment=AS29108 address=94.136.160.0/22} on-error {}
:do {add list=$AddressList comment=AS29108 address=94.136.165.0/24} on-error {}
:do {add list=$AddressList comment=AS29108 address=94.136.166.0/23} on-error {}
