...
:do {add list=$AddressList comment=AS29148 address=for_scripts/asnv4/AS29148.rsc} on-error {}
...
:do {add list=$AddressList comment=AS29148 address=194.127.100.0/24} on-error {}
