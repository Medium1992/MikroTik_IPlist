...
:if ([:len [find where list=$AddressList and address=82.132.146.0/23]] = 0) do={ add list=$AddressList comment=AS29180 address=82.132.146.0/23 }
:if ([:len [find where list=$AddressList and address=82.132.148.0/22]] = 0) do={ add list=$AddressList comment=AS29180 address=82.132.148.0/22 }
:if ([:len [find where list=$AddressList and address=82.132.152.0/21]] = 0) do={ add list=$AddressList comment=AS29180 address=82.132.152.0/21 }
