...
:do {add list=$AddressList comment=AS29205 address=185.100.228.0/24} on-error {}
...
:do {add list=$AddressList comment=AS29205 address=188.214.20.0/24} on-error {}
:do {add list=$AddressList comment=AS29205 address=188.214.23.0/24} on-error {}
