...
:do {add list=$AddressList comment=AS293 address=for_scripts/asnv4/AS293.rsc} on-error {}
...
:do {add list=$AddressList comment=AS293 address=192.74.214.0/23} on-error {}
