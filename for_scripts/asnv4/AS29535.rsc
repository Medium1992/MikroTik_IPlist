...
:do {add list=$AddressList comment=AS29535 address=for_scripts/asnv4/AS29535.rsc} on-error {}
:do {add list=$AddressList comment=AS29535 address=178.42.22.0/24} on-error {}
