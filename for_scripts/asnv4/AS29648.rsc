...
:do {add list=$AddressList comment=AS29648 address=188.94.168.0/23} on-error {}
:do {add list=$AddressList comment=AS29648 address=188.94.171.0/24} on-error {}
:do {add list=$AddressList comment=AS29648 address=188.94.172.0/22} on-error {}
