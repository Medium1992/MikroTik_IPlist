...
:do {add list=$AddressList comment=AS29686 address=for_scripts/asnv4/AS29686.rsc} on-error {}
...
:do {add list=$AddressList comment=AS29686 address=46.243.72.0/23} on-error {}
