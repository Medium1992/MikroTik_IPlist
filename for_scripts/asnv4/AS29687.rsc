...
:do {add list=$AddressList comment=AS29687 address=77.71.100.0/22} on-error {}
:do {add list=$AddressList comment=AS29687 address=77.71.104.0/21} on-error {}
...
:do {add list=$AddressList comment=AS29687 address=77.71.97.0/24} on-error {}
:do {add list=$AddressList comment=AS29687 address=77.71.98.0/23} on-error {}
