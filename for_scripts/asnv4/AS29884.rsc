...
:do {add list=$AddressList comment=AS29884 address=for_scripts/asnv4/AS29884.rsc} on-error {}
...
:do {add list=$AddressList comment=AS29884 address=74.116.174.0/24} on-error {}
