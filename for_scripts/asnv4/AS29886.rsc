...
:do {add list=$AddressList comment=AS29886 address=for_scripts/asnv4/AS29886.rsc} on-error {}
:do {add list=$AddressList comment=AS29886 address=162.217.48.0/21} on-error {}
