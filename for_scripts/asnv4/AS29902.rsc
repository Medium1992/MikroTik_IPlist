...
:do {add list=$AddressList comment=AS29902 address=for_scripts/asnv4/AS29902.rsc} on-error {}
...
:do {add list=$AddressList comment=AS29902 address=70.158.10.0/24} on-error {}
:do {add list=$AddressList comment=AS29902 address=74.174.194.0/23} on-error {}
:do {add list=$AddressList comment=AS29902 address=74.174.196.0/22} on-error {}
