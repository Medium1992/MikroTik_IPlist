...
:do {add list=$AddressList comment=AS29944 address=for_scripts/asnv4/AS29944.rsc} on-error {}
...
:do {add list=$AddressList comment=AS29944 address=67.217.170.0/24} on-error {}
...
:do {add list=$AddressList comment=AS29944 address=67.217.176.0/20} on-error {}
