...
:do {add list=$AddressList comment=AS29974 address=204.138.4.0/23} on-error {}
:do {add list=$AddressList comment=AS29974 address=204.138.6.0/24} on-error {}
:do {add list=$AddressList comment=AS29974 address=207.236.240.0/24} on-error {}
