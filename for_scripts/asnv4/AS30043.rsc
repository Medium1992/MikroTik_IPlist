...
:do {add list=$AddressList comment=AS30043 address=64.110.9.0/24} on-error {}
:do {add list=$AddressList comment=AS30043 address=69.7.113.0/24} on-error {}
:do {add list=$AddressList comment=AS30043 address=69.7.115.0/24} on-error {}
...
:do {add list=$AddressList comment=AS30043 address=69.7.120.0/24} on-error {}
:do {add list=$AddressList comment=AS30043 address=69.7.126.0/23} on-error {}
