...
:do {add list=$AddressList comment=AS30148 address=185.93.229.0/24} on-error {}
:do {add list=$AddressList comment=AS30148 address=185.93.230.0/23} on-error {}
...
:do {add list=$AddressList comment=AS30148 address=208.109.0.0/23} on-error {}
:do {add list=$AddressList comment=AS30148 address=208.109.3.0/24} on-error {}
:do {add list=$AddressList comment=AS30148 address=208.109.4.0/22} on-error {}
