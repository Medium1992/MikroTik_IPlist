...
:do {add list=$AddressList comment=AS30150 address=for_scripts/asnv4/AS30150.rsc} on-error {}
...
:do {add list=$AddressList comment=AS30150 address=202.36.74.0/24} on-error {}
