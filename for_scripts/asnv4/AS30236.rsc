...
:if ([:len [find where list=$AddressList and address=104.241.185.0/24]] = 0) do={ add list=$AddressList comment=AS30236 address=104.241.185.0/24 }
...
:if ([:len [find where list=$AddressList and address=198.1.201.0/24]] = 0) do={ add list=$AddressList comment=AS30236 address=198.1.201.0/24 }
:if ([:len [find where list=$AddressList and address=198.1.202.0/24]] = 0) do={ add list=$AddressList comment=AS30236 address=198.1.202.0/24 }
