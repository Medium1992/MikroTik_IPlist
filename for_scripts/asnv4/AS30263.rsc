...
:do {add list=$AddressList comment=AS30263 address=for_scripts/asnv4/AS30263.rsc} on-error {}
...
:do {add list=$AddressList comment=AS30263 address=69.36.196.0/24} on-error {}
