...
:do {add list=$AddressList comment=AS30355 address=for_scripts/asnv4/AS30355.rsc} on-error {}
...
:do {add list=$AddressList comment=AS30355 address=38.56.252.0/22} on-error {}
