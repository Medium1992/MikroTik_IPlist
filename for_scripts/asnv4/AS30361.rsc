...
:do {add list=$AddressList comment=AS30361 address=64.88.249.0/24} on-error {}
:do {add list=$AddressList comment=AS30361 address=64.88.250.0/23} on-error {}
:do {add list=$AddressList comment=AS30361 address=64.88.252.0/22} on-error {}
