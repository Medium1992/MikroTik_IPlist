...
:do {add list=$AddressList comment=AS30456 address=103.241.212.0/24} on-error {}
:do {add list=$AddressList comment=AS30456 address=103.241.214.0/23} on-error {}
:do {add list=$AddressList comment=AS30456 address=166.88.231.0/24} on-error {}
...
:do {add list=$AddressList comment=AS30456 address=194.39.216.0/24} on-error {}
