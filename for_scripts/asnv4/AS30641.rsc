...
:do {add list=$AddressList comment=AS30641 address=for_scripts/asnv4/AS30641.rsc} on-error {}
:do {add list=$AddressList comment=AS30641 address=167.21.0.0/19} on-error {}
