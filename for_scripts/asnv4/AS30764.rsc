...
:do {add list=$AddressList comment=AS30764 address=for_scripts/asnv4/AS30764.rsc} on-error {}
...
:do {add list=$AddressList comment=AS30764 address=91.106.240.0/20} on-error {}
