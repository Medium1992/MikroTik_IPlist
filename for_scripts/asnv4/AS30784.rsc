...
:if ([:len [find where list=$AddressList and address=82.199.100.0/23]] = 0) do={ add list=$AddressList comment=AS30784 address=82.199.100.0/23 }
...
:if ([:len [find where list=$AddressList and address=82.199.122.0/23]] = 0) do={ add list=$AddressList comment=AS30784 address=82.199.122.0/23 }
