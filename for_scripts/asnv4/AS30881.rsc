...
:if ([:len [find where list=$AddressList and address=94.136.192.0/20]] = 0) do={ add list=$AddressList comment=AS30881 address=94.136.192.0/20 }
:if ([:len [find where list=$AddressList and address=94.136.208.0/23]] = 0) do={ add list=$AddressList comment=AS30881 address=94.136.208.0/23 }
:if ([:len [find where list=$AddressList and address=94.136.212.0/22]] = 0) do={ add list=$AddressList comment=AS30881 address=94.136.212.0/22 }
:if ([:len [find where list=$AddressList and address=94.136.216.0/21]] = 0) do={ add list=$AddressList comment=AS30881 address=94.136.216.0/21 }
