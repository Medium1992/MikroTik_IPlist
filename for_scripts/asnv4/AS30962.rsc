...
:if ([:len [find where list=$AddressList and address=62.108.49.0/24]] = 0) do={ add list=$AddressList comment=AS30962 address=62.108.49.0/24 }
:if ([:len [find where list=$AddressList and address=62.108.50.0/23]] = 0) do={ add list=$AddressList comment=AS30962 address=62.108.50.0/23 }
:if ([:len [find where list=$AddressList and address=62.108.52.0/22]] = 0) do={ add list=$AddressList comment=AS30962 address=62.108.52.0/22 }
:if ([:len [find where list=$AddressList and address=62.108.56.0/21]] = 0) do={ add list=$AddressList comment=AS30962 address=62.108.56.0/21 }
