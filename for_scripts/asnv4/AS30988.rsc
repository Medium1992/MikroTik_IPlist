...
:do {add list=$AddressList comment=AS30988 address=for_scripts/asnv4/AS30988.rsc} on-error {}
...
:do {add list=$AddressList comment=AS30988 address=196.200.124.0/23} on-error {}
:do {add list=$AddressList comment=AS30988 address=196.200.126.0/24} on-error {}
