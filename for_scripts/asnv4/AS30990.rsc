...
:do {add list=$AddressList comment=AS30990 address=197.241.0.0/18} on-error {}
...
:do {add list=$AddressList comment=AS30990 address=197.241.124.0/22} on-error {}
...
:do {add list=$AddressList comment=AS30990 address=41.189.243.0/24} on-error {}
