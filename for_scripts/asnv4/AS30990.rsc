...
:do {add list=$AddressList comment=AS30990 address=197.241.122.0/23} on-error {}
...
:do {add list=$AddressList comment=AS30990 address=197.241.64.0/19} on-error {}
...
:do {add list=$AddressList comment=AS30990 address=41.189.240.0/20} on-error {}
