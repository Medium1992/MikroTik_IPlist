...
:if ([:len [find where list=$AddressList and address=196.201.246.0/23]] = 0) do={ add list=$AddressList comment=AS30993 address=196.201.246.0/23 }
:if ([:len [find where list=$AddressList and address=41.205.102.0/24]] = 0) do={ add list=$AddressList comment=AS30993 address=41.205.102.0/24 }
...
:if ([:len [find where list=$AddressList and address=41.205.124.0/22]] = 0) do={ add list=$AddressList comment=AS30993 address=41.205.124.0/22 }
