...
:do {add list=$AddressList comment=AS31103 address=for_scripts/asnv4/AS31103.rsc} on-error {}
...
:do {add list=$AddressList comment=AS31103 address=84.19.160.0/22} on-error {}
:do {add list=$AddressList comment=AS31103 address=84.19.164.0/23} on-error {}
:do {add list=$AddressList comment=AS31103 address=84.19.166.0/24} on-error {}
:do {add list=$AddressList comment=AS31103 address=84.19.168.0/21} on-error {}
:do {add list=$AddressList comment=AS31103 address=84.19.176.0/20} on-error {}
