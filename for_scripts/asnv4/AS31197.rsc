...
:do {add list=$AddressList comment=AS31197 address=for_scripts/asnv4/AS31197.rsc} on-error {}
...
:do {add list=$AddressList comment=AS31197 address=81.209.200.0/23} on-error {}
