...
:do {add list=$AddressList comment=AS31213 address=178.178.244.0/22} on-error {}
:do {add list=$AddressList comment=AS31213 address=178.178.248.0/23} on-error {}
:do {add list=$AddressList comment=AS31213 address=188.162.64.0/23} on-error {}
:do {add list=$AddressList comment=AS31213 address=188.170.64.0/24} on-error {}
