...
:if ([:len [find where list=$AddressList and address=95.170.120.0/22]] = 0) do={ add list=$AddressList comment=AS31357 address=95.170.120.0/22 }
:if ([:len [find where list=$AddressList and address=95.170.124.0/23]] = 0) do={ add list=$AddressList comment=AS31357 address=95.170.124.0/23 }
:if ([:len [find where list=$AddressList and address=95.170.126.0/24]] = 0) do={ add list=$AddressList comment=AS31357 address=95.170.126.0/24 }
