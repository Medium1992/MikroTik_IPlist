...
:do {add list=$AddressList comment=AS31404 address=for_scripts/asnv4/AS31404.rsc} on-error {}
...
:do {add list=$AddressList comment=AS31404 address=193.148.48.0/22} on-error {}
