...
:if ([:len [find where list=$AddressList and address=185.219.124.0/24]] = 0) do={ add list=$AddressList comment=AS31490 address=185.219.124.0/24 }
...
:if ([:len [find where list=$AddressList and address=87.121.121.0/24]] = 0) do={ add list=$AddressList comment=AS31490 address=87.121.121.0/24 }
