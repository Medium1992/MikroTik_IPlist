...
:do {add list=$AddressList comment=AS31500 address=for_scripts/asnv4/AS31500.rsc} on-error {}
...
:do {add list=$AddressList comment=AS31500 address=95.140.80.0/22} on-error {}
...
:do {add list=$AddressList comment=AS31500 address=95.161.248.0/23} on-error {}
:do {add list=$AddressList comment=AS31500 address=95.161.251.0/24} on-error {}
