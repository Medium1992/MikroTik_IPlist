...
:do {add list=$AddressList comment=AS31500 address=95.161.241.0/24} on-error {}
:do {add list=$AddressList comment=AS31500 address=95.161.242.0/23} on-error {}
:do {add list=$AddressList comment=AS31500 address=95.161.244.0/22} on-error {}
:do {add list=$AddressList comment=AS31500 address=95.161.248.0/22} on-error {}
:do {add list=$AddressList comment=AS31500 address=95.161.253.0/24} on-error {}
