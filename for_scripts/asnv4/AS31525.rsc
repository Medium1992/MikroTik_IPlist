...
:if ([:len [find where list=$AddressList and address=194.32.129.0/24]] = 0) do={ add list=$AddressList comment=AS31525 address=194.32.129.0/24 }
:if ([:len [find where list=$AddressList and address=194.32.130.0/23]] = 0) do={ add list=$AddressList comment=AS31525 address=194.32.130.0/23 }
