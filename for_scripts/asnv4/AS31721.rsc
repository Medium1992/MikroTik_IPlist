...
:do {add list=$AddressList comment=AS31721 address=62.217.136.0/23} on-error {}
:do {add list=$AddressList comment=AS31721 address=62.217.139.0/24} on-error {}
:do {add list=$AddressList comment=AS31721 address=62.217.143.0/24} on-error {}
