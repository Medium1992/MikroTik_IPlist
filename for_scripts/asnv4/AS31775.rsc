...
:do {add list=$AddressList comment=AS31775 address=149.76.32.0/22} on-error {}
...
:do {add list=$AddressList comment=AS31775 address=149.76.52.0/22} on-error {}
:do {add list=$AddressList comment=AS31775 address=162.0.160.0/22} on-error {}
...
:do {add list=$AddressList comment=AS31775 address=38.130.192.0/21} on-error {}
:do {add list=$AddressList comment=AS31775 address=38.130.212.0/24} on-error {}
