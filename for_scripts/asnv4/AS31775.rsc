...
:do {add list=$AddressList comment=AS31775 address=for_scripts/asnv4/AS31775.rsc} on-error {}
...
:do {add list=$AddressList comment=AS31775 address=149.76.40.0/24} on-error {}
