...
:do {add list=$AddressList comment=AS31798 address=for_scripts/asnv4/AS31798.rsc} on-error {}
...
:do {add list=$AddressList comment=AS31798 address=206.223.53.0/24} on-error {}
