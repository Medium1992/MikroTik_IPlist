...
:do {add list=$AddressList comment=AS31856 address=196.44.188.0/24} on-error {}
:do {add list=$AddressList comment=AS31856 address=196.44.190.0/23} on-error {}
...
:do {add list=$AddressList comment=AS31856 address=41.190.40.0/23} on-error {}
:do {add list=$AddressList comment=AS31856 address=41.190.44.0/22} on-error {}
