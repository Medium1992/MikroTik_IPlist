...
:do {add list=$AddressList comment=AS32075 address=12.236.201.0/24} on-error {}
:do {add list=$AddressList comment=AS32075 address=12.32.252.0/24} on-error {}
...
:do {add list=$AddressList comment=AS32075 address=74.112.20.0/23} on-error {}
