...
:do {add list=$AddressList comment=AS32077 address=for_scripts/asnv4/AS32077.rsc} on-error {}
...
:do {add list=$AddressList comment=AS32077 address=209.208.215.0/24} on-error {}
