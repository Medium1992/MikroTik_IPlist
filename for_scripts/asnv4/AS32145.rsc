...
:do {add list=$AddressList comment=AS32145 address=131.109.130.0/24} on-error {}
:do {add list=$AddressList comment=AS32145 address=131.109.134.0/24} on-error {}
...
:do {add list=$AddressList comment=AS32145 address=69.87.184.0/22} on-error {}
