...
:if ([:len [find where list=$AddressList and address=131.109.130.0/24]] = 0) do={ add list=$AddressList comment=AS32145 address=131.109.130.0/24 }
:if ([:len [find where list=$AddressList and address=131.109.134.0/24]] = 0) do={ add list=$AddressList comment=AS32145 address=131.109.134.0/24 }
