...
:do {add list=$AddressList comment=AS32222 address=64.28.112.0/23} on-error {}
:do {add list=$AddressList comment=AS32222 address=64.28.114.0/24} on-error {}
:do {add list=$AddressList comment=AS32222 address=64.28.117.0/24} on-error {}
:do {add list=$AddressList comment=AS32222 address=64.28.119.0/24} on-error {}
:do {add list=$AddressList comment=AS32222 address=64.28.121.0/24} on-error {}
:do {add list=$AddressList comment=AS32222 address=64.28.124.0/23} on-error {}
