...
:if ([:len [find where list=$AddressList and address=64.28.112.0/23]] = 0) do={ add list=$AddressList comment=AS32222 address=64.28.112.0/23 }
...
:if ([:len [find where list=$AddressList and address=64.28.119.0/24]] = 0) do={ add list=$AddressList comment=AS32222 address=64.28.119.0/24 }
