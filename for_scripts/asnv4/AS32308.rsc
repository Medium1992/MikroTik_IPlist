...
:do {add list=$AddressList comment=AS32308 address=216.59.137.0/24} on-error {}
:do {add list=$AddressList comment=AS32308 address=216.59.138.0/23} on-error {}
:do {add list=$AddressList comment=AS32308 address=216.59.140.0/22} on-error {}
