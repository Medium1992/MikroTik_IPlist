...
:do {add list=$AddressList comment=AS32323 address=for_scripts/asnv4/AS32323.rsc} on-error {}
...
:do {add list=$AddressList comment=AS32323 address=199.246.53.0/24} on-error {}
