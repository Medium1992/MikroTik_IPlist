...
:do {add list=$AddressList comment=AS32326 address=for_scripts/asnv4/AS32326.rsc} on-error {}
...
:do {add list=$AddressList comment=AS32326 address=74.120.212.0/22} on-error {}
