...
:do {add list=$AddressList comment=AS32472 address=for_scripts/asnv4/AS32472.rsc} on-error {}
...
:do {add list=$AddressList comment=AS32472 address=198.185.24.0/24} on-error {}
