...
:if ([:len [find where list=$AddressList and address=63.110.168.0/24]] = 0) do={ add list=$AddressList comment=AS32541 address=63.110.168.0/24 }
...
:if ([:len [find where list=$AddressList and address=8.29.18.0/24]] = 0) do={ add list=$AddressList comment=AS32541 address=8.29.18.0/24 }
