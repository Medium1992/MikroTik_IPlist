...
:do {add list=$AddressList comment=AS32625 address=for_scripts/asnv4/AS32625.rsc} on-error {}
...
:do {add list=$AddressList comment=AS32625 address=68.251.204.0/24} on-error {}
