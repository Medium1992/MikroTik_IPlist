...
:do {add list=$AddressList comment=AS3265 address=for_scripts/asnv4/AS3265.rsc} on-error {}
...
:do {add list=$AddressList comment=AS3265 address=95.129.124.0/23} on-error {}
