...
:do {add list=$AddressList comment=AS32710 address=164.153.168.0/24} on-error {}
:do {add list=$AddressList comment=AS32710 address=164.153.172.0/24} on-error {}
:do {add list=$AddressList comment=AS32710 address=164.153.175.0/24} on-error {}
