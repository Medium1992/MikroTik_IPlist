...
:do {add list=$AddressList comment=AS32723 address=216.6.128.0/21} on-error {}
:do {add list=$AddressList comment=AS32723 address=216.6.142.0/23} on-error {}
:do {add list=$AddressList comment=AS32723 address=216.6.148.0/22} on-error {}
...
:do {add list=$AddressList comment=AS32723 address=216.6.168.0/21} on-error {}
