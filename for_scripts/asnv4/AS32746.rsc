...
:if ([:len [find where list=$AddressList and address=208.86.41.0/24]] = 0) do={ add list=$AddressList comment=AS32746 address=208.86.41.0/24 }
:if ([:len [find where list=$AddressList and address=209.209.3.0/24]] = 0) do={ add list=$AddressList comment=AS32746 address=209.209.3.0/24 }
:if ([:len [find where list=$AddressList and address=64.247.42.0/24]] = 0) do={ add list=$AddressList comment=AS32746 address=64.247.42.0/24 }
:if ([:len [find where list=$AddressList and address=8.18.51.0/24]] = 0) do={ add list=$AddressList comment=AS32746 address=8.18.51.0/24 }
:if ([:len [find where list=$AddressList and address=8.21.234.0/24]] = 0) do={ add list=$AddressList comment=AS32746 address=8.21.234.0/24 }
