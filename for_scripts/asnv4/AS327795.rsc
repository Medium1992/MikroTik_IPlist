...
:do {add list=$AddressList comment=AS327795 address=102.202.136.0/22} on-error {}
...
:do {add list=$AddressList comment=AS327795 address=41.59.252.0/23} on-error {}
:do {add list=$AddressList comment=AS327795 address=41.59.254.0/24} on-error {}
