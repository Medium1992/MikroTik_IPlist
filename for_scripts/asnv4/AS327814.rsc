...
:if ([:len [find where list=$AddressList and address=102.134.28.0/22]] = 0) do={ add list=$AddressList comment=AS327814 address=102.134.28.0/22 }
:if ([:len [find where list=$AddressList and address=102.212.76.0/22]] = 0) do={ add list=$AddressList comment=AS327814 address=102.212.76.0/22 }
