...
:do {add list=$AddressList comment=AS327820 address=102.132.24.0/23} on-error {}
:do {add list=$AddressList comment=AS327820 address=102.132.27.0/24} on-error {}
:do {add list=$AddressList comment=AS327820 address=102.132.28.0/22} on-error {}
