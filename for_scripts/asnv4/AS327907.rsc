...
:do {add list=$AddressList comment=AS327907 address=for_scripts/asnv4/AS327907.rsc} on-error {}
...
:do {add list=$AddressList comment=AS327907 address=102.135.144.0/22} on-error {}
:do {add list=$AddressList comment=AS327907 address=102.135.148.0/23} on-error {}
:do {add list=$AddressList comment=AS327907 address=102.135.150.0/24} on-error {}
:do {add list=$AddressList comment=AS327907 address=102.135.152.0/21} on-error {}
:do {add list=$AddressList comment=AS327907 address=102.214.216.0/24} on-error {}
