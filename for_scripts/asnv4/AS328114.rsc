...
:if ([:len [find where list=$AddressList and address=102.203.48.0/23]] = 0) do={ add list=$AddressList comment=AS328114 address=102.203.48.0/23 }
:if ([:len [find where list=$AddressList and address=102.203.51.0/24]] = 0) do={ add list=$AddressList comment=AS328114 address=102.203.51.0/24 }
