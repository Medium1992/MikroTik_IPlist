...
:do {add list=$AddressList comment=AS328137 address=for_scripts/asnv4/AS328137.rsc} on-error {}
:do {add list=$AddressList comment=AS328137 address=102.204.239.0/24} on-error {}
