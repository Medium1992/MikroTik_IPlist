...
:do {add list=$AddressList comment=AS328148 address=for_scripts/asnv4/AS328148.rsc} on-error {}
...
:do {add list=$AddressList comment=AS328148 address=160.0.140.0/23} on-error {}
:do {add list=$AddressList comment=AS328148 address=160.0.143.0/24} on-error {}
