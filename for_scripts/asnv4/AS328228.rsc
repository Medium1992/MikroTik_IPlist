...
:do {add list=$AddressList comment=AS328228 address=137.255.112.0/21} on-error {}
...
:do {add list=$AddressList comment=AS328228 address=137.255.192.0/19} on-error {}
...
:do {add list=$AddressList comment=AS328228 address=137.255.96.0/20} on-error {}
