...
:do {add list=$AddressList comment=AS328317 address=for_scripts/asnv4/AS328317.rsc} on-error {}
...
:do {add list=$AddressList comment=AS328317 address=102.22.199.0/24} on-error {}
