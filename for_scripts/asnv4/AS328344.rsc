...
:do {add list=$AddressList comment=AS328344 address=for_scripts/asnv4/AS328344.rsc} on-error {}
:do {add list=$AddressList comment=AS328344 address=102.135.176.0/22} on-error {}
