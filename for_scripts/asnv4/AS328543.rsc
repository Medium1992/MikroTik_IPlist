...
:do {add list=$AddressList comment=AS328543 address=for_scripts/asnv4/AS328543.rsc} on-error {}
:do {add list=$AddressList comment=AS328543 address=102.141.200.0/22} on-error {}
:do {add list=$AddressList comment=AS328543 address=102.220.89.0/24} on-error {}
:do {add list=$AddressList comment=AS328543 address=102.220.90.0/24} on-error {}
...
:do {add list=$AddressList comment=AS328543 address=45.151.182.0/24} on-error {}
