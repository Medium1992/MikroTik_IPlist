...
:if ([:len [find where list=$AddressList and address=102.202.56.0/23]] = 0) do={ add list=$AddressList comment=AS328611 address=102.202.56.0/23 }
:if ([:len [find where list=$AddressList and address=102.202.58.0/24]] = 0) do={ add list=$AddressList comment=AS328611 address=102.202.58.0/24 }
