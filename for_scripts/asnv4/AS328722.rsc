...
:if ([:len [find where list=$AddressList and address=102.221.236.0/22]] = 0) do={ add list=$AddressList comment=AS328722 address=102.221.236.0/22 }
:if ([:len [find where list=$AddressList and address=156.226.2.0/24]] = 0) do={ add list=$AddressList comment=AS328722 address=156.226.2.0/24 }
