...
:do {add list=$AddressList comment=AS328724 address=for_scripts/asnv4/AS328724.rsc} on-error {}
...
:do {add list=$AddressList comment=AS328724 address=41.191.118.0/24} on-error {}
