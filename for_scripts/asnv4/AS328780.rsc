...
:if ([:len [find where list=$AddressList and address=102.220.212.0/24]] = 0) do={ add list=$AddressList comment=AS328780 address=102.220.212.0/24 }
:if ([:len [find where list=$AddressList and address=102.220.214.0/23]] = 0) do={ add list=$AddressList comment=AS328780 address=102.220.214.0/23 }
