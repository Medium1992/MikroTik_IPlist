...
:if ([:len [find where list=$AddressList and address=149.18.99.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=149.18.99.0/24 }
...
:if ([:len [find where list=$AddressList and address=204.167.189.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=204.167.189.0/24 }
:if ([:len [find where list=$AddressList and address=205.227.174.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=205.227.174.0/24 }
:if ([:len [find where list=$AddressList and address=207.120.120.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=207.120.120.0/24 }
:if ([:len [find where list=$AddressList and address=208.50.200.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=208.50.200.0/24 }
:if ([:len [find where list=$AddressList and address=216.22.79.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=216.22.79.0/24 }
