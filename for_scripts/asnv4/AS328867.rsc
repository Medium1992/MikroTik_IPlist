...
:if ([:len [find where list=$AddressList and address=205.243.61.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=205.243.61.0/24 }
:if ([:len [find where list=$AddressList and address=206.159.100.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=206.159.100.0/24 }
...
:if ([:len [find where list=$AddressList and address=63.172.226.0/24]] = 0) do={ add list=$AddressList comment=AS328867 address=63.172.226.0/24 }
