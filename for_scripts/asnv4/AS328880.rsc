...
:if ([:len [find where list=$AddressList and address=197.10.234.0/23]] = 0) do={ add list=$AddressList comment=AS328880 address=197.10.234.0/23 }
:if ([:len [find where list=$AddressList and address=197.10.64.0/20]] = 0) do={ add list=$AddressList comment=AS328880 address=197.10.64.0/20 }
:if ([:len [find where list=$AddressList and address=197.10.82.0/23]] = 0) do={ add list=$AddressList comment=AS328880 address=197.10.82.0/23 }
:if ([:len [find where list=$AddressList and address=197.10.88.0/21]] = 0) do={ add list=$AddressList comment=AS328880 address=197.10.88.0/21 }
:if ([:len [find where list=$AddressList and address=197.10.96.0/19]] = 0) do={ add list=$AddressList comment=AS328880 address=197.10.96.0/19 }
