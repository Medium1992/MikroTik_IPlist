...
:do {add list=$AddressList comment=AS328977 address=for_scripts/asnv4/AS328977.rsc} on-error {}
...
:do {add list=$AddressList comment=AS328977 address=102.206.168.0/22} on-error {}
