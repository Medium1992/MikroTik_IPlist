...
:do {add list=$AddressList comment=AS33058 address=for_scripts/asnv4/AS33058.rsc} on-error {}
:do {add list=$AddressList comment=AS33058 address=131.226.28.0/23} on-error {}
