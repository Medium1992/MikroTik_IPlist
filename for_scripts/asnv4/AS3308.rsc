...
:do {add list=$AddressList comment=AS3308 address=for_scripts/asnv4/AS3308.rsc} on-error {}
...
:do {add list=$AddressList comment=AS3308 address=91.236.186.0/24} on-error {}
