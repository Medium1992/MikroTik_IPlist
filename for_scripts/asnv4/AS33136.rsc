...
:do {add list=$AddressList comment=AS33136 address=138.129.10.0/23} on-error {}
...
:do {add list=$AddressList comment=AS33136 address=138.129.6.0/24} on-error {}
...
:do {add list=$AddressList comment=AS33136 address=69.9.29.0/24} on-error {}
:do {add list=$AddressList comment=AS33136 address=69.9.30.0/23} on-error {}
