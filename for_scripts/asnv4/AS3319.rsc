...
:do {add list=$AddressList comment=AS3319 address=for_scripts/asnv4/AS3319.rsc} on-error {}
...
:do {add list=$AddressList comment=AS3319 address=195.178.149.0/24} on-error {}
