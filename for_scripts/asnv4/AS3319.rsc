...
:do {add list=$AddressList comment=AS3319 address=77.47.152.0/22} on-error {}
:do {add list=$AddressList comment=AS3319 address=77.47.178.0/24} on-error {}
...
:do {add list=$AddressList comment=AS3319 address=77.47.248.0/21} on-error {}
