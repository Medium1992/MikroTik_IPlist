...
:do {add list=$AddressList comment=AS33236 address=104.244.6.212/32} on-error {}
:do {add list=$AddressList comment=AS33236 address=104.244.6.214/31} on-error {}
...
:do {add list=$AddressList comment=AS33236 address=209.196.80.0/20} on-error {}
:do {add list=$AddressList comment=AS33236 address=216.110.201.0/24} on-error {}
:do {add list=$AddressList comment=AS33236 address=38.87.107.0/24} on-error {}
