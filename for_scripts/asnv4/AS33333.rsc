...
:do {add list=$AddressList comment=AS33333 address=for_scripts/asnv4/AS33333.rsc} on-error {}
...
:do {add list=$AddressList comment=AS33333 address=67.220.89.0/24} on-error {}
:do {add list=$AddressList comment=AS33333 address=68.168.20.0/23} on-error {}
