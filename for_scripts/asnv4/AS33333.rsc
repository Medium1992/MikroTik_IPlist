...
:if ([:len [find where list=$AddressList and address=69.42.208.0/24]] = 0) do={ add list=$AddressList comment=AS33333 address=69.42.208.0/24 }
:if ([:len [find where list=$AddressList and address=69.42.211.0/24]] = 0) do={ add list=$AddressList comment=AS33333 address=69.42.211.0/24 }
