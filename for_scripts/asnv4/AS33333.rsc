...
:if ([:len [find where list=$AddressList and address=67.220.68.0/23]] = 0) do={ add list=$AddressList comment=AS33333 address=67.220.68.0/23 }
...
:if ([:len [find where list=$AddressList and address=67.220.86.0/24]] = 0) do={ add list=$AddressList comment=AS33333 address=67.220.86.0/24 }
...
:if ([:len [find where list=$AddressList and address=69.42.208.0/23]] = 0) do={ add list=$AddressList comment=AS33333 address=69.42.208.0/23 }
:if ([:len [find where list=$AddressList and address=69.42.210.0/24]] = 0) do={ add list=$AddressList comment=AS33333 address=69.42.210.0/24 }
