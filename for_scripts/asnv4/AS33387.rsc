...
:if ([:len [find where list=$AddressList and address=185.240.84.0/24]] = 0) do={ add list=$AddressList comment=AS33387 address=185.240.84.0/24 }
...
:if ([:len [find where list=$AddressList and address=45.141.131.0/24]] = 0) do={ add list=$AddressList comment=AS33387 address=45.141.131.0/24 }
