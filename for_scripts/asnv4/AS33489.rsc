...
:do {add list=$AddressList comment=AS33489 address=for_scripts/asnv4/AS33489.rsc} on-error {}
...
:do {add list=$AddressList comment=AS33489 address=50.206.228.0/24} on-error {}
