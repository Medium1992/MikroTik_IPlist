...
:do {add list=$AddressList comment=AS33545 address=192.246.224.0/22} on-error {}
:do {add list=$AddressList comment=AS33545 address=192.246.228.0/23} on-error {}
:do {add list=$AddressList comment=AS33545 address=192.246.231.0/24} on-error {}
