...
:if ([:len [find where list=$AddressList and address=129.232.32.0/20]] = 0) do={ add list=$AddressList comment=AS33567 address=129.232.32.0/20 }
:if ([:len [find where list=$AddressList and address=129.232.64.0/18]] = 0) do={ add list=$AddressList comment=AS33567 address=129.232.64.0/18 }
...
:if ([:len [find where list=$AddressList and address=41.203.178.0/24]] = 0) do={ add list=$AddressList comment=AS33567 address=41.203.178.0/24 }
