...
:if ([:len [find where list=$AddressList and address=129.232.16.0/20]] = 0) do={ add list=$AddressList comment=AS33567 address=129.232.16.0/20 }
:if ([:len [find where list=$AddressList and address=129.232.32.0/19]] = 0) do={ add list=$AddressList comment=AS33567 address=129.232.32.0/19 }
