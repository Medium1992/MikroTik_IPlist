...
:do {add list=$AddressList comment=AS33660 address=for_scripts/asnv4/AS33660.rsc} on-error {}
...
:do {add list=$AddressList comment=AS33660 address=50.227.51.0/24} on-error {}
