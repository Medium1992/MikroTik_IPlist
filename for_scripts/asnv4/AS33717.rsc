...
:do {add list=$AddressList comment=AS33717 address=for_scripts/asnv4/AS33717.rsc} on-error {}
...
:do {add list=$AddressList comment=AS33717 address=66.150.3.0/24} on-error {}
