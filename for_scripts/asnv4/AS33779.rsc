...
:do {add list=$AddressList comment=AS33779 address=for_scripts/asnv4/AS33779.rsc} on-error {}
...
:do {add list=$AddressList comment=AS33779 address=41.221.24.0/21} on-error {}
