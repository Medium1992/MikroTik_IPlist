...
:if ([:len [find where list=$AddressList and address=5.253.8.0/22]] = 0) do={ add list=$AddressList comment=AS34191 address=5.253.8.0/22 }
:if ([:len [find where list=$AddressList and address=5.253.92.0/22]] = 0) do={ add list=$AddressList comment=AS34191 address=5.253.92.0/22 }
