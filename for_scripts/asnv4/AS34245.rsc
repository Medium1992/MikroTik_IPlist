...
:do {add list=$AddressList comment=AS34245 address=for_scripts/asnv4/AS34245.rsc} on-error {}
...
:do {add list=$AddressList comment=AS34245 address=87.232.64.0/18} on-error {}
