...
:if ([:len [find where list=$AddressList and address=37.228.84.0/23]] = 0) do={ add list=$AddressList comment=AS34352 address=37.228.84.0/23 }
:if ([:len [find where list=$AddressList and address=37.228.86.0/24]] = 0) do={ add list=$AddressList comment=AS34352 address=37.228.86.0/24 }
