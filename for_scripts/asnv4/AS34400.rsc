...
:do {add list=$AddressList comment=AS34400 address=for_scripts/asnv4/AS34400.rsc} on-error {}
...
:do {add list=$AddressList comment=AS34400 address=37.242.30.0/23} on-error {}
