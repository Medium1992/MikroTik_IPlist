...
:if ([:len [find where list=$AddressList and address=113.203.209.0/24]] = 0) do={ add list=$AddressList comment=AS34450 address=113.203.209.0/24 }
:if ([:len [find where list=$AddressList and address=113.203.219.0/24]] = 0) do={ add list=$AddressList comment=AS34450 address=113.203.219.0/24 }
...
:if ([:len [find where list=$AddressList and address=188.215.73.0/24]] = 0) do={ add list=$AddressList comment=AS34450 address=188.215.73.0/24 }
