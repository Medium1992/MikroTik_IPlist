...
:do {add list=$AddressList comment=AS34476 address=153.56.155.0/24} on-error {}
...
:do {add list=$AddressList comment=AS34476 address=45.139.200.0/23} on-error {}
:do {add list=$AddressList comment=AS34476 address=45.139.203.0/24} on-error {}
