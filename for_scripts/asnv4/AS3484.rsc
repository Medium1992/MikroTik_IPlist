...
:do {add list=$AddressList comment=AS3484 address=148.204.129.0/24} on-error {}
:do {add list=$AddressList comment=AS3484 address=148.204.130.0/23} on-error {}
:do {add list=$AddressList comment=AS3484 address=148.204.132.0/22} on-error {}
:do {add list=$AddressList comment=AS3484 address=148.204.136.0/21} on-error {}
:do {add list=$AddressList comment=AS3484 address=148.204.144.0/20} on-error {}
