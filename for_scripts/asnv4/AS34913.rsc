...
:if ([:len [find where list=$AddressList and address=80.89.112.0/23]] = 0) do={ add list=$AddressList comment=AS34913 address=80.89.112.0/23 }
:if ([:len [find where list=$AddressList and address=80.89.115.0/24]] = 0) do={ add list=$AddressList comment=AS34913 address=80.89.115.0/24 }
:if ([:len [find where list=$AddressList and address=80.89.116.0/22]] = 0) do={ add list=$AddressList comment=AS34913 address=80.89.116.0/22 }
:if ([:len [find where list=$AddressList and address=80.89.120.0/21]] = 0) do={ add list=$AddressList comment=AS34913 address=80.89.120.0/21 }
