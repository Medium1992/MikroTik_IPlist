...
:do {add list=$AddressList comment=AS34918 address=78.108.123.0/24} on-error {}
...
:do {add list=$AddressList comment=AS34918 address=85.9.112.0/23} on-error {}
:do {add list=$AddressList comment=AS34918 address=85.9.115.0/24} on-error {}
