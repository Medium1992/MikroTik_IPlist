...
:do {add list=$AddressList comment=AS34960 address=for_scripts/asnv4/AS34960.rsc} on-error {}
:do {add list=$AddressList comment=AS34960 address=185.120.92.0/23} on-error {}
:do {add list=$AddressList comment=AS34960 address=185.122.48.0/22} on-error {}
