...
:do {add list=$AddressList comment=AS34985 address=for_scripts/asnv4/AS34985.rsc} on-error {}
...
:do {add list=$AddressList comment=AS34985 address=185.254.240.0/23} on-error {}
...
:do {add list=$AddressList comment=AS34985 address=213.139.234.0/24} on-error {}
