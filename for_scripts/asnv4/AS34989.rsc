...
:do {add list=$AddressList comment=AS34989 address=for_scripts/asnv4/AS34989.rsc} on-error {}
...
:do {add list=$AddressList comment=AS34989 address=80.71.230.0/24} on-error {}
