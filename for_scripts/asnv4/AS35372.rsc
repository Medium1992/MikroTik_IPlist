...
:do {add list=$AddressList comment=AS35372 address=for_scripts/asnv4/AS35372.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35372 address=37.152.174.0/24} on-error {}
