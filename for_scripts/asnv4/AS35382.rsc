...
:do {add list=$AddressList comment=AS35382 address=for_scripts/asnv4/AS35382.rsc} on-error {}
:do {add list=$AddressList comment=AS35382 address=185.58.32.0/22} on-error {}
:do {add list=$AddressList comment=AS35382 address=5.23.56.0/21} on-error {}
