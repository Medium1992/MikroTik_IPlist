...
:do {add list=$AddressList comment=AS35435 address=for_scripts/asnv4/AS35435.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35435 address=194.187.84.0/22} on-error {}
