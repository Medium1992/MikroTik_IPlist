...
:do {add list=$AddressList comment=AS35478 address=for_scripts/asnv4/AS35478.rsc} on-error {}
:do {add list=$AddressList comment=AS35478 address=103.171.136.0/23} on-error {}
...
:do {add list=$AddressList comment=AS35478 address=195.252.180.0/22} on-error {}
:do {add list=$AddressList comment=AS35478 address=195.252.184.0/22} on-error {}
