...
:do {add list=$AddressList comment=AS35485 address=for_scripts/asnv4/AS35485.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35485 address=93.174.68.0/24} on-error {}
