...
:do {add list=$AddressList comment=AS35487 address=177.177.0.0/23} on-error {}
:do {add list=$AddressList comment=AS35487 address=194.156.154.0/24} on-error {}
:do {add list=$AddressList comment=AS35487 address=201.50.0.0/23} on-error {}
:do {add list=$AddressList comment=AS35487 address=201.78.142.0/24} on-error {}
:do {add list=$AddressList comment=AS35487 address=201.78.144.0/21} on-error {}
:do {add list=$AddressList comment=AS35487 address=201.78.152.0/22} on-error {}
