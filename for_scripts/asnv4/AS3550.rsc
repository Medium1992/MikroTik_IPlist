...
:do {add list=$AddressList comment=AS3550 address=for_scripts/asnv4/AS3550.rsc} on-error {}
:do {add list=$AddressList comment=AS3550 address=165.220.0.0/21} on-error {}
:do {add list=$AddressList comment=AS3550 address=165.220.16.0/20} on-error {}
