...
:do {add list=$AddressList comment=AS35549 address=for_scripts/asnv4/AS35549.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35549 address=78.134.128.0/17} on-error {}
