...
:do {add list=$AddressList comment=AS35567 address=for_scripts/asnv4/AS35567.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35567 address=91.191.0.0/18} on-error {}
