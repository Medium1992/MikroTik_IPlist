...
:do {add list=$AddressList comment=AS35758 address=147.78.2.0/24} on-error {}
...
:do {add list=$AddressList comment=AS35758 address=185.126.238.0/24} on-error {}
...
:do {add list=$AddressList comment=AS35758 address=213.169.200.0/23} on-error {}
:do {add list=$AddressList comment=AS35758 address=216.158.198.0/24} on-error {}
:do {add list=$AddressList comment=AS35758 address=217.11.162.0/24} on-error {}
...
:do {add list=$AddressList comment=AS35758 address=62.192.108.0/23} on-error {}
