...
:do {add list=$AddressList comment=AS35852 address=for_scripts/asnv4/AS35852.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35852 address=204.9.84.0/22} on-error {}
