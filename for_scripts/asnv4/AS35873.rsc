...
:do {add list=$AddressList comment=AS35873 address=67.21.48.0/23} on-error {}
:do {add list=$AddressList comment=AS35873 address=67.21.52.0/23} on-error {}
:do {add list=$AddressList comment=AS35873 address=67.21.55.0/24} on-error {}
:do {add list=$AddressList comment=AS35873 address=67.21.59.0/24} on-error {}
