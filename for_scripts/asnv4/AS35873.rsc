...
:do {add list=$AddressList comment=AS35873 address=67.21.56.0/23} on-error {}
:do {add list=$AddressList comment=AS35873 address=67.21.58.0/24} on-error {}
:do {add list=$AddressList comment=AS35873 address=67.21.60.0/22} on-error {}
