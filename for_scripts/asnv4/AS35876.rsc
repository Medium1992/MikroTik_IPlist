...
:do {add list=$AddressList comment=AS35876 address=for_scripts/asnv4/AS35876.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35876 address=116.204.134.0/24} on-error {}
