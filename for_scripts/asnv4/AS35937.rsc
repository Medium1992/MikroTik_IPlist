...
:do {add list=$AddressList comment=AS35937 address=for_scripts/asnv4/AS35937.rsc} on-error {}
...
:do {add list=$AddressList comment=AS35937 address=24.234.176.0/22} on-error {}
