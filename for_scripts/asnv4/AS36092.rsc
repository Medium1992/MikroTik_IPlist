...
:do {add list=$AddressList comment=AS36092 address=167.238.0.0/21} on-error {}
:do {add list=$AddressList comment=AS36092 address=167.238.120.0/21} on-error {}
:do {add list=$AddressList comment=AS36092 address=167.238.128.0/20} on-error {}
:do {add list=$AddressList comment=AS36092 address=167.238.16.0/21} on-error {}
:do {add list=$AddressList comment=AS36092 address=167.238.200.0/21} on-error {}
