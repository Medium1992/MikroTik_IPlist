...
:if ([:len [find where list=$AddressList and address=107.149.156.0/24]] = 0) do={ add list=$AddressList comment=AS36137 address=107.149.156.0/24 }
...
:if ([:len [find where list=$AddressList and address=38.177.212.0/22]] = 0) do={ add list=$AddressList comment=AS36137 address=38.177.212.0/22 }
