...
:if ([:len [find where list=$AddressList and address=128.64.112.0/24]] = 0) do={ add list=$AddressList comment=AS36210 address=128.64.112.0/24 }
:if ([:len [find where list=$AddressList and address=128.64.118.0/24]] = 0) do={ add list=$AddressList comment=AS36210 address=128.64.118.0/24 }
...
:if ([:len [find where list=$AddressList and address=128.64.144.0/24]] = 0) do={ add list=$AddressList comment=AS36210 address=128.64.144.0/24 }
...
:if ([:len [find where list=$AddressList and address=128.64.240.0/24]] = 0) do={ add list=$AddressList comment=AS36210 address=128.64.240.0/24 }
