...
:do {add list=$AddressList comment=AS36231 address=for_scripts/asnv4/AS36231.rsc} on-error {}
...
:do {add list=$AddressList comment=AS36231 address=149.18.97.0/24} on-error {}
:do {add list=$AddressList comment=AS36231 address=154.6.136.0/23} on-error {}
:do {add list=$AddressList comment=AS36231 address=154.6.138.0/24} on-error {}
...
:do {add list=$AddressList comment=AS36231 address=66.92.176.0/24} on-error {}
:do {add list=$AddressList comment=AS36231 address=85.155.226.0/24} on-error {}
