...
:do {add list=$AddressList comment=AS36454 address=170.39.76.0/24} on-error {}
:do {add list=$AddressList comment=AS36454 address=185.181.253.0/24} on-error {}
:do {add list=$AddressList comment=AS36454 address=185.181.254.0/23} on-error {}
:do {add list=$AddressList comment=AS36454 address=185.74.16.0/23} on-error {}
:do {add list=$AddressList comment=AS36454 address=185.74.18.0/24} on-error {}
:do {add list=$AddressList comment=AS36454 address=190.8.176.0/22} on-error {}
...
:do {add list=$AddressList comment=AS36454 address=194.39.123.0/24} on-error {}
:do {add list=$AddressList comment=AS36454 address=194.39.148.0/23} on-error {}
...
:do {add list=$AddressList comment=AS36454 address=65.181.127.0/24} on-error {}
:do {add list=$AddressList comment=AS36454 address=65.98.5.0/24} on-error {}
:do {add list=$AddressList comment=AS36454 address=69.57.189.0/24} on-error {}
:do {add list=$AddressList comment=AS36454 address=69.72.136.0/24} on-error {}
