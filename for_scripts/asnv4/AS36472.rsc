...
:do {add list=$AddressList comment=AS36472 address=for_scripts/asnv4/AS36472.rsc} on-error {}
...
:do {add list=$AddressList comment=AS36472 address=38.64.38.0/24} on-error {}
