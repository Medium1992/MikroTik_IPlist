...
:do {add list=$AddressList comment=AS36488 address=for_scripts/asnv4/AS36488.rsc} on-error {}
:do {add list=$AddressList comment=AS36488 address=12.191.17.0/24} on-error {}
:do {add list=$AddressList comment=AS36488 address=208.94.153.0/24} on-error {}
