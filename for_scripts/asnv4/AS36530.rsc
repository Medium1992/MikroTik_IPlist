...
:if ([:len [find where list=$AddressList and address=130.12.18.0/24]] = 0) do={ add list=$AddressList comment=AS36530 address=130.12.18.0/24 }
...
:if ([:len [find where list=$AddressList and address=151.243.179.0/24]] = 0) do={ add list=$AddressList comment=AS36530 address=151.243.179.0/24 }
