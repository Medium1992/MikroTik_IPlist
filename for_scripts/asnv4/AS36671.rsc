...
:do {add list=$AddressList comment=AS36671 address=for_scripts/asnv4/AS36671.rsc} on-error {}
:do {add list=$AddressList comment=AS36671 address=154.210.0.0/24} on-error {}
