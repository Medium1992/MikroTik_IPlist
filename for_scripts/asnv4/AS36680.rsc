...
:do {add list=$AddressList comment=AS36680 address=for_scripts/asnv4/AS36680.rsc} on-error {}
...
:do {add list=$AddressList comment=AS36680 address=156.246.70.0/24} on-error {}
