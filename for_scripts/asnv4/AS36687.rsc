...
:do {add list=$AddressList comment=AS36687 address=for_scripts/asnv4/AS36687.rsc} on-error {}
...
:do {add list=$AddressList comment=AS36687 address=67.23.192.0/20} on-error {}
