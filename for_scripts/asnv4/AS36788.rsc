...
:do {add list=$AddressList comment=AS36788 address=for_scripts/asnv4/AS36788.rsc} on-error {}
...
:do {add list=$AddressList comment=AS36788 address=216.163.110.0/24} on-error {}
