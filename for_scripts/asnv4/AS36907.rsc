...
:do {add list=$AddressList comment=AS36907 address=154.127.128.0/18} on-error {}
:do {add list=$AddressList comment=AS36907 address=154.127.192.0/19} on-error {}
:do {add list=$AddressList comment=AS36907 address=154.127.224.0/20} on-error {}
:do {add list=$AddressList comment=AS36907 address=154.127.248.0/21} on-error {}
