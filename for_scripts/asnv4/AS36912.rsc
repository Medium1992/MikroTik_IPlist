...
:do {add list=$AddressList comment=AS36912 address=102.244.192.0/19} on-error {}
:do {add list=$AddressList comment=AS36912 address=102.245.0.0/21} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.192.0/23} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.195.0/24} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.196.0/23} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.198.0/24} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.200.0/22} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.206.0/23} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.210.0/23} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.214.0/23} on-error {}
:do {add list=$AddressList comment=AS36912 address=41.202.216.0/21} on-error {}
