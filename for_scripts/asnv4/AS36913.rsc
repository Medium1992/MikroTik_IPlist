...
:if ([:len [find where list=$AddressList and address=168.253.245.0/24]] = 0) do={ add list=$AddressList comment=AS36913 address=168.253.245.0/24 }
:if ([:len [find where list=$AddressList and address=168.253.248.0/24]] = 0) do={ add list=$AddressList comment=AS36913 address=168.253.248.0/24 }
:if ([:len [find where list=$AddressList and address=168.253.255.0/24]] = 0) do={ add list=$AddressList comment=AS36913 address=168.253.255.0/24 }
