...
:do {add list=$AddressList comment=AS36913 address=for_scripts/asnv4/AS36913.rsc} on-error {}
...
:do {add list=$AddressList comment=AS36913 address=168.253.255.0/24} on-error {}
