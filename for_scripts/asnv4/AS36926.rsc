...
:if ([:len [find where list=$AddressList and address=102.0.32.0/21]] = 0) do={ add list=$AddressList comment=AS36926 address=102.0.32.0/21 }
:if ([:len [find where list=$AddressList and address=102.0.40.0/24]] = 0) do={ add list=$AddressList comment=AS36926 address=102.0.40.0/24 }
