...
:if ([:len [find where list=$AddressList and address=154.74.164.0/24]] = 0) do={ add list=$AddressList comment=AS36930 address=154.74.164.0/24 }
...
:if ([:len [find where list=$AddressList and address=41.73.204.0/23]] = 0) do={ add list=$AddressList comment=AS36930 address=41.73.204.0/23 }
