...
:if ([:len [find where list=$AddressList and address=41.104.0.0/15]] = 0) do={ add list=$AddressList comment=AS36947 address=41.104.0.0/15 }
:if ([:len [find where list=$AddressList and address=41.106.0.0/17]] = 0) do={ add list=$AddressList comment=AS36947 address=41.106.0.0/17 }
:if ([:len [find where list=$AddressList and address=41.106.128.0/19]] = 0) do={ add list=$AddressList comment=AS36947 address=41.106.128.0/19 }
:if ([:len [find where list=$AddressList and address=41.106.224.0/19]] = 0) do={ add list=$AddressList comment=AS36947 address=41.106.224.0/19 }
:if ([:len [find where list=$AddressList and address=41.107.0.0/16]] = 0) do={ add list=$AddressList comment=AS36947 address=41.107.0.0/16 }
:if ([:len [find where list=$AddressList and address=41.108.0.0/14]] = 0) do={ add list=$AddressList comment=AS36947 address=41.108.0.0/14 }
...
:if ([:len [find where list=$AddressList and address=41.96.0.0/13]] = 0) do={ add list=$AddressList comment=AS36947 address=41.96.0.0/13 }
