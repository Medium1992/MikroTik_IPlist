...
:if ([:len [find where list=$AddressList and address=154.100.32.0/20]] = 0) do={ add list=$AddressList comment=AS36998 address=154.100.32.0/20 }
:if ([:len [find where list=$AddressList and address=41.223.200.0/24]] = 0) do={ add list=$AddressList comment=AS36998 address=41.223.200.0/24 }
:if ([:len [find where list=$AddressList and address=41.223.202.0/23]] = 0) do={ add list=$AddressList comment=AS36998 address=41.223.202.0/23 }
:if ([:len [find where list=$AddressList and address=41.95.128.0/24]] = 0) do={ add list=$AddressList comment=AS36998 address=41.95.128.0/24 }
:if ([:len [find where list=$AddressList and address=41.95.130.0/23]] = 0) do={ add list=$AddressList comment=AS36998 address=41.95.130.0/23 }
:if ([:len [find where list=$AddressList and address=41.95.132.0/22]] = 0) do={ add list=$AddressList comment=AS36998 address=41.95.132.0/22 }
:if ([:len [find where list=$AddressList and address=41.95.136.0/21]] = 0) do={ add list=$AddressList comment=AS36998 address=41.95.136.0/21 }
...
:if ([:len [find where list=$AddressList and address=41.95.154.0/23]] = 0) do={ add list=$AddressList comment=AS36998 address=41.95.154.0/23 }
