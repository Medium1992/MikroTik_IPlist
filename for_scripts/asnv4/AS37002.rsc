...
:do {add list=$AddressList comment=AS37002 address=for_scripts/asnv4/AS37002.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37002 address=162.158.206.0/24} on-error {}
