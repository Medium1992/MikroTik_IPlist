...
:do {add list=$AddressList comment=AS37020 address=41.243.14.0/23} on-error {}
...
:do {add list=$AddressList comment=AS37020 address=41.243.48.0/22} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.52.0/23} on-error {}
:do {add list=$AddressList comment=AS37020 address=41.243.54.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37020 address=41.243.72.0/23} on-error {}
...
:do {add list=$AddressList comment=AS37020 address=41.243.8.0/22} on-error {}
