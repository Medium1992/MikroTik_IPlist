...
:do {add list=$AddressList comment=AS37035 address=154.74.0.0/17} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.74.128.0/19} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.74.160.0/22} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.74.165.0/24} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.74.166.0/23} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.74.168.0/21} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.74.176.0/20} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.74.192.0/18} on-error {}
:do {add list=$AddressList comment=AS37035 address=154.75.0.0/16} on-error {}
