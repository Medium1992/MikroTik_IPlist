...
:do {add list=$AddressList comment=AS37075 address=102.85.0.0/16} on-error {}
...
:do {add list=$AddressList comment=AS37075 address=154.229.0.0/16} on-error {}
:do {add list=$AddressList comment=AS37075 address=154.230.0.0/15} on-error {}
