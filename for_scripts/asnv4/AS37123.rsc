...
:do {add list=$AddressList comment=AS37123 address=154.119.80.0/23} on-error {}
:do {add list=$AddressList comment=AS37123 address=154.119.82.0/24} on-error {}
:do {add list=$AddressList comment=AS37123 address=154.119.84.0/22} on-error {}
