...
:if ([:len [find where list=$AddressList and address=197.186.32.0/23]] = 0) do={ add list=$AddressList comment=AS37133 address=197.186.32.0/23 }
:if ([:len [find where list=$AddressList and address=197.186.34.0/24]] = 0) do={ add list=$AddressList comment=AS37133 address=197.186.34.0/24 }
