...
:do {add list=$AddressList comment=AS37140 address=for_scripts/asnv4/AS37140.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37140 address=196.175.248.0/22} on-error {}
