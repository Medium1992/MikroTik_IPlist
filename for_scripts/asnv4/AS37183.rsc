...
:do {add list=$AddressList comment=AS37183 address=102.165.112.0/24} on-error {}
:do {add list=$AddressList comment=AS37183 address=196.2.64.0/24} on-error {}
:do {add list=$AddressList comment=AS37183 address=196.2.66.0/23} on-error {}
:do {add list=$AddressList comment=AS37183 address=196.2.68.0/23} on-error {}
...
:do {add list=$AddressList comment=AS37183 address=41.85.192.0/23} on-error {}
:do {add list=$AddressList comment=AS37183 address=41.85.194.0/24} on-error {}
:do {add list=$AddressList comment=AS37183 address=41.85.196.0/24} on-error {}
