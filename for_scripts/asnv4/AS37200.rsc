...
:do {add list=$AddressList comment=AS37200 address=for_scripts/asnv4/AS37200.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37200 address=41.78.100.0/23} on-error {}
