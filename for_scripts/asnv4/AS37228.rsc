...
:do {add list=$AddressList comment=AS37228 address=for_scripts/asnv4/AS37228.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37228 address=197.243.125.0/24} on-error {}
