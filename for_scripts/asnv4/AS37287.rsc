...
:do {add list=$AddressList comment=AS37287 address=41.77.0.0/24} on-error {}
:do {add list=$AddressList comment=AS37287 address=41.77.2.0/23} on-error {}
:do {add list=$AddressList comment=AS37287 address=41.77.4.0/23} on-error {}
:do {add list=$AddressList comment=AS37287 address=41.77.7.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37287 address=45.215.224.0/24} on-error {}
:do {add list=$AddressList comment=AS37287 address=45.215.226.0/23} on-error {}
:do {add list=$AddressList comment=AS37287 address=45.215.228.0/22} on-error {}
:do {add list=$AddressList comment=AS37287 address=45.215.232.0/21} on-error {}
:do {add list=$AddressList comment=AS37287 address=45.215.240.0/21} on-error {}
:do {add list=$AddressList comment=AS37287 address=45.215.249.0/24} on-error {}
