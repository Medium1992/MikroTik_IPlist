...
:do {add list=$AddressList comment=AS37287 address=41.77.0.0/23} on-error {}
:do {add list=$AddressList comment=AS37287 address=41.77.2.0/24} on-error {}
:do {add list=$AddressList comment=AS37287 address=41.77.4.0/22} on-error {}
...
:do {add list=$AddressList comment=AS37287 address=80.88.3.0/24} on-error {}
