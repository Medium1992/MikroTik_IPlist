...
:do {add list=$AddressList comment=AS37294 address=for_scripts/asnv4/AS37294.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37294 address=168.253.252.0/23} on-error {}
:do {add list=$AddressList comment=AS37294 address=168.253.254.0/24} on-error {}
