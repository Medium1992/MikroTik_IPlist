...
:do {add list=$AddressList comment=AS37294 address=168.253.241.0/24} on-error {}
:do {add list=$AddressList comment=AS37294 address=168.253.242.0/24} on-error {}
:do {add list=$AddressList comment=AS37294 address=168.253.246.0/24} on-error {}
