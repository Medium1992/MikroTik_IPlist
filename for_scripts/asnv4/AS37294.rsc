...
:if ([:len [find where list=$AddressList and address=168.253.240.0/22]] = 0) do={ add list=$AddressList comment=AS37294 address=168.253.240.0/22 }
:if ([:len [find where list=$AddressList and address=168.253.244.0/24]] = 0) do={ add list=$AddressList comment=AS37294 address=168.253.244.0/24 }
...
:if ([:len [find where list=$AddressList and address=168.253.249.0/24]] = 0) do={ add list=$AddressList comment=AS37294 address=168.253.249.0/24 }
:if ([:len [find where list=$AddressList and address=168.253.250.0/23]] = 0) do={ add list=$AddressList comment=AS37294 address=168.253.250.0/23 }
:if ([:len [find where list=$AddressList and address=168.253.252.0/23]] = 0) do={ add list=$AddressList comment=AS37294 address=168.253.252.0/23 }
:if ([:len [find where list=$AddressList and address=168.253.254.0/24]] = 0) do={ add list=$AddressList comment=AS37294 address=168.253.254.0/24 }
