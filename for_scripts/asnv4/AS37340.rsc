...
:do {add list=$AddressList comment=AS37340 address=154.120.64.0/20} on-error {}
:do {add list=$AddressList comment=AS37340 address=154.120.80.0/21} on-error {}
:do {add list=$AddressList comment=AS37340 address=154.120.88.0/22} on-error {}
:do {add list=$AddressList comment=AS37340 address=154.120.94.0/23} on-error {}
:do {add list=$AddressList comment=AS37340 address=154.120.96.0/19} on-error {}
