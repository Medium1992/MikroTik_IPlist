...
:do {add list=$AddressList comment=AS37340 address=154.118.116.0/22} on-error {}
:do {add list=$AddressList comment=AS37340 address=154.118.120.0/21} on-error {}
:do {add list=$AddressList comment=AS37340 address=154.118.64.0/19} on-error {}
:do {add list=$AddressList comment=AS37340 address=154.118.96.0/20} on-error {}
