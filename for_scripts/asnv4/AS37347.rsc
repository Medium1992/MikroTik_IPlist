...
:do {add list=$AddressList comment=AS37347 address=102.216.32.0/23} on-error {}
:do {add list=$AddressList comment=AS37347 address=102.216.34.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37347 address=168.253.112.0/24} on-error {}
:do {add list=$AddressList comment=AS37347 address=168.253.114.0/23} on-error {}
:do {add list=$AddressList comment=AS37347 address=168.253.116.0/22} on-error {}
