...
:do {add list=$AddressList comment=AS37347 address=for_scripts/asnv4/AS37347.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37347 address=102.22.216.0/21} on-error {}
:do {add list=$AddressList comment=AS37347 address=102.221.44.0/22} on-error {}
