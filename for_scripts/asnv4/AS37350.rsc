...
:do {add list=$AddressList comment=AS37350 address=for_scripts/asnv4/AS37350.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37350 address=196.200.127.0/24} on-error {}
:do {add list=$AddressList comment=AS37350 address=197.221.80.0/20} on-error {}
:do {add list=$AddressList comment=AS37350 address=41.73.158.0/23} on-error {}
