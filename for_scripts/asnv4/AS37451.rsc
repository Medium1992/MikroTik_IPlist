...
:do {add list=$AddressList comment=AS37451 address=102.129.72.0/22} on-error {}
:do {add list=$AddressList comment=AS37451 address=102.129.77.0/24} on-error {}
:do {add list=$AddressList comment=AS37451 address=102.129.78.0/23} on-error {}
...
:do {add list=$AddressList comment=AS37451 address=197.157.253.0/24} on-error {}
:do {add list=$AddressList comment=AS37451 address=197.157.254.0/23} on-error {}
