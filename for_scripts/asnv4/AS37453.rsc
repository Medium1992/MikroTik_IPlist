...
:do {add list=$AddressList comment=AS37453 address=102.209.212.0/24} on-error {}
:do {add list=$AddressList comment=AS37453 address=102.209.214.0/23} on-error {}
:do {add list=$AddressList comment=AS37453 address=169.159.208.0/22} on-error {}
:do {add list=$AddressList comment=AS37453 address=169.159.212.0/23} on-error {}
:do {add list=$AddressList comment=AS37453 address=169.159.214.0/24} on-error {}
...
:do {add list=$AddressList comment=AS37453 address=193.110.104.0/24} on-error {}
