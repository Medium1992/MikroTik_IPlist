...
:do {add list=$AddressList comment=AS37504 address=for_scripts/asnv4/AS37504.rsc} on-error {}
...
:do {add list=$AddressList comment=AS37504 address=197.12.28.0/22} on-error {}
:do {add list=$AddressList comment=AS37504 address=197.12.32.0/22} on-error {}
:do {add list=$AddressList comment=AS37504 address=197.12.40.0/21} on-error {}
