...
:do {add list=$AddressList comment=AS38022 address=for_scripts/asnv4/AS38022.rsc} on-error {}
...
:do {add list=$AddressList comment=AS38022 address=202.36.86.0/24} on-error {}
