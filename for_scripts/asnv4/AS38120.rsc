...
:do {add list=$AddressList comment=AS38120 address=1.11.33.0/24} on-error {}
:do {add list=$AddressList comment=AS38120 address=1.11.34.0/23} on-error {}
:do {add list=$AddressList comment=AS38120 address=1.11.36.0/22} on-error {}
:do {add list=$AddressList comment=AS38120 address=1.11.48.0/21} on-error {}
...
:do {add list=$AddressList comment=AS38120 address=119.149.118.0/24} on-error {}
...
:do {add list=$AddressList comment=AS38120 address=36.38.0.0/21} on-error {}
