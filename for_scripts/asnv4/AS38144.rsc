...
:do {add list=$AddressList comment=AS38144 address=for_scripts/asnv4/AS38144.rsc} on-error {}
...
:do {add list=$AddressList comment=AS38144 address=60.253.120.0/22} on-error {}
