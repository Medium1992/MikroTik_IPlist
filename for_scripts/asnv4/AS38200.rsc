...
:if ([:len [find where list=$AddressList and address=103.234.164.0/23]] = 0) do={ add list=$AddressList comment=AS38200 address=103.234.164.0/23 }
:if ([:len [find where list=$AddressList and address=103.234.166.0/24]] = 0) do={ add list=$AddressList comment=AS38200 address=103.234.166.0/24 }
