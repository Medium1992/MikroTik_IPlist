...
:if ([:len [find where list=$AddressList and address=202.134.24.0/22]] = 0) do={ add list=$AddressList comment=AS38201 address=202.134.24.0/22 }
:if ([:len [find where list=$AddressList and address=202.134.29.0/24]] = 0) do={ add list=$AddressList comment=AS38201 address=202.134.29.0/24 }
:if ([:len [find where list=$AddressList and address=202.134.30.0/23]] = 0) do={ add list=$AddressList comment=AS38201 address=202.134.30.0/23 }
