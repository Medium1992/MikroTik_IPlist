...
:do {add list=$AddressList comment=AS38247 address=103.129.188.0/22} on-error {}
...
:do {add list=$AddressList comment=AS38247 address=203.160.96.0/21} on-error {}
...
:do {add list=$AddressList comment=AS38247 address=59.153.212.0/22} on-error {}
