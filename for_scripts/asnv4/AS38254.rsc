...
:if ([:len [find where list=$AddressList and address=103.167.250.0/23]] = 0) do={ add list=$AddressList comment=AS38254 address=103.167.250.0/23 }
:if ([:len [find where list=$AddressList and address=44.31.69.0/24]] = 0) do={ add list=$AddressList comment=AS38254 address=44.31.69.0/24 }
