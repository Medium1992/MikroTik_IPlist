...
:do {add list=$AddressList comment=AS38325 address=123.108.120.0/21} on-error {}
:do {add list=$AddressList comment=AS38325 address=182.239.34.0/23} on-error {}
:do {add list=$AddressList comment=AS38325 address=182.239.36.0/22} on-error {}
