...
:do {add list=$AddressList comment=AS38500 address=103.244.36.0/22} on-error {}
...
:do {add list=$AddressList comment=AS38500 address=137.59.12.0/23} on-error {}
:do {add list=$AddressList comment=AS38500 address=137.59.15.0/24} on-error {}
