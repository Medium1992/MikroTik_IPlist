...
:do {add list=$AddressList comment=AS38511 address=202.182.48.0/24} on-error {}
:do {add list=$AddressList comment=AS38511 address=202.182.50.0/23} on-error {}
:do {add list=$AddressList comment=AS38511 address=202.182.52.0/22} on-error {}
