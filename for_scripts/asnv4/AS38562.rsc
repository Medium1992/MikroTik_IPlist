...
:if ([:len [find where list=$AddressList and address=122.152.48.0/23]] = 0) do={ add list=$AddressList comment=AS38562 address=122.152.48.0/23 }
:if ([:len [find where list=$AddressList and address=122.152.51.0/24]] = 0) do={ add list=$AddressList comment=AS38562 address=122.152.51.0/24 }
