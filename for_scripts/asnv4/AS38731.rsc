...
:do {add list=$AddressList comment=AS38731 address=for_scripts/asnv4/AS38731.rsc} on-error {}
...
:do {add list=$AddressList comment=AS38731 address=27.71.16.0/22} on-error {}
:do {add list=$AddressList comment=AS38731 address=27.71.20.0/23} on-error {}
