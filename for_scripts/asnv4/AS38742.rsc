...
:do {add list=$AddressList comment=AS38742 address=152.36.208.0/23} on-error {}
...
:do {add list=$AddressList comment=AS38742 address=61.5.195.0/24} on-error {}
:do {add list=$AddressList comment=AS38742 address=61.5.197.0/24} on-error {}
:do {add list=$AddressList comment=AS38742 address=61.5.198.0/24} on-error {}
:do {add list=$AddressList comment=AS38742 address=61.5.200.0/23} on-error {}
:do {add list=$AddressList comment=AS38742 address=61.5.202.0/24} on-error {}
:do {add list=$AddressList comment=AS38742 address=61.5.204.0/22} on-error {}
