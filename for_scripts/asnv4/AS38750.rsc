...
:if ([:len [find where list=$AddressList and address=121.50.36.0/24]] = 0) do={ add list=$AddressList comment=AS38750 address=121.50.36.0/24 }
:if ([:len [find where list=$AddressList and address=121.50.39.0/24]] = 0) do={ add list=$AddressList comment=AS38750 address=121.50.39.0/24 }
