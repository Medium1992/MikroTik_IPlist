...
:if ([:len [find where list=$AddressList and address=122.129.200.0/24]] = 0) do={ add list=$AddressList comment=AS38763 address=122.129.200.0/24 }
:if ([:len [find where list=$AddressList and address=122.129.202.0/23]] = 0) do={ add list=$AddressList comment=AS38763 address=122.129.202.0/23 }
