...
:do {add list=$AddressList comment=AS38826 address=119.15.100.0/22} on-error {}
...
:do {add list=$AddressList comment=AS38826 address=119.15.96.0/23} on-error {}
:do {add list=$AddressList comment=AS38826 address=119.15.99.0/24} on-error {}
