...
:do {add list=$AddressList comment=AS39032 address=for_scripts/asnv4/AS39032.rsc} on-error {}
...
:do {add list=$AddressList comment=AS39032 address=94.141.76.0/24} on-error {}
