...
:do {add list=$AddressList comment=AS39045 address=for_scripts/asnv4/AS39045.rsc} on-error {}
...
:do {add list=$AddressList comment=AS39045 address=5.226.156.0/24} on-error {}
:do {add list=$AddressList comment=AS39045 address=5.226.158.0/23} on-error {}
