...
:do {add list=$AddressList comment=AS39151 address=for_scripts/asnv4/AS39151.rsc} on-error {}
:do {add list=$AddressList comment=AS39151 address=102.211.149.0/24} on-error {}
