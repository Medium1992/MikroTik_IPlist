...
:do {add list=$AddressList comment=AS3918 address=for_scripts/asnv4/AS3918.rsc} on-error {}
...
:do {add list=$AddressList comment=AS3918 address=156.149.137.0/24} on-error {}
:do {add list=$AddressList comment=AS3918 address=156.149.138.0/23} on-error {}
