...
:do {add list=$AddressList comment=AS39180 address=185.153.244.0/22} on-error {}
...
:do {add list=$AddressList comment=AS39180 address=195.13.34.0/24} on-error {}
:do {add list=$AddressList comment=AS39180 address=37.148.240.0/21} on-error {}
:do {add list=$AddressList comment=AS39180 address=81.18.176.0/20} on-error {}
:do {add list=$AddressList comment=AS39180 address=93.191.40.0/21} on-error {}
