...
:if ([:len [find where list=$AddressList and address=77.78.136.0/22]] = 0) do={ add list=$AddressList comment=AS39246 address=77.78.136.0/22 }
:if ([:len [find where list=$AddressList and address=77.78.140.0/23]] = 0) do={ add list=$AddressList comment=AS39246 address=77.78.140.0/23 }
:if ([:len [find where list=$AddressList and address=77.78.143.0/24]] = 0) do={ add list=$AddressList comment=AS39246 address=77.78.143.0/24 }
