...
:do {add list=$AddressList comment=AS39312 address=for_scripts/asnv4/AS39312.rsc} on-error {}
...
:do {add list=$AddressList comment=AS39312 address=80.96.82.0/24} on-error {}
