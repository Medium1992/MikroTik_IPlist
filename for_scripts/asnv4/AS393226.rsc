...
:do {add list=$AddressList comment=AS393226 address=for_scripts/asnv4/AS393226.rsc} on-error {}
...
:do {add list=$AddressList comment=AS393226 address=156.48.241.0/24} on-error {}
