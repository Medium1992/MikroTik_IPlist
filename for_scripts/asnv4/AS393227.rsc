...
:do {add list=$AddressList comment=AS393227 address=for_scripts/asnv4/AS393227.rsc} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.212.0/23} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.0/25} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.128/28} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.144/31} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.147/32} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.148/30} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.152/29} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.160/27} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.214.192/26} on-error {}
:do {add list=$AddressList comment=AS393227 address=104.218.215.0/24} on-error {}
