...
:do {add list=$AddressList comment=AS393359 address=for_scripts/asnv4/AS393359.rsc} on-error {}
...
:do {add list=$AddressList comment=AS393359 address=97.79.169.0/24} on-error {}
