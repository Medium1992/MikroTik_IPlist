...
:do {add list=$AddressList comment=AS393398 address=38.247.128.0/20} on-error {}
:do {add list=$AddressList comment=AS393398 address=38.247.160.0/21} on-error {}
...
:do {add list=$AddressList comment=AS393398 address=96.47.45.0/24} on-error {}
:do {add list=$AddressList comment=AS393398 address=96.47.46.0/23} on-error {}
