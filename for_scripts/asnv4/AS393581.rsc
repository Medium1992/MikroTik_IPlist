...
:do {add list=$AddressList comment=AS393581 address=206.57.151.0/24} on-error {}
:do {add list=$AddressList comment=AS393581 address=206.57.168.0/21} on-error {}
:do {add list=$AddressList comment=AS393581 address=206.57.176.0/22} on-error {}
:do {add list=$AddressList comment=AS393581 address=206.57.184.0/21} on-error {}
