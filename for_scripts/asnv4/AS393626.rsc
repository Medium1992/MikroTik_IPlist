...
:do {add list=$AddressList comment=AS393626 address=66.118.250.0/25} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.250.128/27} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.250.160/30} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.250.164/31} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.250.166/32} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.250.168/29} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.250.176/28} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.250.192/26} on-error {}
:do {add list=$AddressList comment=AS393626 address=66.118.251.0/24} on-error {}
