...
:do {add list=$AddressList comment=AS393733 address=74.188.217.0/24} on-error {}
:do {add list=$AddressList comment=AS393733 address=74.188.218.0/23} on-error {}
:do {add list=$AddressList comment=AS393733 address=74.188.220.0/22} on-error {}
