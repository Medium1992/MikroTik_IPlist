...
:do {add list=$AddressList comment=AS393861 address=for_scripts/asnv4/AS393861.rsc} on-error {}
...
:do {add list=$AddressList comment=AS393861 address=167.201.228.0/22} on-error {}
