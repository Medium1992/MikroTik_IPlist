...
:do {add list=$AddressList comment=AS394073 address=205.209.16.0/24} on-error {}
:do {add list=$AddressList comment=AS394073 address=205.209.19.0/24} on-error {}
:do {add list=$AddressList comment=AS394073 address=205.209.20.0/22} on-error {}
