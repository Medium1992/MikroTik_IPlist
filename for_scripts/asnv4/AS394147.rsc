...
:if ([:len [find where list=$AddressList and address=72.13.24.0/22]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.24.0/22 }
:if ([:len [find where list=$AddressList and address=72.13.28.0/25]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.0/25 }
:if ([:len [find where list=$AddressList and address=72.13.28.129/32]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.129/32 }
:if ([:len [find where list=$AddressList and address=72.13.28.130/31]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.130/31 }
:if ([:len [find where list=$AddressList and address=72.13.28.132/30]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.132/30 }
:if ([:len [find where list=$AddressList and address=72.13.28.136/29]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.136/29 }
:if ([:len [find where list=$AddressList and address=72.13.28.144/28]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.144/28 }
:if ([:len [find where list=$AddressList and address=72.13.28.160/27]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.160/27 }
:if ([:len [find where list=$AddressList and address=72.13.28.192/26]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.28.192/26 }
:if ([:len [find where list=$AddressList and address=72.13.29.0/24]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.29.0/24 }
:if ([:len [find where list=$AddressList and address=72.13.30.0/23]] = 0) do={ add list=$AddressList comment=AS394147 address=72.13.30.0/23 }
