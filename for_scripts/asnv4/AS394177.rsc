...
:do {add list=$AddressList comment=AS394177 address=for_scripts/asnv4/AS394177.rsc} on-error {}
...
:do {add list=$AddressList comment=AS394177 address=185.233.166.0/24} on-error {}
