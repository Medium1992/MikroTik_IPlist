...
:do {add list=$AddressList comment=AS394256 address=104.218.61.0/24} on-error {}
...
:do {add list=$AddressList comment=AS394256 address=205.137.251.0/24} on-error {}
...
:do {add list=$AddressList comment=AS394256 address=38.88.124.0/24} on-error {}
