...
:do {add list=$AddressList comment=AS39442 address=178.212.80.0/21} on-error {}
...
:do {add list=$AddressList comment=AS39442 address=213.234.16.0/21} on-error {}
...
:do {add list=$AddressList comment=AS39442 address=62.122.88.0/21} on-error {}
