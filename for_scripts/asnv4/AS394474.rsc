...
:do {add list=$AddressList comment=AS394474 address=191.102.128.0/22} on-error {}
:do {add list=$AddressList comment=AS394474 address=191.102.132.0/23} on-error {}
:do {add list=$AddressList comment=AS394474 address=191.102.134.0/24} on-error {}
:do {add list=$AddressList comment=AS394474 address=191.102.136.0/21} on-error {}
...
:do {add list=$AddressList comment=AS394474 address=191.102.152.0/23} on-error {}
:do {add list=$AddressList comment=AS394474 address=191.102.154.0/24} on-error {}
:do {add list=$AddressList comment=AS394474 address=191.102.156.0/22} on-error {}
