...
:if ([:len [find where list=$AddressList and address=205.184.66.0/24]] = 0) do={ add list=$AddressList comment=AS394720 address=205.184.66.0/24 }
...
:if ([:len [find where list=$AddressList and address=209.71.149.0/24]] = 0) do={ add list=$AddressList comment=AS394720 address=209.71.149.0/24 }
