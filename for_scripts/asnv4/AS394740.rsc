...
:do {add list=$AddressList comment=AS394740 address=for_scripts/asnv4/AS394740.rsc} on-error {}
...
:do {add list=$AddressList comment=AS394740 address=65.49.53.0/24} on-error {}
