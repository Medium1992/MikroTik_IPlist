...
:do {add list=$AddressList comment=AS394749 address=for_scripts/asnv4/AS394749.rsc} on-error {}
...
:do {add list=$AddressList comment=AS394749 address=64.191.202.0/24} on-error {}
