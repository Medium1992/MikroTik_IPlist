...
:do {add list=$AddressList comment=AS394760 address=for_scripts/asnv4/AS394760.rsc} on-error {}
...
:do {add list=$AddressList comment=AS394760 address=200.229.30.0/24} on-error {}
