...
:do {add list=$AddressList comment=AS394814 address=for_scripts/asnv4/AS394814.rsc} on-error {}
:do {add list=$AddressList comment=AS394814 address=185.235.142.0/24} on-error {}
