...
:do {add list=$AddressList comment=AS39494 address=for_scripts/asnv4/AS39494.rsc} on-error {}
...
:do {add list=$AddressList comment=AS39494 address=89.104.72.0/21} on-error {}
...
:do {add list=$AddressList comment=AS39494 address=89.104.94.0/24} on-error {}
