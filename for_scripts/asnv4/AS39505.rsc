...
:do {add list=$AddressList comment=AS39505 address=for_scripts/asnv4/AS39505.rsc} on-error {}
...
:do {add list=$AddressList comment=AS39505 address=87.247.254.0/23} on-error {}
