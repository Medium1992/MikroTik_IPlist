...
:do {add list=$AddressList comment=AS39519 address=for_scripts/asnv4/AS39519.rsc} on-error {}
...
:do {add list=$AddressList comment=AS39519 address=217.18.112.0/22} on-error {}
