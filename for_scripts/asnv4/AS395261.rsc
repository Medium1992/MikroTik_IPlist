...
:do {add list=$AddressList comment=AS395261 address=163.182.228.0/23} on-error {}
:do {add list=$AddressList comment=AS395261 address=163.182.230.0/24} on-error {}
...
:do {add list=$AddressList comment=AS395261 address=163.182.247.0/24} on-error {}
