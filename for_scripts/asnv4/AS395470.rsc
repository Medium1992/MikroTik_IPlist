...
:do {add list=$AddressList comment=AS395470 address=45.87.184.0/24} on-error {}
...
:do {add list=$AddressList comment=AS395470 address=80.174.118.0/24} on-error {}
:do {add list=$AddressList comment=AS395470 address=82.22.126.0/24} on-error {}
:do {add list=$AddressList comment=AS395470 address=89.213.208.0/24} on-error {}
