...
:do {add list=$AddressList comment=AS395535 address=38.146.84.0/24} on-error {}
:do {add list=$AddressList comment=AS395535 address=38.146.86.0/23} on-error {}
:do {add list=$AddressList comment=AS395535 address=38.29.184.0/24} on-error {}
:do {add list=$AddressList comment=AS395535 address=38.66.212.0/24} on-error {}
:do {add list=$AddressList comment=AS395535 address=38.66.214.0/23} on-error {}
