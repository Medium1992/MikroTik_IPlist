...
:if ([:len [find where list=$AddressList and address=167.8.132.0/24]] = 0) do={ add list=$AddressList comment=AS395693 address=167.8.132.0/24 }
:if ([:len [find where list=$AddressList and address=167.8.134.0/23]] = 0) do={ add list=$AddressList comment=AS395693 address=167.8.134.0/23 }
