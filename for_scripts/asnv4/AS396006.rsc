...
:do {add list=$AddressList comment=AS396006 address=198.163.184.0/22} on-error {}
:do {add list=$AddressList comment=AS396006 address=198.163.189.0/24} on-error {}
:do {add list=$AddressList comment=AS396006 address=198.163.190.0/23} on-error {}
