...
:do {add list=$AddressList comment=AS396191 address=for_scripts/asnv4/AS396191.rsc} on-error {}
:do {add list=$AddressList comment=AS396191 address=104.254.200.0/22} on-error {}
