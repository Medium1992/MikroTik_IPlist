...
:do {add list=$AddressList comment=AS396206 address=for_scripts/asnv4/AS396206.rsc} on-error {}
...
:do {add list=$AddressList comment=AS396206 address=199.189.44.0/22} on-error {}
