...
:if ([:len [find where list=$AddressList and address=169.197.164.0/22]] = 0) do={ add list=$AddressList comment=AS396420 address=169.197.164.0/22 }
...
:if ([:len [find where list=$AddressList and address=64.209.216.0/21]] = 0) do={ add list=$AddressList comment=AS396420 address=64.209.216.0/21 }
