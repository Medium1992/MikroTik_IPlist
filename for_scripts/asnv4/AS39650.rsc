...
:do {add list=$AddressList comment=AS39650 address=109.162.252.0/24} on-error {}
:do {add list=$AddressList comment=AS39650 address=178.239.153.0/24} on-error {}
:do {add list=$AddressList comment=AS39650 address=185.161.37.0/24} on-error {}
:do {add list=$AddressList comment=AS39650 address=185.161.38.0/23} on-error {}
