...
:do {add list=$AddressList comment=AS396872 address=130.12.128.0/22} on-error {}
...
:do {add list=$AddressList comment=AS396872 address=216.7.34.0/23} on-error {}
:do {add list=$AddressList comment=AS396872 address=216.7.36.0/23} on-error {}
:do {add list=$AddressList comment=AS396872 address=216.7.38.0/24} on-error {}
...
:do {add list=$AddressList comment=AS396872 address=216.7.48.0/22} on-error {}
:do {add list=$AddressList comment=AS396872 address=216.7.53.0/24} on-error {}
...
:do {add list=$AddressList comment=AS396872 address=216.7.58.0/23} on-error {}
