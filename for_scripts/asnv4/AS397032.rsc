...
:if ([:len [find where list=$AddressList and address=208.87.101.0/24]] = 0) do={ add list=$AddressList comment=AS397032 address=208.87.101.0/24 }
:if ([:len [find where list=$AddressList and address=212.192.28.0/23]] = 0) do={ add list=$AddressList comment=AS397032 address=212.192.28.0/23 }
:if ([:len [find where list=$AddressList and address=216.173.77.0/24]] = 0) do={ add list=$AddressList comment=AS397032 address=216.173.77.0/24 }
:if ([:len [find where list=$AddressList and address=23.230.3.0/24]] = 0) do={ add list=$AddressList comment=AS397032 address=23.230.3.0/24 }
