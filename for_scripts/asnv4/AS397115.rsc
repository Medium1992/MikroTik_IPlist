...
:do {add list=$AddressList comment=AS397115 address=153.11.16.0/23} on-error {}
:do {add list=$AddressList comment=AS397115 address=153.11.18.0/24} on-error {}
...
:do {add list=$AddressList comment=AS397115 address=153.11.252.0/24} on-error {}
:do {add list=$AddressList comment=AS397115 address=153.11.255.0/24} on-error {}
