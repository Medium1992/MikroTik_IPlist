...
:do {add list=$AddressList comment=AS397270 address=for_scripts/asnv4/AS397270.rsc} on-error {}
:do {add list=$AddressList comment=AS397270 address=128.254.172.0/22} on-error {}
