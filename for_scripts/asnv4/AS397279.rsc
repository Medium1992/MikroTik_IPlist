...
:do {add list=$AddressList comment=AS397279 address=for_scripts/asnv4/AS397279.rsc} on-error {}
:do {add list=$AddressList comment=AS397279 address=135.129.100.0/24} on-error {}
