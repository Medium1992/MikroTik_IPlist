...
:do {add list=$AddressList comment=AS397283 address=for_scripts/asnv4/AS397283.rsc} on-error {}
...
:do {add list=$AddressList comment=AS397283 address=89.251.25.0/24} on-error {}
