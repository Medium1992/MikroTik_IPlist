...
:do {add list=$AddressList comment=AS397293 address=for_scripts/asnv4/AS397293.rsc} on-error {}
...
:do {add list=$AddressList comment=AS397293 address=68.69.8.0/22} on-error {}
