...
:do {add list=$AddressList comment=AS397301 address=for_scripts/asnv4/AS397301.rsc} on-error {}
...
:do {add list=$AddressList comment=AS397301 address=45.41.254.0/23} on-error {}
