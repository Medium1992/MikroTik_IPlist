...
:do {add list=$AddressList comment=AS397433 address=156.11.128.0/20} on-error {}
:do {add list=$AddressList comment=AS397433 address=156.11.144.0/22} on-error {}
:do {add list=$AddressList comment=AS397433 address=156.11.148.0/24} on-error {}
:do {add list=$AddressList comment=AS397433 address=156.11.150.0/23} on-error {}
:do {add list=$AddressList comment=AS397433 address=156.11.152.0/21} on-error {}
