...
:if ([:len [find where list=$AddressList and address=169.128.244.0/24]] = 0) do={ add list=$AddressList comment=AS397493 address=169.128.244.0/24 }
...
:if ([:len [find where list=$AddressList and address=38.246.81.0/24]] = 0) do={ add list=$AddressList comment=AS397493 address=38.246.81.0/24 }
