...
:if ([:len [find where list=$AddressList and address=147.189.164.0/22]] = 0) do={ add list=$AddressList comment=AS397688 address=147.189.164.0/22 }
...
:if ([:len [find where list=$AddressList and address=31.222.50.0/23]] = 0) do={ add list=$AddressList comment=AS397688 address=31.222.50.0/23 }
