...
:do {add list=$AddressList comment=AS397836 address=for_scripts/asnv4/AS397836.rsc} on-error {}
...
:do {add list=$AddressList comment=AS397836 address=38.39.24.0/21} on-error {}
