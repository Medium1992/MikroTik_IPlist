...
:do {add list=$AddressList comment=AS398037 address=for_scripts/asnv4/AS398037.rsc} on-error {}
:do {add list=$AddressList comment=AS398037 address=194.88.91.0/24} on-error {}
:do {add list=$AddressList comment=AS398037 address=198.100.160.0/23} on-error {}
:do {add list=$AddressList comment=AS398037 address=198.100.162.0/24} on-error {}
