...
:if ([:len [find where list=$AddressList and address=208.126.170.0/24]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.170.0/24 }
:if ([:len [find where list=$AddressList and address=208.126.171.0/27]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.0/27 }
:if ([:len [find where list=$AddressList and address=208.126.171.128/25]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.128/25 }
:if ([:len [find where list=$AddressList and address=208.126.171.32/28]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.32/28 }
:if ([:len [find where list=$AddressList and address=208.126.171.48/29]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.48/29 }
:if ([:len [find where list=$AddressList and address=208.126.171.57/32]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.57/32 }
:if ([:len [find where list=$AddressList and address=208.126.171.58/31]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.58/31 }
:if ([:len [find where list=$AddressList and address=208.126.171.60/30]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.60/30 }
:if ([:len [find where list=$AddressList and address=208.126.171.64/26]] = 0) do={ add list=$AddressList comment=AS398052 address=208.126.171.64/26 }
