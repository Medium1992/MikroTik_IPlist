...
:do {add list=$AddressList comment=AS398232 address=107.182.138.0/24} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.0/25} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.128/26} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.192/27} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.224/29} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.232/30} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.236/32} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.238/31} on-error {}
:do {add list=$AddressList comment=AS398232 address=107.182.139.240/28} on-error {}
