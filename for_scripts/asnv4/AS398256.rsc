...
:do {add list=$AddressList comment=AS398256 address=151.241.99.0/24} on-error {}
:do {add list=$AddressList comment=AS398256 address=185.233.166.0/24} on-error {}
:do {add list=$AddressList comment=AS398256 address=192.142.48.0/23} on-error {}
