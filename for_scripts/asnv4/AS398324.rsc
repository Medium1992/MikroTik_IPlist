...
:if ([:len [find where list=$AddressList and address=162.142.125.0/24]] = 0) do={ add list=$AddressList comment=AS398324 address=162.142.125.0/24 }
:if ([:len [find where list=$AddressList and address=167.248.133.0/24]] = 0) do={ add list=$AddressList comment=AS398324 address=167.248.133.0/24 }
:if ([:len [find where list=$AddressList and address=167.94.138.0/24]] = 0) do={ add list=$AddressList comment=AS398324 address=167.94.138.0/24 }
:if ([:len [find where list=$AddressList and address=206.168.35.0/24]] = 0) do={ add list=$AddressList comment=AS398324 address=206.168.35.0/24 }
:if ([:len [find where list=$AddressList and address=66.132.148.0/24]] = 0) do={ add list=$AddressList comment=AS398324 address=66.132.148.0/24 }
:if ([:len [find where list=$AddressList and address=66.132.153.0/24]] = 0) do={ add list=$AddressList comment=AS398324 address=66.132.153.0/24 }
