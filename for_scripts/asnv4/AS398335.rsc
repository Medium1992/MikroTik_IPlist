...
:do {add list=$AddressList comment=AS398335 address=for_scripts/asnv4/AS398335.rsc} on-error {}
:do {add list=$AddressList comment=AS398335 address=209.172.24.0/21} on-error {}
