...
:do {add list=$AddressList comment=AS398479 address=for_scripts/asnv4/AS398479.rsc} on-error {}
...
:do {add list=$AddressList comment=AS398479 address=66.118.8.0/24} on-error {}
