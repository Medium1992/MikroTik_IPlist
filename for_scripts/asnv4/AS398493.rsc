...
:do {add list=$AddressList comment=AS398493 address=144.225.246.0/23} on-error {}
:do {add list=$AddressList comment=AS398493 address=151.244.214.0/24} on-error {}
:do {add list=$AddressList comment=AS398493 address=166.88.232.0/24} on-error {}
:do {add list=$AddressList comment=AS398493 address=169.128.158.0/23} on-error {}
