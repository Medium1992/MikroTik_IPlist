...
:if ([:len [find where list=$AddressList and address=199.184.248.0/24]] = 0) do={ add list=$AddressList comment=AS398700 address=199.184.248.0/24 }
...
:if ([:len [find where list=$AddressList and address=206.220.133.0/24]] = 0) do={ add list=$AddressList comment=AS398700 address=206.220.133.0/24 }
