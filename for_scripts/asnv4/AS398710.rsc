...
:do {add list=$AddressList comment=AS398710 address=for_scripts/asnv4/AS398710.rsc} on-error {}
:do {add list=$AddressList comment=AS398710 address=168.100.224.0/23} on-error {}
:do {add list=$AddressList comment=AS398710 address=168.100.232.0/22} on-error {}
...
:do {add list=$AddressList comment=AS398710 address=168.100.247.0/24} on-error {}
