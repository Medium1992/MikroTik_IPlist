...
:do {add list=$AddressList comment=AS39900 address=138.249.142.0/23} on-error {}
...
:do {add list=$AddressList comment=AS39900 address=72.56.52.0/23} on-error {}
:do {add list=$AddressList comment=AS39900 address=77.90.46.0/24} on-error {}
