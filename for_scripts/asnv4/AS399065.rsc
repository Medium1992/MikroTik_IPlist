...
:do {add list=$AddressList comment=AS399065 address=167.224.0.0/21} on-error {}
:do {add list=$AddressList comment=AS399065 address=167.224.12.0/22} on-error {}
...
:do {add list=$AddressList comment=AS399065 address=195.85.120.0/24} on-error {}
