...
:if ([:len [find where list=$AddressList and address=161.115.250.0/23]] = 0) do={ add list=$AddressList comment=AS399122 address=161.115.250.0/23 }
:if ([:len [find where list=$AddressList and address=161.115.252.0/23]] = 0) do={ add list=$AddressList comment=AS399122 address=161.115.252.0/23 }
:if ([:len [find where list=$AddressList and address=161.115.254.0/24]] = 0) do={ add list=$AddressList comment=AS399122 address=161.115.254.0/24 }
...
:if ([:len [find where list=$AddressList and address=38.3.88.0/24]] = 0) do={ add list=$AddressList comment=AS399122 address=38.3.88.0/24 }
