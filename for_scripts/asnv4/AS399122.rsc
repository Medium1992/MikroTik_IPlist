...
:if ([:len [find where list=$AddressList and address=154.27.16.0/21]] = 0) do={ add list=$AddressList comment=AS399122 address=154.27.16.0/21 }
...
:if ([:len [find where list=$AddressList and address=38.3.80.0/20]] = 0) do={ add list=$AddressList comment=AS399122 address=38.3.80.0/20 }
