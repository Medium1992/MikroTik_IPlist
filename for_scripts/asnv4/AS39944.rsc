...
:do {add list=$AddressList comment=AS39944 address=for_scripts/asnv4/AS39944.rsc} on-error {}
...
:do {add list=$AddressList comment=AS39944 address=64.50.160.0/24} on-error {}
...
:do {add list=$AddressList comment=AS39944 address=95.214.176.0/24} on-error {}
