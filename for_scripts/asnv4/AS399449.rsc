...
:if ([:len [find where list=$AddressList and address=158.88.0.0/24]] = 0) do={ add list=$AddressList comment=AS399449 address=158.88.0.0/24 }
:if ([:len [find where list=$AddressList and address=158.88.15.0/24]] = 0) do={ add list=$AddressList comment=AS399449 address=158.88.15.0/24 }
