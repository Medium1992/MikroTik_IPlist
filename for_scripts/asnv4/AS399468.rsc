...
:do {add list=$AddressList comment=AS399468 address=217.60.56.0/22} on-error {}
:do {add list=$AddressList comment=AS399468 address=31.58.184.0/21} on-error {}
:do {add list=$AddressList comment=AS399468 address=31.59.176.0/21} on-error {}
...
:do {add list=$AddressList comment=AS399468 address=94.183.192.0/21} on-error {}
