...
:if ([:len [find where list=$AddressList and address=114.119.192.0/22]] = 0) do={ add list=$AddressList comment=AS399468 address=114.119.192.0/22 }
...
:if ([:len [find where list=$AddressList and address=217.60.52.0/22]] = 0) do={ add list=$AddressList comment=AS399468 address=217.60.52.0/22 }
