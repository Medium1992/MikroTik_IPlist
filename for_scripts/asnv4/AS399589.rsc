...
:if ([:len [find where list=$AddressList and address=173.247.84.0/23]] = 0) do={ add list=$AddressList comment=AS399589 address=173.247.84.0/23 }
:if ([:len [find where list=$AddressList and address=173.247.86.0/24]] = 0) do={ add list=$AddressList comment=AS399589 address=173.247.86.0/24 }
