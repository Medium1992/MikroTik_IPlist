...
:do {add list=$AddressList comment=AS399654 address=198.17.139.0/24} on-error {}
:do {add list=$AddressList comment=AS399654 address=206.85.0.0/24} on-error {}
:do {add list=$AddressList comment=AS399654 address=38.109.89.0/24} on-error {}
...
:do {add list=$AddressList comment=AS399654 address=8.45.19.0/24} on-error {}
