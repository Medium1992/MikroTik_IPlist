...
:do {add list=$AddressList comment=AS399672 address=134.202.100.0/24} on-error {}
:do {add list=$AddressList comment=AS399672 address=134.202.102.0/23} on-error {}
:do {add list=$AddressList comment=AS399672 address=134.202.105.0/24} on-error {}
:do {add list=$AddressList comment=AS399672 address=134.202.108.0/24} on-error {}
:do {add list=$AddressList comment=AS399672 address=134.202.110.0/23} on-error {}
...
:do {add list=$AddressList comment=AS399672 address=206.174.138.0/23} on-error {}
