...
:do {add list=$AddressList comment=AS399768 address=for_scripts/asnv4/AS399768.rsc} on-error {}
:do {add list=$AddressList comment=AS399768 address=160.72.146.0/24} on-error {}
