...
:do {add list=$AddressList comment=AS399870 address=2.58.170.0/24} on-error {}
:do {add list=$AddressList comment=AS399870 address=23.144.172.0/24} on-error {}
:do {add list=$AddressList comment=AS399870 address=23.144.56.0/24} on-error {}
:do {add list=$AddressList comment=AS399870 address=74.52.1.0/24} on-error {}
