...
:if ([:len [find where list=$AddressList and address=128.9.16.0/23]] = 0) do={ add list=$AddressList comment=AS4 address=128.9.16.0/23 }
:if ([:len [find where list=$AddressList and address=128.9.18.0/24]] = 0) do={ add list=$AddressList comment=AS4 address=128.9.18.0/24 }
