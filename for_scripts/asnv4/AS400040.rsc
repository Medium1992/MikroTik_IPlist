...
:do {add list=$AddressList comment=AS400040 address=for_scripts/asnv4/AS400040.rsc} on-error {}
:do {add list=$AddressList comment=AS400040 address=141.11.191.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=141.11.44.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=141.11.6.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=154.16.184.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=154.16.237.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=181.214.84.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=181.215.198.0/24} on-error {}
...
:do {add list=$AddressList comment=AS400040 address=185.225.21.0/24} on-error {}
...
:do {add list=$AddressList comment=AS400040 address=191.96.61.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=193.148.255.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=193.37.198.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=194.169.49.0/24} on-error {}
...
:do {add list=$AddressList comment=AS400040 address=87.248.144.0/24} on-error {}
:do {add list=$AddressList comment=AS400040 address=91.244.196.0/24} on-error {}
