...
:do {add list=$AddressList comment=AS400110 address=for_scripts/asnv4/AS400110.rsc} on-error {}
:do {add list=$AddressList comment=AS400110 address=184.169.38.0/23} on-error {}
:do {add list=$AddressList comment=AS400110 address=184.169.42.0/23} on-error {}
