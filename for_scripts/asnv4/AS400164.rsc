...
:do {add list=$AddressList comment=AS400164 address=for_scripts/asnv4/AS400164.rsc} on-error {}
:do {add list=$AddressList comment=AS400164 address=38.212.192.0/22} on-error {}
