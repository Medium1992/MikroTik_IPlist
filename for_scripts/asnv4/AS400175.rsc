...
:do {add list=$AddressList comment=AS400175 address=for_scripts/asnv4/AS400175.rsc} on-error {}
...
:do {add list=$AddressList comment=AS400175 address=154.203.2.0/24} on-error {}
...
:do {add list=$AddressList comment=AS400175 address=50.114.210.0/24} on-error {}
