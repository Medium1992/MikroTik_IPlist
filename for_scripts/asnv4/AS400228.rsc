...
:do {add list=$AddressList comment=AS400228 address=for_scripts/asnv4/AS400228.rsc} on-error {}
...
:do {add list=$AddressList comment=AS400228 address=38.95.22.0/23} on-error {}
