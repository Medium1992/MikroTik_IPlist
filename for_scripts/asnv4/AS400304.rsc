...
:do {add list=$AddressList comment=AS400304 address=104.204.64.0/19} on-error {}
...
:do {add list=$AddressList comment=AS400304 address=167.17.72.0/23} on-error {}
:do {add list=$AddressList comment=AS400304 address=167.17.75.0/24} on-error {}
:do {add list=$AddressList comment=AS400304 address=167.17.76.0/22} on-error {}
