...
:if ([:len [find where list=$AddressList and address=204.0.120.0/21]] = 0) do={ add list=$AddressList comment=AS400427 address=204.0.120.0/21 }
...
:if ([:len [find where list=$AddressList and address=72.51.12.0/23]] = 0) do={ add list=$AddressList comment=AS400427 address=72.51.12.0/23 }
