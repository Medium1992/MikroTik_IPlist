...
:do {add list=$AddressList comment=AS400427 address=for_scripts/asnv4/AS400427.rsc} on-error {}
...
:do {add list=$AddressList comment=AS400427 address=66.33.58.0/24} on-error {}
