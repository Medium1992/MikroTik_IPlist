...
:if ([:len [find where list=$AddressList and address=64.70.124.0/24]] = 0) do={ add list=$AddressList comment=AS400494 address=64.70.124.0/24 }
:if ([:len [find where list=$AddressList and address=64.70.126.0/24]] = 0) do={ add list=$AddressList comment=AS400494 address=64.70.126.0/24 }
