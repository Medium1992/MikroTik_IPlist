...
:do {add list=$AddressList comment=AS400514 address=for_scripts/asnv4/AS400514.rsc} on-error {}
...
:do {add list=$AddressList comment=AS400514 address=173.209.224.0/23} on-error {}
