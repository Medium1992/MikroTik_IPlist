...
:do {add list=$AddressList comment=AS400529 address=for_scripts/asnv4/AS400529.rsc} on-error {}
...
:do {add list=$AddressList comment=AS400529 address=167.94.253.0/24} on-error {}
