...
:do {add list=$AddressList comment=AS400556 address=for_scripts/asnv4/AS400556.rsc} on-error {}
...
:do {add list=$AddressList comment=AS400556 address=172.82.88.0/24} on-error {}
