...
:if ([:len [find where list=$AddressList and address=216.109.177.0/24]] = 0) do={ add list=$AddressList comment=AS400556 address=216.109.177.0/24 }
:if ([:len [find where list=$AddressList and address=37.202.199.0/24]] = 0) do={ add list=$AddressList comment=AS400556 address=37.202.199.0/24 }
