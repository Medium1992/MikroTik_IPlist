...
:if ([:len [find where list=$AddressList and address=66.6.238.0/24]] = 0) do={ add list=$AddressList comment=AS40073 address=66.6.238.0/24 }
:if ([:len [find where list=$AddressList and address=66.6.240.0/23]] = 0) do={ add list=$AddressList comment=AS40073 address=66.6.240.0/23 }
