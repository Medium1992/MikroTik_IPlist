...
:do {add list=$AddressList comment=AS400754 address=107.180.0.0/21} on-error {}
:do {add list=$AddressList comment=AS400754 address=107.180.10.0/24} on-error {}
:do {add list=$AddressList comment=AS400754 address=107.180.12.0/22} on-error {}
:do {add list=$AddressList comment=AS400754 address=107.180.16.0/20} on-error {}
:do {add list=$AddressList comment=AS400754 address=107.180.32.0/19} on-error {}
:do {add list=$AddressList comment=AS400754 address=107.180.8.0/23} on-error {}
