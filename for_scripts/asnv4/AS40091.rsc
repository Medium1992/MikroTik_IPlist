...
:if ([:len [find where list=$AddressList and address=216.115.192.0/22]] = 0) do={ add list=$AddressList comment=AS40091 address=216.115.192.0/22 }
:if ([:len [find where list=$AddressList and address=216.115.196.0/24]] = 0) do={ add list=$AddressList comment=AS40091 address=216.115.196.0/24 }
:if ([:len [find where list=$AddressList and address=216.115.198.0/23]] = 0) do={ add list=$AddressList comment=AS40091 address=216.115.198.0/23 }
:if ([:len [find where list=$AddressList and address=216.115.200.0/21]] = 0) do={ add list=$AddressList comment=AS40091 address=216.115.200.0/21 }
