...
:do {add list=$AddressList comment=AS400940 address=152.55.176.0/21} on-error {}
:do {add list=$AddressList comment=AS400940 address=152.55.184.0/22} on-error {}
...
:do {add list=$AddressList comment=AS400940 address=69.46.46.0/24} on-error {}
