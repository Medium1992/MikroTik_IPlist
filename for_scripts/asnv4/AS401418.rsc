...
:do {add list=$AddressList comment=AS401418 address=155.117.235.0/24} on-error {}
:do {add list=$AddressList comment=AS401418 address=163.5.198.0/24} on-error {}
...
:do {add list=$AddressList comment=AS401418 address=82.21.20.0/23} on-error {}
