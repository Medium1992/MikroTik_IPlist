...
:do {add list=$AddressList comment=AS401434 address=109.111.240.0/24} on-error {}
:do {add list=$AddressList comment=AS401434 address=143.246.50.0/23} on-error {}
:do {add list=$AddressList comment=AS401434 address=154.85.16.0/23} on-error {}
:do {add list=$AddressList comment=AS401434 address=162.141.136.0/23} on-error {}
