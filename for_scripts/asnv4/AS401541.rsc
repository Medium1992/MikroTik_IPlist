...
:do {add list=$AddressList comment=AS401541 address=for_scripts/asnv4/AS401541.rsc} on-error {}
...
:do {add list=$AddressList comment=AS401541 address=23.155.185.0/24} on-error {}
