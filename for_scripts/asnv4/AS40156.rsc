...
:do {add list=$AddressList comment=AS40156 address=142.249.221.0/24} on-error {}
:do {add list=$AddressList comment=AS40156 address=162.218.228.0/22} on-error {}
:do {add list=$AddressList comment=AS40156 address=193.202.106.0/24} on-error {}
:do {add list=$AddressList comment=AS40156 address=195.8.117.0/24} on-error {}
