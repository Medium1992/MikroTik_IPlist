...
:do {add list=$AddressList comment=AS40165 address=for_scripts/asnv4/AS40165.rsc} on-error {}
...
:do {add list=$AddressList comment=AS40165 address=69.72.92.0/23} on-error {}
