...
:do {add list=$AddressList comment=AS401701 address=154.201.94.0/24} on-error {}
...
:do {add list=$AddressList comment=AS401701 address=82.158.224.0/22} on-error {}
:do {add list=$AddressList comment=AS401701 address=82.158.228.0/24} on-error {}
:do {add list=$AddressList comment=AS401701 address=82.158.230.0/23} on-error {}
