...
:if ([:len [find where list=$AddressList and address=107.149.17.0/24]] = 0) do={ add list=$AddressList comment=AS401776 address=107.149.17.0/24 }
:if ([:len [find where list=$AddressList and address=107.149.36.0/24]] = 0) do={ add list=$AddressList comment=AS401776 address=107.149.36.0/24 }
...
:if ([:len [find where list=$AddressList and address=176.102.174.0/23]] = 0) do={ add list=$AddressList comment=AS401776 address=176.102.174.0/23 }
...
:if ([:len [find where list=$AddressList and address=23.185.104.0/24]] = 0) do={ add list=$AddressList comment=AS401776 address=23.185.104.0/24 }
:if ([:len [find where list=$AddressList and address=40.223.84.0/24]] = 0) do={ add list=$AddressList comment=AS401776 address=40.223.84.0/24 }
...
:if ([:len [find where list=$AddressList and address=77.246.220.0/24]] = 0) do={ add list=$AddressList comment=AS401776 address=77.246.220.0/24 }
