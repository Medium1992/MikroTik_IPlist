...
:if ([:len [find where list=$AddressList and address=131.108.40.0/22]] = 0) do={ add list=$AddressList comment=AS402020 address=131.108.40.0/22 }
...
:if ([:len [find where list=$AddressList and address=179.63.248.0/24]] = 0) do={ add list=$AddressList comment=AS402020 address=179.63.248.0/24 }
