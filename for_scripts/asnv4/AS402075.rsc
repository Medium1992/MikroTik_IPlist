...
:do {add list=$AddressList comment=AS402075 address=189.13.152.0/23} on-error {}
:do {add list=$AddressList comment=AS402075 address=189.13.154.0/24} on-error {}
:do {add list=$AddressList comment=AS402075 address=189.13.160.0/23} on-error {}
