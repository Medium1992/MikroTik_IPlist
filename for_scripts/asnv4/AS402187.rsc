...
:do {add list=$AddressList comment=AS402187 address=178.92.140.0/24} on-error {}
...
:do {add list=$AddressList comment=AS402187 address=45.8.23.0/24} on-error {}
...
:do {add list=$AddressList comment=AS402187 address=91.124.86.0/24} on-error {}
:do {add list=$AddressList comment=AS402187 address=95.134.154.0/24} on-error {}
:do {add list=$AddressList comment=AS402187 address=95.135.251.0/24} on-error {}
