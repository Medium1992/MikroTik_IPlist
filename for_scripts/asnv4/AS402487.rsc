...
:do {add list=$AddressList comment=AS402487 address=104.140.113.0/24} on-error {}
...
:do {add list=$AddressList comment=AS402487 address=158.62.199.0/24} on-error {}
:do {add list=$AddressList comment=AS402487 address=165.49.73.0/24} on-error {}
...
:do {add list=$AddressList comment=AS402487 address=82.139.224.0/24} on-error {}
