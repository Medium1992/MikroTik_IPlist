...
:do {add list=$AddressList comment=AS40352 address=144.225.125.0/24} on-error {}
...
:do {add list=$AddressList comment=AS40352 address=163.123.132.0/24} on-error {}
...
:do {add list=$AddressList comment=AS40352 address=185.11.218.0/24} on-error {}
:do {add list=$AddressList comment=AS40352 address=185.173.35.0/24} on-error {}
:do {add list=$AddressList comment=AS40352 address=192.6.160.0/24} on-error {}
:do {add list=$AddressList comment=AS40352 address=2.26.175.0/24} on-error {}
