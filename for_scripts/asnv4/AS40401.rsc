...
:if ([:len [find where list=$AddressList and address=104.153.232.0/21]] = 0) do={ add list=$AddressList comment=AS40401 address=104.153.232.0/21 }
...
:if ([:len [find where list=$AddressList and address=207.166.148.0/24]] = 0) do={ add list=$AddressList comment=AS40401 address=207.166.148.0/24 }
