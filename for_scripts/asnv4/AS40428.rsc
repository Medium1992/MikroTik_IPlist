...
:if ([:len [find where list=$AddressList and address=199.116.162.0/23]] = 0) do={ add list=$AddressList comment=AS40428 address=199.116.162.0/23 }
...
:if ([:len [find where list=$AddressList and address=208.85.42.0/24]] = 0) do={ add list=$AddressList comment=AS40428 address=208.85.42.0/24 }
