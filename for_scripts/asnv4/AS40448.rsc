...
:if ([:len [find where list=$AddressList and address=207.181.166.0/23]] = 0) do={ add list=$AddressList comment=AS40448 address=207.181.166.0/23 }
:if ([:len [find where list=$AddressList and address=207.181.168.0/23]] = 0) do={ add list=$AddressList comment=AS40448 address=207.181.168.0/23 }
