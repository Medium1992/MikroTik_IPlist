...
:do {add list=$AddressList comment=AS40564 address=149.6.125.0/24} on-error {}
:do {add list=$AddressList comment=AS40564 address=149.7.26.0/24} on-error {}
...
:do {add list=$AddressList comment=AS40564 address=38.57.136.0/24} on-error {}
...
:do {add list=$AddressList comment=AS40564 address=38.70.78.0/23} on-error {}
:do {add list=$AddressList comment=AS40564 address=38.90.16.0/22} on-error {}
:do {add list=$AddressList comment=AS40564 address=38.93.140.0/22} on-error {}
...
:do {add list=$AddressList comment=AS40564 address=64.204.21.0/24} on-error {}
