...
:do {add list=$AddressList comment=AS40581 address=for_scripts/asnv4/AS40581.rsc} on-error {}
...
:do {add list=$AddressList comment=AS40581 address=192.231.213.0/24} on-error {}
...
:do {add list=$AddressList comment=AS40581 address=72.35.208.0/20} on-error {}
