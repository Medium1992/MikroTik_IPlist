...
:if ([:len [find where list=$AddressList and address=75.78.136.0/23]] = 0) do={ add list=$AddressList comment=AS40714 address=75.78.136.0/23 }
:if ([:len [find where list=$AddressList and address=75.78.138.0/24]] = 0) do={ add list=$AddressList comment=AS40714 address=75.78.138.0/24 }
