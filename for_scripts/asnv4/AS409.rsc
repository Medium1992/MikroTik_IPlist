...
:do {add list=$AddressList comment=AS409 address=for_scripts/asnv4/AS409.rsc} on-error {}
:do {add list=$AddressList comment=AS409 address=128.216.0.0/20} on-error {}
:do {add list=$AddressList comment=AS409 address=131.36.0.0/16} on-error {}
:do {add list=$AddressList comment=AS409 address=131.47.0.0/16} on-error {}
