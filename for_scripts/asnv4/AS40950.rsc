...
:do {add list=$AddressList comment=AS40950 address=185.143.73.0/24} on-error {}
:do {add list=$AddressList comment=AS40950 address=66.6.57.0/24} on-error {}
:do {add list=$AddressList comment=AS40950 address=89.125.185.0/24} on-error {}
