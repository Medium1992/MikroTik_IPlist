...
:do {add list=$AddressList comment=AS40994 address=for_scripts/asnv4/AS40994.rsc} on-error {}
...
:do {add list=$AddressList comment=AS40994 address=194.150.74.0/24} on-error {}
