...
:do {add list=$AddressList comment=AS41012 address=for_scripts/asnv4/AS41012.rsc} on-error {}
:do {add list=$AddressList comment=AS41012 address=194.42.124.0/23} on-error {}
:do {add list=$AddressList comment=AS41012 address=91.103.32.0/23} on-error {}
