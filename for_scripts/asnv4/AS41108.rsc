...
:do {add list=$AddressList comment=AS41108 address=for_scripts/asnv4/AS41108.rsc} on-error {}
...
:do {add list=$AddressList comment=AS41108 address=195.110.20.0/24} on-error {}
