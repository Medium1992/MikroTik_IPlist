...
:if ([:len [find where list=$AddressList and address=109.107.134.0/24]] = 0) do={ add list=$AddressList comment=AS41155 address=109.107.134.0/24 }
...
:if ([:len [find where list=$AddressList and address=185.52.230.0/23]] = 0) do={ add list=$AddressList comment=AS41155 address=185.52.230.0/23 }
...
:if ([:len [find where list=$AddressList and address=194.0.193.0/24]] = 0) do={ add list=$AddressList comment=AS41155 address=194.0.193.0/24 }
