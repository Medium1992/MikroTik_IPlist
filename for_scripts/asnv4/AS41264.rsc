...
:if ([:len [find where list=$AddressList and address=104.132.214.0/24]] = 0) do={ add list=$AddressList comment=AS41264 address=104.132.214.0/24 }
...
:if ([:len [find where list=$AddressList and address=209.119.80.0/23]] = 0) do={ add list=$AddressList comment=AS41264 address=209.119.80.0/23 }
