...
:if ([:len [find where list=$AddressList and address=104.133.5.0/24]] = 0) do={ add list=$AddressList comment=AS41264 address=104.133.5.0/24 }
:if ([:len [find where list=$AddressList and address=104.133.6.0/23]] = 0) do={ add list=$AddressList comment=AS41264 address=104.133.6.0/23 }
