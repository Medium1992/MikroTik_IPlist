...
:do {add list=$AddressList comment=AS41275 address=161.104.20.0/24} on-error {}
...
:do {add list=$AddressList comment=AS41275 address=195.170.192.0/21} on-error {}
:do {add list=$AddressList comment=AS41275 address=195.170.200.0/22} on-error {}
