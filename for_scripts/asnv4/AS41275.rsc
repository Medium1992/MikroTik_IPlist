...
:do {add list=$AddressList comment=AS41275 address=for_scripts/asnv4/AS41275.rsc} on-error {}
...
:do {add list=$AddressList comment=AS41275 address=62.217.184.0/22} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.188.0/23} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.190.0/24} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.0/25} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.128/27} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.160/28} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.176/30} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.180/31} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.182/32} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.184/29} on-error {}
:do {add list=$AddressList comment=AS41275 address=62.217.191.192/26} on-error {}
