...
:do {add list=$AddressList comment=AS4136 address=for_scripts/asnv4/AS4136.rsc} on-error {}
...
:do {add list=$AddressList comment=AS4136 address=209.11.210.0/23} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.11.216.0/23} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.11.219.0/24} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.11.220.0/22} on-error {}
...
:do {add list=$AddressList comment=AS4136 address=209.73.192.0/19} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.73.224.0/20} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.73.240.0/24} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.73.242.0/23} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.73.244.0/22} on-error {}
:do {add list=$AddressList comment=AS4136 address=209.73.248.0/21} on-error {}
