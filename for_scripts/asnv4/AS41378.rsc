...
:if ([:len [find where list=$AddressList and address=38.59.232.0/21]] = 0) do={ add list=$AddressList comment=AS41378 address=38.59.232.0/21 }
:if ([:len [find where list=$AddressList and address=38.59.240.0/20]] = 0) do={ add list=$AddressList comment=AS41378 address=38.59.240.0/20 }
