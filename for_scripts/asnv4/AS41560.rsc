...
:if ([:len [find where list=$AddressList and address=109.200.112.0/21]] = 0) do={ add list=$AddressList comment=AS41560 address=109.200.112.0/21 }
:if ([:len [find where list=$AddressList and address=109.200.120.0/22]] = 0) do={ add list=$AddressList comment=AS41560 address=109.200.120.0/22 }
:if ([:len [find where list=$AddressList and address=109.200.125.0/24]] = 0) do={ add list=$AddressList comment=AS41560 address=109.200.125.0/24 }
:if ([:len [find where list=$AddressList and address=109.200.126.0/23]] = 0) do={ add list=$AddressList comment=AS41560 address=109.200.126.0/23 }
:if ([:len [find where list=$AddressList and address=109.200.96.0/20]] = 0) do={ add list=$AddressList comment=AS41560 address=109.200.96.0/20 }
...
:if ([:len [find where list=$AddressList and address=46.160.138.0/24]] = 0) do={ add list=$AddressList comment=AS41560 address=46.160.138.0/24 }
...
:if ([:len [find where list=$AddressList and address=46.160.160.0/20]] = 0) do={ add list=$AddressList comment=AS41560 address=46.160.160.0/20 }
:if ([:len [find where list=$AddressList and address=46.160.176.0/22]] = 0) do={ add list=$AddressList comment=AS41560 address=46.160.176.0/22 }
:if ([:len [find where list=$AddressList and address=46.160.180.0/23]] = 0) do={ add list=$AddressList comment=AS41560 address=46.160.180.0/23 }
:if ([:len [find where list=$AddressList and address=46.160.182.0/24]] = 0) do={ add list=$AddressList comment=AS41560 address=46.160.182.0/24 }
:if ([:len [find where list=$AddressList and address=46.160.184.0/21]] = 0) do={ add list=$AddressList comment=AS41560 address=46.160.184.0/21 }
