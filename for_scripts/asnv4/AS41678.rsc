...
:if ([:len [find where list=$AddressList and address=194.46.0.0/22]] = 0) do={ add list=$AddressList comment=AS41678 address=194.46.0.0/22 }
:if ([:len [find where list=$AddressList and address=194.46.116.0/22]] = 0) do={ add list=$AddressList comment=AS41678 address=194.46.116.0/22 }
:if ([:len [find where list=$AddressList and address=194.46.12.0/22]] = 0) do={ add list=$AddressList comment=AS41678 address=194.46.12.0/22 }
...
:if ([:len [find where list=$AddressList and address=194.46.16.0/20]] = 0) do={ add list=$AddressList comment=AS41678 address=194.46.16.0/20 }
