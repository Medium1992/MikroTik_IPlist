...
:do {add list=$AddressList comment=AS41719 address=for_scripts/asnv4/AS41719.rsc} on-error {}
...
:do {add list=$AddressList comment=AS41719 address=194.190.69.0/24} on-error {}
