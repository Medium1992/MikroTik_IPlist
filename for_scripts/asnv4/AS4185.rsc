...
:if ([:len [find where list=$AddressList and address=165.110.0.0/17]] = 0) do={ add list=$AddressList comment=AS4185 address=165.110.0.0/17 }
:if ([:len [find where list=$AddressList and address=165.110.128.0/18]] = 0) do={ add list=$AddressList comment=AS4185 address=165.110.128.0/18 }
:if ([:len [find where list=$AddressList and address=165.110.192.0/23]] = 0) do={ add list=$AddressList comment=AS4185 address=165.110.192.0/23 }
:if ([:len [find where list=$AddressList and address=165.110.196.0/22]] = 0) do={ add list=$AddressList comment=AS4185 address=165.110.196.0/22 }
:if ([:len [find where list=$AddressList and address=165.110.200.0/21]] = 0) do={ add list=$AddressList comment=AS4185 address=165.110.200.0/21 }
:if ([:len [find where list=$AddressList and address=165.110.208.0/20]] = 0) do={ add list=$AddressList comment=AS4185 address=165.110.208.0/20 }
:if ([:len [find where list=$AddressList and address=165.110.224.0/19]] = 0) do={ add list=$AddressList comment=AS4185 address=165.110.224.0/19 }
