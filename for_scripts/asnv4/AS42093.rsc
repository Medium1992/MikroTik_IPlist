...
:do {add list=$AddressList comment=AS42093 address=195.253.199.0/24} on-error {}
:do {add list=$AddressList comment=AS42093 address=195.253.241.0/24} on-error {}
:do {add list=$AddressList comment=AS42093 address=213.232.253.0/24} on-error {}
:do {add list=$AddressList comment=AS42093 address=217.170.4.0/22} on-error {}
:do {add list=$AddressList comment=AS42093 address=37.72.108.0/24} on-error {}
:do {add list=$AddressList comment=AS42093 address=91.205.192.0/24} on-error {}
:do {add list=$AddressList comment=AS42093 address=91.224.242.0/23} on-error {}
:do {add list=$AddressList comment=AS42093 address=93.190.185.0/24} on-error {}
