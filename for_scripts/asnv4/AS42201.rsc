...
:do {add list=$AddressList comment=AS42201 address=193.104.211.0/24} on-error {}
:do {add list=$AddressList comment=AS42201 address=193.104.222.0/24} on-error {}
:do {add list=$AddressList comment=AS42201 address=193.181.35.0/24} on-error {}
:do {add list=$AddressList comment=AS42201 address=194.132.123.0/24} on-error {}
:do {add list=$AddressList comment=AS42201 address=45.130.84.0/22} on-error {}
:do {add list=$AddressList comment=AS42201 address=45.148.4.0/22} on-error {}
