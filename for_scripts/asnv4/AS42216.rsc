...
:do {add list=$AddressList comment=AS42216 address=for_scripts/asnv4/AS42216.rsc} on-error {}
:do {add list=$AddressList comment=AS42216 address=185.165.76.0/24} on-error {}
:do {add list=$AddressList comment=AS42216 address=185.17.113.0/24} on-error {}
:do {add list=$AddressList comment=AS42216 address=185.17.114.0/24} on-error {}
:do {add list=$AddressList comment=AS42216 address=185.17.136.0/24} on-error {}
