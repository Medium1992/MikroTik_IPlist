...
:do {add list=$AddressList comment=AS42316 address=for_scripts/asnv4/AS42316.rsc} on-error {}
...
:do {add list=$AddressList comment=AS42316 address=185.187.163.0/24} on-error {}
