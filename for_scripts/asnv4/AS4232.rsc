...
:do {add list=$AddressList comment=AS4232 address=for_scripts/asnv4/AS4232.rsc} on-error {}
...
:do {add list=$AddressList comment=AS4232 address=206.81.239.0/24} on-error {}
