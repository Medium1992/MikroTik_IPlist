...
:do {add list=$AddressList comment=AS42334 address=for_scripts/asnv4/AS42334.rsc} on-error {}
:do {add list=$AddressList comment=AS42334 address=185.114.252.0/22} on-error {}
:do {add list=$AddressList comment=AS42334 address=185.131.36.0/23} on-error {}
:do {add list=$AddressList comment=AS42334 address=185.131.39.0/24} on-error {}
