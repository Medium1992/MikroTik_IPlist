...
:if ([:len [find where list=$AddressList and address=95.38.140.0/24]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.140.0/24 }
:if ([:len [find where list=$AddressList and address=95.38.142.0/23]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.142.0/23 }
:if ([:len [find where list=$AddressList and address=95.38.153.0/24]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.153.0/24 }
:if ([:len [find where list=$AddressList and address=95.38.155.0/24]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.155.0/24 }
:if ([:len [find where list=$AddressList and address=95.38.156.0/23]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.156.0/23 }
:if ([:len [find where list=$AddressList and address=95.38.159.0/24]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.159.0/24 }
:if ([:len [find where list=$AddressList and address=95.38.169.0/24]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.169.0/24 }
:if ([:len [find where list=$AddressList and address=95.38.170.0/24]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.170.0/24 }
...
:if ([:len [find where list=$AddressList and address=95.38.200.0/23]] = 0) do={ add list=$AddressList comment=AS42337 address=95.38.200.0/23 }
