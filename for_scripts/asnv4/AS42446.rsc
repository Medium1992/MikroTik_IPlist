...
:do {add list=$AddressList comment=AS42446 address=87.120.91.0/24} on-error {}
:do {add list=$AddressList comment=AS42446 address=91.198.228.0/24} on-error {}
:do {add list=$AddressList comment=AS42446 address=91.199.247.0/24} on-error {}
:do {add list=$AddressList comment=AS42446 address=91.92.232.0/22} on-error {}
:do {add list=$AddressList comment=AS42446 address=93.123.104.0/22} on-error {}
:do {add list=$AddressList comment=AS42446 address=94.156.146.0/23} on-error {}
