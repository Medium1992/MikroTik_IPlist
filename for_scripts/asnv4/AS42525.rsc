...
:do {add list=$AddressList comment=AS42525 address=for_scripts/asnv4/AS42525.rsc} on-error {}
...
:do {add list=$AddressList comment=AS42525 address=46.32.128.0/20} on-error {}
