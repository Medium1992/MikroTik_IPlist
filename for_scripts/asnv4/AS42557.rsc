...
:do {add list=$AddressList comment=AS42557 address=for_scripts/asnv4/AS42557.rsc} on-error {}
...
:do {add list=$AddressList comment=AS42557 address=95.130.120.0/21} on-error {}
