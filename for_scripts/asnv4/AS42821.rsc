...
:if ([:len [find where list=$AddressList and address=213.209.135.0/24]] = 0) do={ add list=$AddressList comment=AS42821 address=213.209.135.0/24 }
...
:if ([:len [find where list=$AddressList and address=213.209.145.0/24]] = 0) do={ add list=$AddressList comment=AS42821 address=213.209.145.0/24 }
...
:if ([:len [find where list=$AddressList and address=77.90.168.0/24]] = 0) do={ add list=$AddressList comment=AS42821 address=77.90.168.0/24 }
