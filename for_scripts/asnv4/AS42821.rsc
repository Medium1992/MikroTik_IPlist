...
:if ([:len [find where list=$AddressList and address=213.209.144.0/24]] = 0) do={ add list=$AddressList comment=AS42821 address=213.209.144.0/24 }
:if ([:len [find where list=$AddressList and address=213.209.156.0/24]] = 0) do={ add list=$AddressList comment=AS42821 address=213.209.156.0/24 }
