...
:do {add list=$AddressList comment=AS42868 address=178.210.161.0/24} on-error {}
:do {add list=$AddressList comment=AS42868 address=178.210.165.0/24} on-error {}
:do {add list=$AddressList comment=AS42868 address=178.210.168.0/24} on-error {}
