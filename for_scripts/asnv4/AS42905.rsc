...
:do {add list=$AddressList comment=AS42905 address=for_scripts/asnv4/AS42905.rsc} on-error {}
:do {add list=$AddressList comment=AS42905 address=141.105.128.0/24} on-error {}
:do {add list=$AddressList comment=AS42905 address=141.105.132.0/22} on-error {}
