...
:do {add list=$AddressList comment=AS42929 address=for_scripts/asnv4/AS42929.rsc} on-error {}
...
:do {add list=$AddressList comment=AS42929 address=195.225.80.0/24} on-error {}
:do {add list=$AddressList comment=AS42929 address=195.8.62.0/24} on-error {}
:do {add list=$AddressList comment=AS42929 address=2.56.80.0/22} on-error {}
