...
:do {add list=$AddressList comment=AS43009 address=131.162.232.0/24} on-error {}
...
:do {add list=$AddressList comment=AS43009 address=81.23.248.0/23} on-error {}
:do {add list=$AddressList comment=AS43009 address=81.23.251.0/24} on-error {}
:do {add list=$AddressList comment=AS43009 address=81.23.252.0/22} on-error {}
...
:do {add list=$AddressList comment=AS43009 address=83.166.88.0/23} on-error {}
