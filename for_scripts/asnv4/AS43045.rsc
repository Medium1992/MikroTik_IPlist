...
:if ([:len [find where list=$AddressList and address=5.182.53.0/24]] = 0) do={ add list=$AddressList comment=AS43045 address=5.182.53.0/24 }
:if ([:len [find where list=$AddressList and address=5.182.54.0/23]] = 0) do={ add list=$AddressList comment=AS43045 address=5.182.54.0/23 }
