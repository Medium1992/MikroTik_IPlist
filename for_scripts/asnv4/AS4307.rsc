...
:if ([:len [find where list=$AddressList and address=216.139.32.0/20]] = 0) do={ add list=$AddressList comment=AS4307 address=216.139.32.0/20 }
:if ([:len [find where list=$AddressList and address=216.139.48.0/21]] = 0) do={ add list=$AddressList comment=AS4307 address=216.139.48.0/21 }
:if ([:len [find where list=$AddressList and address=216.139.56.0/22]] = 0) do={ add list=$AddressList comment=AS4307 address=216.139.56.0/22 }
:if ([:len [find where list=$AddressList and address=216.139.60.0/23]] = 0) do={ add list=$AddressList comment=AS4307 address=216.139.60.0/23 }
:if ([:len [find where list=$AddressList and address=216.139.62.0/24]] = 0) do={ add list=$AddressList comment=AS4307 address=216.139.62.0/24 }
