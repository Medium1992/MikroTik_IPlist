...
:if ([:len [find where list=$AddressList and address=189.74.109.0/24]] = 0) do={ add list=$AddressList comment=AS43278 address=189.74.109.0/24 }
:if ([:len [find where list=$AddressList and address=189.74.110.0/23]] = 0) do={ add list=$AddressList comment=AS43278 address=189.74.110.0/23 }
:if ([:len [find where list=$AddressList and address=201.50.114.0/24]] = 0) do={ add list=$AddressList comment=AS43278 address=201.50.114.0/24 }
