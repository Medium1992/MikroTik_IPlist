...
:do {add list=$AddressList comment=AS43342 address=for_scripts/asnv4/AS43342.rsc} on-error {}
:do {add list=$AddressList comment=AS43342 address=91.135.178.0/23} on-error {}
:do {add list=$AddressList comment=AS43342 address=91.135.180.0/22} on-error {}
