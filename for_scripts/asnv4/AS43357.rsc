...
:do {add list=$AddressList comment=AS43357 address=147.78.240.0/23} on-error {}
:do {add list=$AddressList comment=AS43357 address=176.113.68.0/23} on-error {}
:do {add list=$AddressList comment=AS43357 address=176.119.150.0/24} on-error {}
...
:do {add list=$AddressList comment=AS43357 address=194.127.164.0/23} on-error {}
...
:do {add list=$AddressList comment=AS43357 address=194.36.27.0/24} on-error {}
:do {add list=$AddressList comment=AS43357 address=213.232.112.0/24} on-error {}
...
:do {add list=$AddressList comment=AS43357 address=45.66.219.0/24} on-error {}
:do {add list=$AddressList comment=AS43357 address=80.66.197.0/24} on-error {}
:do {add list=$AddressList comment=AS43357 address=80.66.198.0/24} on-error {}
:do {add list=$AddressList comment=AS43357 address=88.214.21.0/24} on-error {}
