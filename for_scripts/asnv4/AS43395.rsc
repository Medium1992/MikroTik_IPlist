...
:if ([:len [find where list=$AddressList and address=109.68.217.0/24]] = 0) do={ add list=$AddressList comment=AS43395 address=109.68.217.0/24 }
...
:if ([:len [find where list=$AddressList and address=176.101.40.0/21]] = 0) do={ add list=$AddressList comment=AS43395 address=176.101.40.0/21 }
...
:if ([:len [find where list=$AddressList and address=94.127.17.0/24]] = 0) do={ add list=$AddressList comment=AS43395 address=94.127.17.0/24 }
