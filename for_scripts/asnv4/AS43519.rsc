...
:do {add list=$AddressList comment=AS43519 address=213.248.200.0/22} on-error {}
:do {add list=$AddressList comment=AS43519 address=213.248.204.0/23} on-error {}
:do {add list=$AddressList comment=AS43519 address=213.248.216.0/21} on-error {}
:do {add list=$AddressList comment=AS43519 address=213.248.224.0/22} on-error {}
