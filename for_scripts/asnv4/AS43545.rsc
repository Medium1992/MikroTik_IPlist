...
:do {add list=$AddressList comment=AS43545 address=for_scripts/asnv4/AS43545.rsc} on-error {}
:do {add list=$AddressList comment=AS43545 address=185.113.216.0/24} on-error {}
:do {add list=$AddressList comment=AS43545 address=185.113.218.0/23} on-error {}
