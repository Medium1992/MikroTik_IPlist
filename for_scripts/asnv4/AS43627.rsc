...
:do {add list=$AddressList comment=AS43627 address=46.36.64.0/20} on-error {}
:do {add list=$AddressList comment=AS43627 address=46.36.80.0/22} on-error {}
:do {add list=$AddressList comment=AS43627 address=46.36.88.0/21} on-error {}
