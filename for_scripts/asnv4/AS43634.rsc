...
:do {add list=$AddressList comment=AS43634 address=for_scripts/asnv4/AS43634.rsc} on-error {}
:do {add list=$AddressList comment=AS43634 address=194.190.154.0/24} on-error {}
