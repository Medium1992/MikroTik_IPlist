...
:if ([:len [find where list=$AddressList and address=91.147.152.0/23]] = 0) do={ add list=$AddressList comment=AS43775 address=91.147.152.0/23 }
:if ([:len [find where list=$AddressList and address=91.147.154.0/24]] = 0) do={ add list=$AddressList comment=AS43775 address=91.147.154.0/24 }
:if ([:len [find where list=$AddressList and address=91.147.156.0/22]] = 0) do={ add list=$AddressList comment=AS43775 address=91.147.156.0/22 }
