...
:do {add list=$AddressList comment=AS43847 address=for_scripts/asnv4/AS43847.rsc} on-error {}
...
:do {add list=$AddressList comment=AS43847 address=46.182.16.0/22} on-error {}
