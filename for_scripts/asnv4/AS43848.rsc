...
:do {add list=$AddressList comment=AS43848 address=for_scripts/asnv4/AS43848.rsc} on-error {}
...
:do {add list=$AddressList comment=AS43848 address=85.255.145.0/24} on-error {}
