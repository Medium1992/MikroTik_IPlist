...
:do {add list=$AddressList comment=AS43908 address=79.140.240.0/23} on-error {}
:do {add list=$AddressList comment=AS43908 address=79.140.243.0/24} on-error {}
:do {add list=$AddressList comment=AS43908 address=79.140.244.0/22} on-error {}
