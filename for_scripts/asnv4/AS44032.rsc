...
:if ([:len [find where list=$AddressList and address=81.162.244.0/23]] = 0) do={ add list=$AddressList comment=AS44032 address=81.162.244.0/23 }
:if ([:len [find where list=$AddressList and address=81.162.247.0/24]] = 0) do={ add list=$AddressList comment=AS44032 address=81.162.247.0/24 }
