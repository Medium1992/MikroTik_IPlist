...
:do {add list=$AddressList comment=AS44094 address=138.124.107.0/24} on-error {}
:do {add list=$AddressList comment=AS44094 address=185.179.188.0/22} on-error {}
:do {add list=$AddressList comment=AS44094 address=212.102.107.0/24} on-error {}
:do {add list=$AddressList comment=AS44094 address=45.155.52.0/23} on-error {}
