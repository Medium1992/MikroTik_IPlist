...
:do {add list=$AddressList comment=AS44285 address=37.32.32.0/21} on-error {}
...
:do {add list=$AddressList comment=AS44285 address=45.140.224.0/21} on-error {}
:do {add list=$AddressList comment=AS44285 address=45.156.180.0/22} on-error {}
:do {add list=$AddressList comment=AS44285 address=45.156.192.0/22} on-error {}
...
:do {add list=$AddressList comment=AS44285 address=85.198.48.0/20} on-error {}
