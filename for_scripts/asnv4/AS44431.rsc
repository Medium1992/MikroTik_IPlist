...
:do {add list=$AddressList comment=AS44431 address=193.220.224.0/20} on-error {}
:do {add list=$AddressList comment=AS44431 address=204.8.41.0/24} on-error {}
:do {add list=$AddressList comment=AS44431 address=216.9.228.0/23} on-error {}
:do {add list=$AddressList comment=AS44431 address=38.105.15.0/24} on-error {}
:do {add list=$AddressList comment=AS44431 address=77.70.176.0/22} on-error {}
:do {add list=$AddressList comment=AS44431 address=77.70.181.0/24} on-error {}
:do {add list=$AddressList comment=AS44431 address=77.70.184.0/21} on-error {}
