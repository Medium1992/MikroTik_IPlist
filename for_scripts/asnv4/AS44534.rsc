...
:if ([:len [find where list=$AddressList and address=93.158.168.0/23]] = 0) do={ add list=$AddressList comment=AS44534 address=93.158.168.0/23 }
:if ([:len [find where list=$AddressList and address=93.158.170.0/24]] = 0) do={ add list=$AddressList comment=AS44534 address=93.158.170.0/24 }
