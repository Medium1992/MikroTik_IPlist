...
:if ([:len [find where list=$AddressList and address=45.133.39.0/24]] = 0) do={ add list=$AddressList comment=AS44547 address=45.133.39.0/24 }
:if ([:len [find where list=$AddressList and address=45.141.149.0/24]] = 0) do={ add list=$AddressList comment=AS44547 address=45.141.149.0/24 }
