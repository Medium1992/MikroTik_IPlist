...
:if ([:len [find where list=$AddressList and address=188.124.10.0/23]] = 0) do={ add list=$AddressList comment=AS44565 address=188.124.10.0/23 }
:if ([:len [find where list=$AddressList and address=188.124.12.0/22]] = 0) do={ add list=$AddressList comment=AS44565 address=188.124.12.0/22 }
...
:if ([:len [find where list=$AddressList and address=188.124.8.0/24]] = 0) do={ add list=$AddressList comment=AS44565 address=188.124.8.0/24 }
