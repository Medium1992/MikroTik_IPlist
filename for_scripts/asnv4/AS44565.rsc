...
:do {add list=$AddressList comment=AS44565 address=188.124.10.0/23} on-error {}
:do {add list=$AddressList comment=AS44565 address=188.124.12.0/22} on-error {}
:do {add list=$AddressList comment=AS44565 address=188.124.16.0/24} on-error {}
:do {add list=$AddressList comment=AS44565 address=188.124.19.0/24} on-error {}
:do {add list=$AddressList comment=AS44565 address=188.124.21.0/24} on-error {}
:do {add list=$AddressList comment=AS44565 address=188.124.23.0/24} on-error {}
:do {add list=$AddressList comment=AS44565 address=188.124.24.0/24} on-error {}
:do {add list=$AddressList comment=AS44565 address=188.124.26.0/23} on-error {}
...
:do {add list=$AddressList comment=AS44565 address=188.124.9.0/24} on-error {}
...
:do {add list=$AddressList comment=AS44565 address=93.186.115.0/24} on-error {}
:do {add list=$AddressList comment=AS44565 address=93.186.116.0/22} on-error {}
:do {add list=$AddressList comment=AS44565 address=93.186.120.0/23} on-error {}
:do {add list=$AddressList comment=AS44565 address=93.186.123.0/24} on-error {}
