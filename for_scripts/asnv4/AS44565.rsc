...
:do {add list=$AddressList comment=AS44565 address=for_scripts/asnv4/AS44565.rsc} on-error {}
...
:do {add list=$AddressList comment=AS44565 address=93.186.122.0/24} on-error {}
