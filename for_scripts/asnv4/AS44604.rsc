...
:do {add list=$AddressList comment=AS44604 address=for_scripts/asnv4/AS44604.rsc} on-error {}
...
:do {add list=$AddressList comment=AS44604 address=185.33.161.0/24} on-error {}
:do {add list=$AddressList comment=AS44604 address=31.210.223.0/24} on-error {}
...
:do {add list=$AddressList comment=AS44604 address=5.187.85.0/24} on-error {}
:do {add list=$AddressList comment=AS44604 address=5.187.86.0/23} on-error {}
:do {add list=$AddressList comment=AS44604 address=5.187.88.0/24} on-error {}
