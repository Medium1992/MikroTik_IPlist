...
:do {add list=$AddressList comment=AS44724 address=95.154.112.0/21} on-error {}
:do {add list=$AddressList comment=AS44724 address=95.154.121.0/24} on-error {}
:do {add list=$AddressList comment=AS44724 address=95.154.122.0/23} on-error {}
