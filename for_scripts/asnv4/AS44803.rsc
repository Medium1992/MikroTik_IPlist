...
:do {add list=$AddressList comment=AS44803 address=193.182.135.0/24} on-error {}
:do {add list=$AddressList comment=AS44803 address=193.182.136.0/22} on-error {}
:do {add list=$AddressList comment=AS44803 address=193.182.140.0/24} on-error {}
