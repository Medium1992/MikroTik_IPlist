...
:if ([:len [find where list=$AddressList and address=31.13.224.0/24]] = 0) do={ add list=$AddressList comment=AS44828 address=31.13.224.0/24 }
...
:if ([:len [find where list=$AddressList and address=87.121.220.0/24]] = 0) do={ add list=$AddressList comment=AS44828 address=87.121.220.0/24 }
