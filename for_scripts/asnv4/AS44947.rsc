...
:if ([:len [find where list=$AddressList and address=213.176.20.0/22]] = 0) do={ add list=$AddressList comment=AS44947 address=213.176.20.0/22 }
:if ([:len [find where list=$AddressList and address=213.176.68.0/22]] = 0) do={ add list=$AddressList comment=AS44947 address=213.176.68.0/22 }
:if ([:len [find where list=$AddressList and address=213.176.88.0/22]] = 0) do={ add list=$AddressList comment=AS44947 address=213.176.88.0/22 }
...
:if ([:len [find where list=$AddressList and address=91.195.37.0/24]] = 0) do={ add list=$AddressList comment=AS44947 address=91.195.37.0/24 }
