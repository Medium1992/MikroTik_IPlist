...
:do {add list=$AddressList comment=AS44947 address=for_scripts/asnv4/AS44947.rsc} on-error {}
...
:do {add list=$AddressList comment=AS44947 address=212.108.124.0/24} on-error {}
