...
:do {add list=$AddressList comment=AS4503 address=138.33.71.0/24} on-error {}
:do {add list=$AddressList comment=AS4503 address=138.33.72.0/24} on-error {}
:do {add list=$AddressList comment=AS4503 address=138.33.90.0/24} on-error {}
:do {add list=$AddressList comment=AS4503 address=138.33.99.0/24} on-error {}
