...
:do {add list=$AddressList comment=AS45305 address=103.100.180.0/23} on-error {}
:do {add list=$AddressList comment=AS45305 address=103.100.182.0/24} on-error {}
:do {add list=$AddressList comment=AS45305 address=103.114.52.0/24} on-error {}
...
:do {add list=$AddressList comment=AS45305 address=103.251.153.0/24} on-error {}
