...
:do {add list=$AddressList comment=AS45325 address=for_scripts/asnv4/AS45325.rsc} on-error {}
:do {add list=$AddressList comment=AS45325 address=103.149.180.0/24} on-error {}
:do {add list=$AddressList comment=AS45325 address=103.169.206.0/23} on-error {}
