...
:do {add list=$AddressList comment=AS45345 address=for_scripts/asnv4/AS45345.rsc} on-error {}
:do {add list=$AddressList comment=AS45345 address=103.2.184.0/22} on-error {}
:do {add list=$AddressList comment=AS45345 address=103.29.152.0/22} on-error {}
