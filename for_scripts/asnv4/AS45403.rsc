...
:do {add list=$AddressList comment=AS45403 address=112.171.144.0/24} on-error {}
:do {add list=$AddressList comment=AS45403 address=112.171.146.0/23} on-error {}
:do {add list=$AddressList comment=AS45403 address=112.171.148.0/22} on-error {}
