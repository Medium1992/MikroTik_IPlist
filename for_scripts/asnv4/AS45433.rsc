...
:do {add list=$AddressList comment=AS45433 address=103.58.248.0/24} on-error {}
:do {add list=$AddressList comment=AS45433 address=103.58.251.0/24} on-error {}
...
:do {add list=$AddressList comment=AS45433 address=45.118.204.0/24} on-error {}
:do {add list=$AddressList comment=AS45433 address=45.118.206.0/23} on-error {}
...
:do {add list=$AddressList comment=AS45433 address=45.64.176.0/24} on-error {}
