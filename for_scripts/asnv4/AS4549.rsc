...
:do {add list=$AddressList comment=AS4549 address=for_scripts/asnv4/AS4549.rsc} on-error {}
...
:do {add list=$AddressList comment=AS4549 address=45.63.192.0/23} on-error {}
:do {add list=$AddressList comment=AS4549 address=45.63.195.0/24} on-error {}
