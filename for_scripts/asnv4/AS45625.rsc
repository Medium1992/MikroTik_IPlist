...
:do {add list=$AddressList comment=AS45625 address=for_scripts/asnv4/AS45625.rsc} on-error {}
...
:do {add list=$AddressList comment=AS45625 address=112.121.56.0/22} on-error {}
