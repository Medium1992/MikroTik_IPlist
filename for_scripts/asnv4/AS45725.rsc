...
:do {add list=$AddressList comment=AS45725 address=180.211.88.0/22} on-error {}
:do {add list=$AddressList comment=AS45725 address=180.211.92.0/23} on-error {}
:do {add list=$AddressList comment=AS45725 address=180.211.94.0/24} on-error {}
