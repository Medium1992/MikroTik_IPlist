...
:do {add list=$AddressList comment=AS45806 address=for_scripts/asnv4/AS45806.rsc} on-error {}
...
:do {add list=$AddressList comment=AS45806 address=171.102.56.0/24} on-error {}
