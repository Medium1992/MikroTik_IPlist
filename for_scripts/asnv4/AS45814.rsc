...
:if ([:len [find where list=$AddressList and address=103.20.133.0/24]] = 0) do={ add list=$AddressList comment=AS45814 address=103.20.133.0/24 }
:if ([:len [find where list=$AddressList and address=14.192.128.0/23]] = 0) do={ add list=$AddressList comment=AS45814 address=14.192.128.0/23 }
...
:if ([:len [find where list=$AddressList and address=14.192.159.0/24]] = 0) do={ add list=$AddressList comment=AS45814 address=14.192.159.0/24 }
