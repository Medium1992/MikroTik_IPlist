...
:if ([:len [find where list=$AddressList and address=5.175.216.0/24]] = 0) do={ add list=$AddressList comment=AS45815 address=5.175.216.0/24 }
:if ([:len [find where list=$AddressList and address=89.106.69.0/24]] = 0) do={ add list=$AddressList comment=AS45815 address=89.106.69.0/24 }
:if ([:len [find where list=$AddressList and address=94.103.163.0/24]] = 0) do={ add list=$AddressList comment=AS45815 address=94.103.163.0/24 }
:if ([:len [find where list=$AddressList and address=94.249.213.0/24]] = 0) do={ add list=$AddressList comment=AS45815 address=94.249.213.0/24 }
