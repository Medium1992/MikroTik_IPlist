...
:do {add list=$AddressList comment=AS45839 address=124.217.233.0/24} on-error {}
:do {add list=$AddressList comment=AS45839 address=124.217.234.0/23} on-error {}
...
:do {add list=$AddressList comment=AS45839 address=38.133.213.0/24} on-error {}
:do {add list=$AddressList comment=AS45839 address=38.134.3.0/24} on-error {}
