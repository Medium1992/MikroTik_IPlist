...
:do {add list=$AddressList comment=AS45896 address=for_scripts/asnv4/AS45896.rsc} on-error {}
:do {add list=$AddressList comment=AS45896 address=103.19.164.0/22} on-error {}
:do {add list=$AddressList comment=AS45896 address=103.237.64.0/24} on-error {}
