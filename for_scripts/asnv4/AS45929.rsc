...
:do {add list=$AddressList comment=AS45929 address=136.144.24.0/24} on-error {}
:do {add list=$AddressList comment=AS45929 address=185.184.132.0/23} on-error {}
:do {add list=$AddressList comment=AS45929 address=185.205.188.0/24} on-error {}
...
:do {add list=$AddressList comment=AS45929 address=45.132.120.0/22} on-error {}
:do {add list=$AddressList comment=AS45929 address=45.143.52.0/24} on-error {}
:do {add list=$AddressList comment=AS45929 address=45.143.55.0/24} on-error {}
:do {add list=$AddressList comment=AS45929 address=45.149.192.0/22} on-error {}
:do {add list=$AddressList comment=AS45929 address=45.159.244.0/23} on-error {}
...
:do {add list=$AddressList comment=AS45929 address=84.247.24.0/24} on-error {}
:do {add list=$AddressList comment=AS45929 address=84.247.27.0/24} on-error {}
:do {add list=$AddressList comment=AS45929 address=91.188.204.0/22} on-error {}
:do {add list=$AddressList comment=AS45929 address=94.103.248.0/24} on-error {}
:do {add list=$AddressList comment=AS45929 address=94.103.251.0/24} on-error {}
