...
:do {add list=$AddressList comment=AS46082 address=147.68.0.0/23} on-error {}
:do {add list=$AddressList comment=AS46082 address=147.68.112.0/20} on-error {}
:do {add list=$AddressList comment=AS46082 address=147.68.8.0/24} on-error {}
...
:do {add list=$AddressList comment=AS46082 address=159.26.94.0/23} on-error {}
