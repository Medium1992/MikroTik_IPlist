...
:if ([:len [find where list=$AddressList and address=147.68.0.0/24]] = 0) do={ add list=$AddressList comment=AS46082 address=147.68.0.0/24 }
...
:if ([:len [find where list=$AddressList and address=159.26.88.0/23]] = 0) do={ add list=$AddressList comment=AS46082 address=159.26.88.0/23 }
