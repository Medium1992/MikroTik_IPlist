...
:if ([:len [find where list=$AddressList and address=185.87.59.0/24]] = 0) do={ add list=$AddressList comment=AS46370 address=185.87.59.0/24 }
:if ([:len [find where list=$AddressList and address=193.24.4.0/24]] = 0) do={ add list=$AddressList comment=AS46370 address=193.24.4.0/24 }
:if ([:len [find where list=$AddressList and address=212.134.255.0/24]] = 0) do={ add list=$AddressList comment=AS46370 address=212.134.255.0/24 }
...
:if ([:len [find where list=$AddressList and address=83.150.216.0/24]] = 0) do={ add list=$AddressList comment=AS46370 address=83.150.216.0/24 }
