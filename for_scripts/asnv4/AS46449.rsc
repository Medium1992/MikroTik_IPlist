...
:do {add list=$AddressList comment=AS46449 address=for_scripts/asnv4/AS46449.rsc} on-error {}
:do {add list=$AddressList comment=AS46449 address=199.102.72.0/22} on-error {}
