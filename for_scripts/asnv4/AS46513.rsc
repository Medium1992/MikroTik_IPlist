...
:do {add list=$AddressList comment=AS46513 address=156.45.229.0/24} on-error {}
:do {add list=$AddressList comment=AS46513 address=156.45.230.0/23} on-error {}
:do {add list=$AddressList comment=AS46513 address=156.45.237.0/24} on-error {}
:do {add list=$AddressList comment=AS46513 address=156.45.238.0/23} on-error {}
