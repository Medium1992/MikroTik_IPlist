...
:do {add list=$AddressList comment=AS46595 address=for_scripts/asnv4/AS46595.rsc} on-error {}
:do {add list=$AddressList comment=AS46595 address=104.37.76.0/23} on-error {}
