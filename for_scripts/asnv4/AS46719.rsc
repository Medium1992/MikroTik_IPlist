...
:do {add list=$AddressList comment=AS46719 address=for_scripts/asnv4/AS46719.rsc} on-error {}
...
:do {add list=$AddressList comment=AS46719 address=204.154.240.0/21} on-error {}
