...
:do {add list=$AddressList comment=AS46783 address=38.64.60.0/24} on-error {}
:do {add list=$AddressList comment=AS46783 address=38.65.88.0/22} on-error {}
:do {add list=$AddressList comment=AS46783 address=38.65.92.0/23} on-error {}
