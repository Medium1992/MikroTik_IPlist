...
:do {add list=$AddressList comment=AS46783 address=38.57.234.0/24} on-error {}
:do {add list=$AddressList comment=AS46783 address=38.64.56.0/21} on-error {}
:do {add list=$AddressList comment=AS46783 address=38.65.88.0/24} on-error {}
:do {add list=$AddressList comment=AS46783 address=38.65.90.0/23} on-error {}
:do {add list=$AddressList comment=AS46783 address=38.65.92.0/22} on-error {}
:do {add list=$AddressList comment=AS46783 address=38.71.18.0/24} on-error {}
:do {add list=$AddressList comment=AS46783 address=50.118.184.0/24} on-error {}
