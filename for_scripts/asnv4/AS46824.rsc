...
:do {add list=$AddressList comment=AS46824 address=for_scripts/asnv4/AS46824.rsc} on-error {}
:do {add list=$AddressList comment=AS46824 address=162.244.92.0/23} on-error {}
