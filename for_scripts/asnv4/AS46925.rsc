...
:if ([:len [find where list=$AddressList and address=153.33.175.0/24]] = 0) do={ add list=$AddressList comment=AS46925 address=153.33.175.0/24 }
:if ([:len [find where list=$AddressList and address=153.33.200.0/24]] = 0) do={ add list=$AddressList comment=AS46925 address=153.33.200.0/24 }
