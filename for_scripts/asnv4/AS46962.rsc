...
:do {add list=$AddressList comment=AS46962 address=for_scripts/asnv4/AS46962.rsc} on-error {}
...
:do {add list=$AddressList comment=AS46962 address=64.93.68.0/22} on-error {}
