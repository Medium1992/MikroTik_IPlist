...
:if ([:len [find where list=$AddressList and address=64.93.69.0/24]] = 0) do={ add list=$AddressList comment=AS46962 address=64.93.69.0/24 }
:if ([:len [find where list=$AddressList and address=64.93.70.0/23]] = 0) do={ add list=$AddressList comment=AS46962 address=64.93.70.0/23 }
