...
:if ([:len [find where list=$AddressList and address=142.249.200.0/23]] = 0) do={ add list=$AddressList comment=AS46998 address=142.249.200.0/23 }
:if ([:len [find where list=$AddressList and address=142.249.203.0/24]] = 0) do={ add list=$AddressList comment=AS46998 address=142.249.203.0/24 }
