...
:if ([:len [find where list=$AddressList and address=138.185.228.0/24]] = 0) do={ add list=$AddressList comment=AS47065 address=138.185.228.0/24 }
:if ([:len [find where list=$AddressList and address=184.164.232.0/23]] = 0) do={ add list=$AddressList comment=AS47065 address=184.164.232.0/23 }
...
:if ([:len [find where list=$AddressList and address=184.164.238.0/23]] = 0) do={ add list=$AddressList comment=AS47065 address=184.164.238.0/23 }
...
:if ([:len [find where list=$AddressList and address=204.9.170.0/23]] = 0) do={ add list=$AddressList comment=AS47065 address=204.9.170.0/23 }
