...
:do {add list=$AddressList comment=AS47143 address=178.214.96.0/22} on-error {}
...
:do {add list=$AddressList comment=AS47143 address=91.205.96.0/23} on-error {}
:do {add list=$AddressList comment=AS47143 address=91.205.99.0/24} on-error {}
