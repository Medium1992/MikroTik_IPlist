...
:do {add list=$AddressList comment=AS47160 address=for_scripts/asnv4/AS47160.rsc} on-error {}
...
:do {add list=$AddressList comment=AS47160 address=45.112.120.0/23} on-error {}
