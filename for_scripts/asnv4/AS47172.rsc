...
:if ([:len [find where list=$AddressList and address=212.102.113.0/24]] = 0) do={ add list=$AddressList comment=AS47172 address=212.102.113.0/24 }
...
:if ([:len [find where list=$AddressList and address=82.163.16.0/24]] = 0) do={ add list=$AddressList comment=AS47172 address=82.163.16.0/24 }
...
:if ([:len [find where list=$AddressList and address=87.76.150.0/24]] = 0) do={ add list=$AddressList comment=AS47172 address=87.76.150.0/24 }
