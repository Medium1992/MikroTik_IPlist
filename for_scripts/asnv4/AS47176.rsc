...
:if ([:len [find where list=$AddressList and address=185.238.12.0/24]] = 0) do={ add list=$AddressList comment=AS47176 address=185.238.12.0/24 }
:if ([:len [find where list=$AddressList and address=185.238.14.0/23]] = 0) do={ add list=$AddressList comment=AS47176 address=185.238.14.0/23 }
