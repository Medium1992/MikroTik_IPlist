...
:do {add list=$AddressList comment=AS47232 address=for_scripts/asnv4/AS47232.rsc} on-error {}
:do {add list=$AddressList comment=AS47232 address=147.161.28.0/22} on-error {}
...
:do {add list=$AddressList comment=AS47232 address=91.192.32.0/22} on-error {}
