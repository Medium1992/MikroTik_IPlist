...
:do {add list=$AddressList comment=AS47242 address=185.73.136.0/24} on-error {}
:do {add list=$AddressList comment=AS47242 address=185.73.138.0/23} on-error {}
...
:do {add list=$AddressList comment=AS47242 address=82.119.36.0/24} on-error {}
