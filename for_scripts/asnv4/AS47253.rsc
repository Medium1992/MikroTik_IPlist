...
:do {add list=$AddressList comment=AS47253 address=for_scripts/asnv4/AS47253.rsc} on-error {}
...
:do {add list=$AddressList comment=AS47253 address=194.58.72.0/22} on-error {}
