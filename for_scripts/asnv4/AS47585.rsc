...
:do {add list=$AddressList comment=AS47585 address=for_scripts/asnv4/AS47585.rsc} on-error {}
:do {add list=$AddressList comment=AS47585 address=185.7.241.0/24} on-error {}
