...
:do {add list=$AddressList comment=AS47586 address=109.235.184.0/22} on-error {}
:do {add list=$AddressList comment=AS47586 address=109.235.188.0/23} on-error {}
:do {add list=$AddressList comment=AS47586 address=109.235.190.0/24} on-error {}
...
:do {add list=$AddressList comment=AS47586 address=185.30.116.0/23} on-error {}
