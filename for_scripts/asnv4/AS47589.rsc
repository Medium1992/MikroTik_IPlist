...
:do {add list=$AddressList comment=AS47589 address=62.150.119.0/24} on-error {}
...
:do {add list=$AddressList comment=AS47589 address=62.150.52.0/24} on-error {}
:do {add list=$AddressList comment=AS47589 address=62.150.56.0/24} on-error {}
:do {add list=$AddressList comment=AS47589 address=62.150.92.0/24} on-error {}
