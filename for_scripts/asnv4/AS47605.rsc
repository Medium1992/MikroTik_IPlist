...
:do {add list=$AddressList comment=AS47605 address=for_scripts/asnv4/AS47605.rsc} on-error {}
...
:do {add list=$AddressList comment=AS47605 address=85.194.234.0/23} on-error {}
