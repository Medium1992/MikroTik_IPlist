...
:do {add list=$AddressList comment=AS47629 address=for_scripts/asnv4/AS47629.rsc} on-error {}
...
:do {add list=$AddressList comment=AS47629 address=87.229.70.0/24} on-error {}
