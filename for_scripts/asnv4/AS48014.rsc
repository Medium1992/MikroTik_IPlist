...
:if ([:len [find where list=$AddressList and address=143.20.47.0/24]] = 0) do={ add list=$AddressList comment=AS48014 address=143.20.47.0/24 }
...
:if ([:len [find where list=$AddressList and address=87.121.61.0/24]] = 0) do={ add list=$AddressList comment=AS48014 address=87.121.61.0/24 }
