...
:do {add list=$AddressList comment=AS48112 address=for_scripts/asnv4/AS48112.rsc} on-error {}
:do {add list=$AddressList comment=AS48112 address=185.173.16.0/23} on-error {}
