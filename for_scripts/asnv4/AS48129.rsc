...
:if ([:len [find where list=$AddressList and address=81.30.112.0/21]] = 0) do={ add list=$AddressList comment=AS48129 address=81.30.112.0/21 }
:if ([:len [find where list=$AddressList and address=81.30.123.0/24]] = 0) do={ add list=$AddressList comment=AS48129 address=81.30.123.0/24 }
