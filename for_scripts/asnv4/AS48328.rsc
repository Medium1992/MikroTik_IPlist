...
:do {add list=$AddressList comment=AS48328 address=for_scripts/asnv4/AS48328.rsc} on-error {}
...
:do {add list=$AddressList comment=AS48328 address=185.236.172.0/23} on-error {}
