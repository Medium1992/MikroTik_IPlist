...
:do {add list=$AddressList comment=AS48330 address=78.158.201.0/24} on-error {}
:do {add list=$AddressList comment=AS48330 address=78.158.202.0/23} on-error {}
:do {add list=$AddressList comment=AS48330 address=78.158.204.0/22} on-error {}
