...
:do {add list=$AddressList comment=AS48407 address=81.90.20.0/24} on-error {}
:do {add list=$AddressList comment=AS48407 address=81.90.23.0/24} on-error {}
...
:do {add list=$AddressList comment=AS48407 address=93.94.55.0/24} on-error {}
