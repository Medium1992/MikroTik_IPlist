...
:do {add list=$AddressList comment=AS48452 address=for_scripts/asnv4/AS48452.rsc} on-error {}
...
:do {add list=$AddressList comment=AS48452 address=94.26.106.0/23} on-error {}
:do {add list=$AddressList comment=AS48452 address=94.26.2.0/24} on-error {}
:do {add list=$AddressList comment=AS48452 address=94.26.33.0/24} on-error {}
:do {add list=$AddressList comment=AS48452 address=94.26.34.0/24} on-error {}
...
:do {add list=$AddressList comment=AS48452 address=94.26.68.0/24} on-error {}
:do {add list=$AddressList comment=AS48452 address=94.26.70.0/23} on-error {}
