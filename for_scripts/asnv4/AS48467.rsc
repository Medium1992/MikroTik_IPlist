...
:do {add list=$AddressList comment=AS48467 address=178.236.246.0/23} on-error {}
:do {add list=$AddressList comment=AS48467 address=178.236.248.0/23} on-error {}
:do {add list=$AddressList comment=AS48467 address=178.236.251.0/24} on-error {}
...
:do {add list=$AddressList comment=AS48467 address=94.228.169.0/24} on-error {}
:do {add list=$AddressList comment=AS48467 address=94.228.170.0/23} on-error {}
