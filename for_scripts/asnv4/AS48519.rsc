...
:do {add list=$AddressList comment=AS48519 address=for_scripts/asnv4/AS48519.rsc} on-error {}
:do {add list=$AddressList comment=AS48519 address=185.119.136.0/23} on-error {}
:do {add list=$AddressList comment=AS48519 address=185.95.96.0/23} on-error {}
