...
:do {add list=$AddressList comment=AS48803 address=for_scripts/asnv4/AS48803.rsc} on-error {}
...
:do {add list=$AddressList comment=AS48803 address=193.183.194.0/23} on-error {}
:do {add list=$AddressList comment=AS48803 address=193.183.212.0/23} on-error {}
:do {add list=$AddressList comment=AS48803 address=193.183.215.0/24} on-error {}
:do {add list=$AddressList comment=AS48803 address=193.183.250.0/23} on-error {}
:do {add list=$AddressList comment=AS48803 address=193.234.108.0/23} on-error {}
:do {add list=$AddressList comment=AS48803 address=193.234.111.0/24} on-error {}
