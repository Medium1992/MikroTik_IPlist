...
:do {add list=$AddressList comment=AS48832 address=176.28.129.0/24} on-error {}
:do {add list=$AddressList comment=AS48832 address=176.28.130.0/23} on-error {}
:do {add list=$AddressList comment=AS48832 address=176.28.132.0/22} on-error {}
:do {add list=$AddressList comment=AS48832 address=176.28.136.0/21} on-error {}
:do {add list=$AddressList comment=AS48832 address=176.28.144.0/20} on-error {}
:do {add list=$AddressList comment=AS48832 address=176.28.160.0/19} on-error {}
:do {add list=$AddressList comment=AS48832 address=176.28.192.0/18} on-error {}
