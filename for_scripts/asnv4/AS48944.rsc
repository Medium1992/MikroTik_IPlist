...
:do {add list=$AddressList comment=AS48944 address=for_scripts/asnv4/AS48944.rsc} on-error {}
...
:do {add list=$AddressList comment=AS48944 address=91.232.72.0/24} on-error {}
