...
:do {add list=$AddressList comment=AS48944 address=185.11.179.0/24} on-error {}
:do {add list=$AddressList comment=AS48944 address=185.193.208.0/22} on-error {}
:do {add list=$AddressList comment=AS48944 address=185.214.36.0/23} on-error {}
:do {add list=$AddressList comment=AS48944 address=185.214.38.0/24} on-error {}
