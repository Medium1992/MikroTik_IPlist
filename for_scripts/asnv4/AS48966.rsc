...
:if ([:len [find where list=$AddressList and address=185.88.80.0/22]] = 0) do={ add list=$AddressList comment=AS48966 address=185.88.80.0/22 }
...
:if ([:len [find where list=$AddressList and address=95.130.91.0/24]] = 0) do={ add list=$AddressList comment=AS48966 address=95.130.91.0/24 }
