...
:do {add list=$AddressList comment=AS49091 address=for_scripts/asnv4/AS49091.rsc} on-error {}
...
:do {add list=$AddressList comment=AS49091 address=217.21.39.0/24} on-error {}
