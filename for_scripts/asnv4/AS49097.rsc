...
:do {add list=$AddressList comment=AS49097 address=31.3.144.0/22} on-error {}
:do {add list=$AddressList comment=AS49097 address=31.3.150.0/23} on-error {}
:do {add list=$AddressList comment=AS49097 address=80.70.167.0/24} on-error {}
:do {add list=$AddressList comment=AS49097 address=80.70.170.0/23} on-error {}
