...
:do {add list=$AddressList comment=AS49102 address=83.175.128.0/24} on-error {}
...
:do {add list=$AddressList comment=AS49102 address=93.159.176.0/24} on-error {}
:do {add list=$AddressList comment=AS49102 address=93.159.180.0/23} on-error {}
:do {add list=$AddressList comment=AS49102 address=93.159.182.0/24} on-error {}
:do {add list=$AddressList comment=AS49102 address=93.159.185.0/24} on-error {}
