...
:do {add list=$AddressList comment=AS49103 address=for_scripts/asnv4/AS49103.rsc} on-error {}
...
:do {add list=$AddressList comment=AS49103 address=45.156.198.0/23} on-error {}
