...
:do {add list=$AddressList comment=AS49304 address=140.235.10.0/23} on-error {}
...
:do {add list=$AddressList comment=AS49304 address=217.217.32.0/23} on-error {}
:do {add list=$AddressList comment=AS49304 address=217.217.34.0/24} on-error {}
