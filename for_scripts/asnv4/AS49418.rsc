...
:do {add list=$AddressList comment=AS49418 address=for_scripts/asnv4/AS49418.rsc} on-error {}
...
:do {add list=$AddressList comment=AS49418 address=64.188.72.0/24} on-error {}
