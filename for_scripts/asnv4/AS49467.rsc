...
:if ([:len [find where list=$AddressList and address=37.152.72.0/22]] = 0) do={ add list=$AddressList comment=AS49467 address=37.152.72.0/22 }
:if ([:len [find where list=$AddressList and address=37.152.76.0/24]] = 0) do={ add list=$AddressList comment=AS49467 address=37.152.76.0/24 }
