...
:if ([:len [find where list=$AddressList and address=103.102.229.0/24]] = 0) do={ add list=$AddressList comment=AS49468 address=103.102.229.0/24 }
...
:if ([:len [find where list=$AddressList and address=89.125.166.0/24]] = 0) do={ add list=$AddressList comment=AS49468 address=89.125.166.0/24 }
