...
:do {add list=$AddressList comment=AS49683 address=31.25.235.0/24} on-error {}
:do {add list=$AddressList comment=AS49683 address=31.25.236.0/22} on-error {}
:do {add list=$AddressList comment=AS49683 address=89.33.68.0/22} on-error {}
