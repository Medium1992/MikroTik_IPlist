...
:do {add list=$AddressList comment=AS49685 address=176.74.240.0/24} on-error {}
:do {add list=$AddressList comment=AS49685 address=176.74.254.0/24} on-error {}
:do {add list=$AddressList comment=AS49685 address=193.177.160.0/23} on-error {}
