...
:do {add list=$AddressList comment=AS49685 address=for_scripts/asnv4/AS49685.rsc} on-error {}
...
:do {add list=$AddressList comment=AS49685 address=217.21.248.0/24} on-error {}
