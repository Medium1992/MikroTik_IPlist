...
:do {add list=$AddressList comment=AS49835 address=for_scripts/asnv4/AS49835.rsc} on-error {}
...
:do {add list=$AddressList comment=AS49835 address=149.6.200.0/24} on-error {}
...
:do {add list=$AddressList comment=AS49835 address=185.190.176.0/24} on-error {}
:do {add list=$AddressList comment=AS49835 address=185.205.4.0/22} on-error {}
