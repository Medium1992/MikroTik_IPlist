...
:if ([:len [find where list=$AddressList and address=45.95.144.0/24]] = 0) do={ add list=$AddressList comment=AS49870 address=45.95.144.0/24 }
:if ([:len [find where list=$AddressList and address=45.95.146.0/23]] = 0) do={ add list=$AddressList comment=AS49870 address=45.95.146.0/23 }
