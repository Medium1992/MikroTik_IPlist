...
:do {add list=$AddressList comment=AS50113 address=132.243.27.0/24} on-error {}
...
:do {add list=$AddressList comment=AS50113 address=194.63.141.0/24} on-error {}
:do {add list=$AddressList comment=AS50113 address=194.63.143.0/24} on-error {}
