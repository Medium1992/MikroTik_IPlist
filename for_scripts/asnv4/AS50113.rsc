...
:do {add list=$AddressList comment=AS50113 address=for_scripts/asnv4/AS50113.rsc} on-error {}
...
:do {add list=$AddressList comment=AS50113 address=45.89.64.0/24} on-error {}
:do {add list=$AddressList comment=AS50113 address=5.101.88.0/24} on-error {}
:do {add list=$AddressList comment=AS50113 address=5.180.136.0/23} on-error {}
:do {add list=$AddressList comment=AS50113 address=5.252.116.0/24} on-error {}
