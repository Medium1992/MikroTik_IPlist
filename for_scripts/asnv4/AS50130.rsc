...
:do {add list=$AddressList comment=AS50130 address=for_scripts/asnv4/AS50130.rsc} on-error {}
:do {add list=$AddressList comment=AS50130 address=213.5.197.0/24} on-error {}
