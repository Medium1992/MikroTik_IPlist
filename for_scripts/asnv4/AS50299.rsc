...
:do {add list=$AddressList comment=AS50299 address=for_scripts/asnv4/AS50299.rsc} on-error {}
:do {add list=$AddressList comment=AS50299 address=109.232.104.0/22} on-error {}
