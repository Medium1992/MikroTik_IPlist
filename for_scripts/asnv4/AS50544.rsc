...
:do {add list=$AddressList comment=AS50544 address=109.234.128.0/21} on-error {}
...
:do {add list=$AddressList comment=AS50544 address=217.117.184.0/23} on-error {}
...
:do {add list=$AddressList comment=AS50544 address=217.74.160.0/20} on-error {}
