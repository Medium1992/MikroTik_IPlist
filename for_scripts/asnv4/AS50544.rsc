...
:do {add list=$AddressList comment=AS50544 address=for_scripts/asnv4/AS50544.rsc} on-error {}
...
:do {add list=$AddressList comment=AS50544 address=217.117.188.0/24} on-error {}
:do {add list=$AddressList comment=AS50544 address=217.117.191.0/24} on-error {}
