...
:if ([:len [find where list=$AddressList and address=1.179.88.0/21]] = 0) do={ add list=$AddressList comment=AS50670 address=1.179.88.0/21 }
...
:if ([:len [find where list=$AddressList and address=77.91.136.0/22]] = 0) do={ add list=$AddressList comment=AS50670 address=77.91.136.0/22 }
:if ([:len [find where list=$AddressList and address=77.91.140.0/23]] = 0) do={ add list=$AddressList comment=AS50670 address=77.91.140.0/23 }
