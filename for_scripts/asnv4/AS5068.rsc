...
:do {add list=$AddressList comment=AS5068 address=for_scripts/asnv4/AS5068.rsc} on-error {}
:do {add list=$AddressList comment=AS5068 address=103.172.80.0/24} on-error {}
:do {add list=$AddressList comment=AS5068 address=103.231.56.0/24} on-error {}
