...
:if ([:len [find where list=$AddressList and address=204.244.168.0/21]] = 0) do={ add list=$AddressList comment=AS5071 address=204.244.168.0/21 }
:if ([:len [find where list=$AddressList and address=204.244.180.0/22]] = 0) do={ add list=$AddressList comment=AS5071 address=204.244.180.0/22 }
