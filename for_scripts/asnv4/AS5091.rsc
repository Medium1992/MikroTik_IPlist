...
:do {add list=$AddressList comment=AS5091 address=for_scripts/asnv4/AS5091.rsc} on-error {}
:do {add list=$AddressList comment=AS5091 address=139.45.160.0/22} on-error {}
:do {add list=$AddressList comment=AS5091 address=139.45.164.0/23} on-error {}
:do {add list=$AddressList comment=AS5091 address=139.45.169.0/24} on-error {}
