...
:do {add list=$AddressList comment=AS50979 address=193.238.155.0/24} on-error {}
:do {add list=$AddressList comment=AS50979 address=195.123.208.0/21} on-error {}
:do {add list=$AddressList comment=AS50979 address=195.123.236.0/24} on-error {}
...
:do {add list=$AddressList comment=AS50979 address=46.28.64.0/24} on-error {}
