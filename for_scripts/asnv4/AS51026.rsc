...
:if ([:len [find where list=$AddressList and address=62.220.124.0/23]] = 0) do={ add list=$AddressList comment=AS51026 address=62.220.124.0/23 }
:if ([:len [find where list=$AddressList and address=81.12.31.0/24]] = 0) do={ add list=$AddressList comment=AS51026 address=81.12.31.0/24 }
