...
:do {add list=$AddressList comment=AS51043 address=194.238.80.0/20} on-error {}
...
:do {add list=$AddressList comment=AS51043 address=77.73.12.0/24} on-error {}
:do {add list=$AddressList comment=AS51043 address=77.73.9.0/24} on-error {}
:do {add list=$AddressList comment=AS51043 address=82.197.74.0/24} on-error {}
