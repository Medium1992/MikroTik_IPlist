...
:if ([:len [find where list=$AddressList and address=176.116.48.0/21]] = 0) do={ add list=$AddressList comment=AS51070 address=176.116.48.0/21 }
:if ([:len [find where list=$AddressList and address=176.116.56.0/22]] = 0) do={ add list=$AddressList comment=AS51070 address=176.116.56.0/22 }
