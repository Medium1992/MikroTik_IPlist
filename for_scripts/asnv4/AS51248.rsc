...
:do {add list=$AddressList comment=AS51248 address=194.87.126.0/24} on-error {}
:do {add list=$AddressList comment=AS51248 address=194.87.52.0/24} on-error {}
:do {add list=$AddressList comment=AS51248 address=195.133.35.0/24} on-error {}
:do {add list=$AddressList comment=AS51248 address=212.192.210.0/24} on-error {}
:do {add list=$AddressList comment=AS51248 address=45.10.191.0/24} on-error {}
:do {add list=$AddressList comment=AS51248 address=45.129.142.0/24} on-error {}
:do {add list=$AddressList comment=AS51248 address=5.43.224.0/21} on-error {}
:do {add list=$AddressList comment=AS51248 address=85.137.25.0/24} on-error {}
