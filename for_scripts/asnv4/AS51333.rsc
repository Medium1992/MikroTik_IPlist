...
:do {add list=$AddressList comment=AS51333 address=188.65.80.0/23} on-error {}
:do {add list=$AddressList comment=AS51333 address=188.65.83.0/24} on-error {}
:do {add list=$AddressList comment=AS51333 address=188.65.84.0/22} on-error {}
