...
:do {add list=$AddressList comment=AS51336 address=for_scripts/asnv4/AS51336.rsc} on-error {}
...
:do {add list=$AddressList comment=AS51336 address=185.61.200.0/22} on-error {}
