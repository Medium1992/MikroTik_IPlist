...
:do {add list=$AddressList comment=AS51375 address=for_scripts/asnv4/AS51375.rsc} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.0.0/18} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.64.0/24} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.0/26} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.104/30} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.108/31} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.111/32} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.112/28} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.128/25} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.64/27} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.65.96/29} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.66.0/23} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.68.0/22} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.72.0/21} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.80.0/20} on-error {}
:do {add list=$AddressList comment=AS51375 address=109.63.96.0/19} on-error {}
