...
:do {add list=$AddressList comment=AS51551 address=for_scripts/asnv4/AS51551.rsc} on-error {}
...
:do {add list=$AddressList comment=AS51551 address=46.16.0.0/21} on-error {}
