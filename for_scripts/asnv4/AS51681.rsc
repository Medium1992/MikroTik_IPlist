...
:do {add list=$AddressList comment=AS51681 address=for_scripts/asnv4/AS51681.rsc} on-error {}
...
:do {add list=$AddressList comment=AS51681 address=185.223.137.0/24} on-error {}
