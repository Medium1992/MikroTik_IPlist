...
:do {add list=$AddressList comment=AS51722 address=31.40.196.0/24} on-error {}
:do {add list=$AddressList comment=AS51722 address=38.107.122.0/24} on-error {}
...
:do {add list=$AddressList comment=AS51722 address=92.249.62.0/24} on-error {}
