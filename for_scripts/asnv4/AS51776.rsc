...
:do {add list=$AddressList comment=AS51776 address=for_scripts/asnv4/AS51776.rsc} on-error {}
...
:do {add list=$AddressList comment=AS51776 address=91.201.212.0/23} on-error {}
