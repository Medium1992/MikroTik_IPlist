...
:do {add list=$AddressList comment=AS52025 address=169.128.220.0/22} on-error {}
:do {add list=$AddressList comment=AS52025 address=172.99.233.0/24} on-error {}
...
:do {add list=$AddressList comment=AS52025 address=85.155.227.0/24} on-error {}
