...
:if ([:len [find where list=$AddressList and address=130.12.140.0/23]] = 0) do={ add list=$AddressList comment=AS52041 address=130.12.140.0/23 }
:if ([:len [find where list=$AddressList and address=130.12.143.0/24]] = 0) do={ add list=$AddressList comment=AS52041 address=130.12.143.0/24 }
