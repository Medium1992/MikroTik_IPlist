...
:if ([:len [find where list=$AddressList and address=131.0.128.0/22]] = 0) do={ add list=$AddressList comment=AS52232 address=131.0.128.0/22 }
:if ([:len [find where list=$AddressList and address=181.225.1.0/24]] = 0) do={ add list=$AddressList comment=AS52232 address=181.225.1.0/24 }
...
:if ([:len [find where list=$AddressList and address=181.225.8.0/21]] = 0) do={ add list=$AddressList comment=AS52232 address=181.225.8.0/21 }
:if ([:len [find where list=$AddressList and address=190.114.128.0/22]] = 0) do={ add list=$AddressList comment=AS52232 address=190.114.128.0/22 }
:if ([:len [find where list=$AddressList and address=190.114.132.0/24]] = 0) do={ add list=$AddressList comment=AS52232 address=190.114.132.0/24 }
:if ([:len [find where list=$AddressList and address=190.114.136.0/22]] = 0) do={ add list=$AddressList comment=AS52232 address=190.114.136.0/22 }
:if ([:len [find where list=$AddressList and address=190.114.143.0/24]] = 0) do={ add list=$AddressList comment=AS52232 address=190.114.143.0/24 }
:if ([:len [find where list=$AddressList and address=190.114.144.0/20]] = 0) do={ add list=$AddressList comment=AS52232 address=190.114.144.0/20 }
...
:if ([:len [find where list=$AddressList and address=190.114.190.0/24]] = 0) do={ add list=$AddressList comment=AS52232 address=190.114.190.0/24 }
:if ([:len [find where list=$AddressList and address=190.14.160.0/19]] = 0) do={ add list=$AddressList comment=AS52232 address=190.14.160.0/19 }
