...
:do {add list=$AddressList comment=AS52262 address=for_scripts/asnv4/AS52262.rsc} on-error {}
...
:do {add list=$AddressList comment=AS52262 address=186.2.132.0/22} on-error {}
