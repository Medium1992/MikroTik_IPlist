...
:do {add list=$AddressList comment=AS52354 address=190.122.151.0/24} on-error {}
:do {add list=$AddressList comment=AS52354 address=190.122.158.0/23} on-error {}
:do {add list=$AddressList comment=AS52354 address=190.14.32.0/23} on-error {}
:do {add list=$AddressList comment=AS52354 address=190.14.34.0/24} on-error {}
