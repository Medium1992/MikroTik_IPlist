...
:if ([:len [find where list=$AddressList and address=45.236.128.0/22]] = 0) do={ add list=$AddressList comment=AS52368 address=45.236.128.0/22 }
:if ([:len [find where list=$AddressList and address=45.7.228.0/22]] = 0) do={ add list=$AddressList comment=AS52368 address=45.7.228.0/22 }
