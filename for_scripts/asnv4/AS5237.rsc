...
:do {add list=$AddressList comment=AS5237 address=for_scripts/asnv4/AS5237.rsc} on-error {}
...
:do {add list=$AddressList comment=AS5237 address=205.71.240.0/20} on-error {}
:do {add list=$AddressList comment=AS5237 address=205.76.212.0/24} on-error {}
:do {add list=$AddressList comment=AS5237 address=205.89.160.0/21} on-error {}
