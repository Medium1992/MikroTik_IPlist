...
:do {add list=$AddressList comment=AS5237 address=205.91.194.0/23} on-error {}
:do {add list=$AddressList comment=AS5237 address=205.91.196.0/24} on-error {}
:do {add list=$AddressList comment=AS5237 address=205.91.198.0/24} on-error {}
