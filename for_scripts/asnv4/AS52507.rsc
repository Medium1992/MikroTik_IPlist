...
:if ([:len [find where list=$AddressList and address=38.224.226.0/24]] = 0) do={ add list=$AddressList comment=AS52507 address=38.224.226.0/24 }
:if ([:len [find where list=$AddressList and address=45.230.60.0/22]] = 0) do={ add list=$AddressList comment=AS52507 address=45.230.60.0/22 }
