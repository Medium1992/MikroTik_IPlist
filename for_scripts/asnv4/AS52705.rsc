...
:if ([:len [find where list=$AddressList and address=45.228.24.0/23]] = 0) do={ add list=$AddressList comment=AS52705 address=45.228.24.0/23 }
:if ([:len [find where list=$AddressList and address=45.228.27.0/24]] = 0) do={ add list=$AddressList comment=AS52705 address=45.228.27.0/24 }
