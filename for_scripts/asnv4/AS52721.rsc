...
:if ([:len [find where list=$AddressList and address=138.94.81.0/24]] = 0) do={ add list=$AddressList comment=AS52721 address=138.94.81.0/24 }
:if ([:len [find where list=$AddressList and address=143.208.7.0/24]] = 0) do={ add list=$AddressList comment=AS52721 address=143.208.7.0/24 }
