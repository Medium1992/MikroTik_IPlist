...
:if ([:len [find where list=$AddressList and address=177.131.156.0/22]] = 0) do={ add list=$AddressList comment=AS52875 address=177.131.156.0/22 }
:if ([:len [find where list=$AddressList and address=179.63.64.0/24]] = 0) do={ add list=$AddressList comment=AS52875 address=179.63.64.0/24 }
