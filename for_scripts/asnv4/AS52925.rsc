...
:if ([:len [find where list=$AddressList and address=177.185.0.0/24]] = 0) do={ add list=$AddressList comment=AS52925 address=177.185.0.0/24 }
:if ([:len [find where list=$AddressList and address=177.185.3.0/24]] = 0) do={ add list=$AddressList comment=AS52925 address=177.185.3.0/24 }
:if ([:len [find where list=$AddressList and address=177.185.4.0/22]] = 0) do={ add list=$AddressList comment=AS52925 address=177.185.4.0/22 }
:if ([:len [find where list=$AddressList and address=177.185.8.0/21]] = 0) do={ add list=$AddressList comment=AS52925 address=177.185.8.0/21 }
...
:if ([:len [find where list=$AddressList and address=179.190.0.0/18]] = 0) do={ add list=$AddressList comment=AS52925 address=179.190.0.0/18 }
