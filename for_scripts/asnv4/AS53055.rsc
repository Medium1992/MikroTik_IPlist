...
:if ([:len [find where list=$AddressList and address=186.196.12.0/23]] = 0) do={ add list=$AddressList comment=AS53055 address=186.196.12.0/23 }
:if ([:len [find where list=$AddressList and address=186.196.14.0/24]] = 0) do={ add list=$AddressList comment=AS53055 address=186.196.14.0/24 }
:if ([:len [find where list=$AddressList and address=186.196.8.0/22]] = 0) do={ add list=$AddressList comment=AS53055 address=186.196.8.0/22 }
