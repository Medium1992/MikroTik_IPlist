...
:do {add list=$AddressList comment=AS53122 address=for_scripts/asnv4/AS53122.rsc} on-error {}
...
:do {add list=$AddressList comment=AS53122 address=187.111.184.0/22} on-error {}
