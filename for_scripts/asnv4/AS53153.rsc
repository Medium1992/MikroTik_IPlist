...
:if ([:len [find where list=$AddressList and address=187.61.108.0/24]] = 0) do={ add list=$AddressList comment=AS53153 address=187.61.108.0/24 }
:if ([:len [find where list=$AddressList and address=187.61.110.0/24]] = 0) do={ add list=$AddressList comment=AS53153 address=187.61.110.0/24 }
...
:if ([:len [find where list=$AddressList and address=187.61.99.0/24]] = 0) do={ add list=$AddressList comment=AS53153 address=187.61.99.0/24 }
