...
:do {add list=$AddressList comment=AS53153 address=for_scripts/asnv4/AS53153.rsc} on-error {}
...
:do {add list=$AddressList comment=AS53153 address=186.209.106.0/24} on-error {}
...
:do {add list=$AddressList comment=AS53153 address=187.61.104.0/22} on-error {}
:do {add list=$AddressList comment=AS53153 address=187.61.108.0/24} on-error {}
:do {add list=$AddressList comment=AS53153 address=187.61.110.0/23} on-error {}
