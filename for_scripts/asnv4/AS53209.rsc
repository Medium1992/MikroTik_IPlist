...
:if ([:len [find where list=$AddressList and address=168.196.56.0/22]] = 0) do={ add list=$AddressList comment=AS53209 address=168.196.56.0/22 }
...
:if ([:len [find where list=$AddressList and address=177.38.24.0/21]] = 0) do={ add list=$AddressList comment=AS53209 address=177.38.24.0/21 }
