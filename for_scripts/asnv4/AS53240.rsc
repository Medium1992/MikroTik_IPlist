...
:do {add list=$AddressList comment=AS53240 address=190.15.32.0/20} on-error {}
:do {add list=$AddressList comment=AS53240 address=190.15.49.0/24} on-error {}
:do {add list=$AddressList comment=AS53240 address=190.15.50.0/23} on-error {}
:do {add list=$AddressList comment=AS53240 address=190.15.52.0/22} on-error {}
:do {add list=$AddressList comment=AS53240 address=190.15.56.0/21} on-error {}
