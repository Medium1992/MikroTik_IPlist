...
:do {add list=$AddressList comment=AS53559 address=192.238.28.0/23} on-error {}
:do {add list=$AddressList comment=AS53559 address=192.238.30.0/24} on-error {}
...
:do {add list=$AddressList comment=AS53559 address=216.41.141.0/24} on-error {}
