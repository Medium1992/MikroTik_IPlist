...
:do {add list=$AddressList comment=AS53587 address=43.250.184.0/24} on-error {}
...
:do {add list=$AddressList comment=AS53587 address=45.61.244.0/23} on-error {}
:do {add list=$AddressList comment=AS53587 address=45.61.246.0/24} on-error {}
