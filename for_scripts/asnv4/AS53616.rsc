...
:do {add list=$AddressList comment=AS53616 address=185.219.189.0/24} on-error {}
:do {add list=$AddressList comment=AS53616 address=209.209.48.0/24} on-error {}
:do {add list=$AddressList comment=AS53616 address=217.217.32.0/23} on-error {}
:do {add list=$AddressList comment=AS53616 address=217.217.34.0/24} on-error {}
