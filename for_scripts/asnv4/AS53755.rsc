...
:if ([:len [find where list=$AddressList and address=104.255.220.0/23]] = 0) do={ add list=$AddressList comment=AS53755 address=104.255.220.0/23 }
:if ([:len [find where list=$AddressList and address=104.255.222.0/24]] = 0) do={ add list=$AddressList comment=AS53755 address=104.255.222.0/24 }
