...
:if ([:len [find where list=$AddressList and address=161.38.240.0/24]] = 0) do={ add list=$AddressList comment=AS53764 address=161.38.240.0/24 }
:if ([:len [find where list=$AddressList and address=161.38.242.0/23]] = 0) do={ add list=$AddressList comment=AS53764 address=161.38.242.0/23 }
...
:if ([:len [find where list=$AddressList and address=72.249.208.0/24]] = 0) do={ add list=$AddressList comment=AS53764 address=72.249.208.0/24 }
:if ([:len [find where list=$AddressList and address=72.249.210.0/23]] = 0) do={ add list=$AddressList comment=AS53764 address=72.249.210.0/23 }
:if ([:len [find where list=$AddressList and address=72.249.212.0/22]] = 0) do={ add list=$AddressList comment=AS53764 address=72.249.212.0/22 }
