...
:do {add list=$AddressList comment=AS5377 address=for_scripts/asnv4/AS5377.rsc} on-error {}
...
:do {add list=$AddressList comment=AS5377 address=193.220.224.0/19} on-error {}
:do {add list=$AddressList comment=AS5377 address=193.252.234.0/24} on-error {}
:do {add list=$AddressList comment=AS5377 address=216.9.228.0/22} on-error {}
...
:do {add list=$AddressList comment=AS5377 address=77.70.176.0/20} on-error {}
