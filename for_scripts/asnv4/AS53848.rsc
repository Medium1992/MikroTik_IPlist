...
:do {add list=$AddressList comment=AS53848 address=216.211.144.0/23} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.0/25} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.128/27} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.160/28} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.176/29} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.184/32} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.186/31} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.188/30} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.146.192/26} on-error {}
:do {add list=$AddressList comment=AS53848 address=216.211.147.0/24} on-error {}
