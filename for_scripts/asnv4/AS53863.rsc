...
:if ([:len [find where list=$AddressList and address=142.202.212.0/22]] = 0) do={ add list=$AddressList comment=AS53863 address=142.202.212.0/22 }
:if ([:len [find where list=$AddressList and address=208.73.156.0/22]] = 0) do={ add list=$AddressList comment=AS53863 address=208.73.156.0/22 }
