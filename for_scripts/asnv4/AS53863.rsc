...
:do {add list=$AddressList comment=AS53863 address=142.202.212.0/22} on-error {}
:do {add list=$AddressList comment=AS53863 address=208.73.156.0/22} on-error {}
...
:do {add list=$AddressList comment=AS53863 address=38.69.208.0/21} on-error {}
