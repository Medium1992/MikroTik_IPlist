...
:do {add list=$AddressList comment=AS5387 address=84.237.40.0/23} on-error {}
...
:do {add list=$AddressList comment=AS5387 address=84.237.68.0/23} on-error {}
:do {add list=$AddressList comment=AS5387 address=84.237.70.0/24} on-error {}
