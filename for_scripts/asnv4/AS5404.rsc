...
:do {add list=$AddressList comment=AS5404 address=for_scripts/asnv4/AS5404.rsc} on-error {}
...
:do {add list=$AddressList comment=AS5404 address=194.169.246.0/24} on-error {}
