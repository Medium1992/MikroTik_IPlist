...
:do {add list=$AddressList comment=AS5404 address=149.3.164.0/22} on-error {}
...
:do {add list=$AddressList comment=AS5404 address=5.252.12.0/22} on-error {}
:do {add list=$AddressList comment=AS5404 address=77.83.108.0/22} on-error {}
