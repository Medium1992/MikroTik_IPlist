...
:do {add list=$AddressList comment=AS54098 address=for_scripts/asnv4/AS54098.rsc} on-error {}
...
:do {add list=$AddressList comment=AS54098 address=199.19.99.0/24} on-error {}
...
:do {add list=$AddressList comment=AS54098 address=23.29.56.0/24} on-error {}
