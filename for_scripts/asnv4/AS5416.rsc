...
:do {add list=$AddressList comment=AS5416 address=88.201.0.0/19} on-error {}
:do {add list=$AddressList comment=AS5416 address=88.201.32.0/20} on-error {}
:do {add list=$AddressList comment=AS5416 address=88.201.48.0/21} on-error {}
:do {add list=$AddressList comment=AS5416 address=88.201.56.0/22} on-error {}
:do {add list=$AddressList comment=AS5416 address=88.201.60.0/24} on-error {}
:do {add list=$AddressList comment=AS5416 address=88.201.62.0/23} on-error {}
:do {add list=$AddressList comment=AS5416 address=88.201.64.0/18} on-error {}
