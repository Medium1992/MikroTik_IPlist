...
:do {add list=$AddressList comment=AS54309 address=for_scripts/asnv4/AS54309.rsc} on-error {}
...
:do {add list=$AddressList comment=AS54309 address=66.33.5.0/24} on-error {}
