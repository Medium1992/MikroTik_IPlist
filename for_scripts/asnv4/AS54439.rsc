...
:if ([:len [find where list=$AddressList and address=192.26.22.0/23]] = 0) do={ add list=$AddressList comment=AS54439 address=192.26.22.0/23 }
:if ([:len [find where list=$AddressList and address=192.26.24.0/24]] = 0) do={ add list=$AddressList comment=AS54439 address=192.26.24.0/24 }
...
:if ([:len [find where list=$AddressList and address=213.18.192.0/19]] = 0) do={ add list=$AddressList comment=AS54439 address=213.18.192.0/19 }
