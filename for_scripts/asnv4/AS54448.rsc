...
:do {add list=$AddressList comment=AS54448 address=for_scripts/asnv4/AS54448.rsc} on-error {}
...
:do {add list=$AddressList comment=AS54448 address=12.227.104.0/23} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.106.0/24} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.0/25} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.128/26} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.192/27} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.224/29} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.232/30} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.236/31} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.239/32} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.107.240/28} on-error {}
:do {add list=$AddressList comment=AS54448 address=12.227.108.0/22} on-error {}
