...
:do {add list=$AddressList comment=AS54723 address=for_scripts/asnv4/AS54723.rsc} on-error {}
...
:do {add list=$AddressList comment=AS54723 address=209.152.133.0/24} on-error {}
