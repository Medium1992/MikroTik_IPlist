...
:if ([:len [find where list=$AddressList and address=136.144.54.0/23]] = 0) do={ add list=$AddressList comment=AS54825 address=136.144.54.0/23 }
:if ([:len [find where list=$AddressList and address=136.144.60.0/23]] = 0) do={ add list=$AddressList comment=AS54825 address=136.144.60.0/23 }
:if ([:len [find where list=$AddressList and address=139.178.68.0/22]] = 0) do={ add list=$AddressList comment=AS54825 address=139.178.68.0/22 }
:if ([:len [find where list=$AddressList and address=139.178.76.0/23]] = 0) do={ add list=$AddressList comment=AS54825 address=139.178.76.0/23 }
:if ([:len [find where list=$AddressList and address=139.178.88.0/22]] = 0) do={ add list=$AddressList comment=AS54825 address=139.178.88.0/22 }
:if ([:len [find where list=$AddressList and address=139.178.94.0/23]] = 0) do={ add list=$AddressList comment=AS54825 address=139.178.94.0/23 }
:if ([:len [find where list=$AddressList and address=145.40.67.0/24]] = 0) do={ add list=$AddressList comment=AS54825 address=145.40.67.0/24 }
...
:if ([:len [find where list=$AddressList and address=147.28.203.0/24]] = 0) do={ add list=$AddressList comment=AS54825 address=147.28.203.0/24 }
:if ([:len [find where list=$AddressList and address=147.28.212.0/24]] = 0) do={ add list=$AddressList comment=AS54825 address=147.28.212.0/24 }
...
:if ([:len [find where list=$AddressList and address=147.75.68.0/22]] = 0) do={ add list=$AddressList comment=AS54825 address=147.75.68.0/22 }
:if ([:len [find where list=$AddressList and address=147.75.88.0/22]] = 0) do={ add list=$AddressList comment=AS54825 address=147.75.88.0/22 }
:if ([:len [find where list=$AddressList and address=86.109.1.0/24]] = 0) do={ add list=$AddressList comment=AS54825 address=86.109.1.0/24 }
:if ([:len [find where list=$AddressList and address=86.109.10.0/23]] = 0) do={ add list=$AddressList comment=AS54825 address=86.109.10.0/23 }
:if ([:len [find where list=$AddressList and address=86.109.6.0/24]] = 0) do={ add list=$AddressList comment=AS54825 address=86.109.6.0/24 }
:if ([:len [find where list=$AddressList and address=93.187.216.0/23]] = 0) do={ add list=$AddressList comment=AS54825 address=93.187.216.0/23 }
