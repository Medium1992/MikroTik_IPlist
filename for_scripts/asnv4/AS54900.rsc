...
:do {add list=$AddressList comment=AS54900 address=154.6.16.0/24} on-error {}
...
:do {add list=$AddressList comment=AS54900 address=65.181.100.0/24} on-error {}
:do {add list=$AddressList comment=AS54900 address=65.181.96.0/24} on-error {}
