...
:do {add list=$AddressList comment=AS54913 address=for_scripts/asnv4/AS54913.rsc} on-error {}
...
:do {add list=$AddressList comment=AS54913 address=207.126.161.0/24} on-error {}
