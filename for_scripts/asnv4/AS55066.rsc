...
:do {add list=$AddressList comment=AS55066 address=154.21.56.0/23} on-error {}
:do {add list=$AddressList comment=AS55066 address=154.30.156.0/23} on-error {}
:do {add list=$AddressList comment=AS55066 address=154.37.196.0/23} on-error {}
:do {add list=$AddressList comment=AS55066 address=154.50.60.0/23} on-error {}
:do {add list=$AddressList comment=AS55066 address=154.50.62.0/24} on-error {}
:do {add list=$AddressList comment=AS55066 address=154.50.96.0/24} on-error {}
:do {add list=$AddressList comment=AS55066 address=154.51.10.0/23} on-error {}
:do {add list=$AddressList comment=AS55066 address=154.9.114.0/23} on-error {}
