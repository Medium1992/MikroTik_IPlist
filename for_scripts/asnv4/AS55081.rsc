...
:do {add list=$AddressList comment=AS55081 address=for_scripts/asnv4/AS55081.rsc} on-error {}
...
:do {add list=$AddressList comment=AS55081 address=130.117.137.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=139.177.146.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=142.79.52.0/22} on-error {}
:do {add list=$AddressList comment=AS55081 address=154.49.101.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=154.49.96.0/24} on-error {}
...
:do {add list=$AddressList comment=AS55081 address=38.143.105.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=38.84.70.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=38.87.35.0/24} on-error {}
:do {add list=$AddressList comment=AS55081 address=38.89.71.0/24} on-error {}
