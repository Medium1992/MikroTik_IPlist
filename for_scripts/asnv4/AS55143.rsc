...
:do {add list=$AddressList comment=AS55143 address=162.42.12.0/22} on-error {}
:do {add list=$AddressList comment=AS55143 address=162.42.16.0/23} on-error {}
:do {add list=$AddressList comment=AS55143 address=162.42.18.0/24} on-error {}
