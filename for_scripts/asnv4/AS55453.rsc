...
:if ([:len [find where list=$AddressList and address=103.151.26.0/24]] = 0) do={ add list=$AddressList comment=AS55453 address=103.151.26.0/24 }
:if ([:len [find where list=$AddressList and address=103.20.0.0/22]] = 0) do={ add list=$AddressList comment=AS55453 address=103.20.0.0/22 }
...
:if ([:len [find where list=$AddressList and address=223.29.235.0/24]] = 0) do={ add list=$AddressList comment=AS55453 address=223.29.235.0/24 }
