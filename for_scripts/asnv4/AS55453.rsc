...
:if ([:len [find where list=$AddressList and address=137.59.192.0/23]] = 0) do={ add list=$AddressList comment=AS55453 address=137.59.192.0/23 }
:if ([:len [find where list=$AddressList and address=137.59.194.0/24]] = 0) do={ add list=$AddressList comment=AS55453 address=137.59.194.0/24 }
...
:if ([:len [find where list=$AddressList and address=27.54.120.0/23]] = 0) do={ add list=$AddressList comment=AS55453 address=27.54.120.0/23 }
:if ([:len [find where list=$AddressList and address=27.54.122.0/24]] = 0) do={ add list=$AddressList comment=AS55453 address=27.54.122.0/24 }
