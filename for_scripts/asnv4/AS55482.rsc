...
:if ([:len [find where list=$AddressList and address=182.173.72.0/23]] = 0) do={ add list=$AddressList comment=AS55482 address=182.173.72.0/23 }
:if ([:len [find where list=$AddressList and address=182.173.75.0/24]] = 0) do={ add list=$AddressList comment=AS55482 address=182.173.75.0/24 }
