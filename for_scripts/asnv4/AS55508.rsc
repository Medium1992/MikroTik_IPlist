...
:do {add list=$AddressList comment=AS55508 address=for_scripts/asnv4/AS55508.rsc} on-error {}
...
:do {add list=$AddressList comment=AS55508 address=203.110.64.0/20} on-error {}
