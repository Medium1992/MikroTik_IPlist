...
:do {add list=$AddressList comment=AS55701 address=for_scripts/asnv4/AS55701.rsc} on-error {}
:do {add list=$AddressList comment=AS55701 address=103.112.139.0/24} on-error {}
