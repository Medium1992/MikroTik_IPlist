...
:do {add list=$AddressList comment=AS55799 address=for_scripts/asnv4/AS55799.rsc} on-error {}
...
:do {add list=$AddressList comment=AS55799 address=103.35.72.0/22} on-error {}
...
:do {add list=$AddressList comment=AS55799 address=103.81.247.0/24} on-error {}
...
:do {add list=$AddressList comment=AS55799 address=43.251.158.0/23} on-error {}
