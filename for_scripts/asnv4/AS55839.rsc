...
:if ([:len [find where list=$AddressList and address=43.245.136.0/23]] = 0) do={ add list=$AddressList comment=AS55839 address=43.245.136.0/23 }
:if ([:len [find where list=$AddressList and address=43.245.138.0/24]] = 0) do={ add list=$AddressList comment=AS55839 address=43.245.138.0/24 }
