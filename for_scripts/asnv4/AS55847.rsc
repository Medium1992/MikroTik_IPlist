...
:do {add list=$AddressList comment=AS55847 address=for_scripts/asnv4/AS55847.rsc} on-error {}
...
:do {add list=$AddressList comment=AS55847 address=14.139.46.0/23} on-error {}
