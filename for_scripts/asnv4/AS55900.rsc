...
:do {add list=$AddressList comment=AS55900 address=104.222.192.0/20} on-error {}
:do {add list=$AddressList comment=AS55900 address=104.222.208.0/21} on-error {}
:do {add list=$AddressList comment=AS55900 address=104.222.216.0/22} on-error {}
...
:do {add list=$AddressList comment=AS55900 address=172.97.80.0/20} on-error {}
