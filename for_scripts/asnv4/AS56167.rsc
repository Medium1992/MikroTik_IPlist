...
:do {add list=$AddressList comment=AS56167 address=for_scripts/asnv4/AS56167.rsc} on-error {}
...
:do {add list=$AddressList comment=AS56167 address=119.155.192.0/19} on-error {}
