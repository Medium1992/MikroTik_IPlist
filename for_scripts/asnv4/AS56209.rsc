...
:do {add list=$AddressList comment=AS56209 address=202.47.112.0/24} on-error {}
:do {add list=$AddressList comment=AS56209 address=202.47.114.0/23} on-error {}
:do {add list=$AddressList comment=AS56209 address=202.47.116.0/22} on-error {}
