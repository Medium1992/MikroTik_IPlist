...
:if ([:len [find where list=$AddressList and address=103.10.120.0/23]] = 0) do={ add list=$AddressList comment=AS56246 address=103.10.120.0/23 }
:if ([:len [find where list=$AddressList and address=103.10.122.0/24]] = 0) do={ add list=$AddressList comment=AS56246 address=103.10.122.0/24 }
...
:if ([:len [find where list=$AddressList and address=116.68.172.0/23]] = 0) do={ add list=$AddressList comment=AS56246 address=116.68.172.0/23 }
:if ([:len [find where list=$AddressList and address=116.68.175.0/24]] = 0) do={ add list=$AddressList comment=AS56246 address=116.68.175.0/24 }
