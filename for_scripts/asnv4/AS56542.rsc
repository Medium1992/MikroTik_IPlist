...
:do {add list=$AddressList comment=AS56542 address=46.160.141.0/24} on-error {}
:do {add list=$AddressList comment=AS56542 address=46.160.142.0/23} on-error {}
...
:do {add list=$AddressList comment=AS56542 address=94.137.252.0/24} on-error {}
:do {add list=$AddressList comment=AS56542 address=94.137.255.0/24} on-error {}
