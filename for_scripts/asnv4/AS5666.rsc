...
:do {add list=$AddressList comment=AS5666 address=for_scripts/asnv4/AS5666.rsc} on-error {}
:do {add list=$AddressList comment=AS5666 address=103.212.40.0/24} on-error {}
:do {add list=$AddressList comment=AS5666 address=103.250.1.0/24} on-error {}
