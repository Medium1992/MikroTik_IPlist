...
:if ([:len [find where list=$AddressList and address=5.188.166.0/24]] = 0) do={ add list=$AddressList comment=AS56694 address=5.188.166.0/24 }
:if ([:len [find where list=$AddressList and address=5.188.60.0/24]] = 0) do={ add list=$AddressList comment=AS56694 address=5.188.60.0/24 }
