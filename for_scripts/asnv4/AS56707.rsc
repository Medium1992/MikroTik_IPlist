...
:if ([:len [find where list=$AddressList and address=193.232.107.0/24]] = 0) do={ add list=$AddressList comment=AS56707 address=193.232.107.0/24 }
:if ([:len [find where list=$AddressList and address=193.232.110.0/24]] = 0) do={ add list=$AddressList comment=AS56707 address=193.232.110.0/24 }
...
:if ([:len [find where list=$AddressList and address=193.232.40.0/22]] = 0) do={ add list=$AddressList comment=AS56707 address=193.232.40.0/22 }
...
:if ([:len [find where list=$AddressList and address=193.232.92.0/24]] = 0) do={ add list=$AddressList comment=AS56707 address=193.232.92.0/24 }
...
:if ([:len [find where list=$AddressList and address=212.107.240.0/21]] = 0) do={ add list=$AddressList comment=AS56707 address=212.107.240.0/21 }
...
:if ([:len [find where list=$AddressList and address=46.166.240.0/21]] = 0) do={ add list=$AddressList comment=AS56707 address=46.166.240.0/21 }
