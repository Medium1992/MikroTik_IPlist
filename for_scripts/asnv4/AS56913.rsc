...
:do {add list=$AddressList comment=AS56913 address=for_scripts/asnv4/AS56913.rsc} on-error {}
...
:do {add list=$AddressList comment=AS56913 address=151.240.29.0/24} on-error {}
