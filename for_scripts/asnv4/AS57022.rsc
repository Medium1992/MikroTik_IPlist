...
:if ([:len [find where list=$AddressList and address=193.35.28.0/23]] = 0) do={ add list=$AddressList comment=AS57022 address=193.35.28.0/23 }
:if ([:len [find where list=$AddressList and address=193.35.30.0/24]] = 0) do={ add list=$AddressList comment=AS57022 address=193.35.30.0/24 }
