...
:do {add list=$AddressList comment=AS5716 address=64.46.128.0/21} on-error {}
:do {add list=$AddressList comment=AS5716 address=64.46.136.0/22} on-error {}
:do {add list=$AddressList comment=AS5716 address=64.46.141.0/24} on-error {}
:do {add list=$AddressList comment=AS5716 address=64.46.144.0/20} on-error {}
