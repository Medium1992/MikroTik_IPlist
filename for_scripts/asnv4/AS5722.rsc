...
:do {add list=$AddressList comment=AS5722 address=168.176.192.0/23} on-error {}
:do {add list=$AddressList comment=AS5722 address=168.176.195.0/24} on-error {}
:do {add list=$AddressList comment=AS5722 address=168.176.196.0/23} on-error {}
:do {add list=$AddressList comment=AS5722 address=168.176.198.0/24} on-error {}
...
:do {add list=$AddressList comment=AS5722 address=168.176.212.0/24} on-error {}
...
:do {add list=$AddressList comment=AS5722 address=168.176.250.0/24} on-error {}
