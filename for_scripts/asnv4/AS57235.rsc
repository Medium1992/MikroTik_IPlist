...
:do {add list=$AddressList comment=AS57235 address=81.31.224.0/24} on-error {}
:do {add list=$AddressList comment=AS57235 address=81.31.226.0/23} on-error {}
...
:do {add list=$AddressList comment=AS57235 address=81.31.238.0/23} on-error {}
