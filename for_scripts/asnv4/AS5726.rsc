...
:do {add list=$AddressList comment=AS5726 address=for_scripts/asnv4/AS5726.rsc} on-error {}
...
:do {add list=$AddressList comment=AS5726 address=206.117.75.0/24} on-error {}
