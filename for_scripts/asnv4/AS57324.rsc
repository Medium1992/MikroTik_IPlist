...
:do {add list=$AddressList comment=AS57324 address=for_scripts/asnv4/AS57324.rsc} on-error {}
...
:do {add list=$AddressList comment=AS57324 address=202.164.204.0/23} on-error {}
