...
:do {add list=$AddressList comment=AS57695 address=for_scripts/asnv4/AS57695.rsc} on-error {}
...
:do {add list=$AddressList comment=AS57695 address=45.11.106.0/24} on-error {}
