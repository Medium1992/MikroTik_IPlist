...
:do {add list=$AddressList comment=AS57814 address=185.139.56.0/23} on-error {}
:do {add list=$AddressList comment=AS57814 address=185.139.58.0/24} on-error {}
...
:do {add list=$AddressList comment=AS57814 address=80.75.215.0/24} on-error {}
