...
:do {add list=$AddressList comment=AS57918 address=185.201.52.0/23} on-error {}
:do {add list=$AddressList comment=AS57918 address=185.201.54.0/24} on-error {}
:do {add list=$AddressList comment=AS57918 address=213.232.214.0/23} on-error {}
