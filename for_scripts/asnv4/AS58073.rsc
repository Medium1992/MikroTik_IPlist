...
:do {add list=$AddressList comment=AS58073 address=for_scripts/asnv4/AS58073.rsc} on-error {}
:do {add list=$AddressList comment=AS58073 address=154.84.1.0/24} on-error {}
