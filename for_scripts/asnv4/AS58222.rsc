...
:do {add list=$AddressList comment=AS58222 address=for_scripts/asnv4/AS58222.rsc} on-error {}
...
:do {add list=$AddressList comment=AS58222 address=185.234.16.0/22} on-error {}
:do {add list=$AddressList comment=AS58222 address=212.237.208.0/22} on-error {}
:do {add list=$AddressList comment=AS58222 address=45.80.16.0/22} on-error {}
:do {add list=$AddressList comment=AS58222 address=89.43.116.0/22} on-error {}
:do {add list=$AddressList comment=AS58222 address=91.210.70.0/24} on-error {}
