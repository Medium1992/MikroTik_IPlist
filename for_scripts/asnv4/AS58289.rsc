...
:do {add list=$AddressList comment=AS58289 address=78.109.19.0/24} on-error {}
:do {add list=$AddressList comment=AS58289 address=82.115.58.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58289 address=91.147.108.0/24} on-error {}
