...
:do {add list=$AddressList comment=AS58389 address=103.11.30.0/23} on-error {}
:do {add list=$AddressList comment=AS58389 address=103.143.222.0/24} on-error {}
:do {add list=$AddressList comment=AS58389 address=103.226.119.0/24} on-error {}
:do {add list=$AddressList comment=AS58389 address=103.227.248.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58389 address=116.68.169.0/24} on-error {}
:do {add list=$AddressList comment=AS58389 address=202.47.182.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58389 address=43.240.230.0/24} on-error {}
