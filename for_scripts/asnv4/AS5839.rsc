...
:do {add list=$AddressList comment=AS5839 address=205.59.100.0/22} on-error {}
...
:do {add list=$AddressList comment=AS5839 address=205.78.42.0/23} on-error {}
:do {add list=$AddressList comment=AS5839 address=205.78.44.0/24} on-error {}
