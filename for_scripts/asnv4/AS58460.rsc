...
:do {add list=$AddressList comment=AS58460 address=for_scripts/asnv4/AS58460.rsc} on-error {}
...
:do {add list=$AddressList comment=AS58460 address=180.150.253.0/24} on-error {}
:do {add list=$AddressList comment=AS58460 address=180.150.254.0/23} on-error {}
