...
:do {add list=$AddressList comment=AS58558 address=for_scripts/asnv4/AS58558.rsc} on-error {}
:do {add list=$AddressList comment=AS58558 address=103.196.43.0/24} on-error {}
:do {add list=$AddressList comment=AS58558 address=103.196.46.0/23} on-error {}
