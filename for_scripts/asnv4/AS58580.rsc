...
:if ([:len [find where list=$AddressList and address=163.47.100.0/22]] = 0) do={ add list=$AddressList comment=AS58580 address=163.47.100.0/22 }
:if ([:len [find where list=$AddressList and address=168.245.200.0/22]] = 0) do={ add list=$AddressList comment=AS58580 address=168.245.200.0/22 }
:if ([:len [find where list=$AddressList and address=185.254.56.0/22]] = 0) do={ add list=$AddressList comment=AS58580 address=185.254.56.0/22 }
:if ([:len [find where list=$AddressList and address=199.101.108.0/22]] = 0) do={ add list=$AddressList comment=AS58580 address=199.101.108.0/22 }
