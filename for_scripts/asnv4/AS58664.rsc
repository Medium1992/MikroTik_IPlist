...
:do {add list=$AddressList comment=AS58664 address=130.248.112.0/22} on-error {}
:do {add list=$AddressList comment=AS58664 address=130.248.118.0/23} on-error {}
:do {add list=$AddressList comment=AS58664 address=130.248.120.0/21} on-error {}
