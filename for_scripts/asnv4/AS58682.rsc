...
:do {add list=$AddressList comment=AS58682 address=for_scripts/asnv4/AS58682.rsc} on-error {}
...
:do {add list=$AddressList comment=AS58682 address=103.7.123.0/24} on-error {}
