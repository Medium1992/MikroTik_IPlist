...
:do {add list=$AddressList comment=AS58762 address=103.138.9.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58762 address=103.69.12.0/24} on-error {}
:do {add list=$AddressList comment=AS58762 address=150.129.44.0/22} on-error {}
:do {add list=$AddressList comment=AS58762 address=45.117.183.0/24} on-error {}
