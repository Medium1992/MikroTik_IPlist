...
:if ([:len [find where list=$AddressList and address=157.7.120.0/21]] = 0) do={ add list=$AddressList comment=AS58791 address=157.7.120.0/21 }
...
:if ([:len [find where list=$AddressList and address=160.251.84.0/22]] = 0) do={ add list=$AddressList comment=AS58791 address=160.251.84.0/22 }
...
:if ([:len [find where list=$AddressList and address=163.44.64.0/21]] = 0) do={ add list=$AddressList comment=AS58791 address=163.44.64.0/21 }
...
:if ([:len [find where list=$AddressList and address=210.172.184.0/21]] = 0) do={ add list=$AddressList comment=AS58791 address=210.172.184.0/21 }
:if ([:len [find where list=$AddressList and address=211.125.80.0/21]] = 0) do={ add list=$AddressList comment=AS58791 address=211.125.80.0/21 }
