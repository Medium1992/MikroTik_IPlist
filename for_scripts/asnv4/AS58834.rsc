...
:do {add list=$AddressList comment=AS58834 address=202.168.162.0/23} on-error {}
:do {add list=$AddressList comment=AS58834 address=202.168.168.0/21} on-error {}
:do {add list=$AddressList comment=AS58834 address=202.168.177.0/24} on-error {}
:do {add list=$AddressList comment=AS58834 address=202.168.180.0/22} on-error {}
:do {add list=$AddressList comment=AS58834 address=202.168.188.0/22} on-error {}
