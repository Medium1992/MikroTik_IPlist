...
:do {add list=$AddressList comment=AS58834 address=for_scripts/asnv4/AS58834.rsc} on-error {}
:do {add list=$AddressList comment=AS58834 address=103.27.24.0/24} on-error {}
...
:do {add list=$AddressList comment=AS58834 address=124.240.112.0/20} on-error {}
