...
:do {add list=$AddressList comment=AS58834 address=103.27.24.0/22} on-error {}
...
:do {add list=$AddressList comment=AS58834 address=124.240.0.0/17} on-error {}
...
:do {add list=$AddressList comment=AS58834 address=49.239.192.0/18} on-error {}
