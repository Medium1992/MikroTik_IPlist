...
:if ([:len [find where list=$AddressList and address=103.23.40.0/23]] = 0) do={ add list=$AddressList comment=AS58923 address=103.23.40.0/23 }
:if ([:len [find where list=$AddressList and address=103.23.42.0/24]] = 0) do={ add list=$AddressList comment=AS58923 address=103.23.42.0/24 }
