...
:do {add list=$AddressList comment=AS58965 address=103.110.16.0/22} on-error {}
...
:do {add list=$AddressList comment=AS58965 address=103.134.114.0/23} on-error {}
:do {add list=$AddressList comment=AS58965 address=103.141.90.0/23} on-error {}
...
:do {add list=$AddressList comment=AS58965 address=103.188.126.0/23} on-error {}
...
:do {add list=$AddressList comment=AS58965 address=103.77.40.0/22} on-error {}
