...
:if ([:len [find where list=$AddressList and address=103.233.228.0/22]] = 0) do={ add list=$AddressList comment=AS59009 address=103.233.228.0/22 }
...
:if ([:len [find where list=$AddressList and address=150.242.152.0/22]] = 0) do={ add list=$AddressList comment=AS59009 address=150.242.152.0/22 }
