...
:do {add list=$AddressList comment=AS59134 address=38.47.80.0/24} on-error {}
:do {add list=$AddressList comment=AS59134 address=38.47.82.0/23} on-error {}
:do {add list=$AddressList comment=AS59134 address=38.47.84.0/22} on-error {}
