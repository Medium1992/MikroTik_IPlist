...
:do {add list=$AddressList comment=AS59223 address=for_scripts/asnv4/AS59223.rsc} on-error {}
...
:do {add list=$AddressList comment=AS59223 address=125.72.109.0/24} on-error {}
:do {add list=$AddressList comment=AS59223 address=125.72.124.0/24} on-error {}
:do {add list=$AddressList comment=AS59223 address=125.72.129.0/24} on-error {}
:do {add list=$AddressList comment=AS59223 address=125.72.143.0/24} on-error {}
:do {add list=$AddressList comment=AS59223 address=125.72.144.0/24} on-error {}
:do {add list=$AddressList comment=AS59223 address=125.72.18.0/23} on-error {}
:do {add list=$AddressList comment=AS59223 address=218.95.237.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59223 address=223.221.162.0/24} on-error {}
