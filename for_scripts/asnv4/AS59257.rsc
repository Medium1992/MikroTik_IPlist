...
:do {add list=$AddressList comment=AS59257 address=for_scripts/asnv4/AS59257.rsc} on-error {}
...
:do {add list=$AddressList comment=AS59257 address=203.189.224.0/21} on-error {}
...
:do {add list=$AddressList comment=AS59257 address=223.123.64.0/19} on-error {}
