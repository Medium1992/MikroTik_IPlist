...
:do {add list=$AddressList comment=AS59432 address=141.11.172.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=141.11.218.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=141.98.149.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=151.243.156.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=178.253.233.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=31.42.123.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=31.56.82.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=45.81.154.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=45.90.16.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=82.24.107.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=85.239.152.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=89.251.18.0/24} on-error {}
