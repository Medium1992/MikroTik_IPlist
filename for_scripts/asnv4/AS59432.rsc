...
:do {add list=$AddressList comment=AS59432 address=145.79.134.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=178.239.116.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=31.58.59.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=78.108.60.0/24} on-error {}
