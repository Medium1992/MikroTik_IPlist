...
:do {add list=$AddressList comment=AS59432 address=143.20.151.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=143.20.192.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=143.20.34.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=151.242.253.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=151.243.148.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=169.40.137.0/24} on-error {}
...
:do {add list=$AddressList comment=AS59432 address=78.143.253.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=82.23.181.0/24} on-error {}
:do {add list=$AddressList comment=AS59432 address=89.40.83.0/24} on-error {}
