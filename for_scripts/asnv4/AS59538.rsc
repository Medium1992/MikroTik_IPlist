...
:do {add list=$AddressList comment=AS59538 address=for_scripts/asnv4/AS59538.rsc} on-error {}
...
:do {add list=$AddressList comment=AS59538 address=154.62.183.0/24} on-error {}
