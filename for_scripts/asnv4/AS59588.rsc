...
:if ([:len [find where list=$AddressList and address=154.43.179.0/24]] = 0) do={ add list=$AddressList comment=AS59588 address=154.43.179.0/24 }
:if ([:len [find where list=$AddressList and address=185.112.190.0/24]] = 0) do={ add list=$AddressList comment=AS59588 address=185.112.190.0/24 }
