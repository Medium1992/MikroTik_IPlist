...
:do {add list=$AddressList comment=AS59869 address=for_scripts/asnv4/AS59869.rsc} on-error {}
:do {add list=$AddressList comment=AS59869 address=178.22.224.0/21} on-error {}
:do {add list=$AddressList comment=AS59869 address=185.91.142.0/24} on-error {}
