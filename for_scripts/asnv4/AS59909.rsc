...
:do {add list=$AddressList comment=AS59909 address=for_scripts/asnv4/AS59909.rsc} on-error {}
...
:do {add list=$AddressList comment=AS59909 address=45.90.76.0/22} on-error {}
