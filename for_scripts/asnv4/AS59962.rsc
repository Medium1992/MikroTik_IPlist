...
:do {add list=$AddressList comment=AS59962 address=46.209.34.0/24} on-error {}
:do {add list=$AddressList comment=AS59962 address=46.209.36.0/24} on-error {}
:do {add list=$AddressList comment=AS59962 address=46.209.38.0/23} on-error {}
