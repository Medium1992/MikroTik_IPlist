...
:do {add list=$AddressList comment=AS60024 address=104.249.172.0/24} on-error {}
:do {add list=$AddressList comment=AS60024 address=185.148.12.0/24} on-error {}
:do {add list=$AddressList comment=AS60024 address=185.212.62.0/23} on-error {}
...
:do {add list=$AddressList comment=AS60024 address=38.59.231.0/24} on-error {}
