...
:do {add list=$AddressList comment=AS60064 address=for_scripts/asnv4/AS60064.rsc} on-error {}
...
:do {add list=$AddressList comment=AS60064 address=192.142.56.0/24} on-error {}
