...
:if ([:len [find where list=$AddressList and address=217.13.96.0/23]] = 0) do={ add list=$AddressList comment=AS60071 address=217.13.96.0/23 }
:if ([:len [find where list=$AddressList and address=217.144.51.0/24]] = 0) do={ add list=$AddressList comment=AS60071 address=217.144.51.0/24 }
:if ([:len [find where list=$AddressList and address=87.229.103.0/24]] = 0) do={ add list=$AddressList comment=AS60071 address=87.229.103.0/24 }
