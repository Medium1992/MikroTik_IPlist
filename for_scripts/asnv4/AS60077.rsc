...
:do {add list=$AddressList comment=AS60077 address=for_scripts/asnv4/AS60077.rsc} on-error {}
:do {add list=$AddressList comment=AS60077 address=193.151.128.0/19} on-error {}
:do {add list=$AddressList comment=AS60077 address=78.110.112.0/24} on-error {}
