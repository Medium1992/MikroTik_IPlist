...
:do {add list=$AddressList comment=AS60117 address=109.206.243.0/24} on-error {}
...
:do {add list=$AddressList comment=AS60117 address=185.218.138.0/24} on-error {}
...
:do {add list=$AddressList comment=AS60117 address=85.31.46.0/24} on-error {}
:do {add list=$AddressList comment=AS60117 address=91.204.76.0/24} on-error {}
:do {add list=$AddressList comment=AS60117 address=91.92.21.0/24} on-error {}
