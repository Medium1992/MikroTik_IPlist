...
:do {add list=$AddressList comment=AS60148 address=2.178.254.0/24} on-error {}
:do {add list=$AddressList comment=AS60148 address=2.179.168.0/24} on-error {}
:do {add list=$AddressList comment=AS60148 address=2.180.254.0/24} on-error {}
...
:do {add list=$AddressList comment=AS60148 address=78.39.152.0/23} on-error {}
:do {add list=$AddressList comment=AS60148 address=78.39.157.0/24} on-error {}
:do {add list=$AddressList comment=AS60148 address=78.39.221.0/24} on-error {}
