...
:if ([:len [find where list=$AddressList and address=5.32.128.0/24]] = 0) do={ add list=$AddressList comment=AS60168 address=5.32.128.0/24 }
:if ([:len [find where list=$AddressList and address=5.32.130.0/23]] = 0) do={ add list=$AddressList comment=AS60168 address=5.32.130.0/23 }
