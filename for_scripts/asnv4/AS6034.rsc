...
:if ([:len [find where list=$AddressList and address=143.81.105.0/24]] = 0) do={ add list=$AddressList comment=AS6034 address=143.81.105.0/24 }
:if ([:len [find where list=$AddressList and address=143.81.106.0/24]] = 0) do={ add list=$AddressList comment=AS6034 address=143.81.106.0/24 }
:if ([:len [find where list=$AddressList and address=143.81.112.0/24]] = 0) do={ add list=$AddressList comment=AS6034 address=143.81.112.0/24 }
...
:if ([:len [find where list=$AddressList and address=143.81.72.0/22]] = 0) do={ add list=$AddressList comment=AS6034 address=143.81.72.0/22 }
:if ([:len [find where list=$AddressList and address=143.81.8.0/21]] = 0) do={ add list=$AddressList comment=AS6034 address=143.81.8.0/21 }
:if ([:len [find where list=$AddressList and address=143.81.90.0/24]] = 0) do={ add list=$AddressList comment=AS6034 address=143.81.90.0/24 }
