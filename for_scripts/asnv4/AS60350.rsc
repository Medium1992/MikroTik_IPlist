...
:do {add list=$AddressList comment=AS60350 address=193.105.151.0/24} on-error {}
:do {add list=$AddressList comment=AS60350 address=193.105.154.0/24} on-error {}
:do {add list=$AddressList comment=AS60350 address=193.105.162.0/24} on-error {}
