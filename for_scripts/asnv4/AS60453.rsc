...
:do {add list=$AddressList comment=AS60453 address=for_scripts/asnv4/AS60453.rsc} on-error {}
...
:do {add list=$AddressList comment=AS60453 address=193.142.234.0/24} on-error {}
