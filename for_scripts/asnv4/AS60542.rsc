...
:do {add list=$AddressList comment=AS60542 address=147.90.39.0/24} on-error {}
:do {add list=$AddressList comment=AS60542 address=151.247.216.0/24} on-error {}
...
:do {add list=$AddressList comment=AS60542 address=193.168.209.0/24} on-error {}
:do {add list=$AddressList comment=AS60542 address=202.71.8.0/24} on-error {}
:do {add list=$AddressList comment=AS60542 address=85.208.107.0/24} on-error {}
:do {add list=$AddressList comment=AS60542 address=87.232.120.0/24} on-error {}
:do {add list=$AddressList comment=AS60542 address=87.76.180.0/24} on-error {}
