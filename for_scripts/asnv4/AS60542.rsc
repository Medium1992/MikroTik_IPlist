...
:if ([:len [find where list=$AddressList and address=178.248.74.0/24]] = 0) do={ add list=$AddressList comment=AS60542 address=178.248.74.0/24 }
...
:if ([:len [find where list=$AddressList and address=217.217.192.0/24]] = 0) do={ add list=$AddressList comment=AS60542 address=217.217.192.0/24 }
