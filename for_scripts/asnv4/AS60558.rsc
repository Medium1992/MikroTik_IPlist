...
:do {add list=$AddressList comment=AS60558 address=for_scripts/asnv4/AS60558.rsc} on-error {}
...
:do {add list=$AddressList comment=AS60558 address=83.150.216.0/24} on-error {}
