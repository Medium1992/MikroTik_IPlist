...
:do {add list=$AddressList comment=AS60592 address=185.38.108.0/23} on-error {}
:do {add list=$AddressList comment=AS60592 address=185.38.110.0/24} on-error {}
...
:do {add list=$AddressList comment=AS60592 address=23.26.24.0/21} on-error {}
