...
:if ([:len [find where list=$AddressList and address=5.101.80.0/24]] = 0) do={ add list=$AddressList comment=AS60602 address=5.101.80.0/24 }
:if ([:len [find where list=$AddressList and address=80.66.79.0/24]] = 0) do={ add list=$AddressList comment=AS60602 address=80.66.79.0/24 }
