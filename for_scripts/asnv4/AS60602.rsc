...
:do {add list=$AddressList comment=AS60602 address=157.254.206.0/24} on-error {}
:do {add list=$AddressList comment=AS60602 address=163.5.118.0/24} on-error {}
:do {add list=$AddressList comment=AS60602 address=163.5.216.0/24} on-error {}
...
:do {add list=$AddressList comment=AS60602 address=194.77.26.0/24} on-error {}
:do {add list=$AddressList comment=AS60602 address=205.186.118.0/24} on-error {}
...
:do {add list=$AddressList comment=AS60602 address=83.245.12.0/24} on-error {}
