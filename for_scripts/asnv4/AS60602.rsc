...
:do {add list=$AddressList comment=AS60602 address=for_scripts/asnv4/AS60602.rsc} on-error {}
:do {add list=$AddressList comment=AS60602 address=151.243.80.0/23} on-error {}
