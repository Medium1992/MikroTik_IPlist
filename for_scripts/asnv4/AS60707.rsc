...
:do {add list=$AddressList comment=AS60707 address=for_scripts/asnv4/AS60707.rsc} on-error {}
...
:do {add list=$AddressList comment=AS60707 address=80.253.244.0/23} on-error {}
...
:do {add list=$AddressList comment=AS60707 address=91.228.12.0/24} on-error {}
:do {add list=$AddressList comment=AS60707 address=91.228.14.0/24} on-error {}
