...
:if ([:len [find where list=$AddressList and address=185.26.193.0/24]] = 0) do={ add list=$AddressList comment=AS60720 address=185.26.193.0/24 }
:if ([:len [find where list=$AddressList and address=185.26.194.0/23]] = 0) do={ add list=$AddressList comment=AS60720 address=185.26.194.0/23 }
