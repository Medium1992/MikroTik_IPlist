...
:if ([:len [find where list=$AddressList and address=193.160.142.0/24]] = 0) do={ add list=$AddressList comment=AS60721 address=193.160.142.0/24 }
:if ([:len [find where list=$AddressList and address=193.223.104.0/24]] = 0) do={ add list=$AddressList comment=AS60721 address=193.223.104.0/24 }
