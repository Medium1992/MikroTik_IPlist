...
:do {add list=$AddressList comment=AS60757 address=130.193.6.0/24} on-error {}
:do {add list=$AddressList comment=AS60757 address=185.217.188.0/24} on-error {}
:do {add list=$AddressList comment=AS60757 address=185.217.190.0/23} on-error {}
