...
:do {add list=$AddressList comment=AS60807 address=213.181.89.0/24} on-error {}
:do {add list=$AddressList comment=AS60807 address=213.181.90.0/23} on-error {}
...
:do {add list=$AddressList comment=AS60807 address=89.29.206.0/23} on-error {}
:do {add list=$AddressList comment=AS60807 address=89.29.225.0/24} on-error {}
