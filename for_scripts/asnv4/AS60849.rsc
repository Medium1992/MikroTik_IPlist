...
:if ([:len [find where list=$AddressList and address=185.218.85.0/24]] = 0) do={ add list=$AddressList comment=AS60849 address=185.218.85.0/24 }
...
:if ([:len [find where list=$AddressList and address=87.121.62.0/24]] = 0) do={ add list=$AddressList comment=AS60849 address=87.121.62.0/24 }
