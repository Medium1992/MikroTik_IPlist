...
:do {add list=$AddressList comment=AS6102 address=for_scripts/asnv4/AS6102.rsc} on-error {}
...
:do {add list=$AddressList comment=AS6102 address=8.12.120.0/24} on-error {}
