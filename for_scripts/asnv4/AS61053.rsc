...
:do {add list=$AddressList comment=AS61053 address=185.111.180.0/22} on-error {}
:do {add list=$AddressList comment=AS61053 address=185.169.140.0/22} on-error {}
:do {add list=$AddressList comment=AS61053 address=185.172.156.0/24} on-error {}
...
:do {add list=$AddressList comment=AS61053 address=94.176.188.0/24} on-error {}
