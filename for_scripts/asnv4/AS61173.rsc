...
:do {add list=$AddressList comment=AS61173 address=185.213.167.0/24} on-error {}
:do {add list=$AddressList comment=AS61173 address=185.255.88.0/22} on-error {}
:do {add list=$AddressList comment=AS61173 address=185.4.29.0/24} on-error {}
:do {add list=$AddressList comment=AS61173 address=185.4.30.0/23} on-error {}
...
:do {add list=$AddressList comment=AS61173 address=193.141.127.0/24} on-error {}
...
:do {add list=$AddressList comment=AS61173 address=85.208.254.0/24} on-error {}
