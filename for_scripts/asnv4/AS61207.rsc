...
:do {add list=$AddressList comment=AS61207 address=for_scripts/asnv4/AS61207.rsc} on-error {}
...
:do {add list=$AddressList comment=AS61207 address=192.121.56.0/24} on-error {}
