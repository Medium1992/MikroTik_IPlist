...
:do {add list=$AddressList comment=AS61213 address=91.123.48.0/21} on-error {}
:do {add list=$AddressList comment=AS61213 address=91.123.56.0/23} on-error {}
:do {add list=$AddressList comment=AS61213 address=91.123.60.0/22} on-error {}
