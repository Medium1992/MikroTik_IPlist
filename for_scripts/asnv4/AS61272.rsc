...
:do {add list=$AddressList comment=AS61272 address=107.149.18.0/24} on-error {}
:do {add list=$AddressList comment=AS61272 address=158.173.79.0/24} on-error {}
:do {add list=$AddressList comment=AS61272 address=178.83.26.0/24} on-error {}
...
:do {add list=$AddressList comment=AS61272 address=2.26.174.0/24} on-error {}
:do {add list=$AddressList comment=AS61272 address=213.252.228.0/22} on-error {}
:do {add list=$AddressList comment=AS61272 address=213.252.232.0/23} on-error {}
:do {add list=$AddressList comment=AS61272 address=213.252.238.0/23} on-error {}
...
:do {add list=$AddressList comment=AS61272 address=64.204.173.0/24} on-error {}
...
:do {add list=$AddressList comment=AS61272 address=89.117.211.0/24} on-error {}
:do {add list=$AddressList comment=AS61272 address=89.117.242.0/24} on-error {}
