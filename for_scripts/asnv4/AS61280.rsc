...
:if ([:len [find where list=$AddressList and address=185.224.228.0/24]] = 0) do={ add list=$AddressList comment=AS61280 address=185.224.228.0/24 }
:if ([:len [find where list=$AddressList and address=185.224.230.0/23]] = 0) do={ add list=$AddressList comment=AS61280 address=185.224.230.0/23 }
