...
:do {add list=$AddressList comment=AS61312 address=for_scripts/asnv4/AS61312.rsc} on-error {}
:do {add list=$AddressList comment=AS61312 address=31.148.25.0/24} on-error {}
