...
:if ([:len [find where list=$AddressList and address=103.213.244.0/24]] = 0) do={ add list=$AddressList comment=AS61414 address=103.213.244.0/24 }
...
:if ([:len [find where list=$AddressList and address=93.93.246.0/24]] = 0) do={ add list=$AddressList comment=AS61414 address=93.93.246.0/24 }
