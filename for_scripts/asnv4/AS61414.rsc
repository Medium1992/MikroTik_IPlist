...
:do {add list=$AddressList comment=AS61414 address=for_scripts/asnv4/AS61414.rsc} on-error {}
...
:do {add list=$AddressList comment=AS61414 address=154.217.248.0/21} on-error {}
