...
:do {add list=$AddressList comment=AS61588 address=for_scripts/asnv4/AS61588.rsc} on-error {}
:do {add list=$AddressList comment=AS61588 address=132.255.240.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=138.121.172.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=138.185.60.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=138.59.124.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=143.255.76.0/22} on-error {}
...
:do {add list=$AddressList comment=AS61588 address=170.233.224.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=170.245.24.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=170.246.228.0/22} on-error {}
...
:do {add list=$AddressList comment=AS61588 address=201.148.236.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=201.216.96.0/22} on-error {}
:do {add list=$AddressList comment=AS61588 address=45.179.176.0/22} on-error {}
