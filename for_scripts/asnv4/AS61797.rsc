...
:do {add list=$AddressList comment=AS61797 address=for_scripts/asnv4/AS61797.rsc} on-error {}
...
:do {add list=$AddressList comment=AS61797 address=200.225.140.0/23} on-error {}
