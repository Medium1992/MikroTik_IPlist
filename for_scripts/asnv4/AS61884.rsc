...
:do {add list=$AddressList comment=AS61884 address=for_scripts/asnv4/AS61884.rsc} on-error {}
:do {add list=$AddressList comment=AS61884 address=131.0.116.0/22} on-error {}
:do {add list=$AddressList comment=AS61884 address=201.182.147.0/24} on-error {}
