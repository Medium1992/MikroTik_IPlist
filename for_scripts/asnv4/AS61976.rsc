...
:do {add list=$AddressList comment=AS61976 address=109.172.96.0/22} on-error {}
:do {add list=$AddressList comment=AS61976 address=136.234.124.0/23} on-error {}
...
:do {add list=$AddressList comment=AS61976 address=92.242.62.0/23} on-error {}
