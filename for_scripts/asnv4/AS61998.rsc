...
:do {add list=$AddressList comment=AS61998 address=for_scripts/asnv4/AS61998.rsc} on-error {}
...
:do {add list=$AddressList comment=AS61998 address=37.17.170.0/24} on-error {}
