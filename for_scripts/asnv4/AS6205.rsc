...
:do {add list=$AddressList comment=AS6205 address=104.247.181.0/24} on-error {}
...
:do {add list=$AddressList comment=AS6205 address=185.157.40.0/24} on-error {}
...
:do {add list=$AddressList comment=AS6205 address=70.40.136.0/23} on-error {}
:do {add list=$AddressList comment=AS6205 address=85.189.14.0/24} on-error {}
