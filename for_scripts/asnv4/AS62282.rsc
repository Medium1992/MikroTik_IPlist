...
:do {add list=$AddressList comment=AS62282 address=for_scripts/asnv4/AS62282.rsc} on-error {}
:do {add list=$AddressList comment=AS62282 address=185.140.230.0/23} on-error {}
...
:do {add list=$AddressList comment=AS62282 address=193.34.233.0/24} on-error {}
:do {add list=$AddressList comment=AS62282 address=37.156.216.0/21} on-error {}
:do {add list=$AddressList comment=AS62282 address=89.47.172.0/22} on-error {}
