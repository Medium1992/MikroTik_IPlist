...
:do {add list=$AddressList comment=AS62300 address=178.212.78.0/24} on-error {}
...
:do {add list=$AddressList comment=AS62300 address=186.246.32.0/24} on-error {}
...
:do {add list=$AddressList comment=AS62300 address=62.204.32.0/24} on-error {}
