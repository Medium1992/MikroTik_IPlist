...
:do {add list=$AddressList comment=AS62314 address=for_scripts/asnv4/AS62314.rsc} on-error {}
...
:do {add list=$AddressList comment=AS62314 address=89.20.45.0/24} on-error {}
:do {add list=$AddressList comment=AS62314 address=89.20.46.0/23} on-error {}
