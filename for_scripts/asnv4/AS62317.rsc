...
:do {add list=$AddressList comment=AS62317 address=for_scripts/asnv4/AS62317.rsc} on-error {}
...
:do {add list=$AddressList comment=AS62317 address=185.66.78.0/24} on-error {}
