...
:do {add list=$AddressList comment=AS62370 address=37.148.163.0/24} on-error {}
...
:do {add list=$AddressList comment=AS62370 address=78.41.204.0/23} on-error {}
...
:do {add list=$AddressList comment=AS62370 address=89.207.134.0/24} on-error {}
