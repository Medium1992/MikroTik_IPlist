...
:do {add list=$AddressList comment=AS62425 address=185.229.12.0/24} on-error {}
:do {add list=$AddressList comment=AS62425 address=185.231.111.0/24} on-error {}
:do {add list=$AddressList comment=AS62425 address=188.132.215.0/24} on-error {}
