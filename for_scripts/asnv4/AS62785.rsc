...
:do {add list=$AddressList comment=AS62785 address=for_scripts/asnv4/AS62785.rsc} on-error {}
...
:do {add list=$AddressList comment=AS62785 address=172.96.98.0/23} on-error {}
