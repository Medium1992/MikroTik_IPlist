...
:if ([:len [find where list=$AddressList and address=208.97.18.0/24]] = 0) do={ add list=$AddressList comment=AS63010 address=208.97.18.0/24 }
...
:if ([:len [find where list=$AddressList and address=38.110.48.0/24]] = 0) do={ add list=$AddressList comment=AS63010 address=38.110.48.0/24 }
