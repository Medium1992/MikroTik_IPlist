...
:do {add list=$AddressList comment=AS63178 address=67.22.208.0/22} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.212.0/24} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.0/26} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.112/29} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.120/32} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.122/31} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.124/30} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.128/25} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.64/27} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.213.96/28} on-error {}
:do {add list=$AddressList comment=AS63178 address=67.22.214.0/23} on-error {}
