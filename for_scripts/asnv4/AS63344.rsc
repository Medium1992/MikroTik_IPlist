...
:do {add list=$AddressList comment=AS63344 address=206.180.26.0/24} on-error {}
:do {add list=$AddressList comment=AS63344 address=206.180.32.0/24} on-error {}
:do {add list=$AddressList comment=AS63344 address=206.180.34.0/24} on-error {}
...
:do {add list=$AddressList comment=AS63344 address=206.180.57.0/24} on-error {}
