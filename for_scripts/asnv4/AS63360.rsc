...
:if ([:len [find where list=$AddressList and address=168.225.40.0/21]] = 0) do={ add list=$AddressList comment=AS63360 address=168.225.40.0/21 }
:if ([:len [find where list=$AddressList and address=168.225.48.0/20]] = 0) do={ add list=$AddressList comment=AS63360 address=168.225.48.0/20 }
