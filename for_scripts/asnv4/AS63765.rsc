...
:do {add list=$AddressList comment=AS63765 address=for_scripts/asnv4/AS63765.rsc} on-error {}
...
:do {add list=$AddressList comment=AS63765 address=103.53.158.0/24} on-error {}
