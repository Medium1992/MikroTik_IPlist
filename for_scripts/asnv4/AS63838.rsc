...
:do {add list=$AddressList comment=AS63838 address=for_scripts/asnv4/AS63838.rsc} on-error {}
...
:do {add list=$AddressList comment=AS63838 address=203.56.227.0/24} on-error {}
