...
:do {add list=$AddressList comment=AS63897 address=103.127.237.0/24} on-error {}
:do {add list=$AddressList comment=AS63897 address=103.127.239.0/24} on-error {}
...
:do {add list=$AddressList comment=AS63897 address=161.248.160.0/23} on-error {}
