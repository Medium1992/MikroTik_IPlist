...
:if ([:len [find where list=$AddressList and address=81.168.76.0/24]] = 0) do={ add list=$AddressList comment=AS63902 address=81.168.76.0/24 }
:if ([:len [find where list=$AddressList and address=81.168.79.0/24]] = 0) do={ add list=$AddressList comment=AS63902 address=81.168.79.0/24 }
...
:if ([:len [find where list=$AddressList and address=96.62.152.0/24]] = 0) do={ add list=$AddressList comment=AS63902 address=96.62.152.0/24 }
