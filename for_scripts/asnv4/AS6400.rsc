...
:do {add list=$AddressList comment=AS6400 address=179.52.0.0/16} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.0.0/18} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.128.0/17} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.64.0/20} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.80.0/23} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.0/26} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.128/25} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.64/29} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.72/31} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.75/32} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.76/30} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.80/28} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.82.96/27} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.83.0/24} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.84.0/22} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.88.0/21} on-error {}
:do {add list=$AddressList comment=AS6400 address=179.53.96.0/19} on-error {}
