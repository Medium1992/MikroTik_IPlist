...
:do {add list=$AddressList comment=AS64013 address=for_scripts/asnv4/AS64013.rsc} on-error {}
...
:do {add list=$AddressList comment=AS64013 address=23.226.50.0/24} on-error {}
