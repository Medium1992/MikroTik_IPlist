...
:do {add list=$AddressList comment=AS64096 address=151.242.122.0/24} on-error {}
...
:do {add list=$AddressList comment=AS64096 address=31.132.44.0/23} on-error {}
:do {add list=$AddressList comment=AS64096 address=31.132.46.0/24} on-error {}
