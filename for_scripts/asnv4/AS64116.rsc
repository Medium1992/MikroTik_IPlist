...
:if ([:len [find where list=$AddressList and address=38.199.81.0/24]] = 0) do={ add list=$AddressList comment=AS64116 address=38.199.81.0/24 }
...
:if ([:len [find where list=$AddressList and address=38.56.122.0/23]] = 0) do={ add list=$AddressList comment=AS64116 address=38.56.122.0/23 }
