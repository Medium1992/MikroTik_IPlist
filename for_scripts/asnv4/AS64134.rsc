...
:do {add list=$AddressList comment=AS64134 address=for_scripts/asnv4/AS64134.rsc} on-error {}
:do {add list=$AddressList comment=AS64134 address=38.156.20.0/22} on-error {}
:do {add list=$AddressList comment=AS64134 address=38.156.253.0/24} on-error {}
...
:do {add list=$AddressList comment=AS64134 address=38.44.244.0/24} on-error {}
:do {add list=$AddressList comment=AS64134 address=38.44.246.0/23} on-error {}
