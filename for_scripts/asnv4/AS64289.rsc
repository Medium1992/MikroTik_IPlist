...
:do {add list=$AddressList comment=AS64289 address=for_scripts/asnv4/AS64289.rsc} on-error {}
...
:do {add list=$AddressList comment=AS64289 address=185.225.24.0/24} on-error {}
:do {add list=$AddressList comment=AS64289 address=185.225.26.0/24} on-error {}
:do {add list=$AddressList comment=AS64289 address=192.189.157.0/24} on-error {}
...
:do {add list=$AddressList comment=AS64289 address=23.151.136.0/24} on-error {}
:do {add list=$AddressList comment=AS64289 address=23.155.72.0/24} on-error {}
:do {add list=$AddressList comment=AS64289 address=23.161.232.0/24} on-error {}
