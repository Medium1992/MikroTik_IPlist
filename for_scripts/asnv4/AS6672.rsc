...
:do {add list=$AddressList comment=AS6672 address=for_scripts/asnv4/AS6672.rsc} on-error {}
:do {add list=$AddressList comment=AS6672 address=212.113.104.0/23} on-error {}
:do {add list=$AddressList comment=AS6672 address=212.113.108.0/24} on-error {}
:do {add list=$AddressList comment=AS6672 address=212.113.111.0/24} on-error {}
