...
:do {add list=$AddressList comment=AS6681 address=195.191.234.0/23} on-error {}
:do {add list=$AddressList comment=AS6681 address=2.152.66.0/24} on-error {}
:do {add list=$AddressList comment=AS6681 address=45.128.218.0/23} on-error {}
:do {add list=$AddressList comment=AS6681 address=45.13.27.0/24} on-error {}
