...
:do {add list=$AddressList comment=AS6698 address=178.83.5.0/24} on-error {}
:do {add list=$AddressList comment=AS6698 address=185.254.198.0/24} on-error {}
:do {add list=$AddressList comment=AS6698 address=185.66.91.0/24} on-error {}
...
:do {add list=$AddressList comment=AS6698 address=212.86.124.0/24} on-error {}
...
:do {add list=$AddressList comment=AS6698 address=40.223.190.0/24} on-error {}
...
:do {add list=$AddressList comment=AS6698 address=85.137.57.0/24} on-error {}
