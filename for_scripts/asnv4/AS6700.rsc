...
:do {add list=$AddressList comment=AS6700 address=for_scripts/asnv4/AS6700.rsc} on-error {}
...
:do {add list=$AddressList comment=AS6700 address=195.252.64.0/18} on-error {}
