...
:if ([:len [find where list=$AddressList and address=87.104.192.0/19]] = 0) do={ add list=$AddressList comment=AS6797 address=87.104.192.0/19 }
:if ([:len [find where list=$AddressList and address=87.104.233.0/24]] = 0) do={ add list=$AddressList comment=AS6797 address=87.104.233.0/24 }
:if ([:len [find where list=$AddressList and address=87.104.234.0/23]] = 0) do={ add list=$AddressList comment=AS6797 address=87.104.234.0/23 }
:if ([:len [find where list=$AddressList and address=87.104.236.0/22]] = 0) do={ add list=$AddressList comment=AS6797 address=87.104.236.0/22 }
