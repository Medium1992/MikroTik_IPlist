...
:do {add list=$AddressList comment=AS6798 address=for_scripts/asnv4/AS6798.rsc} on-error {}
:do {add list=$AddressList comment=AS6798 address=193.105.153.0/24} on-error {}
