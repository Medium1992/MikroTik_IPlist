...
:do {add list=$AddressList comment=AS6949 address=162.93.120.0/22} on-error {}
...
:do {add list=$AddressList comment=AS6949 address=162.93.177.0/24} on-error {}
:do {add list=$AddressList comment=AS6949 address=162.93.179.0/24} on-error {}
:do {add list=$AddressList comment=AS6949 address=162.93.185.0/24} on-error {}
:do {add list=$AddressList comment=AS6949 address=162.93.187.0/24} on-error {}
:do {add list=$AddressList comment=AS6949 address=162.93.188.0/24} on-error {}
...
:do {add list=$AddressList comment=AS6949 address=162.93.8.0/24} on-error {}
