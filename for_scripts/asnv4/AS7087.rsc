...
:if ([:len [find where list=$AddressList and address=200.13.208.0/22]] = 0) do={ add list=$AddressList comment=AS7087 address=200.13.208.0/22 }
:if ([:len [find where list=$AddressList and address=200.13.212.0/23]] = 0) do={ add list=$AddressList comment=AS7087 address=200.13.212.0/23 }
:if ([:len [find where list=$AddressList and address=200.13.214.0/24]] = 0) do={ add list=$AddressList comment=AS7087 address=200.13.214.0/24 }
:if ([:len [find where list=$AddressList and address=200.13.216.0/21]] = 0) do={ add list=$AddressList comment=AS7087 address=200.13.216.0/21 }
