...
:do {add list=$AddressList comment=AS7131 address=209.92.162.0/23} on-error {}
...
:do {add list=$AddressList comment=AS7131 address=49.128.104.0/23} on-error {}
:do {add list=$AddressList comment=AS7131 address=49.128.106.0/24} on-error {}
