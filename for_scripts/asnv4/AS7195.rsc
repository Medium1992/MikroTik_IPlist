...
:if ([:len [find where list=$AddressList and address=200.25.112.0/21]] = 0) do={ add list=$AddressList comment=AS7195 address=200.25.112.0/21 }
...
:if ([:len [find where list=$AddressList and address=200.25.120.0/23]] = 0) do={ add list=$AddressList comment=AS7195 address=200.25.120.0/23 }
:if ([:len [find where list=$AddressList and address=200.25.122.0/24]] = 0) do={ add list=$AddressList comment=AS7195 address=200.25.122.0/24 }
:if ([:len [find where list=$AddressList and address=200.25.124.0/22]] = 0) do={ add list=$AddressList comment=AS7195 address=200.25.124.0/22 }
...
:if ([:len [find where list=$AddressList and address=200.25.96.0/20]] = 0) do={ add list=$AddressList comment=AS7195 address=200.25.96.0/20 }
