...
:if ([:len [find where list=$AddressList and address=199.207.232.0/23]] = 0) do={ add list=$AddressList comment=AS7227 address=199.207.232.0/23 }
:if ([:len [find where list=$AddressList and address=199.207.234.0/24]] = 0) do={ add list=$AddressList comment=AS7227 address=199.207.234.0/24 }
