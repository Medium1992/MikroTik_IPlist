...
:if ([:len [find where list=$AddressList and address=210.56.18.0/24]] = 0) do={ add list=$AddressList comment=AS7590 address=210.56.18.0/24 }
...
:if ([:len [find where list=$AddressList and address=210.56.20.0/22]] = 0) do={ add list=$AddressList comment=AS7590 address=210.56.20.0/22 }
