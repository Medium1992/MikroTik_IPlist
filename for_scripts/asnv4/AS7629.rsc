...
:if ([:len [find where list=$AddressList and address=202.57.104.0/22]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.104.0/22 }
:if ([:len [find where list=$AddressList and address=202.57.108.0/23]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.108.0/23 }
:if ([:len [find where list=$AddressList and address=202.57.111.0/24]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.111.0/24 }
:if ([:len [find where list=$AddressList and address=202.57.115.0/24]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.115.0/24 }
:if ([:len [find where list=$AddressList and address=202.57.117.0/24]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.117.0/24 }
:if ([:len [find where list=$AddressList and address=202.57.118.0/23]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.118.0/23 }
:if ([:len [find where list=$AddressList and address=202.57.120.0/21]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.120.0/21 }
:if ([:len [find where list=$AddressList and address=202.57.64.0/19]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.64.0/19 }
:if ([:len [find where list=$AddressList and address=202.57.96.0/21]] = 0) do={ add list=$AddressList comment=AS7629 address=202.57.96.0/21 }
