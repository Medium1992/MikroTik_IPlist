...
:if ([:len [find where list=$AddressList and address=207.62.160.0/23]] = 0) do={ add list=$AddressList comment=AS7960 address=207.62.160.0/23 }
:if ([:len [find where list=$AddressList and address=207.62.163.0/24]] = 0) do={ add list=$AddressList comment=AS7960 address=207.62.163.0/24 }
:if ([:len [find where list=$AddressList and address=207.62.164.0/22]] = 0) do={ add list=$AddressList comment=AS7960 address=207.62.164.0/22 }
