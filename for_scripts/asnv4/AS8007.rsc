...
:do {add list=$AddressList comment=AS8007 address=207.249.72.0/23} on-error {}
:do {add list=$AddressList comment=AS8007 address=207.249.74.0/24} on-error {}
:do {add list=$AddressList comment=AS8007 address=207.249.76.0/22} on-error {}
