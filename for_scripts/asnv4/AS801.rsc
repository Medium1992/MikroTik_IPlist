...
:do {add list=$AddressList comment=AS801 address=35.96.24.0/23} on-error {}
...
:do {add list=$AddressList comment=AS801 address=35.97.131.0/24} on-error {}
:do {add list=$AddressList comment=AS801 address=35.97.193.0/24} on-error {}
