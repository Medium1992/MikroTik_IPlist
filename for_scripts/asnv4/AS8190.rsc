...
:do {add list=$AddressList comment=AS8190 address=for_scripts/asnv4/AS8190.rsc} on-error {}
...
:do {add list=$AddressList comment=AS8190 address=212.134.79.0/24} on-error {}
