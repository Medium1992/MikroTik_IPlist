...
:do {add list=$AddressList comment=AS8282 address=for_scripts/asnv4/AS8282.rsc} on-error {}
...
:do {add list=$AddressList comment=AS8282 address=80.252.124.0/22} on-error {}
