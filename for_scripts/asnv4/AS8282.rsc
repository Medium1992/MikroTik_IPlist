...
:do {add list=$AddressList comment=AS8282 address=192.88.83.0/24} on-error {}
...
:do {add list=$AddressList comment=AS8282 address=45.67.248.0/22} on-error {}
...
:do {add list=$AddressList comment=AS8282 address=84.246.192.0/23} on-error {}
:do {add list=$AddressList comment=AS8282 address=93.188.180.0/23} on-error {}
