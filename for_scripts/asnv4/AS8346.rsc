...
:do {add list=$AddressList comment=AS8346 address=196.1.96.0/24} on-error {}
:do {add list=$AddressList comment=AS8346 address=196.1.98.0/23} on-error {}
...
:do {add list=$AddressList comment=AS8346 address=80.15.245.0/24} on-error {}
