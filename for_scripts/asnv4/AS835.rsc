...
:if ([:len [find where list=$AddressList and address=153.76.3.0/24]] = 0) do={ add list=$AddressList comment=AS835 address=153.76.3.0/24 }
:if ([:len [find where list=$AddressList and address=153.76.6.0/23]] = 0) do={ add list=$AddressList comment=AS835 address=153.76.6.0/23 }
