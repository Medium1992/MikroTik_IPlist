...
:do {add list=$AddressList comment=AS8393 address=193.193.224.0/22} on-error {}
:do {add list=$AddressList comment=AS8393 address=193.193.229.0/24} on-error {}
:do {add list=$AddressList comment=AS8393 address=193.193.230.0/23} on-error {}
:do {add list=$AddressList comment=AS8393 address=193.193.232.0/21} on-error {}
:do {add list=$AddressList comment=AS8393 address=193.193.240.0/20} on-error {}
...
:do {add list=$AddressList comment=AS8393 address=93.183.96.0/23} on-error {}
