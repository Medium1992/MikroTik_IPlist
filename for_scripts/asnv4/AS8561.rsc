...
:do {add list=$AddressList comment=AS8561 address=185.95.98.0/23} on-error {}
...
:do {add list=$AddressList comment=AS8561 address=195.253.88.0/23} on-error {}
:do {add list=$AddressList comment=AS8561 address=195.253.92.0/22} on-error {}
