...
:if ([:len [find where list=$AddressList and address=195.114.224.0/21]] = 0) do={ add list=$AddressList comment=AS8587 address=195.114.224.0/21 }
:if ([:len [find where list=$AddressList and address=195.114.232.0/22]] = 0) do={ add list=$AddressList comment=AS8587 address=195.114.232.0/22 }
:if ([:len [find where list=$AddressList and address=195.114.236.0/23]] = 0) do={ add list=$AddressList comment=AS8587 address=195.114.236.0/23 }
