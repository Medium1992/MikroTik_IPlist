...
:if ([:len [find where list=$AddressList and address=91.209.14.0/24]] = 0) do={ add list=$AddressList comment=AS8587 address=91.209.14.0/24 }
:if ([:len [find where list=$AddressList and address=91.209.21.0/24]] = 0) do={ add list=$AddressList comment=AS8587 address=91.209.21.0/24 }
:if ([:len [find where list=$AddressList and address=91.209.22.0/24]] = 0) do={ add list=$AddressList comment=AS8587 address=91.209.22.0/24 }
