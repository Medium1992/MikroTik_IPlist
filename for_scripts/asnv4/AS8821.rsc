...
:do {add list=$AddressList comment=AS8821 address=for_scripts/asnv4/AS8821.rsc} on-error {}
...
:do {add list=$AddressList comment=AS8821 address=62.171.0.0/17} on-error {}
