...
:if ([:len [find where list=$AddressList and address=147.237.72.0/23]] = 0) do={ add list=$AddressList comment=AS8867 address=147.237.72.0/23 }
...
:if ([:len [find where list=$AddressList and address=147.237.80.0/24]] = 0) do={ add list=$AddressList comment=AS8867 address=147.237.80.0/24 }
