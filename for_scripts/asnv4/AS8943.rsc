...
:do {add list=$AddressList comment=AS8943 address=for_scripts/asnv4/AS8943.rsc} on-error {}
...
:do {add list=$AddressList comment=AS8943 address=46.255.72.0/22} on-error {}
:do {add list=$AddressList comment=AS8943 address=46.255.77.0/24} on-error {}
:do {add list=$AddressList comment=AS8943 address=46.255.78.0/23} on-error {}
