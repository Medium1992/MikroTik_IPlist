...
:do {add list=$AddressList comment=AS8985 address=for_scripts/asnv4/AS8985.rsc} on-error {}
...
:do {add list=$AddressList comment=AS8985 address=193.232.76.0/24} on-error {}
