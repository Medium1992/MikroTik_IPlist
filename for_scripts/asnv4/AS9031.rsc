...
:do {add list=$AddressList comment=AS9031 address=for_scripts/asnv4/AS9031.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9031 address=212.233.32.0/31} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.32.128/25} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.32.16/28} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.32.3/32} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.32.32/27} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.32.4/30} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.32.64/26} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.32.8/29} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.33.0/24} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.34.0/23} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.36.0/22} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.40.0/21} on-error {}
:do {add list=$AddressList comment=AS9031 address=212.233.48.0/20} on-error {}
