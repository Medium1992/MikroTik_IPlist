...
:do {add list=$AddressList comment=AS9076 address=for_scripts/asnv4/AS9076.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9076 address=212.104.43.0/24} on-error {}
