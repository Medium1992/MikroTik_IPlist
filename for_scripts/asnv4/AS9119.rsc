...
:do {add list=$AddressList comment=AS9119 address=for_scripts/asnv4/AS9119.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9119 address=45.15.44.0/22} on-error {}
