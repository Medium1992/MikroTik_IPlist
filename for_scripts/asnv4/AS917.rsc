...
:do {add list=$AddressList comment=AS917 address=38.175.100.0/23} on-error {}
:do {add list=$AddressList comment=AS917 address=38.175.102.0/24} on-error {}
...
:do {add list=$AddressList comment=AS917 address=38.175.96.0/22} on-error {}
