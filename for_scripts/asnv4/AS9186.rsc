...
:do {add list=$AddressList comment=AS9186 address=for_scripts/asnv4/AS9186.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9186 address=84.252.88.0/22} on-error {}
