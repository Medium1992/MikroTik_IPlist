...
:do {add list=$AddressList comment=AS9230 address=103.129.245.0/24} on-error {}
:do {add list=$AddressList comment=AS9230 address=103.129.246.0/23} on-error {}
...
:do {add list=$AddressList comment=AS9230 address=150.129.16.0/23} on-error {}
