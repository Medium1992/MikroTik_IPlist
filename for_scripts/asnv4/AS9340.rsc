...
:do {add list=$AddressList comment=AS9340 address=for_scripts/asnv4/AS9340.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9340 address=202.53.203.0/24} on-error {}
