...
:if ([:len [find where list=$AddressList and address=180.178.137.0/24]] = 0) do={ add list=$AddressList comment=AS9387 address=180.178.137.0/24 }
:if ([:len [find where list=$AddressList and address=180.178.138.0/23]] = 0) do={ add list=$AddressList comment=AS9387 address=180.178.138.0/23 }
...
:if ([:len [find where list=$AddressList and address=180.178.175.0/24]] = 0) do={ add list=$AddressList comment=AS9387 address=180.178.175.0/24 }
