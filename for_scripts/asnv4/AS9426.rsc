...
:if ([:len [find where list=$AddressList and address=110.5.80.0/20]] = 0) do={ add list=$AddressList comment=AS9426 address=110.5.80.0/20 }
...
:if ([:len [find where list=$AddressList and address=166.120.58.0/23]] = 0) do={ add list=$AddressList comment=AS9426 address=166.120.58.0/23 }
:if ([:len [find where list=$AddressList and address=166.120.64.0/19]] = 0) do={ add list=$AddressList comment=AS9426 address=166.120.64.0/19 }
