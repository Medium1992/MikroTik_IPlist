...
:do {add list=$AddressList comment=AS9464 address=202.29.144.0/24} on-error {}
:do {add list=$AddressList comment=AS9464 address=202.29.146.0/23} on-error {}
:do {add list=$AddressList comment=AS9464 address=202.29.148.0/22} on-error {}
