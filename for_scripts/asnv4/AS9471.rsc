...
:do {add list=$AddressList comment=AS9471 address=for_scripts/asnv4/AS9471.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9471 address=64.140.153.0/24} on-error {}
