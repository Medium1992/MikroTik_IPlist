...
:do {add list=$AddressList comment=AS964 address=for_scripts/asnv4/AS964.rsc} on-error {}
...
:do {add list=$AddressList comment=AS964 address=45.61.144.0/23} on-error {}
