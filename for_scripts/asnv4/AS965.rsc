...
:do {add list=$AddressList comment=AS965 address=for_scripts/asnv4/AS965.rsc} on-error {}
:do {add list=$AddressList comment=AS965 address=160.30.208.0/24} on-error {}
:do {add list=$AddressList comment=AS965 address=162.244.94.0/23} on-error {}
