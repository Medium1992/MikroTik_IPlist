...
:do {add list=$AddressList comment=AS9691 address=for_scripts/asnv4/AS9691.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9691 address=134.75.197.0/24} on-error {}
