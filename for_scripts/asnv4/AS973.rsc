...
:if ([:len [find where list=$AddressList and address=209.151.108.0/23]] = 0) do={ add list=$AddressList comment=AS973 address=209.151.108.0/23 }
:if ([:len [find where list=$AddressList and address=209.151.110.0/24]] = 0) do={ add list=$AddressList comment=AS973 address=209.151.110.0/24 }
