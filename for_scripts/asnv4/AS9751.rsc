...
:do {add list=$AddressList comment=AS9751 address=for_scripts/asnv4/AS9751.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9751 address=66.178.14.0/24} on-error {}
:do {add list=$AddressList comment=AS9751 address=66.178.5.0/24} on-error {}
