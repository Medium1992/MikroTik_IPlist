...
:do {add list=$AddressList comment=AS976 address=for_scripts/asnv4/AS976.rsc} on-error {}
...
:do {add list=$AddressList comment=AS976 address=103.177.45.0/24} on-error {}
