...
:do {add list=$AddressList comment=AS9764 address=113.29.184.0/22} on-error {}
:do {add list=$AddressList comment=AS9764 address=113.29.188.0/24} on-error {}
:do {add list=$AddressList comment=AS9764 address=113.29.190.0/23} on-error {}
