...
:if ([:len [find where list=$AddressList and address=114.128.96.0/23]] = 0) do={ add list=$AddressList comment=AS9871 address=114.128.96.0/23 }
...
:if ([:len [find where list=$AddressList and address=204.187.250.0/23]] = 0) do={ add list=$AddressList comment=AS9871 address=204.187.250.0/23 }
