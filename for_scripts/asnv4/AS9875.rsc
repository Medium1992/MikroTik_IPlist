...
:if ([:len [find where list=$AddressList and address=103.169.122.0/23]] = 0) do={ add list=$AddressList comment=AS9875 address=103.169.122.0/23 }
...
:if ([:len [find where list=$AddressList and address=202.182.164.0/22]] = 0) do={ add list=$AddressList comment=AS9875 address=202.182.164.0/22 }
...
:if ([:len [find where list=$AddressList and address=202.95.128.0/20]] = 0) do={ add list=$AddressList comment=AS9875 address=202.95.128.0/20 }
:if ([:len [find where list=$AddressList and address=202.95.144.0/21]] = 0) do={ add list=$AddressList comment=AS9875 address=202.95.144.0/21 }
:if ([:len [find where list=$AddressList and address=202.95.152.0/23]] = 0) do={ add list=$AddressList comment=AS9875 address=202.95.152.0/23 }
:if ([:len [find where list=$AddressList and address=202.95.154.0/24]] = 0) do={ add list=$AddressList comment=AS9875 address=202.95.154.0/24 }
:if ([:len [find where list=$AddressList and address=202.95.156.0/22]] = 0) do={ add list=$AddressList comment=AS9875 address=202.95.156.0/22 }
