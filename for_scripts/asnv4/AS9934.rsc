...
:do {add list=$AddressList comment=AS9934 address=for_scripts/asnv4/AS9934.rsc} on-error {}
...
:do {add list=$AddressList comment=AS9934 address=202.179.24.0/21} on-error {}
...
:do {add list=$AddressList comment=AS9934 address=202.5.196.0/24} on-error {}
