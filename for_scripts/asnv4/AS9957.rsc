...
:do {add list=$AddressList comment=AS9957 address=1.201.134.0/24} on-error {}
:do {add list=$AddressList comment=AS9957 address=1.201.182.0/24} on-error {}
:do {add list=$AddressList comment=AS9957 address=1.201.210.0/24} on-error {}
:do {add list=$AddressList comment=AS9957 address=1.201.42.0/24} on-error {}
...
:do {add list=$AddressList comment=AS9957 address=139.150.217.0/24} on-error {}
:do {add list=$AddressList comment=AS9957 address=139.150.223.0/24} on-error {}
:do {add list=$AddressList comment=AS9957 address=182.161.125.0/24} on-error {}
...
:do {add list=$AddressList comment=AS9957 address=49.50.48.0/24} on-error {}
:do {add list=$AddressList comment=AS9957 address=49.50.50.0/23} on-error {}
:do {add list=$AddressList comment=AS9957 address=49.50.52.0/23} on-error {}
