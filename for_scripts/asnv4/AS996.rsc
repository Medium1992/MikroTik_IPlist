...
:do {add list=$AddressList comment=AS996 address=for_scripts/asnv4/AS996.rsc} on-error {}
...
:do {add list=$AddressList comment=AS996 address=178.92.44.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=178.93.117.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=178.93.121.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=178.94.168.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=178.94.175.0/24} on-error {}
...
:do {add list=$AddressList comment=AS996 address=92.112.36.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=92.112.38.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=92.112.7.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=92.113.169.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=92.113.247.0/24} on-error {}
:do {add list=$AddressList comment=AS996 address=92.113.56.0/22} on-error {}
