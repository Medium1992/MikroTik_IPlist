...
:do {add list=$AddressList comment=aistudio.google.com address=172.253.0.0/16} on-error {}
:do {add list=$AddressList comment=aistudio.google.com address=173.194.0.0/16} on-error {}
:do {add list=$AddressList comment=aistudio.google.com address=192.178.0.0/15} on-error {}
