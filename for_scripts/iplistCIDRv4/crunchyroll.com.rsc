...
:do {add list=$AddressList comment=crunchyroll.com address=13.248.0.0/14} on-error {}
...
:do {add list=$AddressList comment=crunchyroll.com address=75.2.0.0/17} on-error {}
:do {add list=$AddressList comment=crunchyroll.com address=76.223.0.0/17} on-error {}
...
:do {add list=$AddressList comment=crunchyroll.com address=99.83.128.0/17} on-error {}
