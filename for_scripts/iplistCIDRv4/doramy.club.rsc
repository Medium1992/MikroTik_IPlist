...
:do {add list=$AddressList comment=doramy.club address=193.233.63.0/24} on-error {}
:do {add list=$AddressList comment=doramy.club address=5.252.32.0/22} on-error {}
