...
:do {add list=$AddressList comment=euronews.com address=34.250.0.0/15} on-error {}
...
:do {add list=$AddressList comment=euronews.com address=52.19.55.201/32} on-error {}
