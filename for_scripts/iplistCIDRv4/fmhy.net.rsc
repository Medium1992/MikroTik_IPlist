...
:if ([:len [find where list=$AddressList and address=82.192.80.0/24]] = 0) do={ add list=$AddressList comment=fmhy.net address=82.192.80.0/24 }
...
:if ([:len [find where list=$AddressList and address=95.211.136.160/27]] = 0) do={ add list=$AddressList comment=fmhy.net address=95.211.136.160/27 }
