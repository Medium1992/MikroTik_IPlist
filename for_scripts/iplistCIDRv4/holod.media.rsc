...
:do {add list=$AddressList comment=holod.media address=104.21.0.0/16} on-error {}
...
:do {add list=$AddressList comment=holod.media address=172.67.134.19/32} on-error {}
