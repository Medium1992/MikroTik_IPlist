...
:if ([:len [find where list=$AddressList and address=104.20.26.66/32]] = 0) do={ add list=$AddressList comment=navalny.com address=104.20.26.66/32 }
...
:if ([:len [find where list=$AddressList and address=172.66.156.251/32]] = 0) do={ add list=$AddressList comment=navalny.com address=172.66.156.251/32 }
