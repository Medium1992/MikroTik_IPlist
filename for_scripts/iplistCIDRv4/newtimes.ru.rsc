...
:do {add list=$AddressList comment=newtimes.ru address=104.21.72.246/32} on-error {}
:do {add list=$AddressList comment=newtimes.ru address=172.67.136.177/32} on-error {}
