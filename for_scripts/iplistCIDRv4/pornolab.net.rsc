...
:do {add list=$AddressList comment=pornolab.net address=18.141.199.30/32} on-error {}
:do {add list=$AddressList comment=pornolab.net address=18.141.222.153/32} on-error {}
