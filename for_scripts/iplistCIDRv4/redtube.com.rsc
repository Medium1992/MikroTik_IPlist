...
:do {add list=$AddressList comment=redtube.com address=208.99.64.0/19} on-error {}
:do {add list=$AddressList comment=redtube.com address=216.18.160.0/19} on-error {}
