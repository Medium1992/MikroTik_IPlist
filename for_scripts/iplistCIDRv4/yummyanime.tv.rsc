...
:do {add list=$AddressList comment=yummyanime.tv address=186.2.165.0/24} on-error {}
...
:do {add list=$AddressList comment=yummyanime.tv address=81.161.98.0/23} on-error {}
