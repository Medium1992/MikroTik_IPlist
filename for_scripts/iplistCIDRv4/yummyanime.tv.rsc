...
:do {add list=$AddressList comment=yummyanime.tv address=176.58.38.0/23} on-error {}
:do {add list=$AddressList comment=yummyanime.tv address=176.58.48.0/23} on-error {}
:do {add list=$AddressList comment=yummyanime.tv address=176.58.56.0/24} on-error {}
...
:do {add list=$AddressList comment=yummyanime.tv address=190.115.16.0/24} on-error {}
