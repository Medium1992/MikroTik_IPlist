...
:if ([:len [find where list=$AddressList and address=3.209.247.145]] = 0) do={ add list=$AddressList comment=grammarly.com address=3.209.247.145 }
...
:if ([:len [find where list=$AddressList and address=3.209.91.235]] = 0) do={ add list=$AddressList comment=grammarly.com address=3.209.91.235 }
