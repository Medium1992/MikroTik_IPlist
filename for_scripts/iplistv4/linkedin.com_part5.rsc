...
:if ([:len [find where list=$AddressList and address=23.196.236.27]] = 0) do={ add list=$AddressList comment=linkedin.com address=23.196.236.27 }
...
:if ([:len [find where list=$AddressList and address=23.196.236.35]] = 0) do={ add list=$AddressList comment=linkedin.com address=23.196.236.35 }
