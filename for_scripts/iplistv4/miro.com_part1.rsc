...
:if ([:len [find where list=$AddressList and address=108.128.62.188]] = 0) do={ add list=$AddressList comment=miro.com address=108.128.62.188 }
...
:if ([:len [find where list=$AddressList and address=108.128.9.11]] = 0) do={ add list=$AddressList comment=miro.com address=108.128.9.11 }
...
:if ([:len [find where list=$AddressList and address=108.132.67.213]] = 0) do={ add list=$AddressList comment=miro.com address=108.132.67.213 }
