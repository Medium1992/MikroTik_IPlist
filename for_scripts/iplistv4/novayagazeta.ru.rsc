...
:do {add list=$AddressList comment=novayagazeta.ru address=104.20.34.97} on-error {}
...
:do {add list=$AddressList comment=novayagazeta.ru address=172.66.169.237} on-error {}
