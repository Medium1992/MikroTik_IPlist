...
:if ([:len [find where list=$AddressList and address=67.22.55.18]] = 0) do={ add list=$AddressList comment=redtube.com address=67.22.55.18 }
:if ([:len [find where list=$AddressList and address=67.22.55.19]] = 0) do={ add list=$AddressList comment=redtube.com address=67.22.55.19 }
:if ([:len [find where list=$AddressList and address=67.22.55.20]] = 0) do={ add list=$AddressList comment=redtube.com address=67.22.55.20 }
:if ([:len [find where list=$AddressList and address=67.22.55.21]] = 0) do={ add list=$AddressList comment=redtube.com address=67.22.55.21 }
:if ([:len [find where list=$AddressList and address=67.22.55.22]] = 0) do={ add list=$AddressList comment=redtube.com address=67.22.55.22 }
:if ([:len [find where list=$AddressList and address=67.22.55.23]] = 0) do={ add list=$AddressList comment=redtube.com address=67.22.55.23 }
