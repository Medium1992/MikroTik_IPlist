...
:do { add dynamic=yes list=$AddressList comment=tor address=1.2.220.75/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=103.107.198.251/32 } on-error={}
