...
:do { add dynamic=yes list=$AddressList comment=tor address=101.109.173.229/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=103.69.224.24/32 } on-error={}
