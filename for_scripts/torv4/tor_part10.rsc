...
:do { add dynamic=yes list=$AddressList comment=tor address=192.119.55.89/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=192.119.62.232/32 } on-error={}
