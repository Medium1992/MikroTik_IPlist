...
:do { add dynamic=yes list=$AddressList comment=tor address=192.210.133.13/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=192.248.182.52/32 } on-error={}
