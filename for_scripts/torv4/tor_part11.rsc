...
:do { add dynamic=yes list=$AddressList comment=tor address=194.113.194.66/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=194.15.36.92/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.154.5/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.159.2/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.175.145/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=198.167.206.129/32 } on-error={}
