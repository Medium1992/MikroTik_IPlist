...
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.185.159/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.30.160/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.53.240/32 } on-error={}
