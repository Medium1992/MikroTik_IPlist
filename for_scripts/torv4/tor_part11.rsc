...
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.161.235/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.59.41/32 } on-error={}
