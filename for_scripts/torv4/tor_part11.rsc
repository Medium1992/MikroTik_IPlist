...
:do { add dynamic=yes list=$AddressList comment=tor address=195.52.183.83/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=198.167.206.138/32 } on-error={}
