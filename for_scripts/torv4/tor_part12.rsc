...
:do { add dynamic=yes list=$AddressList comment=tor address=2.155.26.37/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=2.243.157.182/32 } on-error={}
