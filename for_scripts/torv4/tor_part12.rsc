...
:do { add dynamic=yes list=$AddressList comment=tor address=2.241.152.2/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=2.245.11.77/32 } on-error={}
