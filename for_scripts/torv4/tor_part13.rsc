...
:do { add dynamic=yes list=$AddressList comment=tor address=212.100.55.229/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=212.53.243.160/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=213.232.102.177/32 } on-error={}
