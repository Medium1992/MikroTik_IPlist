...
:do { add dynamic=yes list=$AddressList comment=tor address=212.146.146.111/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=212.53.230.44/32 } on-error={}
