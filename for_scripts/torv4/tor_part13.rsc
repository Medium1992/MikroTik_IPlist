...
:do { add dynamic=yes list=$AddressList comment=tor address=212.53.238.13/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=212.92.104.210/32 } on-error={}
