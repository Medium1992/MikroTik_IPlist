...
:do { add dynamic=yes list=$AddressList comment=tor address=212.146.159.83/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=212.53.252.31/32 } on-error={}
