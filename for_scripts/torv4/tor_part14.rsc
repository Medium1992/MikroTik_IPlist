...
:do { add dynamic=yes list=$AddressList comment=tor address=217.25.173.13/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=217.82.97.86/32 } on-error={}
