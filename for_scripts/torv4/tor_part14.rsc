...
:do { add dynamic=yes list=$AddressList comment=tor address=217.82.100.87/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=23.172.120.24/32 } on-error={}
