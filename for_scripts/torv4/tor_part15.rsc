...
:do { add dynamic=yes list=$AddressList comment=tor address=23.254.208.25/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=37.115.248.92/32 } on-error={}
