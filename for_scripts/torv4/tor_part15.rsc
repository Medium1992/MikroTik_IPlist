...
:do { add dynamic=yes list=$AddressList comment=tor address=24.16.56.93/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=36.225.56.209/32 } on-error={}
