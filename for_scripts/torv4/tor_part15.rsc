...
:do { add dynamic=yes list=$AddressList comment=tor address=37.120.25.139/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=37.152.231.57/32 } on-error={}
