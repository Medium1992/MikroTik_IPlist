...
:do { add dynamic=yes list=$AddressList comment=tor address=45.61.138.161/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=45.61.139.109/32 } on-error={}
