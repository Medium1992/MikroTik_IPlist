...
:do { add dynamic=yes list=$AddressList comment=tor address=45.74.60.90/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=46.29.25.144/32 } on-error={}
