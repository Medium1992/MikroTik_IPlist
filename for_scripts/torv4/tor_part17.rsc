...
:do { add dynamic=yes list=$AddressList comment=tor address=45.76.234.136/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=46.142.14.53/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=46.22.157.113/32 } on-error={}
