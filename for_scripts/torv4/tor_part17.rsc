...
:do { add dynamic=yes list=$AddressList comment=tor address=45.74.60.134/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=46.142.14.245/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=5.10.44.249/32 } on-error={}
