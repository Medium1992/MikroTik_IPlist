...
:do { add dynamic=yes list=$AddressList comment=tor address=45.74.60.54/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=46.142.15.112/32 } on-error={}
