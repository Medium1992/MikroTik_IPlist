...
:do { add dynamic=yes list=$AddressList comment=tor address=51.158.248.216/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=51.37.36.243/32 } on-error={}
