...
:do { add dynamic=yes list=$AddressList comment=tor address=51.37.78.178/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=62.144.228.144/32 } on-error={}
