...
:do { add dynamic=yes list=$AddressList comment=tor address=5.187.245.235/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=50.125.221.252/32 } on-error={}
