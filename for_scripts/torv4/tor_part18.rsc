...
:do { add dynamic=yes list=$AddressList comment=tor address=5.69.209.10/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=54.237.185.183/32 } on-error={}
