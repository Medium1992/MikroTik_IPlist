...
:do { add dynamic=yes list=$AddressList comment=tor address=62.27.197.244/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=62.93.16.232/32 } on-error={}
