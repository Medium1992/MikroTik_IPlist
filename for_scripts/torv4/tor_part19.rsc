...
:do { add dynamic=yes list=$AddressList comment=tor address=62.27.252.207/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=62.93.14.231/32 } on-error={}
