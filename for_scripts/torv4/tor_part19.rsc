...
:do { add dynamic=yes list=$AddressList comment=tor address=62.246.39.221/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=62.27.235.45/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=62.93.9.109/32 } on-error={}
