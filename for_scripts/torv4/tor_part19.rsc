...
:do { add dynamic=yes list=$AddressList comment=tor address=62.246.44.134/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=62.27.212.150/32 } on-error={}
