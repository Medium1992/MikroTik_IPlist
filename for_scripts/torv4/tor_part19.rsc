...
:do { add dynamic=yes list=$AddressList comment=tor address=62.246.42.173/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=62.27.246.176/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=62.93.11.199/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=62.93.28.83/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=64.226.109.220/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=64.43.157.153/32 } on-error={}
