...
:do { add dynamic=yes list=$AddressList comment=tor address=62.144.248.131/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=62.93.27.219/32 } on-error={}
