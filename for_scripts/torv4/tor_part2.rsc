...
:do { add dynamic=yes list=$AddressList comment=tor address=109.134.79.46/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=134.236.55.189/32 } on-error={}
