...
:do { add dynamic=yes list=$AddressList comment=tor address=108.53.56.102/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=109.78.209.144/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=110.77.176.150/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=124.168.217.195/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=125.24.200.97/32 } on-error={}
