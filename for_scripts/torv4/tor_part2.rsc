...
:do { add dynamic=yes list=$AddressList comment=tor address=124.149.229.68/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=125.24.199.12/32 } on-error={}
