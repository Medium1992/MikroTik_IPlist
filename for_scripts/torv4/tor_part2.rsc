...
:do { add dynamic=yes list=$AddressList comment=tor address=110.77.176.175/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=125.25.133.103/32 } on-error={}
