...
:do { add dynamic=yes list=$AddressList comment=tor address=109.250.46.165/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=109.79.191.174/32 } on-error={}
