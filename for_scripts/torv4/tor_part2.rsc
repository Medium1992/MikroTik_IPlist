...
:do { add dynamic=yes list=$AddressList comment=tor address=130.17.12.187/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=134.236.54.66/32 } on-error={}
