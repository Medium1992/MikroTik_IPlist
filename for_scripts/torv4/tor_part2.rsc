...
:do { add dynamic=yes list=$AddressList comment=tor address=110.78.134.114/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=125.24.203.115/32 } on-error={}
