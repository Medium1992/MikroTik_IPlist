...
:do { add dynamic=yes list=$AddressList comment=tor address=109.250.47.207/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=109.79.59.5/32 } on-error={}
