...
:do { add dynamic=yes list=$AddressList comment=tor address=109.250.47.97/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=109.78.48.49/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=110.77.154.157/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=114.188.80.227/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=125.25.140.218/32 } on-error={}
