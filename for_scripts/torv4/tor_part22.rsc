...
:do { add dynamic=yes list=$AddressList comment=tor address=66.179.31.212/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=69.48.229.86/32 } on-error={}
