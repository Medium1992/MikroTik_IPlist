...
:do { add dynamic=yes list=$AddressList comment=tor address=79.239.31.20/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=79.51.107.68/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=80.171.123.231/32 } on-error={}
