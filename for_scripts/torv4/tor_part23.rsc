...
:do { add dynamic=yes list=$AddressList comment=tor address=74.15.97.81/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=79.206.208.201/32 } on-error={}
