...
:do { add dynamic=yes list=$AddressList comment=tor address=79.27.226.220/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=80.145.222.53/32 } on-error={}
