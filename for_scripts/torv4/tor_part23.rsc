...
:do { add dynamic=yes list=$AddressList comment=tor address=80.145.217.8/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=81.243.206.11/32 } on-error={}
