...
:do { add dynamic=yes list=$AddressList comment=tor address=70.54.130.87/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=77.3.209.246/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=79.14.42.229/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=8.215.7.203/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=80.176.198.156/32 } on-error={}
