...
:do { add dynamic=yes list=$AddressList comment=tor address=79.250.235.123/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=80.145.222.130/32 } on-error={}
