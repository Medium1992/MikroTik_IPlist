...
:do { add dynamic=yes list=$AddressList comment=tor address=80.228.207.163/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.242.56.17/32 } on-error={}
