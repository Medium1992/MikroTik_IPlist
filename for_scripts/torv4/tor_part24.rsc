...
:do { add dynamic=yes list=$AddressList comment=tor address=81.25.175.188/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=82.135.76.29/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=82.174.147.169/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.135.166.28/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.173.151.131/32 } on-error={}
