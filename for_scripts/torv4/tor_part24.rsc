...
:do { add dynamic=yes list=$AddressList comment=tor address=82.135.66.139/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.135.166.8/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.137.16.91/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.173.145.73/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.66.131.195/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=85.16.186.130/32 } on-error={}
