...
:do { add dynamic=yes list=$AddressList comment=tor address=82.59.17.228/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.135.166.25/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.7.122.215/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.173.153.103/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=84.185.21.69/32 } on-error={}
