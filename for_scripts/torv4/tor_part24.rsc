...
:do { add dynamic=yes list=$AddressList comment=tor address=82.135.75.86/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=82.48.198.47/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.173.159.123/32 } on-error={}
