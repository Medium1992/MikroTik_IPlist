...
:do { add dynamic=yes list=$AddressList comment=tor address=84.185.26.220/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.69.215.68/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=86.120.175.138/32 } on-error={}
