...
:do { add dynamic=yes list=$AddressList comment=tor address=82.135.65.225/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.135.166.7/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.173.147.102/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.191.138.178/32 } on-error={}
