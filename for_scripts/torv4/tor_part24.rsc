...
:do { add dynamic=yes list=$AddressList comment=tor address=82.135.68.187/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.135.166.2/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=84.173.153.87/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=85.16.178.225/32 } on-error={}
