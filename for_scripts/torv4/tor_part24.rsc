...
:do { add dynamic=yes list=$AddressList comment=tor address=82.54.70.36/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=83.135.166.29/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=85.66.117.201/32 } on-error={}
