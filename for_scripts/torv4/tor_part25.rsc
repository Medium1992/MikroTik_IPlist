...
:do { add dynamic=yes list=$AddressList comment=tor address=89.182.63.205/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=89.245.198.249/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=89.246.50.56/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=89.247.2.53/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=89.247.254.236/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=91.32.232.6/32 } on-error={}
