...
:do { add dynamic=yes list=$AddressList comment=tor address=87.122.39.37/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=87.123.139.110/32 } on-error={}
