...
:do { add dynamic=yes list=$AddressList comment=tor address=87.123.143.203/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=88.133.99.245/32 } on-error={}
