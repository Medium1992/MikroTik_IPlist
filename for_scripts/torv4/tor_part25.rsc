...
:do { add dynamic=yes list=$AddressList comment=tor address=87.223.233.80/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=88.217.44.211/32 } on-error={}
