...
:do { add dynamic=yes list=$AddressList comment=tor address=91.19.25.97/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=91.8.52.120/32 } on-error={}
