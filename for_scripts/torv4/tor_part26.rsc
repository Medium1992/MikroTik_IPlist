...
:do { add dynamic=yes list=$AddressList comment=tor address=91.59.225.207/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=92.116.244.134/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=93.207.44.139/32 } on-error={}
