...
:do { add dynamic=yes list=$AddressList comment=tor address=91.2.60.187/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=91.200.110.233/32 } on-error={}
