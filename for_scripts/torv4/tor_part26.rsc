...
:do { add dynamic=yes list=$AddressList comment=tor address=91.19.30.151/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=91.8.62.186/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=92.117.21.210/32 } on-error={}
