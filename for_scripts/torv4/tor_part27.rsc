...
:do { add dynamic=yes list=$AddressList comment=tor address=95.113.147.156/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=95.81.11.162/32 } on-error={}
