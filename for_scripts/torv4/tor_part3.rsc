...
:do { add dynamic=yes list=$AddressList comment=tor address=136.51.8.16/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=137.184.42.39/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=141.227.135.119/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=141.78.141.10/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=142.198.174.119/32 } on-error={}
