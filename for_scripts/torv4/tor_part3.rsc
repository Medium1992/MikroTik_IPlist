...
:do { add dynamic=yes list=$AddressList comment=tor address=139.177.204.109/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=141.78.140.74/32 } on-error={}
