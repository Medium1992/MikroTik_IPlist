...
:do { add dynamic=yes list=$AddressList comment=tor address=141.78.144.167/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=143.177.155.44/32 } on-error={}
