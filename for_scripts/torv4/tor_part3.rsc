...
:do { add dynamic=yes list=$AddressList comment=tor address=136.50.26.32/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=141.78.189.108/32 } on-error={}
