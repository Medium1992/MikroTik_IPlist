...
:do { add dynamic=yes list=$AddressList comment=tor address=141.78.159.1/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=142.159.106.53/32 } on-error={}
