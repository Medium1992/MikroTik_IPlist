...
:do { add dynamic=yes list=$AddressList comment=tor address=147.182.171.95/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=149.233.186.48/32 } on-error={}
