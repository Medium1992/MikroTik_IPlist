...
:do { add dynamic=yes list=$AddressList comment=tor address=149.224.238.133/32 } on-error={}
:do { add dynamic=yes list=$AddressList comment=tor address=149.224.63.44/32 } on-error={}
