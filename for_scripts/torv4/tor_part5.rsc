...
:do { add dynamic=yes list=$AddressList comment=tor address=159.65.239.64/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=167.99.204.37/32 } on-error={}
