...
:do { add dynamic=yes list=$AddressList comment=tor address=162.33.177.223/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=168.100.9.40/32 } on-error={}
