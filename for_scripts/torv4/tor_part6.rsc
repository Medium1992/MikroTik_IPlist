...
:do { add dynamic=yes list=$AddressList comment=tor address=172.233.91.23/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=176.109.215.66/32 } on-error={}
