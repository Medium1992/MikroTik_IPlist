...
:do { add dynamic=yes list=$AddressList comment=tor address=176.62.1.56/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=177.106.192.73/32 } on-error={}
