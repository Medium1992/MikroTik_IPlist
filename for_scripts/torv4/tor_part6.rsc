...
:do { add dynamic=yes list=$AddressList comment=tor address=172.86.118.131/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=174.20.247.122/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=174.88.169.205/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=176.62.18.73/32 } on-error={}
