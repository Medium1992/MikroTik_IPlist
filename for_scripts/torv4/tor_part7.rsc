...
:do { add dynamic=yes list=$AddressList comment=tor address=179.175.141.65/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=179.43.169.34/32 } on-error={}
