...
:do { add dynamic=yes list=$AddressList comment=tor address=185.206.241.220/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=185.215.237.242/32 } on-error={}
