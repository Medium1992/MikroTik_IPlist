...
:do { add dynamic=yes list=$AddressList comment=tor address=185.206.242.182/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=185.215.237.92/32 } on-error={}
