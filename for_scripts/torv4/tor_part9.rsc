...
:do { add dynamic=yes list=$AddressList comment=tor address=187.168.81.239/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=189.230.145.174/32 } on-error={}
