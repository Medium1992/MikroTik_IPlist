...
:do { add dynamic=yes list=$AddressList comment=tor address=188.136.242.178/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=189.15.88.120/32 } on-error={}
