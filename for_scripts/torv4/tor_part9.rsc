...
:do { add dynamic=yes list=$AddressList comment=tor address=188.136.241.38/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=189.230.135.0/32 } on-error={}
