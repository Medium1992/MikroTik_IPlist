...
:do { add dynamic=yes list=$AddressList comment=tor address=188.174.202.59/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=189.230.179.6/32 } on-error={}
