...
:do { add dynamic=yes list=$AddressList comment=tor address=191.55.74.218/32 } on-error={}
...
:do { add dynamic=yes list=$AddressList comment=tor address=192.196.192.106/32 } on-error={}
