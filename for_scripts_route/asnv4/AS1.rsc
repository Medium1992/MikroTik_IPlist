...
:if ([:len [/ip/route/find dst-address=193.35.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.35.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1 }
:if ([:len [/ip/route/find dst-address=205.207.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.207.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1 }
