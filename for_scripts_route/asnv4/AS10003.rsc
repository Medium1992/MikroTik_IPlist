...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10003 and dst-address=for_scripts_route/asnv4/AS10003.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10003.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10003 }
