...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=162.4.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.4.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10031 }
:if ([:len [/ip/route/find dst-address=202.170.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.170.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10031 }
