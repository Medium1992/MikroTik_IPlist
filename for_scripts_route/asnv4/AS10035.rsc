...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=115.92.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.92.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10035 }
...
:if ([:len [/ip/route/find dst-address=221.140.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=221.140.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10035 }
