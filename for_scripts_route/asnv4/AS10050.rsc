...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10050 and dst-address=for_scripts_route/asnv4/AS10050.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10050.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10050 }
