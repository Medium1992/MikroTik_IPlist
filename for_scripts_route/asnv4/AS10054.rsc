...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10054 and dst-address=for_scripts_route/asnv4/AS10054.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10054.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10054 }
