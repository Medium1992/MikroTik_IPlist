...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10129 and dst-address=for_scripts_route/asnv4/AS10129.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10129.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10129 }
