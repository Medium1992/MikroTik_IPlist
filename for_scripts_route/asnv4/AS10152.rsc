...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10152 and dst-address=for_scripts_route/asnv4/AS10152.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10152.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10152 }
