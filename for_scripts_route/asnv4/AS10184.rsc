...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10184 and dst-address=for_scripts_route/asnv4/AS10184.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10184.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10184 }
