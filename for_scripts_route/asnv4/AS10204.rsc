...
:if ([:len [/ip/route/find dst-address=203.115.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.115.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10204 }
:if ([:len [/ip/route/find dst-address=203.115.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.115.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10204 }
:if ([:len [/ip/route/find dst-address=203.115.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.115.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10204 }
