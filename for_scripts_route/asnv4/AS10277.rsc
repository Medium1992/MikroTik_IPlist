...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10277 and dst-address=for_scripts_route/asnv4/AS10277.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10277.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10277 }
