...
:if ([:len [/ip/route/find dst-address=138.122.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.122.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10299 }
...
:if ([:len [/ip/route/find dst-address=186.27.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.27.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10299 }
