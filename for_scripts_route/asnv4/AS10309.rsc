...
:if ([:len [/ip/route/find dst-address=199.88.113.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.88.113.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10309 }
:if ([:len [/ip/route/find dst-address=199.88.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.88.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10309 }
...
:if ([:len [/ip/route/find dst-address=199.88.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.88.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10309 }
:if ([:len [/ip/route/find dst-address=199.88.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.88.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10309 }
