...
:if ([:len [/ip/route/find dst-address=209.94.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.94.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10352 }
:if ([:len [/ip/route/find dst-address=209.94.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.94.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10352 }
:if ([:len [/ip/route/find dst-address=209.94.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.94.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10352 }
:if ([:len [/ip/route/find dst-address=209.94.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.94.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10352 }
