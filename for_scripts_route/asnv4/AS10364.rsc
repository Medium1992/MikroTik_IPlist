...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10364 and dst-address=for_scripts_route/asnv4/AS10364.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10364.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10364 }
