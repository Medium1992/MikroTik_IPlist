...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.151.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.151.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
:if ([:len [/ip/route/find dst-address=159.37.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.37.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
:if ([:len [/ip/route/find dst-address=159.37.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.37.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
:if ([:len [/ip/route/find dst-address=159.37.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.37.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
...
:if ([:len [/ip/route/find dst-address=162.28.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.28.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
...
:if ([:len [/ip/route/find dst-address=162.60.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.60.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
:if ([:len [/ip/route/find dst-address=169.200.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.200.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
:if ([:len [/ip/route/find dst-address=169.200.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.200.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10372 }
