...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10376 and dst-address=for_scripts_route/asnv4/AS10376.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10376.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10376 }
