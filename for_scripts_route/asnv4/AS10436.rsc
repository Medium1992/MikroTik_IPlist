...
:if ([:len [/ip/route/find dst-address=148.241.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.241.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10436 }
...
:if ([:len [/ip/route/find dst-address=148.241.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.241.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10436 }
