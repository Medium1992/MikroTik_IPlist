...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10482 and dst-address=for_scripts_route/asnv4/AS10482.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10482.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10482 }
