...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=198.29.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.29.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1054 }
...
:if ([:len [/ip/route/find dst-address=207.57.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.57.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1054 }
:if ([:len [/ip/route/find dst-address=207.57.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.57.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1054 }
