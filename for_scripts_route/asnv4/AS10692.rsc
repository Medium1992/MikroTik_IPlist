...
:if ([:len [/ip/route/find dst-address=209.242.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.242.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10692 }
...
:if ([:len [/ip/route/find dst-address=216.180.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.180.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10692 }
:if ([:len [/ip/route/find dst-address=216.180.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.180.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10692 }
