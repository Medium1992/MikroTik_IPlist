...
:if ([:len [/ip/route/find dst-address=200.239.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.239.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10704 }
:if ([:len [/ip/route/find dst-address=200.239.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.239.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10704 }
:if ([:len [/ip/route/find dst-address=200.239.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.239.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10704 }
:if ([:len [/ip/route/find dst-address=200.239.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.239.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10704 }
