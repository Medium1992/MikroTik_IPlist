...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1072 and dst-address=for_scripts_route/asnv4/AS1072.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1072.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1072 }
