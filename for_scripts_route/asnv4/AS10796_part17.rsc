...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=98.29.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.29.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10796 }
:if ([:len [/ip/route/find dst-address=98.29.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.29.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10796 }
:if ([:len [/ip/route/find dst-address=98.30.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.30.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10796 }
:if ([:len [/ip/route/find dst-address=98.30.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.30.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10796 }
