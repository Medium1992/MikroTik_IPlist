...
:if ([:len [/ip/route/find dst-address=207.207.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.207.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10823 }
:if ([:len [/ip/route/find dst-address=209.204.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.204.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10823 }
:if ([:len [/ip/route/find dst-address=209.204.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.204.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10823 }
:if ([:len [/ip/route/find dst-address=209.204.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.204.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10823 }
:if ([:len [/ip/route/find dst-address=209.204.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.204.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10823 }
:if ([:len [/ip/route/find dst-address=209.204.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.204.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10823 }
:if ([:len [/ip/route/find dst-address=209.204.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.204.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10823 }
