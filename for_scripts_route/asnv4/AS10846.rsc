...
:if ([:len [/ip/route/find dst-address=192.43.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.43.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10846 }
...
:if ([:len [/ip/route/find dst-address=204.54.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.54.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10846 }
...
:if ([:len [/ip/route/find dst-address=204.55.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.55.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10846 }
...
:if ([:len [/ip/route/find dst-address=204.55.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.55.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10846 }
