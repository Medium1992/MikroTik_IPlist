...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10886 and dst-address=for_scripts_route/asnv4/AS10886.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10886.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10886 }
