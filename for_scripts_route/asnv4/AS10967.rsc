...
:if ([:len [/ip/route/find dst-address=165.130.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
:if ([:len [/ip/route/find dst-address=165.130.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
:if ([:len [/ip/route/find dst-address=165.130.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
:if ([:len [/ip/route/find dst-address=165.130.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
:if ([:len [/ip/route/find dst-address=165.130.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
:if ([:len [/ip/route/find dst-address=165.130.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
:if ([:len [/ip/route/find dst-address=165.130.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
...
:if ([:len [/ip/route/find dst-address=165.130.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.130.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10967 }
