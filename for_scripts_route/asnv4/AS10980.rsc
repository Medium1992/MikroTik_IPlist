...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS10980 and dst-address=for_scripts_route/asnv4/AS10980.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS10980.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS10980 }
