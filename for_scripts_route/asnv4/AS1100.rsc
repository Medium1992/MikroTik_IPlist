...
:if ([:len [/ip/route/find dst-address=207.176.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.176.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1100 }
...
:if ([:len [/ip/route/find dst-address=209.251.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.251.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1100 }
