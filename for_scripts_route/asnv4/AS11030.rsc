...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11030 and dst-address=for_scripts_route/asnv4/AS11030.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11030.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11030 }
