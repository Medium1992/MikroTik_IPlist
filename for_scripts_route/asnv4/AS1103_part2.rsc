...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=192.42.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.42.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
...
:if ([:len [/ip/route/find dst-address=192.87.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
