...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=192.42.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.42.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.43.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.43.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=192.87.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.87.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
:if ([:len [/ip/route/find dst-address=193.176.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.176.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1103 }
