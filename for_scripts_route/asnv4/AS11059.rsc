...
:if ([:len [/ip/route/find dst-address=178.83.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=178.83.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=69.33.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
