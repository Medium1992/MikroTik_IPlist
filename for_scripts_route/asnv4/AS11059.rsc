...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=136.162.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.162.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=142.214.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.214.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=143.20.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=68.166.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.166.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=68.166.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.166.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
