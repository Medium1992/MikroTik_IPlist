...
:if ([:len [/ip/route/find dst-address=192.132.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.132.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=198.29.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.29.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
