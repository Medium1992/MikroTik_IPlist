...
:if ([:len [/ip/route/find dst-address=140.99.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.99.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=143.20.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=192.102.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.102.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=192.132.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.132.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=192.132.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.132.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=192.132.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.132.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=192.132.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.132.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
