...
:if ([:len [/ip/route/find dst-address=178.83.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=178.83.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=178.83.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=178.83.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
...
:if ([:len [/ip/route/find dst-address=69.33.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=69.33.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=69.33.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=69.33.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
:if ([:len [/ip/route/find dst-address=69.33.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11059 }
