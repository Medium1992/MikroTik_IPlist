...
:if ([:len [/ip/route/find dst-address=128.148.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
...
:if ([:len [/ip/route/find dst-address=128.148.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
