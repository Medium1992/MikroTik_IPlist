...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=128.148.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
...
:if ([:len [/ip/route/find dst-address=128.148.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
...
:if ([:len [/ip/route/find dst-address=128.148.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
...
:if ([:len [/ip/route/find dst-address=128.148.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
:if ([:len [/ip/route/find dst-address=128.148.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
:if ([:len [/ip/route/find dst-address=128.148.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.148.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11078 }
