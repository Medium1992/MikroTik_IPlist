...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11096 and dst-address=for_scripts_route/asnv4/AS11096.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11096.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11096 }
