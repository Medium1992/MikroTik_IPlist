...
:if ([:len [/ip/route/find dst-address=132.254.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.254.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11136 }
:if ([:len [/ip/route/find dst-address=132.254.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.254.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11136 }
:if ([:len [/ip/route/find dst-address=132.254.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.254.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11136 }
