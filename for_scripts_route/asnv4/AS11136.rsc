...
:if ([:len [/ip/route/find dst-address=200.36.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.36.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11136 }
:if ([:len [/ip/route/find dst-address=200.36.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.36.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11136 }
