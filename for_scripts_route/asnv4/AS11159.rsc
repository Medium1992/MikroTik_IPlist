...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11159 and dst-address=for_scripts_route/asnv4/AS11159.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11159.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11159 }
