...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=201.163.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.163.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11172 }
:if ([:len [/ip/route/find dst-address=201.163.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.163.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11172 }
:if ([:len [/ip/route/find dst-address=201.163.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.163.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11172 }
:if ([:len [/ip/route/find dst-address=201.163.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.163.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11172 }
:if ([:len [/ip/route/find dst-address=201.163.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.163.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11172 }
:if ([:len [/ip/route/find dst-address=201.163.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.163.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11172 }
