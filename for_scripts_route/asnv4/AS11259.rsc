...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11259 and dst-address=for_scripts_route/asnv4/AS11259.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11259.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11259 }
