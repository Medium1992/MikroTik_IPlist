...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11269 and dst-address=for_scripts_route/asnv4/AS11269.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11269.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11269 }
