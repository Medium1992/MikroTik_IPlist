...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=162.34.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.34.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11271 }
...
:if ([:len [/ip/route/find dst-address=201.62.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.62.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11271 }
