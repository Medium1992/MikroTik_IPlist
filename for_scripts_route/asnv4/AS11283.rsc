...
:if ([:len [/ip/route/find dst-address=170.167.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.167.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11283 }
...
:if ([:len [/ip/route/find dst-address=170.167.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.167.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11283 }
