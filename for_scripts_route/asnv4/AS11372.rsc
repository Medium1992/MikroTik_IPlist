...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11372 and dst-address=for_scripts_route/asnv4/AS11372.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11372.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11372 }
