...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.142.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.142.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11396 }
...
:if ([:len [/ip/route/find dst-address=151.142.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.142.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11396 }
