...
:if ([:len [/ip/route/find dst-address=209.136.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.136.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11402 }
...
:if ([:len [/ip/route/find dst-address=66.195.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.195.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11402 }
