...
:if ([:len [/ip/route/find dst-address=24.51.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.51.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11414 }
:if ([:len [/ip/route/find dst-address=24.51.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.51.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11414 }
