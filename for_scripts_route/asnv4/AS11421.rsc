...
:if ([:len [/ip/route/find dst-address=77.67.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.67.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11421 }
:if ([:len [/ip/route/find dst-address=87.86.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.86.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11421 }
