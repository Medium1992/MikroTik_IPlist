...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11437 and dst-address=for_scripts_route/asnv4/AS11437.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11437.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11437 }
