...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11448 and dst-address=for_scripts_route/asnv4/AS11448.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11448.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11448 }
