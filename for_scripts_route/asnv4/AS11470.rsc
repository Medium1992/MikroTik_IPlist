...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11470 and dst-address=for_scripts_route/asnv4/AS11470.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11470.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11470 }
