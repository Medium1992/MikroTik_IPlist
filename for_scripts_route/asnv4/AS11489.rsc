...
:if ([:len [/ip/route/find dst-address=205.151.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.151.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11489 }
:if ([:len [/ip/route/find dst-address=205.151.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.151.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11489 }
:if ([:len [/ip/route/find dst-address=205.151.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.151.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11489 }
:if ([:len [/ip/route/find dst-address=205.151.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.151.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11489 }
:if ([:len [/ip/route/find dst-address=206.167.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.167.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11489 }
