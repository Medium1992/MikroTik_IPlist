...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11492 and dst-address=for_scripts_route/asnv4/AS11492_part14.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11492_part14.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11492 }
