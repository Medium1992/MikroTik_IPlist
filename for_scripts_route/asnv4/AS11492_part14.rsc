...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=96.19.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.19.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11492 }
:if ([:len [/ip/route/find dst-address=96.19.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.19.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11492 }
