...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11496 and dst-address=for_scripts_route/asnv4/AS11496.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11496.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11496 }
