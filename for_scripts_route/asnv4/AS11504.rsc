...
:if ([:len [/ip/route/find dst-address=69.8.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.8.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11504 }
:if ([:len [/ip/route/find dst-address=69.8.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.8.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11504 }
