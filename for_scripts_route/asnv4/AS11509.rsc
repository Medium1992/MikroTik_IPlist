...
:if ([:len [/ip/route/find dst-address=64.239.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11509 }
:if ([:len [/ip/route/find dst-address=64.239.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11509 }
:if ([:len [/ip/route/find dst-address=64.239.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11509 }
:if ([:len [/ip/route/find dst-address=64.239.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11509 }
:if ([:len [/ip/route/find dst-address=64.239.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11509 }
:if ([:len [/ip/route/find dst-address=64.239.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11509 }
:if ([:len [/ip/route/find dst-address=64.239.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11509 }
