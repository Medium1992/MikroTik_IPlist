...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11521 and dst-address=for_scripts_route/asnv4/AS11521.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11521.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11521 }
