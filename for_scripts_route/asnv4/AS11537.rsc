...
:if ([:len [/ip/route/find dst-address=163.253.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.253.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11537 }
:if ([:len [/ip/route/find dst-address=163.253.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.253.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11537 }
