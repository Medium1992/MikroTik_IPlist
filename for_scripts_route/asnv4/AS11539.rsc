...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11539 and dst-address=for_scripts_route/asnv4/AS11539.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11539.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11539 }
