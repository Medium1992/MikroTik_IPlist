...
:if ([:len [/ip/route/find dst-address=190.153.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
...
:if ([:len [/ip/route/find dst-address=190.153.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
