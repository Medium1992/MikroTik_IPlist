...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=138.59.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.59.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
...
:if ([:len [/ip/route/find dst-address=190.153.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
...
:if ([:len [/ip/route/find dst-address=190.153.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
:if ([:len [/ip/route/find dst-address=190.153.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
:if ([:len [/ip/route/find dst-address=190.153.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
...
:if ([:len [/ip/route/find dst-address=190.153.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
...
:if ([:len [/ip/route/find dst-address=190.6.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.6.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
