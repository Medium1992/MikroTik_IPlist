...
:if ([:len [/ip/route/find dst-address=190.153.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
:if ([:len [/ip/route/find dst-address=190.153.91.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.153.91.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
...
:if ([:len [/ip/route/find dst-address=190.6.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.6.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
:if ([:len [/ip/route/find dst-address=190.6.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.6.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
:if ([:len [/ip/route/find dst-address=190.6.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.6.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
:if ([:len [/ip/route/find dst-address=190.6.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.6.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11562 }
