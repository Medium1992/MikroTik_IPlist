...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11572 and dst-address=for_scripts_route/asnv4/AS11572.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11572.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11572 }
