...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11577 and dst-address=for_scripts_route/asnv4/AS11577.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11577.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11577 }
