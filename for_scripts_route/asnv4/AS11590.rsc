...
:if ([:len [/ip/route/find dst-address=66.59.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.59.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11590 }
:if ([:len [/ip/route/find dst-address=66.59.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.59.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11590 }
:if ([:len [/ip/route/find dst-address=66.59.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.59.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11590 }
:if ([:len [/ip/route/find dst-address=66.59.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.59.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11590 }
