...
:if ([:len [/ip/route/find dst-address=216.6.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.6.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11606 }
:if ([:len [/ip/route/find dst-address=216.6.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.6.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11606 }
:if ([:len [/ip/route/find dst-address=67.210.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.210.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11606 }
