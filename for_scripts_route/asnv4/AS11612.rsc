...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=216.162.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.162.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11612 }
...
:if ([:len [/ip/route/find dst-address=69.84.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.84.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11612 }
...
:if ([:len [/ip/route/find dst-address=69.84.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.84.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11612 }
