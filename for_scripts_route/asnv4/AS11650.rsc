...
:if ([:len [/ip/route/find dst-address=198.46.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.46.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11650 }
:if ([:len [/ip/route/find dst-address=198.58.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.58.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11650 }
:if ([:len [/ip/route/find dst-address=199.96.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.96.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11650 }
...
:if ([:len [/ip/route/find dst-address=216.176.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.176.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11650 }
...
:if ([:len [/ip/route/find dst-address=216.71.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.71.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11650 }
