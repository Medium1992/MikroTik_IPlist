...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11727 and dst-address=for_scripts_route/asnv4/AS11727.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11727.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11727 }
