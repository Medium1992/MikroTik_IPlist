...
:if ([:len [/ip/route/find dst-address=170.218.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.218.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11740 }
...
:if ([:len [/ip/route/find dst-address=170.218.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.218.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11740 }
...
:if ([:len [/ip/route/find dst-address=170.218.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.218.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11740 }
