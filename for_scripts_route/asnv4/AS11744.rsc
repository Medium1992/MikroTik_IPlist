...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11744 and dst-address=for_scripts_route/asnv4/AS11744.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11744.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11744 }
