...
:if ([:len [/ip/route/find dst-address=208.115.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.115.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11749 }
...
:if ([:len [/ip/route/find dst-address=216.53.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.53.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11749 }
...
:if ([:len [/ip/route/find dst-address=24.56.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.56.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11749 }
:if ([:len [/ip/route/find dst-address=24.75.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.75.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11749 }
