...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11767 and dst-address=for_scripts_route/asnv4/AS11767.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11767.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11767 }
