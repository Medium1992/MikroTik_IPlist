...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=75.76.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.76.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11776 }
:if ([:len [/ip/route/find dst-address=75.76.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.76.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11776 }
