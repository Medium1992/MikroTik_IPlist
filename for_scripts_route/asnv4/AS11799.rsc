...
:if ([:len [/ip/route/find dst-address=207.171.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.171.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11799 }
:if ([:len [/ip/route/find dst-address=207.171.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.171.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11799 }
