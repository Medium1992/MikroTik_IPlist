...
:if ([:len [/ip/route/find dst-address=208.91.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.91.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11805 }
:if ([:len [/ip/route/find dst-address=23.136.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.136.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11805 }
