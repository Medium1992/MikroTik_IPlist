...
:if ([:len [/ip/route/find dst-address=129.101.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.101.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11808 }
:if ([:len [/ip/route/find dst-address=129.101.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.101.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11808 }
:if ([:len [/ip/route/find dst-address=129.101.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.101.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11808 }
:if ([:len [/ip/route/find dst-address=129.101.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.101.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11808 }
:if ([:len [/ip/route/find dst-address=129.101.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.101.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11808 }
