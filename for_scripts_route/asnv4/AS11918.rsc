...
:if ([:len [/ip/route/find dst-address=66.7.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.7.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11918 }
:if ([:len [/ip/route/find dst-address=66.7.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.7.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11918 }
