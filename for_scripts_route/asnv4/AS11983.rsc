...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=147.160.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.160.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
...
:if ([:len [/ip/route/find dst-address=71.18.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
...
:if ([:len [/ip/route/find dst-address=71.18.162.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.162.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
...
:if ([:len [/ip/route/find dst-address=71.18.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
...
:if ([:len [/ip/route/find dst-address=71.18.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
:if ([:len [/ip/route/find dst-address=71.18.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
:if ([:len [/ip/route/find dst-address=71.18.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
:if ([:len [/ip/route/find dst-address=71.18.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
...
:if ([:len [/ip/route/find dst-address=71.18.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
:if ([:len [/ip/route/find dst-address=71.18.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
:if ([:len [/ip/route/find dst-address=71.18.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.18.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11983 }
