...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11990 and dst-address=for_scripts_route/asnv4/AS11990.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11990.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11990 }
