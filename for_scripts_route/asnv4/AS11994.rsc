...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=161.129.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.129.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11994 }
:if ([:len [/ip/route/find dst-address=162.251.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.251.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11994 }
...
:if ([:len [/ip/route/find dst-address=207.89.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.89.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11994 }
...
:if ([:len [/ip/route/find dst-address=68.170.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.170.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11994 }
