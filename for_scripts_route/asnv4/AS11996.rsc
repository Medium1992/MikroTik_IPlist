...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS11996 and dst-address=for_scripts_route/asnv4/AS11996.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS11996.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS11996 }
