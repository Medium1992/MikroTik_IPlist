...
:if ([:len [/ip/route/find dst-address=67.43.73.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
:if ([:len [/ip/route/find dst-address=67.43.73.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
:if ([:len [/ip/route/find dst-address=67.43.73.160/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.160/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
:if ([:len [/ip/route/find dst-address=67.43.73.169/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.169/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
:if ([:len [/ip/route/find dst-address=67.43.73.170/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.170/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
:if ([:len [/ip/route/find dst-address=67.43.73.172/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.172/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
:if ([:len [/ip/route/find dst-address=67.43.73.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
:if ([:len [/ip/route/find dst-address=67.43.73.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.43.73.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12044 }
