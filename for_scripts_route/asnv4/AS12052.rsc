...
:if ([:len [/ip/route/find dst-address=167.64.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.64.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12052 }
:if ([:len [/ip/route/find dst-address=167.64.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.64.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12052 }
...
:if ([:len [/ip/route/find dst-address=167.64.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.64.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12052 }
