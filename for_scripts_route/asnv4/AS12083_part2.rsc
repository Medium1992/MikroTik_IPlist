...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=69.14.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.14.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12083 }
:if ([:len [/ip/route/find dst-address=69.14.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.14.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12083 }
:if ([:len [/ip/route/find dst-address=69.14.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.14.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12083 }
:if ([:len [/ip/route/find dst-address=69.14.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.14.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12083 }
:if ([:len [/ip/route/find dst-address=69.14.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.14.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12083 }
:if ([:len [/ip/route/find dst-address=69.171.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.171.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12083 }
