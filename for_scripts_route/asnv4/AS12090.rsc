...
:if ([:len [/ip/route/find dst-address=209.82.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.82.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12090 }
:if ([:len [/ip/route/find dst-address=209.82.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.82.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12090 }
...
:if ([:len [/ip/route/find dst-address=209.82.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.82.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12090 }
:if ([:len [/ip/route/find dst-address=209.82.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.82.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12090 }
:if ([:len [/ip/route/find dst-address=63.240.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=63.240.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12090 }
:if ([:len [/ip/route/find dst-address=63.240.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=63.240.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12090 }
