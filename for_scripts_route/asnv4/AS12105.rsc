...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12105 and dst-address=for_scripts_route/asnv4/AS12105.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12105.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12105 }
