...
:if ([:len [/ip/route/find dst-address=198.153.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.153.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12110 }
:if ([:len [/ip/route/find dst-address=199.47.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.47.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12110 }
