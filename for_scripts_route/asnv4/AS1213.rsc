...
:if ([:len [/ip/route/find dst-address=193.1.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=193.1.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=193.1.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=193.1.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=193.1.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=193.1.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=193.1.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
:if ([:len [/ip/route/find dst-address=193.1.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.1.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1213 }
