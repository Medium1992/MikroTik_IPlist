...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12155 and dst-address=for_scripts_route/asnv4/AS12155.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12155.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12155 }
