...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1216 and dst-address=for_scripts_route/asnv4/AS1216.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1216.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1216 }
