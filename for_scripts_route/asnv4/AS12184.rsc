...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12184 and dst-address=for_scripts_route/asnv4/AS12184.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12184.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12184 }
