...
:if ([:len [/ip/route/find dst-address=174.143.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=174.143.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12200 }
:if ([:len [/ip/route/find dst-address=192.65.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.65.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12200 }
...
:if ([:len [/ip/route/find dst-address=81.168.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.168.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12200 }
