...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=108.186.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.186.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12213 }
...
:if ([:len [/ip/route/find dst-address=24.170.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.170.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12213 }
:if ([:len [/ip/route/find dst-address=24.170.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.170.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12213 }
