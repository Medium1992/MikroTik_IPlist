...
:if ([:len [/ip/route/find dst-address=2.16.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.16.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12222 }
...
:if ([:len [/ip/route/find dst-address=23.15.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.15.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12222 }
...
:if ([:len [/ip/route/find dst-address=72.247.150.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.247.150.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12222 }
...
:if ([:len [/ip/route/find dst-address=80.67.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.67.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12222 }
