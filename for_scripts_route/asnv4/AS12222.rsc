...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.101.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.101.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12222 }
...
:if ([:len [/ip/route/find dst-address=2.16.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.16.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12222 }
