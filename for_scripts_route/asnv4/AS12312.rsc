...
:if ([:len [/ip/route/find dst-address=194.112.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.112.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12312 }
:if ([:len [/ip/route/find dst-address=194.112.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.112.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12312 }
