...
:if ([:len [/ip/route/find dst-address=195.63.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.63.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12312 }
:if ([:len [/ip/route/find dst-address=195.63.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.63.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12312 }
...
:if ([:len [/ip/route/find dst-address=62.144.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.144.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12312 }
