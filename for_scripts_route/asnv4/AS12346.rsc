...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12346 and dst-address=for_scripts_route/asnv4/AS12346.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12346.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12346 }
