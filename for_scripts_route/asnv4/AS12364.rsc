...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12364 and dst-address=for_scripts_route/asnv4/AS12364.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12364.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12364 }
