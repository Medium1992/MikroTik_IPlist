...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12365 and dst-address=for_scripts_route/asnv4/AS12365.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12365.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12365 }
