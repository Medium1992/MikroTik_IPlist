...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12372 and dst-address=for_scripts_route/asnv4/AS12372.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12372.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12372 }
