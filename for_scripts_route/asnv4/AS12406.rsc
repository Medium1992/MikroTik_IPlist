...
:if ([:len [/ip/route/find dst-address=87.232.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.232.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12406 }
:if ([:len [/ip/route/find dst-address=93.125.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.125.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12406 }
