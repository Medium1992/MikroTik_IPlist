...
:if ([:len [/ip/route/find dst-address=88.86.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.86.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12418 }
:if ([:len [/ip/route/find dst-address=88.86.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.86.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12418 }
:if ([:len [/ip/route/find dst-address=88.86.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.86.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12418 }
:if ([:len [/ip/route/find dst-address=88.86.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.86.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12418 }
