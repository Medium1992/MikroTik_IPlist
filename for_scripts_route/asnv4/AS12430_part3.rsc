...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=77.231.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.231.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12430 }
:if ([:len [/ip/route/find dst-address=77.231.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.231.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12430 }
