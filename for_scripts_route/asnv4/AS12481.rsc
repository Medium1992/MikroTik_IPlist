...
:if ([:len [/ip/route/find dst-address=5.100.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.100.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12481 }
