...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12498 and dst-address=for_scripts_route/asnv4/AS12498.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12498.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12498 }
