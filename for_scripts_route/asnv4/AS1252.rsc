...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1252 and dst-address=for_scripts_route/asnv4/AS1252.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1252.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1252 }
