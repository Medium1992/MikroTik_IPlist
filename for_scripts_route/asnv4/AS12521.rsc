...
:if ([:len [/ip/route/find dst-address=212.85.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.85.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12521 }
...
:if ([:len [/ip/route/find dst-address=91.195.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.195.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12521 }
