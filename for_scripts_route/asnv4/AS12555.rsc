...
:if ([:len [/ip/route/find dst-address=193.47.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.47.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12555 }
...
:if ([:len [/ip/route/find dst-address=81.29.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.29.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12555 }
