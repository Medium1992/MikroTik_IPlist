...
:if ([:len [/ip/route/find dst-address=94.249.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.249.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12586 }
...
:if ([:len [/ip/route/find dst-address=94.249.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.249.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12586 }
