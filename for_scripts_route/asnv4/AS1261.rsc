...
:if ([:len [/ip/route/find dst-address=130.164.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.164.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1261 }
...
:if ([:len [/ip/route/find dst-address=130.164.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.164.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1261 }
