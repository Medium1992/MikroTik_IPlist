...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS12649 and dst-address=for_scripts_route/asnv4/AS12649.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS12649.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12649 }
