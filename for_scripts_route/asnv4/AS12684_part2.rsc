...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=66.178.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.178.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12684 }
:if ([:len [/ip/route/find dst-address=66.178.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.178.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12684 }
:if ([:len [/ip/route/find dst-address=66.178.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.178.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12684 }
:if ([:len [/ip/route/find dst-address=66.178.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.178.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12684 }
:if ([:len [/ip/route/find dst-address=66.178.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.178.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12684 }
:if ([:len [/ip/route/find dst-address=66.178.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.178.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12684 }
