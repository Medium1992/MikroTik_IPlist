...
:if ([:len [/ip/route/find dst-address=212.22.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.22.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12798 }
:if ([:len [/ip/route/find dst-address=212.22.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.22.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12798 }
