...
:if ([:len [/ip/route/find dst-address=192.70.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.70.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12844 }
...
:if ([:len [/ip/route/find dst-address=78.105.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.105.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12844 }
