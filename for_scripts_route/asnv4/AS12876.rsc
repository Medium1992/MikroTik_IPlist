...
:if ([:len [/ip/route/find dst-address=151.115.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.115.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12876 }
:if ([:len [/ip/route/find dst-address=151.115.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.115.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12876 }
...
:if ([:len [/ip/route/find dst-address=151.115.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.115.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12876 }
