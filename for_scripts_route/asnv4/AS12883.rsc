...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=213.130.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.130.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12883 }
:if ([:len [/ip/route/find dst-address=213.130.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.130.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12883 }
:if ([:len [/ip/route/find dst-address=213.130.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.130.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12883 }
...
:if ([:len [/ip/route/find dst-address=62.221.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.221.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12883 }
...
:if ([:len [/ip/route/find dst-address=93.178.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.178.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12883 }
:if ([:len [/ip/route/find dst-address=93.178.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.178.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12883 }
