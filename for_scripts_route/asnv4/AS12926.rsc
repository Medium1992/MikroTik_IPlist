...
:if ([:len [/ip/route/find dst-address=84.232.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.232.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12926 }
:if ([:len [/ip/route/find dst-address=84.236.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12926 }
