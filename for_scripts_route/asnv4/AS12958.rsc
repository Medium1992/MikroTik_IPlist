...
:if ([:len [/ip/route/find dst-address=89.249.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.249.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12958 }
:if ([:len [/ip/route/find dst-address=89.249.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.249.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12958 }
:if ([:len [/ip/route/find dst-address=89.249.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.249.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12958 }
:if ([:len [/ip/route/find dst-address=89.249.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.249.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12958 }
