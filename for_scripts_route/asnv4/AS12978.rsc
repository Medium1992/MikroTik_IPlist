...
:if ([:len [/ip/route/find dst-address=213.243.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
:if ([:len [/ip/route/find dst-address=213.243.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
:if ([:len [/ip/route/find dst-address=213.243.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
:if ([:len [/ip/route/find dst-address=213.243.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
:if ([:len [/ip/route/find dst-address=213.243.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
:if ([:len [/ip/route/find dst-address=213.243.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
:if ([:len [/ip/route/find dst-address=213.243.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
:if ([:len [/ip/route/find dst-address=213.243.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.243.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12978 }
