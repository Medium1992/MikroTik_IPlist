...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=129.35.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.35.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12980 }
:if ([:len [/ip/route/find dst-address=129.35.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.35.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12980 }
:if ([:len [/ip/route/find dst-address=129.35.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.35.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS12980 }
