...
:if ([:len [/ip/route/find dst-address=91.213.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.213.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13009 }
:if ([:len [/ip/route/find dst-address=91.213.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.213.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13009 }
:if ([:len [/ip/route/find dst-address=91.213.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.213.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13009 }
:if ([:len [/ip/route/find dst-address=91.213.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.213.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13009 }
:if ([:len [/ip/route/find dst-address=91.232.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.232.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13009 }
