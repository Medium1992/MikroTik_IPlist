...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13041 and dst-address=for_scripts_route/asnv4/AS13041.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13041.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13041 }
