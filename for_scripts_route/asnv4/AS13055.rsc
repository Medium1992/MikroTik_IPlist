...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13055 and dst-address=for_scripts_route/asnv4/AS13055.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13055.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13055 }
