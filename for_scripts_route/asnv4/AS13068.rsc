...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13068 and dst-address=for_scripts_route/asnv4/AS13068.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13068.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13068 }
