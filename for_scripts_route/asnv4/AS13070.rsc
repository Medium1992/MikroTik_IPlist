...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13070 and dst-address=for_scripts_route/asnv4/AS13070.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13070.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13070 }
