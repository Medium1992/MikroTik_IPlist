...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13105 and dst-address=for_scripts_route/asnv4/AS13105.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13105.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13105 }
