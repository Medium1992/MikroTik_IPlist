...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.78.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.78.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131111 }
...
:if ([:len [/ip/route/find dst-address=119.235.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.235.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131111 }
:if ([:len [/ip/route/find dst-address=119.235.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.235.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131111 }
...
:if ([:len [/ip/route/find dst-address=9.154.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.154.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131111 }
