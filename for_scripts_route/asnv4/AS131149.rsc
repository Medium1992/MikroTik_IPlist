...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131149 and dst-address=for_scripts_route/asnv4/AS131149.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131149.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131149 }
