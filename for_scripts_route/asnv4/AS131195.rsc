...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131195 and dst-address=for_scripts_route/asnv4/AS131195.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131195.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131195 }
