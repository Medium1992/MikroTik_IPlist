...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131232 and dst-address=for_scripts_route/asnv4/AS131232.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131232.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131232 }
