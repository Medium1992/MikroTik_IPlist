...
:if ([:len [/ip/route/find dst-address=38.18.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.18.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131267 }
:if ([:len [/ip/route/find dst-address=38.78.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.78.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131267 }
