...
:if ([:len [/ip/route/find dst-address=103.200.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.200.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131314 }
...
:if ([:len [/ip/route/find dst-address=103.201.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.201.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131314 }
...
:if ([:len [/ip/route/find dst-address=202.57.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.57.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131314 }
