...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131447 and dst-address=for_scripts_route/asnv4/AS131447.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131447.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131447 }
