...
:if ([:len [/ip/route/find dst-address=103.239.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.239.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131516 }
...
:if ([:len [/ip/route/find dst-address=116.196.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.196.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131516 }
