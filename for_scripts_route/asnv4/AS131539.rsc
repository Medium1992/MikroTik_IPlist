...
:if ([:len [/ip/route/find dst-address=110.42.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=110.42.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131539 }
:if ([:len [/ip/route/find dst-address=110.42.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=110.42.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131539 }
