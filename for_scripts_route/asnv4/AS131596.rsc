...
:if ([:len [/ip/route/find dst-address=59.102.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.102.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131596 }
:if ([:len [/ip/route/find dst-address=59.102.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.102.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131596 }
:if ([:len [/ip/route/find dst-address=59.102.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.102.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131596 }
:if ([:len [/ip/route/find dst-address=59.102.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.102.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131596 }
:if ([:len [/ip/route/find dst-address=59.102.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.102.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131596 }
