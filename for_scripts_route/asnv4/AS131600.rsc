...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131600 and dst-address=for_scripts_route/asnv4/AS131600.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131600.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131600 }
