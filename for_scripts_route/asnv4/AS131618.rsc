...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.103.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.103.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131618 }
:if ([:len [/ip/route/find dst-address=103.103.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.103.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131618 }
...
:if ([:len [/ip/route/find dst-address=103.129.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.129.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131618 }
:if ([:len [/ip/route/find dst-address=103.135.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.135.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131618 }
:if ([:len [/ip/route/find dst-address=103.161.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.161.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131618 }
