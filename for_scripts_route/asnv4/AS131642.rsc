...
:if ([:len [/ip/route/find dst-address=103.254.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.254.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131642 }
...
:if ([:len [/ip/route/find dst-address=187.79.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.79.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131642 }
