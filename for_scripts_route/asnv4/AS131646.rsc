...
:if ([:len [/ip/route/find dst-address=103.225.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.225.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131646 }
...
:if ([:len [/ip/route/find dst-address=150.107.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.107.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131646 }
...
:if ([:len [/ip/route/find dst-address=43.252.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.252.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131646 }
