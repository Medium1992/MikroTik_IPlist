...
:if ([:len [/ip/route/find dst-address=138.252.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.252.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131657 }
...
:if ([:len [/ip/route/find dst-address=210.1.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.1.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131657 }
