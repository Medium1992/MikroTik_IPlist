...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131660 and dst-address=for_scripts_route/asnv4/AS131660.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131660.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131660 }
