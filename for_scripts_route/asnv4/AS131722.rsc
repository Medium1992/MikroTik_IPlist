...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131722 and dst-address=for_scripts_route/asnv4/AS131722.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131722.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131722 }
