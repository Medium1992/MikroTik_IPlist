...
:if ([:len [/ip/route/find dst-address=210.247.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.247.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131745 }
:if ([:len [/ip/route/find dst-address=210.247.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.247.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131745 }
:if ([:len [/ip/route/find dst-address=210.247.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.247.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131745 }
