...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131824 and dst-address=for_scripts_route/asnv4/AS131824.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131824.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131824 }
