...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131927 and dst-address=for_scripts_route/asnv4/AS131927.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131927.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131927 }
