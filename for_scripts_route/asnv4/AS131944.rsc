...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS131944 and dst-address=for_scripts_route/asnv4/AS131944.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS131944.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS131944 }
