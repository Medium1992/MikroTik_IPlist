...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132000 and dst-address=for_scripts_route/asnv4/AS132000.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132000.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132000 }
