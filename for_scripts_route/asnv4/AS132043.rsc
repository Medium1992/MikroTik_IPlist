...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132043 and dst-address=for_scripts_route/asnv4/AS132043.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132043.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132043 }
