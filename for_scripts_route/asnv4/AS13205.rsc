...
:if ([:len [/ip/route/find dst-address=192.31.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.31.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13205 }
:if ([:len [/ip/route/find dst-address=192.65.153.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.65.153.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13205 }
