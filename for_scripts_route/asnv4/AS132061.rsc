...
:if ([:len [/ip/route/find dst-address=223.24.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
...
:if ([:len [/ip/route/find dst-address=27.55.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
:if ([:len [/ip/route/find dst-address=27.55.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
:if ([:len [/ip/route/find dst-address=27.55.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
