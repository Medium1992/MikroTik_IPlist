...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=223.24.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
:if ([:len [/ip/route/find dst-address=223.24.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
