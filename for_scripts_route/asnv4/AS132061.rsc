...
:if ([:len [/ip/route/find dst-address=27.55.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
:if ([:len [/ip/route/find dst-address=27.55.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
:if ([:len [/ip/route/find dst-address=27.55.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132061 }
