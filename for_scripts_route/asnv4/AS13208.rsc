...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13208 and dst-address=for_scripts_route/asnv4/AS13208.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13208.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13208 }
