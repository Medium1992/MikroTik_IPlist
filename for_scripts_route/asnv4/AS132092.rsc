...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132092 and dst-address=for_scripts_route/asnv4/AS132092.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132092.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132092 }
