...
:if ([:len [/ip/route/find dst-address=43.250.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.250.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132110 }
:if ([:len [/ip/route/find dst-address=43.250.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.250.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132110 }
