...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132162 and dst-address=for_scripts_route/asnv4/AS132162.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132162.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132162 }
