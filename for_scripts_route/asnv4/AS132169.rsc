...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132169 and dst-address=for_scripts_route/asnv4/AS132169.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132169.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132169 }
