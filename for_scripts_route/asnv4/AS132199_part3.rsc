...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=216.247.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.247.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
:if ([:len [/ip/route/find dst-address=222.127.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.127.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132199 }
