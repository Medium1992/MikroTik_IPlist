...
:if ([:len [/ip/route/find dst-address=87.124.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.124.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132280 }
...
:if ([:len [/ip/route/find dst-address=89.126.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.126.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132280 }
:if ([:len [/ip/route/find dst-address=89.127.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.127.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132280 }
...
:if ([:len [/ip/route/find dst-address=96.30.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.30.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132280 }
