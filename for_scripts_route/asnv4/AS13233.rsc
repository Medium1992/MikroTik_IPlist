...
:if ([:len [/ip/route/find dst-address=213.143.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.143.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13233 }
:if ([:len [/ip/route/find dst-address=213.143.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.143.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13233 }
