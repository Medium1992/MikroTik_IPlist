...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13246 and dst-address=for_scripts_route/asnv4/AS13246.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13246.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13246 }
