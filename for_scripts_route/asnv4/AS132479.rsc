...
:if ([:len [/ip/route/find dst-address=212.134.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.134.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132479 }
...
:if ([:len [/ip/route/find dst-address=89.213.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132479 }
