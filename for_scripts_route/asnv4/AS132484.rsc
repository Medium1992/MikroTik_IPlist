...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132484 and dst-address=for_scripts_route/asnv4/AS132484.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132484.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132484 }
