...
:if ([:len [/ip/route/find dst-address=103.231.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.231.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132556 }
:if ([:len [/ip/route/find dst-address=103.231.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.231.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132556 }
