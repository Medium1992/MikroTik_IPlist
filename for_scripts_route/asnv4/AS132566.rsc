...
:if ([:len [/ip/route/find dst-address=45.198.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.198.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132566 }
:if ([:len [/ip/route/find dst-address=45.198.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.198.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132566 }
:if ([:len [/ip/route/find dst-address=45.198.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.198.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132566 }
