...
:if ([:len [/ip/route/find dst-address=103.17.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.17.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132573 }
...
:if ([:len [/ip/route/find dst-address=45.248.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.248.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132573 }
