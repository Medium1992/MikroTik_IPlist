...
:if ([:len [/ip/route/find dst-address=223.24.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=223.24.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=223.24.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=223.24.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
...
:if ([:len [/ip/route/find dst-address=223.24.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.24.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=27.55.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=27.55.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.55.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
...
:if ([:len [/ip/route/find dst-address=49.237.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.237.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
...
:if ([:len [/ip/route/find dst-address=49.237.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.237.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
