...
:if ([:len [/ip/route/find dst-address=49.237.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.237.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=49.237.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.237.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=49.237.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.237.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
...
:if ([:len [/ip/route/find dst-address=49.237.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.237.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
:if ([:len [/ip/route/find dst-address=49.237.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.237.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132618 }
