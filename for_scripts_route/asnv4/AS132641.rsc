...
:if ([:len [/ip/route/find dst-address=103.145.218.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.145.218.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132641 }
...
:if ([:len [/ip/route/find dst-address=103.41.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.41.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132641 }
:if ([:len [/ip/route/find dst-address=103.41.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.41.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132641 }
