...
:if ([:len [/ip/route/find dst-address=117.239.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.239.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132717 }
:if ([:len [/ip/route/find dst-address=117.239.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.239.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132717 }
