...
:if ([:len [/ip/route/find dst-address=103.18.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.18.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
...
:if ([:len [/ip/route/find dst-address=103.241.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.241.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
