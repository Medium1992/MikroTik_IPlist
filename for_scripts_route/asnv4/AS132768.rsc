...
:if ([:len [/ip/route/find dst-address=103.18.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.18.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
:if ([:len [/ip/route/find dst-address=103.18.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.18.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
...
:if ([:len [/ip/route/find dst-address=139.5.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.5.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
