...
:if ([:len [/ip/route/find dst-address=103.16.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.16.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
:if ([:len [/ip/route/find dst-address=103.16.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.16.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
...
:if ([:len [/ip/route/find dst-address=103.198.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.198.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
...
:if ([:len [/ip/route/find dst-address=103.25.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.25.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
:if ([:len [/ip/route/find dst-address=103.25.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.25.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132768 }
