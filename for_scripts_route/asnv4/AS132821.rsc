...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132821 and dst-address=for_scripts_route/asnv4/AS132821.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132821.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132821 }
