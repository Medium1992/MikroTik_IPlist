...
:if ([:len [/ip/route/find dst-address=43.231.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.231.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132825 }
:if ([:len [/ip/route/find dst-address=43.249.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.249.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132825 }
