...
:if ([:len [/ip/route/find dst-address=45.8.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.8.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132839 }
...
:if ([:len [/ip/route/find dst-address=45.9.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.9.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132839 }
