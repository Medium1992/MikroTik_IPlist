...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.144.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.144.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132883 }
:if ([:len [/ip/route/find dst-address=103.147.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.147.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132883 }
...
:if ([:len [/ip/route/find dst-address=43.251.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.251.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132883 }
:if ([:len [/ip/route/find dst-address=45.115.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.115.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132883 }
