...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132906 and dst-address=for_scripts_route/asnv4/AS132906.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132906.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132906 }
