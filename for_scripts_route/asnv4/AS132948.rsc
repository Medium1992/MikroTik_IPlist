...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132948 and dst-address=for_scripts_route/asnv4/AS132948.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132948.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132948 }
