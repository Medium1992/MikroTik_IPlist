...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS132960 and dst-address=for_scripts_route/asnv4/AS132960.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS132960.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS132960 }
