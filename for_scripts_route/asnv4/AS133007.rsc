...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133007 and dst-address=for_scripts_route/asnv4/AS133007.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133007.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133007 }
