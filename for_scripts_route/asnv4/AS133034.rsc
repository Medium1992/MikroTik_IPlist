...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133034 and dst-address=for_scripts_route/asnv4/AS133034.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133034.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133034 }
