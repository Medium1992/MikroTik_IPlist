...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133051 and dst-address=for_scripts_route/asnv4/AS133051.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133051.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133051 }
