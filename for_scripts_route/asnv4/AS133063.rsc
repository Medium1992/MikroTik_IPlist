...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133063 and dst-address=for_scripts_route/asnv4/AS133063.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133063.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133063 }
