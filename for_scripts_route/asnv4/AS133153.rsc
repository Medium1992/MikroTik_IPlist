...
:if ([:len [/ip/route/find dst-address=212.66.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.66.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133153 }
...
:if ([:len [/ip/route/find dst-address=31.42.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.42.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133153 }
