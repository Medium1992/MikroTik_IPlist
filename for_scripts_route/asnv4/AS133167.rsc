...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133167 and dst-address=for_scripts_route/asnv4/AS133167.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133167.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133167 }
