...
:if ([:len [/ip/route/find dst-address=124.199.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.199.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133200 }
...
:if ([:len [/ip/route/find dst-address=124.199.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.199.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133200 }
...
:if ([:len [/ip/route/find dst-address=167.179.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.179.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133200 }
...
:if ([:len [/ip/route/find dst-address=202.124.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.124.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133200 }
