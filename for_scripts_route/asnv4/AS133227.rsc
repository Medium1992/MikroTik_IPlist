...
:if ([:len [/ip/route/find dst-address=103.48.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.48.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133227 }
...
:if ([:len [/ip/route/find dst-address=163.52.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.52.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133227 }
