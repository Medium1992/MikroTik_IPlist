...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133322 and dst-address=for_scripts_route/asnv4/AS133322.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133322.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133322 }
