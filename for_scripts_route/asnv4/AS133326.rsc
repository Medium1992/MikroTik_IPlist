...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133326 and dst-address=for_scripts_route/asnv4/AS133326.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133326.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133326 }
