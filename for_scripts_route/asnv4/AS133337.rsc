...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133337 and dst-address=for_scripts_route/asnv4/AS133337.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133337.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133337 }
