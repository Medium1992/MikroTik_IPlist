...
:if ([:len [/ip/route/find dst-address=38.21.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.21.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133384 }
:if ([:len [/ip/route/find dst-address=38.47.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133384 }
:if ([:len [/ip/route/find dst-address=38.47.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133384 }
