...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133458 and dst-address=for_scripts_route/asnv4/AS133458.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133458.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133458 }
