...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.155.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.155.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133594 }
:if ([:len [/ip/route/find dst-address=103.37.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.37.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133594 }
...
:if ([:len [/ip/route/find dst-address=103.5.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.5.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133594 }
...
:if ([:len [/ip/route/find dst-address=14.102.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.102.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133594 }
