...
:if ([:len [/ip/route/find dst-address=116.199.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.199.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133606 }
...
:if ([:len [/ip/route/find dst-address=223.29.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.29.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133606 }
:if ([:len [/ip/route/find dst-address=223.29.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.29.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133606 }
