...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133610 and dst-address=for_scripts_route/asnv4/AS133610.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133610.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133610 }
