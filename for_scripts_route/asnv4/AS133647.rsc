...
:if ([:len [/ip/route/find dst-address=103.161.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.161.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
:if ([:len [/ip/route/find dst-address=103.161.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.161.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
...
:if ([:len [/ip/route/find dst-address=103.43.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.43.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
...
:if ([:len [/ip/route/find dst-address=103.93.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.93.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
:if ([:len [/ip/route/find dst-address=160.191.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.191.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
...
:if ([:len [/ip/route/find dst-address=43.230.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.230.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
