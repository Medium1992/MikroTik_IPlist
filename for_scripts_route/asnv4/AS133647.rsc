...
:if ([:len [/ip/route/find dst-address=103.43.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.43.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
...
:if ([:len [/ip/route/find dst-address=160.191.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.191.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133647 }
