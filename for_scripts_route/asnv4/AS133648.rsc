...
:if ([:len [/ip/route/find dst-address=103.170.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.170.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133648 }
...
:if ([:len [/ip/route/find dst-address=43.243.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.243.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133648 }
:if ([:len [/ip/route/find dst-address=45.248.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.248.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133648 }
