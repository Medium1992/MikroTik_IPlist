...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133680 and dst-address=for_scripts_route/asnv4/AS133680.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133680.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133680 }
