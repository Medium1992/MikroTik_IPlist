...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133697 and dst-address=for_scripts_route/asnv4/AS133697.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133697.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133697 }
