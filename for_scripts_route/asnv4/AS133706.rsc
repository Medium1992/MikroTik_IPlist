...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.215.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.215.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133706 }
:if ([:len [/ip/route/find dst-address=103.47.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.47.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133706 }
