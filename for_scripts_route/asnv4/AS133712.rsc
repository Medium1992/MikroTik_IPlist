...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.119.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.119.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133712 }
:if ([:len [/ip/route/find dst-address=103.127.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.127.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133712 }
...
:if ([:len [/ip/route/find dst-address=103.146.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.146.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133712 }
:if ([:len [/ip/route/find dst-address=103.170.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.170.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133712 }
:if ([:len [/ip/route/find dst-address=103.171.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.171.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133712 }
...
:if ([:len [/ip/route/find dst-address=43.231.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.231.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133712 }
