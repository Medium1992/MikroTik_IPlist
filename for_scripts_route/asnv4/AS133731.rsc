...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.231.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.231.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133731 }
...
:if ([:len [/ip/route/find dst-address=103.51.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.51.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133731 }
:if ([:len [/ip/route/find dst-address=103.51.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.51.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133731 }
