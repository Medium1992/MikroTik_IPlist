...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133760 and dst-address=for_scripts_route/asnv4/AS133760.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133760.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133760 }
