...
:if ([:len [/ip/route/find dst-address=200.112.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.112.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13381 }
:if ([:len [/ip/route/find dst-address=200.112.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.112.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13381 }
:if ([:len [/ip/route/find dst-address=200.112.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.112.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13381 }
