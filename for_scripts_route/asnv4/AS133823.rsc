...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133823 and dst-address=for_scripts_route/asnv4/AS133823.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133823.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133823 }
