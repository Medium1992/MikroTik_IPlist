...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS133854 and dst-address=for_scripts_route/asnv4/AS133854.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS133854.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133854 }
