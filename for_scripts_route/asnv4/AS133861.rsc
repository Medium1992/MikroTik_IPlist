...
:if ([:len [/ip/route/find dst-address=206.119.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.119.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133861 }
...
:if ([:len [/ip/route/find dst-address=38.190.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.190.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133861 }
:if ([:len [/ip/route/find dst-address=38.190.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.190.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133861 }
