...
:if ([:len [/ip/route/find dst-address=103.20.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.20.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
...
:if ([:len [/ip/route/find dst-address=111.92.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=111.92.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=111.92.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=111.92.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
