...
:if ([:len [/ip/route/find dst-address=111.92.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=111.92.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=111.92.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=111.92.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
...
:if ([:len [/ip/route/find dst-address=14.192.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=14.192.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
:if ([:len [/ip/route/find dst-address=14.192.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS133933 }
