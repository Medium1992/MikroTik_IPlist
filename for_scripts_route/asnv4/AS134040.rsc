...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS134040 and dst-address=for_scripts_route/asnv4/AS134040.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS134040.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134040 }
