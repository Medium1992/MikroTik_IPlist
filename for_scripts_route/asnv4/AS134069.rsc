...
:if ([:len [/ip/route/find dst-address=203.115.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.115.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134069 }
...
:if ([:len [/ip/route/find dst-address=203.115.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.115.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134069 }
