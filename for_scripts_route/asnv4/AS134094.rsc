...
:if ([:len [/ip/route/find dst-address=103.103.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.103.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134094 }
...
:if ([:len [/ip/route/find dst-address=131.143.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.143.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134094 }
:if ([:len [/ip/route/find dst-address=185.190.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.190.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134094 }
:if ([:len [/ip/route/find dst-address=185.190.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.190.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134094 }
