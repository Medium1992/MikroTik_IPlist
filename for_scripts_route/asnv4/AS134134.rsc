...
:if ([:len [/ip/route/find dst-address=103.53.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.53.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134134 }
:if ([:len [/ip/route/find dst-address=103.53.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.53.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134134 }
:if ([:len [/ip/route/find dst-address=116.204.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.204.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134134 }
:if ([:len [/ip/route/find dst-address=163.223.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.223.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134134 }
