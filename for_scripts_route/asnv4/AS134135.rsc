...
:if ([:len [/ip/route/find dst-address=212.134.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.134.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134135 }
:if ([:len [/ip/route/find dst-address=212.134.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.134.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134135 }
