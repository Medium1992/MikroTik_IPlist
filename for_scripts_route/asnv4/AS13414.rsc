...
:if ([:len [/ip/route/find dst-address=209.237.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.237.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
:if ([:len [/ip/route/find dst-address=209.237.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.237.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
:if ([:len [/ip/route/find dst-address=209.237.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.237.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
:if ([:len [/ip/route/find dst-address=209.237.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.237.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
:if ([:len [/ip/route/find dst-address=209.237.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.237.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
...
:if ([:len [/ip/route/find dst-address=69.195.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.195.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
