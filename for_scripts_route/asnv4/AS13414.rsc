...
:if ([:len [/ip/route/find dst-address=104.244.40.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.244.40.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
...
:if ([:len [/ip/route/find dst-address=209.237.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.237.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13414 }
