...
:if ([:len [/ip/route/find dst-address=154.221.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.221.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
...
:if ([:len [/ip/route/find dst-address=177.210.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.210.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
:if ([:len [/ip/route/find dst-address=177.210.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.210.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
:if ([:len [/ip/route/find dst-address=177.210.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.210.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
:if ([:len [/ip/route/find dst-address=177.210.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.210.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
:if ([:len [/ip/route/find dst-address=177.210.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.210.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
:if ([:len [/ip/route/find dst-address=177.210.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.210.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
:if ([:len [/ip/route/find dst-address=177.210.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.210.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134175 }
