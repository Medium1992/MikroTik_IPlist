...
:if ([:len [/ip/route/find dst-address=43.243.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.243.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134254 }
:if ([:len [/ip/route/find dst-address=43.243.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.243.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134254 }
