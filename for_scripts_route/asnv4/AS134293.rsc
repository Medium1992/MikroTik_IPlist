...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS134293 and dst-address=for_scripts_route/asnv4/AS134293.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS134293.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134293 }
