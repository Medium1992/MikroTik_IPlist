...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS134294 and dst-address=for_scripts_route/asnv4/AS134294.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS134294.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134294 }
