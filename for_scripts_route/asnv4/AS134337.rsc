...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS134337 and dst-address=for_scripts_route/asnv4/AS134337.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS134337.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134337 }
