...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=107.149.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.149.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134365 }
...
:if ([:len [/ip/route/find dst-address=156.226.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.226.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134365 }
