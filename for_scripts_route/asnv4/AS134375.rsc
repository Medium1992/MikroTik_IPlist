...
:if ([:len [/ip/route/find dst-address=119.252.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.252.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134375 }
:if ([:len [/ip/route/find dst-address=119.252.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.252.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134375 }
:if ([:len [/ip/route/find dst-address=119.252.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.252.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134375 }
:if ([:len [/ip/route/find dst-address=119.252.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.252.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134375 }
