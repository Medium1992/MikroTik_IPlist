...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=114.106.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.106.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134425 }
:if ([:len [/ip/route/find dst-address=114.106.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.106.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134425 }
