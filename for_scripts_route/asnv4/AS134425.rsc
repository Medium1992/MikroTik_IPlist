...
:if ([:len [/ip/route/find dst-address=117.66.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.66.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134425 }
:if ([:len [/ip/route/find dst-address=117.66.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.66.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134425 }
