...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.127.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.127.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13444 }
...
:if ([:len [/ip/route/find dst-address=103.59.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.59.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13444 }
:if ([:len [/ip/route/find dst-address=103.59.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.59.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13444 }
