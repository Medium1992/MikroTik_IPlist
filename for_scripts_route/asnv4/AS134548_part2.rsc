...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=45.199.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.199.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134548 }
:if ([:len [/ip/route/find dst-address=45.203.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.203.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134548 }
