...
:if ([:len [/ip/route/find dst-address=103.47.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.47.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134555 }
:if ([:len [/ip/route/find dst-address=103.86.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.86.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134555 }
...
:if ([:len [/ip/route/find dst-address=160.236.63.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.236.63.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134555 }
