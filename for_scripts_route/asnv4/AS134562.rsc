...
:if ([:len [/ip/route/find dst-address=103.238.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.238.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134562 }
...
:if ([:len [/ip/route/find dst-address=151.158.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134562 }
:if ([:len [/ip/route/find dst-address=160.250.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.250.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134562 }
