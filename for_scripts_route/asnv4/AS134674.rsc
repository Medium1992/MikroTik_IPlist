...
:if ([:len [/ip/route/find dst-address=103.76.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.76.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134674 }
...
:if ([:len [/ip/route/find dst-address=45.127.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.127.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134674 }
