...
:if ([:len [/ip/route/find dst-address=103.76.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.76.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134674 }
:if ([:len [/ip/route/find dst-address=103.76.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.76.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134674 }
