...
:if ([:len [/ip/route/find dst-address=183.39.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.39.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134774 }
:if ([:len [/ip/route/find dst-address=183.62.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.62.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134774 }
...
:if ([:len [/ip/route/find dst-address=218.18.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.18.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134774 }
