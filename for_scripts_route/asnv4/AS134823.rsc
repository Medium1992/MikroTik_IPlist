...
:if ([:len [/ip/route/find dst-address=103.136.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.136.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
...
:if ([:len [/ip/route/find dst-address=103.208.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.208.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
:if ([:len [/ip/route/find dst-address=103.246.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.246.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
:if ([:len [/ip/route/find dst-address=144.48.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.48.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
:if ([:len [/ip/route/find dst-address=154.18.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.18.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
...
:if ([:len [/ip/route/find dst-address=163.128.193.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.128.193.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
...
:if ([:len [/ip/route/find dst-address=211.155.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.155.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
...
:if ([:len [/ip/route/find dst-address=45.221.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.221.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
:if ([:len [/ip/route/find dst-address=93.90.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.90.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134823 }
