...
:if ([:len [/ip/route/find dst-address=103.56.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.56.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
:if ([:len [/ip/route/find dst-address=103.72.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.72.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
...
:if ([:len [/ip/route/find dst-address=122.128.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=122.128.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
...
:if ([:len [/ip/route/find dst-address=185.239.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.239.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
...
:if ([:len [/ip/route/find dst-address=217.60.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
:if ([:len [/ip/route/find dst-address=217.60.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
