...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.194.41.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.194.41.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
...
:if ([:len [/ip/route/find dst-address=103.205.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.205.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134835 }
