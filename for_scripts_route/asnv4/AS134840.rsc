...
:if ([:len [/ip/route/find dst-address=103.237.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.237.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134840 }
:if ([:len [/ip/route/find dst-address=103.237.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.237.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134840 }
