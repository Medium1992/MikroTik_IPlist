...
:if ([:len [/ip/route/find dst-address=103.237.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.237.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134840 }
:if ([:len [/ip/route/find dst-address=103.56.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.56.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134840 }
...
:if ([:len [/ip/route/find dst-address=116.206.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.206.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134840 }
