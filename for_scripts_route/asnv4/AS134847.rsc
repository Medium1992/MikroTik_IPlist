...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS134847 and dst-address=for_scripts_route/asnv4/AS134847.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS134847.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134847 }
