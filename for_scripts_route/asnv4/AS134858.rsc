...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.105.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.105.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134858 }
...
:if ([:len [/ip/route/find dst-address=103.148.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.148.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS134858 }
