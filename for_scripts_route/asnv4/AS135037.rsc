...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.156.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.156.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135037 }
...
:if ([:len [/ip/route/find dst-address=103.251.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.251.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135037 }
