...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135048 and dst-address=for_scripts_route/asnv4/AS135048.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135048.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135048 }
