...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135076 and dst-address=for_scripts_route/asnv4/AS135076.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135076.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135076 }
