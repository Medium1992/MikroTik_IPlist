...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135102 and dst-address=for_scripts_route/asnv4/AS135102.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135102.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135102 }
