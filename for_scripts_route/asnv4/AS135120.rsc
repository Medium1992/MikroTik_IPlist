...
:if ([:len [/ip/route/find dst-address=142.249.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
...
:if ([:len [/ip/route/find dst-address=182.237.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=182.237.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
...
:if ([:len [/ip/route/find dst-address=203.210.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.210.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
...
:if ([:len [/ip/route/find dst-address=210.87.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.87.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
