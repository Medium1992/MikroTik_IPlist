...
:if ([:len [/ip/route/find dst-address=203.210.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.210.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
:if ([:len [/ip/route/find dst-address=203.210.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.210.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
...
:if ([:len [/ip/route/find dst-address=210.87.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.87.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
:if ([:len [/ip/route/find dst-address=210.87.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.87.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
:if ([:len [/ip/route/find dst-address=210.87.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.87.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
...
:if ([:len [/ip/route/find dst-address=23.27.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.27.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135120 }
