...
:if ([:len [/ip/route/find dst-address=103.129.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.129.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135193 }
...
:if ([:len [/ip/route/find dst-address=103.176.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.176.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135193 }
