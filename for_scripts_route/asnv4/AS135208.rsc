...
:if ([:len [/ip/route/find dst-address=103.160.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.160.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135208 }
...
:if ([:len [/ip/route/find dst-address=103.173.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.173.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135208 }
