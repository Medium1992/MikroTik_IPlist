...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135277 and dst-address=for_scripts_route/asnv4/AS135277.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135277.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135277 }
