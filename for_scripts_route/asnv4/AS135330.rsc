...
:if ([:len [/ip/route/find dst-address=139.28.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.28.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135330 }
:if ([:len [/ip/route/find dst-address=147.189.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.189.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135330 }
...
:if ([:len [/ip/route/find dst-address=2.56.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.56.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135330 }
