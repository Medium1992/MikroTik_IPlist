...
:if ([:len [/ip/route/find dst-address=139.28.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.28.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135330 }
:if ([:len [/ip/route/find dst-address=139.28.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.28.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135330 }
