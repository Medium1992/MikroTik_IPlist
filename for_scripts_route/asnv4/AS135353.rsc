...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135353 and dst-address=for_scripts_route/asnv4/AS135353.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135353.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135353 }
