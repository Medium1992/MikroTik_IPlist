...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135359 and dst-address=for_scripts_route/asnv4/AS135359.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135359.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135359 }
