...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135376 and dst-address=for_scripts_route/asnv4/AS135376.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135376.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135376 }
