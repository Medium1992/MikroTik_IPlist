...
:if ([:len [/ip/route/find dst-address=202.44.246.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.44.246.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135381 }
...
:if ([:len [/ip/route/find dst-address=203.150.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.150.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135381 }
...
:if ([:len [/ip/route/find dst-address=203.150.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.150.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135381 }
