...
:if ([:len [/ip/route/find dst-address=103.216.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.216.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135386 }
...
:if ([:len [/ip/route/find dst-address=103.9.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.9.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135386 }
...
:if ([:len [/ip/route/find dst-address=45.248.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.248.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135386 }
