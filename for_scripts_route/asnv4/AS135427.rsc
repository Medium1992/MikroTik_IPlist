...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135427 and dst-address=for_scripts_route/asnv4/AS135427.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135427.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135427 }
