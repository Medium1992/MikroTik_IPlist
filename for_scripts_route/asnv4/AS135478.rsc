...
:if ([:len [/ip/route/find dst-address=103.121.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.121.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135478 }
...
:if ([:len [/ip/route/find dst-address=103.129.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.129.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135478 }
...
:if ([:len [/ip/route/find dst-address=103.129.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.129.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135478 }
...
:if ([:len [/ip/route/find dst-address=175.158.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.158.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135478 }
:if ([:len [/ip/route/find dst-address=175.158.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.158.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135478 }
...
:if ([:len [/ip/route/find dst-address=202.73.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.73.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135478 }
:if ([:len [/ip/route/find dst-address=23.27.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.27.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135478 }
