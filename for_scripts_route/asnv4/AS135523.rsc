...
:if ([:len [/ip/route/find dst-address=202.142.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.142.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135523 }
...
:if ([:len [/ip/route/find dst-address=203.92.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.92.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135523 }
