...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.65.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.65.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135553 }
...
:if ([:len [/ip/route/find dst-address=203.34.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.34.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135553 }
