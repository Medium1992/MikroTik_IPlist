...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135581 and dst-address=for_scripts_route/asnv4/AS135581.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135581.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135581 }
