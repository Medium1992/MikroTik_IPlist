...
:if ([:len [/ip/route/find dst-address=103.139.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.139.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135636 }
...
:if ([:len [/ip/route/find dst-address=116.206.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.206.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135636 }
