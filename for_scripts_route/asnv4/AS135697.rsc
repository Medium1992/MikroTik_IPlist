...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135697 and dst-address=for_scripts_route/asnv4/AS135697.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135697.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135697 }
