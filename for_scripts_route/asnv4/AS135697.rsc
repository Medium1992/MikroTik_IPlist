...
:if ([:len [/ip/route/find dst-address=103.211.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.211.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135697 }
...
:if ([:len [/ip/route/find dst-address=160.191.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.191.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135697 }
