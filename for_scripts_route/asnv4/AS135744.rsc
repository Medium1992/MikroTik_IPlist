...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.162.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.162.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135744 }
...
:if ([:len [/ip/route/find dst-address=49.213.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.213.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135744 }
