...
:if ([:len [/ip/route/find dst-address=103.208.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.208.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135761 }
:if ([:len [/ip/route/find dst-address=103.218.186.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.218.186.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135761 }
