...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135814 and dst-address=for_scripts_route/asnv4/AS135814.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135814.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135814 }
