...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135821 and dst-address=for_scripts_route/asnv4/AS135821.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135821.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135821 }
