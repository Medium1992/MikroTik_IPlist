...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS135826 and dst-address=for_scripts_route/asnv4/AS135826.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS135826.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135826 }
