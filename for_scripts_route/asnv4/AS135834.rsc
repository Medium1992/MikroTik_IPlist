...
:if ([:len [/ip/route/find dst-address=160.25.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.25.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135834 }
:if ([:len [/ip/route/find dst-address=163.227.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.227.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135834 }
:if ([:len [/ip/route/find dst-address=165.99.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.99.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135834 }
