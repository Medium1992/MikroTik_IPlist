...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.109.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.109.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135836 }
...
:if ([:len [/ip/route/find dst-address=103.182.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.182.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135836 }
:if ([:len [/ip/route/find dst-address=103.189.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.189.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135836 }
...
:if ([:len [/ip/route/find dst-address=103.87.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.87.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135836 }
:if ([:len [/ip/route/find dst-address=103.87.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.87.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135836 }
:if ([:len [/ip/route/find dst-address=43.225.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.225.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135836 }
