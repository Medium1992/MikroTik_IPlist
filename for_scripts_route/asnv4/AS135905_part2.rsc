...
:if ([:len [/ip/route/find dst-address=45.120.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.120.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135905 }
:if ([:len [/ip/route/find dst-address=45.120.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.120.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS135905 }
