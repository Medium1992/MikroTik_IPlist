...
:if ([:len [/ip/route/find dst-address=103.125.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.125.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136030 }
...
:if ([:len [/ip/route/find dst-address=180.149.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.149.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136030 }
:if ([:len [/ip/route/find dst-address=180.149.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.149.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136030 }
