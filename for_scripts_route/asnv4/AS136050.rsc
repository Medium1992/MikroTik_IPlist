...
:if ([:len [/ip/route/find dst-address=103.175.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.175.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136050 }
...
:if ([:len [/ip/route/find dst-address=172.110.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.110.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136050 }
...
:if ([:len [/ip/route/find dst-address=87.86.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.86.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136050 }
