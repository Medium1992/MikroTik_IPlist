...
:if ([:len [/ip/route/find dst-address=103.220.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.220.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136093 }
...
:if ([:len [/ip/route/find dst-address=154.38.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.38.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136093 }
:if ([:len [/ip/route/find dst-address=154.38.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.38.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136093 }
