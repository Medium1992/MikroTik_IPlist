...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.122.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.122.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136141 }
...
:if ([:len [/ip/route/find dst-address=103.136.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.136.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136141 }
...
:if ([:len [/ip/route/find dst-address=103.166.41.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.166.41.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136141 }
...
:if ([:len [/ip/route/find dst-address=151.158.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136141 }
