...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136161 and dst-address=for_scripts_route/asnv4/AS136161.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136161.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136161 }
