...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136180 and dst-address=for_scripts_route/asnv4/AS136180.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136180.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136180 }
