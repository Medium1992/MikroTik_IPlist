...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136184 and dst-address=for_scripts_route/asnv4/AS136184.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136184.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136184 }
