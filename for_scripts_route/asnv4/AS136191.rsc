...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136191 and dst-address=for_scripts_route/asnv4/AS136191.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136191.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136191 }
