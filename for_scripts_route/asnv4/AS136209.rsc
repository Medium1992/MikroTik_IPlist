...
:if ([:len [/ip/route/find dst-address=103.50.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.50.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
...
:if ([:len [/ip/route/find dst-address=103.60.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.60.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
:if ([:len [/ip/route/find dst-address=103.60.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.60.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
...
:if ([:len [/ip/route/find dst-address=43.231.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.231.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
...
:if ([:len [/ip/route/find dst-address=45.117.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.117.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
:if ([:len [/ip/route/find dst-address=45.117.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.117.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
:if ([:len [/ip/route/find dst-address=45.119.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.119.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
:if ([:len [/ip/route/find dst-address=45.120.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.120.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136209 }
