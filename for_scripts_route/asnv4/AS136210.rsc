...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136210 and dst-address=for_scripts_route/asnv4/AS136210.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136210.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136210 }
