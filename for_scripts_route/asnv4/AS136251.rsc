...
:if ([:len [/ip/route/find dst-address=202.181.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.181.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136251 }
:if ([:len [/ip/route/find dst-address=202.181.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.181.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136251 }
