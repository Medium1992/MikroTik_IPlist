...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136251 and dst-address=for_scripts_route/asnv4/AS136251.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136251.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136251 }
