...
:if ([:len [/ip/route/find dst-address=202.165.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.165.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136255 }
...
:if ([:len [/ip/route/find dst-address=27.109.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.109.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136255 }
