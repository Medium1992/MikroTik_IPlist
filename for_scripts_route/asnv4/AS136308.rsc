...
:if ([:len [/ip/route/find dst-address=103.188.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.188.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136308 }
:if ([:len [/ip/route/find dst-address=103.189.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.189.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136308 }
...
:if ([:len [/ip/route/find dst-address=162.4.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.4.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136308 }
