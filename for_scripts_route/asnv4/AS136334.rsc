...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.113.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.113.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136334 }
...
:if ([:len [/ip/route/find dst-address=38.121.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.121.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136334 }
:if ([:len [/ip/route/find dst-address=38.35.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.35.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136334 }
