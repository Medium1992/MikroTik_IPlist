...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.228.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.228.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136374 }
...
:if ([:len [/ip/route/find dst-address=103.94.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.94.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136374 }
