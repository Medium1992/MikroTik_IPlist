...
:if ([:len [/ip/route/find dst-address=205.164.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.164.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=205.164.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.164.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=205.164.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.164.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=205.164.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.164.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=205.164.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.164.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
