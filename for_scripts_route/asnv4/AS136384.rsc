...
:if ([:len [/ip/route/find dst-address=206.0.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=38.10.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.10.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=38.10.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.10.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
