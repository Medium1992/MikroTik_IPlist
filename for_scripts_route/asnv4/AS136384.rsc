...
:if ([:len [/ip/route/find dst-address=206.0.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
...
:if ([:len [/ip/route/find dst-address=206.0.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
:if ([:len [/ip/route/find dst-address=206.0.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136384 }
