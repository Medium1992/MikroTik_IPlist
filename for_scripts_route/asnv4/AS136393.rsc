...
:if ([:len [/ip/route/find dst-address=96.30.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.30.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136393 }
...
:if ([:len [/ip/route/find dst-address=96.30.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.30.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136393 }
