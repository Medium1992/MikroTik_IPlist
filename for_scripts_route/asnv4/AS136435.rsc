...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136435 and dst-address=for_scripts_route/asnv4/AS136435.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136435.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136435 }
