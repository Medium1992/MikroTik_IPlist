...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136457 and dst-address=for_scripts_route/asnv4/AS136457.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136457.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136457 }
