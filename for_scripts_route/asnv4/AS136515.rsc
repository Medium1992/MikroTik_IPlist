...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136515 and dst-address=for_scripts_route/asnv4/AS136515.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136515.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136515 }
