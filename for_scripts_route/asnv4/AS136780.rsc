...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS136780 and dst-address=for_scripts_route/asnv4/AS136780.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS136780.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136780 }
