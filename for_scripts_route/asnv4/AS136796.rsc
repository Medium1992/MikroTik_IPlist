...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.81.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.81.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136796 }
...
:if ([:len [/ip/route/find dst-address=195.180.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.180.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS136796 }
