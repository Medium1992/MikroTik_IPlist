...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=64.185.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.185.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13693 }
:if ([:len [/ip/route/find dst-address=64.185.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.185.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13693 }
:if ([:len [/ip/route/find dst-address=64.185.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.185.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13693 }
:if ([:len [/ip/route/find dst-address=64.185.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.185.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13693 }
:if ([:len [/ip/route/find dst-address=64.185.47.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.185.47.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13693 }
:if ([:len [/ip/route/find dst-address=64.185.47.128/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.185.47.128/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13693 }
