...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137023 and dst-address=for_scripts_route/asnv4/AS137023.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137023.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137023 }
