...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137058 and dst-address=for_scripts_route/asnv4/AS137058.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137058.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137058 }
