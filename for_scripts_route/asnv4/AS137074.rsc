...
:if ([:len [/ip/route/find dst-address=203.144.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.144.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137074 }
:if ([:len [/ip/route/find dst-address=203.144.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.144.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137074 }
