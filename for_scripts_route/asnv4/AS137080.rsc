...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137080 and dst-address=for_scripts_route/asnv4/AS137080.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137080.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137080 }
