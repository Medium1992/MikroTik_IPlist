...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137083 and dst-address=for_scripts_route/asnv4/AS137083.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137083.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137083 }
