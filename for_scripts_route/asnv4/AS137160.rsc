...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137160 and dst-address=for_scripts_route/asnv4/AS137160.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137160.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137160 }
