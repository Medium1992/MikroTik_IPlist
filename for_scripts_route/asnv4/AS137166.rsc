...
:if ([:len [/ip/route/find dst-address=114.79.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.79.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137166 }
...
:if ([:len [/ip/route/find dst-address=163.53.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.53.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137166 }
