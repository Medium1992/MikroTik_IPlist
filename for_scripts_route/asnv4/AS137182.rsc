...
:if ([:len [/ip/route/find dst-address=154.46.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.46.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137182 }
...
:if ([:len [/ip/route/find dst-address=38.135.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.135.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137182 }
