...
:if ([:len [/ip/route/find dst-address=157.228.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.228.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137182 }
:if ([:len [/ip/route/find dst-address=157.228.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.228.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137182 }
:if ([:len [/ip/route/find dst-address=157.228.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.228.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137182 }
:if ([:len [/ip/route/find dst-address=157.228.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.228.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137182 }
...
:if ([:len [/ip/route/find dst-address=38.57.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.57.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137182 }
