...
:if ([:len [/ip/route/find dst-address=163.128.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.128.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137331 }
:if ([:len [/ip/route/find dst-address=178.83.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137331 }
