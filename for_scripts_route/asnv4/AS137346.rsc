...
:if ([:len [/ip/route/find dst-address=115.178.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.178.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137346 }
:if ([:len [/ip/route/find dst-address=115.178.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.178.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137346 }
