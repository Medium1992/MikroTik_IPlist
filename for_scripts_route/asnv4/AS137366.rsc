...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137366 and dst-address=for_scripts_route/asnv4/AS137366.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137366.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137366 }
