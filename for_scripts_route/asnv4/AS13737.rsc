...
:if ([:len [/ip/route/find dst-address=23.129.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.129.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13737 }
:if ([:len [/ip/route/find dst-address=23.169.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.169.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13737 }
