...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137394 and dst-address=for_scripts_route/asnv4/AS137394.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137394.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137394 }
