...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137455 and dst-address=for_scripts_route/asnv4/AS137455.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137455.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137455 }
