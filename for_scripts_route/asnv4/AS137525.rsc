...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137525 and dst-address=for_scripts_route/asnv4/AS137525.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137525.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137525 }
