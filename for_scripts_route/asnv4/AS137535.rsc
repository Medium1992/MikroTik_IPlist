...
:if ([:len [/ip/route/find dst-address=177.2.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.2.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137535 }
:if ([:len [/ip/route/find dst-address=177.3.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.3.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137535 }
:if ([:len [/ip/route/find dst-address=177.4.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.4.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137535 }
:if ([:len [/ip/route/find dst-address=177.5.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.5.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137535 }
