...
:if ([:len [/ip/route/find dst-address=172.81.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.81.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137535 }
:if ([:len [/ip/route/find dst-address=172.81.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.81.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137535 }
