...
:if ([:len [/ip/route/find dst-address=42.201.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.201.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137735 }
...
:if ([:len [/ip/route/find dst-address=42.240.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.240.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137735 }
:if ([:len [/ip/route/find dst-address=42.240.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.240.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137735 }
:if ([:len [/ip/route/find dst-address=42.240.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.240.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137735 }
:if ([:len [/ip/route/find dst-address=42.240.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.240.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137735 }
