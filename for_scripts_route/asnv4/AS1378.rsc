...
:if ([:len [/ip/route/find dst-address=38.252.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.160/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.160/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.169/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.169/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.170/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.170/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.172/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.172/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.169.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.169.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
:if ([:len [/ip/route/find dst-address=38.252.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.252.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1378 }
