...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137868 and dst-address=for_scripts_route/asnv4/AS137868.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137868.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137868 }
