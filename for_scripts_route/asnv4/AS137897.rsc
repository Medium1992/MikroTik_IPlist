...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.182.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.182.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137897 }
...
:if ([:len [/ip/route/find dst-address=151.242.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.242.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137897 }
:if ([:len [/ip/route/find dst-address=151.242.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.242.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137897 }
...
:if ([:len [/ip/route/find dst-address=31.57.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137897 }
:if ([:len [/ip/route/find dst-address=38.248.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.248.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137897 }
