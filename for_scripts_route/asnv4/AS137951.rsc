...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.212.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.212.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
...
:if ([:len [/ip/route/find dst-address=168.76.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
