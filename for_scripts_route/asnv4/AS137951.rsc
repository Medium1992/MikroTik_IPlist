...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.212.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.212.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=154.212.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.212.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
...
:if ([:len [/ip/route/find dst-address=168.76.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
...
:if ([:len [/ip/route/find dst-address=168.76.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
:if ([:len [/ip/route/find dst-address=168.76.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.76.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137951 }
