...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137964 and dst-address=for_scripts_route/asnv4/AS137964.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137964.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137964 }
