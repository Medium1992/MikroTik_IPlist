...
:if ([:len [/ip/route/find dst-address=154.209.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.209.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137996 }
:if ([:len [/ip/route/find dst-address=45.196.153.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.196.153.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137996 }
