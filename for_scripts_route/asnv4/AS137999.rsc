...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS137999 and dst-address=for_scripts_route/asnv4/AS137999.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS137999.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS137999 }
