...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS138045 and dst-address=for_scripts_route/asnv4/AS138045.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS138045.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138045 }
