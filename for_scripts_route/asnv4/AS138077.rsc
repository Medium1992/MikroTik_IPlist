...
:if ([:len [/ip/route/find dst-address=103.150.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.150.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
:if ([:len [/ip/route/find dst-address=103.16.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.16.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
:if ([:len [/ip/route/find dst-address=103.160.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.160.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
...
:if ([:len [/ip/route/find dst-address=103.52.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.52.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
...
:if ([:len [/ip/route/find dst-address=202.155.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.155.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
:if ([:len [/ip/route/find dst-address=202.155.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.155.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
:if ([:len [/ip/route/find dst-address=202.155.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.155.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
...
:if ([:len [/ip/route/find dst-address=203.84.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.84.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
