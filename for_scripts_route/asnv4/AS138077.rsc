...
:if ([:len [/ip/route/find dst-address=117.103.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.103.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
...
:if ([:len [/ip/route/find dst-address=202.56.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.56.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
:if ([:len [/ip/route/find dst-address=202.56.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.56.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138077 }
