...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13807 and dst-address=for_scripts_route/asnv4/AS13807_part2.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13807_part2.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13807 }
