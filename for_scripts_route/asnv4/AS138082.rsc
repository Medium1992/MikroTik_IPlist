...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS138082 and dst-address=for_scripts_route/asnv4/AS138082.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS138082.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138082 }
