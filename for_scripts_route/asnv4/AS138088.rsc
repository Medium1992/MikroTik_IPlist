...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS138088 and dst-address=for_scripts_route/asnv4/AS138088.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS138088.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138088 }
