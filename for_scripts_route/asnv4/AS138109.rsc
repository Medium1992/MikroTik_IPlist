...
:if ([:len [/ip/route/find dst-address=103.126.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.126.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138109 }
