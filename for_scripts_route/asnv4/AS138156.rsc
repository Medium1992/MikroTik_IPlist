...
:if ([:len [/ip/route/find dst-address=191.96.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.96.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138156 }
...
:if ([:len [/ip/route/find dst-address=89.213.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138156 }
