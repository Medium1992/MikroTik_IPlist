...
:if ([:len [/ip/route/find dst-address=66.249.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.249.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13819 }
:if ([:len [/ip/route/find dst-address=66.249.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.249.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13819 }
:if ([:len [/ip/route/find dst-address=66.249.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.249.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13819 }
