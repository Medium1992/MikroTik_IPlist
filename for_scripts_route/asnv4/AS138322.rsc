...
:if ([:len [/ip/route/find dst-address=61.5.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.5.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138322 }
...
:if ([:len [/ip/route/find dst-address=61.5.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.5.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138322 }
