...
:if ([:len [/ip/route/find dst-address=152.36.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.36.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138322 }
...
:if ([:len [/ip/route/find dst-address=152.36.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.36.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138322 }
...
:if ([:len [/ip/route/find dst-address=43.250.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.250.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138322 }
