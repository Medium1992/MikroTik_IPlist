...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.213.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.213.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138322 }
:if ([:len [/ip/route/find dst-address=103.213.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.213.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138322 }
