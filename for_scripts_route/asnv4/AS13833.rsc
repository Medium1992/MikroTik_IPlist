...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13833 and dst-address=for_scripts_route/asnv4/AS13833.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13833.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13833 }
