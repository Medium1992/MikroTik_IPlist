...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.123.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.123.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138346 }
...
:if ([:len [/ip/route/find dst-address=103.38.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.38.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138346 }
