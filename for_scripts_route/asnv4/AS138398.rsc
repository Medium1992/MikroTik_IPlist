...
:if ([:len [/ip/route/find dst-address=163.128.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.128.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138398 }
:if ([:len [/ip/route/find dst-address=167.179.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.179.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138398 }
:if ([:len [/ip/route/find dst-address=45.74.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.74.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138398 }
