...
:if ([:len [/ip/route/find dst-address=117.134.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=117.134.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=117.134.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=117.134.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=117.134.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=117.134.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
