...
:if ([:len [/ip/route/find dst-address=223.123.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=223.123.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=223.123.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=223.123.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=223.123.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
:if ([:len [/ip/route/find dst-address=223.123.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138423 }
