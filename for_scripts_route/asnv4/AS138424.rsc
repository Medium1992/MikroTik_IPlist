...
:if ([:len [/ip/route/find dst-address=103.92.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.92.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138424 }
...
:if ([:len [/ip/route/find dst-address=192.58.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.58.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138424 }
