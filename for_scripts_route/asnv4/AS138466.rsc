...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS138466 and dst-address=for_scripts_route/asnv4/AS138466.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS138466.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138466 }
