...
:if ([:len [/ip/route/find dst-address=180.183.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.183.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138524 }
:if ([:len [/ip/route/find dst-address=180.183.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.183.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138524 }
:if ([:len [/ip/route/find dst-address=180.183.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.183.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138524 }
