...
:if ([:len [/ip/route/find dst-address=180.183.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.183.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138524 }
:if ([:len [/ip/route/find dst-address=180.183.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.183.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138524 }
