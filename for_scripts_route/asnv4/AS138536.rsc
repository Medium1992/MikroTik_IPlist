...
:if ([:len [/ip/route/find dst-address=180.210.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.210.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138536 }
:if ([:len [/ip/route/find dst-address=180.210.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.210.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138536 }
