...
:if ([:len [/ip/route/find dst-address=180.210.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.210.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138536 }
...
:if ([:len [/ip/route/find dst-address=180.210.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.210.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138536 }
