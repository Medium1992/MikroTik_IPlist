...
:if ([:len [/ip/route/find dst-address=103.114.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.114.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138640 }
:if ([:len [/ip/route/find dst-address=103.131.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.131.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138640 }
...
:if ([:len [/ip/route/find dst-address=220.152.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=220.152.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138640 }
