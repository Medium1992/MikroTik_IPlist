...
:if ([:len [/ip/route/find dst-address=103.137.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.137.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138640 }
...
:if ([:len [/ip/route/find dst-address=103.159.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.159.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138640 }
...
:if ([:len [/ip/route/find dst-address=123.136.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=123.136.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138640 }
