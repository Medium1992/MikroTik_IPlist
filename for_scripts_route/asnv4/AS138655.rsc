...
:if ([:len [/ip/route/find dst-address=119.73.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.73.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138655 }
:if ([:len [/ip/route/find dst-address=119.73.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.73.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138655 }
...
:if ([:len [/ip/route/find dst-address=149.40.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.40.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138655 }
:if ([:len [/ip/route/find dst-address=149.71.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.71.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138655 }
...
:if ([:len [/ip/route/find dst-address=154.57.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.57.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138655 }
...
:if ([:len [/ip/route/find dst-address=38.249.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.249.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138655 }
