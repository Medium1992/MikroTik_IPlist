...
:if ([:len [/ip/route/find dst-address=207.14.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.14.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13871 }
:if ([:len [/ip/route/find dst-address=207.14.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.14.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13871 }
