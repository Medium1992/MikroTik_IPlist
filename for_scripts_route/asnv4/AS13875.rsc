...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13875 and dst-address=for_scripts_route/asnv4/AS13875.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13875.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13875 }
