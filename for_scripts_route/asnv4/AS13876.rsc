...
:if ([:len [/ip/route/find dst-address=64.186.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.186.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=64.186.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.186.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=64.186.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.186.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
