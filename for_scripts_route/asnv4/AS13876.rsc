...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=158.41.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
...
:if ([:len [/ip/route/find dst-address=64.186.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.186.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=64.186.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.186.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=64.186.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.186.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
...
:if ([:len [/ip/route/find dst-address=67.204.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.204.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=67.204.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.204.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
...
:if ([:len [/ip/route/find dst-address=67.204.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.204.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=67.204.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.204.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=67.204.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.204.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=67.204.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.204.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
:if ([:len [/ip/route/find dst-address=67.204.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.204.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13876 }
