...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS138884 and dst-address=for_scripts_route/asnv4/AS138884.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS138884.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138884 }
