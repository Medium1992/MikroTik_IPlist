...
:if ([:len [/ip/route/find dst-address=162.223.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.223.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13896 }
...
:if ([:len [/ip/route/find dst-address=206.81.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.81.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13896 }
...
:if ([:len [/ip/route/find dst-address=209.94.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.94.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13896 }
