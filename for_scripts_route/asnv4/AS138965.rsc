...
:if ([:len [/ip/route/find dst-address=103.252.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.252.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138965 }
:if ([:len [/ip/route/find dst-address=103.252.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.252.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138965 }
...
:if ([:len [/ip/route/find dst-address=154.223.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.223.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138965 }
