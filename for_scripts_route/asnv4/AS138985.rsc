...
:if ([:len [/ip/route/find dst-address=103.20.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.20.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138985 }
...
:if ([:len [/ip/route/find dst-address=116.90.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.90.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138985 }
:if ([:len [/ip/route/find dst-address=14.192.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138985 }
...
:if ([:len [/ip/route/find dst-address=43.247.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.247.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138985 }
