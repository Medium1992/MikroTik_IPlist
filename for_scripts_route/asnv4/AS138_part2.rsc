...
:if ([:len [/ip/route/find dst-address=131.68.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.68.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138 }
:if ([:len [/ip/route/find dst-address=131.68.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.68.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138 }
:if ([:len [/ip/route/find dst-address=131.68.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.68.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138 }
:if ([:len [/ip/route/find dst-address=131.68.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.68.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS138 }
