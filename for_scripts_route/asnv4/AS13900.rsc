...
:if ([:len [/ip/route/find dst-address=159.26.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.26.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13900 }
:if ([:len [/ip/route/find dst-address=159.26.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.26.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13900 }
...
:if ([:len [/ip/route/find dst-address=159.26.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.26.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13900 }
