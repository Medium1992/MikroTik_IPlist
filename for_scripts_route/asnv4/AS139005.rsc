...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139005 and dst-address=for_scripts_route/asnv4/AS139005.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139005.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139005 }
