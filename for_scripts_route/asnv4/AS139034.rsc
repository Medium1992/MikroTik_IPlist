...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139034 and dst-address=for_scripts_route/asnv4/AS139034.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139034.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139034 }
