...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139049 and dst-address=for_scripts_route/asnv4/AS139049.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139049.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139049 }
