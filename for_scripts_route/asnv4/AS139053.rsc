...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139053 and dst-address=for_scripts_route/asnv4/AS139053.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139053.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139053 }
