...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.105.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.105.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139195 }
...
:if ([:len [/ip/route/find dst-address=103.42.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.42.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139195 }
...
:if ([:len [/ip/route/find dst-address=38.183.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.183.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139195 }
:if ([:len [/ip/route/find dst-address=38.183.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.183.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139195 }
