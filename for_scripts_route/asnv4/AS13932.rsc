...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS13932 and dst-address=for_scripts_route/asnv4/AS13932.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS13932.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13932 }
