...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139351 and dst-address=for_scripts_route/asnv4/AS139351.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139351.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139351 }
