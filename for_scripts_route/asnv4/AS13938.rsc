...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.2.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.2.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13938 }
...
:if ([:len [/ip/route/find dst-address=65.51.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.51.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13938 }
