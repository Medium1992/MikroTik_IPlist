...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139479 and dst-address=for_scripts_route/asnv4/AS139479.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139479.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139479 }
