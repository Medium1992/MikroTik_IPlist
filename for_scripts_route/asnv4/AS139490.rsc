...
:if ([:len [/ip/route/find dst-address=103.171.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.171.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139490 }
...
:if ([:len [/ip/route/find dst-address=14.192.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139490 }
:if ([:len [/ip/route/find dst-address=14.192.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139490 }
