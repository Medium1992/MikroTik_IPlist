...
:if ([:len [/ip/route/find dst-address=103.164.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.164.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139623 }
...
:if ([:len [/ip/route/find dst-address=146.19.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=146.19.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139623 }
...
:if ([:len [/ip/route/find dst-address=192.54.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.54.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139623 }
...
:if ([:len [/ip/route/find dst-address=212.23.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.23.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139623 }
