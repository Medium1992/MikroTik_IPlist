...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139623 and dst-address=for_scripts_route/asnv4/AS139623.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139623.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139623 }
