...
:if ([:len [/ip/route/find dst-address=160.238.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.238.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139642 }
...
:if ([:len [/ip/route/find dst-address=185.255.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.255.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139642 }
...
:if ([:len [/ip/route/find dst-address=212.134.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.134.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139642 }
...
:if ([:len [/ip/route/find dst-address=82.108.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.108.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139642 }
...
:if ([:len [/ip/route/find dst-address=87.85.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.85.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139642 }
:if ([:len [/ip/route/find dst-address=87.86.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.86.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139642 }
