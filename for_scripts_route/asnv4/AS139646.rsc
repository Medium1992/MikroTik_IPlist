...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.143.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.143.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139646 }
...
:if ([:len [/ip/route/find dst-address=154.214.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.214.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139646 }
:if ([:len [/ip/route/find dst-address=154.214.63.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.214.63.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139646 }
...
:if ([:len [/ip/route/find dst-address=154.221.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.221.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139646 }
