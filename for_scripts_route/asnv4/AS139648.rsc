...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.143.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.143.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139648 }
...
:if ([:len [/ip/route/find dst-address=142.249.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139648 }
:if ([:len [/ip/route/find dst-address=142.249.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139648 }
...
:if ([:len [/ip/route/find dst-address=61.107.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.107.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139648 }
