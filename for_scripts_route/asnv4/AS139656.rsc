...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=125.236.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.236.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139656 }
...
:if ([:len [/ip/route/find dst-address=156.13.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.13.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139656 }
:if ([:len [/ip/route/find dst-address=202.27.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.27.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139656 }
