...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139719 and dst-address=for_scripts_route/asnv4/AS139719.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139719.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139719 }
