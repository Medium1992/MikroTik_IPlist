...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=72.87.63.224/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.87.63.224/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
:if ([:len [/ip/route/find dst-address=72.87.63.232/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.87.63.232/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
:if ([:len [/ip/route/find dst-address=72.87.63.236/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.87.63.236/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
:if ([:len [/ip/route/find dst-address=72.87.63.238/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.87.63.238/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
