...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=72.92.146.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.92.146.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
:if ([:len [/ip/route/find dst-address=72.92.146.96/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.92.146.96/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
:if ([:len [/ip/route/find dst-address=72.92.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.92.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
:if ([:len [/ip/route/find dst-address=72.92.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.92.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
:if ([:len [/ip/route/find dst-address=72.92.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.92.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13977 }
