...
:if ([:len [/ip/route/find dst-address=103.62.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.62.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
...
:if ([:len [/ip/route/find dst-address=144.79.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.79.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
...
:if ([:len [/ip/route/find dst-address=39.62.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=39.62.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
:if ([:len [/ip/route/find dst-address=39.62.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=39.62.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
...
:if ([:len [/ip/route/find dst-address=59.103.40.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.103.40.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
:if ([:len [/ip/route/find dst-address=59.103.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.103.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
:if ([:len [/ip/route/find dst-address=59.103.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.103.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
:if ([:len [/ip/route/find dst-address=59.103.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.103.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139820 }
