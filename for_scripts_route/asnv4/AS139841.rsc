...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139841 and dst-address=for_scripts_route/asnv4/AS139841.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139841.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139841 }
