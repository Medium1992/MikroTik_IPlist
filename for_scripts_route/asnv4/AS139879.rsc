...
:if ([:len [/ip/route/find dst-address=110.38.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=110.38.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139879 }
:if ([:len [/ip/route/find dst-address=110.38.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=110.38.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139879 }
...
:if ([:len [/ip/route/find dst-address=14.192.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139879 }
:if ([:len [/ip/route/find dst-address=157.10.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.10.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139879 }
