...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS139938 and dst-address=for_scripts_route/asnv4/AS139938.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS139938.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139938 }
