...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.3.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.3.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=103.3.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.3.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
...
:if ([:len [/ip/route/find dst-address=157.85.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=157.85.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=157.85.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=157.85.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=157.85.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=157.85.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
...
:if ([:len [/ip/route/find dst-address=157.85.218.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.218.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=157.85.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
