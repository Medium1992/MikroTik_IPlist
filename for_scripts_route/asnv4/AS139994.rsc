...
:if ([:len [/ip/route/find dst-address=157.85.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
:if ([:len [/ip/route/find dst-address=157.85.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
