...
:if ([:len [/ip/route/find dst-address=140.213.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.213.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
...
:if ([:len [/ip/route/find dst-address=157.85.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
...
:if ([:len [/ip/route/find dst-address=157.85.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS139994 }
