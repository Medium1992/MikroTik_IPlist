...
:if ([:len [/ip/route/find dst-address=201.165.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
