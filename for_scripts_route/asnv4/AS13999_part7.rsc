...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=201.165.150.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.150.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.159.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.159.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
