...
:if ([:len [/ip/route/find dst-address=201.165.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
...
:if ([:len [/ip/route/find dst-address=201.165.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
:if ([:len [/ip/route/find dst-address=201.165.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.165.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS13999 }
