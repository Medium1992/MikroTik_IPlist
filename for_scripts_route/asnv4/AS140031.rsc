...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140031 and dst-address=for_scripts_route/asnv4/AS140031.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140031.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140031 }
