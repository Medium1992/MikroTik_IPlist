...
:if ([:len [/ip/route/find dst-address=104.251.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.251.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140042 }
:if ([:len [/ip/route/find dst-address=104.251.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.251.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140042 }
:if ([:len [/ip/route/find dst-address=104.251.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.251.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140042 }
...
:if ([:len [/ip/route/find dst-address=172.81.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.81.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140042 }
...
:if ([:len [/ip/route/find dst-address=177.0.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.0.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140042 }
