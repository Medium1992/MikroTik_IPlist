...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140055 and dst-address=for_scripts_route/asnv4/AS140055.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140055.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140055 }
