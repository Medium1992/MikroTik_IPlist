...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140062 and dst-address=for_scripts_route/asnv4/AS140062.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140062.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140062 }
