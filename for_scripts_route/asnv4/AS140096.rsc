...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140096 and dst-address=for_scripts_route/asnv4/AS140096.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140096.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140096 }
