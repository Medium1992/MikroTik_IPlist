...
:if ([:len [/ip/route/find dst-address=136.0.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.0.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140133 }
:if ([:len [/ip/route/find dst-address=144.79.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.79.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140133 }
...
:if ([:len [/ip/route/find dst-address=79.175.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.175.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140133 }
:if ([:len [/ip/route/find dst-address=89.23.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.23.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140133 }
