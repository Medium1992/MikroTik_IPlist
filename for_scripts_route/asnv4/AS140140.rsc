...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140140 and dst-address=for_scripts_route/asnv4/AS140140.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140140.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140140 }
