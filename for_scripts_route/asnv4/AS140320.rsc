...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=113.82.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=113.82.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=113.82.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=113.82.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=113.82.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
...
:if ([:len [/ip/route/find dst-address=183.1.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.1.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=183.1.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.1.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
