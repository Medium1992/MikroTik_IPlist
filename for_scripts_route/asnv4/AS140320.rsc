...
:if ([:len [/ip/route/find dst-address=113.82.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=113.82.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=113.82.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
:if ([:len [/ip/route/find dst-address=113.82.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.82.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
...
:if ([:len [/ip/route/find dst-address=119.134.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.134.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
...
:if ([:len [/ip/route/find dst-address=183.1.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.1.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140320 }
