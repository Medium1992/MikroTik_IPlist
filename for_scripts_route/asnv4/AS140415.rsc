...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140415 and dst-address=for_scripts_route/asnv4/AS140415.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140415.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140415 }
