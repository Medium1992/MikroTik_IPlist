...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140433 and dst-address=for_scripts_route/asnv4/AS140433.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140433.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140433 }
