...
:if ([:len [/ip/route/find dst-address=206.237.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=206.237.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
...
:if ([:len [/ip/route/find dst-address=38.47.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=38.47.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
