...
:if ([:len [/ip/route/find dst-address=206.237.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=206.237.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=206.237.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=206.237.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=206.237.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=206.237.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.237.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
:if ([:len [/ip/route/find dst-address=38.47.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140443 }
