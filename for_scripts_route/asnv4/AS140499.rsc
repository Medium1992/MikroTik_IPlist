...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.115.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.115.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140499 }
...
:if ([:len [/ip/route/find dst-address=144.79.150.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.79.150.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140499 }
:if ([:len [/ip/route/find dst-address=163.128.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.128.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140499 }
