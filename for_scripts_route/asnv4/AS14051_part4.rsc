...
:if ([:len [/ip/route/find dst-address=70.9.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.64/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.64/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.80/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.80/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.84/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.84/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.87/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.87/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.88/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.88/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.124.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.124.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
:if ([:len [/ip/route/find dst-address=70.9.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.9.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14051 }
