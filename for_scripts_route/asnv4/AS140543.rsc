...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140543 and dst-address=for_scripts_route/asnv4/AS140543.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140543.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140543 }
