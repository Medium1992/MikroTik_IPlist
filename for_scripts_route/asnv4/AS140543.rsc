...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.110.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.110.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140543 }
...
:if ([:len [/ip/route/find dst-address=151.243.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.243.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140543 }
...
:if ([:len [/ip/route/find dst-address=193.25.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.25.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140543 }
