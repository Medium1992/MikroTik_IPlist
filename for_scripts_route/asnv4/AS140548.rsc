...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140548 and dst-address=for_scripts_route/asnv4/AS140548.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140548.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140548 }
