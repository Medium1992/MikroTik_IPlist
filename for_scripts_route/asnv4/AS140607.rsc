...
:if ([:len [/ip/route/find dst-address=38.125.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.125.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140607 }
:if ([:len [/ip/route/find dst-address=38.87.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.87.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140607 }
