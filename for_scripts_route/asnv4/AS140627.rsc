...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140627 and dst-address=for_scripts_route/asnv4/AS140627.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140627.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140627 }
