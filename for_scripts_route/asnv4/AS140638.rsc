...
:if ([:len [/ip/route/find dst-address=117.61.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.61.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140638 }
:if ([:len [/ip/route/find dst-address=117.61.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.61.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140638 }
...
:if ([:len [/ip/route/find dst-address=117.61.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.61.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140638 }
:if ([:len [/ip/route/find dst-address=117.61.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.61.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140638 }
