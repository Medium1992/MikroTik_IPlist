...
:if ([:len [/ip/route/find dst-address=161.248.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.248.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140822 }
:if ([:len [/ip/route/find dst-address=161.248.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.248.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140822 }
:if ([:len [/ip/route/find dst-address=161.248.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.248.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140822 }
:if ([:len [/ip/route/find dst-address=161.248.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.248.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140822 }
:if ([:len [/ip/route/find dst-address=161.248.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.248.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140822 }
