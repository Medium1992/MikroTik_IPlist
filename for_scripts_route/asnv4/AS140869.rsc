...
:if ([:len [/ip/route/find dst-address=117.120.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.120.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
:if ([:len [/ip/route/find dst-address=117.120.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.120.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
:if ([:len [/ip/route/find dst-address=117.120.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.120.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140869 }
