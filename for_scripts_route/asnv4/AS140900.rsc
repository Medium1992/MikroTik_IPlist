...
:if ([:len [/ip/route/find dst-address=151.123.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.123.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140900 }
:if ([:len [/ip/route/find dst-address=43.230.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.230.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140900 }
