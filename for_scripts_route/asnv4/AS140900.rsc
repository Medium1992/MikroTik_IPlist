...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS140900 and dst-address=for_scripts_route/asnv4/AS140900.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS140900.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS140900 }
