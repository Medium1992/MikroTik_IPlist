...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141004 and dst-address=for_scripts_route/asnv4/AS141004.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141004.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141004 }
