...
:if ([:len [/ip/route/find dst-address=156.230.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.230.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141109 }
:if ([:len [/ip/route/find dst-address=45.196.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.196.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141109 }
:if ([:len [/ip/route/find dst-address=45.198.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.198.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141109 }
