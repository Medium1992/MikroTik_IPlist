...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141196 and dst-address=for_scripts_route/asnv4/AS141196.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141196.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141196 }
