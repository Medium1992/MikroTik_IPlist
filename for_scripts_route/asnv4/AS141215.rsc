...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141215 and dst-address=for_scripts_route/asnv4/AS141215.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141215.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141215 }
