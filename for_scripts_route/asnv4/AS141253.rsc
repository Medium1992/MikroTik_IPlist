...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.119.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.119.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141253 }
...
:if ([:len [/ip/route/find dst-address=103.61.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.61.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141253 }
