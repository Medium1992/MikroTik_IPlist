...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141303 and dst-address=for_scripts_route/asnv4/AS141303.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141303.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141303 }
