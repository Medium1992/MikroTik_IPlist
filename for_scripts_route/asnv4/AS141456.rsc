...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141456 and dst-address=for_scripts_route/asnv4/AS141456.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141456.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141456 }
