...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14149 and dst-address=for_scripts_route/asnv4/AS14149.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14149.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14149 }
