...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141525 and dst-address=for_scripts_route/asnv4/AS141525.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141525.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141525 }
