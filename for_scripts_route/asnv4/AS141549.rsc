...
:if ([:len [/ip/route/find dst-address=144.16.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.16.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141549 }
:if ([:len [/ip/route/find dst-address=144.16.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.16.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141549 }
:if ([:len [/ip/route/find dst-address=144.16.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.16.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141549 }
