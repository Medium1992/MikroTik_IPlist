...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141671 and dst-address=for_scripts_route/asnv4/AS141671.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141671.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141671 }
