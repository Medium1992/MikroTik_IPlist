...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141681 and dst-address=for_scripts_route/asnv4/AS141681.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141681.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141681 }
