...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141709 and dst-address=for_scripts_route/asnv4/AS141709.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141709.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141709 }
