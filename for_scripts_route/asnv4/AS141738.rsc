...
:if ([:len [/ip/route/find dst-address=95.155.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.155.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141738 }
:if ([:len [/ip/route/find dst-address=95.155.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.155.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141738 }
