...
:if ([:len [/ip/route/find dst-address=103.87.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.87.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141778 }
...
:if ([:len [/ip/route/find dst-address=144.79.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.79.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141778 }
