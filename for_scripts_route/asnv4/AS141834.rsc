...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141834 and dst-address=for_scripts_route/asnv4/AS141834.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141834.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141834 }
