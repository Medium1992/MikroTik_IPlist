...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141856 and dst-address=for_scripts_route/asnv4/AS141856.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141856.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141856 }
