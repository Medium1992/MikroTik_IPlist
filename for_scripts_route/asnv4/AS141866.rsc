...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141866 and dst-address=for_scripts_route/asnv4/AS141866.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141866.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141866 }
