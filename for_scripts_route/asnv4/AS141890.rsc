...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141890 and dst-address=for_scripts_route/asnv4/AS141890.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141890.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141890 }
