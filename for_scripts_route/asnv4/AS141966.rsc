...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS141966 and dst-address=for_scripts_route/asnv4/AS141966.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS141966.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS141966 }
