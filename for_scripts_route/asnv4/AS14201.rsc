...
:if ([:len [/ip/route/find dst-address=170.65.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.65.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14201 }
:if ([:len [/ip/route/find dst-address=170.65.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.65.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14201 }
:if ([:len [/ip/route/find dst-address=170.65.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.65.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14201 }
...
:if ([:len [/ip/route/find dst-address=170.65.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.65.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14201 }
:if ([:len [/ip/route/find dst-address=170.65.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.65.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14201 }
...
:if ([:len [/ip/route/find dst-address=170.65.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.65.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14201 }
