...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS142038 and dst-address=for_scripts_route/asnv4/AS142038.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS142038.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142038 }
