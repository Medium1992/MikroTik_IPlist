...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14207 and dst-address=for_scripts_route/asnv4/AS14207.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14207.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14207 }
