...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=152.199.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.199.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14210 }
...
:if ([:len [/ip/route/find dst-address=152.199.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.199.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14210 }
