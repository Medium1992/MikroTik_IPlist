...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14232 and dst-address=for_scripts_route/asnv4/AS14232.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14232.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14232 }
