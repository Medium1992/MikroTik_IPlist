...
:if ([:len [/ip/route/find dst-address=103.170.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.170.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142393 }
...
:if ([:len [/ip/route/find dst-address=38.44.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.44.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142393 }
