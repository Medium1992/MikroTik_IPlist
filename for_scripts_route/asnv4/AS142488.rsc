...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS142488 and dst-address=for_scripts_route/asnv4/AS142488.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS142488.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142488 }
