...
:if ([:len [/ip/route/find dst-address=80.246.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.246.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142561 }
:if ([:len [/ip/route/find dst-address=81.18.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.18.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142561 }
:if ([:len [/ip/route/find dst-address=91.124.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.124.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142561 }
