...
:if ([:len [/ip/route/find dst-address=103.207.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.207.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142647 }
...
:if ([:len [/ip/route/find dst-address=151.158.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142647 }
:if ([:len [/ip/route/find dst-address=160.30.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.30.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142647 }
:if ([:len [/ip/route/find dst-address=165.101.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.101.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS142647 }
