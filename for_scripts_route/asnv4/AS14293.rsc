...
:if ([:len [/ip/route/find dst-address=46.18.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.18.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14293 }
...
:if ([:len [/ip/route/find dst-address=82.39.233.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.39.233.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14293 }
