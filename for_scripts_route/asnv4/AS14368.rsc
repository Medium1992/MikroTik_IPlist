...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14368 and dst-address=for_scripts_route/asnv4/AS14368.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14368.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14368 }
