...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14383 and dst-address=for_scripts_route/asnv4/AS14383.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14383.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14383 }
