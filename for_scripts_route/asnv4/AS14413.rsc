...
:if ([:len [/ip/route/find dst-address=108.174.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.174.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14413 }
:if ([:len [/ip/route/find dst-address=108.174.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.174.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14413 }
...
:if ([:len [/ip/route/find dst-address=144.2.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.2.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14413 }
...
:if ([:len [/ip/route/find dst-address=144.2.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.2.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14413 }
:if ([:len [/ip/route/find dst-address=216.200.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.200.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14413 }
