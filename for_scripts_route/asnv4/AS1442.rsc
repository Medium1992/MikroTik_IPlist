...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1442 and dst-address=for_scripts_route/asnv4/AS1442.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1442.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1442 }
