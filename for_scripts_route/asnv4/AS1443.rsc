...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1443 and dst-address=for_scripts_route/asnv4/AS1443.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1443.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1443 }
