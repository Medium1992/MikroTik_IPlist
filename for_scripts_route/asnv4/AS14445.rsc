...
:if ([:len [/ip/route/find dst-address=145.79.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.79.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
:if ([:len [/ip/route/find dst-address=151.243.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.243.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
...
:if ([:len [/ip/route/find dst-address=188.255.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.255.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
...
:if ([:len [/ip/route/find dst-address=23.230.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.230.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
...
:if ([:len [/ip/route/find dst-address=79.110.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.110.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
:if ([:len [/ip/route/find dst-address=82.152.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.152.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
:if ([:len [/ip/route/find dst-address=82.25.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.25.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
:if ([:len [/ip/route/find dst-address=82.25.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.25.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14445 }
