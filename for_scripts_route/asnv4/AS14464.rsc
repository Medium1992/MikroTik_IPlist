...
:if ([:len [/ip/route/find dst-address=131.109.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
:if ([:len [/ip/route/find dst-address=131.109.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
:if ([:len [/ip/route/find dst-address=131.109.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.109.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14464 }
