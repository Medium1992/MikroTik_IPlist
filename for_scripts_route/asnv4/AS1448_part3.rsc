...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=158.41.194.210/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.194.210/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
:if ([:len [/ip/route/find dst-address=158.41.194.212/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.194.212/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
:if ([:len [/ip/route/find dst-address=158.41.194.216/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.194.216/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
:if ([:len [/ip/route/find dst-address=158.41.194.224/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.194.224/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
:if ([:len [/ip/route/find dst-address=158.41.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
:if ([:len [/ip/route/find dst-address=158.41.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
:if ([:len [/ip/route/find dst-address=158.41.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
:if ([:len [/ip/route/find dst-address=158.41.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.41.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1448 }
