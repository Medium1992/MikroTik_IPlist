...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14523 and dst-address=for_scripts_route/asnv4/AS14523.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14523.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14523 }
