...
:if ([:len [/ip/route/find dst-address=67.216.120.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.216.120.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14559 }
:if ([:len [/ip/route/find dst-address=67.216.120.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.216.120.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14559 }
:if ([:len [/ip/route/find dst-address=67.216.120.240/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.216.120.240/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14559 }
:if ([:len [/ip/route/find dst-address=67.216.120.249/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.216.120.249/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14559 }
:if ([:len [/ip/route/find dst-address=67.216.120.250/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.216.120.250/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14559 }
:if ([:len [/ip/route/find dst-address=67.216.120.252/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.216.120.252/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14559 }
