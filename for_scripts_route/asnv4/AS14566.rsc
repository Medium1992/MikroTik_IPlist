...
:if ([:len [/ip/route/find dst-address=66.85.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.85.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14566 }
:if ([:len [/ip/route/find dst-address=67.222.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.222.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14566 }
:if ([:len [/ip/route/find dst-address=67.222.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.222.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14566 }
:if ([:len [/ip/route/find dst-address=67.222.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.222.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14566 }
:if ([:len [/ip/route/find dst-address=67.222.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.222.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14566 }
