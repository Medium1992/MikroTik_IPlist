...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14569 and dst-address=for_scripts_route/asnv4/AS14569.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14569.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14569 }
