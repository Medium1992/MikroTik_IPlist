...
:if ([:len [/ip/route/find dst-address=9.170.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.170.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14593 }
:if ([:len [/ip/route/find dst-address=9.170.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.170.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14593 }
:if ([:len [/ip/route/find dst-address=9.170.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.170.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14593 }
:if ([:len [/ip/route/find dst-address=9.170.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.170.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14593 }
...
:if ([:len [/ip/route/find dst-address=9.246.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.246.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14593 }
