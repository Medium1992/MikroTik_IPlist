...
:if ([:len [/ip/route/find dst-address=205.174.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.174.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14630 }
:if ([:len [/ip/route/find dst-address=205.174.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.174.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14630 }
:if ([:len [/ip/route/find dst-address=205.174.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.174.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14630 }
:if ([:len [/ip/route/find dst-address=205.174.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.174.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14630 }
