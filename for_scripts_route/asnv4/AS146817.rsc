...
:if ([:len [/ip/route/find dst-address=103.38.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.38.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146817 }
...
:if ([:len [/ip/route/find dst-address=103.7.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.7.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146817 }
...
:if ([:len [/ip/route/find dst-address=103.99.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.99.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146817 }
...
:if ([:len [/ip/route/find dst-address=210.16.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.16.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146817 }
