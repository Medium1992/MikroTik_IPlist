...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS146870 and dst-address=for_scripts_route/asnv4/AS146870.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS146870.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146870 }
