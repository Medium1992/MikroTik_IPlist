...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS146987 and dst-address=for_scripts_route/asnv4/AS146987.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS146987.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146987 }
