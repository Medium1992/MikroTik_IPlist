...
:if ([:len [/ip/route/find dst-address=143.14.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.14.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146996 }
:if ([:len [/ip/route/find dst-address=151.243.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.243.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146996 }
:if ([:len [/ip/route/find dst-address=151.246.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.246.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146996 }
...
:if ([:len [/ip/route/find dst-address=168.222.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.222.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146996 }
...
:if ([:len [/ip/route/find dst-address=168.222.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.222.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146996 }
:if ([:len [/ip/route/find dst-address=31.58.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.58.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146996 }
:if ([:len [/ip/route/find dst-address=31.58.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.58.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS146996 }
