...
:if ([:len [/ip/route/find dst-address=38.47.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147019 }
...
:if ([:len [/ip/route/find dst-address=38.47.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147019 }
...
:if ([:len [/ip/route/find dst-address=38.47.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147019 }
:if ([:len [/ip/route/find dst-address=38.47.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147019 }
:if ([:len [/ip/route/find dst-address=38.47.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147019 }
