...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS147027 and dst-address=for_scripts_route/asnv4/AS147027.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS147027.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147027 }
