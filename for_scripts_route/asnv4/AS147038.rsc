...
:if ([:len [/ip/route/find dst-address=118.181.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=118.181.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147038 }
:if ([:len [/ip/route/find dst-address=118.183.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=118.183.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147038 }
...
:if ([:len [/ip/route/find dst-address=118.183.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=118.183.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147038 }
...
:if ([:len [/ip/route/find dst-address=125.74.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.74.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147038 }
