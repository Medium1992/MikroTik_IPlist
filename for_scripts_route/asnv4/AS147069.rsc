...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS147069 and dst-address=for_scripts_route/asnv4/AS147069.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS147069.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147069 }
