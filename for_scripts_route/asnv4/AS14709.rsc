...
:if ([:len [/ip/route/find dst-address=200.108.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.108.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.108.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.108.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.108.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.108.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.108.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.46.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.46.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
