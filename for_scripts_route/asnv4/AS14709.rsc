...
:if ([:len [/ip/route/find dst-address=200.108.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
:if ([:len [/ip/route/find dst-address=200.108.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14709 }
