...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=142.202.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.202.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14713 }
:if ([:len [/ip/route/find dst-address=142.202.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.202.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14713 }
