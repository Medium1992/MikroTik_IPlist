...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS147131 and dst-address=for_scripts_route/asnv4/AS147131.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS147131.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147131 }
