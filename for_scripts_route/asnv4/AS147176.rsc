...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.129.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.129.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147176 }
...
:if ([:len [/ip/route/find dst-address=191.96.153.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.96.153.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147176 }
...
:if ([:len [/ip/route/find dst-address=45.201.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.201.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147176 }
