...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS147182 and dst-address=for_scripts_route/asnv4/AS147182.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS147182.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147182 }
