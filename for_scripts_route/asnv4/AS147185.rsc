...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.105.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.105.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147185 }
...
:if ([:len [/ip/route/find dst-address=103.156.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.156.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147185 }
...
:if ([:len [/ip/route/find dst-address=103.189.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.189.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147185 }
...
:if ([:len [/ip/route/find dst-address=144.79.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.79.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147185 }
