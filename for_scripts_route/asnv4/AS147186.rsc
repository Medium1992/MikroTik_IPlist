...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS147186 and dst-address=for_scripts_route/asnv4/AS147186.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS147186.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147186 }
