...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS147279 and dst-address=for_scripts_route/asnv4/AS147279.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS147279.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147279 }
