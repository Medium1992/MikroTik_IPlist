...
:if ([:len [/ip/route/find dst-address=178.214.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.214.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147293 }
...
:if ([:len [/ip/route/find dst-address=88.80.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.80.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147293 }
