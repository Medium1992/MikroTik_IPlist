...
:if ([:len [/ip/route/find dst-address=23.26.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.26.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147293 }
:if ([:len [/ip/route/find dst-address=38.207.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.207.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147293 }
