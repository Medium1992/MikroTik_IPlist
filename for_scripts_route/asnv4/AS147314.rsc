...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS147314 and dst-address=for_scripts_route/asnv4/AS147314.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS147314.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
