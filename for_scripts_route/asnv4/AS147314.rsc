...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.123.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.123.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
:if ([:len [/ip/route/find dst-address=103.123.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.123.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
...
:if ([:len [/ip/route/find dst-address=103.210.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.210.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
:if ([:len [/ip/route/find dst-address=103.228.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.228.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
...
:if ([:len [/ip/route/find dst-address=103.66.169.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.66.169.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
...
:if ([:len [/ip/route/find dst-address=160.20.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.20.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
:if ([:len [/ip/route/find dst-address=165.101.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.101.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS147314 }
