...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14733 and dst-address=for_scripts_route/asnv4/AS14733.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14733.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14733 }
