...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14746 and dst-address=for_scripts_route/asnv4/AS14746.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14746.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14746 }
