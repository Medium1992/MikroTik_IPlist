...
:if ([:len [/ip/route/find dst-address=76.9.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.225/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.225/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.226/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.226/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.228/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.228/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.232/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.232/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.86.240/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.86.240/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
:if ([:len [/ip/route/find dst-address=76.9.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14750 }
