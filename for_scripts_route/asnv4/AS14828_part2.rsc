...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=64.211.114.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.114.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.114.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.114.48/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.48/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.114.57/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.57/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.114.58/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.58/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.114.60/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.60/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.114.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.114.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
:if ([:len [/ip/route/find dst-address=64.211.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.211.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
...
:if ([:len [/ip/route/find dst-address=8.24.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.24.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14828 }
