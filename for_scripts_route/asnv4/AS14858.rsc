...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS14858 and dst-address=for_scripts_route/asnv4/AS14858.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS14858.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14858 }
