...
:if ([:len [/ip/route/find dst-address=216.8.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.8.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14858 }
:if ([:len [/ip/route/find dst-address=216.8.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.8.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14858 }
:if ([:len [/ip/route/find dst-address=216.8.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.8.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14858 }
