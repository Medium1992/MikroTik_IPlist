...
:if ([:len [/ip/route/find dst-address=138.99.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.99.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
...
:if ([:len [/ip/route/find dst-address=170.80.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.80.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
...
:if ([:len [/ip/route/find dst-address=177.38.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.38.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
:if ([:len [/ip/route/find dst-address=177.66.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.66.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
:if ([:len [/ip/route/find dst-address=177.86.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.86.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
...
:if ([:len [/ip/route/find dst-address=200.195.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.195.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
:if ([:len [/ip/route/find dst-address=45.160.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.160.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
:if ([:len [/ip/route/find dst-address=45.4.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.4.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14868 }
