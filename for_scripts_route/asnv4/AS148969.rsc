...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS148969 and dst-address=for_scripts_route/asnv4/AS148969.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS148969.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS148969 }
