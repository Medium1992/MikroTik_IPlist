...
:if ([:len [/ip/route/find dst-address=103.175.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.175.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149187 }
...
:if ([:len [/ip/route/find dst-address=115.42.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.42.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149187 }
