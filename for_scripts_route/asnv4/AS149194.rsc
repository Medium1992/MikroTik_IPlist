...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS149194 and dst-address=for_scripts_route/asnv4/AS149194.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS149194.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149194 }
