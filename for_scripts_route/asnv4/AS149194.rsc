...
:if ([:len [/ip/route/find dst-address=103.2.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.2.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149194 }
...
:if ([:len [/ip/route/find dst-address=119.10.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.10.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149194 }
