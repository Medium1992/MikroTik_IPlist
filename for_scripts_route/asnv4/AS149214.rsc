...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS149214 and dst-address=for_scripts_route/asnv4/AS149214.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS149214.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149214 }
