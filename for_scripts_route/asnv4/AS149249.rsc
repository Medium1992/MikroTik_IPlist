...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS149249 and dst-address=for_scripts_route/asnv4/AS149249.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS149249.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149249 }
