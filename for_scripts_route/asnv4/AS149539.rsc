...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS149539 and dst-address=for_scripts_route/asnv4/AS149539.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS149539.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149539 }
