...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS149549 and dst-address=for_scripts_route/asnv4/AS149549.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS149549.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149549 }
