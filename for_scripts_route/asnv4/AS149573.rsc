...
:if ([:len [/ip/route/find dst-address=103.183.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.183.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
...
:if ([:len [/ip/route/find dst-address=141.11.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.11.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
:if ([:len [/ip/route/find dst-address=141.11.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.11.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
:if ([:len [/ip/route/find dst-address=143.109.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.109.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
:if ([:len [/ip/route/find dst-address=144.225.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
...
:if ([:len [/ip/route/find dst-address=178.83.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
...
:if ([:len [/ip/route/find dst-address=188.255.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.255.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
...
:if ([:len [/ip/route/find dst-address=193.151.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.151.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
