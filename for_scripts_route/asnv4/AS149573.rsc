...
:if ([:len [/ip/route/find dst-address=145.79.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.79.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
...
:if ([:len [/ip/route/find dst-address=82.153.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.153.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149573 }
