...
:if ([:len [/ip/route/find dst-address=103.159.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.159.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149765 }
...
:if ([:len [/ip/route/find dst-address=157.15.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.15.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149765 }
