...
:if ([:len [/ip/route/find dst-address=198.69.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.69.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14979 }
:if ([:len [/ip/route/find dst-address=199.1.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.1.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14979 }
...
:if ([:len [/ip/route/find dst-address=208.35.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.35.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS14979 }
