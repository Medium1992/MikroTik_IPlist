...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.191.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.191.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149946 }
...
:if ([:len [/ip/route/find dst-address=117.102.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.102.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS149946 }
