...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.120.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.120.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150027 }
...
:if ([:len [/ip/route/find dst-address=157.119.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.119.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150027 }
...
:if ([:len [/ip/route/find dst-address=160.30.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.30.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150027 }
