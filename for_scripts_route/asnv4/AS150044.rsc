...
:if ([:len [/ip/route/find dst-address=154.21.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.21.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150044 }
:if ([:len [/ip/route/find dst-address=163.227.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.227.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150044 }
