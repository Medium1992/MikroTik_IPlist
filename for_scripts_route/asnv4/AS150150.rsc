...
:if ([:len [/ip/route/find dst-address=206.238.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.238.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150150 }
...
:if ([:len [/ip/route/find dst-address=38.123.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.123.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150150 }
