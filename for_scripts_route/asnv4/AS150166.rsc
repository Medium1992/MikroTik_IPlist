...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS150166 and dst-address=for_scripts_route/asnv4/AS150166.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS150166.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150166 }
