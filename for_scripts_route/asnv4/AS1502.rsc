...
:if ([:len [/ip/route/find dst-address=147.104.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.104.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1502 }
...
:if ([:len [/ip/route/find dst-address=155.30.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.30.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1502 }
:if ([:len [/ip/route/find dst-address=155.30.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.30.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1502 }
:if ([:len [/ip/route/find dst-address=158.11.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.11.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1502 }
...
:if ([:len [/ip/route/find dst-address=158.19.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.19.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1502 }
