...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS150279 and dst-address=for_scripts_route/asnv4/AS150279.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS150279.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150279 }
