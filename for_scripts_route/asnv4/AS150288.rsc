...
:if ([:len [/ip/route/find dst-address=103.135.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.135.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150288 }
...
:if ([:len [/ip/route/find dst-address=211.79.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.79.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150288 }
