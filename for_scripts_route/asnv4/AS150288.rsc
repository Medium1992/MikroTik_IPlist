...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.104.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.104.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150288 }
...
:if ([:len [/ip/route/find dst-address=211.79.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.79.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150288 }
