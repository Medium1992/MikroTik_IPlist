...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS150329 and dst-address=for_scripts_route/asnv4/AS150329.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS150329.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150329 }
