...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS15036 and dst-address=for_scripts_route/asnv4/AS15036.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS15036.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15036 }
