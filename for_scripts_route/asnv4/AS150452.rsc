...
:if ([:len [/ip/route/find dst-address=101.192.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.192.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150452 }
:if ([:len [/ip/route/find dst-address=101.192.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.192.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150452 }
