...
:if ([:len [/ip/route/find dst-address=63.246.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=63.246.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15054 }
:if ([:len [/ip/route/find dst-address=63.246.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=63.246.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15054 }
:if ([:len [/ip/route/find dst-address=63.246.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=63.246.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15054 }
