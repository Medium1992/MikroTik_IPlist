...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.136.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.136.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150654 }
...
:if ([:len [/ip/route/find dst-address=109.248.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.248.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150654 }
