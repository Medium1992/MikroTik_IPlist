...
:if ([:len [/ip/route/find dst-address=151.158.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150683 }
:if ([:len [/ip/route/find dst-address=165.101.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.101.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150683 }
:if ([:len [/ip/route/find dst-address=203.215.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.215.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150683 }
...
:if ([:len [/ip/route/find dst-address=203.215.169.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.215.169.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150683 }
:if ([:len [/ip/route/find dst-address=203.215.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.215.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150683 }
