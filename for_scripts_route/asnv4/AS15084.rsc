...
:if ([:len [/ip/route/find dst-address=167.1.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.1.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15084 }
:if ([:len [/ip/route/find dst-address=167.1.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.1.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15084 }
...
:if ([:len [/ip/route/find dst-address=167.1.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.1.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15084 }
:if ([:len [/ip/route/find dst-address=167.1.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.1.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15084 }
