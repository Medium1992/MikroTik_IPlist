...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS150855 and dst-address=for_scripts_route/asnv4/AS150855.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS150855.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS150855 }
