...
:if ([:len [/ip/route/find dst-address=103.155.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.155.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151000 }
...
:if ([:len [/ip/route/find dst-address=103.190.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.190.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151000 }
