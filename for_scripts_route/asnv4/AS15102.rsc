...
:if ([:len [/ip/route/find dst-address=208.82.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15102 }
:if ([:len [/ip/route/find dst-address=208.82.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15102 }
...
:if ([:len [/ip/route/find dst-address=72.13.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15102 }
