...
:if ([:len [/ip/route/find dst-address=64.56.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.56.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15102 }
:if ([:len [/ip/route/find dst-address=67.215.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.215.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15102 }
