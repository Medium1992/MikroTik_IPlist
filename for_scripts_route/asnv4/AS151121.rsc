...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS151121 and dst-address=for_scripts_route/asnv4/AS151121.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS151121.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151121 }
