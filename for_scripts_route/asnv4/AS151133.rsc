...
:if ([:len [/ip/route/find dst-address=160.191.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.191.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151133 }
...
:if ([:len [/ip/route/find dst-address=163.227.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.227.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151133 }
