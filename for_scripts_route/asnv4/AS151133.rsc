...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS151133 and dst-address=for_scripts_route/asnv4/AS151133.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS151133.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151133 }
