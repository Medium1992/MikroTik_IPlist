...
:if ([:len [/ip/route/find dst-address=103.45.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.45.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151185 }
...
:if ([:len [/ip/route/find dst-address=43.226.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.226.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151185 }
:if ([:len [/ip/route/find dst-address=43.226.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.226.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151185 }
:if ([:len [/ip/route/find dst-address=43.227.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.227.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151185 }
