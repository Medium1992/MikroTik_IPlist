...
:if ([:len [/ip/route/find dst-address=192.235.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.235.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15128 }
...
:if ([:len [/ip/route/find dst-address=209.163.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.163.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15128 }
:if ([:len [/ip/route/find dst-address=209.163.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.163.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15128 }
:if ([:len [/ip/route/find dst-address=209.163.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.163.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15128 }
:if ([:len [/ip/route/find dst-address=209.163.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.163.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15128 }
:if ([:len [/ip/route/find dst-address=209.163.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.163.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15128 }
...
:if ([:len [/ip/route/find dst-address=99.223.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.223.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15128 }
