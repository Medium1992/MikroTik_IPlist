...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS151336 and dst-address=for_scripts_route/asnv4/AS151336.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS151336.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151336 }
