...
:if ([:len [/ip/route/find dst-address=128.14.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.14.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151373 }
...
:if ([:len [/ip/route/find dst-address=69.17.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.17.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151373 }
:if ([:len [/ip/route/find dst-address=82.108.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.108.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151373 }
