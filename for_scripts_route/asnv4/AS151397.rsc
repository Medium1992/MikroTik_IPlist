...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=193.119.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.119.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151397 }
...
:if ([:len [/ip/route/find dst-address=193.119.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.119.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151397 }
:if ([:len [/ip/route/find dst-address=193.119.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.119.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151397 }
