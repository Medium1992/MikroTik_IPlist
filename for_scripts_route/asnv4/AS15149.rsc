...
:if ([:len [/ip/route/find dst-address=216.150.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.150.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15149 }
:if ([:len [/ip/route/find dst-address=216.150.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.150.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15149 }
:if ([:len [/ip/route/find dst-address=216.150.91.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.150.91.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15149 }
:if ([:len [/ip/route/find dst-address=216.150.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.150.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15149 }
