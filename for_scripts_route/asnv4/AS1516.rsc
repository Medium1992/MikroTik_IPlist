...
:if ([:len [/ip/route/find dst-address=143.74.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.74.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
...
:if ([:len [/ip/route/find dst-address=143.74.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.74.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
