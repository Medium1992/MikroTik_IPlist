...
:if ([:len [/ip/route/find dst-address=155.28.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.28.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
:if ([:len [/ip/route/find dst-address=160.140.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.140.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
