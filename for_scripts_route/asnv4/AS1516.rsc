...
:if ([:len [/ip/route/find dst-address=143.74.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.74.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
:if ([:len [/ip/route/find dst-address=143.74.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.74.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1516 }
