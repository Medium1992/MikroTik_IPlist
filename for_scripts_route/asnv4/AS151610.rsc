...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS151610 and dst-address=for_scripts_route/asnv4/AS151610.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS151610.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151610 }
