...
:if ([:len [/ip/route/find dst-address=206.0.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151612 }
...
:if ([:len [/ip/route/find dst-address=5.175.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151612 }
