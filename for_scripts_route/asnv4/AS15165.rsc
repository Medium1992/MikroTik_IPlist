...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS15165 and dst-address=for_scripts_route/asnv4/AS15165.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS15165.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15165 }
