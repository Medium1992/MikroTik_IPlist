...
:if ([:len [/ip/route/find dst-address=157.85.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151660 }
:if ([:len [/ip/route/find dst-address=157.85.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.85.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151660 }
