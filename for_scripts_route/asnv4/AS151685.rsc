...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS151685 and dst-address=for_scripts_route/asnv4/AS151685.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS151685.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151685 }
