...
:if ([:len [/ip/route/find dst-address=103.202.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.202.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151690 }
...
:if ([:len [/ip/route/find dst-address=165.99.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.99.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151690 }
