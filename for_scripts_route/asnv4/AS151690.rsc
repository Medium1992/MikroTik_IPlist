...
:if ([:len [/ip/route/find dst-address=151.158.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151690 }
:if ([:len [/ip/route/find dst-address=154.22.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.22.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151690 }
...
:if ([:len [/ip/route/find dst-address=163.128.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.128.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151690 }
...
:if ([:len [/ip/route/find dst-address=38.128.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151690 }
:if ([:len [/ip/route/find dst-address=38.128.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151690 }
