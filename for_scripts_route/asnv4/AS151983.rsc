...
:if ([:len [/ip/route/find dst-address=14.192.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151983 }
:if ([:len [/ip/route/find dst-address=14.192.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS151983 }
