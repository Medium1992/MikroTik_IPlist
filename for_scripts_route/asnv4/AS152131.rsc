...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152131 and dst-address=for_scripts_route/asnv4/AS152131.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152131.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152131 }
