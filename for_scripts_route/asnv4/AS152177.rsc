...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152177 and dst-address=for_scripts_route/asnv4/AS152177.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152177.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152177 }
