...
:if ([:len [/ip/route/find dst-address=210.105.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152214 }
:if ([:len [/ip/route/find dst-address=210.105.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152214 }
:if ([:len [/ip/route/find dst-address=210.105.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152214 }
:if ([:len [/ip/route/find dst-address=210.105.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152214 }
:if ([:len [/ip/route/find dst-address=210.105.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152214 }
