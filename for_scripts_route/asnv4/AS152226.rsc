...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152226 and dst-address=for_scripts_route/asnv4/AS152226.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152226.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152226 }
