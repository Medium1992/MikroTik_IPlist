...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152232 and dst-address=for_scripts_route/asnv4/AS152232.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152232.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152232 }
