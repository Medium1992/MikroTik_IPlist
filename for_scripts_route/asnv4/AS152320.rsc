...
:if ([:len [/ip/route/find dst-address=163.128.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.128.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152320 }
...
:if ([:len [/ip/route/find dst-address=45.254.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.254.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152320 }
:if ([:len [/ip/route/find dst-address=45.254.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.254.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152320 }
