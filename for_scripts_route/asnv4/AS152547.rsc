...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152547 and dst-address=for_scripts_route/asnv4/AS152547.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152547.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152547 }
