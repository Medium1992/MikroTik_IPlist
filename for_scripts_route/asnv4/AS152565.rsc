...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.151.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.151.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
:if ([:len [/ip/route/find dst-address=103.165.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.165.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
...
:if ([:len [/ip/route/find dst-address=201.7.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.7.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
:if ([:len [/ip/route/find dst-address=31.42.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.42.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
:if ([:len [/ip/route/find dst-address=46.232.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.232.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
