...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.243.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.243.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
...
:if ([:len [/ip/route/find dst-address=37.202.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
:if ([:len [/ip/route/find dst-address=38.224.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.224.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
