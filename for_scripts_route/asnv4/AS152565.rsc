...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.165.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.165.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
:if ([:len [/ip/route/find dst-address=138.252.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.252.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152565 }
