...
:if ([:len [/ip/route/find dst-address=167.148.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152586 }
...
:if ([:len [/ip/route/find dst-address=201.78.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.78.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152586 }
