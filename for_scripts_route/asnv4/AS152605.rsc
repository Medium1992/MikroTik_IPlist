...
:if ([:len [/ip/route/find dst-address=116.90.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.90.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152605 }
...
:if ([:len [/ip/route/find dst-address=163.61.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.61.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152605 }
