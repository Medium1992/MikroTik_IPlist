...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.115.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.115.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152605 }
:if ([:len [/ip/route/find dst-address=103.115.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.115.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152605 }
...
:if ([:len [/ip/route/find dst-address=38.100.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.100.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152605 }
:if ([:len [/ip/route/find dst-address=38.68.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.68.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152605 }
