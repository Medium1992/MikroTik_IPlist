...
:if ([:len [/ip/route/find dst-address=163.227.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.227.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152698 }
:if ([:len [/ip/route/find dst-address=163.61.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.61.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152698 }
