...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152705 and dst-address=for_scripts_route/asnv4/AS152705.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152705.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152705 }
