...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152900 and dst-address=for_scripts_route/asnv4/AS152900.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152900.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152900 }
