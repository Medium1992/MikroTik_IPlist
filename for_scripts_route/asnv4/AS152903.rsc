...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152903 and dst-address=for_scripts_route/asnv4/AS152903.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152903.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152903 }
