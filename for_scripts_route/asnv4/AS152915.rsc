...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS152915 and dst-address=for_scripts_route/asnv4/AS152915.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS152915.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152915 }
