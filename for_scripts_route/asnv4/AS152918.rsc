...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.118.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.118.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152918 }
...
:if ([:len [/ip/route/find dst-address=150.241.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.241.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152918 }
...
:if ([:len [/ip/route/find dst-address=45.121.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.121.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS152918 }
