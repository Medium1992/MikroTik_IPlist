...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS153038 and dst-address=for_scripts_route/asnv4/AS153038.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS153038.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153038 }
