...
:if ([:len [/ip/route/find dst-address=163.123.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.123.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153169 }
...
:if ([:len [/ip/route/find dst-address=83.147.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.147.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153169 }
