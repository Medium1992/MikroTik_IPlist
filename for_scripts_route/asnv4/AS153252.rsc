...
:if ([:len [/ip/route/find dst-address=103.161.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.161.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153252 }
:if ([:len [/ip/route/find dst-address=103.161.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.161.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153252 }
:if ([:len [/ip/route/find dst-address=103.175.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.175.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153252 }
...
:if ([:len [/ip/route/find dst-address=103.93.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.93.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153252 }
