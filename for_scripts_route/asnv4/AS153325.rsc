...
:if ([:len [/ip/route/find dst-address=223.26.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.26.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153325 }
:if ([:len [/ip/route/find dst-address=64.255.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.255.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153325 }
:if ([:len [/ip/route/find dst-address=64.255.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.255.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153325 }
:if ([:len [/ip/route/find dst-address=85.155.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.155.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153325 }
:if ([:len [/ip/route/find dst-address=85.155.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.155.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153325 }
