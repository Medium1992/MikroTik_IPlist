...
:if ([:len [/ip/route/find dst-address=103.72.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.72.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
...
:if ([:len [/ip/route/find dst-address=218.33.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.33.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
:if ([:len [/ip/route/find dst-address=218.33.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.33.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
