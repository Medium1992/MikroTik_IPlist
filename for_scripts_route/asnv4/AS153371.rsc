...
:if ([:len [/ip/route/find dst-address=142.249.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
:if ([:len [/ip/route/find dst-address=143.246.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.246.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
...
:if ([:len [/ip/route/find dst-address=163.8.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.8.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
:if ([:len [/ip/route/find dst-address=163.8.207.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.8.207.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
...
:if ([:len [/ip/route/find dst-address=207.174.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.174.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
:if ([:len [/ip/route/find dst-address=207.174.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.174.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153371 }
