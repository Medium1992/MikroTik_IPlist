...
:if ([:len [/ip/route/find dst-address=166.1.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.1.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153393 }
...
:if ([:len [/ip/route/find dst-address=203.32.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.32.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153393 }
