...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS153397 and dst-address=for_scripts_route/asnv4/AS153397.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS153397.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153397 }
