...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS15347 and dst-address=for_scripts_route/asnv4/AS15347.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS15347.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15347 }
