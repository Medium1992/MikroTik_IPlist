...
:if ([:len [/ip/route/find dst-address=64.99.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.99.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15348 }
...
:if ([:len [/ip/route/find dst-address=64.99.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.99.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15348 }
:if ([:len [/ip/route/find dst-address=64.99.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.99.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15348 }
:if ([:len [/ip/route/find dst-address=64.99.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.99.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15348 }
