...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=112.142.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=112.142.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153526 }
...
:if ([:len [/ip/route/find dst-address=112.142.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=112.142.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153526 }
...
:if ([:len [/ip/route/find dst-address=112.143.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=112.143.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153526 }
:if ([:len [/ip/route/find dst-address=112.143.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=112.143.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153526 }
