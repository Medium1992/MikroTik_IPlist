...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=112.142.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=112.142.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153526 }
...
:if ([:len [/ip/route/find dst-address=209.209.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153526 }
:if ([:len [/ip/route/find dst-address=209.209.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153526 }
