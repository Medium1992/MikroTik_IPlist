...
:if ([:len [/ip/route/find dst-address=163.8.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.8.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153656 }
:if ([:len [/ip/route/find dst-address=166.88.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.88.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153656 }
:if ([:len [/ip/route/find dst-address=168.222.65.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.222.65.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153656 }
...
:if ([:len [/ip/route/find dst-address=87.84.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.84.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153656 }
