...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS153771 and dst-address=for_scripts_route/asnv4/AS153771.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS153771.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153771 }
