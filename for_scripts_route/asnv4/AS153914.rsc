...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS153914 and dst-address=for_scripts_route/asnv4/AS153914.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS153914.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153914 }
