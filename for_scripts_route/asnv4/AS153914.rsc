...
:if ([:len [/ip/route/find dst-address=5.253.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.253.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153914 }
:if ([:len [/ip/route/find dst-address=5.253.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.253.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153914 }
:if ([:len [/ip/route/find dst-address=91.132.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.132.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS153914 }
