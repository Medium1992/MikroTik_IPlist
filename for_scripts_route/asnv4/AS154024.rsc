...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.124.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.124.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154024 }
...
:if ([:len [/ip/route/find dst-address=160.191.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.191.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154024 }
