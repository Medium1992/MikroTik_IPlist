...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS154026 and dst-address=for_scripts_route/asnv4/AS154026.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS154026.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154026 }
