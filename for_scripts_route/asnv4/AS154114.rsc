...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS154114 and dst-address=for_scripts_route/asnv4/AS154114.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS154114.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154114 }
