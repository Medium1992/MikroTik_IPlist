...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.66.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.66.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154132 }
...
:if ([:len [/ip/route/find dst-address=23.94.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.94.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154132 }
...
:if ([:len [/ip/route/find dst-address=69.12.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.12.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154132 }
