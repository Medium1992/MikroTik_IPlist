...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS154177 and dst-address=for_scripts_route/asnv4/AS154177.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS154177.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154177 }
