...
:if ([:len [/ip/route/find dst-address=130.94.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.94.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154177 }
...
:if ([:len [/ip/route/find dst-address=130.94.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.94.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154177 }
...
:if ([:len [/ip/route/find dst-address=130.94.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.94.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154177 }
:if ([:len [/ip/route/find dst-address=130.94.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.94.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154177 }
...
:if ([:len [/ip/route/find dst-address=130.94.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.94.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154177 }
:if ([:len [/ip/route/find dst-address=130.94.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.94.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154177 }
