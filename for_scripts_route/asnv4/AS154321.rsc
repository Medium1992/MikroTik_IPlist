...
:if ([:len [/ip/route/find dst-address=156.239.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.239.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154321 }
:if ([:len [/ip/route/find dst-address=156.239.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.239.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154321 }
:if ([:len [/ip/route/find dst-address=156.239.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.239.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154321 }
:if ([:len [/ip/route/find dst-address=156.239.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.239.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154321 }
...
:if ([:len [/ip/route/find dst-address=191.40.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.40.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154321 }
