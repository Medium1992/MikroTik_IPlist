...
:if ([:len [/ip/route/find dst-address=103.160.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.160.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154410 }
...
:if ([:len [/ip/route/find dst-address=103.211.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.211.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154410 }
...
:if ([:len [/ip/route/find dst-address=144.225.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154410 }
...
:if ([:len [/ip/route/find dst-address=160.25.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.25.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS154410 }
