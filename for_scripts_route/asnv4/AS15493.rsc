...
:if ([:len [/ip/route/find dst-address=5.1.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.1.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15493 }
...
:if ([:len [/ip/route/find dst-address=80.91.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.91.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15493 }
