...
:if ([:len [/ip/route/find dst-address=185.222.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.222.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15525 }
...
:if ([:len [/ip/route/find dst-address=93.127.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.127.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15525 }
