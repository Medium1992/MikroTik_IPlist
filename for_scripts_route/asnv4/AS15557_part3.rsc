...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=92.94.123.54/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.94.123.54/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
:if ([:len [/ip/route/find dst-address=92.94.123.56/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.94.123.56/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
:if ([:len [/ip/route/find dst-address=92.94.123.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.94.123.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
:if ([:len [/ip/route/find dst-address=92.94.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.94.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
:if ([:len [/ip/route/find dst-address=92.94.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.94.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
:if ([:len [/ip/route/find dst-address=92.94.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.94.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
:if ([:len [/ip/route/find dst-address=92.94.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.94.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
:if ([:len [/ip/route/find dst-address=92.95.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.95.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15557 }
