...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS15605 and dst-address=for_scripts_route/asnv4/AS15605.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS15605.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15605 }
