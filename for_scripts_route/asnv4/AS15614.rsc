...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS15614 and dst-address=for_scripts_route/asnv4/AS15614.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS15614.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15614 }
