...
:if ([:len [/ip/route/find dst-address=213.193.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.193.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15703 }
...
:if ([:len [/ip/route/find dst-address=213.239.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.239.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15703 }
...
:if ([:len [/ip/route/find dst-address=80.247.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.247.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15703 }
