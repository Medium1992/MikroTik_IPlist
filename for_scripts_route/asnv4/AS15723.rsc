...
:if ([:len [/ip/route/find dst-address=46.23.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.23.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15723 }
:if ([:len [/ip/route/find dst-address=5.178.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.178.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15723 }
...
:if ([:len [/ip/route/find dst-address=62.217.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15723 }
:if ([:len [/ip/route/find dst-address=62.217.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15723 }
:if ([:len [/ip/route/find dst-address=62.217.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15723 }
...
:if ([:len [/ip/route/find dst-address=88.151.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.151.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15723 }
