...
:if ([:len [/ip/route/find dst-address=153.52.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.52.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15731 }
...
:if ([:len [/ip/route/find dst-address=80.86.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.86.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15731 }
