...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.203.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.203.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15755 }
:if ([:len [/ip/route/find dst-address=185.203.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.203.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15755 }
...
:if ([:len [/ip/route/find dst-address=94.103.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.103.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15755 }
