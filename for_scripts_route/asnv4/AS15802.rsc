...
:if ([:len [/ip/route/find dst-address=91.72.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.72.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.74.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.74.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
:if ([:len [/ip/route/find dst-address=91.75.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.75.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15802 }
