...
:if ([:len [/ip/route/find dst-address=165.211.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.211.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15964 }
:if ([:len [/ip/route/find dst-address=165.211.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.211.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS15964 }
