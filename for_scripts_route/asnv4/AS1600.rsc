...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1600 and dst-address=for_scripts_route/asnv4/AS1600.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1600.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1600 }
