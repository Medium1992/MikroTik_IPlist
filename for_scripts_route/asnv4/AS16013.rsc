...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16013 and dst-address=for_scripts_route/asnv4/AS16013.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16013.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16013 }
