...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16065 and dst-address=for_scripts_route/asnv4/AS16065.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16065.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16065 }
