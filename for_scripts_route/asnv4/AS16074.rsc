...
:if ([:len [/ip/route/find dst-address=62.145.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.145.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
