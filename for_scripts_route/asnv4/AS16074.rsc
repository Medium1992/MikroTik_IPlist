...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=145.77.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.77.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
...
:if ([:len [/ip/route/find dst-address=145.77.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.77.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
...
:if ([:len [/ip/route/find dst-address=194.14.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.14.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
...
:if ([:len [/ip/route/find dst-address=62.145.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.145.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
:if ([:len [/ip/route/find dst-address=62.145.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.145.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
:if ([:len [/ip/route/find dst-address=62.145.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.145.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
:if ([:len [/ip/route/find dst-address=62.145.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.145.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16074 }
