...
:if ([:len [/ip/route/find dst-address=153.96.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.96.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16097 }
...
:if ([:len [/ip/route/find dst-address=192.44.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.44.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16097 }
...
:if ([:len [/ip/route/find dst-address=86.56.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.56.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16097 }
