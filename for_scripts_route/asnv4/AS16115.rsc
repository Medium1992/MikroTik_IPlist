...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16115 and dst-address=for_scripts_route/asnv4/AS16115.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16115.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16115 }
