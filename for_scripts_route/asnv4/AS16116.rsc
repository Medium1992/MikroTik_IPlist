...
:if ([:len [/ip/route/find dst-address=150.251.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.251.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16116 }
:if ([:len [/ip/route/find dst-address=150.251.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.251.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16116 }
...
:if ([:len [/ip/route/find dst-address=185.80.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.80.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16116 }
...
:if ([:len [/ip/route/find dst-address=84.111.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.111.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16116 }
