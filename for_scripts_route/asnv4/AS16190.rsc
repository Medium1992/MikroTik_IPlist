...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16190 and dst-address=for_scripts_route/asnv4/AS16190.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16190.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16190 }
