...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.87.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.87.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16236 }
...
:if ([:len [/ip/route/find dst-address=151.91.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.91.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16236 }
:if ([:len [/ip/route/find dst-address=151.91.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.91.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16236 }
...
:if ([:len [/ip/route/find dst-address=193.43.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.43.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16236 }
