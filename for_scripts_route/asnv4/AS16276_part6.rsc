...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16276 and dst-address=for_scripts_route/asnv4/AS16276_part6.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16276_part6.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16276 }
