...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16290 and dst-address=for_scripts_route/asnv4/AS16290.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16290.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16290 }
