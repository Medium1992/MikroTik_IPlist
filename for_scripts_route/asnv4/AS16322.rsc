...
:if ([:len [/ip/route/find dst-address=82.99.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.99.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
:if ([:len [/ip/route/find dst-address=82.99.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.99.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
:if ([:len [/ip/route/find dst-address=82.99.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.99.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
:if ([:len [/ip/route/find dst-address=82.99.207.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.99.207.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
:if ([:len [/ip/route/find dst-address=82.99.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.99.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
