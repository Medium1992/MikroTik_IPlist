...
:if ([:len [/ip/route/find dst-address=109.230.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.230.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
:if ([:len [/ip/route/find dst-address=185.10.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.10.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
:if ([:len [/ip/route/find dst-address=217.114.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.114.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16322 }
