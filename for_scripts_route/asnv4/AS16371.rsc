...
:if ([:len [/ip/route/find dst-address=185.10.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.10.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16371 }
:if ([:len [/ip/route/find dst-address=185.106.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.106.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16371 }
...
:if ([:len [/ip/route/find dst-address=185.83.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.83.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16371 }
