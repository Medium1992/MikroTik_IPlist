...
:if ([:len [/ip/route/find dst-address=205.157.193.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.157.193.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16410 }
...
:if ([:len [/ip/route/find dst-address=206.180.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.180.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16410 }
