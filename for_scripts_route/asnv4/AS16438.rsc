...
:if ([:len [/ip/route/find dst-address=204.80.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.80.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16438 }
:if ([:len [/ip/route/find dst-address=204.80.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.80.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16438 }
