...
:if ([:len [/ip/route/find dst-address=99.86.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.86.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16509 }
...
:if ([:len [/ip/route/find dst-address=99.86.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.86.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16509 }
:if ([:len [/ip/route/find dst-address=99.86.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.86.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16509 }
:if ([:len [/ip/route/find dst-address=99.86.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.86.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16509 }
