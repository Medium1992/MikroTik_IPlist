...
:if ([:len [/ip/route/find dst-address=96.8.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
...
:if ([:len [/ip/route/find dst-address=96.8.139.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.139.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
:if ([:len [/ip/route/find dst-address=96.8.139.161/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.139.161/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
:if ([:len [/ip/route/find dst-address=96.8.139.162/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.139.162/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
:if ([:len [/ip/route/find dst-address=96.8.139.164/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.139.164/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
:if ([:len [/ip/route/find dst-address=96.8.139.168/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.139.168/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
:if ([:len [/ip/route/find dst-address=96.8.139.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.139.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
:if ([:len [/ip/route/find dst-address=96.8.139.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.8.139.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16527 }
