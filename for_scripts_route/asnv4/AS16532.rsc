...
:if ([:len [/ip/route/find dst-address=66.158.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.158.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
:if ([:len [/ip/route/find dst-address=66.158.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.158.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
:if ([:len [/ip/route/find dst-address=72.10.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.10.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
:if ([:len [/ip/route/find dst-address=72.10.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.10.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
:if ([:len [/ip/route/find dst-address=72.10.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.10.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
:if ([:len [/ip/route/find dst-address=72.10.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.10.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
:if ([:len [/ip/route/find dst-address=72.10.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.10.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
