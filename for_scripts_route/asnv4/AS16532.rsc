...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=198.52.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.52.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
...
:if ([:len [/ip/route/find dst-address=72.10.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.10.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
:if ([:len [/ip/route/find dst-address=72.12.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.12.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16532 }
