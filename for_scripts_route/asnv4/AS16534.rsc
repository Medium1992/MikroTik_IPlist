...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16534 and dst-address=for_scripts_route/asnv4/AS16534.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16534.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16534 }
