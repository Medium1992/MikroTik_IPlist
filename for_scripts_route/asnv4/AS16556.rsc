...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16556 and dst-address=for_scripts_route/asnv4/AS16556.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16556.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16556 }
