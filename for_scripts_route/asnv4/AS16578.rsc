...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16578 and dst-address=for_scripts_route/asnv4/AS16578.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16578.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16578 }
