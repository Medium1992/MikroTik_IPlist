...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=136.62.94.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.94.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.94.240/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.94.240/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.94.242/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.94.242/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.94.244/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.94.244/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.94.248/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.94.248/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.95.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.95.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.95.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.95.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.95.192/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.95.192/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.95.195/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.95.195/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
:if ([:len [/ip/route/find dst-address=136.62.95.196/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.62.95.196/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16591 }
