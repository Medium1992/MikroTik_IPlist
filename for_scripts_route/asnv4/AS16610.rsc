...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=208.88.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.88.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16610 }
:if ([:len [/ip/route/find dst-address=208.88.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.88.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16610 }
...
:if ([:len [/ip/route/find dst-address=68.67.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.67.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16610 }
