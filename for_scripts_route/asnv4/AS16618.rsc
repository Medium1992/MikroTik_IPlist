...
:if ([:len [/ip/route/find dst-address=67.210.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.210.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16618 }
:if ([:len [/ip/route/find dst-address=67.210.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.210.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16618 }
:if ([:len [/ip/route/find dst-address=67.210.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.210.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16618 }
