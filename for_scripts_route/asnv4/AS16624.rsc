...
:if ([:len [/ip/route/find dst-address=199.22.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.22.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16624 }
:if ([:len [/ip/route/find dst-address=199.22.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.22.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16624 }
