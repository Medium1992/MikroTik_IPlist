...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16756 and dst-address=for_scripts_route/asnv4/AS16756.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16756.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16756 }
