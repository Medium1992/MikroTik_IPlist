...
:if ([:len [/ip/route/find dst-address=206.63.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.63.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16766 }
:if ([:len [/ip/route/find dst-address=206.63.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.63.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16766 }
