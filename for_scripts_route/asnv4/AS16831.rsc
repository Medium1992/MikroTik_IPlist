...
:if ([:len [/ip/route/find dst-address=168.127.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.127.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16831 }
...
:if ([:len [/ip/route/find dst-address=168.127.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.127.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16831 }
:if ([:len [/ip/route/find dst-address=168.127.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.127.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16831 }
