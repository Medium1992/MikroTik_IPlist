...
:if ([:len [/ip/route/find dst-address=104.218.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16851 }
...
:if ([:len [/ip/route/find dst-address=199.36.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.36.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16851 }
:if ([:len [/ip/route/find dst-address=199.36.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.36.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16851 }
