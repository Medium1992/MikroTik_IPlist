...
:if ([:len [/ip/route/find dst-address=209.55.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.55.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16857 }
...
:if ([:len [/ip/route/find dst-address=66.208.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.208.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16857 }
