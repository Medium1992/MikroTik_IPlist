...
:if ([:len [/ip/route/find dst-address=192.171.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.171.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16887 }
:if ([:len [/ip/route/find dst-address=192.171.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.171.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16887 }
