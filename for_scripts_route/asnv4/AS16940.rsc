...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS16940 and dst-address=for_scripts_route/asnv4/AS16940.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS16940.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16940 }
