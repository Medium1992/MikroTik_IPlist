...
:if ([:len [/ip/route/find dst-address=206.167.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.167.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16941 }
:if ([:len [/ip/route/find dst-address=206.83.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.83.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16941 }
:if ([:len [/ip/route/find dst-address=208.70.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.70.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS16941 }
