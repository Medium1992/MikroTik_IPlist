...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17005 and dst-address=for_scripts_route/asnv4/AS17005.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17005.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17005 }
