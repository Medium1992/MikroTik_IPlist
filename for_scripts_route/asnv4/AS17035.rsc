...
:if ([:len [/ip/route/find dst-address=50.221.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.221.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17035 }
...
:if ([:len [/ip/route/find dst-address=70.39.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.39.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17035 }
...
:if ([:len [/ip/route/find dst-address=70.39.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.39.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17035 }
:if ([:len [/ip/route/find dst-address=70.39.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.39.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17035 }
