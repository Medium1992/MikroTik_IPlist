...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17073 and dst-address=for_scripts_route/asnv4/AS17073.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17073.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17073 }
