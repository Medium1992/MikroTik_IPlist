...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.168.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.168.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17117 }
...
:if ([:len [/ip/route/find dst-address=207.47.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.47.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17117 }
...
:if ([:len [/ip/route/find dst-address=50.216.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.216.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17117 }
