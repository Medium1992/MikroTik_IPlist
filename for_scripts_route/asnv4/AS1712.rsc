...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1712 and dst-address=for_scripts_route/asnv4/AS1712.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1712.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1712 }
