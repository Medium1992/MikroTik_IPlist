...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17133 and dst-address=for_scripts_route/asnv4/AS17133.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17133.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17133 }
