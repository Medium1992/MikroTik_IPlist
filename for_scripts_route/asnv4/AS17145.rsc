...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17145 and dst-address=for_scripts_route/asnv4/AS17145.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17145.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17145 }
