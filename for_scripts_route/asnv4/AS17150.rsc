...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17150 and dst-address=for_scripts_route/asnv4/AS17150.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17150.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17150 }
