...
:if ([:len [/ip/route/find dst-address=139.28.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.28.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17158 }
...
:if ([:len [/ip/route/find dst-address=185.217.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.217.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17158 }
:if ([:len [/ip/route/find dst-address=185.252.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.252.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17158 }
...
:if ([:len [/ip/route/find dst-address=76.77.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.77.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17158 }
