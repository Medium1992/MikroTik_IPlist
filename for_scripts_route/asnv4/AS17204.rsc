...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17204 and dst-address=for_scripts_route/asnv4/AS17204.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17204.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17204 }
