...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17267 and dst-address=for_scripts_route/asnv4/AS17267.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17267.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17267 }
