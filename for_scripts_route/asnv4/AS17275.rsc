...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=161.107.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.107.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17275 }
...
:if ([:len [/ip/route/find dst-address=161.107.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.107.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17275 }
