...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17301 and dst-address=for_scripts_route/asnv4/AS17301.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17301.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17301 }
