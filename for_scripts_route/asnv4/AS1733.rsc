...
:if ([:len [/ip/route/find dst-address=214.48.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=214.48.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1733 }
...
:if ([:len [/ip/route/find dst-address=215.1.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=215.1.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1733 }
...
:if ([:len [/ip/route/find dst-address=215.65.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=215.65.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1733 }
