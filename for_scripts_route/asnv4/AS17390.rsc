...
:if ([:len [/ip/route/find dst-address=129.41.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.41.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17390 }
:if ([:len [/ip/route/find dst-address=129.41.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.41.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17390 }
:if ([:len [/ip/route/find dst-address=129.41.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.41.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17390 }
...
:if ([:len [/ip/route/find dst-address=170.224.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.224.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17390 }
