...
:if ([:len [/ip/route/find dst-address=38.134.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17426 }
:if ([:len [/ip/route/find dst-address=38.188.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.188.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17426 }
:if ([:len [/ip/route/find dst-address=38.9.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.9.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17426 }
