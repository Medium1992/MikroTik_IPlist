...
:if ([:len [/ip/route/find dst-address=167.179.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.179.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17434 }
:if ([:len [/ip/route/find dst-address=167.179.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.179.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17434 }
