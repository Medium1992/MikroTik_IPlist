...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.147.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.147.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17436 }
...
:if ([:len [/ip/route/find dst-address=103.217.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.217.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17436 }
...
:if ([:len [/ip/route/find dst-address=103.83.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.83.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17436 }
