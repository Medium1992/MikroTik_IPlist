...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=182.253.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=182.253.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17451 }
:if ([:len [/ip/route/find dst-address=182.253.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=182.253.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17451 }
