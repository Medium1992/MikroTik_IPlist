...
:if ([:len [/ip/route/find dst-address=124.41.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.41.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17501 }
...
:if ([:len [/ip/route/find dst-address=212.32.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.32.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17501 }
