...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17516 and dst-address=for_scripts_route/asnv4/AS17516.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17516.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17516 }
