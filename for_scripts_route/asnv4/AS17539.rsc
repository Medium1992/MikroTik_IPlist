...
:if ([:len [/ip/route/find dst-address=58.84.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=58.84.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17539 }
:if ([:len [/ip/route/find dst-address=58.84.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=58.84.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17539 }
