...
:if ([:len [/ip/route/find dst-address=45.203.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.203.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
:if ([:len [/ip/route/find dst-address=45.203.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.203.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
...
:if ([:len [/ip/route/find dst-address=45.204.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.204.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
:if ([:len [/ip/route/find dst-address=45.204.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.204.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
:if ([:len [/ip/route/find dst-address=45.204.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.204.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
:if ([:len [/ip/route/find dst-address=45.204.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.204.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
...
:if ([:len [/ip/route/find dst-address=45.204.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.204.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
:if ([:len [/ip/route/find dst-address=45.204.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.204.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17561 }
