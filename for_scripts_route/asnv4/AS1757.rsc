...
:if ([:len [/ip/route/find dst-address=198.185.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.185.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1757 }
:if ([:len [/ip/route/find dst-address=198.185.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.185.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1757 }
