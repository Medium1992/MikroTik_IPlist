...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17590 and dst-address=for_scripts_route/asnv4/AS17590.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17590.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17590 }
