...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17598 and dst-address=for_scripts_route/asnv4/AS17598.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17598.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17598 }
