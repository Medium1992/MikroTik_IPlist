...
:if ([:len [/ip/route/find dst-address=158.26.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.26.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1766 }
...
:if ([:len [/ip/route/find dst-address=158.26.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.26.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1766 }
