...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17726 and dst-address=for_scripts_route/asnv4/AS17726.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17726.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17726 }
