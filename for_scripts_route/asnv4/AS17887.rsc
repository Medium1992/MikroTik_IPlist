...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17887 and dst-address=for_scripts_route/asnv4/AS17887.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17887.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17887 }
