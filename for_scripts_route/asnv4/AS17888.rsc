...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS17888 and dst-address=for_scripts_route/asnv4/AS17888.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS17888.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17888 }
