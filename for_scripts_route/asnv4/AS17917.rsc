...
:if ([:len [/ip/route/find dst-address=49.156.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.101/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.101/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.102/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.102/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.104/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.104/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.112/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.112/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.86.96/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.86.96/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=49.156.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.156.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
