...
:if ([:len [/ip/route/find dst-address=124.253.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.253.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=124.253.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.253.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=124.253.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.253.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=124.253.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.253.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
:if ([:len [/ip/route/find dst-address=124.253.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.253.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17917 }
