...
:if ([:len [/ip/route/find dst-address=103.193.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.193.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17976 }
...
:if ([:len [/ip/route/find dst-address=45.201.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.201.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS17976 }
