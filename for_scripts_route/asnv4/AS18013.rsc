...
:if ([:len [/ip/route/find dst-address=103.134.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.134.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18013 }
...
:if ([:len [/ip/route/find dst-address=151.158.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18013 }
:if ([:len [/ip/route/find dst-address=202.58.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.58.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18013 }
...
:if ([:len [/ip/route/find dst-address=74.52.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.52.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18013 }
