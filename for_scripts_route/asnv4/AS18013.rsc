...
:if ([:len [/ip/route/find dst-address=103.199.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.199.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18013 }
