...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1802 and dst-address=for_scripts_route/asnv4/AS1802.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1802.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1802 }
