...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18021 and dst-address=for_scripts_route/asnv4/AS18021.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18021.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18021 }
