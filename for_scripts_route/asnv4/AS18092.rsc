...
:if ([:len [/ip/route/find dst-address=27.122.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.112/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.112/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.120/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.120/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.122/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.122/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.124/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.124/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.8.96/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.8.96/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
:if ([:len [/ip/route/find dst-address=27.122.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18092 }
