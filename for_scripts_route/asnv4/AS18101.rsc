...
:if ([:len [/ip/route/find dst-address=220.225.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=220.225.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18101 }
:if ([:len [/ip/route/find dst-address=220.225.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=220.225.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18101 }
:if ([:len [/ip/route/find dst-address=220.225.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=220.225.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18101 }
