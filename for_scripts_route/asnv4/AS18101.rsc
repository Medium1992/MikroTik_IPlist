...
:if ([:len [/ip/route/find dst-address=202.138.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.138.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18101 }
...
:if ([:len [/ip/route/find dst-address=202.138.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.138.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18101 }
:if ([:len [/ip/route/find dst-address=202.138.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.138.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18101 }
