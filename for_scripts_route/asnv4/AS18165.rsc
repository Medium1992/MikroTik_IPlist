...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18165 and dst-address=for_scripts_route/asnv4/AS18165.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18165.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18165 }
