...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS1819 and dst-address=for_scripts_route/asnv4/AS1819.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS1819.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1819 }
