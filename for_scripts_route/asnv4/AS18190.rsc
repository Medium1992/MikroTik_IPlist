...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=112.198.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=112.198.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18190 }
...
:if ([:len [/ip/route/find dst-address=61.28.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.28.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18190 }
