...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.160.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.160.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18222 }
...
:if ([:len [/ip/route/find dst-address=202.51.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18222 }
...
:if ([:len [/ip/route/find dst-address=202.51.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18222 }
...
:if ([:len [/ip/route/find dst-address=202.51.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18222 }
