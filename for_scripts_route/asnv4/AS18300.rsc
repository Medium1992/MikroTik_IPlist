...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18300 and dst-address=for_scripts_route/asnv4/AS18300.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18300.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18300 }
