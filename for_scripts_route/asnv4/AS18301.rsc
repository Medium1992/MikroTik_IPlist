...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18301 and dst-address=for_scripts_route/asnv4/AS18301.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18301.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18301 }
