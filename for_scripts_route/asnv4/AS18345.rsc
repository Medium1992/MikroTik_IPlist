...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.16.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.16.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18345 }
:if ([:len [/ip/route/find dst-address=173.239.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.239.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18345 }
:if ([:len [/ip/route/find dst-address=173.239.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.239.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18345 }
...
:if ([:len [/ip/route/find dst-address=191.101.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.101.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18345 }
