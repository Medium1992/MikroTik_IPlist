...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18361 and dst-address=for_scripts_route/asnv4/AS18361.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18361.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18361 }
