...
:if ([:len [/ip/route/find dst-address=203.81.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.81.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18399 }
...
:if ([:len [/ip/route/find dst-address=61.4.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.4.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18399 }
:if ([:len [/ip/route/find dst-address=61.4.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.4.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18399 }
:if ([:len [/ip/route/find dst-address=61.4.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.4.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18399 }
