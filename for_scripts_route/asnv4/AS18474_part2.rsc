...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=66.78.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.78.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18474 }
:if ([:len [/ip/route/find dst-address=66.78.176.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.78.176.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18474 }
:if ([:len [/ip/route/find dst-address=66.78.176.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.78.176.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18474 }
:if ([:len [/ip/route/find dst-address=66.78.176.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.78.176.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18474 }
:if ([:len [/ip/route/find dst-address=66.78.176.48/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.78.176.48/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18474 }
:if ([:len [/ip/route/find dst-address=66.78.176.56/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.78.176.56/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18474 }
