...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18488 and dst-address=for_scripts_route/asnv4/AS18488.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18488.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18488 }
