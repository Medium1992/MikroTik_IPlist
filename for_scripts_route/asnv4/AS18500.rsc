...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18500 and dst-address=for_scripts_route/asnv4/AS18500.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18500.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18500 }
