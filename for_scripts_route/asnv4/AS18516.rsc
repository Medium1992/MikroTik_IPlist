...
:if ([:len [/ip/route/find dst-address=69.5.100.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.100.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.100.64/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.64/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.100.80/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.80/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.100.88/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.88/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.100.92/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.92/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.100.94/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.94/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.100.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.100.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
:if ([:len [/ip/route/find dst-address=69.5.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18516 }
