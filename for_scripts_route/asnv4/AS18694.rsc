...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18694 and dst-address=for_scripts_route/asnv4/AS18694.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18694.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18694 }
