...
:if ([:len [/ip/route/find dst-address=208.93.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.93.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18705 }
:if ([:len [/ip/route/find dst-address=208.93.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.93.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18705 }
