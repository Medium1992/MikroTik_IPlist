...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18725 and dst-address=for_scripts_route/asnv4/AS18725.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18725.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18725 }
