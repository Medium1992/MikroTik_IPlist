...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=200.73.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.73.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18747 }
:if ([:len [/ip/route/find dst-address=200.80.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.80.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18747 }
:if ([:len [/ip/route/find dst-address=200.80.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.80.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18747 }
:if ([:len [/ip/route/find dst-address=200.80.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.80.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18747 }
