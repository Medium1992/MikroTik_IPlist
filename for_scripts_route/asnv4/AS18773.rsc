...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18773 and dst-address=for_scripts_route/asnv4/AS18773.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18773.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18773 }
