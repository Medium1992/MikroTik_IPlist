...
:if ([:len [/ip/route/find dst-address=216.147.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.147.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18780 }
...
:if ([:len [/ip/route/find dst-address=66.97.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.97.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18780 }
