...
:if ([:len [/ip/route/find dst-address=64.33.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.33.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18785 }
...
:if ([:len [/ip/route/find dst-address=66.115.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.115.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18785 }
