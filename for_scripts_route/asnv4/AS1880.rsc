...
:if ([:len [/ip/route/find dst-address=192.108.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.108.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1880 }
...
:if ([:len [/ip/route/find dst-address=192.36.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.36.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1880 }
:if ([:len [/ip/route/find dst-address=204.29.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.29.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS1880 }
