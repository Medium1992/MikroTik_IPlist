...
:if ([:len [/ip/route/find dst-address=38.97.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.97.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18848 }
...
:if ([:len [/ip/route/find dst-address=69.40.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.40.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18848 }
