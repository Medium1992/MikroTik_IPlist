...
:if ([:len [/ip/route/find dst-address=152.145.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.145.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18862 }
:if ([:len [/ip/route/find dst-address=152.145.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.145.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18862 }
...
:if ([:len [/ip/route/find dst-address=152.145.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.145.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18862 }
...
:if ([:len [/ip/route/find dst-address=74.116.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.116.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18862 }
