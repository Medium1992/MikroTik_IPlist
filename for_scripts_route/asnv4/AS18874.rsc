...
:if ([:len [/ip/route/find dst-address=158.184.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.184.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18874 }
...
:if ([:len [/ip/route/find dst-address=158.184.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.184.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18874 }
