...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS18937 and dst-address=for_scripts_route/asnv4/AS18937.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS18937.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS18937 }
