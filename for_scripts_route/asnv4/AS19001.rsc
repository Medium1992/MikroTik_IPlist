...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19001 and dst-address=for_scripts_route/asnv4/AS19001.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19001.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19001 }
