...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19050 and dst-address=for_scripts_route/asnv4/AS19050.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19050.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19050 }
