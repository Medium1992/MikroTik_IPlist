...
:if ([:len [/ip/route/find dst-address=162.223.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.223.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19084 }
:if ([:len [/ip/route/find dst-address=162.245.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.245.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19084 }
