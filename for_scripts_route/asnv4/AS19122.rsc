...
:if ([:len [/ip/route/find dst-address=38.132.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.132.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19122 }
:if ([:len [/ip/route/find dst-address=38.132.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.132.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19122 }
:if ([:len [/ip/route/find dst-address=38.132.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.132.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19122 }
:if ([:len [/ip/route/find dst-address=38.132.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.132.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19122 }
