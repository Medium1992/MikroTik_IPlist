...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=173.45.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.45.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19133 }
...
:if ([:len [/ip/route/find dst-address=204.11.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.11.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19133 }
...
:if ([:len [/ip/route/find dst-address=208.65.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.65.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19133 }
:if ([:len [/ip/route/find dst-address=208.65.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.65.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19133 }
...
:if ([:len [/ip/route/find dst-address=208.93.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.93.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19133 }
