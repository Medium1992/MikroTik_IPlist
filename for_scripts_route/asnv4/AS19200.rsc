...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19200 and dst-address=for_scripts_route/asnv4/AS19200.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19200.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19200 }
