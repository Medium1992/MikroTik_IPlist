...
:if ([:len [/ip/route/find dst-address=162.220.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.220.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
...
:if ([:len [/ip/route/find dst-address=208.82.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.32/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.32/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.37/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.37/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.38/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.38/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.40/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.40/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.46.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.46.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
:if ([:len [/ip/route/find dst-address=208.82.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.82.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19215 }
