...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19222 and dst-address=for_scripts_route/asnv4/AS19222.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19222.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19222 }
