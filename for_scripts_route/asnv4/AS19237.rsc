...
:if ([:len [/ip/route/find dst-address=216.239.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.239.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19237 }
:if ([:len [/ip/route/find dst-address=216.239.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.239.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19237 }
