...
:if ([:len [/ip/route/find dst-address=192.146.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.146.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19239 }
...
:if ([:len [/ip/route/find dst-address=192.146.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.146.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19239 }
