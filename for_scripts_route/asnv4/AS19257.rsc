...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19257 and dst-address=for_scripts_route/asnv4/AS19257.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19257.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19257 }
