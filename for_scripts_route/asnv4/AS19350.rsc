...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19350 and dst-address=for_scripts_route/asnv4/AS19350.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19350.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19350 }
