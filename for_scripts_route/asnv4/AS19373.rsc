...
:if ([:len [/ip/route/find dst-address=187.228.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.228.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19373 }
:if ([:len [/ip/route/find dst-address=187.228.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.228.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19373 }
...
:if ([:len [/ip/route/find dst-address=200.38.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.38.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19373 }
:if ([:len [/ip/route/find dst-address=200.38.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.38.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19373 }
