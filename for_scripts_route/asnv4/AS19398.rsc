...
:if ([:len [/ip/route/find dst-address=155.139.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.139.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19398 }
...
:if ([:len [/ip/route/find dst-address=155.139.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.139.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19398 }
...
:if ([:len [/ip/route/find dst-address=199.5.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.5.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19398 }
