...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19406 and dst-address=for_scripts_route/asnv4/AS19406.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19406.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19406 }
