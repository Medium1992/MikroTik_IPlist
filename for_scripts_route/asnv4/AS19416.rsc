...
:if ([:len [/ip/route/find dst-address=159.55.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.55.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19416 }
:if ([:len [/ip/route/find dst-address=159.55.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.55.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19416 }
...
:if ([:len [/ip/route/find dst-address=198.96.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.96.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19416 }
