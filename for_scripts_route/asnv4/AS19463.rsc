...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19463 and dst-address=for_scripts_route/asnv4/AS19463.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19463.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19463 }
