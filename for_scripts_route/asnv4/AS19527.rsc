...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=136.121.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.121.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
:if ([:len [/ip/route/find dst-address=136.121.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.121.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=34.0.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.0.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
:if ([:len [/ip/route/find dst-address=34.0.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.0.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=34.1.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.1.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=34.190.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.190.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=34.2.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.2.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=34.3.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.3.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
:if ([:len [/ip/route/find dst-address=34.4.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.4.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=57.140.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.140.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
