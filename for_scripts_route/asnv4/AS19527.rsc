...
:if ([:len [/ip/route/find dst-address=152.65.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.65.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=34.1.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.1.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
...
:if ([:len [/ip/route/find dst-address=34.190.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=34.190.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19527 }
