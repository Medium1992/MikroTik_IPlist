...
:if ([:len [/ip/route/find dst-address=69.46.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.46.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19528 }
:if ([:len [/ip/route/find dst-address=69.46.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.46.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19528 }
:if ([:len [/ip/route/find dst-address=69.46.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.46.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19528 }
:if ([:len [/ip/route/find dst-address=69.46.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.46.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19528 }
...
:if ([:len [/ip/route/find dst-address=74.209.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.209.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19528 }
