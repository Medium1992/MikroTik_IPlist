...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19624 and dst-address=for_scripts_route/asnv4/AS19624.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19624.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19624 }
