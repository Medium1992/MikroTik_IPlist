...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19626 and dst-address=for_scripts_route/asnv4/AS19626.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19626.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19626 }
