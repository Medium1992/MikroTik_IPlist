...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196721 and dst-address=for_scripts_route/asnv4/AS196721.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196721.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196721 }
