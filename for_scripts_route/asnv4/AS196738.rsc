...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196738 and dst-address=for_scripts_route/asnv4/AS196738.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196738.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196738 }
