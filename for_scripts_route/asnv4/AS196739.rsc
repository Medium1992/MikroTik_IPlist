...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196739 and dst-address=for_scripts_route/asnv4/AS196739.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196739.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196739 }
