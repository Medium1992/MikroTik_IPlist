...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196778 and dst-address=for_scripts_route/asnv4/AS196778.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196778.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196778 }
