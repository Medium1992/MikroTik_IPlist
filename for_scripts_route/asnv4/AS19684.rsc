...
:if ([:len [/ip/route/find dst-address=207.29.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.29.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19684 }
:if ([:len [/ip/route/find dst-address=207.29.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.29.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19684 }
