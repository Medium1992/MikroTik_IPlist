...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196861 and dst-address=for_scripts_route/asnv4/AS196861.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196861.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196861 }
