...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196906 and dst-address=for_scripts_route/asnv4/AS196906.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196906.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196906 }
