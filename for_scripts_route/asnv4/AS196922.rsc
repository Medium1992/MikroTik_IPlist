...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196922 and dst-address=for_scripts_route/asnv4/AS196922.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196922.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196922 }
