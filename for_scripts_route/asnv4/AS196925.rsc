...
:if ([:len [/ip/route/find dst-address=134.19.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.19.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196925 }
...
:if ([:len [/ip/route/find dst-address=185.127.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.127.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196925 }
:if ([:len [/ip/route/find dst-address=192.145.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.145.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196925 }
...
:if ([:len [/ip/route/find dst-address=93.114.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.114.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196925 }
