...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196936 and dst-address=for_scripts_route/asnv4/AS196936.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196936.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196936 }
