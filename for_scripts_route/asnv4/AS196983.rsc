...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS196983 and dst-address=for_scripts_route/asnv4/AS196983.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS196983.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS196983 }
