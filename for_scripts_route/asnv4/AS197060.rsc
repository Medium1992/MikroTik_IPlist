...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197060 and dst-address=for_scripts_route/asnv4/AS197060.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197060.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197060 }
