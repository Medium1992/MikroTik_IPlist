...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197068 and dst-address=for_scripts_route/asnv4/AS197068.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197068.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197068 }
