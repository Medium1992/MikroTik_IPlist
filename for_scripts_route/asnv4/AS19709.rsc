...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=184.188.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=184.188.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19709 }
...
:if ([:len [/ip/route/find dst-address=98.179.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.179.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19709 }
