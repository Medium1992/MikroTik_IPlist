...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.160.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.160.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197170 }
:if ([:len [/ip/route/find dst-address=176.65.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.65.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197170 }
...
:if ([:len [/ip/route/find dst-address=91.92.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.92.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197170 }
:if ([:len [/ip/route/find dst-address=93.152.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.152.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197170 }
