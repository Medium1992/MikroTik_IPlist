...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197275 and dst-address=for_scripts_route/asnv4/AS197275.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197275.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197275 }
