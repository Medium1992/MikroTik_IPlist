...
:if ([:len [/ip/route/find dst-address=185.15.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.15.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197293 }
:if ([:len [/ip/route/find dst-address=185.15.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.15.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197293 }
