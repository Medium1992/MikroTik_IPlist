...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.240.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.240.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197328 }
:if ([:len [/ip/route/find dst-address=151.240.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.240.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197328 }
:if ([:len [/ip/route/find dst-address=151.247.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.247.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197328 }
