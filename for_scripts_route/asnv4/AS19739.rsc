...
:if ([:len [/ip/route/find dst-address=170.164.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.164.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19739 }
...
:if ([:len [/ip/route/find dst-address=170.164.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.164.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19739 }
...
:if ([:len [/ip/route/find dst-address=170.164.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.164.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19739 }
