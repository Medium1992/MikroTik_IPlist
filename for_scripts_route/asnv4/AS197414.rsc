...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197414 and dst-address=for_scripts_route/asnv4/AS197414.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197414.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197414 }
