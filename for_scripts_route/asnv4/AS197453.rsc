...
:if ([:len [/ip/route/find dst-address=185.218.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.218.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197453 }
...
:if ([:len [/ip/route/find dst-address=217.72.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.72.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197453 }
