...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197485 and dst-address=for_scripts_route/asnv4/AS197485.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197485.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197485 }
