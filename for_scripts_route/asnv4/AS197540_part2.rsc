...
:if ([:len [/ip/route/find dst-address=5.182.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.182.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197540 }
:if ([:len [/ip/route/find dst-address=5.182.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.182.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197540 }
...
:if ([:len [/ip/route/find dst-address=77.90.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.90.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197540 }
