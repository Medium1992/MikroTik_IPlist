...
:if ([:len [/ip/route/find dst-address=89.144.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
:if ([:len [/ip/route/find dst-address=89.144.63.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.63.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
