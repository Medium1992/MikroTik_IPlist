...
:if ([:len [/ip/route/find dst-address=85.93.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.93.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
:if ([:len [/ip/route/find dst-address=85.93.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.93.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=85.93.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.93.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
:if ([:len [/ip/route/find dst-address=85.93.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.93.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
:if ([:len [/ip/route/find dst-address=89.144.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
:if ([:len [/ip/route/find dst-address=89.144.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
:if ([:len [/ip/route/find dst-address=89.144.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
