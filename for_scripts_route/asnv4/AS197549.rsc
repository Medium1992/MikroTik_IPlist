...
:if ([:len [/ip/route/find dst-address=85.93.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.93.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
