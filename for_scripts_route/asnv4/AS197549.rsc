...
:if ([:len [/ip/route/find dst-address=85.93.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.93.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
...
:if ([:len [/ip/route/find dst-address=89.144.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197549 }
