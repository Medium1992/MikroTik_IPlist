...
:if ([:len [/ip/route/find dst-address=162.223.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.223.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19755 }
...
:if ([:len [/ip/route/find dst-address=199.73.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.73.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19755 }
