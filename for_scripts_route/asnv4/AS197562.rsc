...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197562 and dst-address=for_scripts_route/asnv4/AS197562.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197562.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197562 }
