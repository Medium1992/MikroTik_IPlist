...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197564 and dst-address=for_scripts_route/asnv4/AS197564.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197564.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197564 }
