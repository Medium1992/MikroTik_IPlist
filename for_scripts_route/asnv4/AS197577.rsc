...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197577 and dst-address=for_scripts_route/asnv4/AS197577.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197577.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197577 }
