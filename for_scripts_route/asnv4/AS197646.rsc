...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=153.51.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197646 }
:if ([:len [/ip/route/find dst-address=153.51.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197646 }
