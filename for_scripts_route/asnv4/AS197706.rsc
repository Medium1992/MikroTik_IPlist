...
:if ([:len [/ip/route/find dst-address=103.93.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.93.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197706 }
:if ([:len [/ip/route/find dst-address=109.104.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.104.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197706 }
:if ([:len [/ip/route/find dst-address=109.104.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.104.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197706 }
