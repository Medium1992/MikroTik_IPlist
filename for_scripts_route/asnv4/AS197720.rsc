...
:if ([:len [/ip/route/find dst-address=31.186.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.186.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197720 }
:if ([:len [/ip/route/find dst-address=31.186.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.186.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197720 }
