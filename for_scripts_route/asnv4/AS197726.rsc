...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197726 and dst-address=for_scripts_route/asnv4/AS197726.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197726.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197726 }
