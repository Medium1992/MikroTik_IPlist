...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197809 and dst-address=for_scripts_route/asnv4/AS197809.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197809.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197809 }
