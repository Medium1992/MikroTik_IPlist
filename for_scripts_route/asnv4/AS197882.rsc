...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=130.255.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.255.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197882 }
:if ([:len [/ip/route/find dst-address=159.255.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.255.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197882 }
...
:if ([:len [/ip/route/find dst-address=185.14.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.14.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197882 }
...
:if ([:len [/ip/route/find dst-address=31.25.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.25.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197882 }
