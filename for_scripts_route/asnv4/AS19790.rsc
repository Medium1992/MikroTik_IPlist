...
:if ([:len [/ip/route/find dst-address=134.49.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.49.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.48/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.48/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.50/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.50/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.52/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.52/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.56/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.56/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
:if ([:len [/ip/route/find dst-address=23.148.36.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.36.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19790 }
