...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197915 and dst-address=for_scripts_route/asnv4/AS197915.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197915.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197915 }
