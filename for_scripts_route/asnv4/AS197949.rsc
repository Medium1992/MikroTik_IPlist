...
:if ([:len [/ip/route/find dst-address=145.60.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.60.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197949 }
:if ([:len [/ip/route/find dst-address=145.60.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.60.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197949 }
