...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197949 and dst-address=for_scripts_route/asnv4/AS197949.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197949.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197949 }
