...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS197965 and dst-address=for_scripts_route/asnv4/AS197965.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS197965.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197965 }
