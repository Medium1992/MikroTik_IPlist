...
:if ([:len [/ip/route/find dst-address=64.90.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.90.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19797 }
:if ([:len [/ip/route/find dst-address=64.90.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.90.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19797 }
:if ([:len [/ip/route/find dst-address=64.90.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.90.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19797 }
:if ([:len [/ip/route/find dst-address=64.90.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.90.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19797 }
