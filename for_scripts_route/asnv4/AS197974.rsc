...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=31.56.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.56.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197974 }
...
:if ([:len [/ip/route/find dst-address=31.77.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.77.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS197974 }
