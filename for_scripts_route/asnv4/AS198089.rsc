...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198089 and dst-address=for_scripts_route/asnv4/AS198089.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198089.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198089 }
