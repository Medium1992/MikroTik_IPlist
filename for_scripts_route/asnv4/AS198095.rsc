...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198095 and dst-address=for_scripts_route/asnv4/AS198095.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198095.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198095 }
