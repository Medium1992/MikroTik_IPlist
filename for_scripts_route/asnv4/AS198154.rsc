...
:if ([:len [/ip/route/find dst-address=109.122.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.122.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198154 }
...
:if ([:len [/ip/route/find dst-address=81.12.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198154 }
:if ([:len [/ip/route/find dst-address=81.12.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198154 }
