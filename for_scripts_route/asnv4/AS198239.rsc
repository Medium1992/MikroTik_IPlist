...
:if ([:len [/ip/route/find dst-address=91.226.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.226.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198239 }
...
:if ([:len [/ip/route/find dst-address=91.237.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.237.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198239 }
