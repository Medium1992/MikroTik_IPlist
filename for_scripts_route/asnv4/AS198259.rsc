...
:if ([:len [/ip/route/find dst-address=145.255.205.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.255.205.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198259 }
:if ([:len [/ip/route/find dst-address=145.255.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.255.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198259 }
:if ([:len [/ip/route/find dst-address=145.255.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.255.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198259 }
:if ([:len [/ip/route/find dst-address=145.255.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.255.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198259 }
:if ([:len [/ip/route/find dst-address=145.255.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.255.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198259 }
