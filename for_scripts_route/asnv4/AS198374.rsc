...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198374 and dst-address=for_scripts_route/asnv4/AS198374.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198374.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198374 }
