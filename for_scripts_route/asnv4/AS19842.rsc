...
:if ([:len [/ip/route/find dst-address=216.105.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.105.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19842 }
:if ([:len [/ip/route/find dst-address=216.105.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.105.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19842 }
:if ([:len [/ip/route/find dst-address=216.105.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.105.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19842 }
