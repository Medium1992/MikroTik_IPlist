...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.192.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.192.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19842 }
...
:if ([:len [/ip/route/find dst-address=206.130.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.130.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19842 }
...
:if ([:len [/ip/route/find dst-address=216.105.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.105.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19842 }
:if ([:len [/ip/route/find dst-address=98.158.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.158.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19842 }
