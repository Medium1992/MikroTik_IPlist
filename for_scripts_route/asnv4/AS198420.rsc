...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=140.233.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.233.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198420 }
...
:if ([:len [/ip/route/find dst-address=82.41.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.41.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198420 }
