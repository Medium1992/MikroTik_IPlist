...
:if ([:len [/ip/route/find dst-address=37.128.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.128.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198433 }
:if ([:len [/ip/route/find dst-address=37.128.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.128.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198433 }
:if ([:len [/ip/route/find dst-address=37.128.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.128.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198433 }
