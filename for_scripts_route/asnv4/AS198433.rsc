...
:if ([:len [/ip/route/find dst-address=193.135.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.135.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198433 }
:if ([:len [/ip/route/find dst-address=195.225.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.225.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198433 }
