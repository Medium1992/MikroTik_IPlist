...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198454 and dst-address=for_scripts_route/asnv4/AS198454.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198454.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198454 }
