...
:if ([:len [/ip/route/find dst-address=37.128.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.128.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198479 }
...
:if ([:len [/ip/route/find dst-address=91.235.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.235.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198479 }
