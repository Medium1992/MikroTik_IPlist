...
:if ([:len [/ip/route/find dst-address=93.95.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.95.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198486 }
:if ([:len [/ip/route/find dst-address=93.95.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.95.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198486 }
:if ([:len [/ip/route/find dst-address=93.95.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.95.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198486 }
:if ([:len [/ip/route/find dst-address=93.95.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.95.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198486 }
