...
:if ([:len [/ip/route/find dst-address=2.27.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.27.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198487 }
...
:if ([:len [/ip/route/find dst-address=79.176.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.176.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198487 }
