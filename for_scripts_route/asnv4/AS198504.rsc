...
:if ([:len [/ip/route/find dst-address=116.0.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.0.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198504 }
...
:if ([:len [/ip/route/find dst-address=43.225.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.225.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198504 }
