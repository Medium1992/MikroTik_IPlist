...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=167.148.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198510 }
:if ([:len [/ip/route/find dst-address=178.214.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.214.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198510 }
...
:if ([:len [/ip/route/find dst-address=78.105.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.105.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198510 }
