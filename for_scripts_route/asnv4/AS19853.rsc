...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS19853 and dst-address=for_scripts_route/asnv4/AS19853.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS19853.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19853 }
