...
:if ([:len [/ip/route/find dst-address=192.156.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.156.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
...
:if ([:len [/ip/route/find dst-address=94.183.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.183.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
