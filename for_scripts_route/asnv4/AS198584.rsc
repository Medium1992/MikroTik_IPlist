...
:if ([:len [/ip/route/find dst-address=185.43.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.43.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
...
:if ([:len [/ip/route/find dst-address=194.213.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.213.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
:if ([:len [/ip/route/find dst-address=194.77.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.77.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
...
:if ([:len [/ip/route/find dst-address=31.59.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.59.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
...
:if ([:len [/ip/route/find dst-address=87.229.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.229.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
:if ([:len [/ip/route/find dst-address=91.206.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.206.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198584 }
