...
:if ([:len [/ip/route/find dst-address=151.245.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.245.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198653 }
:if ([:len [/ip/route/find dst-address=31.57.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198653 }
