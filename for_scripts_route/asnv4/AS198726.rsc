...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198726 and dst-address=for_scripts_route/asnv4/AS198726.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198726.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198726 }
