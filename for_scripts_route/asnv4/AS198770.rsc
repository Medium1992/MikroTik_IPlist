...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198770 and dst-address=for_scripts_route/asnv4/AS198770.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198770.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198770 }
