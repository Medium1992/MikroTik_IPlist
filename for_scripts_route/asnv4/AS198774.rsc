...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198774 and dst-address=for_scripts_route/asnv4/AS198774.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198774.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198774 }
