...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198785 and dst-address=for_scripts_route/asnv4/AS198785.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198785.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198785 }
