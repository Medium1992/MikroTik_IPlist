...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198793 and dst-address=for_scripts_route/asnv4/AS198793.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198793.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198793 }
