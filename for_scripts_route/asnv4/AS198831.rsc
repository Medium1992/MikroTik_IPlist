...
:if ([:len [/ip/route/find dst-address=141.11.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.11.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198831 }
...
:if ([:len [/ip/route/find dst-address=185.164.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.164.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198831 }
...
:if ([:len [/ip/route/find dst-address=193.31.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.31.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198831 }
