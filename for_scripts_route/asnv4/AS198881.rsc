...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198881 and dst-address=for_scripts_route/asnv4/AS198881.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198881.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198881 }
