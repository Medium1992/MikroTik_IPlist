...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198947 and dst-address=for_scripts_route/asnv4/AS198947.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198947.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198947 }
