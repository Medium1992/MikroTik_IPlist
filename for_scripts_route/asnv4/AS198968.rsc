...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS198968 and dst-address=for_scripts_route/asnv4/AS198968.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS198968.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198968 }
