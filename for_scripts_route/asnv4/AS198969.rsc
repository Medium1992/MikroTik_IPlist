...
:if ([:len [/ip/route/find dst-address=141.0.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.0.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198969 }
...
:if ([:len [/ip/route/find dst-address=94.192.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.192.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198969 }
:if ([:len [/ip/route/find dst-address=94.192.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.192.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198969 }
:if ([:len [/ip/route/find dst-address=94.192.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.192.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198969 }
