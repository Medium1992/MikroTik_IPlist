...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=130.254.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.254.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198969 }
:if ([:len [/ip/route/find dst-address=130.254.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.254.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198969 }
...
:if ([:len [/ip/route/find dst-address=94.192.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.192.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS198969 }
