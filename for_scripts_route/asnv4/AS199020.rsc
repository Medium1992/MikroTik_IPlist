...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199020 and dst-address=for_scripts_route/asnv4/AS199020.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199020.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199020 }
