...
:if ([:len [/ip/route/find dst-address=107.178.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.178.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS19903 }
