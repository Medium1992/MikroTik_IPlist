...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199152 and dst-address=for_scripts_route/asnv4/AS199152.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199152.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199152 }
