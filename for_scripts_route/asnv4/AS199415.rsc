...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=141.11.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.11.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199415 }
...
:if ([:len [/ip/route/find dst-address=82.21.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.21.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199415 }
