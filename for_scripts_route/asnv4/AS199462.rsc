...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199462 and dst-address=for_scripts_route/asnv4/AS199462.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199462.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199462 }
