...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199493 and dst-address=for_scripts_route/asnv4/AS199493.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199493.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199493 }
