...
:if ([:len [/ip/route/find dst-address=188.220.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.220.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199550 }
...
:if ([:len [/ip/route/find dst-address=51.146.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.146.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199550 }
