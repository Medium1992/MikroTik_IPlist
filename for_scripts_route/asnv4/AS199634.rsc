...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199634 and dst-address=for_scripts_route/asnv4/AS199634.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199634.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199634 }
