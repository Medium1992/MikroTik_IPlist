...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199704 and dst-address=for_scripts_route/asnv4/AS199704.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199704.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199704 }
