...
:if ([:len [/ip/route/find dst-address=37.237.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.237.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199739 }
...
:if ([:len [/ip/route/find dst-address=37.238.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.238.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199739 }
...
:if ([:len [/ip/route/find dst-address=37.239.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.239.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199739 }
:if ([:len [/ip/route/find dst-address=37.239.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.239.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199739 }
:if ([:len [/ip/route/find dst-address=37.239.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.239.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199739 }
