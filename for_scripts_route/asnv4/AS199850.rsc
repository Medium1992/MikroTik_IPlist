...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199850 and dst-address=for_scripts_route/asnv4/AS199850.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199850.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199850 }
