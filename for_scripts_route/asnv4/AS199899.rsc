...
:if ([:len [/ip/route/find dst-address=175.110.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.110.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199899 }
:if ([:len [/ip/route/find dst-address=180.178.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.178.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199899 }
