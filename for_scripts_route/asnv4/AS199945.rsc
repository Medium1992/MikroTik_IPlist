...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199945 and dst-address=for_scripts_route/asnv4/AS199945.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199945.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199945 }
