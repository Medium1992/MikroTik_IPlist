...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS199965 and dst-address=for_scripts_route/asnv4/AS199965.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS199965.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS199965 }
