...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200018 and dst-address=for_scripts_route/asnv4/AS200018.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200018.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200018 }
