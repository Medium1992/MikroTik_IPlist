...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=98.151.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.151.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20001 }
...
:if ([:len [/ip/route/find dst-address=98.154.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.154.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20001 }
