...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=98.150.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.150.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20001 }
:if ([:len [/ip/route/find dst-address=98.150.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.150.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20001 }
