...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200062 and dst-address=for_scripts_route/asnv4/AS200062.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200062.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200062 }
