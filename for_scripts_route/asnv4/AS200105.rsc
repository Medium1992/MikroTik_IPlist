...
:if ([:len [/ip/route/find dst-address=147.90.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.90.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200105 }
...
:if ([:len [/ip/route/find dst-address=51.194.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.194.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200105 }
