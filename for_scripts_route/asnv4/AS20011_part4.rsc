...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=41.133.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.133.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20011 }
:if ([:len [/ip/route/find dst-address=41.133.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.133.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20011 }
:if ([:len [/ip/route/find dst-address=41.133.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.133.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20011 }
:if ([:len [/ip/route/find dst-address=41.133.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.133.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20011 }
:if ([:len [/ip/route/find dst-address=41.134.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.134.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20011 }
:if ([:len [/ip/route/find dst-address=41.134.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.134.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20011 }
:if ([:len [/ip/route/find dst-address=41.134.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.134.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20011 }
