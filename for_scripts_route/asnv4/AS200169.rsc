...
:if ([:len [/ip/route/find dst-address=188.220.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.220.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200169 }
...
:if ([:len [/ip/route/find dst-address=77.67.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.67.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200169 }
:if ([:len [/ip/route/find dst-address=78.154.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.154.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200169 }
