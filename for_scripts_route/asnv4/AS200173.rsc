...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.156.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.156.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200173 }
...
:if ([:len [/ip/route/find dst-address=134.195.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.195.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200173 }
:if ([:len [/ip/route/find dst-address=140.225.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.225.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200173 }
...
:if ([:len [/ip/route/find dst-address=31.77.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.77.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200173 }
