...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200186 and dst-address=for_scripts_route/asnv4/AS200186.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200186.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200186 }
