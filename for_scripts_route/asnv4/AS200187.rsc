...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200187 and dst-address=for_scripts_route/asnv4/AS200187.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200187.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200187 }
