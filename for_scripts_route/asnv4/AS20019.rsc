...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20019 and dst-address=for_scripts_route/asnv4/AS20019.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20019.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20019 }
