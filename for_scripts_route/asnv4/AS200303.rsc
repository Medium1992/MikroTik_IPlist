...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.244.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.244.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200303 }
...
:if ([:len [/ip/route/find dst-address=45.95.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.95.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200303 }
