...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200314 and dst-address=for_scripts_route/asnv4/AS200314.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200314.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200314 }
