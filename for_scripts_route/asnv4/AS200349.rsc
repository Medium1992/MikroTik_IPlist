...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200349 and dst-address=for_scripts_route/asnv4/AS200349.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200349.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200349 }
