...
:if ([:len [/ip/route/find dst-address=37.230.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.230.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200350 }
:if ([:len [/ip/route/find dst-address=45.133.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.133.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200350 }
...
:if ([:len [/ip/route/find dst-address=46.243.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.243.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200350 }
...
:if ([:len [/ip/route/find dst-address=89.223.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.223.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200350 }
:if ([:len [/ip/route/find dst-address=89.232.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.232.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200350 }
