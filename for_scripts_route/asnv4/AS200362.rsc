...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200362 and dst-address=for_scripts_route/asnv4/AS200362.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200362.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200362 }
