...
:if ([:len [/ip/route/find dst-address=192.124.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.124.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200367 }
...
:if ([:len [/ip/route/find dst-address=87.58.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.58.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200367 }
