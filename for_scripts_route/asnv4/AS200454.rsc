...
:if ([:len [/ip/route/find dst-address=199.16.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200454 }
...
:if ([:len [/ip/route/find dst-address=64.93.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.93.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200454 }
