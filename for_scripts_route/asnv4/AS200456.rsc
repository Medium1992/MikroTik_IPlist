...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.71.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.71.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200456 }
...
:if ([:len [/ip/route/find dst-address=217.179.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.179.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200456 }
:if ([:len [/ip/route/find dst-address=217.179.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.179.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200456 }
