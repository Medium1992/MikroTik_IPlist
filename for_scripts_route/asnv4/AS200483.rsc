...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.16.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.16.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200483 }
...
:if ([:len [/ip/route/find dst-address=185.119.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.119.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200483 }
:if ([:len [/ip/route/find dst-address=185.171.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.171.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200483 }
:if ([:len [/ip/route/find dst-address=185.241.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.241.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200483 }
...
:if ([:len [/ip/route/find dst-address=95.161.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200483 }
:if ([:len [/ip/route/find dst-address=95.161.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200483 }
:if ([:len [/ip/route/find dst-address=95.161.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200483 }
