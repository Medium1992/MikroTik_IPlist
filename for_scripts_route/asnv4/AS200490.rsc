...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200490 and dst-address=for_scripts_route/asnv4/AS200490.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200490.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200490 }
