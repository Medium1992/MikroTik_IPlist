...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200492 and dst-address=for_scripts_route/asnv4/AS200492.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200492.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200492 }
