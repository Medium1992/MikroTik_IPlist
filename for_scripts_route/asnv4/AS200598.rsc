...
:if ([:len [/ip/route/find dst-address=145.249.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.249.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200598 }
:if ([:len [/ip/route/find dst-address=145.249.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.249.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200598 }
:if ([:len [/ip/route/find dst-address=145.249.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.249.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200598 }
