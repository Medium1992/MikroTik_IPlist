...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.83.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200651 }
...
:if ([:len [/ip/route/find dst-address=195.58.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.58.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200651 }
:if ([:len [/ip/route/find dst-address=213.218.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.218.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200651 }
...
:if ([:len [/ip/route/find dst-address=95.133.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.133.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200651 }
:if ([:len [/ip/route/find dst-address=95.133.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.133.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200651 }
