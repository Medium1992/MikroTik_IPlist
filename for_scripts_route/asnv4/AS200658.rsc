...
:if ([:len [/ip/route/find dst-address=107.149.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.149.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200658 }
:if ([:len [/ip/route/find dst-address=134.195.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.195.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200658 }
...
:if ([:len [/ip/route/find dst-address=141.195.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.195.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200658 }
:if ([:len [/ip/route/find dst-address=142.249.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200658 }
...
:if ([:len [/ip/route/find dst-address=192.25.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.25.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200658 }
...
:if ([:len [/ip/route/find dst-address=216.205.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.205.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200658 }
