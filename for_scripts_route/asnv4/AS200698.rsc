...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200698 and dst-address=for_scripts_route/asnv4/AS200698.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200698.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200698 }
