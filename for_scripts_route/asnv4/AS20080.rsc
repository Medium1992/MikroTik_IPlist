...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20080 and dst-address=for_scripts_route/asnv4/AS20080.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20080.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20080 }
