...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.114.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.114.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200823 }
...
:if ([:len [/ip/route/find dst-address=193.41.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.41.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200823 }
...
:if ([:len [/ip/route/find dst-address=194.35.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.35.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200823 }
...
:if ([:len [/ip/route/find dst-address=45.153.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.153.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200823 }
:if ([:len [/ip/route/find dst-address=45.95.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.95.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200823 }
...
:if ([:len [/ip/route/find dst-address=93.190.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.190.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200823 }
