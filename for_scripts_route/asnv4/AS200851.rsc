...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200851 and dst-address=for_scripts_route/asnv4/AS200851.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200851.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200851 }
