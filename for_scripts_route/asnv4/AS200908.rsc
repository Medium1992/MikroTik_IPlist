...
:if ([:len [/ip/route/find dst-address=45.150.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.150.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200908 }
:if ([:len [/ip/route/find dst-address=69.40.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.40.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200908 }
:if ([:len [/ip/route/find dst-address=69.40.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.40.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200908 }
