...
:if ([:len [/ip/route/find dst-address=45.144.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.144.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200908 }
:if ([:len [/ip/route/find dst-address=45.150.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.150.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200908 }
