...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS200970 and dst-address=for_scripts_route/asnv4/AS200970.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS200970.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200970 }
