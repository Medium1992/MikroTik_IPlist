...
:if ([:len [/ip/route/find dst-address=185.52.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.52.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200999 }
:if ([:len [/ip/route/find dst-address=193.142.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.142.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200999 }
...
:if ([:len [/ip/route/find dst-address=194.146.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.146.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200999 }
...
:if ([:len [/ip/route/find dst-address=91.212.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.212.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS200999 }
