...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201062 and dst-address=for_scripts_route/asnv4/AS201062.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201062.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201062 }
