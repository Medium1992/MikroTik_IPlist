...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201109 and dst-address=for_scripts_route/asnv4/AS201109.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201109.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201109 }
