...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201160 and dst-address=for_scripts_route/asnv4/AS201160.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201160.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201160 }
