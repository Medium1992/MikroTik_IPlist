...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201168 and dst-address=for_scripts_route/asnv4/AS201168.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201168.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201168 }
