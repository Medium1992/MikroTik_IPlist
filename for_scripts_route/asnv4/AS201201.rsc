...
:if ([:len [/ip/route/find dst-address=185.84.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.84.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201201 }
...
:if ([:len [/ip/route/find dst-address=81.16.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.16.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201201 }
