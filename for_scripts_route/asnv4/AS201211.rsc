...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201211 and dst-address=for_scripts_route/asnv4/AS201211.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201211.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201211 }
