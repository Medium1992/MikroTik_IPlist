...
:if ([:len [/ip/route/find dst-address=192.36.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.36.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201216 }
:if ([:len [/ip/route/find dst-address=192.36.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.36.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201216 }
:if ([:len [/ip/route/find dst-address=192.36.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.36.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201216 }
:if ([:len [/ip/route/find dst-address=192.71.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.71.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201216 }
:if ([:len [/ip/route/find dst-address=192.71.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.71.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201216 }
:if ([:len [/ip/route/find dst-address=192.71.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.71.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201216 }
