...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201265 and dst-address=for_scripts_route/asnv4/AS201265.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201265.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201265 }
