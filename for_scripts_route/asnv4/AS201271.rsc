...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201271 and dst-address=for_scripts_route/asnv4/AS201271.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201271.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201271 }
