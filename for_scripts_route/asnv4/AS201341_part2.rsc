...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=62.106.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.106.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201341 }
:if ([:len [/ip/route/find dst-address=62.3.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.3.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201341 }
:if ([:len [/ip/route/find dst-address=62.3.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.3.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201341 }
:if ([:len [/ip/route/find dst-address=77.237.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.237.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201341 }
:if ([:len [/ip/route/find dst-address=77.237.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.237.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201341 }
:if ([:len [/ip/route/find dst-address=77.237.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.237.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201341 }
:if ([:len [/ip/route/find dst-address=80.245.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.245.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201341 }
