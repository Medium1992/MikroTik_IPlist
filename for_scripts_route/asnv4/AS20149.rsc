...
:if ([:len [/ip/route/find dst-address=98.97.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.97.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20149 }
:if ([:len [/ip/route/find dst-address=98.97.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.97.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20149 }
