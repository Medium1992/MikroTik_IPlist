...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201664 and dst-address=for_scripts_route/asnv4/AS201664.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201664.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201664 }
