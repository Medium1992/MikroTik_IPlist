...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201678 and dst-address=for_scripts_route/asnv4/AS201678.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201678.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201678 }
