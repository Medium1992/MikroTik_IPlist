...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS201684 and dst-address=for_scripts_route/asnv4/AS201684.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS201684.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201684 }
