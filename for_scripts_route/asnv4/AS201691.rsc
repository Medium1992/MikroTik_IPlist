...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.88.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.88.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201691 }
:if ([:len [/ip/route/find dst-address=185.88.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.88.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201691 }
