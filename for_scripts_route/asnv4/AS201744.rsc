...
:if ([:len [/ip/route/find dst-address=150.40.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.40.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201744 }
:if ([:len [/ip/route/find dst-address=150.40.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.40.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201744 }
:if ([:len [/ip/route/find dst-address=203.31.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.31.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201744 }
:if ([:len [/ip/route/find dst-address=45.95.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.95.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201744 }
:if ([:len [/ip/route/find dst-address=85.136.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.136.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201744 }
