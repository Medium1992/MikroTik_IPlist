...
:if ([:len [/ip/route/find dst-address=109.160.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.160.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201813 }
...
:if ([:len [/ip/route/find dst-address=94.26.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201813 }
