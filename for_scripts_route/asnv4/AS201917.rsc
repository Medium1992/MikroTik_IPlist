...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=139.47.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.47.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
:if ([:len [/ip/route/find dst-address=139.47.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.47.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
...
:if ([:len [/ip/route/find dst-address=37.25.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.25.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
...
:if ([:len [/ip/route/find dst-address=37.25.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.25.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
:if ([:len [/ip/route/find dst-address=37.25.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.25.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
:if ([:len [/ip/route/find dst-address=37.25.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.25.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
...
:if ([:len [/ip/route/find dst-address=46.190.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.190.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
...
:if ([:len [/ip/route/find dst-address=47.73.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=47.73.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
...
:if ([:len [/ip/route/find dst-address=47.73.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=47.73.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201917 }
