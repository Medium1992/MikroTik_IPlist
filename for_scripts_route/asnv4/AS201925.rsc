...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.203.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.203.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201925 }
:if ([:len [/ip/route/find dst-address=103.203.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.203.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201925 }
...
:if ([:len [/ip/route/find dst-address=155.133.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.133.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201925 }
