...
:if ([:len [/ip/route/find dst-address=2.26.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201988 }
:if ([:len [/ip/route/find dst-address=2.26.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201988 }
