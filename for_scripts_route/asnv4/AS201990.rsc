...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=167.104.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.104.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201990 }
...
:if ([:len [/ip/route/find dst-address=31.179.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.179.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201990 }
...
:if ([:len [/ip/route/find dst-address=94.75.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.75.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS201990 }
