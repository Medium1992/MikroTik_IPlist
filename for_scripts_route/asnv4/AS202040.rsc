...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202040 and dst-address=for_scripts_route/asnv4/AS202040.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202040.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202040 }
