...
:if ([:len [/ip/route/find dst-address=95.111.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.111.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202045 }
:if ([:len [/ip/route/find dst-address=95.111.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.111.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202045 }
:if ([:len [/ip/route/find dst-address=95.111.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.111.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202045 }
