...
:if ([:len [/ip/route/find dst-address=212.147.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.147.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202053 }
...
:if ([:len [/ip/route/find dst-address=87.58.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.58.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202053 }
