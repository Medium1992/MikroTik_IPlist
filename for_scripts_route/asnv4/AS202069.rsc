...
:if ([:len [/ip/route/find dst-address=152.175.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.175.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202069 }
:if ([:len [/ip/route/find dst-address=152.175.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.175.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202069 }
...
:if ([:len [/ip/route/find dst-address=152.175.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.175.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202069 }
...
:if ([:len [/ip/route/find dst-address=152.175.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.175.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202069 }
