...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202085 and dst-address=for_scripts_route/asnv4/AS202085.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202085.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202085 }
