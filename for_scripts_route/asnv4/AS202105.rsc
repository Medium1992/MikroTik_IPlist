...
:if ([:len [/ip/route/find dst-address=185.203.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.203.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202105 }
:if ([:len [/ip/route/find dst-address=185.203.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.203.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202105 }
...
:if ([:len [/ip/route/find dst-address=185.206.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.206.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202105 }
