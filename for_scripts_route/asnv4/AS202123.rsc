...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202123 and dst-address=for_scripts_route/asnv4/AS202123.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202123.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202123 }
