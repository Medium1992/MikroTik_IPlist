...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202154 and dst-address=for_scripts_route/asnv4/AS202154.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202154.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202154 }
