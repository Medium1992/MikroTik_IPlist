...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=209.164.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.164.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20222 }
...
:if ([:len [/ip/route/find dst-address=209.164.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.164.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20222 }
