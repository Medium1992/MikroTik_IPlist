...
:if ([:len [/ip/route/find dst-address=144.31.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202226 }
...
:if ([:len [/ip/route/find dst-address=31.76.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.76.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202226 }
...
:if ([:len [/ip/route/find dst-address=31.77.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.77.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202226 }
:if ([:len [/ip/route/find dst-address=31.77.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.77.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202226 }
