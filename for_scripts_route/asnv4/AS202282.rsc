...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202282 and dst-address=for_scripts_route/asnv4/AS202282.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202282.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202282 }
