...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS2024 and dst-address=for_scripts_route/asnv4/AS2024.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS2024.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2024 }
