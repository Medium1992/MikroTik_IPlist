...
:if ([:len [/ip/route/find dst-address=193.176.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.176.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
...
:if ([:len [/ip/route/find dst-address=45.156.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.156.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
...
:if ([:len [/ip/route/find dst-address=5.253.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.253.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
...
:if ([:len [/ip/route/find dst-address=95.38.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.38.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
:if ([:len [/ip/route/find dst-address=95.38.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.38.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
:if ([:len [/ip/route/find dst-address=95.38.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.38.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
:if ([:len [/ip/route/find dst-address=95.38.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.38.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
