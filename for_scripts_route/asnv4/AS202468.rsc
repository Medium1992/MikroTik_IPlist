...
:if ([:len [/ip/route/find dst-address=193.176.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.176.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
...
:if ([:len [/ip/route/find dst-address=37.32.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.32.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202468 }
