...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202496 and dst-address=for_scripts_route/asnv4/AS202496.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202496.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202496 }
