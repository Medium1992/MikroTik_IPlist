...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20255 and dst-address=for_scripts_route/asnv4/AS20255.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20255.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20255 }
