...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20257 and dst-address=for_scripts_route/asnv4/AS20257.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20257.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20257 }
