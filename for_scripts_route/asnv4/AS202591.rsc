...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202591 and dst-address=for_scripts_route/asnv4/AS202591.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202591.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202591 }
