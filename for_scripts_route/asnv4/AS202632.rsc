...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202632 and dst-address=for_scripts_route/asnv4/AS202632.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202632.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202632 }
