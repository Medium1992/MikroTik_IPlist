...
:if ([:len [/ip/route/find dst-address=222.167.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.167.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202662 }
:if ([:len [/ip/route/find dst-address=31.56.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.56.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202662 }
...
:if ([:len [/ip/route/find dst-address=45.207.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.207.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202662 }
...
:if ([:len [/ip/route/find dst-address=89.185.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.185.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202662 }
:if ([:len [/ip/route/find dst-address=89.185.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.185.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202662 }
