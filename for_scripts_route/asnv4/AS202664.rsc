...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202664 and dst-address=for_scripts_route/asnv4/AS202664.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202664.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202664 }
