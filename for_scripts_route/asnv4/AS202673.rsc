...
:if ([:len [/ip/route/find dst-address=191.101.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.101.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202673 }
:if ([:len [/ip/route/find dst-address=206.245.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.245.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202673 }
