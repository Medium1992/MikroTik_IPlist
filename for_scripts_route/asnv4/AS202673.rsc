...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202673 and dst-address=for_scripts_route/asnv4/AS202673.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202673.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202673 }
