...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202708 and dst-address=for_scripts_route/asnv4/AS202708.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202708.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202708 }
