...
:if ([:len [/ip/route/find dst-address=193.218.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.218.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202761 }
:if ([:len [/ip/route/find dst-address=212.48.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.48.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202761 }
