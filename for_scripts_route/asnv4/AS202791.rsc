...
:if ([:len [/ip/route/find dst-address=178.95.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.95.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202791 }
...
:if ([:len [/ip/route/find dst-address=46.203.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.203.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202791 }
:if ([:len [/ip/route/find dst-address=92.113.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.113.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202791 }
:if ([:len [/ip/route/find dst-address=92.113.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.113.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202791 }
