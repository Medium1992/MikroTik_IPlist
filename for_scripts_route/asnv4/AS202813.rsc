...
:if ([:len [/ip/route/find dst-address=5.59.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.59.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202813 }
:if ([:len [/ip/route/find dst-address=5.59.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.59.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202813 }
