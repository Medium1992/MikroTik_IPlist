...
:if ([:len [/ip/route/find dst-address=68.170.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.170.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20283 }
:if ([:len [/ip/route/find dst-address=68.170.113.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.170.113.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20283 }
:if ([:len [/ip/route/find dst-address=68.170.113.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.170.113.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20283 }
:if ([:len [/ip/route/find dst-address=68.170.113.160/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.170.113.160/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20283 }
