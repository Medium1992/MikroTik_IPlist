...
:if ([:len [/ip/route/find dst-address=195.32.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.48/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.48/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.56/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.56/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.61/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.61/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.62/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.62/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
:if ([:len [/ip/route/find dst-address=195.32.71.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.32.71.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202870 }
