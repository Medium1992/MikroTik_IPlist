...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS202901 and dst-address=for_scripts_route/asnv4/AS202901.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS202901.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202901 }
