...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=141.226.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.226.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202940 }
:if ([:len [/ip/route/find dst-address=141.226.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.226.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202940 }
...
:if ([:len [/ip/route/find dst-address=147.236.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.236.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202940 }
:if ([:len [/ip/route/find dst-address=147.236.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.236.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS202940 }
