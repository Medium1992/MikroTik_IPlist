...
:if ([:len [/ip/route/find dst-address=192.65.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.65.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20300 }
:if ([:len [/ip/route/find dst-address=207.66.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.66.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20300 }
