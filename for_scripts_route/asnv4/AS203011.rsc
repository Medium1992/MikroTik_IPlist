...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203011 and dst-address=for_scripts_route/asnv4/AS203011.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203011.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203011 }
