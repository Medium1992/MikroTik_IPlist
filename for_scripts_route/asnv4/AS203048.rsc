...
:if ([:len [/ip/route/find dst-address=155.117.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.117.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203048 }
...
:if ([:len [/ip/route/find dst-address=212.134.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.134.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203048 }
