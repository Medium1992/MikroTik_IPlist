...
:if ([:len [/ip/route/find dst-address=136.0.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.0.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
...
:if ([:len [/ip/route/find dst-address=148.135.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.135.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
...
:if ([:len [/ip/route/find dst-address=162.33.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.33.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
...
:if ([:len [/ip/route/find dst-address=216.185.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.185.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
:if ([:len [/ip/route/find dst-address=31.59.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.59.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
...
:if ([:len [/ip/route/find dst-address=46.203.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.203.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
...
:if ([:len [/ip/route/find dst-address=82.26.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.26.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
:if ([:len [/ip/route/find dst-address=87.229.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.229.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
...
:if ([:len [/ip/route/find dst-address=92.113.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.113.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203057 }
