...
:if ([:len [/ip/route/find dst-address=143.246.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.246.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203059 }
...
:if ([:len [/ip/route/find dst-address=64.254.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.254.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203059 }
