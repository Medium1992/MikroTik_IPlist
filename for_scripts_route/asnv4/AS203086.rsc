...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203086 and dst-address=for_scripts_route/asnv4/AS203086.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203086.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203086 }
