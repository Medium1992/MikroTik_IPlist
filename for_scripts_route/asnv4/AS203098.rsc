...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203098 and dst-address=for_scripts_route/asnv4/AS203098.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203098.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203098 }
