...
:if ([:len [/ip/route/find dst-address=46.203.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.203.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203106 }
...
:if ([:len [/ip/route/find dst-address=84.75.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.75.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203106 }
:if ([:len [/ip/route/find dst-address=91.124.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.124.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203106 }
