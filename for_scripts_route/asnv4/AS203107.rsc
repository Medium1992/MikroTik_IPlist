...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203107 and dst-address=for_scripts_route/asnv4/AS203107.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203107.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203107 }
