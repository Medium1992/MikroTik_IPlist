...
:if ([:len [/ip/route/find dst-address=150.185.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.185.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20312 }
...
:if ([:len [/ip/route/find dst-address=150.186.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.186.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20312 }
...
:if ([:len [/ip/route/find dst-address=150.188.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.188.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20312 }
