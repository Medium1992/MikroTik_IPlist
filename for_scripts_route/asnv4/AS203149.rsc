...
:if ([:len [/ip/route/find dst-address=142.252.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.252.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203149 }
...
:if ([:len [/ip/route/find dst-address=82.206.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.206.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203149 }
