...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203185 and dst-address=for_scripts_route/asnv4/AS203185.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203185.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203185 }
