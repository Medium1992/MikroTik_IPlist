...
:if ([:len [/ip/route/find dst-address=154.43.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.43.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203217 }
...
:if ([:len [/ip/route/find dst-address=185.247.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.247.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203217 }
...
:if ([:len [/ip/route/find dst-address=198.160.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.160.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203217 }
...
:if ([:len [/ip/route/find dst-address=204.157.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.157.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203217 }
...
:if ([:len [/ip/route/find dst-address=93.180.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.180.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203217 }
