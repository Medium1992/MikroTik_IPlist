...
:if ([:len [/ip/route/find dst-address=185.112.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.112.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203217 }
...
:if ([:len [/ip/route/find dst-address=185.194.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.194.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203217 }
