...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203263 and dst-address=for_scripts_route/asnv4/AS203263.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203263.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203263 }
