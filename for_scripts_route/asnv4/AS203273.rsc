...
:if ([:len [/ip/route/find dst-address=193.233.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
...
:if ([:len [/ip/route/find dst-address=213.165.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.165.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
:if ([:len [/ip/route/find dst-address=213.165.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.165.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
:if ([:len [/ip/route/find dst-address=213.165.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.165.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
...
:if ([:len [/ip/route/find dst-address=213.176.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.176.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
