...
:if ([:len [/ip/route/find dst-address=213.176.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.176.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
:if ([:len [/ip/route/find dst-address=213.176.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.176.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
...
:if ([:len [/ip/route/find dst-address=83.147.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.147.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203273 }
