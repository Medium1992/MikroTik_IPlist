...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20334 and dst-address=for_scripts_route/asnv4/AS20334.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20334.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20334 }
