...
:if ([:len [/ip/route/find dst-address=204.52.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.52.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20335 }
...
:if ([:len [/ip/route/find dst-address=38.187.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.187.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20335 }
...
:if ([:len [/ip/route/find dst-address=38.98.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.98.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20335 }
