...
:if ([:len [/ip/route/find dst-address=62.105.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.105.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203410 }
...
:if ([:len [/ip/route/find dst-address=83.245.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.245.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203410 }
