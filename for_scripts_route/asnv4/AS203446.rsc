...
:if ([:len [/ip/route/find dst-address=87.84.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.84.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203446 }
:if ([:len [/ip/route/find dst-address=91.143.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.143.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203446 }
