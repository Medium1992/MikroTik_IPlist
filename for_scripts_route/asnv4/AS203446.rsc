...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203446 and dst-address=for_scripts_route/asnv4/AS203446.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203446.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203446 }
