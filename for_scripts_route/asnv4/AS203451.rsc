...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203451 and dst-address=for_scripts_route/asnv4/AS203451.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203451.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203451 }
