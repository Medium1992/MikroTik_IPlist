...
:if ([:len [/ip/route/find dst-address=194.50.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.50.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203451 }
:if ([:len [/ip/route/find dst-address=2.56.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.56.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203451 }
...
:if ([:len [/ip/route/find dst-address=85.193.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.193.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203451 }
:if ([:len [/ip/route/find dst-address=95.81.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.81.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203451 }
