...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203462 and dst-address=for_scripts_route/asnv4/AS203462.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203462.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203462 }
