...
:if ([:len [/ip/route/find dst-address=66.22.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.22.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20347 }
:if ([:len [/ip/route/find dst-address=66.22.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.22.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20347 }
