...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203503 and dst-address=for_scripts_route/asnv4/AS203503.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203503.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203503 }
