...
:if ([:len [/ip/route/find dst-address=144.225.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203545 }
:if ([:len [/ip/route/find dst-address=166.1.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.1.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203545 }
