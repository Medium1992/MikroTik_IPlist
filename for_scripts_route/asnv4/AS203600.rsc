...
:if ([:len [/ip/route/find dst-address=84.236.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203600 }
:if ([:len [/ip/route/find dst-address=84.236.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203600 }
