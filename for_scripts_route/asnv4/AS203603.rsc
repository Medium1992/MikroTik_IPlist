...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203603 and dst-address=for_scripts_route/asnv4/AS203603.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203603.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203603 }
