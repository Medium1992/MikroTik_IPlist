...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203618 and dst-address=for_scripts_route/asnv4/AS203618.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203618.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203618 }
