...
:if ([:len [/ip/route/find dst-address=95.86.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203622 }
:if ([:len [/ip/route/find dst-address=95.86.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203622 }
:if ([:len [/ip/route/find dst-address=95.86.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203622 }
:if ([:len [/ip/route/find dst-address=95.86.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203622 }
:if ([:len [/ip/route/find dst-address=95.86.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203622 }
