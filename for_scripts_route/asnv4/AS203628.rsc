...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203628 and dst-address=for_scripts_route/asnv4/AS203628.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203628.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203628 }
