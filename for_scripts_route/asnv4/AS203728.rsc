...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203728 and dst-address=for_scripts_route/asnv4/AS203728.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203728.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203728 }
