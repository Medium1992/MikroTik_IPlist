...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203733 and dst-address=for_scripts_route/asnv4/AS203733.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203733.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203733 }
