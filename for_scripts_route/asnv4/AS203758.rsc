...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=108.186.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.186.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
...
:if ([:len [/ip/route/find dst-address=178.214.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.214.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
:if ([:len [/ip/route/find dst-address=178.214.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.214.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
...
:if ([:len [/ip/route/find dst-address=195.58.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.58.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
:if ([:len [/ip/route/find dst-address=195.72.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.72.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
...
:if ([:len [/ip/route/find dst-address=62.141.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.141.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
:if ([:len [/ip/route/find dst-address=82.153.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.153.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
...
:if ([:len [/ip/route/find dst-address=82.38.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203758 }
