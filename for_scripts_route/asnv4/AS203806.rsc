...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203806 and dst-address=for_scripts_route/asnv4/AS203806.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203806.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203806 }
