...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS203851 and dst-address=for_scripts_route/asnv4/AS203851.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS203851.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203851 }
