...
:if ([:len [/ip/route/find dst-address=148.169.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.169.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203885 }
...
:if ([:len [/ip/route/find dst-address=148.169.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.169.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203885 }
:if ([:len [/ip/route/find dst-address=148.169.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.169.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203885 }
...
:if ([:len [/ip/route/find dst-address=148.169.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.169.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203885 }
