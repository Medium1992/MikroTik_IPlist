...
:if ([:len [/ip/route/find dst-address=78.105.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.105.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203997 }
...
:if ([:len [/ip/route/find dst-address=82.24.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.24.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203997 }
...
:if ([:len [/ip/route/find dst-address=91.217.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.217.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS203997 }
