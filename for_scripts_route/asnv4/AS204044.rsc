...
:if ([:len [/ip/route/find dst-address=164.37.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.37.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204044 }
...
:if ([:len [/ip/route/find dst-address=213.193.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.193.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204044 }
...
:if ([:len [/ip/route/find dst-address=217.179.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.179.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204044 }
