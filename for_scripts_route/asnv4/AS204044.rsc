...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=130.78.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.78.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204044 }
:if ([:len [/ip/route/find dst-address=164.37.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.37.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204044 }
:if ([:len [/ip/route/find dst-address=167.148.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204044 }
...
:if ([:len [/ip/route/find dst-address=217.179.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.179.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204044 }
