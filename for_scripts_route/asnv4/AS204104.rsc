...
:if ([:len [/ip/route/find dst-address=212.108.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.108.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
...
:if ([:len [/ip/route/find dst-address=45.11.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.11.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
...
:if ([:len [/ip/route/find dst-address=87.107.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
:if ([:len [/ip/route/find dst-address=87.107.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
:if ([:len [/ip/route/find dst-address=87.107.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
