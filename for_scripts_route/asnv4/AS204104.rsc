...
:if ([:len [/ip/route/find dst-address=212.80.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.80.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
...
:if ([:len [/ip/route/find dst-address=217.60.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
...
:if ([:len [/ip/route/find dst-address=31.57.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204104 }
