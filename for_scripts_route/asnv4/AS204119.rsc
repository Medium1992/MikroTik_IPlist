...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204119 and dst-address=for_scripts_route/asnv4/AS204119.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204119.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204119 }
