...
:if ([:len [/ip/route/find dst-address=204.108.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
:if ([:len [/ip/route/find dst-address=204.108.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
:if ([:len [/ip/route/find dst-address=204.108.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
:if ([:len [/ip/route/find dst-address=204.108.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.108.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20413 }
