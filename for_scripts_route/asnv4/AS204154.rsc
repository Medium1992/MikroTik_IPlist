...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=132.243.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.243.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204154 }
...
:if ([:len [/ip/route/find dst-address=46.8.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.8.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204154 }
