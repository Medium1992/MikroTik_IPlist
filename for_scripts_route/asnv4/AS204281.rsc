...
:if ([:len [/ip/route/find dst-address=94.26.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204281 }
:if ([:len [/ip/route/find dst-address=94.26.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204281 }
:if ([:len [/ip/route/find dst-address=94.26.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204281 }
