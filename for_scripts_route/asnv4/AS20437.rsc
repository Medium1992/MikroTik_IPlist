...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20437 and dst-address=for_scripts_route/asnv4/AS20437.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20437.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20437 }
