...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204396 and dst-address=for_scripts_route/asnv4/AS204396.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204396.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204396 }
