...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204453 and dst-address=for_scripts_route/asnv4/AS204453.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204453.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204453 }
