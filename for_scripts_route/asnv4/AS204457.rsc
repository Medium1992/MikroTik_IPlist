...
:if ([:len [/ip/route/find dst-address=153.56.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204457 }
:if ([:len [/ip/route/find dst-address=153.56.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204457 }
