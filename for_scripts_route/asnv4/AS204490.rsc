...
:if ([:len [/ip/route/find dst-address=161.104.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.104.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204490 }
:if ([:len [/ip/route/find dst-address=161.104.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.104.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204490 }
