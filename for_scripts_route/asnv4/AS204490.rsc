...
:if ([:len [/ip/route/find dst-address=153.79.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.79.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204490 }
:if ([:len [/ip/route/find dst-address=153.79.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.79.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204490 }
:if ([:len [/ip/route/find dst-address=159.200.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.200.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204490 }
:if ([:len [/ip/route/find dst-address=161.104.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.104.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204490 }
