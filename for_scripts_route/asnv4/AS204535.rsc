...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.241.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.241.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204535 }
:if ([:len [/ip/route/find dst-address=143.20.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204535 }
...
:if ([:len [/ip/route/find dst-address=178.95.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.95.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204535 }
...
:if ([:len [/ip/route/find dst-address=74.1.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204535 }
...
:if ([:len [/ip/route/find dst-address=82.153.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.153.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204535 }
