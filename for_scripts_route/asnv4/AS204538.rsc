...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204538 and dst-address=for_scripts_route/asnv4/AS204538.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204538.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204538 }
