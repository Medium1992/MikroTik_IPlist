...
:if ([:len [/ip/route/find dst-address=81.12.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204544 }
...
:if ([:len [/ip/route/find dst-address=87.107.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204544 }
...
:if ([:len [/ip/route/find dst-address=95.128.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.128.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204544 }
