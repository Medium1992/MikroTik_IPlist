...
:if ([:len [/ip/route/find dst-address=153.80.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.80.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204610 }
:if ([:len [/ip/route/find dst-address=153.80.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.80.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204610 }
