...
:if ([:len [/ip/route/find dst-address=199.59.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.59.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204631 }
:if ([:len [/ip/route/find dst-address=199.59.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.59.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204631 }
