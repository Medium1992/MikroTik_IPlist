...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.239.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.239.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204650 }
...
:if ([:len [/ip/route/find dst-address=185.215.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.215.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204650 }
...
:if ([:len [/ip/route/find dst-address=37.32.40.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.32.40.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204650 }
