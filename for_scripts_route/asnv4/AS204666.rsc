...
:if ([:len [/ip/route/find dst-address=185.64.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.64.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204666 }
...
:if ([:len [/ip/route/find dst-address=85.255.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.255.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204666 }
:if ([:len [/ip/route/find dst-address=91.224.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.224.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204666 }
