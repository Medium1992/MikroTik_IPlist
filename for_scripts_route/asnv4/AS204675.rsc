...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204675 and dst-address=for_scripts_route/asnv4/AS204675.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204675.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204675 }
