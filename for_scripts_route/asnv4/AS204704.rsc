...
:if ([:len [/ip/route/find dst-address=45.139.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.139.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204704 }
...
:if ([:len [/ip/route/find dst-address=45.154.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.154.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204704 }
