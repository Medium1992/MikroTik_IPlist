...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204764 and dst-address=for_scripts_route/asnv4/AS204764.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204764.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204764 }
