...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=143.14.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.14.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204765 }
:if ([:len [/ip/route/find dst-address=153.51.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204765 }
