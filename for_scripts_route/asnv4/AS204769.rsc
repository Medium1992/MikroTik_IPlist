...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204769 and dst-address=for_scripts_route/asnv4/AS204769.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204769.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204769 }
