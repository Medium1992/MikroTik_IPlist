...
:if ([:len [/ip/route/find dst-address=143.20.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
:if ([:len [/ip/route/find dst-address=154.193.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.193.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
:if ([:len [/ip/route/find dst-address=154.88.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.88.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
:if ([:len [/ip/route/find dst-address=167.148.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
...
:if ([:len [/ip/route/find dst-address=198.59.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.59.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
:if ([:len [/ip/route/find dst-address=217.216.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.216.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
...
:if ([:len [/ip/route/find dst-address=84.32.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.32.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
...
:if ([:len [/ip/route/find dst-address=88.216.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
...
:if ([:len [/ip/route/find dst-address=88.216.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
...
:if ([:len [/ip/route/find dst-address=88.216.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
