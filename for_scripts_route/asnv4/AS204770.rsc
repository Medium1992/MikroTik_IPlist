...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS204770 and dst-address=for_scripts_route/asnv4/AS204770.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS204770.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204770 }
