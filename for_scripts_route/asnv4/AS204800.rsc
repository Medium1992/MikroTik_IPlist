...
:if ([:len [/ip/route/find dst-address=181.224.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.224.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204800 }
...
:if ([:len [/ip/route/find dst-address=216.67.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.67.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204800 }
...
:if ([:len [/ip/route/find dst-address=65.98.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.98.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204800 }
:if ([:len [/ip/route/find dst-address=65.98.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.98.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS204800 }
