...
:if ([:len [/ip/route/find dst-address=142.44.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.44.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205019 }
:if ([:len [/ip/route/find dst-address=142.44.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.44.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205019 }
