...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS205078 and dst-address=for_scripts_route/asnv4/AS205078.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS205078.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205078 }
