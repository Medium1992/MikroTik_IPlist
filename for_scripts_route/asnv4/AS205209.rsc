...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS205209 and dst-address=for_scripts_route/asnv4/AS205209.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS205209.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205209 }
