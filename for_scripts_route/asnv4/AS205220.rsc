...
:if ([:len [/ip/route/find dst-address=192.34.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.34.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
...
:if ([:len [/ip/route/find dst-address=192.5.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.5.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
...
:if ([:len [/ip/route/find dst-address=198.160.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.160.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
:if ([:len [/ip/route/find dst-address=198.41.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.41.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
...
:if ([:len [/ip/route/find dst-address=199.5.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.5.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
:if ([:len [/ip/route/find dst-address=199.67.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.67.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
...
:if ([:len [/ip/route/find dst-address=209.126.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.126.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
...
:if ([:len [/ip/route/find dst-address=216.98.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.98.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
...
:if ([:len [/ip/route/find dst-address=96.126.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.126.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205220 }
