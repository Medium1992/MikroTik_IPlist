...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS205332 and dst-address=for_scripts_route/asnv4/AS205332.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS205332.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205332 }
