...
:if ([:len [/ip/route/find dst-address=193.102.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.102.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=193.201.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.201.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=193.96.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.96.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
...
:if ([:len [/ip/route/find dst-address=194.77.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.77.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=194.77.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.77.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=194.77.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.77.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
...
:if ([:len [/ip/route/find dst-address=45.112.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.112.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
...
:if ([:len [/ip/route/find dst-address=80.90.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=80.90.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=80.90.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=80.90.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=80.90.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
:if ([:len [/ip/route/find dst-address=80.90.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
...
:if ([:len [/ip/route/find dst-address=80.90.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
