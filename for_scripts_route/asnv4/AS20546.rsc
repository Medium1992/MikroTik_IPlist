...
:if ([:len [/ip/route/find dst-address=46.235.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.235.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
...
:if ([:len [/ip/route/find dst-address=81.20.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.20.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20546 }
