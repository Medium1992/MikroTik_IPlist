...
:if ([:len [/ip/route/find dst-address=193.28.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.28.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205516 }
...
:if ([:len [/ip/route/find dst-address=45.145.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.145.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205516 }
...
:if ([:len [/ip/route/find dst-address=91.193.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.193.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205516 }
