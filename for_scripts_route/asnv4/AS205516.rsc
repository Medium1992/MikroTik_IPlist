...
:if ([:len [/ip/route/find dst-address=195.12.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.12.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205516 }
:if ([:len [/ip/route/find dst-address=195.12.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.12.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205516 }
