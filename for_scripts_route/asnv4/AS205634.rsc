...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=138.249.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.249.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205634 }
:if ([:len [/ip/route/find dst-address=144.124.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.124.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205634 }
...
:if ([:len [/ip/route/find dst-address=144.124.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.124.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205634 }
:if ([:len [/ip/route/find dst-address=144.124.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.124.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205634 }
...
:if ([:len [/ip/route/find dst-address=158.94.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.94.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205634 }
...
:if ([:len [/ip/route/find dst-address=82.27.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.27.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205634 }
