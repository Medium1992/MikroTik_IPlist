...
:if ([:len [/ip/route/find dst-address=213.177.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.177.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205775 }
:if ([:len [/ip/route/find dst-address=217.145.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.145.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205775 }
...
:if ([:len [/ip/route/find dst-address=77.91.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205775 }
