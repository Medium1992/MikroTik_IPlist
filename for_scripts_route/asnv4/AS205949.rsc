...
:if ([:len [/ip/route/find dst-address=143.20.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205949 }
...
:if ([:len [/ip/route/find dst-address=23.168.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.168.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205949 }
