...
:if ([:len [/ip/route/find dst-address=148.135.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.135.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205960 }
...
:if ([:len [/ip/route/find dst-address=167.148.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205960 }
:if ([:len [/ip/route/find dst-address=169.40.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.40.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS205960 }
