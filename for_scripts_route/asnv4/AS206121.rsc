...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS206121 and dst-address=for_scripts_route/asnv4/AS206121.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS206121.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206121 }
