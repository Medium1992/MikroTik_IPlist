...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS206173 and dst-address=for_scripts_route/asnv4/AS206173.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS206173.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206173 }
