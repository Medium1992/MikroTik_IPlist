...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=142.248.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.248.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206216 }
...
:if ([:len [/ip/route/find dst-address=170.205.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.205.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206216 }
:if ([:len [/ip/route/find dst-address=170.205.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.205.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206216 }
...
:if ([:len [/ip/route/find dst-address=207.241.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.241.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206216 }
