...
:if ([:len [/ip/route/find dst-address=192.165.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.165.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20626 }
...
:if ([:len [/ip/route/find dst-address=193.235.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.235.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20626 }
