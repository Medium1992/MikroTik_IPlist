...
:if ([:len [/ip/route/find dst-address=185.219.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.219.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206375 }
:if ([:len [/ip/route/find dst-address=185.219.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.219.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206375 }
...
:if ([:len [/ip/route/find dst-address=188.132.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.132.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206375 }
:if ([:len [/ip/route/find dst-address=188.132.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.132.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206375 }
