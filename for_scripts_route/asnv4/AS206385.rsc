...
:if ([:len [/ip/route/find dst-address=37.18.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.18.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206385 }
...
:if ([:len [/ip/route/find dst-address=37.230.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.230.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206385 }
