...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.241.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.241.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20645 }
...
:if ([:len [/ip/route/find dst-address=5.104.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.104.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20645 }
...
:if ([:len [/ip/route/find dst-address=95.142.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.142.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20645 }
