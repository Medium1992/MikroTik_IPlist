...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS206521 and dst-address=for_scripts_route/asnv4/AS206521.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS206521.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206521 }
