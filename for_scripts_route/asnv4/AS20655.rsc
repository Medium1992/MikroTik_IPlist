...
:if ([:len [/ip/route/find dst-address=185.88.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.88.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20655 }
:if ([:len [/ip/route/find dst-address=185.88.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.88.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20655 }
...
:if ([:len [/ip/route/find dst-address=45.10.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.10.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20655 }
:if ([:len [/ip/route/find dst-address=45.132.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.132.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20655 }
