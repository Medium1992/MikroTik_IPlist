...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS206565 and dst-address=for_scripts_route/asnv4/AS206565.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS206565.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206565 }
