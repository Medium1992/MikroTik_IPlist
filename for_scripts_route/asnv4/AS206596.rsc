...
:if ([:len [/ip/route/find dst-address=158.58.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.58.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206596 }
...
:if ([:len [/ip/route/find dst-address=45.135.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.135.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206596 }
:if ([:len [/ip/route/find dst-address=91.231.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.231.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206596 }
