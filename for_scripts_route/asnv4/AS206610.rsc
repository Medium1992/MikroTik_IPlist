...
:if ([:len [/ip/route/find dst-address=78.111.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.111.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206610 }
:if ([:len [/ip/route/find dst-address=78.111.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.111.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206610 }
:if ([:len [/ip/route/find dst-address=78.111.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.111.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206610 }
