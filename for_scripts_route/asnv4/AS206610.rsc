...
:if ([:len [/ip/route/find dst-address=46.29.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.29.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206610 }
:if ([:len [/ip/route/find dst-address=46.29.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.29.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206610 }
:if ([:len [/ip/route/find dst-address=46.29.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.29.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206610 }
