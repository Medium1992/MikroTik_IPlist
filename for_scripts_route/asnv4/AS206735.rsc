...
:if ([:len [/ip/route/find dst-address=154.57.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.57.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206735 }
:if ([:len [/ip/route/find dst-address=154.57.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.57.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206735 }
:if ([:len [/ip/route/find dst-address=154.57.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.57.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206735 }
