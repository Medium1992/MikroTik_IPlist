...
:if ([:len [/ip/route/find dst-address=151.243.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.243.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206766 }
:if ([:len [/ip/route/find dst-address=169.40.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.40.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206766 }
