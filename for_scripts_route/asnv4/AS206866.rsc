...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.34.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.34.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206866 }
:if ([:len [/ip/route/find dst-address=157.97.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.97.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206866 }
