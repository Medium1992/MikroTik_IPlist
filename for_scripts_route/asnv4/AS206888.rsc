...
:if ([:len [/ip/route/find dst-address=121.54.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=121.54.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206888 }
...
:if ([:len [/ip/route/find dst-address=69.165.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.165.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206888 }
