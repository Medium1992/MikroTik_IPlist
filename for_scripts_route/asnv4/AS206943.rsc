...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.159.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.159.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206943 }
:if ([:len [/ip/route/find dst-address=178.159.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.159.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206943 }
