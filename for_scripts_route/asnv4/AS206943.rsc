...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.159.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.159.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206943 }
:if ([:len [/ip/route/find dst-address=178.159.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.159.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206943 }
:if ([:len [/ip/route/find dst-address=178.218.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.218.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206943 }
...
:if ([:len [/ip/route/find dst-address=31.42.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.42.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS206943 }
