...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=156.255.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.255.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
...
:if ([:len [/ip/route/find dst-address=185.168.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.168.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
