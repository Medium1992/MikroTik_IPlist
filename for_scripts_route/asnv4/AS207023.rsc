...
:if ([:len [/ip/route/find dst-address=185.151.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.151.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
...
:if ([:len [/ip/route/find dst-address=185.197.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.197.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
:if ([:len [/ip/route/find dst-address=185.197.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.197.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
...
:if ([:len [/ip/route/find dst-address=194.31.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.31.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
:if ([:len [/ip/route/find dst-address=194.31.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.31.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
...
:if ([:len [/ip/route/find dst-address=2.57.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.57.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
...
:if ([:len [/ip/route/find dst-address=46.173.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.173.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
:if ([:len [/ip/route/find dst-address=46.173.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.173.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
:if ([:len [/ip/route/find dst-address=46.173.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.173.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
...
:if ([:len [/ip/route/find dst-address=91.246.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.246.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
:if ([:len [/ip/route/find dst-address=94.232.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.232.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207023 }
