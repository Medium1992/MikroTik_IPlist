...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207033 and dst-address=for_scripts_route/asnv4/AS207033.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207033.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207033 }
