...
:if ([:len [/ip/route/find dst-address=194.146.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.146.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207046 }
:if ([:len [/ip/route/find dst-address=194.146.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.146.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207046 }
:if ([:len [/ip/route/find dst-address=80.71.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.71.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207046 }
