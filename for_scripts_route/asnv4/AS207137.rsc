...
:if ([:len [/ip/route/find dst-address=194.110.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.110.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207137 }
...
:if ([:len [/ip/route/find dst-address=217.216.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.216.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207137 }
