...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20714 and dst-address=for_scripts_route/asnv4/AS20714.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20714.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20714 }
