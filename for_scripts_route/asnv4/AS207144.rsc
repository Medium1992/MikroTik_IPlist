...
:if ([:len [/ip/route/find dst-address=85.11.169.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.11.169.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207144 }
:if ([:len [/ip/route/find dst-address=85.11.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.11.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207144 }
:if ([:len [/ip/route/find dst-address=85.11.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.11.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207144 }
