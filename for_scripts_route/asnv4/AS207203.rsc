...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207203 and dst-address=for_scripts_route/asnv4/AS207203.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207203.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207203 }
