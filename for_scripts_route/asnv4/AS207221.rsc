...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207221 and dst-address=for_scripts_route/asnv4/AS207221.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207221.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207221 }
