...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207246 and dst-address=for_scripts_route/asnv4/AS207246.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207246.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207246 }
