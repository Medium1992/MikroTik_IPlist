...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.238.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.238.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207359 }
...
:if ([:len [/ip/route/find dst-address=167.17.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.17.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207359 }
...
:if ([:len [/ip/route/find dst-address=179.254.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.254.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207359 }
...
:if ([:len [/ip/route/find dst-address=194.58.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.58.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207359 }
:if ([:len [/ip/route/find dst-address=206.245.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.245.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207359 }
