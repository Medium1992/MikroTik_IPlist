...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.104.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.104.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20738 }
...
:if ([:len [/ip/route/find dst-address=91.109.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.109.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20738 }
