...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=144.31.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207416 }
:if ([:len [/ip/route/find dst-address=144.31.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207416 }
...
:if ([:len [/ip/route/find dst-address=64.188.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.188.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207416 }
