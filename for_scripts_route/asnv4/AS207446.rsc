...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207446 and dst-address=for_scripts_route/asnv4/AS207446.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207446.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207446 }
