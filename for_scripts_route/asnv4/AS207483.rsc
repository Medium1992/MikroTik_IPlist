...
:if ([:len [/ip/route/find dst-address=87.76.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.76.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207483 }
:if ([:len [/ip/route/find dst-address=87.76.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.76.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207483 }
:if ([:len [/ip/route/find dst-address=87.76.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.76.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207483 }
