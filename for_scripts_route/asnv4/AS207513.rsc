...
:if ([:len [/ip/route/find dst-address=13.143.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.143.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
:if ([:len [/ip/route/find dst-address=13.143.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.143.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
:if ([:len [/ip/route/find dst-address=139.28.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.28.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
...
:if ([:len [/ip/route/find dst-address=144.31.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
:if ([:len [/ip/route/find dst-address=144.31.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
...
:if ([:len [/ip/route/find dst-address=153.76.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.76.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
:if ([:len [/ip/route/find dst-address=177.1.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.1.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
...
:if ([:len [/ip/route/find dst-address=2.27.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.27.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
...
:if ([:len [/ip/route/find dst-address=89.125.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.125.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207513 }
