...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207561 and dst-address=for_scripts_route/asnv4/AS207561.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207561.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207561 }
