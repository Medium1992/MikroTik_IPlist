...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207594 and dst-address=for_scripts_route/asnv4/AS207594.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207594.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207594 }
