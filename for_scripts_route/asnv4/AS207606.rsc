...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207606 and dst-address=for_scripts_route/asnv4/AS207606.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207606.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207606 }
