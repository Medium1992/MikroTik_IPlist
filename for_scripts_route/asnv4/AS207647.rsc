...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207647 and dst-address=for_scripts_route/asnv4/AS207647.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207647.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207647 }
