...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=130.49.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.49.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207713 }
...
:if ([:len [/ip/route/find dst-address=157.22.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.22.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207713 }
:if ([:len [/ip/route/find dst-address=185.76.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.76.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207713 }
:if ([:len [/ip/route/find dst-address=185.76.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.76.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207713 }
...
:if ([:len [/ip/route/find dst-address=94.103.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.103.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207713 }
