...
:if ([:len [/ip/route/find dst-address=138.226.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.226.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
