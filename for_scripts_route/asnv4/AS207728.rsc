...
:if ([:len [/ip/route/find dst-address=138.226.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.226.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
...
:if ([:len [/ip/route/find dst-address=62.171.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.171.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
...
:if ([:len [/ip/route/find dst-address=85.136.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.136.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
