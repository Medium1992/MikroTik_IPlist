...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.65.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.65.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
...
:if ([:len [/ip/route/find dst-address=138.226.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.226.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
:if ([:len [/ip/route/find dst-address=138.226.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.226.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
...
:if ([:len [/ip/route/find dst-address=185.204.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.204.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
...
:if ([:len [/ip/route/find dst-address=62.171.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.171.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
:if ([:len [/ip/route/find dst-address=62.171.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.171.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
...
:if ([:len [/ip/route/find dst-address=85.136.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.136.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
:if ([:len [/ip/route/find dst-address=85.136.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.136.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
:if ([:len [/ip/route/find dst-address=85.136.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.136.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
...
:if ([:len [/ip/route/find dst-address=95.141.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.141.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207728 }
