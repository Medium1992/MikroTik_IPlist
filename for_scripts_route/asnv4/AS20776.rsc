...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20776 and dst-address=for_scripts_route/asnv4/AS20776.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20776.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20776 }
