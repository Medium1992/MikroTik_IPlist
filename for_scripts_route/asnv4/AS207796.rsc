...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207796 and dst-address=for_scripts_route/asnv4/AS207796.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207796.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207796 }
