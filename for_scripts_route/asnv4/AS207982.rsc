...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207982 and dst-address=for_scripts_route/asnv4/AS207982.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207982.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207982 }
