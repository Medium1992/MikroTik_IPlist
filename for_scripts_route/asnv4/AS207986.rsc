...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS207986 and dst-address=for_scripts_route/asnv4/AS207986.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS207986.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS207986 }
