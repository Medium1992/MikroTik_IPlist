...
:if ([:len [/ip/route/find dst-address=59.152.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.152.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
...
:if ([:len [/ip/route/find dst-address=94.154.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.154.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
...
:if ([:len [/ip/route/find dst-address=94.183.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.183.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
:if ([:len [/ip/route/find dst-address=94.183.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.183.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
:if ([:len [/ip/route/find dst-address=94.183.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.183.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
...
:if ([:len [/ip/route/find dst-address=94.183.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.183.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
