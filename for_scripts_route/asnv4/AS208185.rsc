...
:if ([:len [/ip/route/find dst-address=175.110.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.110.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
...
:if ([:len [/ip/route/find dst-address=175.110.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.110.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
...
:if ([:len [/ip/route/find dst-address=45.221.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.221.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
:if ([:len [/ip/route/find dst-address=45.74.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.74.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208185 }
