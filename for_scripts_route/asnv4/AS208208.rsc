...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.230.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.230.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208208 }
...
:if ([:len [/ip/route/find dst-address=77.90.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.90.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208208 }
