...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.176.91.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.176.91.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208226 }
...
:if ([:len [/ip/route/find dst-address=194.59.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.59.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208226 }
...
:if ([:len [/ip/route/find dst-address=64.204.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.204.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208226 }
:if ([:len [/ip/route/find dst-address=82.41.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.41.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208226 }
