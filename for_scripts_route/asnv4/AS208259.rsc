...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=16.5.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=16.5.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208259 }
:if ([:len [/ip/route/find dst-address=16.5.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=16.5.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208259 }
...
:if ([:len [/ip/route/find dst-address=74.1.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208259 }
