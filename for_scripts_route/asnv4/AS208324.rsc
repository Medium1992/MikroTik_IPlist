...
:if ([:len [/ip/route/find dst-address=176.105.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.105.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208324 }
:if ([:len [/ip/route/find dst-address=176.105.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.105.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208324 }
...
:if ([:len [/ip/route/find dst-address=85.31.41.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.31.41.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208324 }
