...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=136.148.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.148.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208328 }
:if ([:len [/ip/route/find dst-address=150.251.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.251.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208328 }
