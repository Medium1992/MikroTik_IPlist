...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS208328 and dst-address=for_scripts_route/asnv4/AS208328.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS208328.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208328 }
