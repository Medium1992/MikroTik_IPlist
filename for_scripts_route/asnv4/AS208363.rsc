...
:if ([:len [/ip/route/find dst-address=2.152.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.152.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208363 }
...
:if ([:len [/ip/route/find dst-address=89.37.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.37.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208363 }
