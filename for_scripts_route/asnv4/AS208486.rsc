...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS208486 and dst-address=for_scripts_route/asnv4/AS208486.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS208486.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208486 }
