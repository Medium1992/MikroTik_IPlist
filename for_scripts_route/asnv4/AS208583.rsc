...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS208583 and dst-address=for_scripts_route/asnv4/AS208583.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS208583.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208583 }
