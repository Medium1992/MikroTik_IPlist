...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20880 and dst-address=for_scripts_route/asnv4/AS20880.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20880.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20880 }
