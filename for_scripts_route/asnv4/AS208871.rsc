...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS208871 and dst-address=for_scripts_route/asnv4/AS208871.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS208871.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208871 }
