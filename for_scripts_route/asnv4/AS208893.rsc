...
:if ([:len [/ip/route/find dst-address=194.238.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.238.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208893 }
:if ([:len [/ip/route/find dst-address=46.255.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.255.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208893 }
:if ([:len [/ip/route/find dst-address=91.92.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.92.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208893 }
...
:if ([:len [/ip/route/find dst-address=94.156.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.156.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208893 }
