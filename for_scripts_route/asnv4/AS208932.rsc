...
:if ([:len [/ip/route/find dst-address=103.127.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.127.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208932 }
...
:if ([:len [/ip/route/find dst-address=203.91.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.91.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208932 }
