...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS208933 and dst-address=for_scripts_route/asnv4/AS208933.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS208933.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208933 }
