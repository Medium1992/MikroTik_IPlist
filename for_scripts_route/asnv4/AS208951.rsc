...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.207.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.207.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208951 }
...
:if ([:len [/ip/route/find dst-address=45.159.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.159.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208951 }
:if ([:len [/ip/route/find dst-address=45.159.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.159.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208951 }
...
:if ([:len [/ip/route/find dst-address=94.141.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.141.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208951 }
