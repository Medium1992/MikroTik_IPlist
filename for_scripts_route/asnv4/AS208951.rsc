...
:if ([:len [/ip/route/find dst-address=109.207.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.207.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208951 }
:if ([:len [/ip/route/find dst-address=109.207.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.207.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS208951 }
