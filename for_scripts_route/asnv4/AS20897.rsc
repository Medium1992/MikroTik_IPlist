...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20897 and dst-address=for_scripts_route/asnv4/AS20897.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20897.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20897 }
