...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209055 and dst-address=for_scripts_route/asnv4/AS209055.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209055.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209055 }
