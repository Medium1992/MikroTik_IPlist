...
:if ([:len [/ip/route/find dst-address=189.13.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.13.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209104 }
:if ([:len [/ip/route/find dst-address=189.13.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.13.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209104 }
