...
:if ([:len [/ip/route/find dst-address=217.25.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.25.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20915 }
...
:if ([:len [/ip/route/find dst-address=87.254.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.254.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20915 }
:if ([:len [/ip/route/find dst-address=87.254.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.254.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20915 }
:if ([:len [/ip/route/find dst-address=87.254.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.254.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20915 }
...
:if ([:len [/ip/route/find dst-address=87.254.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.254.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20915 }
