...
:if ([:len [/ip/route/find dst-address=199.177.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.177.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209155 }
...
:if ([:len [/ip/route/find dst-address=91.211.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.211.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209155 }
