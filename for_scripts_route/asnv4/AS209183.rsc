...
:if ([:len [/ip/route/find dst-address=72.56.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
:if ([:len [/ip/route/find dst-address=72.56.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
...
:if ([:len [/ip/route/find dst-address=72.56.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
...
:if ([:len [/ip/route/find dst-address=72.56.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
...
:if ([:len [/ip/route/find dst-address=72.56.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
