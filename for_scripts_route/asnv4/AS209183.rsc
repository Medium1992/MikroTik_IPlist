...
:if ([:len [/ip/route/find dst-address=193.233.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
...
:if ([:len [/ip/route/find dst-address=72.56.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
:if ([:len [/ip/route/find dst-address=72.56.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
:if ([:len [/ip/route/find dst-address=72.56.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
:if ([:len [/ip/route/find dst-address=72.56.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
:if ([:len [/ip/route/find dst-address=72.56.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
:if ([:len [/ip/route/find dst-address=72.56.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
...
:if ([:len [/ip/route/find dst-address=72.56.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209183 }
