...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.147.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.147.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
:if ([:len [/ip/route/find dst-address=185.147.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.147.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
...
:if ([:len [/ip/route/find dst-address=195.69.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.69.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
...
:if ([:len [/ip/route/find dst-address=5.231.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
