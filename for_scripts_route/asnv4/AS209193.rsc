...
:if ([:len [/ip/route/find dst-address=185.216.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.216.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
...
:if ([:len [/ip/route/find dst-address=5.175.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
:if ([:len [/ip/route/find dst-address=5.231.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209193 }
