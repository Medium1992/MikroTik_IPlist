...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209243 and dst-address=for_scripts_route/asnv4/AS209243.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209243.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209243 }
