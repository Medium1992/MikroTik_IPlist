...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209263 and dst-address=for_scripts_route/asnv4/AS209263.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209263.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209263 }
