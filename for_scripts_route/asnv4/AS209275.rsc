...
:if ([:len [/ip/route/find dst-address=213.238.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.238.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209275 }
:if ([:len [/ip/route/find dst-address=88.214.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.214.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209275 }
