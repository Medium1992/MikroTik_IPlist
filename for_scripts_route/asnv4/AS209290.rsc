...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209290 and dst-address=for_scripts_route/asnv4/AS209290.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209290.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209290 }
