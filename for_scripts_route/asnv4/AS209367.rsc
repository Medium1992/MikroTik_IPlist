...
:if ([:len [/ip/route/find dst-address=193.232.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.232.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209367 }
...
:if ([:len [/ip/route/find dst-address=194.190.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.190.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209367 }
...
:if ([:len [/ip/route/find dst-address=62.76.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.76.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209367 }
