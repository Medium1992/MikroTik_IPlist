...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20938 and dst-address=for_scripts_route/asnv4/AS20938.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20938.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20938 }
