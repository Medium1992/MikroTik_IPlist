...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209406 and dst-address=for_scripts_route/asnv4/AS209406.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209406.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209406 }
