...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209482 and dst-address=for_scripts_route/asnv4/AS209482.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209482.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209482 }
