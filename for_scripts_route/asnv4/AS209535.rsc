...
:if ([:len [/ip/route/find dst-address=212.163.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.163.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209535 }
:if ([:len [/ip/route/find dst-address=212.163.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.163.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209535 }
