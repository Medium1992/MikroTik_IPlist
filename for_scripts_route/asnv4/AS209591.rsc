...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209591 and dst-address=for_scripts_route/asnv4/AS209591.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209591.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209591 }
