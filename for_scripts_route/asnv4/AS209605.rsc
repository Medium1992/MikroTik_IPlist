...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=141.98.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.98.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209605 }
:if ([:len [/ip/route/find dst-address=141.98.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.98.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209605 }
