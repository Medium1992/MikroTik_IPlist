...
:if ([:len [/ip/route/find dst-address=185.218.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.218.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209630 }
:if ([:len [/ip/route/find dst-address=31.57.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209630 }
