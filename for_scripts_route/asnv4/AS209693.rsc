...
:if ([:len [/ip/route/find dst-address=64.188.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.188.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
:if ([:len [/ip/route/find dst-address=64.188.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.188.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
...
:if ([:len [/ip/route/find dst-address=95.85.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
:if ([:len [/ip/route/find dst-address=95.85.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
