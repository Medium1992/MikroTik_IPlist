...
:if ([:len [/ip/route/find dst-address=2.26.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
:if ([:len [/ip/route/find dst-address=31.76.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.76.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
...
:if ([:len [/ip/route/find dst-address=95.85.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
:if ([:len [/ip/route/find dst-address=95.85.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
:if ([:len [/ip/route/find dst-address=95.85.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
:if ([:len [/ip/route/find dst-address=95.85.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209693 }
