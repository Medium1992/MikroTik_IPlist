...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209699 and dst-address=for_scripts_route/asnv4/AS209699.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209699.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209699 }
