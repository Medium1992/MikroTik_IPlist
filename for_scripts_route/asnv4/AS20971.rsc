...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20971 and dst-address=for_scripts_route/asnv4/AS20971.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20971.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20971 }
