...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS20972 and dst-address=for_scripts_route/asnv4/AS20972.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS20972.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS20972 }
