...
:if ([:len [/ip/route/find dst-address=185.254.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.254.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209737 }
...
:if ([:len [/ip/route/find dst-address=45.74.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.74.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209737 }
:if ([:len [/ip/route/find dst-address=45.74.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.74.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209737 }
...
:if ([:len [/ip/route/find dst-address=66.228.86.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.228.86.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209737 }
...
:if ([:len [/ip/route/find dst-address=85.235.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.235.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209737 }
