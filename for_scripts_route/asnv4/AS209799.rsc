...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209799 and dst-address=for_scripts_route/asnv4/AS209799.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209799.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209799 }
