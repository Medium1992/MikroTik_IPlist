...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209801 and dst-address=for_scripts_route/asnv4/AS209801.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209801.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209801 }
