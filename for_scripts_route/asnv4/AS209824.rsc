...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209824 and dst-address=for_scripts_route/asnv4/AS209824.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209824.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209824 }
