...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209835 and dst-address=for_scripts_route/asnv4/AS209835.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209835.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209835 }
