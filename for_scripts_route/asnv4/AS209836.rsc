...
:if ([:len [/ip/route/find dst-address=194.225.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.225.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209836 }
:if ([:len [/ip/route/find dst-address=194.225.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.225.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209836 }
:if ([:len [/ip/route/find dst-address=194.225.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.225.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209836 }
...
:if ([:len [/ip/route/find dst-address=77.104.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.104.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209836 }
