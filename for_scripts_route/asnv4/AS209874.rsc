...
:if ([:len [/ip/route/find dst-address=217.69.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.69.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=5.230.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.230.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=5.231.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
:if ([:len [/ip/route/find dst-address=5.231.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=89.106.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.106.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
:if ([:len [/ip/route/find dst-address=89.144.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=94.249.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.249.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=94.249.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.249.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=94.249.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.249.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
:if ([:len [/ip/route/find dst-address=95.215.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.215.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
