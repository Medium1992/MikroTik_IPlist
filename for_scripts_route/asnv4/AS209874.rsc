...
:if ([:len [/ip/route/find dst-address=5.230.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.230.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=5.231.246.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.246.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=85.118.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.118.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
:if ([:len [/ip/route/find dst-address=85.118.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.118.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
:if ([:len [/ip/route/find dst-address=85.93.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.93.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=94.249.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.249.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
