...
:if ([:len [/ip/route/find dst-address=5.231.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=5.231.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=87.239.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.239.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=89.106.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.106.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
