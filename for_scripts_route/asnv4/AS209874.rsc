...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.18.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.18.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=94.103.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.103.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
...
:if ([:len [/ip/route/find dst-address=95.215.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.215.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209874 }
