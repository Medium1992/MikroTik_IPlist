...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS209910 and dst-address=for_scripts_route/asnv4/AS209910.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS209910.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209910 }
