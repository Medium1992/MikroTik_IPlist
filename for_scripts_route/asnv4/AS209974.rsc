...
:if ([:len [/ip/route/find dst-address=188.227.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.227.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209974 }
:if ([:len [/ip/route/find dst-address=188.227.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.227.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209974 }
