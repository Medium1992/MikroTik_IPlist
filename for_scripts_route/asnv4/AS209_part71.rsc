...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=97.125.9.44/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.125.9.44/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209 }
:if ([:len [/ip/route/find dst-address=97.125.9.46/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.125.9.46/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209 }
:if ([:len [/ip/route/find dst-address=97.125.9.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.125.9.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209 }
:if ([:len [/ip/route/find dst-address=97.125.9.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.125.9.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209 }
...
:if ([:len [/ip/route/find dst-address=97.127.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.127.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS209 }
