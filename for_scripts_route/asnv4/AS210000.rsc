...
:if ([:len [/ip/route/find dst-address=163.61.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.61.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210000 }
:if ([:len [/ip/route/find dst-address=177.177.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.177.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210000 }
...
:if ([:len [/ip/route/find dst-address=72.22.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.22.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210000 }
