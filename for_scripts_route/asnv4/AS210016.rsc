...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210016 and dst-address=for_scripts_route/asnv4/AS210016.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210016.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210016 }
