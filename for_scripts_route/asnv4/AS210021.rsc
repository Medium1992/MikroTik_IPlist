...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.100.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.100.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210021 }
...
:if ([:len [/ip/route/find dst-address=185.253.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.253.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210021 }
...
:if ([:len [/ip/route/find dst-address=194.127.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.127.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210021 }
...
:if ([:len [/ip/route/find dst-address=86.105.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.105.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210021 }
