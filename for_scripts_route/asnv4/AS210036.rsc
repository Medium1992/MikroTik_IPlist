...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210036 and dst-address=for_scripts_route/asnv4/AS210036.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210036.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210036 }
