...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210109 and dst-address=for_scripts_route/asnv4/AS210109.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210109.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210109 }
