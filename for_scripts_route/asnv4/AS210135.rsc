...
:if ([:len [/ip/route/find dst-address=45.89.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.89.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210135 }
:if ([:len [/ip/route/find dst-address=46.174.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.174.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210135 }
