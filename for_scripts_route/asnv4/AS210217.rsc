...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210217 and dst-address=for_scripts_route/asnv4/AS210217.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210217.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210217 }
