...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210240 and dst-address=for_scripts_route/asnv4/AS210240.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210240.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210240 }
