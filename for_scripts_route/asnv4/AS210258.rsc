...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210258 and dst-address=for_scripts_route/asnv4/AS210258.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210258.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210258 }
