...
:if ([:len [/ip/route/find dst-address=216.162.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.162.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21030 }
:if ([:len [/ip/route/find dst-address=217.119.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.119.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21030 }
:if ([:len [/ip/route/find dst-address=62.204.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.204.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21030 }
