...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210346 and dst-address=for_scripts_route/asnv4/AS210346.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210346.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210346 }
