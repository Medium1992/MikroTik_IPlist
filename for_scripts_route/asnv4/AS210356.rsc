...
:if ([:len [/ip/route/find dst-address=144.225.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210356 }
:if ([:len [/ip/route/find dst-address=167.148.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210356 }
...
:if ([:len [/ip/route/find dst-address=188.220.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.220.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210356 }
