...
:if ([:len [/ip/route/find dst-address=185.212.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.212.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210392 }
:if ([:len [/ip/route/find dst-address=185.33.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.33.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210392 }
:if ([:len [/ip/route/find dst-address=88.135.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.135.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210392 }
