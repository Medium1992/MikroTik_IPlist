...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210422 and dst-address=for_scripts_route/asnv4/AS210422.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210422.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210422 }
