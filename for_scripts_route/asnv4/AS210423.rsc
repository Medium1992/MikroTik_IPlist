...
:if ([:len [/ip/route/find dst-address=84.236.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210423 }
...
:if ([:len [/ip/route/find dst-address=88.148.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.148.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210423 }
...
:if ([:len [/ip/route/find dst-address=94.24.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.24.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210423 }
