...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210512 and dst-address=for_scripts_route/asnv4/AS210512.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210512.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210512 }
