...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210537 and dst-address=for_scripts_route/asnv4/AS210537.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210537.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210537 }
