...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210550 and dst-address=for_scripts_route/asnv4/AS210550.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210550.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210550 }
