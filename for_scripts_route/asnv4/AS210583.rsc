...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210583 and dst-address=for_scripts_route/asnv4/AS210583.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210583.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210583 }
