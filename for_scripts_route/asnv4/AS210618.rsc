...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210618 and dst-address=for_scripts_route/asnv4/AS210618.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210618.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210618 }
