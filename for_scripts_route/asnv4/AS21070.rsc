...
:if ([:len [/ip/route/find dst-address=141.227.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.227.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21070 }
...
:if ([:len [/ip/route/find dst-address=141.227.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.227.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21070 }
:if ([:len [/ip/route/find dst-address=146.249.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=146.249.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21070 }
