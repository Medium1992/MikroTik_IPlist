...
:if ([:len [/ip/route/find dst-address=111.88.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.88.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210734 }
:if ([:len [/ip/route/find dst-address=153.56.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210734 }
:if ([:len [/ip/route/find dst-address=185.73.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.73.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210734 }
...
:if ([:len [/ip/route/find dst-address=193.106.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.106.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210734 }
...
:if ([:len [/ip/route/find dst-address=2.26.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210734 }
...
:if ([:len [/ip/route/find dst-address=78.17.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210734 }
