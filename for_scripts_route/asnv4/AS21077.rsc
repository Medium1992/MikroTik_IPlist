...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21077 and dst-address=for_scripts_route/asnv4/AS21077.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21077.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21077 }
