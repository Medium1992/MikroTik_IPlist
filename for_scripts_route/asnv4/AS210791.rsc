...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210791 and dst-address=for_scripts_route/asnv4/AS210791.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210791.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210791 }
