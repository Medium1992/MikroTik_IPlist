...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210805 and dst-address=for_scripts_route/asnv4/AS210805.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210805.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210805 }
