...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210832 and dst-address=for_scripts_route/asnv4/AS210832.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210832.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210832 }
