...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=160.119.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.119.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210848 }
...
:if ([:len [/ip/route/find dst-address=45.80.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.80.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210848 }
:if ([:len [/ip/route/find dst-address=45.95.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.95.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210848 }
