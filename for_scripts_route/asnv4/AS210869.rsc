...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210869 and dst-address=for_scripts_route/asnv4/AS210869.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210869.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210869 }
