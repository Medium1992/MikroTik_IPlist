...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21087 and dst-address=for_scripts_route/asnv4/AS21087.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21087.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21087 }
