...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=145.63.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.63.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210895 }
:if ([:len [/ip/route/find dst-address=185.203.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.203.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210895 }
...
:if ([:len [/ip/route/find dst-address=212.162.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.162.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210895 }
:if ([:len [/ip/route/find dst-address=213.134.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.134.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210895 }
