...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS210911 and dst-address=for_scripts_route/asnv4/AS210911.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS210911.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS210911 }
