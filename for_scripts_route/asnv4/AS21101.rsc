...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21101 and dst-address=for_scripts_route/asnv4/AS21101.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21101.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21101 }
