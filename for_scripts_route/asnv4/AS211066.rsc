...
:if ([:len [/ip/route/find dst-address=5.175.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211066 }
...
:if ([:len [/ip/route/find dst-address=89.106.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.106.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211066 }
