...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS211130 and dst-address=for_scripts_route/asnv4/AS211130.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS211130.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211130 }
