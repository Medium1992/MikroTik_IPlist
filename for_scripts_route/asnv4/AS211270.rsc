...
:if ([:len [/ip/route/find dst-address=187.13.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.13.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211270 }
:if ([:len [/ip/route/find dst-address=189.74.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.74.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211270 }
