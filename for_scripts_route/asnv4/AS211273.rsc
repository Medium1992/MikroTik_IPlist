...
:if ([:len [/ip/route/find dst-address=104.252.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.252.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211273 }
...
:if ([:len [/ip/route/find dst-address=104.253.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.253.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211273 }
...
:if ([:len [/ip/route/find dst-address=45.39.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.39.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211273 }
...
:if ([:len [/ip/route/find dst-address=45.39.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.39.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211273 }
:if ([:len [/ip/route/find dst-address=45.39.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.39.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211273 }
:if ([:len [/ip/route/find dst-address=45.39.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.39.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211273 }
