...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS211391 and dst-address=for_scripts_route/asnv4/AS211391.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS211391.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211391 }
