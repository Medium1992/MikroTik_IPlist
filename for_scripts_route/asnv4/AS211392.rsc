...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.84.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211392 }
...
:if ([:len [/ip/route/find dst-address=203.168.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.168.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211392 }
:if ([:len [/ip/route/find dst-address=222.167.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=222.167.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211392 }
