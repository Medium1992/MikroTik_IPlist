...
:if ([:len [/ip/route/find dst-address=93.152.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.152.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211443 }
...
:if ([:len [/ip/route/find dst-address=94.26.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211443 }
:if ([:len [/ip/route/find dst-address=94.26.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211443 }
