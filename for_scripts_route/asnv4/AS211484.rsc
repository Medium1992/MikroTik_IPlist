...
:if ([:len [/ip/route/find dst-address=149.18.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.18.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211484 }
:if ([:len [/ip/route/find dst-address=149.57.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.57.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211484 }
...
:if ([:len [/ip/route/find dst-address=151.246.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.246.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211484 }
:if ([:len [/ip/route/find dst-address=154.6.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.6.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211484 }
...
:if ([:len [/ip/route/find dst-address=192.208.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.208.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211484 }
...
:if ([:len [/ip/route/find dst-address=31.56.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.56.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211484 }
:if ([:len [/ip/route/find dst-address=31.57.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211484 }
