...
:if ([:len [/ip/route/find dst-address=217.60.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211507 }
:if ([:len [/ip/route/find dst-address=31.59.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.59.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211507 }
...
:if ([:len [/ip/route/find dst-address=85.8.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.8.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211507 }
