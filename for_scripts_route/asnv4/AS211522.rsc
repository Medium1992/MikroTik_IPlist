...
:if ([:len [/ip/route/find dst-address=185.17.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.17.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211522 }
...
:if ([:len [/ip/route/find dst-address=77.91.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211522 }
:if ([:len [/ip/route/find dst-address=77.91.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211522 }
:if ([:len [/ip/route/find dst-address=77.91.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211522 }
