...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS211593 and dst-address=for_scripts_route/asnv4/AS211593.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS211593.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211593 }
