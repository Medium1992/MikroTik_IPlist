...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS211612 and dst-address=for_scripts_route/asnv4/AS211612.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS211612.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211612 }
