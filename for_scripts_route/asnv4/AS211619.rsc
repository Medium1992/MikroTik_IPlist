...
:if ([:len [/ip/route/find dst-address=150.40.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.40.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211619 }
:if ([:len [/ip/route/find dst-address=150.40.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.40.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211619 }
:if ([:len [/ip/route/find dst-address=150.40.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.40.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211619 }
...
:if ([:len [/ip/route/find dst-address=150.40.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.40.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211619 }
:if ([:len [/ip/route/find dst-address=150.40.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.40.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211619 }
...
:if ([:len [/ip/route/find dst-address=5.175.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211619 }
