...
:if ([:len [/ip/route/find dst-address=85.137.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.137.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211757 }
:if ([:len [/ip/route/find dst-address=85.137.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.137.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211757 }
:if ([:len [/ip/route/find dst-address=85.137.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.137.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211757 }
