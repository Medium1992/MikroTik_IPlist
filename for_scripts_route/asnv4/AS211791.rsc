...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS211791 and dst-address=for_scripts_route/asnv4/AS211791.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS211791.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211791 }
