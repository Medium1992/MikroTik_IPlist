...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS211827 and dst-address=for_scripts_route/asnv4/AS211827.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS211827.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211827 }
