...
:if ([:len [/ip/route/find dst-address=191.44.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.44.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211895 }
...
:if ([:len [/ip/route/find dst-address=94.247.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.247.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211895 }
