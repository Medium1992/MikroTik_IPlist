...
:if ([:len [/ip/route/find dst-address=204.157.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.157.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211908 }
...
:if ([:len [/ip/route/find dst-address=93.180.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.180.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211908 }
