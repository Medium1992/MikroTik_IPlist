...
:if ([:len [/ip/route/find dst-address=83.69.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.69.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21191 }
:if ([:len [/ip/route/find dst-address=83.69.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.69.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21191 }
:if ([:len [/ip/route/find dst-address=83.69.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.69.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21191 }
:if ([:len [/ip/route/find dst-address=83.69.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.69.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21191 }
:if ([:len [/ip/route/find dst-address=83.69.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.69.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21191 }
:if ([:len [/ip/route/find dst-address=83.69.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.69.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21191 }
