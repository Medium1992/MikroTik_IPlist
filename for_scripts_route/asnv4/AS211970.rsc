...
:if ([:len [/ip/route/find dst-address=188.72.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.72.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211970 }
...
:if ([:len [/ip/route/find dst-address=188.72.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.72.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211970 }
