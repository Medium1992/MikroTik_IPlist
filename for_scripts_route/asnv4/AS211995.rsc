...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.237.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.237.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211995 }
:if ([:len [/ip/route/find dst-address=109.237.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.237.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211995 }
:if ([:len [/ip/route/find dst-address=109.237.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.237.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211995 }
:if ([:len [/ip/route/find dst-address=109.237.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.237.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211995 }
:if ([:len [/ip/route/find dst-address=109.237.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.237.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS211995 }
