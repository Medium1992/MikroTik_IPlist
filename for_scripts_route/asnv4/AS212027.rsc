...
:if ([:len [/ip/route/find dst-address=212.80.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.80.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212027 }
...
:if ([:len [/ip/route/find dst-address=45.85.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.85.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212027 }
:if ([:len [/ip/route/find dst-address=45.85.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.85.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212027 }
