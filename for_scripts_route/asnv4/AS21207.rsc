...
:if ([:len [/ip/route/find dst-address=153.100.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.100.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21207 }
:if ([:len [/ip/route/find dst-address=153.100.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.100.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21207 }
:if ([:len [/ip/route/find dst-address=153.100.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.100.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21207 }
:if ([:len [/ip/route/find dst-address=153.100.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.100.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21207 }
:if ([:len [/ip/route/find dst-address=153.100.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.100.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21207 }
