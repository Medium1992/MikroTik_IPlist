...
:if ([:len [/ip/route/find dst-address=149.71.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.71.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212087 }
...
:if ([:len [/ip/route/find dst-address=149.86.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.86.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212087 }
...
:if ([:len [/ip/route/find dst-address=154.62.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.62.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212087 }
:if ([:len [/ip/route/find dst-address=154.62.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.62.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212087 }
...
:if ([:len [/ip/route/find dst-address=38.58.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.58.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212087 }
