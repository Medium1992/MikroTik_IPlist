...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS212109 and dst-address=for_scripts_route/asnv4/AS212109.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS212109.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212109 }
