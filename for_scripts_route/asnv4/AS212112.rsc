...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=13.143.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.143.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212112 }
:if ([:len [/ip/route/find dst-address=130.78.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.78.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212112 }
