...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.166.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.166.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212171 }
...
:if ([:len [/ip/route/find dst-address=185.99.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.99.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212171 }
...
:if ([:len [/ip/route/find dst-address=45.86.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.86.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212171 }
:if ([:len [/ip/route/find dst-address=45.86.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.86.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212171 }
:if ([:len [/ip/route/find dst-address=45.86.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.86.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212171 }
...
:if ([:len [/ip/route/find dst-address=77.91.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212171 }
