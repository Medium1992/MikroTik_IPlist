...
:if ([:len [/ip/route/find dst-address=194.67.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.67.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212189 }
:if ([:len [/ip/route/find dst-address=194.67.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.67.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212189 }
