...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.10.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.10.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212189 }
...
:if ([:len [/ip/route/find dst-address=31.210.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.210.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212189 }
