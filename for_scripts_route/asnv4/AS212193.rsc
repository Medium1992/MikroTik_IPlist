...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS212193 and dst-address=for_scripts_route/asnv4/AS212193.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS212193.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212193 }
