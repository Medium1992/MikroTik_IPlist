...
:if ([:len [/ip/route/find dst-address=2.26.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212194 }
:if ([:len [/ip/route/find dst-address=2.26.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212194 }
:if ([:len [/ip/route/find dst-address=2.26.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212194 }
