...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=95.173.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.173.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.173.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.173.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.173.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.173.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
