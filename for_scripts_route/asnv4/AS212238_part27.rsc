...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=95.177.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.91.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.91.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=95.177.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.177.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
...
:if ([:len [/ip/route/find dst-address=96.126.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.126.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=96.126.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.126.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
:if ([:len [/ip/route/find dst-address=96.62.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.62.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212238 }
