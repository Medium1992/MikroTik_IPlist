...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS212251 and dst-address=for_scripts_route/asnv4/AS212251.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS212251.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212251 }
