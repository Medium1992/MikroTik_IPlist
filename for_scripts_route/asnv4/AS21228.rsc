...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21228 and dst-address=for_scripts_route/asnv4/AS21228.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21228.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21228 }
