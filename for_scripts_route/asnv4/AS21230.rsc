...
:if ([:len [/ip/route/find dst-address=46.35.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.35.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21230 }
:if ([:len [/ip/route/find dst-address=46.35.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.35.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21230 }
