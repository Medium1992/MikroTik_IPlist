...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS212318 and dst-address=for_scripts_route/asnv4/AS212318.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS212318.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212318 }
