...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS212337 and dst-address=for_scripts_route/asnv4/AS212337.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS212337.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212337 }
