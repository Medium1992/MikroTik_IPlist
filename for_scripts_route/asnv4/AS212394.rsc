...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS212394 and dst-address=for_scripts_route/asnv4/AS212394.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS212394.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212394 }
