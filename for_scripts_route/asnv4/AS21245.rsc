...
:if ([:len [/ip/route/find dst-address=185.87.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.87.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=193.47.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.47.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=31.3.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.3.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=31.3.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.3.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=31.3.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.3.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
...
:if ([:len [/ip/route/find dst-address=82.24.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.24.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=82.24.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.24.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=82.25.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.25.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=82.26.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.26.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
:if ([:len [/ip/route/find dst-address=82.38.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21245 }
