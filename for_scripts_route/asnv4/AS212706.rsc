...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.171.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.171.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212706 }
:if ([:len [/ip/route/find dst-address=111.88.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.88.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212706 }
...
:if ([:len [/ip/route/find dst-address=185.159.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.159.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212706 }
:if ([:len [/ip/route/find dst-address=185.159.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.159.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212706 }
