...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=155.117.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.117.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212815 }
...
:if ([:len [/ip/route/find dst-address=89.33.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.33.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212815 }
