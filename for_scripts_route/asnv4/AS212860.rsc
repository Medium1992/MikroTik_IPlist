...
:if ([:len [/ip/route/find dst-address=46.8.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.8.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212860 }
...
:if ([:len [/ip/route/find dst-address=46.8.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.8.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212860 }
