...
:if ([:len [/ip/route/find dst-address=130.49.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.49.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212913 }
:if ([:len [/ip/route/find dst-address=170.168.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.168.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212913 }
...
:if ([:len [/ip/route/find dst-address=91.242.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.242.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212913 }
