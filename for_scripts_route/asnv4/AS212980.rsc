...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.244.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.244.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212980 }
...
:if ([:len [/ip/route/find dst-address=178.95.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.95.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212980 }
...
:if ([:len [/ip/route/find dst-address=79.172.193.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.172.193.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212980 }
...
:if ([:len [/ip/route/find dst-address=82.29.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.29.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS212980 }
