...
:if ([:len [/ip/route/find dst-address=15.20.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.20.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
:if ([:len [/ip/route/find dst-address=15.20.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.20.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
:if ([:len [/ip/route/find dst-address=15.20.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.20.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
:if ([:len [/ip/route/find dst-address=15.20.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.20.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
:if ([:len [/ip/route/find dst-address=15.20.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.20.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
...
:if ([:len [/ip/route/find dst-address=15.24.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.24.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
:if ([:len [/ip/route/find dst-address=15.24.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.24.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
:if ([:len [/ip/route/find dst-address=15.24.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.24.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
:if ([:len [/ip/route/find dst-address=15.24.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=15.24.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21302 }
