...
:if ([:len [/ip/route/find dst-address=107.182.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.182.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
:if ([:len [/ip/route/find dst-address=144.31.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
...
:if ([:len [/ip/route/find dst-address=163.123.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.123.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
...
:if ([:len [/ip/route/find dst-address=185.188.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.188.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
...
:if ([:len [/ip/route/find dst-address=185.28.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.28.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
:if ([:len [/ip/route/find dst-address=194.156.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.156.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
...
:if ([:len [/ip/route/find dst-address=194.85.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.85.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
...
:if ([:len [/ip/route/find dst-address=212.192.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.192.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
...
:if ([:len [/ip/route/find dst-address=91.198.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.198.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213035 }
