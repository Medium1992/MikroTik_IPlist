...
:if ([:len [/ip/route/find dst-address=167.254.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.254.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213038 }
...
:if ([:len [/ip/route/find dst-address=82.38.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213038 }
:if ([:len [/ip/route/find dst-address=82.38.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213038 }
:if ([:len [/ip/route/find dst-address=82.38.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213038 }
:if ([:len [/ip/route/find dst-address=82.38.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213038 }
:if ([:len [/ip/route/find dst-address=82.38.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213038 }
