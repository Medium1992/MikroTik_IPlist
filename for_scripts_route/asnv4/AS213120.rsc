...
:if ([:len [/ip/route/find dst-address=23.57.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.57.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
...
:if ([:len [/ip/route/find dst-address=72.52.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.52.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
:if ([:len [/ip/route/find dst-address=72.52.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.52.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
...
:if ([:len [/ip/route/find dst-address=72.52.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.52.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
:if ([:len [/ip/route/find dst-address=72.52.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.52.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
:if ([:len [/ip/route/find dst-address=72.52.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.52.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
