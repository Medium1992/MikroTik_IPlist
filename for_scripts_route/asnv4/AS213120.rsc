...
:if ([:len [/ip/route/find dst-address=209.200.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.200.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
...
:if ([:len [/ip/route/find dst-address=72.52.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.52.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
:if ([:len [/ip/route/find dst-address=72.52.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.52.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213120 }
