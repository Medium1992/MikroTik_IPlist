...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213161 and dst-address=for_scripts_route/asnv4/AS213161.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213161.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213161 }
