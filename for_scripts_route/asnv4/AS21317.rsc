...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21317 and dst-address=for_scripts_route/asnv4/AS21317.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21317.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21317 }
