...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213174 and dst-address=for_scripts_route/asnv4/AS213174.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213174.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213174 }
