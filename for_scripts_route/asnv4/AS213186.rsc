...
:if ([:len [/ip/route/find dst-address=199.245.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.245.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213186 }
...
:if ([:len [/ip/route/find dst-address=45.158.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.158.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213186 }
...
:if ([:len [/ip/route/find dst-address=62.233.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.233.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213186 }
