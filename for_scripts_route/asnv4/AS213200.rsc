...
:if ([:len [/ip/route/find dst-address=151.243.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.243.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213200 }
...
:if ([:len [/ip/route/find dst-address=5.231.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213200 }
