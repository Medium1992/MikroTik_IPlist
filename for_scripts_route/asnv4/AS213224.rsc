...
:if ([:len [/ip/route/find dst-address=66.71.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.71.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213224 }
...
:if ([:len [/ip/route/find dst-address=66.71.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.71.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213224 }
