...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213230 and dst-address=for_scripts_route/asnv4/AS213230.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213230.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213230 }
