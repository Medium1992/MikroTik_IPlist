...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=147.185.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.185.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
:if ([:len [/ip/route/find dst-address=185.129.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.129.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
:if ([:len [/ip/route/find dst-address=185.129.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.129.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
...
:if ([:len [/ip/route/find dst-address=207.180.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.180.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
...
:if ([:len [/ip/route/find dst-address=64.204.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.204.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
...
:if ([:len [/ip/route/find dst-address=82.22.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.22.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
:if ([:len [/ip/route/find dst-address=89.213.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213250 }
