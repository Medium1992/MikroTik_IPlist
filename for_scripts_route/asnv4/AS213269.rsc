...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213269 and dst-address=for_scripts_route/asnv4/AS213269.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213269.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213269 }
