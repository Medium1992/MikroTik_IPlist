...
:if ([:len [/ip/route/find dst-address=217.195.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.195.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213281 }
:if ([:len [/ip/route/find dst-address=217.195.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.195.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213281 }
:if ([:len [/ip/route/find dst-address=45.133.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.133.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213281 }
:if ([:len [/ip/route/find dst-address=45.133.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.133.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213281 }
