...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=145.79.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.79.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213323 }
:if ([:len [/ip/route/find dst-address=163.5.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.5.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213323 }
...
:if ([:len [/ip/route/find dst-address=2.26.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213323 }
