...
:if ([:len [/ip/route/find dst-address=5.180.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.180.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213323 }
...
:if ([:len [/ip/route/find dst-address=80.97.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.97.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213323 }
