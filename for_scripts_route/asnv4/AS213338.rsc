...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213338 and dst-address=for_scripts_route/asnv4/AS213338.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213338.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213338 }
