...
:if ([:len [/ip/route/find dst-address=204.77.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.77.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213398 }
...
:if ([:len [/ip/route/find dst-address=89.124.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.124.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213398 }
:if ([:len [/ip/route/find dst-address=89.23.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.23.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213398 }
