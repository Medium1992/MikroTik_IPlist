...
:if ([:len [/ip/route/find dst-address=81.12.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21341 }
:if ([:len [/ip/route/find dst-address=87.107.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21341 }
