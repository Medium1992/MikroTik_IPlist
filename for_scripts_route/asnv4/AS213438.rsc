...
:if ([:len [/ip/route/find dst-address=45.129.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.129.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213438 }
...
:if ([:len [/ip/route/find dst-address=45.142.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.142.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213438 }
:if ([:len [/ip/route/find dst-address=45.148.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.148.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213438 }
