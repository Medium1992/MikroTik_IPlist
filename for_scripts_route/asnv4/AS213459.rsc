...
:if ([:len [/ip/route/find dst-address=78.17.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
:if ([:len [/ip/route/find dst-address=78.17.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
:if ([:len [/ip/route/find dst-address=78.17.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
:if ([:len [/ip/route/find dst-address=78.17.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
:if ([:len [/ip/route/find dst-address=78.17.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
...
:if ([:len [/ip/route/find dst-address=78.17.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
:if ([:len [/ip/route/find dst-address=78.17.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
:if ([:len [/ip/route/find dst-address=78.17.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
:if ([:len [/ip/route/find dst-address=78.17.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213459 }
