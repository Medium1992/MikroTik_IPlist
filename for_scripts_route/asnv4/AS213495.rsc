...
:if ([:len [/ip/route/find dst-address=217.216.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.216.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213495 }
...
:if ([:len [/ip/route/find dst-address=82.139.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.139.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213495 }
