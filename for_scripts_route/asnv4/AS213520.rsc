...
:if ([:len [/ip/route/find dst-address=144.31.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
:if ([:len [/ip/route/find dst-address=144.31.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
...
:if ([:len [/ip/route/find dst-address=64.188.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.188.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213520 }
