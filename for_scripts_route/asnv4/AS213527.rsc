...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213527 and dst-address=for_scripts_route/asnv4/AS213527.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213527.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213527 }
