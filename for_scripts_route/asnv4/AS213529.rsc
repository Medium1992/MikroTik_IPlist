...
:if ([:len [/ip/route/find dst-address=140.235.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.235.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
:if ([:len [/ip/route/find dst-address=147.45.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.45.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
:if ([:len [/ip/route/find dst-address=193.5.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.5.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
...
:if ([:len [/ip/route/find dst-address=216.162.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.162.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
...
:if ([:len [/ip/route/find dst-address=31.76.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.76.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
:if ([:len [/ip/route/find dst-address=31.77.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.77.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
:if ([:len [/ip/route/find dst-address=50.114.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.114.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
:if ([:len [/ip/route/find dst-address=50.114.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.114.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213529 }
