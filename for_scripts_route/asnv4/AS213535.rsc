...
:if ([:len [/ip/route/find dst-address=153.76.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.76.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
...
:if ([:len [/ip/route/find dst-address=198.105.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.105.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
...
:if ([:len [/ip/route/find dst-address=204.11.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.11.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
:if ([:len [/ip/route/find dst-address=217.179.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.179.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
:if ([:len [/ip/route/find dst-address=217.179.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.179.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
