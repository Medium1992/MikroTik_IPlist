...
:if ([:len [/ip/route/find dst-address=107.161.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.161.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
...
:if ([:len [/ip/route/find dst-address=45.92.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.92.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213535 }
