...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213603 and dst-address=for_scripts_route/asnv4/AS213603.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213603.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213603 }
