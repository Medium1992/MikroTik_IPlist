...
:if ([:len [/ip/route/find dst-address=131.143.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.143.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213607 }
...
:if ([:len [/ip/route/find dst-address=151.247.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.247.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213607 }
...
:if ([:len [/ip/route/find dst-address=165.49.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.49.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213607 }
...
:if ([:len [/ip/route/find dst-address=45.170.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.170.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213607 }
