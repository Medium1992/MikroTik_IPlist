...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213624 and dst-address=for_scripts_route/asnv4/AS213624.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213624.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213624 }
