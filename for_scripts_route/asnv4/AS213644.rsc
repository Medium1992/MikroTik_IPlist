...
:if ([:len [/ip/route/find dst-address=185.84.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.84.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213644 }
:if ([:len [/ip/route/find dst-address=194.145.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.145.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213644 }
