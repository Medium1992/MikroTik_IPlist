...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.119.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.119.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213671 }
...
:if ([:len [/ip/route/find dst-address=150.237.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.237.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213671 }
...
:if ([:len [/ip/route/find dst-address=38.44.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.44.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213671 }
...
:if ([:len [/ip/route/find dst-address=95.142.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.142.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213671 }
