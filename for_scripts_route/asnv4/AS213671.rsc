...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213671 and dst-address=for_scripts_route/asnv4/AS213671.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213671.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213671 }
