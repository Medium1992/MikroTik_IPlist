...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=157.203.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.203.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21369 }
...
:if ([:len [/ip/route/find dst-address=157.203.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.203.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21369 }
