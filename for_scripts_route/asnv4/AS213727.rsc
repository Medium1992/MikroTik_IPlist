...
:if ([:len [/ip/route/find dst-address=37.152.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.152.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213727 }
:if ([:len [/ip/route/find dst-address=91.102.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.102.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213727 }
