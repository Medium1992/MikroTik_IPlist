...
:if ([:len [/ip/route/find dst-address=46.38.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.38.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213732 }
:if ([:len [/ip/route/find dst-address=46.38.150.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.38.150.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213732 }
