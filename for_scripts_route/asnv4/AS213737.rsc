...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=155.117.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.117.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213737 }
:if ([:len [/ip/route/find dst-address=31.58.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.58.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213737 }
