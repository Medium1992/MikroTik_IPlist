...
:if ([:len [/ip/route/find dst-address=37.202.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
...
:if ([:len [/ip/route/find dst-address=87.107.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=87.107.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
...
:if ([:len [/ip/route/find dst-address=94.182.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.182.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
...
:if ([:len [/ip/route/find dst-address=94.182.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.182.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
