...
:if ([:len [/ip/route/find dst-address=37.202.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=37.202.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
...
:if ([:len [/ip/route/find dst-address=37.202.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
...
:if ([:len [/ip/route/find dst-address=94.182.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.182.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
:if ([:len [/ip/route/find dst-address=94.182.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.182.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213807 }
