...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS213848 and dst-address=for_scripts_route/asnv4/AS213848.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS213848.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213848 }
