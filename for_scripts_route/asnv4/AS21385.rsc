...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21385 and dst-address=for_scripts_route/asnv4/AS21385.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21385.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21385 }
