...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.114.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.114.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213861 }
...
:if ([:len [/ip/route/find dst-address=207.89.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.89.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213861 }
:if ([:len [/ip/route/find dst-address=45.137.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.137.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213861 }
...
:if ([:len [/ip/route/find dst-address=45.149.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.149.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213861 }
