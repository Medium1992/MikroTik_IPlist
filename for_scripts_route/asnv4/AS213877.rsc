...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=144.31.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213877 }
:if ([:len [/ip/route/find dst-address=144.31.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213877 }
...
:if ([:len [/ip/route/find dst-address=144.31.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213877 }
:if ([:len [/ip/route/find dst-address=144.31.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213877 }
:if ([:len [/ip/route/find dst-address=144.31.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213877 }
...
:if ([:len [/ip/route/find dst-address=144.31.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213877 }
...
:if ([:len [/ip/route/find dst-address=64.188.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.188.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213877 }
