...
:if ([:len [/ip/route/find dst-address=142.249.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213990 }
...
:if ([:len [/ip/route/find dst-address=168.222.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.222.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS213990 }
