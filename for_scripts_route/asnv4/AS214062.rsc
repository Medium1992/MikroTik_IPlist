...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214062 and dst-address=for_scripts_route/asnv4/AS214062.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214062.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214062 }
