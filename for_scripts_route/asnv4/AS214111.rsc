...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214111 and dst-address=for_scripts_route/asnv4/AS214111.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214111.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214111 }
