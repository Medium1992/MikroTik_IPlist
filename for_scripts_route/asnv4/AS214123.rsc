...
:if ([:len [/ip/route/find dst-address=192.140.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.140.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214123 }
:if ([:len [/ip/route/find dst-address=38.225.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.225.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214123 }
