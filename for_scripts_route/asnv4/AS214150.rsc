...
:if ([:len [/ip/route/find dst-address=16.5.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=16.5.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214150 }
:if ([:len [/ip/route/find dst-address=169.128.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.128.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214150 }
