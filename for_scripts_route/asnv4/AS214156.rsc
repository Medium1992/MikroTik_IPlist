...
:if ([:len [/ip/route/find dst-address=2.59.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.59.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214156 }
:if ([:len [/ip/route/find dst-address=2.59.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.59.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214156 }
