...
:if ([:len [/ip/route/find dst-address=195.21.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.21.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214159 }
...
:if ([:len [/ip/route/find dst-address=84.32.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.32.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214159 }
...
:if ([:len [/ip/route/find dst-address=87.81.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.81.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214159 }
:if ([:len [/ip/route/find dst-address=87.81.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.81.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214159 }
:if ([:len [/ip/route/find dst-address=88.216.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214159 }
:if ([:len [/ip/route/find dst-address=88.216.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214159 }
...
:if ([:len [/ip/route/find dst-address=88.216.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214159 }
