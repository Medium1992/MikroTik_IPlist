...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214209 and dst-address=for_scripts_route/asnv4/AS214209.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214209.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214209 }
