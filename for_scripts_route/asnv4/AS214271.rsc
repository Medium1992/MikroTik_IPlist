...
:if ([:len [/ip/route/find dst-address=45.144.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.144.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214271 }
:if ([:len [/ip/route/find dst-address=46.236.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.236.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214271 }
