...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=153.51.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214366 }
:if ([:len [/ip/route/find dst-address=153.51.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.51.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214366 }
