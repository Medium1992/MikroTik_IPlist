...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214366 and dst-address=for_scripts_route/asnv4/AS214366.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214366.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214366 }
