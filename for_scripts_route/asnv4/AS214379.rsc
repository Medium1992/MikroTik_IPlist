...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214379 and dst-address=for_scripts_route/asnv4/AS214379.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214379.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214379 }
