...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214431 and dst-address=for_scripts_route/asnv4/AS214431.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214431.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214431 }
