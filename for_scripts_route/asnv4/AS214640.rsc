...
:if ([:len [/ip/route/find dst-address=136.148.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.148.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214640 }
:if ([:len [/ip/route/find dst-address=143.14.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.14.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214640 }
:if ([:len [/ip/route/find dst-address=143.14.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.14.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214640 }
...
:if ([:len [/ip/route/find dst-address=207.2.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.2.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214640 }
...
:if ([:len [/ip/route/find dst-address=64.112.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.112.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214640 }
