...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214656 and dst-address=for_scripts_route/asnv4/AS214656.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214656.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214656 }
