...
:if ([:len [/ip/route/find dst-address=141.11.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.11.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214677 }
...
:if ([:len [/ip/route/find dst-address=162.141.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.141.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214677 }
...
:if ([:len [/ip/route/find dst-address=195.206.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.206.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214677 }
...
:if ([:len [/ip/route/find dst-address=46.34.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.34.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214677 }
...
:if ([:len [/ip/route/find dst-address=82.39.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.39.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214677 }
...
:if ([:len [/ip/route/find dst-address=95.135.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.135.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214677 }
:if ([:len [/ip/route/find dst-address=96.62.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.62.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214677 }
