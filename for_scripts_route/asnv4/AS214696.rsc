...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS214696 and dst-address=for_scripts_route/asnv4/AS214696.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS214696.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214696 }
