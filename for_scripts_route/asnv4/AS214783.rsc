...
:if ([:len [/ip/route/find dst-address=5.231.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214783 }
...
:if ([:len [/ip/route/find dst-address=89.106.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.106.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214783 }
