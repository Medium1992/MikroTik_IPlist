...
:if ([:len [/ip/route/find dst-address=172.110.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.110.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214785 }
:if ([:len [/ip/route/find dst-address=172.110.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.110.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214785 }
...
:if ([:len [/ip/route/find dst-address=185.235.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.235.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214785 }
