...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.223.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.223.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214790 }
...
:if ([:len [/ip/route/find dst-address=5.181.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.181.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214790 }
