...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=138.249.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.249.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
:if ([:len [/ip/route/find dst-address=152.89.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.89.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
:if ([:len [/ip/route/find dst-address=170.168.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.168.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
...
:if ([:len [/ip/route/find dst-address=187.13.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.13.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
...
:if ([:len [/ip/route/find dst-address=201.50.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.50.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
