...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.17.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.17.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
...
:if ([:len [/ip/route/find dst-address=45.129.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.129.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
...
:if ([:len [/ip/route/find dst-address=95.181.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.181.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214833 }
