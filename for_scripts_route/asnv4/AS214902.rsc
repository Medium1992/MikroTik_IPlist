...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=5.175.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214902 }
:if ([:len [/ip/route/find dst-address=5.175.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214902 }
...
:if ([:len [/ip/route/find dst-address=5.231.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.231.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214902 }
...
:if ([:len [/ip/route/find dst-address=89.144.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.144.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214902 }
