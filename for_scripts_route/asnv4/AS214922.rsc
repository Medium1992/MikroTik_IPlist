...
:if ([:len [/ip/route/find dst-address=5.160.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.160.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
:if ([:len [/ip/route/find dst-address=5.160.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.160.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
...
:if ([:len [/ip/route/find dst-address=5.160.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.160.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
...
:if ([:len [/ip/route/find dst-address=77.104.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.104.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
...
:if ([:len [/ip/route/find dst-address=81.12.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
...
:if ([:len [/ip/route/find dst-address=94.184.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
:if ([:len [/ip/route/find dst-address=94.184.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
:if ([:len [/ip/route/find dst-address=94.184.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214922 }
