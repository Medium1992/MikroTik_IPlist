...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.239.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.239.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214961 }
...
:if ([:len [/ip/route/find dst-address=217.217.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.217.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214961 }
:if ([:len [/ip/route/find dst-address=45.141.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.141.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214961 }
