...
:if ([:len [/ip/route/find dst-address=151.242.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.242.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214987 }
:if ([:len [/ip/route/find dst-address=151.243.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.243.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214987 }
...
:if ([:len [/ip/route/find dst-address=31.77.246.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.77.246.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214987 }
:if ([:len [/ip/route/find dst-address=82.27.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.27.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS214987 }
