...
:if ([:len [/ip/route/find dst-address=188.121.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.121.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21499 }
...
:if ([:len [/ip/route/find dst-address=92.205.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.205.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21499 }
