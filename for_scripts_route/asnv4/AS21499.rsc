...
:if ([:len [/ip/route/find dst-address=92.205.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.205.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21499 }
:if ([:len [/ip/route/find dst-address=92.205.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.205.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21499 }
:if ([:len [/ip/route/find dst-address=92.205.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.205.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21499 }
:if ([:len [/ip/route/find dst-address=92.205.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.205.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21499 }
