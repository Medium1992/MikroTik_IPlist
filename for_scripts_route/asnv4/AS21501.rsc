...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21501 and dst-address=for_scripts_route/asnv4/AS21501.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21501.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21501 }
