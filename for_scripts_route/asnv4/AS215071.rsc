...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.6.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.6.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215071 }
:if ([:len [/ip/route/find dst-address=154.6.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.6.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215071 }
...
:if ([:len [/ip/route/find dst-address=217.179.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.179.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215071 }
