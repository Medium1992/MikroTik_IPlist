...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215089 and dst-address=for_scripts_route/asnv4/AS215089.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215089.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215089 }
