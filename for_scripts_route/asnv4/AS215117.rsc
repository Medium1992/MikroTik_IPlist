...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215117 and dst-address=for_scripts_route/asnv4/AS215117.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215117.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215117 }
