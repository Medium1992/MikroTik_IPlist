...
:if ([:len [/ip/route/find dst-address=188.220.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.220.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215120 }
...
:if ([:len [/ip/route/find dst-address=201.3.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.3.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215120 }
:if ([:len [/ip/route/find dst-address=89.126.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.126.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215120 }
