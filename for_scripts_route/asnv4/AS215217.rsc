...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215217 and dst-address=for_scripts_route/asnv4/AS215217.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215217.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215217 }
