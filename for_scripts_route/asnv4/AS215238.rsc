...
:if ([:len [/ip/route/find dst-address=142.249.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215238 }
...
:if ([:len [/ip/route/find dst-address=191.44.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.44.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215238 }
...
:if ([:len [/ip/route/find dst-address=31.42.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.42.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215238 }
...
:if ([:len [/ip/route/find dst-address=87.76.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.76.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215238 }
:if ([:len [/ip/route/find dst-address=87.76.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.76.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215238 }
