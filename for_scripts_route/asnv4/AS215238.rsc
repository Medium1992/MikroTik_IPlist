...
:if ([:len [/ip/route/find dst-address=45.151.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.151.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215238 }
...
:if ([:len [/ip/route/find dst-address=45.88.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.88.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215238 }
