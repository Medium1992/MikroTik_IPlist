...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.167.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.167.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215272 }
:if ([:len [/ip/route/find dst-address=130.49.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.49.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215272 }
:if ([:len [/ip/route/find dst-address=153.80.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.80.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215272 }
:if ([:len [/ip/route/find dst-address=155.212.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.212.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215272 }
...
:if ([:len [/ip/route/find dst-address=62.182.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.182.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215272 }
