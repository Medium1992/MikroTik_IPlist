...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.112.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.112.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215305 }
:if ([:len [/ip/route/find dst-address=103.118.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.118.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215305 }
:if ([:len [/ip/route/find dst-address=103.119.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.119.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215305 }
:if ([:len [/ip/route/find dst-address=103.200.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.200.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215305 }
...
:if ([:len [/ip/route/find dst-address=45.151.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.151.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215305 }
