...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215365 and dst-address=for_scripts_route/asnv4/AS215365.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215365.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215365 }
