...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.219.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.219.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215373 }
...
:if ([:len [/ip/route/find dst-address=193.164.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.164.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215373 }
...
:if ([:len [/ip/route/find dst-address=89.111.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.111.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215373 }
