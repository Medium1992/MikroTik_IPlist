...
:if ([:len [/ip/route/find dst-address=89.111.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.111.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215373 }
...
:if ([:len [/ip/route/find dst-address=89.111.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.111.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215373 }
:if ([:len [/ip/route/find dst-address=89.111.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.111.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215373 }
:if ([:len [/ip/route/find dst-address=89.111.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.111.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215373 }
