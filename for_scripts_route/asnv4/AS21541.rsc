...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=208.186.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.48/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.48/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.53/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.53/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.54/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.54/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.56/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.56/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.56.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.56.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
:if ([:len [/ip/route/find dst-address=208.186.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.186.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21541 }
