...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215467 and dst-address=for_scripts_route/asnv4/AS215467.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215467.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215467 }
