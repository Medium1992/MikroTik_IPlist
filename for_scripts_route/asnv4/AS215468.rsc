...
:if ([:len [/ip/route/find dst-address=206.245.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.245.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215468 }
...
:if ([:len [/ip/route/find dst-address=72.35.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.35.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215468 }
...
:if ([:len [/ip/route/find dst-address=89.125.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.125.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215468 }
