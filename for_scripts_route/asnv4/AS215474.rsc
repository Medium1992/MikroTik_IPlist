...
:if ([:len [/ip/route/find dst-address=136.0.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.0.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215474 }
:if ([:len [/ip/route/find dst-address=144.31.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215474 }
...
:if ([:len [/ip/route/find dst-address=150.241.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.241.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215474 }
:if ([:len [/ip/route/find dst-address=150.241.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.241.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215474 }
