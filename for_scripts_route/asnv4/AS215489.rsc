...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215489 and dst-address=for_scripts_route/asnv4/AS215489.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215489.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215489 }
