...
:if ([:len [/ip/route/find dst-address=94.183.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.183.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215496 }
:if ([:len [/ip/route/find dst-address=94.184.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215496 }
