...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215597 and dst-address=for_scripts_route/asnv4/AS215597.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215597.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215597 }
