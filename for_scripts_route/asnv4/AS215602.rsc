...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215602 and dst-address=for_scripts_route/asnv4/AS215602.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215602.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215602 }
