...
:if ([:len [/ip/route/find dst-address=216.24.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.24.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215607 }
...
:if ([:len [/ip/route/find dst-address=23.95.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.95.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215607 }
...
:if ([:len [/ip/route/find dst-address=46.203.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.203.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215607 }
...
:if ([:len [/ip/route/find dst-address=64.93.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.93.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215607 }
...
:if ([:len [/ip/route/find dst-address=96.62.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.62.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215607 }
