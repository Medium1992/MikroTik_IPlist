...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215633 and dst-address=for_scripts_route/asnv4/AS215633.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215633.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215633 }
