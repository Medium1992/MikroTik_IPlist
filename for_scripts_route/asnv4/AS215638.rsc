...
:if ([:len [/ip/route/find dst-address=185.225.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.225.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215638 }
...
:if ([:len [/ip/route/find dst-address=91.217.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.217.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215638 }
