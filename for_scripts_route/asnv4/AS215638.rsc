...
:if ([:len [/ip/route/find dst-address=141.98.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.98.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215638 }
...
:if ([:len [/ip/route/find dst-address=151.247.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.247.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215638 }
...
:if ([:len [/ip/route/find dst-address=82.39.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.39.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215638 }
