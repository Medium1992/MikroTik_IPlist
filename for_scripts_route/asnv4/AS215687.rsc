...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215687 and dst-address=for_scripts_route/asnv4/AS215687.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215687.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215687 }
