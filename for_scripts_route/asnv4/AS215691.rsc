...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.204.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.204.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215691 }
...
:if ([:len [/ip/route/find dst-address=151.242.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.242.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215691 }
...
:if ([:len [/ip/route/find dst-address=193.8.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.8.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215691 }
...
:if ([:len [/ip/route/find dst-address=213.220.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.220.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215691 }
