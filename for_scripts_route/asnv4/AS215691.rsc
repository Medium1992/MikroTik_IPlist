...
:if ([:len [/ip/route/find dst-address=2.27.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.27.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215691 }
:if ([:len [/ip/route/find dst-address=212.47.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.47.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215691 }
