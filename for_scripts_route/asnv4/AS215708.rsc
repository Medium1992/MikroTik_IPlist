...
:if ([:len [/ip/route/find dst-address=62.220.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.220.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215708 }
...
:if ([:len [/ip/route/find dst-address=81.12.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215708 }
...
:if ([:len [/ip/route/find dst-address=81.12.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215708 }
...
:if ([:len [/ip/route/find dst-address=87.107.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215708 }
:if ([:len [/ip/route/find dst-address=87.107.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215708 }
