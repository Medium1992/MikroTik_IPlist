...
:if ([:len [/ip/route/find dst-address=130.193.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.193.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215727 }
:if ([:len [/ip/route/find dst-address=14.137.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.137.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215727 }
...
:if ([:len [/ip/route/find dst-address=163.5.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.5.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215727 }
...
:if ([:len [/ip/route/find dst-address=185.227.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.227.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215727 }
:if ([:len [/ip/route/find dst-address=188.66.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.66.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215727 }
...
:if ([:len [/ip/route/find dst-address=64.204.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.204.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215727 }
:if ([:len [/ip/route/find dst-address=82.153.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.153.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215727 }
