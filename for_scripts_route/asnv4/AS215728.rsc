...
:if ([:len [/ip/route/find dst-address=115.167.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.167.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215728 }
:if ([:len [/ip/route/find dst-address=115.167.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.167.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215728 }
:if ([:len [/ip/route/find dst-address=115.167.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.167.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215728 }
:if ([:len [/ip/route/find dst-address=115.167.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.167.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215728 }
:if ([:len [/ip/route/find dst-address=115.167.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.167.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215728 }
