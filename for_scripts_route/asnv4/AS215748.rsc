...
:if ([:len [/ip/route/find dst-address=103.78.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.78.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215748 }
:if ([:len [/ip/route/find dst-address=14.192.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215748 }
...
:if ([:len [/ip/route/find dst-address=209.209.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215748 }
:if ([:len [/ip/route/find dst-address=23.157.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.157.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215748 }
:if ([:len [/ip/route/find dst-address=23.157.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.157.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215748 }
:if ([:len [/ip/route/find dst-address=23.157.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.157.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215748 }
