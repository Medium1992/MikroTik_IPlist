...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215776 and dst-address=for_scripts_route/asnv4/AS215776.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215776.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215776 }
