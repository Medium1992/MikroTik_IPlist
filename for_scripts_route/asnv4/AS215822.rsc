...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215822 and dst-address=for_scripts_route/asnv4/AS215822.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215822.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215822 }
