...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS215931 and dst-address=for_scripts_route/asnv4/AS215931.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS215931.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS215931 }
