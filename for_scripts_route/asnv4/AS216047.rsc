...
:if ([:len [/ip/route/find dst-address=45.248.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.248.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216047 }
:if ([:len [/ip/route/find dst-address=45.248.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.248.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216047 }
