...
:if ([:len [/ip/route/find dst-address=103.255.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.255.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216047 }
...
:if ([:len [/ip/route/find dst-address=156.246.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.246.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216047 }
