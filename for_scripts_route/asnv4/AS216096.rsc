...
:if ([:len [/ip/route/find dst-address=168.222.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.222.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216096 }
:if ([:len [/ip/route/find dst-address=2.27.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.27.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216096 }
