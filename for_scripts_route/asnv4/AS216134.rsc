...
:if ([:len [/ip/route/find dst-address=149.238.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.238.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216134 }
:if ([:len [/ip/route/find dst-address=149.238.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.238.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216134 }
:if ([:len [/ip/route/find dst-address=149.238.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.238.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216134 }
:if ([:len [/ip/route/find dst-address=149.238.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.238.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216134 }
:if ([:len [/ip/route/find dst-address=149.238.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.238.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216134 }
:if ([:len [/ip/route/find dst-address=149.238.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.238.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216134 }
