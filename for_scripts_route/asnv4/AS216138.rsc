...
:if ([:len [/ip/route/find dst-address=82.26.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.26.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216138 }
...
:if ([:len [/ip/route/find dst-address=85.237.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.237.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216138 }
