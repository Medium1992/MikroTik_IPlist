...
:if ([:len [/ip/route/find dst-address=132.243.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.243.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216154 }
:if ([:len [/ip/route/find dst-address=157.22.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.22.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216154 }
...
:if ([:len [/ip/route/find dst-address=85.137.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.137.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216154 }
