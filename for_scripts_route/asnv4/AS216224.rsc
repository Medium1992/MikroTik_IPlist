...
:if ([:len [/ip/route/find dst-address=178.83.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216224 }
...
:if ([:len [/ip/route/find dst-address=82.21.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.21.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216224 }
