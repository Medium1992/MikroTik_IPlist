...
:if ([:len [/ip/route/find dst-address=185.103.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.103.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216246 }
...
:if ([:len [/ip/route/find dst-address=193.233.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216246 }
...
:if ([:len [/ip/route/find dst-address=193.233.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216246 }
:if ([:len [/ip/route/find dst-address=193.233.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216246 }
:if ([:len [/ip/route/find dst-address=193.233.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216246 }
...
:if ([:len [/ip/route/find dst-address=194.26.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.26.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216246 }
...
:if ([:len [/ip/route/find dst-address=92.246.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.246.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216246 }
