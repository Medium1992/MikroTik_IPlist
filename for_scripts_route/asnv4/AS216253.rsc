...
:if ([:len [/ip/route/find dst-address=104.238.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.238.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
...
:if ([:len [/ip/route/find dst-address=13.140.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.140.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
:if ([:len [/ip/route/find dst-address=13.140.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.140.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
:if ([:len [/ip/route/find dst-address=13.140.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.140.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
...
:if ([:len [/ip/route/find dst-address=217.217.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.217.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
:if ([:len [/ip/route/find dst-address=217.217.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.217.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
:if ([:len [/ip/route/find dst-address=217.217.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.217.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
...
:if ([:len [/ip/route/find dst-address=85.208.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.208.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216253 }
