...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS216329 and dst-address=for_scripts_route/asnv4/AS216329.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS216329.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216329 }
