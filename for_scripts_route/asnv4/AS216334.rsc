...
:if ([:len [/ip/route/find dst-address=194.55.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.55.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216334 }
...
:if ([:len [/ip/route/find dst-address=45.154.246.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.154.246.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216334 }
