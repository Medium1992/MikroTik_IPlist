...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS216368 and dst-address=for_scripts_route/asnv4/AS216368.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS216368.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216368 }
