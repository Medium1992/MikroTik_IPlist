...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=146.19.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=146.19.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216383 }
:if ([:len [/ip/route/find dst-address=185.36.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.36.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216383 }
:if ([:len [/ip/route/find dst-address=185.81.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.81.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216383 }
...
:if ([:len [/ip/route/find dst-address=23.90.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.90.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216383 }
