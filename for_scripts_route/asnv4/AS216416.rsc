...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=157.173.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.173.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216416 }
:if ([:len [/ip/route/find dst-address=157.173.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.173.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216416 }
...
:if ([:len [/ip/route/find dst-address=188.137.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.137.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216416 }
:if ([:len [/ip/route/find dst-address=188.137.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.137.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216416 }
:if ([:len [/ip/route/find dst-address=188.137.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.137.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216416 }
