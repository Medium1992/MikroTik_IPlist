...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS216434 and dst-address=for_scripts_route/asnv4/AS216434.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS216434.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216434 }
