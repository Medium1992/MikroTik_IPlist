...
:if ([:len [/ip/route/find dst-address=45.141.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.141.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216459 }
:if ([:len [/ip/route/find dst-address=45.148.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.148.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS216459 }
