...
:if ([:len [/ip/route/find dst-address=162.222.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.222.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
:if ([:len [/ip/route/find dst-address=162.222.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.222.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
:if ([:len [/ip/route/find dst-address=162.222.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.222.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
