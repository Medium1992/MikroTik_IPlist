...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.20.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.20.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
...
:if ([:len [/ip/route/find dst-address=192.234.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.234.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
...
:if ([:len [/ip/route/find dst-address=23.130.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.130.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
...
:if ([:len [/ip/route/find dst-address=45.41.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.41.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
:if ([:len [/ip/route/find dst-address=45.41.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.41.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
...
:if ([:len [/ip/route/find dst-address=72.21.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.21.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
:if ([:len [/ip/route/find dst-address=72.21.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.21.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
:if ([:len [/ip/route/find dst-address=72.21.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.21.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21699 }
