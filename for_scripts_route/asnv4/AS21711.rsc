...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21711 and dst-address=for_scripts_route/asnv4/AS21711.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21711.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21711 }
