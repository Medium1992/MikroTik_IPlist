...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21729 and dst-address=for_scripts_route/asnv4/AS21729.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21729.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21729 }
