...
:if ([:len [/ip/route/find dst-address=149.57.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.57.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21743 }
...
:if ([:len [/ip/route/find dst-address=165.140.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.140.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21743 }
...
:if ([:len [/ip/route/find dst-address=216.75.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.75.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21743 }
...
:if ([:len [/ip/route/find dst-address=64.57.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.57.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21743 }
...
:if ([:len [/ip/route/find dst-address=66.93.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.93.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21743 }
