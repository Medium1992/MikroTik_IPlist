...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21750 and dst-address=for_scripts_route/asnv4/AS21750.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21750.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21750 }
