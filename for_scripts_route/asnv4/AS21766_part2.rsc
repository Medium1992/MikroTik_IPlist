...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=152.97.76.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.97.76.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21766 }
:if ([:len [/ip/route/find dst-address=152.97.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.97.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21766 }
:if ([:len [/ip/route/find dst-address=152.97.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.97.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21766 }
:if ([:len [/ip/route/find dst-address=152.97.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.97.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21766 }
:if ([:len [/ip/route/find dst-address=152.97.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.97.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21766 }
...
:if ([:len [/ip/route/find dst-address=64.63.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.63.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21766 }
