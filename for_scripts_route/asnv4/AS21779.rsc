...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21779 and dst-address=for_scripts_route/asnv4/AS21779.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21779.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21779 }
