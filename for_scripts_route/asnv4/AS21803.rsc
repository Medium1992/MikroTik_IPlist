...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=209.140.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.140.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
...
:if ([:len [/ip/route/find dst-address=209.140.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.140.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
:if ([:len [/ip/route/find dst-address=209.140.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.140.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
...
:if ([:len [/ip/route/find dst-address=67.223.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.223.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
:if ([:len [/ip/route/find dst-address=67.223.162.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.223.162.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
...
:if ([:len [/ip/route/find dst-address=69.39.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.39.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
:if ([:len [/ip/route/find dst-address=69.39.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.39.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
:if ([:len [/ip/route/find dst-address=69.39.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.39.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21803 }
