...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21813 and dst-address=for_scripts_route/asnv4/AS21813.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21813.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21813 }
