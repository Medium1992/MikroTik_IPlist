...
:if ([:len [/ip/route/find dst-address=192.173.6.208/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.173.6.208/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
