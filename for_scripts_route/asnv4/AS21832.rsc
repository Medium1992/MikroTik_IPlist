...
:if ([:len [/ip/route/find dst-address=172.83.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.112/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.112/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.117/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.117/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.118/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.118/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.120/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.120/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.243.96/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.243.96/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
:if ([:len [/ip/route/find dst-address=172.83.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
...
:if ([:len [/ip/route/find dst-address=192.173.6.192/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.173.6.192/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21832 }
