...
:if ([:len [/ip/route/find dst-address=167.148.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS218799 }
:if ([:len [/ip/route/find dst-address=167.148.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS218799 }
...
:if ([:len [/ip/route/find dst-address=212.74.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.74.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS218799 }
...
:if ([:len [/ip/route/find dst-address=64.57.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.57.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS218799 }
