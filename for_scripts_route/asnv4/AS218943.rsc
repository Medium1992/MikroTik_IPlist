...
:if ([:len [/ip/route/find dst-address=143.20.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS218943 }
:if ([:len [/ip/route/find dst-address=178.95.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.95.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS218943 }
...
:if ([:len [/ip/route/find dst-address=91.124.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.124.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS218943 }
