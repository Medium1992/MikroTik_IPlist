...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS21898 and dst-address=for_scripts_route/asnv4/AS21898.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS21898.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21898 }
