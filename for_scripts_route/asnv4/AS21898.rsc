...
:if ([:len [/ip/route/find dst-address=74.188.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21898 }
:if ([:len [/ip/route/find dst-address=74.188.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21898 }
:if ([:len [/ip/route/find dst-address=74.188.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21898 }
