...
:if ([:len [/ip/route/find dst-address=74.188.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21898 }
:if ([:len [/ip/route/find dst-address=74.188.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21898 }
:if ([:len [/ip/route/find dst-address=74.188.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS21898 }
