...
:if ([:len [/ip/route/find dst-address=151.244.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.244.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219105 }
:if ([:len [/ip/route/find dst-address=162.141.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.141.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219105 }
...
:if ([:len [/ip/route/find dst-address=178.95.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.95.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219105 }
...
:if ([:len [/ip/route/find dst-address=51.194.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.194.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219105 }
...
:if ([:len [/ip/route/find dst-address=89.116.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.116.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219105 }
