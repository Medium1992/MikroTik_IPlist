...
:if ([:len [/ip/route/find dst-address=109.95.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.95.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219142 }
:if ([:len [/ip/route/find dst-address=109.95.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.95.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219142 }
