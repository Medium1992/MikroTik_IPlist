...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=153.79.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.79.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219464 }
...
:if ([:len [/ip/route/find dst-address=45.131.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.131.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS219464 }
