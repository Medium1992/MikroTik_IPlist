...
:if ([:len [/ip/route/find dst-address=200.53.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.53.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22011 }
...
:if ([:len [/ip/route/find dst-address=200.57.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.57.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22011 }
:if ([:len [/ip/route/find dst-address=201.159.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.159.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22011 }
