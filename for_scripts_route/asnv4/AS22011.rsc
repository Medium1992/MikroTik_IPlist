...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22011 and dst-address=for_scripts_route/asnv4/AS22011.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22011.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22011 }
