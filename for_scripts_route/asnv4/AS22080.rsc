...
:if ([:len [/ip/route/find dst-address=186.148.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.148.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22080 }
...
:if ([:len [/ip/route/find dst-address=200.112.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.112.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22080 }
