...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22113 and dst-address=for_scripts_route/asnv4/AS22113.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22113.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22113 }
