...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22184 and dst-address=for_scripts_route/asnv4/AS22184.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22184.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22184 }
