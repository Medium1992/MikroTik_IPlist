...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22216 and dst-address=for_scripts_route/asnv4/AS22216.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22216.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22216 }
