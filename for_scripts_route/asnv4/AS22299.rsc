...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22299 and dst-address=for_scripts_route/asnv4/AS22299.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22299.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22299 }
