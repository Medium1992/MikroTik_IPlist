...
:if ([:len [/ip/route/find dst-address=97.133.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.133.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22394 }
...
:if ([:len [/ip/route/find dst-address=97.160.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.160.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22394 }
:if ([:len [/ip/route/find dst-address=97.162.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.162.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22394 }
