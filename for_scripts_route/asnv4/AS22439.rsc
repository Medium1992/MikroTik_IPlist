...
:if ([:len [/ip/route/find dst-address=70.36.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.36.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22439 }
:if ([:len [/ip/route/find dst-address=70.36.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.36.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22439 }
:if ([:len [/ip/route/find dst-address=70.36.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.36.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22439 }
...
:if ([:len [/ip/route/find dst-address=70.36.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.36.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22439 }
