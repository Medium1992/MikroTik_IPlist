...
:if ([:len [/ip/route/find dst-address=104.152.206.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.206.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22466 }
...
:if ([:len [/ip/route/find dst-address=104.152.206.32/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.206.32/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22466 }
:if ([:len [/ip/route/find dst-address=104.152.206.40/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.206.40/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22466 }
:if ([:len [/ip/route/find dst-address=104.152.206.44/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.206.44/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22466 }
:if ([:len [/ip/route/find dst-address=104.152.206.47/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.206.47/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22466 }
:if ([:len [/ip/route/find dst-address=104.152.206.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.206.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22466 }
:if ([:len [/ip/route/find dst-address=104.152.206.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.206.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22466 }
