...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22482 and dst-address=for_scripts_route/asnv4/AS22482.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22482.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22482 }
