...
:if ([:len [/ip/route/find dst-address=216.1.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.1.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22511 }
...
:if ([:len [/ip/route/find dst-address=8.28.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.28.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22511 }
...
:if ([:len [/ip/route/find dst-address=8.36.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.36.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22511 }
