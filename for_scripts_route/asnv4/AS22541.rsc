...
:if ([:len [/ip/route/find dst-address=190.14.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.14.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22541 }
...
:if ([:len [/ip/route/find dst-address=190.14.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.14.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22541 }
