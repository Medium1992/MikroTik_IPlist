...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=198.28.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.28.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22576 }
:if ([:len [/ip/route/find dst-address=198.28.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.28.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22576 }
