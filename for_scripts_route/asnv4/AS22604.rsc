...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=139.104.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.104.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22604 }
...
:if ([:len [/ip/route/find dst-address=139.104.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.104.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22604 }
