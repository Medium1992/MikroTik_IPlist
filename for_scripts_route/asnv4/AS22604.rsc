...
:if ([:len [/ip/route/find dst-address=139.104.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.104.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22604 }
...
:if ([:len [/ip/route/find dst-address=139.104.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.104.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22604 }
:if ([:len [/ip/route/find dst-address=139.104.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.104.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22604 }
:if ([:len [/ip/route/find dst-address=139.104.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.104.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22604 }
...
:if ([:len [/ip/route/find dst-address=157.23.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.23.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22604 }
