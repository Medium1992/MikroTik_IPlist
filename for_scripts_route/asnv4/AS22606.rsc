...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22606 and dst-address=for_scripts_route/asnv4/AS22606.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22606.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22606 }
