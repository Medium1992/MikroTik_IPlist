...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22634 and dst-address=for_scripts_route/asnv4/AS22634.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22634.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22634 }
