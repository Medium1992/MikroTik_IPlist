...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22644 and dst-address=for_scripts_route/asnv4/AS22644.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22644.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22644 }
