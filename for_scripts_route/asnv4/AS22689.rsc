...
:if ([:len [/ip/route/find dst-address=187.121.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
:if ([:len [/ip/route/find dst-address=187.121.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
:if ([:len [/ip/route/find dst-address=187.121.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
:if ([:len [/ip/route/find dst-address=187.121.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
:if ([:len [/ip/route/find dst-address=187.121.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
