...
:if ([:len [/ip/route/find dst-address=187.121.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
:if ([:len [/ip/route/find dst-address=187.121.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
:if ([:len [/ip/route/find dst-address=187.121.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
:if ([:len [/ip/route/find dst-address=187.121.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.121.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22689 }
