...
:if ([:len [/ip/route/find dst-address=140.82.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.82.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
:if ([:len [/ip/route/find dst-address=140.82.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.82.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
:if ([:len [/ip/route/find dst-address=140.82.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.82.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
...
:if ([:len [/ip/route/find dst-address=192.245.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.245.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
...
:if ([:len [/ip/route/find dst-address=204.11.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.11.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
:if ([:len [/ip/route/find dst-address=208.75.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.75.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
:if ([:len [/ip/route/find dst-address=52.119.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=52.119.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
:if ([:len [/ip/route/find dst-address=52.119.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=52.119.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
:if ([:len [/ip/route/find dst-address=52.119.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=52.119.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22768 }
