...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=98.188.191.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.188.191.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22773 }
:if ([:len [/ip/route/find dst-address=98.188.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.188.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22773 }
:if ([:len [/ip/route/find dst-address=98.188.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.188.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22773 }
:if ([:len [/ip/route/find dst-address=98.188.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.188.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22773 }
