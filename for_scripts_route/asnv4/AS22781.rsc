...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22781 and dst-address=for_scripts_route/asnv4/AS22781.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22781.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22781 }
