...
:if ([:len [/ip/route/find dst-address=134.242.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.242.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22787 }
:if ([:len [/ip/route/find dst-address=134.242.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.242.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22787 }
...
:if ([:len [/ip/route/find dst-address=134.242.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.242.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22787 }
