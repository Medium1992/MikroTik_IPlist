...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22792 and dst-address=for_scripts_route/asnv4/AS22792.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22792.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22792 }
