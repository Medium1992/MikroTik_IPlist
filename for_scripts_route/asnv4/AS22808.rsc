...
:if ([:len [/ip/route/find dst-address=167.246.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.246.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22808 }
...
:if ([:len [/ip/route/find dst-address=167.246.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.246.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22808 }
:if ([:len [/ip/route/find dst-address=167.246.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.246.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22808 }
...
:if ([:len [/ip/route/find dst-address=216.99.24.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.99.24.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22808 }
:if ([:len [/ip/route/find dst-address=216.99.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.99.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22808 }
