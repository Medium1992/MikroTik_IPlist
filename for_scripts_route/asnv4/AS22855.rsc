...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22855 and dst-address=for_scripts_route/asnv4/AS22855.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22855.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22855 }
