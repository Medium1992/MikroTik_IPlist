...
:if ([:len [/ip/route/find dst-address=216.160.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.160.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22904 }
...
:if ([:len [/ip/route/find dst-address=67.133.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.133.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22904 }
