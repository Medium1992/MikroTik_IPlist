...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22919 and dst-address=for_scripts_route/asnv4/AS22919.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22919.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22919 }
