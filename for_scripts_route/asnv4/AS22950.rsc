...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS22950 and dst-address=for_scripts_route/asnv4/AS22950.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS22950.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22950 }
