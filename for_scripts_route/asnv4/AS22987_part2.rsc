...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=68.209.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.238.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.238.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.238.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.238.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.238.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.238.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.238.225/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.238.225/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.238.226/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.238.226/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
:if ([:len [/ip/route/find dst-address=68.209.238.228/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.209.238.228/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22987 }
