...
:if ([:len [/ip/route/find dst-address=208.89.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.89.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22992 }
:if ([:len [/ip/route/find dst-address=208.89.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.89.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS22992 }
