...
:if ([:len [/ip/route/find dst-address=216.31.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.31.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23028 }
:if ([:len [/ip/route/find dst-address=216.31.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.31.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23028 }
:if ([:len [/ip/route/find dst-address=216.31.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.31.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23028 }
