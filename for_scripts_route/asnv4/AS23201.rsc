...
:if ([:len [/ip/route/find dst-address=190.2.193.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.2.193.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23201 }
:if ([:len [/ip/route/find dst-address=190.2.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.2.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23201 }
:if ([:len [/ip/route/find dst-address=190.2.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.2.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23201 }
:if ([:len [/ip/route/find dst-address=190.2.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.2.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23201 }
