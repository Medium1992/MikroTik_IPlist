...
:if ([:len [/ip/route/find dst-address=45.62.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.62.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23252 }
:if ([:len [/ip/route/find dst-address=45.62.86.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.62.86.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23252 }
:if ([:len [/ip/route/find dst-address=45.62.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.62.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23252 }
