...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=75.102.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.102.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
...
:if ([:len [/ip/route/find dst-address=75.102.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.102.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
...
:if ([:len [/ip/route/find dst-address=75.102.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.102.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
...
:if ([:len [/ip/route/find dst-address=81.199.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.199.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
