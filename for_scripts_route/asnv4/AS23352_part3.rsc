...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=66.225.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.225.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=66.225.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.225.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=66.225.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.225.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=66.225.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.225.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=66.235.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.235.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=66.235.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.235.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=68.71.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.71.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=72.5.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.5.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
...
:if ([:len [/ip/route/find dst-address=75.102.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.102.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
:if ([:len [/ip/route/find dst-address=75.102.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=75.102.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23352 }
