...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS23394 and dst-address=for_scripts_route/asnv4/AS23394.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS23394.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23394 }
