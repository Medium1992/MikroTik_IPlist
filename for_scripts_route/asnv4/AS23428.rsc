...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS23428 and dst-address=for_scripts_route/asnv4/AS23428.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS23428.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23428 }
