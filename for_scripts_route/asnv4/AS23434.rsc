...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS23434 and dst-address=for_scripts_route/asnv4/AS23434.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS23434.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23434 }
