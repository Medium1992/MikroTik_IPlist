...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=70.99.78.172/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.172/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.78.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.78.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.78.224/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.224/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.78.232/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.232/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.78.236/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.236/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.78.238/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.238/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.78.240/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.78.240/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
:if ([:len [/ip/route/find dst-address=70.99.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.99.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23465 }
