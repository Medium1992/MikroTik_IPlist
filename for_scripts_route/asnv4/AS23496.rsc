...
:if ([:len [/ip/route/find dst-address=161.208.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.208.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23496 }
:if ([:len [/ip/route/find dst-address=161.208.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.208.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23496 }
