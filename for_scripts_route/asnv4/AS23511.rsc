...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=142.252.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.252.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23511 }
:if ([:len [/ip/route/find dst-address=142.252.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.252.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23511 }
...
:if ([:len [/ip/route/find dst-address=45.38.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.38.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23511 }
...
:if ([:len [/ip/route/find dst-address=45.38.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.38.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23511 }
