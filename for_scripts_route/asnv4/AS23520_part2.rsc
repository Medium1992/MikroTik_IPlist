...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=69.79.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.79.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23520 }
...
:if ([:len [/ip/route/find dst-address=69.79.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.79.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23520 }
...
:if ([:len [/ip/route/find dst-address=69.79.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.79.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23520 }
:if ([:len [/ip/route/find dst-address=69.79.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.79.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23520 }
:if ([:len [/ip/route/find dst-address=69.79.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.79.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23520 }
:if ([:len [/ip/route/find dst-address=69.79.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.79.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23520 }
