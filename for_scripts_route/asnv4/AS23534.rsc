...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=150.2.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.2.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23534 }
:if ([:len [/ip/route/find dst-address=192.68.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.68.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23534 }
