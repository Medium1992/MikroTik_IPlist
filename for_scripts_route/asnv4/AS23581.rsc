...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS23581 and dst-address=for_scripts_route/asnv4/AS23581.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS23581.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23581 }
