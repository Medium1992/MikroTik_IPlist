...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=1.201.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.201.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23588 }
...
:if ([:len [/ip/route/find dst-address=210.109.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.109.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23588 }
...
:if ([:len [/ip/route/find dst-address=210.109.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.109.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23588 }
...
:if ([:len [/ip/route/find dst-address=61.250.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.250.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23588 }
