...
:if ([:len [/ip/route/find dst-address=111.92.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23671 }
:if ([:len [/ip/route/find dst-address=111.92.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23671 }
