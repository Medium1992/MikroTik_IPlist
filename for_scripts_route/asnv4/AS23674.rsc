...
:if ([:len [/ip/route/find dst-address=151.123.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.123.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23674 }
:if ([:len [/ip/route/find dst-address=151.123.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.123.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23674 }
:if ([:len [/ip/route/find dst-address=151.123.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.123.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23674 }
:if ([:len [/ip/route/find dst-address=151.123.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.123.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23674 }
...
:if ([:len [/ip/route/find dst-address=202.165.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.165.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23674 }
