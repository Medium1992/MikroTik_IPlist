...
:if ([:len [/ip/route/find dst-address=103.198.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.198.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23838 }
...
:if ([:len [/ip/route/find dst-address=202.14.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.14.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23838 }
:if ([:len [/ip/route/find dst-address=202.36.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.36.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23838 }
