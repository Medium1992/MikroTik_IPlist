...
:if ([:len [/ip/route/find dst-address=61.16.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.16.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.16.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.16.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.16.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.16.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.16.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.16.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
...
:if ([:len [/ip/route/find dst-address=61.16.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.16.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.16.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.16.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
