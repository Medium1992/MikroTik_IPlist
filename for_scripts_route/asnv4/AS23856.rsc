...
:if ([:len [/ip/route/find dst-address=160.222.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.222.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
...
:if ([:len [/ip/route/find dst-address=61.13.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.13.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.13.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.13.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.13.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.13.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.13.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.13.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.13.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.13.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
:if ([:len [/ip/route/find dst-address=61.13.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.13.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
...
:if ([:len [/ip/route/find dst-address=61.16.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.16.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23856 }
