...
:if ([:len [/ip/route/find dst-address=175.107.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23888 }
:if ([:len [/ip/route/find dst-address=175.107.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23888 }
...
:if ([:len [/ip/route/find dst-address=175.107.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23888 }
:if ([:len [/ip/route/find dst-address=175.107.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23888 }
:if ([:len [/ip/route/find dst-address=175.107.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23888 }
:if ([:len [/ip/route/find dst-address=175.107.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23888 }
:if ([:len [/ip/route/find dst-address=175.107.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23888 }
