...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS23923 and dst-address=for_scripts_route/asnv4/AS23923.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS23923.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23923 }
