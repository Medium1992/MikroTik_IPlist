...
:if ([:len [/ip/route/find dst-address=103.80.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.80.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23953 }
...
:if ([:len [/ip/route/find dst-address=202.72.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.72.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS23953 }
