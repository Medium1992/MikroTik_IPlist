...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.197.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.197.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24016 }
...
:if ([:len [/ip/route/find dst-address=202.21.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.21.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24016 }
...
:if ([:len [/ip/route/find dst-address=202.21.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.21.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24016 }
