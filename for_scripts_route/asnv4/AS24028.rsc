...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24028 and dst-address=for_scripts_route/asnv4/AS24028.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24028.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24028 }
