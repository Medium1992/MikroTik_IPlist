...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24147 and dst-address=for_scripts_route/asnv4/AS24147.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24147.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24147 }
