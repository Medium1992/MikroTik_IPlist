...
:if ([:len [/ip/route/find dst-address=125.208.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.208.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24151 }
:if ([:len [/ip/route/find dst-address=125.208.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.208.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24151 }
:if ([:len [/ip/route/find dst-address=125.208.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.208.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24151 }
...
:if ([:len [/ip/route/find dst-address=42.83.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.83.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24151 }
:if ([:len [/ip/route/find dst-address=42.83.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.83.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24151 }
