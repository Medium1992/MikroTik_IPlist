...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=101.53.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
...
:if ([:len [/ip/route/find dst-address=101.53.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
...
:if ([:len [/ip/route/find dst-address=101.53.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
:if ([:len [/ip/route/find dst-address=101.53.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
...
:if ([:len [/ip/route/find dst-address=101.53.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
:if ([:len [/ip/route/find dst-address=101.53.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
:if ([:len [/ip/route/find dst-address=101.53.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
