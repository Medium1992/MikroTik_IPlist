...
:if ([:len [/ip/route/find dst-address=101.53.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
:if ([:len [/ip/route/find dst-address=101.53.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
...
:if ([:len [/ip/route/find dst-address=101.53.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24173 }
