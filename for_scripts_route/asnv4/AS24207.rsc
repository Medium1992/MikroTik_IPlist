...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24207 and dst-address=for_scripts_route/asnv4/AS24207.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24207.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24207 }
