...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24309 and dst-address=for_scripts_route/asnv4/AS24309_part2.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24309_part2.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24309 }
