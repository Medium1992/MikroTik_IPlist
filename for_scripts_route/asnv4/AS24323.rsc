...
:if ([:len [/ip/route/find dst-address=103.243.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.243.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24323 }
...
:if ([:len [/ip/route/find dst-address=116.206.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.206.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24323 }
