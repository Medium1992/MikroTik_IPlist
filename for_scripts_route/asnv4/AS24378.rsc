...
:if ([:len [/ip/route/find dst-address=1.47.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.47.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24378 }
:if ([:len [/ip/route/find dst-address=1.47.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.47.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24378 }
:if ([:len [/ip/route/find dst-address=1.47.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.47.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24378 }
