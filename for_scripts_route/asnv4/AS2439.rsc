...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS2439 and dst-address=for_scripts_route/asnv4/AS2439.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS2439.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2439 }
