...
:if ([:len [/ip/route/find dst-address=203.168.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.168.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24395 }
...
:if ([:len [/ip/route/find dst-address=203.168.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.168.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24395 }
