...
:if ([:len [/ip/route/find dst-address=101.53.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.53.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24440 }
...
:if ([:len [/ip/route/find dst-address=119.13.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.13.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24440 }
:if ([:len [/ip/route/find dst-address=119.13.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.13.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24440 }
...
:if ([:len [/ip/route/find dst-address=175.107.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24440 }
:if ([:len [/ip/route/find dst-address=175.107.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.107.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24440 }
