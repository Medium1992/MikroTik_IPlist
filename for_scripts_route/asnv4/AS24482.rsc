...
:if ([:len [/ip/route/find dst-address=116.251.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.251.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24482 }
...
:if ([:len [/ip/route/find dst-address=203.175.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.175.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24482 }
