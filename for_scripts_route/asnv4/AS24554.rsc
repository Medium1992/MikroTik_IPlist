...
:if ([:len [/ip/route/find dst-address=183.87.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.87.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24554 }
:if ([:len [/ip/route/find dst-address=183.87.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.87.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24554 }
