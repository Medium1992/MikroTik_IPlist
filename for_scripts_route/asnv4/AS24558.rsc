...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24558 and dst-address=for_scripts_route/asnv4/AS24558.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24558.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24558 }
