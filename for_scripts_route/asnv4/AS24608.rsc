...
:if ([:len [/ip/route/find dst-address=2.156.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.156.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24608 }
:if ([:len [/ip/route/find dst-address=2.157.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.157.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24608 }
:if ([:len [/ip/route/find dst-address=2.157.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.157.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24608 }
:if ([:len [/ip/route/find dst-address=2.158.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.158.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24608 }
