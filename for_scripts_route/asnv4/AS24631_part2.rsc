...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=81.29.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.29.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24631 }
:if ([:len [/ip/route/find dst-address=81.29.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.29.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24631 }
:if ([:len [/ip/route/find dst-address=86.109.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.109.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24631 }
:if ([:len [/ip/route/find dst-address=86.109.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.109.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24631 }
:if ([:len [/ip/route/find dst-address=86.109.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.109.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24631 }
:if ([:len [/ip/route/find dst-address=86.109.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.109.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24631 }
