...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=213.187.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.187.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24753 }
:if ([:len [/ip/route/find dst-address=213.187.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.187.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24753 }
...
:if ([:len [/ip/route/find dst-address=89.21.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.21.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24753 }
