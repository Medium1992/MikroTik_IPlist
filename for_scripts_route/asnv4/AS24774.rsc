...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24774 and dst-address=for_scripts_route/asnv4/AS24774.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24774.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24774 }
