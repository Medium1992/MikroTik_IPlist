...
:if ([:len [/ip/route/find dst-address=62.241.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.241.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24863 }
:if ([:len [/ip/route/find dst-address=62.241.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.241.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24863 }
:if ([:len [/ip/route/find dst-address=62.241.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.241.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24863 }
:if ([:len [/ip/route/find dst-address=62.241.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.241.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24863 }
:if ([:len [/ip/route/find dst-address=62.241.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.241.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24863 }
