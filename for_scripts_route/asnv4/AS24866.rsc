...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24866 and dst-address=for_scripts_route/asnv4/AS24866.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24866.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24866 }
