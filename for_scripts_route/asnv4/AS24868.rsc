...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24868 and dst-address=for_scripts_route/asnv4/AS24868.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24868.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24868 }
