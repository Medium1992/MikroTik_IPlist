...
:if ([:len [/ip/route/find dst-address=80.89.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.89.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24875 }
...
:if ([:len [/ip/route/find dst-address=80.89.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.89.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24875 }
...
:if ([:len [/ip/route/find dst-address=89.105.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.105.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24875 }
