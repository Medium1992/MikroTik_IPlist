...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS24893 and dst-address=for_scripts_route/asnv4/AS24893.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS24893.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS24893 }
