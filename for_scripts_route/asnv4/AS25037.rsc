...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=77.80.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.80.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25037 }
:if ([:len [/ip/route/find dst-address=77.80.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.80.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25037 }
:if ([:len [/ip/route/find dst-address=77.80.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.80.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25037 }
