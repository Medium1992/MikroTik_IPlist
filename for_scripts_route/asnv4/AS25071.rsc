...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25071 and dst-address=for_scripts_route/asnv4/AS25071.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25071.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25071 }
