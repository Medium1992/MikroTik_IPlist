...
:if ([:len [/ip/route/find dst-address=46.102.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.102.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25091 }
:if ([:len [/ip/route/find dst-address=46.174.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.174.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25091 }
...
:if ([:len [/ip/route/find dst-address=5.144.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.144.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25091 }
