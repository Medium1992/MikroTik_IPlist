...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25091 and dst-address=for_scripts_route/asnv4/AS25091.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25091.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25091 }
