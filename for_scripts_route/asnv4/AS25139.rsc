...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25139 and dst-address=for_scripts_route/asnv4/AS25139.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25139.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25139 }
