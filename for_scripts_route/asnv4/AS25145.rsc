...
:if ([:len [/ip/route/find dst-address=185.231.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.231.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
...
:if ([:len [/ip/route/find dst-address=213.144.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.144.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
:if ([:len [/ip/route/find dst-address=213.144.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.144.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
:if ([:len [/ip/route/find dst-address=213.144.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.144.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
:if ([:len [/ip/route/find dst-address=213.144.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.144.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
:if ([:len [/ip/route/find dst-address=213.144.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.144.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
:if ([:len [/ip/route/find dst-address=213.144.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.144.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
...
:if ([:len [/ip/route/find dst-address=77.92.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.92.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
:if ([:len [/ip/route/find dst-address=77.92.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.92.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
:if ([:len [/ip/route/find dst-address=77.92.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.92.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25145 }
