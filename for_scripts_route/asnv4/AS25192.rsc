...
:if ([:len [/ip/route/find dst-address=185.43.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.43.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25192 }
:if ([:len [/ip/route/find dst-address=193.29.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.29.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25192 }
