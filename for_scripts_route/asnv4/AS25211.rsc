...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.160.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.160.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
...
:if ([:len [/ip/route/find dst-address=45.141.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.141.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=45.141.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.141.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
...
:if ([:len [/ip/route/find dst-address=78.159.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.159.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=78.159.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.159.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=78.159.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.159.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
...
:if ([:len [/ip/route/find dst-address=93.152.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.152.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=93.152.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.152.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=93.152.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.152.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=93.152.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.152.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=93.152.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.152.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
...
:if ([:len [/ip/route/find dst-address=94.26.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
