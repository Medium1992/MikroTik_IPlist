...
:if ([:len [/ip/route/find dst-address=94.26.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
...
:if ([:len [/ip/route/find dst-address=94.26.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
:if ([:len [/ip/route/find dst-address=94.26.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
...
:if ([:len [/ip/route/find dst-address=94.26.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25211 }
