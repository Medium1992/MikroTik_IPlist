...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25231 and dst-address=for_scripts_route/asnv4/AS25231.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25231.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25231 }
