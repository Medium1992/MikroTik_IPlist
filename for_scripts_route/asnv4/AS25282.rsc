...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25282 and dst-address=for_scripts_route/asnv4/AS25282.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25282.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25282 }
