...
:if ([:len [/ip/route/find dst-address=81.29.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.29.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25364 }
:if ([:len [/ip/route/find dst-address=81.29.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.29.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25364 }
