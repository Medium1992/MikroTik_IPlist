...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25409 and dst-address=for_scripts_route/asnv4/AS25409.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25409.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25409 }
