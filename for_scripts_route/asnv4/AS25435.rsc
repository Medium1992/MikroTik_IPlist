...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25435 and dst-address=for_scripts_route/asnv4/AS25435.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25435.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25435 }
