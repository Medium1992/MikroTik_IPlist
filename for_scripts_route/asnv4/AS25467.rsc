...
:if ([:len [/ip/route/find dst-address=82.214.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.214.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
...
:if ([:len [/ip/route/find dst-address=95.180.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.180.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
