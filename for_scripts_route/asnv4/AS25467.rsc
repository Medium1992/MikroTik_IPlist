...
:if ([:len [/ip/route/find dst-address=188.190.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.190.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
...
:if ([:len [/ip/route/find dst-address=82.214.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.214.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
:if ([:len [/ip/route/find dst-address=82.214.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.214.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
:if ([:len [/ip/route/find dst-address=82.214.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.214.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
:if ([:len [/ip/route/find dst-address=82.214.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.214.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
:if ([:len [/ip/route/find dst-address=82.214.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.214.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25467 }
