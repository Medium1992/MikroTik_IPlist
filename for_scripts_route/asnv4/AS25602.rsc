...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25602 and dst-address=for_scripts_route/asnv4/AS25602.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25602.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25602 }
