...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=170.77.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.77.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25611 }
...
:if ([:len [/ip/route/find dst-address=9.179.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=9.179.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25611 }
