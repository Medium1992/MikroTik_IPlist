...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25657 and dst-address=for_scripts_route/asnv4/AS25657.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25657.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25657 }
