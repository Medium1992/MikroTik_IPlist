...
:if ([:len [/ip/route/find dst-address=192.23.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.23.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2567 }
...
:if ([:len [/ip/route/find dst-address=195.19.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.19.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2567 }
