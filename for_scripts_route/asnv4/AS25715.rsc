...
:if ([:len [/ip/route/find dst-address=74.188.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25715 }
:if ([:len [/ip/route/find dst-address=74.188.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25715 }
:if ([:len [/ip/route/find dst-address=74.188.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25715 }
:if ([:len [/ip/route/find dst-address=74.188.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25715 }
:if ([:len [/ip/route/find dst-address=74.188.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.188.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25715 }
