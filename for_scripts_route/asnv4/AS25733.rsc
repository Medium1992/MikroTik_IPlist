...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25733 and dst-address=for_scripts_route/asnv4/AS25733.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25733.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25733 }
