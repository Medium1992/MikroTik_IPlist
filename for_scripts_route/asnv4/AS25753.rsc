...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25753 and dst-address=for_scripts_route/asnv4/AS25753.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25753.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25753 }
