...
:if ([:len [/ip/route/find dst-address=74.123.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.123.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25787 }
:if ([:len [/ip/route/find dst-address=74.123.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.123.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25787 }
