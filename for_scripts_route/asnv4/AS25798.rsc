...
:if ([:len [/ip/route/find dst-address=38.158.135.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
:if ([:len [/ip/route/find dst-address=38.158.135.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
:if ([:len [/ip/route/find dst-address=38.158.135.64/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.64/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
:if ([:len [/ip/route/find dst-address=38.158.135.72/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.72/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
:if ([:len [/ip/route/find dst-address=38.158.135.76/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.76/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
:if ([:len [/ip/route/find dst-address=38.158.135.78/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.78/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
:if ([:len [/ip/route/find dst-address=38.158.135.80/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.80/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
:if ([:len [/ip/route/find dst-address=38.158.135.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.158.135.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25798 }
