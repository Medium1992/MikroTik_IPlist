...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=72.19.36.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.36.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
:if ([:len [/ip/route/find dst-address=72.19.36.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.36.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
:if ([:len [/ip/route/find dst-address=72.19.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
:if ([:len [/ip/route/find dst-address=72.19.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
:if ([:len [/ip/route/find dst-address=72.19.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
:if ([:len [/ip/route/find dst-address=72.19.58.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.58.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
:if ([:len [/ip/route/find dst-address=72.19.58.128/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.58.128/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
:if ([:len [/ip/route/find dst-address=72.19.58.144/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.58.144/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25840 }
