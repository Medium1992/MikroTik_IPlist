...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS25871 and dst-address=for_scripts_route/asnv4/AS25871.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS25871.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25871 }
