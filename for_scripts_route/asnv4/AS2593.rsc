...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS2593 and dst-address=for_scripts_route/asnv4/AS2593.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS2593.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2593 }
