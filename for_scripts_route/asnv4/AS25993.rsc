...
:if ([:len [/ip/route/find dst-address=144.60.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.60.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25993 }
:if ([:len [/ip/route/find dst-address=144.60.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.60.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25993 }
...
:if ([:len [/ip/route/find dst-address=32.139.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.139.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS25993 }
