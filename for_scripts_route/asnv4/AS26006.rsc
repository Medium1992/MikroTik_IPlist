...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26006 and dst-address=for_scripts_route/asnv4/AS26006.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26006.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26006 }
