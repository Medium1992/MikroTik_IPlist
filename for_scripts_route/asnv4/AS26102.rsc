...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26102 and dst-address=for_scripts_route/asnv4/AS26102.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26102.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26102 }
