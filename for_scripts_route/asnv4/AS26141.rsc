...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=107.148.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.148.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26141 }
...
:if ([:len [/ip/route/find dst-address=108.186.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.186.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26141 }
:if ([:len [/ip/route/find dst-address=142.111.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.111.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26141 }
:if ([:len [/ip/route/find dst-address=144.225.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26141 }
