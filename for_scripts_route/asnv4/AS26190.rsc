...
:if ([:len [/ip/route/find dst-address=157.248.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.248.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26190 }
:if ([:len [/ip/route/find dst-address=157.248.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.248.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26190 }
