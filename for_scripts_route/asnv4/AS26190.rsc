...
:if ([:len [/ip/route/find dst-address=157.248.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.248.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26190 }
:if ([:len [/ip/route/find dst-address=157.248.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.248.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26190 }
:if ([:len [/ip/route/find dst-address=157.248.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.248.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26190 }
