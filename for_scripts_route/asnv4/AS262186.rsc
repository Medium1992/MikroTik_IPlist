...
:if ([:len [/ip/route/find dst-address=209.14.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.14.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262186 }
:if ([:len [/ip/route/find dst-address=209.14.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.14.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262186 }
:if ([:len [/ip/route/find dst-address=209.14.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.14.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262186 }
...
:if ([:len [/ip/route/find dst-address=45.170.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.170.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262186 }
