...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262187 and dst-address=for_scripts_route/asnv4/AS262187.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262187.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262187 }
