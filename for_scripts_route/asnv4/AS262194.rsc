...
:if ([:len [/ip/route/find dst-address=190.109.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.109.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262194 }
...
:if ([:len [/ip/route/find dst-address=190.109.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.109.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262194 }
