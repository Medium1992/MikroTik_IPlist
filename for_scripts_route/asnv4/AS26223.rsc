...
:if ([:len [/ip/route/find dst-address=38.41.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.41.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26223 }
:if ([:len [/ip/route/find dst-address=38.41.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.41.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26223 }
:if ([:len [/ip/route/find dst-address=38.41.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.41.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26223 }
:if ([:len [/ip/route/find dst-address=38.41.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.41.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26223 }
