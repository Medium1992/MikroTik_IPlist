...
:if ([:len [/ip/route/find dst-address=204.10.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.10.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26225 }
:if ([:len [/ip/route/find dst-address=204.10.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.10.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26225 }
