...
:if ([:len [/ip/route/find dst-address=209.45.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.45.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262253 }
...
:if ([:len [/ip/route/find dst-address=209.45.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.45.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262253 }
