...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262262 and dst-address=for_scripts_route/asnv4/AS262262.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262262.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262262 }
