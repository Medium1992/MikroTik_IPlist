...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262285 and dst-address=for_scripts_route/asnv4/AS262285.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262285.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262285 }
