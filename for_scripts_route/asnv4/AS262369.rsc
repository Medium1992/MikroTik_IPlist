...
:if ([:len [/ip/route/find dst-address=170.247.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.247.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262369 }
:if ([:len [/ip/route/find dst-address=170.247.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.247.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262369 }
