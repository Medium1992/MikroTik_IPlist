...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262379 and dst-address=for_scripts_route/asnv4/AS262379.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262379.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262379 }
