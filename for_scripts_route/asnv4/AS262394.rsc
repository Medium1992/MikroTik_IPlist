...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262394 and dst-address=for_scripts_route/asnv4/AS262394.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262394.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262394 }
