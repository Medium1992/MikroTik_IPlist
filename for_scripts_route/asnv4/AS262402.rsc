...
:if ([:len [/ip/route/find dst-address=177.38.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.38.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262402 }
...
:if ([:len [/ip/route/find dst-address=177.38.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.38.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262402 }
