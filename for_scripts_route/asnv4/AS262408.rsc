...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262408 and dst-address=for_scripts_route/asnv4/AS262408.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262408.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262408 }
