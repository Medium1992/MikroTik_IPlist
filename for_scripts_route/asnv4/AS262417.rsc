...
:if ([:len [/ip/route/find dst-address=177.125.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.125.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262417 }
...
:if ([:len [/ip/route/find dst-address=186.209.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.209.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262417 }
:if ([:len [/ip/route/find dst-address=186.209.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.209.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262417 }
...
:if ([:len [/ip/route/find dst-address=45.164.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.164.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262417 }
