...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262424 and dst-address=for_scripts_route/asnv4/AS262424.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262424.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262424 }
