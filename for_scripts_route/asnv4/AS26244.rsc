...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26244 and dst-address=for_scripts_route/asnv4/AS26244.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26244.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26244 }
