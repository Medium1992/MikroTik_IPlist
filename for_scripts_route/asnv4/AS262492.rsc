...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262492 and dst-address=for_scripts_route/asnv4/AS262492.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262492.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262492 }
