...
:if ([:len [/ip/route/find dst-address=38.236.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.236.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262503 }
:if ([:len [/ip/route/find dst-address=38.236.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.236.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262503 }
