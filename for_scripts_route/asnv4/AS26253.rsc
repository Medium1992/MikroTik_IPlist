...
:if ([:len [/ip/route/find dst-address=199.101.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.160/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.160/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.176/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.176/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.184/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.184/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.188/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.188/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.190/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.190/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.205.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.205.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
:if ([:len [/ip/route/find dst-address=199.101.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26253 }
