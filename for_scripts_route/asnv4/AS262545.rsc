...
:if ([:len [/ip/route/find dst-address=187.33.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.33.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262545 }
:if ([:len [/ip/route/find dst-address=187.33.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.33.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262545 }
:if ([:len [/ip/route/find dst-address=187.33.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.33.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262545 }
