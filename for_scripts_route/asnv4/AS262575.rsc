...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262575 and dst-address=for_scripts_route/asnv4/AS262575.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262575.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262575 }
