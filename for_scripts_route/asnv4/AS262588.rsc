...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262588 and dst-address=for_scripts_route/asnv4/AS262588.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262588.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262588 }
