...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262597 and dst-address=for_scripts_route/asnv4/AS262597.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262597.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262597 }
