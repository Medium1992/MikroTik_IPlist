...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262617 and dst-address=for_scripts_route/asnv4/AS262617.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262617.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262617 }
