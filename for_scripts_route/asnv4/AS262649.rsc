...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262649 and dst-address=for_scripts_route/asnv4/AS262649.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262649.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262649 }
