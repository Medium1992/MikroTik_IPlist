...
:if ([:len [/ip/route/find dst-address=186.216.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=186.216.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=186.216.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=187.62.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.62.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
