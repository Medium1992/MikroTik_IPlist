...
:if ([:len [/ip/route/find dst-address=186.216.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=186.216.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=186.216.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=186.216.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
