...
:if ([:len [/ip/route/find dst-address=186.216.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=186.216.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=186.216.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=186.216.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=186.216.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=186.216.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=187.62.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.62.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=187.62.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.62.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=187.62.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.62.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
:if ([:len [/ip/route/find dst-address=187.62.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.62.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=38.199.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.199.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
