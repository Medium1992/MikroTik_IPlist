...
:if ([:len [/ip/route/find dst-address=186.216.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
...
:if ([:len [/ip/route/find dst-address=186.216.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.216.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262663 }
