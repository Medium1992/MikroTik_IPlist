...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262669 and dst-address=for_scripts_route/asnv4/AS262669.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262669.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262669 }
