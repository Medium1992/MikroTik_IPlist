...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262728 and dst-address=for_scripts_route/asnv4/AS262728.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262728.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262728 }
