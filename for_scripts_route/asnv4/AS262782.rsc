...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262782 and dst-address=for_scripts_route/asnv4/AS262782.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262782.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262782 }
