...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262821 and dst-address=for_scripts_route/asnv4/AS262821.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262821.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262821 }
