...
:if ([:len [/ip/route/find dst-address=181.233.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.233.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262875 }
...
:if ([:len [/ip/route/find dst-address=45.6.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.6.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262875 }
