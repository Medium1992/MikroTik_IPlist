...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS262988 and dst-address=for_scripts_route/asnv4/AS262988.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS262988.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS262988 }
