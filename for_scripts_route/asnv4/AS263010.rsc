...
:if ([:len [/ip/route/find dst-address=168.196.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.196.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263010 }
:if ([:len [/ip/route/find dst-address=168.196.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.196.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263010 }
