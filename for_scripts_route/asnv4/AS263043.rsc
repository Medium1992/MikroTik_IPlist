...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263043 and dst-address=for_scripts_route/asnv4/AS263043.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263043.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263043 }
