...
:if ([:len [/ip/route/find dst-address=138.99.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.99.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263077 }
...
:if ([:len [/ip/route/find dst-address=168.195.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.195.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263077 }
...
:if ([:len [/ip/route/find dst-address=177.70.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.70.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263077 }
:if ([:len [/ip/route/find dst-address=177.70.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.70.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263077 }
:if ([:len [/ip/route/find dst-address=177.75.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.75.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263077 }
:if ([:len [/ip/route/find dst-address=177.75.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.75.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263077 }
