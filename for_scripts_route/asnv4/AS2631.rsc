...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=157.166.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.166.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2631 }
:if ([:len [/ip/route/find dst-address=157.166.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.166.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2631 }
:if ([:len [/ip/route/find dst-address=157.166.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.166.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2631 }
...
:if ([:len [/ip/route/find dst-address=157.166.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.166.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2631 }
:if ([:len [/ip/route/find dst-address=157.166.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.166.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2631 }
