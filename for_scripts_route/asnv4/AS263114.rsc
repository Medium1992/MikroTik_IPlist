...
:if ([:len [/ip/route/find dst-address=201.139.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.139.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263114 }
...
:if ([:len [/ip/route/find dst-address=201.139.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.139.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263114 }
