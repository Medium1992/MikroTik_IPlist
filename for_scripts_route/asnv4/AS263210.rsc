...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=179.51.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.51.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263210 }
:if ([:len [/ip/route/find dst-address=179.51.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.51.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263210 }
:if ([:len [/ip/route/find dst-address=179.51.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.51.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263210 }
:if ([:len [/ip/route/find dst-address=179.51.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.51.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263210 }
...
:if ([:len [/ip/route/find dst-address=179.51.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.51.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263210 }
