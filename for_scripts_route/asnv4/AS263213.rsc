...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=170.238.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.238.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263213 }
:if ([:len [/ip/route/find dst-address=170.238.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.238.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263213 }
