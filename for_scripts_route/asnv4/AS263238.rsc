...
:if ([:len [/ip/route/find dst-address=2.152.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.152.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263238 }
...
:if ([:len [/ip/route/find dst-address=200.76.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.76.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263238 }
