...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26324 and dst-address=for_scripts_route/asnv4/AS26324.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26324.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26324 }
