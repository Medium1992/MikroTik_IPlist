...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26328 and dst-address=for_scripts_route/asnv4/AS26328.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26328.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26328 }
