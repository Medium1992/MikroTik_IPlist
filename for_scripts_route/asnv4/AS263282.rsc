...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263282 and dst-address=for_scripts_route/asnv4/AS263282.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263282.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263282 }
