...
:if ([:len [/ip/route/find dst-address=129.121.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.121.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26337 }
...
:if ([:len [/ip/route/find dst-address=129.121.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.121.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26337 }
:if ([:len [/ip/route/find dst-address=129.121.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=129.121.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26337 }
