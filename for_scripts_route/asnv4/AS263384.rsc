...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263384 and dst-address=for_scripts_route/asnv4/AS263384.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263384.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263384 }
