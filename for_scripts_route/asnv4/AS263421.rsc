...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263421 and dst-address=for_scripts_route/asnv4/AS263421.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263421.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263421 }
