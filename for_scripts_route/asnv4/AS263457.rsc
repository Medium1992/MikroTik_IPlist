...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263457 and dst-address=for_scripts_route/asnv4/AS263457.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263457.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263457 }
