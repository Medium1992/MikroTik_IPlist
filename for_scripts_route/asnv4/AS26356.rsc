...
:if ([:len [/ip/route/find dst-address=160.211.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
:if ([:len [/ip/route/find dst-address=160.211.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
