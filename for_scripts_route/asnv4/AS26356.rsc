...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=160.211.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
...
:if ([:len [/ip/route/find dst-address=160.211.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
:if ([:len [/ip/route/find dst-address=160.211.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
:if ([:len [/ip/route/find dst-address=160.211.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
:if ([:len [/ip/route/find dst-address=160.211.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
:if ([:len [/ip/route/find dst-address=160.211.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
:if ([:len [/ip/route/find dst-address=160.211.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.211.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26356 }
