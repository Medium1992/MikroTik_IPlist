...
:if ([:len [/ip/route/find dst-address=201.55.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.55.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263579 }
:if ([:len [/ip/route/find dst-address=201.55.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.55.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263579 }
