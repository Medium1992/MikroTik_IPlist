...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263656 and dst-address=for_scripts_route/asnv4/AS263656.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263656.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263656 }
