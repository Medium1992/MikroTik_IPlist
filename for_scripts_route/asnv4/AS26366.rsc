...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26366 and dst-address=for_scripts_route/asnv4/AS26366.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26366.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26366 }
