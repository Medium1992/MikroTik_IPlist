...
:if ([:len [/ip/route/find dst-address=200.0.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.0.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263684 }
...
:if ([:len [/ip/route/find dst-address=200.115.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.115.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263684 }
:if ([:len [/ip/route/find dst-address=200.115.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.115.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263684 }
...
:if ([:len [/ip/route/find dst-address=38.10.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.10.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263684 }
