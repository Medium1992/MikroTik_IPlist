...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263726 and dst-address=for_scripts_route/asnv4/AS263726.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263726.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263726 }
