...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=166.1.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.1.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263767 }
:if ([:len [/ip/route/find dst-address=166.1.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.1.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263767 }
...
:if ([:len [/ip/route/find dst-address=201.10.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.10.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263767 }
