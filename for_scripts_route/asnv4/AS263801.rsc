...
:if ([:len [/ip/route/find dst-address=149.78.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263801 }
...
:if ([:len [/ip/route/find dst-address=149.78.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263801 }
