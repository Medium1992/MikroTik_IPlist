...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263809 and dst-address=for_scripts_route/asnv4/AS263809.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263809.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263809 }
