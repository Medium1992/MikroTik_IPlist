...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.255.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.255.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263824 }
:if ([:len [/ip/route/find dst-address=131.255.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.255.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263824 }
