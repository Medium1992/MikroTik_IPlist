...
:if ([:len [/ip/route/find dst-address=165.173.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.173.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
:if ([:len [/ip/route/find dst-address=165.173.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.173.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
:if ([:len [/ip/route/find dst-address=165.173.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.173.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
:if ([:len [/ip/route/find dst-address=165.173.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.173.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
...
:if ([:len [/ip/route/find dst-address=199.67.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.67.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
:if ([:len [/ip/route/find dst-address=199.67.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.67.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
