...
:if ([:len [/ip/route/find dst-address=136.143.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.143.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
...
:if ([:len [/ip/route/find dst-address=165.173.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.173.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
:if ([:len [/ip/route/find dst-address=165.173.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.173.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
:if ([:len [/ip/route/find dst-address=165.173.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.173.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2639 }
