...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263966 and dst-address=for_scripts_route/asnv4/AS263966.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263966.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263966 }
