...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS263991 and dst-address=for_scripts_route/asnv4/AS263991.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS263991.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS263991 }
