...
:if ([:len [/ip/route/find dst-address=199.36.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.36.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26405 }
...
:if ([:len [/ip/route/find dst-address=74.124.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.124.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26405 }
