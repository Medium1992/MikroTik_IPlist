...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264106 and dst-address=for_scripts_route/asnv4/AS264106.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264106.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264106 }
