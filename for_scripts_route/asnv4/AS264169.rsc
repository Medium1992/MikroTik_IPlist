...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264169 and dst-address=for_scripts_route/asnv4/AS264169.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264169.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264169 }
