...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264212 and dst-address=for_scripts_route/asnv4/AS264212.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264212.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264212 }
