...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264432 and dst-address=for_scripts_route/asnv4/AS264432.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264432.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264432 }
