...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264446 and dst-address=for_scripts_route/asnv4/AS264446.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264446.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264446 }
