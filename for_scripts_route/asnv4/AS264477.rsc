...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264477 and dst-address=for_scripts_route/asnv4/AS264477.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264477.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264477 }
