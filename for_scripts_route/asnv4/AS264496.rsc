...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264496 and dst-address=for_scripts_route/asnv4/AS264496.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264496.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264496 }
