...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264508 and dst-address=for_scripts_route/asnv4/AS264508.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264508.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264508 }
