...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264524 and dst-address=for_scripts_route/asnv4/AS264524.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264524.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264524 }
