...
:if ([:len [/ip/route/find dst-address=191.128.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.128.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264562 }
:if ([:len [/ip/route/find dst-address=191.128.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.128.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264562 }
:if ([:len [/ip/route/find dst-address=191.128.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.128.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264562 }
