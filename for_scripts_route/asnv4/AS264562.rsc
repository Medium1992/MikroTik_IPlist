...
:if ([:len [/ip/route/find dst-address=45.239.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.239.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264562 }
:if ([:len [/ip/route/find dst-address=45.239.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.239.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264562 }
