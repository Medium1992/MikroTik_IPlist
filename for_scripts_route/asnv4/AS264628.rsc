...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264628 and dst-address=for_scripts_route/asnv4/AS264628.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264628.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264628 }
