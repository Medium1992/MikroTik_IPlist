...
:if ([:len [/ip/route/find dst-address=165.225.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.225.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26464 }
:if ([:len [/ip/route/find dst-address=165.225.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.225.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26464 }
...
:if ([:len [/ip/route/find dst-address=64.30.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.30.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26464 }
