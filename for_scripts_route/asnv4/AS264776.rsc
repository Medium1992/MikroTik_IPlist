...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264776 and dst-address=for_scripts_route/asnv4/AS264776.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264776.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264776 }
