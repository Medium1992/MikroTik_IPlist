...
:if ([:len [/ip/route/find dst-address=200.12.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.12.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264780 }
...
:if ([:len [/ip/route/find dst-address=200.126.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.126.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264780 }
:if ([:len [/ip/route/find dst-address=200.126.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.126.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264780 }
:if ([:len [/ip/route/find dst-address=45.165.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.165.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264780 }
