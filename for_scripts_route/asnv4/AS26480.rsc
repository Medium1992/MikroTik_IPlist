...
:if ([:len [/ip/route/find dst-address=66.254.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.254.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26480 }
:if ([:len [/ip/route/find dst-address=66.254.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.254.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26480 }
:if ([:len [/ip/route/find dst-address=66.254.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.254.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26480 }
