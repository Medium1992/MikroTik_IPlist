...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264830 and dst-address=for_scripts_route/asnv4/AS264830.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264830.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264830 }
