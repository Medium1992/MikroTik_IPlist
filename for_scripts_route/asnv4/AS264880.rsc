...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS264880 and dst-address=for_scripts_route/asnv4/AS264880.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS264880.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS264880 }
