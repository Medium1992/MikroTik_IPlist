...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=207.233.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.233.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26492 }
...
:if ([:len [/ip/route/find dst-address=207.233.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.233.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26492 }
...
:if ([:len [/ip/route/find dst-address=207.233.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.233.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26492 }
...
:if ([:len [/ip/route/find dst-address=207.62.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.62.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26492 }
