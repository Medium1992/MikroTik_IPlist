...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=143.255.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.255.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265141 }
:if ([:len [/ip/route/find dst-address=143.255.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.255.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265141 }
