...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265171 and dst-address=for_scripts_route/asnv4/AS265171.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265171.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265171 }
