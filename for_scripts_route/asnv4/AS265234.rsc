...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265234 and dst-address=for_scripts_route/asnv4/AS265234.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265234.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265234 }
