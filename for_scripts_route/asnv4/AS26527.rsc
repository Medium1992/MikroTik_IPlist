...
:if ([:len [/ip/route/find dst-address=69.166.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.166.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26527 }
:if ([:len [/ip/route/find dst-address=70.35.159.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.159.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26527 }
