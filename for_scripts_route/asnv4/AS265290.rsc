...
:if ([:len [/ip/route/find dst-address=177.46.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265290 }
:if ([:len [/ip/route/find dst-address=177.71.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.71.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265290 }
