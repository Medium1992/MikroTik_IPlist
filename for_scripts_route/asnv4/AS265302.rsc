...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265302 and dst-address=for_scripts_route/asnv4/AS265302.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265302.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265302 }
