...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265418 and dst-address=for_scripts_route/asnv4/AS265418.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265418.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265418 }
