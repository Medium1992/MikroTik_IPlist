...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265432 and dst-address=for_scripts_route/asnv4/AS265432.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265432.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265432 }
