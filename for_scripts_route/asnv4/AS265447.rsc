...
:if ([:len [/ip/route/find dst-address=45.70.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.70.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265447 }
:if ([:len [/ip/route/find dst-address=45.70.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.70.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265447 }
