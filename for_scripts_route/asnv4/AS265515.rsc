...
:if ([:len [/ip/route/find dst-address=138.36.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.36.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265515 }
...
:if ([:len [/ip/route/find dst-address=176.227.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.227.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265515 }
:if ([:len [/ip/route/find dst-address=176.227.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.227.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265515 }
:if ([:len [/ip/route/find dst-address=200.108.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.108.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265515 }
...
:if ([:len [/ip/route/find dst-address=95.210.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.210.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265515 }
:if ([:len [/ip/route/find dst-address=95.210.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.210.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265515 }
