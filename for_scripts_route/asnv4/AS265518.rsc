...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265518 and dst-address=for_scripts_route/asnv4/AS265518.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265518.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265518 }
