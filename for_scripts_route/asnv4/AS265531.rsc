...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265531 and dst-address=for_scripts_route/asnv4/AS265531.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265531.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265531 }
