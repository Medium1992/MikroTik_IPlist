...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=152.55.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.55.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265540 }
:if ([:len [/ip/route/find dst-address=152.55.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.55.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265540 }
:if ([:len [/ip/route/find dst-address=152.55.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.55.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265540 }
