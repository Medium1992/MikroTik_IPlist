...
:if ([:len [/ip/route/find dst-address=204.157.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.157.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265561 }
:if ([:len [/ip/route/find dst-address=209.178.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.178.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265561 }
:if ([:len [/ip/route/find dst-address=209.178.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.178.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265561 }
:if ([:len [/ip/route/find dst-address=209.178.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.178.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265561 }
:if ([:len [/ip/route/find dst-address=209.178.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.178.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265561 }
