...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265725 and dst-address=for_scripts_route/asnv4/AS265725.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265725.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265725 }
