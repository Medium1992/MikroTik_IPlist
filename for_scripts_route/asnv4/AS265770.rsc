...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS265770 and dst-address=for_scripts_route/asnv4/AS265770.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS265770.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265770 }
