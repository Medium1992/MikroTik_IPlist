...
:if ([:len [/ip/route/find dst-address=38.51.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.51.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265855 }
:if ([:len [/ip/route/find dst-address=38.51.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.51.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265855 }
