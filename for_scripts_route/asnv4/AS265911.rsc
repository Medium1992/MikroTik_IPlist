...
:if ([:len [/ip/route/find dst-address=186.250.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.250.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265911 }
:if ([:len [/ip/route/find dst-address=186.250.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.250.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS265911 }
