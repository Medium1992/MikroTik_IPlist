...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266044 and dst-address=for_scripts_route/asnv4/AS266044.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266044.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266044 }
