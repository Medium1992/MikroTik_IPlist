...
:if ([:len [/ip/route/find dst-address=191.242.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.242.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266181 }
:if ([:len [/ip/route/find dst-address=191.242.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.242.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266181 }
