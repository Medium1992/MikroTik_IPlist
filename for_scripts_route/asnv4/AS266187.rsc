...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266187 and dst-address=for_scripts_route/asnv4/AS266187.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266187.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266187 }
