...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266192 and dst-address=for_scripts_route/asnv4/AS266192.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266192.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266192 }
