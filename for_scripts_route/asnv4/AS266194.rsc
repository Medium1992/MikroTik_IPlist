...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266194 and dst-address=for_scripts_route/asnv4/AS266194.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266194.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266194 }
