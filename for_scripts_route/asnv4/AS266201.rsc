...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266201 and dst-address=for_scripts_route/asnv4/AS266201.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266201.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266201 }
