...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266228 and dst-address=for_scripts_route/asnv4/AS266228.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266228.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266228 }
