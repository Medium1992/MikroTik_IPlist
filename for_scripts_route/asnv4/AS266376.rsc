...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266376 and dst-address=for_scripts_route/asnv4/AS266376.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266376.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266376 }
