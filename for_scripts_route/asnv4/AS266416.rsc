...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266416 and dst-address=for_scripts_route/asnv4/AS266416.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266416.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266416 }
