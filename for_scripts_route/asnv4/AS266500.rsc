...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266500 and dst-address=for_scripts_route/asnv4/AS266500.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266500.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266500 }
