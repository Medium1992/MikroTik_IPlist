...
:if ([:len [/ip/route/find dst-address=192.110.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.64/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.64/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.72/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.72/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.76/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.76/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.78/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.78/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.80/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.80/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.202.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.202.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
:if ([:len [/ip/route/find dst-address=192.110.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.110.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26652 }
