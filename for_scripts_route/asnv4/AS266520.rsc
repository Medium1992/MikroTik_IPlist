...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266520 and dst-address=for_scripts_route/asnv4/AS266520.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266520.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266520 }
