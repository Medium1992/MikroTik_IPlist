...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26663 and dst-address=for_scripts_route/asnv4/AS26663.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26663.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26663 }
