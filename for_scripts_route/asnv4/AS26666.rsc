...
:if ([:len [/ip/route/find dst-address=207.180.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.180.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26666 }
...
:if ([:len [/ip/route/find dst-address=23.136.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.136.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26666 }
:if ([:len [/ip/route/find dst-address=45.128.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.128.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26666 }
...
:if ([:len [/ip/route/find dst-address=69.169.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.169.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26666 }
:if ([:len [/ip/route/find dst-address=74.1.233.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.233.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26666 }
:if ([:len [/ip/route/find dst-address=74.1.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26666 }
