...
:if ([:len [/ip/route/find dst-address=192.203.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.203.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26667 }
...
:if ([:len [/ip/route/find dst-address=69.173.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.173.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26667 }
