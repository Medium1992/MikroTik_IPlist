...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266841 and dst-address=for_scripts_route/asnv4/AS266841.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266841.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266841 }
