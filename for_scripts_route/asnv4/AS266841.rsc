...
:if ([:len [/ip/route/find dst-address=38.121.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.121.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266841 }
:if ([:len [/ip/route/find dst-address=38.121.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.121.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266841 }
:if ([:len [/ip/route/find dst-address=38.121.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.121.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266841 }
