...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26685 and dst-address=for_scripts_route/asnv4/AS26685.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26685.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26685 }
