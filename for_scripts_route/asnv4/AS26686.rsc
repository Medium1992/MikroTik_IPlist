...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26686 and dst-address=for_scripts_route/asnv4/AS26686.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26686.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26686 }
