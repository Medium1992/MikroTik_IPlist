...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS266871 and dst-address=for_scripts_route/asnv4/AS266871.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS266871.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS266871 }
