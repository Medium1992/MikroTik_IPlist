...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS267003 and dst-address=for_scripts_route/asnv4/AS267003.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS267003.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267003 }
