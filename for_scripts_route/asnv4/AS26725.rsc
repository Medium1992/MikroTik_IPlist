...
:if ([:len [/ip/route/find dst-address=149.120.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.120.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26725 }
:if ([:len [/ip/route/find dst-address=149.120.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.120.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26725 }
...
:if ([:len [/ip/route/find dst-address=209.152.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.152.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26725 }
