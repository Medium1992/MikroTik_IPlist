...
:if ([:len [/ip/route/find dst-address=178.95.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.95.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26737 }
...
:if ([:len [/ip/route/find dst-address=82.29.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.29.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26737 }
