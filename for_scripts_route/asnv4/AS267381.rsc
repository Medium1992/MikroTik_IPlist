...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS267381 and dst-address=for_scripts_route/asnv4/AS267381.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS267381.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267381 }
