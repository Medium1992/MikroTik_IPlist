...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=144.225.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26739 }
...
:if ([:len [/ip/route/find dst-address=178.83.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26739 }
...
:if ([:len [/ip/route/find dst-address=89.167.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.167.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26739 }
