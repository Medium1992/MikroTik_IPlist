...
:if ([:len [/ip/route/find dst-address=144.31.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.31.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26769 }
:if ([:len [/ip/route/find dst-address=185.253.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.253.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26769 }
...
:if ([:len [/ip/route/find dst-address=31.57.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26769 }
...
:if ([:len [/ip/route/find dst-address=96.126.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.126.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26769 }
