...
:if ([:len [/ip/route/find dst-address=186.65.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.65.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267706 }
...
:if ([:len [/ip/route/find dst-address=45.164.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.164.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267706 }
