...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS267730 and dst-address=for_scripts_route/asnv4/AS267730.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS267730.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267730 }
