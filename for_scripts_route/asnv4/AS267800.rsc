...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS267800 and dst-address=for_scripts_route/asnv4/AS267800.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS267800.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267800 }
