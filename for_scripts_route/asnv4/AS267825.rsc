...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS267825 and dst-address=for_scripts_route/asnv4/AS267825.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS267825.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267825 }
