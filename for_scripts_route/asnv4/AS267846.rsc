...
:if ([:len [/ip/route/find dst-address=154.41.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.41.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267846 }
:if ([:len [/ip/route/find dst-address=38.159.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267846 }
:if ([:len [/ip/route/find dst-address=38.159.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267846 }
:if ([:len [/ip/route/find dst-address=38.159.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267846 }
:if ([:len [/ip/route/find dst-address=38.159.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS267846 }
