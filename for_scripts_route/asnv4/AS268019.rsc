...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS268019 and dst-address=for_scripts_route/asnv4/AS268019.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS268019.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268019 }
