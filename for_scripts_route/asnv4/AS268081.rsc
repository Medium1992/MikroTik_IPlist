...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS268081 and dst-address=for_scripts_route/asnv4/AS268081.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS268081.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268081 }
