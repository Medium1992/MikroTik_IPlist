...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26819 and dst-address=for_scripts_route/asnv4/AS26819.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26819.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26819 }
