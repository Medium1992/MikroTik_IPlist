...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS268200 and dst-address=for_scripts_route/asnv4/AS268200.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS268200.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268200 }
