...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS268244 and dst-address=for_scripts_route/asnv4/AS268244.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS268244.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268244 }
