...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS268289 and dst-address=for_scripts_route/asnv4/AS268289.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS268289.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268289 }
