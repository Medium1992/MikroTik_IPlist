...
:if ([:len [/ip/route/find dst-address=104.241.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.241.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26832 }
...
:if ([:len [/ip/route/find dst-address=38.9.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.9.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26832 }
:if ([:len [/ip/route/find dst-address=78.17.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.17.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26832 }
:if ([:len [/ip/route/find dst-address=86.107.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.107.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26832 }
