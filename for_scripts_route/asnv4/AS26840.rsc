...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26840 and dst-address=for_scripts_route/asnv4/AS26840.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26840.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26840 }
