...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS268546 and dst-address=for_scripts_route/asnv4/AS268546.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS268546.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268546 }
