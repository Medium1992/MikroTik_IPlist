...
:if ([:len [/ip/route/find dst-address=144.225.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268624 }
...
:if ([:len [/ip/route/find dst-address=195.182.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.182.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268624 }
:if ([:len [/ip/route/find dst-address=2.27.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.27.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268624 }
:if ([:len [/ip/route/find dst-address=200.15.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.15.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268624 }
:if ([:len [/ip/route/find dst-address=200.15.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.15.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268624 }
...
:if ([:len [/ip/route/find dst-address=91.190.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.190.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268624 }
