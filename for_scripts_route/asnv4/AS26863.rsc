...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26863 and dst-address=for_scripts_route/asnv4/AS26863.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26863.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26863 }
