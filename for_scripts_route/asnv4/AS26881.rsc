...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26881 and dst-address=for_scripts_route/asnv4/AS26881.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26881.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26881 }
