...
:if ([:len [/ip/route/find dst-address=162.210.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.210.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26891 }
...
:if ([:len [/ip/route/find dst-address=64.25.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26891 }
