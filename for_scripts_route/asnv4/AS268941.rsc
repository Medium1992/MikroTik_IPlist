...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS268941 and dst-address=for_scripts_route/asnv4/AS268941.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS268941.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS268941 }
