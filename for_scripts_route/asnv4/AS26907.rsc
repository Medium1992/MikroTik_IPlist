...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26907 and dst-address=for_scripts_route/asnv4/AS26907.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26907.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26907 }
