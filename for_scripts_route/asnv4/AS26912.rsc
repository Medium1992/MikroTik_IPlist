...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26912 and dst-address=for_scripts_route/asnv4/AS26912.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26912.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26912 }
