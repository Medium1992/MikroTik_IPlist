...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS269182 and dst-address=for_scripts_route/asnv4/AS269182.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS269182.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269182 }
