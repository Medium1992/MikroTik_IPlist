...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=64.52.189.44/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.189.44/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.189.47/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.189.47/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.189.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.189.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.189.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.189.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.191.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.191.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.191.112/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.191.112/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.191.114/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.191.114/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.191.116/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.191.116/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
:if ([:len [/ip/route/find dst-address=64.52.191.120/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.191.120/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26919 }
