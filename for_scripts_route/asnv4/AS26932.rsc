...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.192.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.192.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26932 }
...
:if ([:len [/ip/route/find dst-address=38.74.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.74.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26932 }
:if ([:len [/ip/route/find dst-address=38.74.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.74.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26932 }
:if ([:len [/ip/route/find dst-address=38.74.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.74.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26932 }
:if ([:len [/ip/route/find dst-address=38.74.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.74.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26932 }
:if ([:len [/ip/route/find dst-address=38.80.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.80.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26932 }
