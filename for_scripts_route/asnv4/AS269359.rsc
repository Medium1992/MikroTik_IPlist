...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS269359 and dst-address=for_scripts_route/asnv4/AS269359.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS269359.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269359 }
