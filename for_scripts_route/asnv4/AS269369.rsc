...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS269369 and dst-address=for_scripts_route/asnv4/AS269369.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS269369.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269369 }
