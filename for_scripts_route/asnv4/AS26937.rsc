...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS26937 and dst-address=for_scripts_route/asnv4/AS26937.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS26937.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS26937 }
