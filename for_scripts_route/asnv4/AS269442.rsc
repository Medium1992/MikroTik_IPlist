...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS269442 and dst-address=for_scripts_route/asnv4/AS269442.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS269442.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269442 }
