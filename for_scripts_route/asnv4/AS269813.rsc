...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS269813 and dst-address=for_scripts_route/asnv4/AS269813.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS269813.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269813 }
