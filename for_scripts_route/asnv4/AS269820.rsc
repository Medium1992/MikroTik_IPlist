...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.41.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.41.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269820 }
:if ([:len [/ip/route/find dst-address=154.41.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.41.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269820 }
:if ([:len [/ip/route/find dst-address=154.41.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.41.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269820 }
...
:if ([:len [/ip/route/find dst-address=38.43.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.43.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269820 }
