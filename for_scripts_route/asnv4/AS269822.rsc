...
:if ([:len [/ip/route/find dst-address=185.104.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.104.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269822 }
:if ([:len [/ip/route/find dst-address=185.104.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.104.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269822 }
:if ([:len [/ip/route/find dst-address=185.91.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.91.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269822 }
:if ([:len [/ip/route/find dst-address=190.102.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.102.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269822 }
