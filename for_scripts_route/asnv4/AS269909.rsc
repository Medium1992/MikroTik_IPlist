...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.78.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269909 }
:if ([:len [/ip/route/find dst-address=149.78.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269909 }
:if ([:len [/ip/route/find dst-address=149.78.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269909 }
