...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS269915 and dst-address=for_scripts_route/asnv4/AS269915.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS269915.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269915 }
