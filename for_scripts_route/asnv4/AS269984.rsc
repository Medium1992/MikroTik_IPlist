...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS269984 and dst-address=for_scripts_route/asnv4/AS269984.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS269984.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS269984 }
