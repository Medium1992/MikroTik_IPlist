...
:if ([:len [/ip/route/find dst-address=65.39.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
...
:if ([:len [/ip/route/find dst-address=65.39.106.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.106.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
...
:if ([:len [/ip/route/find dst-address=65.39.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.64/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.64/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.80/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.80/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.85/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.85/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.86/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.86/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.88/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.88/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.98.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.98.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
:if ([:len [/ip/route/find dst-address=65.39.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.39.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27005 }
