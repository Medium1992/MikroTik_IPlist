...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS270087 and dst-address=for_scripts_route/asnv4/AS270087.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS270087.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270087 }
