...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS27009 and dst-address=for_scripts_route/asnv4/AS27009.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS27009.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27009 }
