...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS270147 and dst-address=for_scripts_route/asnv4/AS270147.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS270147.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270147 }
