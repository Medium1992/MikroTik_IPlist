...
:if ([:len [/ip/route/find dst-address=69.171.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.171.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270158 }
:if ([:len [/ip/route/find dst-address=69.171.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.171.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270158 }
...
:if ([:len [/ip/route/find dst-address=95.135.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.135.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270158 }
