...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.234.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.234.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270187 }
...
:if ([:len [/ip/route/find dst-address=38.199.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.199.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270187 }
...
:if ([:len [/ip/route/find dst-address=74.1.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270187 }
