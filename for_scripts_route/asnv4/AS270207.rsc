...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS270207 and dst-address=for_scripts_route/asnv4/AS270207.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS270207.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270207 }
