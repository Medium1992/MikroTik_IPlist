...
:if ([:len [/ip/route/find dst-address=167.102.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.102.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27026 }
:if ([:len [/ip/route/find dst-address=167.102.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.102.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27026 }
:if ([:len [/ip/route/find dst-address=167.102.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.102.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27026 }
