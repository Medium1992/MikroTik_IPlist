...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.234.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.234.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270564 }
...
:if ([:len [/ip/route/find dst-address=31.56.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.56.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270564 }
...
:if ([:len [/ip/route/find dst-address=50.114.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.114.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270564 }
:if ([:len [/ip/route/find dst-address=89.213.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270564 }
