...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS270623 and dst-address=for_scripts_route/asnv4/AS270623.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS270623.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270623 }
