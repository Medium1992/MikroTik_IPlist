...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS2707 and dst-address=for_scripts_route/asnv4/AS2707.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS2707.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2707 }
