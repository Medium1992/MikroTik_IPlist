...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS270801 and dst-address=for_scripts_route/asnv4/AS270801.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS270801.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS270801 }
