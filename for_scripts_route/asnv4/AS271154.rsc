...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271154 and dst-address=for_scripts_route/asnv4/AS271154.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271154.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271154 }
