...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271183 and dst-address=for_scripts_route/asnv4/AS271183.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271183.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271183 }
