...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=128.26.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.26.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
...
:if ([:len [/ip/route/find dst-address=198.218.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.218.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
:if ([:len [/ip/route/find dst-address=198.218.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.218.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
