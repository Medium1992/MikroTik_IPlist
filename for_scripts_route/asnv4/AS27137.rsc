...
:if ([:len [/ip/route/find dst-address=128.26.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.26.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
...
:if ([:len [/ip/route/find dst-address=198.218.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.218.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
:if ([:len [/ip/route/find dst-address=198.218.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.218.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
:if ([:len [/ip/route/find dst-address=198.218.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.218.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
:if ([:len [/ip/route/find dst-address=198.218.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.218.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
...
:if ([:len [/ip/route/find dst-address=198.220.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.220.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27137 }
