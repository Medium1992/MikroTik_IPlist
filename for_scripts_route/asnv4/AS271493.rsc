...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271493 and dst-address=for_scripts_route/asnv4/AS271493.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271493.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271493 }
