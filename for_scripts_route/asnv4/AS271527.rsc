...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271527 and dst-address=for_scripts_route/asnv4/AS271527.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271527.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271527 }
