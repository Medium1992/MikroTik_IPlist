...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=179.63.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.63.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27161 }
:if ([:len [/ip/route/find dst-address=184.174.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=184.174.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27161 }
