...
:if ([:len [/ip/route/find dst-address=38.3.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.3.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271612 }
:if ([:len [/ip/route/find dst-address=38.3.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.3.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271612 }
