...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271614 and dst-address=for_scripts_route/asnv4/AS271614.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271614.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271614 }
