...
:if ([:len [/ip/route/find dst-address=170.77.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.77.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27185 }
:if ([:len [/ip/route/find dst-address=170.77.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.77.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27185 }
:if ([:len [/ip/route/find dst-address=170.77.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.77.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27185 }
:if ([:len [/ip/route/find dst-address=170.77.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.77.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27185 }
