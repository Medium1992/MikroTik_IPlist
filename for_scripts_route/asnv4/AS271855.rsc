...
:if ([:len [/ip/route/find dst-address=154.7.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.7.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271855 }
:if ([:len [/ip/route/find dst-address=154.7.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.7.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271855 }
