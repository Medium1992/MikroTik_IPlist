...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271904 and dst-address=for_scripts_route/asnv4/AS271904.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271904.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271904 }
