...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271906 and dst-address=for_scripts_route/asnv4/AS271906.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271906.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271906 }
