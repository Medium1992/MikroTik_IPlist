...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271908 and dst-address=for_scripts_route/asnv4/AS271908.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271908.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271908 }
