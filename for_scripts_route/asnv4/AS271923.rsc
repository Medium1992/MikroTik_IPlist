...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271923 and dst-address=for_scripts_route/asnv4/AS271923.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271923.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271923 }
