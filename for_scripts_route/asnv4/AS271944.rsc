...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271944 and dst-address=for_scripts_route/asnv4/AS271944.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271944.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271944 }
