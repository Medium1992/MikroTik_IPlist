...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271968 and dst-address=for_scripts_route/asnv4/AS271968.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271968.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271968 }
