...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS271984 and dst-address=for_scripts_route/asnv4/AS271984.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS271984.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS271984 }
