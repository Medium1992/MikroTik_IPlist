...
:if ([:len [/ip/route/find dst-address=216.185.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.185.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272011 }
...
:if ([:len [/ip/route/find dst-address=38.51.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.51.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272011 }
