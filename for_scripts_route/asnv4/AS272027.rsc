...
:if ([:len [/ip/route/find dst-address=170.84.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.84.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272027 }
...
:if ([:len [/ip/route/find dst-address=190.112.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.112.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272027 }
...
:if ([:len [/ip/route/find dst-address=38.191.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.191.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272027 }
