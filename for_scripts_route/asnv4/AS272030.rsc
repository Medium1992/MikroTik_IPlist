...
:if ([:len [/ip/route/find dst-address=149.78.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272030 }
:if ([:len [/ip/route/find dst-address=149.78.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.78.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272030 }
