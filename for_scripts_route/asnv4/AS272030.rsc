...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.46.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.46.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272030 }
:if ([:len [/ip/route/find dst-address=149.46.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.46.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272030 }
:if ([:len [/ip/route/find dst-address=149.46.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.46.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272030 }
