...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=141.171.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
...
:if ([:len [/ip/route/find dst-address=141.171.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.86.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.86.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
:if ([:len [/ip/route/find dst-address=141.171.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.171.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
...
:if ([:len [/ip/route/find dst-address=149.174.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.174.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
