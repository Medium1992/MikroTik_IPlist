...
:if ([:len [/ip/route/find dst-address=149.174.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.174.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
...
:if ([:len [/ip/route/find dst-address=149.174.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.174.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272096 }
