...
:if ([:len [/ip/route/find dst-address=64.147.40.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.40.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.32/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.32/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.40/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.40/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.42/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.42/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.44/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.44/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.42.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.42.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
:if ([:len [/ip/route/find dst-address=64.147.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.147.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27254 }
