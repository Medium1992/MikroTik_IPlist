...
:if ([:len [/ip/route/find dst-address=178.253.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.253.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272696 }
:if ([:len [/ip/route/find dst-address=178.83.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272696 }
:if ([:len [/ip/route/find dst-address=178.83.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.83.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272696 }
