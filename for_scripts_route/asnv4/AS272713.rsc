...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272713 and dst-address=for_scripts_route/asnv4/AS272713.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272713.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272713 }
