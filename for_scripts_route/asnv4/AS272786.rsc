...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272786 and dst-address=for_scripts_route/asnv4/AS272786.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272786.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272786 }
