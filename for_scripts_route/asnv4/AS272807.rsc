...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272807 and dst-address=for_scripts_route/asnv4/AS272807.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272807.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272807 }
