...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=38.199.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.199.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272836 }
:if ([:len [/ip/route/find dst-address=38.199.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.199.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272836 }
:if ([:len [/ip/route/find dst-address=38.199.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.199.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272836 }
...
:if ([:len [/ip/route/find dst-address=38.199.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.199.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272836 }
