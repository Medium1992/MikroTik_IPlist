...
:if ([:len [/ip/route/find dst-address=38.224.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.224.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272836 }
...
:if ([:len [/ip/route/find dst-address=38.226.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.226.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272836 }
