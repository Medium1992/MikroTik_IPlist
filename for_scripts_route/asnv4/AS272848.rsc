...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272848 and dst-address=for_scripts_route/asnv4/AS272848.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272848.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272848 }
