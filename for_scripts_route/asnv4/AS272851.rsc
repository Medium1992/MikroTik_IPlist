...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272851 and dst-address=for_scripts_route/asnv4/AS272851.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272851.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272851 }
