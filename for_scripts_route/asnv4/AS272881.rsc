...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272881 and dst-address=for_scripts_route/asnv4/AS272881.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272881.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272881 }
