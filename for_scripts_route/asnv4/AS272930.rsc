...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272930 and dst-address=for_scripts_route/asnv4/AS272930.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272930.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272930 }
