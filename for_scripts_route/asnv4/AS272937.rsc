...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272937 and dst-address=for_scripts_route/asnv4/AS272937.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272937.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272937 }
