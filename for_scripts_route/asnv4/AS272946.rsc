...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272946 and dst-address=for_scripts_route/asnv4/AS272946.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272946.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272946 }
