...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272953 and dst-address=for_scripts_route/asnv4/AS272953.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272953.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272953 }
