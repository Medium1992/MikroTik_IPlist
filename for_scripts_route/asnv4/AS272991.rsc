...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS272991 and dst-address=for_scripts_route/asnv4/AS272991.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS272991.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS272991 }
