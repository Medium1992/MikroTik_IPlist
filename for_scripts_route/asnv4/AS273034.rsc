...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS273034 and dst-address=for_scripts_route/asnv4/AS273034.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS273034.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273034 }
