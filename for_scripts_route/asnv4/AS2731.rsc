...
:if ([:len [/ip/route/find dst-address=206.82.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.82.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2731 }
:if ([:len [/ip/route/find dst-address=206.82.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.82.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2731 }
:if ([:len [/ip/route/find dst-address=206.82.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.82.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2731 }
...
:if ([:len [/ip/route/find dst-address=206.82.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.82.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2731 }
:if ([:len [/ip/route/find dst-address=206.82.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.82.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2731 }
