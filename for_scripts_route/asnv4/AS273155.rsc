...
:if ([:len [/ip/route/find dst-address=156.236.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.236.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273155 }
...
:if ([:len [/ip/route/find dst-address=156.236.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.236.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273155 }
