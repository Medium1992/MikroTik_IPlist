...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS273177 and dst-address=for_scripts_route/asnv4/AS273177.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS273177.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273177 }
