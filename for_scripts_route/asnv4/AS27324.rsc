...
:if ([:len [/ip/route/find dst-address=159.33.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.33.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27324 }
:if ([:len [/ip/route/find dst-address=159.33.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.33.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27324 }
