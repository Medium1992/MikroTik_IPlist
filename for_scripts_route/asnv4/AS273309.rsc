...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS273309 and dst-address=for_scripts_route/asnv4/AS273309.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS273309.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273309 }
