...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS273692 and dst-address=for_scripts_route/asnv4/AS273692.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS273692.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273692 }
