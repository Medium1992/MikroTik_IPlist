...
:if ([:len [/ip/route/find dst-address=64.146.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.146.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27373 }
...
:if ([:len [/ip/route/find dst-address=64.239.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.239.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27373 }
