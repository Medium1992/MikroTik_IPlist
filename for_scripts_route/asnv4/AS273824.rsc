...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=157.254.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.254.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273824 }
:if ([:len [/ip/route/find dst-address=178.95.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.95.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273824 }
