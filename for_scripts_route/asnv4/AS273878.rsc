...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS273878 and dst-address=for_scripts_route/asnv4/AS273878.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS273878.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS273878 }
