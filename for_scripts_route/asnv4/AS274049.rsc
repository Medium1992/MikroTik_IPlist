...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS274049 and dst-address=for_scripts_route/asnv4/AS274049.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS274049.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274049 }
