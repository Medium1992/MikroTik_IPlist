...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS274062 and dst-address=for_scripts_route/asnv4/AS274062.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS274062.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274062 }
