...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS274072 and dst-address=for_scripts_route/asnv4/AS274072.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS274072.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274072 }
