...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS274087 and dst-address=for_scripts_route/asnv4/AS274087.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS274087.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274087 }
