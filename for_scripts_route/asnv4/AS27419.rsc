...
:if ([:len [/ip/route/find dst-address=64.82.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.82.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27419 }
:if ([:len [/ip/route/find dst-address=64.82.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.82.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27419 }
:if ([:len [/ip/route/find dst-address=64.82.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.82.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27419 }
:if ([:len [/ip/route/find dst-address=64.82.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.82.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27419 }
