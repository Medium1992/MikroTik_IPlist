...
:if ([:len [/ip/route/find dst-address=72.250.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.250.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27446 }
:if ([:len [/ip/route/find dst-address=72.250.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.250.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27446 }
:if ([:len [/ip/route/find dst-address=72.250.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.250.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27446 }
:if ([:len [/ip/route/find dst-address=72.250.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.250.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27446 }
