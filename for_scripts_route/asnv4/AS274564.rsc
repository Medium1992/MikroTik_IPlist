...
:if ([:len [/ip/route/find dst-address=157.254.207.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.254.207.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274564 }
:if ([:len [/ip/route/find dst-address=192.48.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.48.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274564 }
