...
:if ([:len [/ip/route/find dst-address=190.93.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274720 }
:if ([:len [/ip/route/find dst-address=190.93.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274720 }
:if ([:len [/ip/route/find dst-address=190.93.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274720 }
