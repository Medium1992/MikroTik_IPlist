...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS274747 and dst-address=for_scripts_route/asnv4/AS274747.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS274747.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274747 }
