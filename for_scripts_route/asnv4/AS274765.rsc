...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS274765 and dst-address=for_scripts_route/asnv4/AS274765.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS274765.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS274765 }
