...
:if ([:len [/ip/route/find dst-address=8.12.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.12.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27548 }
:if ([:len [/ip/route/find dst-address=8.21.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.21.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27548 }
