...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS27720 and dst-address=for_scripts_route/asnv4/AS27720.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS27720.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27720 }
