...
:if ([:len [/ip/route/find dst-address=185.244.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.244.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27729 }
:if ([:len [/ip/route/find dst-address=213.236.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.236.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27729 }
