...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS27753 and dst-address=for_scripts_route/asnv4/AS27753.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS27753.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27753 }
