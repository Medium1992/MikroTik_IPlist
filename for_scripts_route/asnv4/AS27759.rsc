...
:if ([:len [/ip/route/find dst-address=179.51.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.51.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
...
:if ([:len [/ip/route/find dst-address=200.4.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.4.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
:if ([:len [/ip/route/find dst-address=200.4.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.4.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
:if ([:len [/ip/route/find dst-address=200.4.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.4.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
:if ([:len [/ip/route/find dst-address=200.4.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.4.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
:if ([:len [/ip/route/find dst-address=200.4.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.4.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
