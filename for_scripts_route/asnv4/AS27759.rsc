...
:if ([:len [/ip/route/find dst-address=190.105.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.105.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
...
:if ([:len [/ip/route/find dst-address=200.115.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.115.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27759 }
