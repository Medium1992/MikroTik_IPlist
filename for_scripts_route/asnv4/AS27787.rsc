...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS27787 and dst-address=for_scripts_route/asnv4/AS27787.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS27787.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27787 }
