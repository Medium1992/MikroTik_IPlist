...
:if ([:len [/ip/route/find dst-address=190.93.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
:if ([:len [/ip/route/find dst-address=190.93.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
:if ([:len [/ip/route/find dst-address=190.93.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
:if ([:len [/ip/route/find dst-address=190.93.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
...
:if ([:len [/ip/route/find dst-address=190.93.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
:if ([:len [/ip/route/find dst-address=190.93.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
:if ([:len [/ip/route/find dst-address=190.93.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
:if ([:len [/ip/route/find dst-address=190.93.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.93.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27789 }
