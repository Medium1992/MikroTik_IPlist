...
:if ([:len [/ip/route/find dst-address=38.254.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27813 }
:if ([:len [/ip/route/find dst-address=38.254.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27813 }
:if ([:len [/ip/route/find dst-address=38.254.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27813 }
:if ([:len [/ip/route/find dst-address=38.254.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27813 }
