...
:if ([:len [/ip/route/find dst-address=190.103.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.103.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27855 }
:if ([:len [/ip/route/find dst-address=190.103.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.103.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27855 }
...
:if ([:len [/ip/route/find dst-address=45.65.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.65.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27855 }
:if ([:len [/ip/route/find dst-address=45.65.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.65.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27855 }
