...
:if ([:len [/ip/route/find dst-address=190.7.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.7.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27855 }
...
:if ([:len [/ip/route/find dst-address=190.7.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.7.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27855 }
