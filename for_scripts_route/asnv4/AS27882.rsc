...
:if ([:len [/ip/route/find dst-address=49.0.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.0.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
...
:if ([:len [/ip/route/find dst-address=49.0.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.0.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
