...
:if ([:len [/ip/route/find dst-address=158.172.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.172.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
...
:if ([:len [/ip/route/find dst-address=181.114.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.114.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
...
:if ([:len [/ip/route/find dst-address=192.223.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.223.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
:if ([:len [/ip/route/find dst-address=192.223.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.223.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
:if ([:len [/ip/route/find dst-address=192.223.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.223.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
...
:if ([:len [/ip/route/find dst-address=203.88.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.88.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27882 }
