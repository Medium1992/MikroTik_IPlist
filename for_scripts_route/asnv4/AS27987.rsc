...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=168.227.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.227.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27987 }
:if ([:len [/ip/route/find dst-address=181.189.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.189.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27987 }
...
:if ([:len [/ip/route/find dst-address=190.103.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.103.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27987 }
