...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS27999 and dst-address=for_scripts_route/asnv4/AS27999.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS27999.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS27999 }
