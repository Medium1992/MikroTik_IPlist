...
:if ([:len [/ip/route/find dst-address=201.219.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.219.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28006 }
...
:if ([:len [/ip/route/find dst-address=201.219.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.219.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28006 }
...
:if ([:len [/ip/route/find dst-address=201.219.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.219.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28006 }
