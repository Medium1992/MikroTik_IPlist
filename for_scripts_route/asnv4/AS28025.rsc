...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28025 and dst-address=for_scripts_route/asnv4/AS28025.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28025.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28025 }
