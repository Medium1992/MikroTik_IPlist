...
:if ([:len [/ip/route/find dst-address=152.231.43.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.231.43.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
...
:if ([:len [/ip/route/find dst-address=165.98.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.98.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
:if ([:len [/ip/route/find dst-address=165.98.246.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.98.246.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
...
:if ([:len [/ip/route/find dst-address=186.32.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.32.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
:if ([:len [/ip/route/find dst-address=186.32.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.32.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
...
:if ([:len [/ip/route/find dst-address=190.143.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.143.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
...
:if ([:len [/ip/route/find dst-address=190.98.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.98.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
:if ([:len [/ip/route/find dst-address=208.96.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.96.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28036 }
