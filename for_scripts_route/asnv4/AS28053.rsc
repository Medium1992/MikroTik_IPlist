...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28053 and dst-address=for_scripts_route/asnv4/AS28053.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28053.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28053 }
