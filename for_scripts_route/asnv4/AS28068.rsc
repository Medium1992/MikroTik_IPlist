...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28068 and dst-address=for_scripts_route/asnv4/AS28068.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28068.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28068 }
