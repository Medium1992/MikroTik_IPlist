...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28086 and dst-address=for_scripts_route/asnv4/AS28086.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28086.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28086 }
