...
:if ([:len [/ip/route/find dst-address=168.234.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.234.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28087 }
...
:if ([:len [/ip/route/find dst-address=200.10.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.10.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28087 }
