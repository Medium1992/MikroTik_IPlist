...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=168.195.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.195.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28114 }
...
:if ([:len [/ip/route/find dst-address=190.12.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.12.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28114 }
