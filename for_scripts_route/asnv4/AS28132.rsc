...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28132 and dst-address=for_scripts_route/asnv4/AS28132.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28132.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28132 }
