...
:if ([:len [/ip/route/find dst-address=177.46.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=177.46.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
:if ([:len [/ip/route/find dst-address=177.46.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=177.46.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
:if ([:len [/ip/route/find dst-address=177.46.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
:if ([:len [/ip/route/find dst-address=177.46.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=187.86.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.86.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=187.86.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.86.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
:if ([:len [/ip/route/find dst-address=187.86.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.86.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
