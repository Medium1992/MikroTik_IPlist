...
:if ([:len [/ip/route/find dst-address=177.46.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=177.46.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
