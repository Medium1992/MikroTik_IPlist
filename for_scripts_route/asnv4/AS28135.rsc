...
:if ([:len [/ip/route/find dst-address=177.46.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
:if ([:len [/ip/route/find dst-address=177.46.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=177.46.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=177.46.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
...
:if ([:len [/ip/route/find dst-address=177.46.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.46.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28135 }
