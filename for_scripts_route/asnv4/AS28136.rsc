...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28136 and dst-address=for_scripts_route/asnv4/AS28136.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28136.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28136 }
