...
:if ([:len [/ip/route/find dst-address=187.85.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.85.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28205 }
:if ([:len [/ip/route/find dst-address=187.85.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.85.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28205 }
:if ([:len [/ip/route/find dst-address=187.85.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.85.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28205 }
