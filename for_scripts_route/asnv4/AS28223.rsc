...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28223 and dst-address=for_scripts_route/asnv4/AS28223.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28223.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28223 }
