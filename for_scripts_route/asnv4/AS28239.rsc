...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28239 and dst-address=for_scripts_route/asnv4/AS28239.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28239.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28239 }
