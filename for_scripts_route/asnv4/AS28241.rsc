...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28241 and dst-address=for_scripts_route/asnv4/AS28241.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28241.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28241 }
