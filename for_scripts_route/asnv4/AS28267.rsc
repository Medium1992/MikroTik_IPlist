...
:if ([:len [/ip/route/find dst-address=190.102.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.102.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28267 }
:if ([:len [/ip/route/find dst-address=190.102.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.102.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28267 }
:if ([:len [/ip/route/find dst-address=45.175.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.175.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28267 }
:if ([:len [/ip/route/find dst-address=45.175.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.175.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28267 }
