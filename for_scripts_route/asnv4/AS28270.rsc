...
:if ([:len [/ip/route/find dst-address=179.191.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.191.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28270 }
:if ([:len [/ip/route/find dst-address=187.110.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.110.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28270 }
...
:if ([:len [/ip/route/find dst-address=187.18.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.18.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28270 }
