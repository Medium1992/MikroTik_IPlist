...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28277 and dst-address=for_scripts_route/asnv4/AS28277.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28277.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28277 }
