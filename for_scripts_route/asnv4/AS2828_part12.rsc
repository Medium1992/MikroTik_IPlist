...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=71.4.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.4.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2828 }
:if ([:len [/ip/route/find dst-address=71.4.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.4.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2828 }
:if ([:len [/ip/route/find dst-address=71.4.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.4.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2828 }
:if ([:len [/ip/route/find dst-address=71.4.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.4.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2828 }
:if ([:len [/ip/route/find dst-address=71.4.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.4.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2828 }
:if ([:len [/ip/route/find dst-address=71.4.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.4.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2828 }
:if ([:len [/ip/route/find dst-address=71.4.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=71.4.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2828 }
