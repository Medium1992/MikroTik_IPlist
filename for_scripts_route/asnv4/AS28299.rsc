...
:if ([:len [/ip/route/find dst-address=191.6.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.6.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28299 }
:if ([:len [/ip/route/find dst-address=191.6.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.6.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28299 }
...
:if ([:len [/ip/route/find dst-address=191.6.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.6.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28299 }
:if ([:len [/ip/route/find dst-address=191.6.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.6.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28299 }
:if ([:len [/ip/route/find dst-address=191.6.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.6.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28299 }
