...
:if ([:len [/ip/route/find dst-address=179.96.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.96.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28329 }
...
:if ([:len [/ip/route/find dst-address=186.226.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.226.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28329 }
