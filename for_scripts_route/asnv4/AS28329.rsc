...
:if ([:len [/ip/route/find dst-address=179.96.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.96.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28329 }
...
:if ([:len [/ip/route/find dst-address=179.96.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.96.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28329 }
:if ([:len [/ip/route/find dst-address=179.96.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.96.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28329 }
