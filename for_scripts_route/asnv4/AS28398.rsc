...
:if ([:len [/ip/route/find dst-address=38.7.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.7.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28398 }
:if ([:len [/ip/route/find dst-address=38.7.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.7.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28398 }
:if ([:len [/ip/route/find dst-address=38.7.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.7.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28398 }
