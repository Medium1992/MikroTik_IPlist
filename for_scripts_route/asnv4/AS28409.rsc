...
:if ([:len [/ip/route/find dst-address=38.65.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.65.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28409 }
:if ([:len [/ip/route/find dst-address=38.65.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.65.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28409 }
