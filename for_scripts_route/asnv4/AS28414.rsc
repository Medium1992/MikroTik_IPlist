...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=187.251.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.251.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28414 }
:if ([:len [/ip/route/find dst-address=187.251.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.251.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28414 }
:if ([:len [/ip/route/find dst-address=189.203.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.203.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28414 }
...
:if ([:len [/ip/route/find dst-address=200.23.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.23.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28414 }
