...
:if ([:len [/ip/route/find dst-address=148.222.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.222.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28417 }
:if ([:len [/ip/route/find dst-address=148.222.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.222.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28417 }
