...
:if ([:len [/ip/route/find dst-address=187.251.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.251.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
:if ([:len [/ip/route/find dst-address=187.251.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.251.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
:if ([:len [/ip/route/find dst-address=187.251.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.251.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
...
:if ([:len [/ip/route/find dst-address=206.135.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
:if ([:len [/ip/route/find dst-address=206.135.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
:if ([:len [/ip/route/find dst-address=206.135.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
:if ([:len [/ip/route/find dst-address=206.135.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
:if ([:len [/ip/route/find dst-address=206.135.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
...
:if ([:len [/ip/route/find dst-address=38.224.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.224.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
