...
:if ([:len [/ip/route/find dst-address=206.135.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
...
:if ([:len [/ip/route/find dst-address=206.135.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
