...
:if ([:len [/ip/route/find dst-address=206.135.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
:if ([:len [/ip/route/find dst-address=206.135.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28458 }
