...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28467 and dst-address=for_scripts_route/asnv4/AS28467.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28467.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28467 }
