...
:if ([:len [/ip/route/find dst-address=201.140.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.140.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28506 }
:if ([:len [/ip/route/find dst-address=201.140.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.140.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28506 }
:if ([:len [/ip/route/find dst-address=201.140.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.140.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28506 }
:if ([:len [/ip/route/find dst-address=201.140.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.140.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28506 }
