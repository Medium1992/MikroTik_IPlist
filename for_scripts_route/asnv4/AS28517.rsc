...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28517 and dst-address=for_scripts_route/asnv4/AS28517.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28517.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28517 }
