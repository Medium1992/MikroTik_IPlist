...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28538 and dst-address=for_scripts_route/asnv4/AS28538.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28538.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28538 }
