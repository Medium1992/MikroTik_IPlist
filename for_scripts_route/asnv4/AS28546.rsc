...
:if ([:len [/ip/route/find dst-address=85.92.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.92.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28546 }
:if ([:len [/ip/route/find dst-address=85.92.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.92.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28546 }
