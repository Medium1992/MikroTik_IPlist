...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28556 and dst-address=for_scripts_route/asnv4/AS28556.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28556.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28556 }
