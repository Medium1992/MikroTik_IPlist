...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28571 and dst-address=for_scripts_route/asnv4/AS28571.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28571.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28571 }
