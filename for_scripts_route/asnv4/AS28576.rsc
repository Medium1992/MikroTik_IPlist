...
:if ([:len [/ip/route/find dst-address=189.38.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.38.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28576 }
:if ([:len [/ip/route/find dst-address=189.38.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.38.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28576 }
