...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28576 and dst-address=for_scripts_route/asnv4/AS28576.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28576.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28576 }
