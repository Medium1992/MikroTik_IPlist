...
:if ([:len [/ip/route/find dst-address=189.38.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.38.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28576 }
...
:if ([:len [/ip/route/find dst-address=200.220.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.220.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28576 }
