...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=177.92.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.92.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28586 }
...
:if ([:len [/ip/route/find dst-address=200.155.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.155.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28586 }
