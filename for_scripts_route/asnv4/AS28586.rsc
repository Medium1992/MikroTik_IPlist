...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28586 and dst-address=for_scripts_route/asnv4/AS28586.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28586.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28586 }
