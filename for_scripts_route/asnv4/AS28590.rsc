...
:if ([:len [/ip/route/find dst-address=200.152.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.152.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
...
:if ([:len [/ip/route/find dst-address=200.152.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.152.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
...
:if ([:len [/ip/route/find dst-address=200.218.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.218.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
:if ([:len [/ip/route/find dst-address=200.218.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.218.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
