...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=200.152.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.152.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
...
:if ([:len [/ip/route/find dst-address=200.218.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.218.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
:if ([:len [/ip/route/find dst-address=200.218.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.218.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28590 }
