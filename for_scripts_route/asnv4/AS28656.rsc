...
:if ([:len [/ip/route/find dst-address=177.131.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.131.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28656 }
:if ([:len [/ip/route/find dst-address=177.55.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.55.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28656 }
...
:if ([:len [/ip/route/find dst-address=177.87.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.87.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28656 }
