...
:if ([:len [/ip/route/find dst-address=185.158.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.158.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28676 }
:if ([:len [/ip/route/find dst-address=185.158.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.158.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28676 }
