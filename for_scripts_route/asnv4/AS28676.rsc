...
:if ([:len [/ip/route/find dst-address=217.19.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.19.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28676 }
:if ([:len [/ip/route/find dst-address=217.19.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.19.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28676 }
:if ([:len [/ip/route/find dst-address=217.19.186.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.19.186.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28676 }
:if ([:len [/ip/route/find dst-address=217.19.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.19.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28676 }
