...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28685 and dst-address=for_scripts_route/asnv4/AS28685.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28685.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28685 }
