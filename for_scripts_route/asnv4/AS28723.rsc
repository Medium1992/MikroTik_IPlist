...
:if ([:len [/ip/route/find dst-address=135.250.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=135.250.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28723 }
:if ([:len [/ip/route/find dst-address=135.250.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=135.250.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28723 }
:if ([:len [/ip/route/find dst-address=135.250.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=135.250.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28723 }
:if ([:len [/ip/route/find dst-address=135.250.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=135.250.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28723 }
