...
:if ([:len [/ip/route/find dst-address=212.96.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.96.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28725 }
:if ([:len [/ip/route/find dst-address=80.78.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.78.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28725 }
