...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28756 and dst-address=for_scripts_route/asnv4/AS28756.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28756.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28756 }
