...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28792 and dst-address=for_scripts_route/asnv4/AS28792.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28792.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28792 }
