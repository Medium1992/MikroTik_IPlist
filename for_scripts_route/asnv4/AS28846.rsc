...
:if ([:len [/ip/route/find dst-address=194.62.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.62.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28846 }
:if ([:len [/ip/route/find dst-address=194.62.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.62.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28846 }
