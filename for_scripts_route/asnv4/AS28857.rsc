...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28857 and dst-address=for_scripts_route/asnv4/AS28857.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28857.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28857 }
