...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28883 and dst-address=for_scripts_route/asnv4/AS28883.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28883.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28883 }
