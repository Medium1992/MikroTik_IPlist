...
:if ([:len [/ip/route/find dst-address=193.124.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.124.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
:if ([:len [/ip/route/find dst-address=194.87.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.87.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
:if ([:len [/ip/route/find dst-address=194.87.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.87.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
:if ([:len [/ip/route/find dst-address=194.87.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.87.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
:if ([:len [/ip/route/find dst-address=194.87.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.87.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
:if ([:len [/ip/route/find dst-address=194.87.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.87.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
:if ([:len [/ip/route/find dst-address=195.133.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.133.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
:if ([:len [/ip/route/find dst-address=195.133.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.133.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28890 }
