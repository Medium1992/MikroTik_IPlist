...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28893 and dst-address=for_scripts_route/asnv4/AS28893.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28893.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28893 }
