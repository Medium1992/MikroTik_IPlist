...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=136.0.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.0.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28917 }
:if ([:len [/ip/route/find dst-address=142.111.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.111.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28917 }
...
:if ([:len [/ip/route/find dst-address=80.77.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.77.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28917 }
