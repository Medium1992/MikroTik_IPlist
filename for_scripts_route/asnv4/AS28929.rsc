...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28929 and dst-address=for_scripts_route/asnv4/AS28929.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28929.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28929 }
