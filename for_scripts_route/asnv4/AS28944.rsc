...
:if ([:len [/ip/route/find dst-address=151.237.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.237.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28944 }
:if ([:len [/ip/route/find dst-address=151.237.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.237.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28944 }
