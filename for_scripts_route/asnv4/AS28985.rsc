...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS28985 and dst-address=for_scripts_route/asnv4/AS28985.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS28985.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS28985 }
