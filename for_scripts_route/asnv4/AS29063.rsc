...
:if ([:len [/ip/route/find dst-address=212.25.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.25.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29063 }
:if ([:len [/ip/route/find dst-address=212.25.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.25.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29063 }
