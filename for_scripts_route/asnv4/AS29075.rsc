...
:if ([:len [/ip/route/find dst-address=185.132.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.132.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29075 }
...
:if ([:len [/ip/route/find dst-address=188.121.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.121.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29075 }
