...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=128.204.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.204.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29075 }
...
:if ([:len [/ip/route/find dst-address=194.147.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.147.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29075 }
