...
:if ([:len [/ip/route/find dst-address=217.26.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.26.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29097 }
:if ([:len [/ip/route/find dst-address=217.26.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.26.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29097 }
