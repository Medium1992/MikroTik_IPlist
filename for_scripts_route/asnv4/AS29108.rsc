...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.103.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.103.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29108 }
...
:if ([:len [/ip/route/find dst-address=94.136.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.136.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29108 }
:if ([:len [/ip/route/find dst-address=94.136.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.136.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29108 }
:if ([:len [/ip/route/find dst-address=94.136.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.136.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29108 }
