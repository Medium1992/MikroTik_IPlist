...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29128 and dst-address=for_scripts_route/asnv4/AS29128.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29128.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29128 }
