...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29152 and dst-address=for_scripts_route/asnv4/AS29152.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29152.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29152 }
