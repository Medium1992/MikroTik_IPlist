...
:if ([:len [/ip/route/find dst-address=82.132.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.132.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29180 }
:if ([:len [/ip/route/find dst-address=82.132.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.132.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29180 }
:if ([:len [/ip/route/find dst-address=82.132.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.132.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29180 }
