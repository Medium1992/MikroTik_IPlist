...
:if ([:len [/ip/route/find dst-address=31.29.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.29.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29190 }
...
:if ([:len [/ip/route/find dst-address=95.104.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.104.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29190 }
:if ([:len [/ip/route/find dst-address=95.104.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.104.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29190 }
