...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29240 and dst-address=for_scripts_route/asnv4/AS29240.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29240.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29240 }
