...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29282 and dst-address=for_scripts_route/asnv4/AS29282.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29282.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29282 }
