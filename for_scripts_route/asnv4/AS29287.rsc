...
:if ([:len [/ip/route/find dst-address=217.194.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.194.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29287 }
:if ([:len [/ip/route/find dst-address=217.194.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.194.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29287 }
:if ([:len [/ip/route/find dst-address=217.194.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.194.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29287 }
