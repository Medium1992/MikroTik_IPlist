...
:if ([:len [/ip/route/find dst-address=164.0.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.0.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
:if ([:len [/ip/route/find dst-address=164.0.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.0.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
:if ([:len [/ip/route/find dst-address=164.0.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.0.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
:if ([:len [/ip/route/find dst-address=164.0.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.0.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
:if ([:len [/ip/route/find dst-address=164.0.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.0.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
:if ([:len [/ip/route/find dst-address=164.138.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.138.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
:if ([:len [/ip/route/find dst-address=164.138.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.138.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
:if ([:len [/ip/route/find dst-address=164.138.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.138.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
...
:if ([:len [/ip/route/find dst-address=185.134.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.134.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
...
:if ([:len [/ip/route/find dst-address=2.78.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.78.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
...
:if ([:len [/ip/route/find dst-address=2.78.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.78.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29355 }
