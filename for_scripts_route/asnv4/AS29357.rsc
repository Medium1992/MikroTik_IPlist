...
:if ([:len [/ip/route/find dst-address=188.70.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.70.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29357 }
:if ([:len [/ip/route/find dst-address=194.126.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.126.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29357 }
