...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS2941 and dst-address=for_scripts_route/asnv4/AS2941.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS2941.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS2941 }
