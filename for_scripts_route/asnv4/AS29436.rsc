...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29436 and dst-address=for_scripts_route/asnv4/AS29436.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29436.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29436 }
