...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.106.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.106.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29457 }
...
:if ([:len [/ip/route/find dst-address=195.167.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.167.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29457 }
:if ([:len [/ip/route/find dst-address=195.167.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.167.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29457 }
