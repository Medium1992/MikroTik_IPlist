...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29479 and dst-address=for_scripts_route/asnv4/AS29479.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29479.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29479 }
