...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29534 and dst-address=for_scripts_route/asnv4/AS29534.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29534.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29534 }
