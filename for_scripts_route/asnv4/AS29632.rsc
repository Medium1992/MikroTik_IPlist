...
:if ([:len [/ip/route/find dst-address=62.205.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.205.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29632 }
...
:if ([:len [/ip/route/find dst-address=62.205.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.205.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29632 }
:if ([:len [/ip/route/find dst-address=62.205.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.205.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29632 }
:if ([:len [/ip/route/find dst-address=62.205.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.205.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29632 }
:if ([:len [/ip/route/find dst-address=62.205.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.205.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29632 }
...
:if ([:len [/ip/route/find dst-address=94.131.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.131.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29632 }
