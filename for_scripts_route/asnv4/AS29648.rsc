...
:if ([:len [/ip/route/find dst-address=188.94.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.94.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29648 }
:if ([:len [/ip/route/find dst-address=188.94.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.94.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29648 }
:if ([:len [/ip/route/find dst-address=188.94.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.94.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29648 }
...
:if ([:len [/ip/route/find dst-address=78.109.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.109.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29648 }
