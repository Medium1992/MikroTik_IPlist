...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29680 and dst-address=for_scripts_route/asnv4/AS29680.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29680.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29680 }
