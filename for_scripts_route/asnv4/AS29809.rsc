...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29809 and dst-address=for_scripts_route/asnv4/AS29809.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29809.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29809 }
