...
:if ([:len [/ip/route/find dst-address=173.240.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.240.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29892 }
