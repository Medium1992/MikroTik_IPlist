...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS29918 and dst-address=for_scripts_route/asnv4/AS29918.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS29918.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29918 }
