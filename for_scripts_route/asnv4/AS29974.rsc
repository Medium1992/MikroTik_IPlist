...
:if ([:len [/ip/route/find dst-address=204.138.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.138.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29974 }
:if ([:len [/ip/route/find dst-address=204.138.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.138.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29974 }
:if ([:len [/ip/route/find dst-address=207.236.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.236.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS29974 }
