...
:if ([:len [/ip/route/find dst-address=64.110.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.110.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30043 }
...
:if ([:len [/ip/route/find dst-address=69.7.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.7.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30043 }
...
:if ([:len [/ip/route/find dst-address=69.7.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.7.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30043 }
:if ([:len [/ip/route/find dst-address=69.7.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.7.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30043 }
:if ([:len [/ip/route/find dst-address=69.7.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.7.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30043 }
