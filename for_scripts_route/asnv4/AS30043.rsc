...
:if ([:len [/ip/route/find dst-address=64.110.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.110.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30043 }
...
:if ([:len [/ip/route/find dst-address=69.7.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.7.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30043 }
