...
:if ([:len [/ip/route/find dst-address=74.119.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.119.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30097 }
:if ([:len [/ip/route/find dst-address=74.119.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.119.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30097 }
