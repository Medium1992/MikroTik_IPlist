...
:if ([:len [/ip/route/find dst-address=208.109.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.109.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30148 }
:if ([:len [/ip/route/find dst-address=208.109.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.109.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30148 }
