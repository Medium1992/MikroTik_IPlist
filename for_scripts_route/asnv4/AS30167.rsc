...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=201.174.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.174.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30167 }
...
:if ([:len [/ip/route/find dst-address=216.171.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.171.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30167 }
