...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=216.51.225.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.225.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=216.51.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.195.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.195.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.195.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.195.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.195.33/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.195.33/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.195.34/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.195.34/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.195.36/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.195.36/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.195.40/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.195.40/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
:if ([:len [/ip/route/find dst-address=66.129.195.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.195.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
...
:if ([:len [/ip/route/find dst-address=66.129.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.129.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30325 }
