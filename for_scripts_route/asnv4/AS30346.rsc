...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS30346 and dst-address=for_scripts_route/asnv4/AS30346.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS30346.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30346 }
