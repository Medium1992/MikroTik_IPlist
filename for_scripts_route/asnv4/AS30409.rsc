...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS30409 and dst-address=for_scripts_route/asnv4/AS30409.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS30409.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30409 }
