...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS30417 and dst-address=for_scripts_route/asnv4/AS30417.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS30417.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30417 }
