...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS30500 and dst-address=for_scripts_route/asnv4/AS30500.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS30500.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30500 }
