...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS30528 and dst-address=for_scripts_route/asnv4/AS30528.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS30528.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30528 }
