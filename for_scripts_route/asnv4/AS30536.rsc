...
:if ([:len [/ip/route/find dst-address=208.76.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.76.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30536 }
...
:if ([:len [/ip/route/find dst-address=38.10.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.10.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30536 }
:if ([:len [/ip/route/find dst-address=38.45.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.45.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30536 }
:if ([:len [/ip/route/find dst-address=38.45.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.45.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30536 }
