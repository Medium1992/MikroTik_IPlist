...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS30551 and dst-address=for_scripts_route/asnv4/AS30551.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS30551.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30551 }
