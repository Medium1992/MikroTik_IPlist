...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=38.182.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.48/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.48/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.52/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.52/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.54/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.54/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.56/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.56/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.83.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.83.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.182.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.182.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
