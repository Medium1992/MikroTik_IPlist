...
:if ([:len [/ip/route/find dst-address=38.254.34.0/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.34.0/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.254.34.11/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.34.11/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.254.34.12/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.34.12/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
...
:if ([:len [/ip/route/find dst-address=38.254.34.16/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.34.16/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.254.34.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.34.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.254.34.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.34.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
:if ([:len [/ip/route/find dst-address=38.254.34.8/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.254.34.8/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30567 }
