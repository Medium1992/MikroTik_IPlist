...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.124.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.124.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30598 }
:if ([:len [/ip/route/find dst-address=151.124.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.124.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30598 }
