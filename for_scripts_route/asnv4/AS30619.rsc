...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=169.239.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.239.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30619 }
...
:if ([:len [/ip/route/find dst-address=41.220.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.220.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30619 }
