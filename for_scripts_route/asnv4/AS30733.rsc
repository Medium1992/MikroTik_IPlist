...
:if ([:len [/ip/route/find dst-address=185.15.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.15.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30733 }
:if ([:len [/ip/route/find dst-address=185.15.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.15.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30733 }
