...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=188.130.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.130.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30738 }
...
:if ([:len [/ip/route/find dst-address=46.8.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.8.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30738 }
