...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.118.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.118.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30742 }
:if ([:len [/ip/route/find dst-address=176.118.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.118.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30742 }
