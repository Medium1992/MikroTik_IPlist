...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=82.199.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.199.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30784 }
...
:if ([:len [/ip/route/find dst-address=82.199.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.199.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30784 }
