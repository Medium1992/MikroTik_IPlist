...
:if ([:len [/ip/route/find dst-address=88.209.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.209.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30815 }
:if ([:len [/ip/route/find dst-address=88.209.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.209.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30815 }
:if ([:len [/ip/route/find dst-address=88.209.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.209.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30815 }
