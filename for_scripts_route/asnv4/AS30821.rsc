...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS30821 and dst-address=for_scripts_route/asnv4/AS30821.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS30821.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30821 }
