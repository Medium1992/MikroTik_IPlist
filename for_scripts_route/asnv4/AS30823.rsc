...
:if ([:len [/ip/route/find dst-address=144.172.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.172.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30823 }
...
:if ([:len [/ip/route/find dst-address=160.20.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.20.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30823 }
:if ([:len [/ip/route/find dst-address=160.20.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.20.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30823 }
...
:if ([:len [/ip/route/find dst-address=41.216.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.216.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30823 }
...
:if ([:len [/ip/route/find dst-address=45.135.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.135.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30823 }
...
:if ([:len [/ip/route/find dst-address=5.175.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30823 }
