...
:if ([:len [/ip/route/find dst-address=213.247.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.247.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30870 }
...
:if ([:len [/ip/route/find dst-address=83.98.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.98.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30870 }
