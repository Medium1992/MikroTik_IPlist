...
:if ([:len [/ip/route/find dst-address=192.71.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.71.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30880 }
...
:if ([:len [/ip/route/find dst-address=212.63.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.63.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30880 }
