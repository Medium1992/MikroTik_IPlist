...
:if ([:len [/ip/route/find dst-address=31.22.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.22.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30893 }
...
:if ([:len [/ip/route/find dst-address=5.175.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30893 }
