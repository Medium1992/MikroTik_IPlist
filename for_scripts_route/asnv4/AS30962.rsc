...
:if ([:len [/ip/route/find dst-address=62.108.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.108.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30962 }
:if ([:len [/ip/route/find dst-address=62.108.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.108.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30962 }
:if ([:len [/ip/route/find dst-address=62.108.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.108.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30962 }
:if ([:len [/ip/route/find dst-address=62.108.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.108.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30962 }
