...
:if ([:len [/ip/route/find dst-address=197.241.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.241.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
...
:if ([:len [/ip/route/find dst-address=41.189.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.189.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
:if ([:len [/ip/route/find dst-address=41.189.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.189.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
:if ([:len [/ip/route/find dst-address=41.189.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.189.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
:if ([:len [/ip/route/find dst-address=41.189.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.189.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
:if ([:len [/ip/route/find dst-address=41.189.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.189.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
