...
:if ([:len [/ip/route/find dst-address=197.241.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.241.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
...
:if ([:len [/ip/route/find dst-address=197.241.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.241.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
...
:if ([:len [/ip/route/find dst-address=41.189.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.189.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
...
:if ([:len [/ip/route/find dst-address=41.189.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.189.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS30990 }
