...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31004 and dst-address=for_scripts_route/asnv4/AS31004.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31004.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31004 }
