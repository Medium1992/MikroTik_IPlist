...
:if ([:len [/ip/route/find dst-address=5.22.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.22.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31042 }
:if ([:len [/ip/route/find dst-address=5.22.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.22.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31042 }
:if ([:len [/ip/route/find dst-address=5.22.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.22.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31042 }
:if ([:len [/ip/route/find dst-address=5.22.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.22.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31042 }
:if ([:len [/ip/route/find dst-address=5.22.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.22.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31042 }
