...
:if ([:len [/ip/route/find dst-address=41.179.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.179.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31065 }
:if ([:len [/ip/route/find dst-address=41.179.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.179.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31065 }
