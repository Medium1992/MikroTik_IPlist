...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31178 and dst-address=for_scripts_route/asnv4/AS31178.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31178.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31178 }
