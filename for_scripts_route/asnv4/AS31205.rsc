...
:if ([:len [/ip/route/find dst-address=188.162.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.162.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31205 }
...
:if ([:len [/ip/route/find dst-address=188.162.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.162.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31205 }
:if ([:len [/ip/route/find dst-address=188.162.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.162.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31205 }
:if ([:len [/ip/route/find dst-address=188.162.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.162.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31205 }
:if ([:len [/ip/route/find dst-address=188.162.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.162.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31205 }
