...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31235 and dst-address=for_scripts_route/asnv4/AS31235.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31235.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31235 }
