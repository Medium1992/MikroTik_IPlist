...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31297 and dst-address=for_scripts_route/asnv4/AS31297.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31297.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31297 }
