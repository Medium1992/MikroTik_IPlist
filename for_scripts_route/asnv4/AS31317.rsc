...
:if ([:len [/ip/route/find dst-address=185.206.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.206.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31317 }
...
:if ([:len [/ip/route/find dst-address=5.154.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.154.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31317 }
...
:if ([:len [/ip/route/find dst-address=80.224.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.224.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31317 }
