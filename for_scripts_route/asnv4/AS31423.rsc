...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31423 and dst-address=for_scripts_route/asnv4/AS31423.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31423.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31423 }
