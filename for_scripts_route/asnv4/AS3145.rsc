...
:if ([:len [/ip/route/find dst-address=198.80.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.80.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3145 }
...
:if ([:len [/ip/route/find dst-address=199.224.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.224.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3145 }
