...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31452 and dst-address=for_scripts_route/asnv4/AS31452.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31452.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31452 }
