...
:if ([:len [/ip/route/find dst-address=2.153.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.153.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
...
:if ([:len [/ip/route/find dst-address=95.140.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.140.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
:if ([:len [/ip/route/find dst-address=95.140.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.140.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
...
:if ([:len [/ip/route/find dst-address=95.161.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
:if ([:len [/ip/route/find dst-address=95.161.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
:if ([:len [/ip/route/find dst-address=95.161.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
...
:if ([:len [/ip/route/find dst-address=95.161.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31500 }
