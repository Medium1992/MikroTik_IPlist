...
:if ([:len [/ip/route/find dst-address=194.32.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.32.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31525 }
:if ([:len [/ip/route/find dst-address=194.32.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.32.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31525 }
