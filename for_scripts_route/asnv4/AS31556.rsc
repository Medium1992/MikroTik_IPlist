...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31556 and dst-address=for_scripts_route/asnv4/AS31556.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31556.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31556 }
