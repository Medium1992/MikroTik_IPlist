...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31688 and dst-address=for_scripts_route/asnv4/AS31688.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31688.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31688 }
