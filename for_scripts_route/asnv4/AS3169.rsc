...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS3169 and dst-address=for_scripts_route/asnv4/AS3169.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS3169.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3169 }
