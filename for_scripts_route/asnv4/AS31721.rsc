...
:if ([:len [/ip/route/find dst-address=62.217.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31721 }
:if ([:len [/ip/route/find dst-address=62.217.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31721 }
:if ([:len [/ip/route/find dst-address=62.217.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31721 }
