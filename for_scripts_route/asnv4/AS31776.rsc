...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31776 and dst-address=for_scripts_route/asnv4/AS31776.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31776.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31776 }
