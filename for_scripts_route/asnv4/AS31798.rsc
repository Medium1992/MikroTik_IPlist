...
:if ([:len [/ip/route/find dst-address=198.246.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.246.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31798 }
...
:if ([:len [/ip/route/find dst-address=45.62.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.62.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31798 }
...
:if ([:len [/ip/route/find dst-address=45.62.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.62.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31798 }
