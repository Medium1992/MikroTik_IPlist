...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS31827 and dst-address=for_scripts_route/asnv4/AS31827.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS31827.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS31827 }
