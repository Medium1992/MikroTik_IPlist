...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS3188 and dst-address=for_scripts_route/asnv4/AS3188.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS3188.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3188 }
