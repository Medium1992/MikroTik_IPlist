...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32002 and dst-address=for_scripts_route/asnv4/AS32002.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32002.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32002 }
