...
:if ([:len [/ip/route/find dst-address=154.50.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.50.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32024 }
...
:if ([:len [/ip/route/find dst-address=38.83.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.83.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32024 }
:if ([:len [/ip/route/find dst-address=38.86.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.86.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32024 }
