...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=199.91.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.91.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32040 }
:if ([:len [/ip/route/find dst-address=216.8.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.8.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32040 }
:if ([:len [/ip/route/find dst-address=216.8.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.8.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32040 }
:if ([:len [/ip/route/find dst-address=216.8.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.8.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32040 }
:if ([:len [/ip/route/find dst-address=216.8.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.8.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32040 }
