...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=43.243.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.243.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32043 }
:if ([:len [/ip/route/find dst-address=45.126.86.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.126.86.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32043 }
:if ([:len [/ip/route/find dst-address=45.157.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.157.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32043 }
