...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.236.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.236.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32075 }
:if ([:len [/ip/route/find dst-address=12.32.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.32.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32075 }
...
:if ([:len [/ip/route/find dst-address=74.112.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.112.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32075 }
