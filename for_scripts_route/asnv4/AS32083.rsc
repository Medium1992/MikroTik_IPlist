...
:if ([:len [/ip/route/find dst-address=173.46.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.46.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32083 }
...
:if ([:len [/ip/route/find dst-address=66.158.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.158.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32083 }
