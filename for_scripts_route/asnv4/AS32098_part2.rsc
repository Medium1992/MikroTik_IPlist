...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=201.174.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.174.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32098 }
...
:if ([:len [/ip/route/find dst-address=38.51.153.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.51.153.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32098 }
