...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32100 and dst-address=for_scripts_route/asnv4/AS32100.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32100.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32100 }
