...
:if ([:len [/ip/route/find dst-address=154.83.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.83.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32167 }
...
:if ([:len [/ip/route/find dst-address=156.226.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.226.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32167 }
...
:if ([:len [/ip/route/find dst-address=192.208.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.208.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32167 }
...
:if ([:len [/ip/route/find dst-address=45.192.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.192.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32167 }
:if ([:len [/ip/route/find dst-address=45.196.218.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.196.218.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32167 }
:if ([:len [/ip/route/find dst-address=45.196.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.196.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32167 }
