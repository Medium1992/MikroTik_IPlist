...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32204 and dst-address=for_scripts_route/asnv4/AS32204.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32204.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32204 }
