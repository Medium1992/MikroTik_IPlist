...
:if ([:len [/ip/route/find dst-address=70.35.103.64/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.103.64/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
:if ([:len [/ip/route/find dst-address=70.35.103.80/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.103.80/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
:if ([:len [/ip/route/find dst-address=70.35.103.82/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.103.82/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
:if ([:len [/ip/route/find dst-address=70.35.103.84/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.103.84/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
:if ([:len [/ip/route/find dst-address=70.35.103.88/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.103.88/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
:if ([:len [/ip/route/find dst-address=70.35.103.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.103.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
...
:if ([:len [/ip/route/find dst-address=70.35.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.35.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
