...
:if ([:len [/ip/route/find dst-address=206.9.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.9.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
:if ([:len [/ip/route/find dst-address=206.9.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.9.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32264 }
