...
:if ([:len [/ip/route/find dst-address=209.209.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.64/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.64/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.69/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.69/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.70/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.70/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.72/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.72/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.80/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.80/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
:if ([:len [/ip/route/find dst-address=209.209.105.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.209.105.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32281 }
