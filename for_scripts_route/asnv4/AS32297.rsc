...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32297 and dst-address=for_scripts_route/asnv4/AS32297.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32297.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32297 }
