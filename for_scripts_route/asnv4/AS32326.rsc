...
:if ([:len [/ip/route/find dst-address=65.218.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.218.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32326 }
:if ([:len [/ip/route/find dst-address=74.120.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.120.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32326 }
