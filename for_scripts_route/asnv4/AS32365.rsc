...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32365 and dst-address=for_scripts_route/asnv4/AS32365.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32365.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32365 }
