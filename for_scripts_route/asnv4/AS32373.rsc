...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32373 and dst-address=for_scripts_route/asnv4/AS32373.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32373.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32373 }
