...
:if ([:len [/ip/route/find dst-address=151.1.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.1.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3242 }
:if ([:len [/ip/route/find dst-address=151.1.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.1.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3242 }
...
:if ([:len [/ip/route/find dst-address=151.1.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.1.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3242 }
...
:if ([:len [/ip/route/find dst-address=212.115.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.115.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3242 }
:if ([:len [/ip/route/find dst-address=212.115.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.115.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3242 }
...
:if ([:len [/ip/route/find dst-address=217.73.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.73.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3242 }
