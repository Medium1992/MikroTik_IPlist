...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.141.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.141.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32440 }
...
:if ([:len [/ip/route/find dst-address=104.141.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.141.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32440 }
...
:if ([:len [/ip/route/find dst-address=208.100.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.100.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32440 }
:if ([:len [/ip/route/find dst-address=208.100.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.100.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32440 }
...
:if ([:len [/ip/route/find dst-address=76.165.205.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.165.205.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32440 }
...
:if ([:len [/ip/route/find dst-address=76.165.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.165.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32440 }
