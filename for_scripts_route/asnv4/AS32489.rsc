...
:if ([:len [/ip/route/find dst-address=184.75.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=184.75.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32489 }
...
:if ([:len [/ip/route/find dst-address=38.111.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.111.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32489 }
