...
:if ([:len [/ip/route/find dst-address=206.0.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.193/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.193/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.194/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.194/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.196/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.196/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.200/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.200/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.208/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.208/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.133.224/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.133.224/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
:if ([:len [/ip/route/find dst-address=206.0.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.0.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32508 }
