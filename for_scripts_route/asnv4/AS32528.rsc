...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32528 and dst-address=for_scripts_route/asnv4/AS32528.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32528.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32528 }
