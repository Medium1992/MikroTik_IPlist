...
:if ([:len [/ip/route/find dst-address=62.244.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.244.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3254 }
...
:if ([:len [/ip/route/find dst-address=62.244.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.244.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3254 }
:if ([:len [/ip/route/find dst-address=62.244.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.244.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3254 }
