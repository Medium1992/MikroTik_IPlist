...
:if ([:len [/ip/route/find dst-address=45.152.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.152.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3255 }
:if ([:len [/ip/route/find dst-address=45.152.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.152.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3255 }
...
:if ([:len [/ip/route/find dst-address=46.174.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.174.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3255 }
