...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=168.222.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.222.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32620 }
:if ([:len [/ip/route/find dst-address=168.222.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.222.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32620 }
