...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32653 and dst-address=for_scripts_route/asnv4/AS32653.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32653.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32653 }
