...
:if ([:len [/ip/route/find dst-address=74.1.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32693 }
...
:if ([:len [/ip/route/find dst-address=74.1.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32693 }
