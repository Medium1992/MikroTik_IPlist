...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=164.153.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.153.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32710 }
:if ([:len [/ip/route/find dst-address=164.153.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.153.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32710 }
:if ([:len [/ip/route/find dst-address=164.153.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.153.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32710 }
:if ([:len [/ip/route/find dst-address=164.153.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.153.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32710 }
