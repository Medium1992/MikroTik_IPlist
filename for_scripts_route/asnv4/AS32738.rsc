...
:if ([:len [/ip/route/find dst-address=208.70.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.70.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32738 }
:if ([:len [/ip/route/find dst-address=208.70.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.70.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32738 }
:if ([:len [/ip/route/find dst-address=208.70.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.70.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32738 }
