...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS327687 and dst-address=for_scripts_route/asnv4/AS327687.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS327687.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327687 }
