...
:if ([:len [/ip/route/find dst-address=197.157.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.157.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327707 }
:if ([:len [/ip/route/find dst-address=197.157.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.157.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327707 }
...
:if ([:len [/ip/route/find dst-address=41.138.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.138.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327707 }
:if ([:len [/ip/route/find dst-address=41.138.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.138.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327707 }
