...
:if ([:len [/ip/route/find dst-address=102.0.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.0.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327708 }
...
:if ([:len [/ip/route/find dst-address=105.112.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.112.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327708 }
...
:if ([:len [/ip/route/find dst-address=105.112.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.112.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327708 }
