...
:if ([:len [/ip/route/find dst-address=197.157.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.157.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327708 }
...
:if ([:len [/ip/route/find dst-address=41.243.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327708 }
