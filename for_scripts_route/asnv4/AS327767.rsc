...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS327767 and dst-address=for_scripts_route/asnv4/AS327767.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS327767.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327767 }
