...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS327791 and dst-address=for_scripts_route/asnv4/AS327791.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS327791.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327791 }
