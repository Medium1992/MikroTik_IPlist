...
:if ([:len [/ip/route/find dst-address=102.36.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.36.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327794 }
:if ([:len [/ip/route/find dst-address=102.36.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.36.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327794 }
