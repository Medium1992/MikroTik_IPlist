...
:if ([:len [/ip/route/find dst-address=196.203.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.203.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327934 }
...
:if ([:len [/ip/route/find dst-address=196.203.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.203.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327934 }
...
:if ([:len [/ip/route/find dst-address=197.11.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.11.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327934 }
:if ([:len [/ip/route/find dst-address=197.11.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.11.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327934 }
