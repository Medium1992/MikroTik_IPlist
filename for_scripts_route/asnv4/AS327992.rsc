...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS327992 and dst-address=for_scripts_route/asnv4/AS327992.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS327992.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS327992 }
