...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS32800 and dst-address=for_scripts_route/asnv4/AS32800.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS32800.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32800 }
