...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS328015 and dst-address=for_scripts_route/asnv4/AS328015.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS328015.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328015 }
