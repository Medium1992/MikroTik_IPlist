...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.204.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.204.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328137 }
:if ([:len [/ip/route/find dst-address=102.204.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.204.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328137 }
...
:if ([:len [/ip/route/find dst-address=102.23.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.23.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328137 }
