...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=137.255.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.255.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328228 }
...
:if ([:len [/ip/route/find dst-address=137.255.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.255.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328228 }
...
:if ([:len [/ip/route/find dst-address=137.255.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.255.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328228 }
...
:if ([:len [/ip/route/find dst-address=137.255.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.255.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328228 }
