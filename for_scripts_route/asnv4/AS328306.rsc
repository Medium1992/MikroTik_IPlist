...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS328306 and dst-address=for_scripts_route/asnv4/AS328306.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS328306.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328306 }
