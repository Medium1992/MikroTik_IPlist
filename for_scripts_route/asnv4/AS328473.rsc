...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS328473 and dst-address=for_scripts_route/asnv4/AS328473.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS328473.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328473 }
