...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS328646 and dst-address=for_scripts_route/asnv4/AS328646.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS328646.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328646 }
