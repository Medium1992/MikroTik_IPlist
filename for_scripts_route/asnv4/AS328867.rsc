...
:if ([:len [/ip/route/find dst-address=149.18.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.18.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
:if ([:len [/ip/route/find dst-address=149.18.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.18.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
...
:if ([:len [/ip/route/find dst-address=204.167.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.167.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
:if ([:len [/ip/route/find dst-address=205.227.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.227.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
:if ([:len [/ip/route/find dst-address=205.243.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.243.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
:if ([:len [/ip/route/find dst-address=206.159.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.159.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
:if ([:len [/ip/route/find dst-address=207.120.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.120.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
:if ([:len [/ip/route/find dst-address=208.50.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.50.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
:if ([:len [/ip/route/find dst-address=216.22.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.22.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
...
:if ([:len [/ip/route/find dst-address=63.172.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=63.172.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328867 }
