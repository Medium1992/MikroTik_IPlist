...
:if ([:len [/ip/route/find dst-address=197.10.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
...
:if ([:len [/ip/route/find dst-address=197.10.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
...
:if ([:len [/ip/route/find dst-address=197.11.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.11.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
