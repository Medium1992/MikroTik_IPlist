...
:if ([:len [/ip/route/find dst-address=197.10.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
:if ([:len [/ip/route/find dst-address=197.10.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
:if ([:len [/ip/route/find dst-address=197.10.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
:if ([:len [/ip/route/find dst-address=197.10.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
...
:if ([:len [/ip/route/find dst-address=197.11.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.11.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
:if ([:len [/ip/route/find dst-address=197.11.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.11.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
