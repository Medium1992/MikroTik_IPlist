...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=196.203.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.203.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
:if ([:len [/ip/route/find dst-address=197.10.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
:if ([:len [/ip/route/find dst-address=197.10.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
...
:if ([:len [/ip/route/find dst-address=197.10.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
:if ([:len [/ip/route/find dst-address=197.10.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
...
:if ([:len [/ip/route/find dst-address=197.10.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.10.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
...
:if ([:len [/ip/route/find dst-address=197.11.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.11.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS328880 }
