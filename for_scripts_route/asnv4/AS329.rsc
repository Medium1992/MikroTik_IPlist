...
:if ([:len [/ip/route/find dst-address=55.51.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=55.51.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329 }
:if ([:len [/ip/route/find dst-address=55.78.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=55.78.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329 }
