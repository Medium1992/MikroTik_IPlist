...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS329048 and dst-address=for_scripts_route/asnv4/AS329048.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS329048.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329048 }
