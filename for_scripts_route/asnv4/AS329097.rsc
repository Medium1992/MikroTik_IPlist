...
:if ([:len [/ip/route/find dst-address=102.207.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.207.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329097 }
...
:if ([:len [/ip/route/find dst-address=206.185.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.185.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329097 }
