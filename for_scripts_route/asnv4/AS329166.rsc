...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS329166 and dst-address=for_scripts_route/asnv4/AS329166.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS329166.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329166 }
