...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS329181 and dst-address=for_scripts_route/asnv4/AS329181.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS329181.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329181 }
