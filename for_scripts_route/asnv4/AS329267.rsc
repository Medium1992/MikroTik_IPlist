...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS329267 and dst-address=for_scripts_route/asnv4/AS329267.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS329267.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329267 }
