...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.204.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.204.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329267 }
...
:if ([:len [/ip/route/find dst-address=102.219.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.219.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329267 }
