...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS329305 and dst-address=for_scripts_route/asnv4/AS329305.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS329305.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329305 }
