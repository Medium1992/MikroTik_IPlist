...
:if ([:len [/ip/route/find dst-address=57.141.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.141.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32934 }
:if ([:len [/ip/route/find dst-address=57.141.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.141.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32934 }
:if ([:len [/ip/route/find dst-address=57.141.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.141.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32934 }
