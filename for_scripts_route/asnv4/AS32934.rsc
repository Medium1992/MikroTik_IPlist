...
:if ([:len [/ip/route/find dst-address=57.141.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.141.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32934 }
:if ([:len [/ip/route/find dst-address=57.141.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.141.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32934 }
:if ([:len [/ip/route/find dst-address=57.141.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.141.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32934 }
:if ([:len [/ip/route/find dst-address=57.141.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=57.141.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS32934 }
