...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.201.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.201.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329341 }
:if ([:len [/ip/route/find dst-address=102.203.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.203.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329341 }
:if ([:len [/ip/route/find dst-address=102.203.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.203.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS329341 }
