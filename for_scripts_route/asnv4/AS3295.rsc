...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS3295 and dst-address=for_scripts_route/asnv4/AS3295.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS3295.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3295 }
