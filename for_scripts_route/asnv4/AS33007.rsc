...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33007 and dst-address=for_scripts_route/asnv4/AS33007.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33007.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33007 }
