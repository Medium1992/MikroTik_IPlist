...
:if ([:len [/ip/route/find dst-address=142.248.218.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.248.218.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33039 }
...
:if ([:len [/ip/route/find dst-address=44.32.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=44.32.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33039 }
