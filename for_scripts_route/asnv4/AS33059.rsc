...
:if ([:len [/ip/route/find dst-address=204.174.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.174.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33059 }
...
:if ([:len [/ip/route/find dst-address=64.92.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.92.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33059 }
