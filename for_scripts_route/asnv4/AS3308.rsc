...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=158.233.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.233.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3308 }
...
:if ([:len [/ip/route/find dst-address=195.110.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.110.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3308 }
