...
:if ([:len [/ip/route/find dst-address=162.35.142.0/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.0/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
:if ([:len [/ip/route/find dst-address=162.35.142.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
:if ([:len [/ip/route/find dst-address=162.35.142.16/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.16/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
:if ([:len [/ip/route/find dst-address=162.35.142.24/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.24/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
:if ([:len [/ip/route/find dst-address=162.35.142.27/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.27/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
:if ([:len [/ip/route/find dst-address=162.35.142.28/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.28/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
:if ([:len [/ip/route/find dst-address=162.35.142.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
:if ([:len [/ip/route/find dst-address=162.35.142.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.35.142.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33099 }
