...
:if ([:len [/ip/route/find dst-address=138.129.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.129.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33136 }
...
:if ([:len [/ip/route/find dst-address=138.129.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.129.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33136 }
:if ([:len [/ip/route/find dst-address=138.129.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.129.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33136 }
...
:if ([:len [/ip/route/find dst-address=69.9.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.9.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33136 }
:if ([:len [/ip/route/find dst-address=69.9.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.9.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33136 }
