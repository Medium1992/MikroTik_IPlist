...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33178 and dst-address=for_scripts_route/asnv4/AS33178.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33178.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33178 }
