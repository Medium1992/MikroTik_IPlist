...
:if ([:len [/ip/route/find dst-address=195.178.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.178.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3319 }
...
:if ([:len [/ip/route/find dst-address=195.178.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.178.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3319 }
...
:if ([:len [/ip/route/find dst-address=77.47.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.47.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3319 }
...
:if ([:len [/ip/route/find dst-address=77.47.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.47.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3319 }
