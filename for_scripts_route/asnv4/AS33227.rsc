...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33227 and dst-address=for_scripts_route/asnv4/AS33227.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33227.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33227 }
