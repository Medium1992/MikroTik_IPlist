...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33257 and dst-address=for_scripts_route/asnv4/AS33257.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33257.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33257 }
