...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33261 and dst-address=for_scripts_route/asnv4/AS33261.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33261.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33261 }
