...
:if ([:len [/ip/route/find dst-address=62.128.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.128.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3327 }
...
:if ([:len [/ip/route/find dst-address=89.219.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.219.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3327 }
