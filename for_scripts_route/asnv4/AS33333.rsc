...
:if ([:len [/ip/route/find dst-address=186.190.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.190.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
...
:if ([:len [/ip/route/find dst-address=186.190.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.190.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
...
:if ([:len [/ip/route/find dst-address=67.220.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.220.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
:if ([:len [/ip/route/find dst-address=68.168.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.168.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
:if ([:len [/ip/route/find dst-address=68.168.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.168.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
:if ([:len [/ip/route/find dst-address=68.168.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.168.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
:if ([:len [/ip/route/find dst-address=68.168.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.168.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
:if ([:len [/ip/route/find dst-address=69.42.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.42.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
:if ([:len [/ip/route/find dst-address=69.42.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.42.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
...
:if ([:len [/ip/route/find dst-address=69.42.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.42.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
