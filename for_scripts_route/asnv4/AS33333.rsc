...
:if ([:len [/ip/route/find dst-address=67.220.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.220.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
...
:if ([:len [/ip/route/find dst-address=69.42.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.42.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
