...
:if ([:len [/ip/route/find dst-address=67.220.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.220.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
:if ([:len [/ip/route/find dst-address=67.220.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.220.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33333 }
