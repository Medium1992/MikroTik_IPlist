...
:if ([:len [/ip/route/find dst-address=162.254.211.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.254.211.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33346 }
:if ([:len [/ip/route/find dst-address=162.254.211.224/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.254.211.224/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33346 }
:if ([:len [/ip/route/find dst-address=162.254.211.226/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.254.211.226/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33346 }
:if ([:len [/ip/route/find dst-address=162.254.211.228/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.254.211.228/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33346 }
:if ([:len [/ip/route/find dst-address=162.254.211.232/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.254.211.232/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33346 }
:if ([:len [/ip/route/find dst-address=162.254.211.240/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.254.211.240/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33346 }
