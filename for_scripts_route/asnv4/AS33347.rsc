...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33347 and dst-address=for_scripts_route/asnv4/AS33347.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33347.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33347 }
