...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33354 and dst-address=for_scripts_route/asnv4/AS33354.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33354.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33354 }
