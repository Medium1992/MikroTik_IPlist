...
:if ([:len [/ip/route/find dst-address=69.89.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.112/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.112/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.120/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.120/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.123/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.123/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.124/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.124/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.198.96/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.198.96/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
:if ([:len [/ip/route/find dst-address=69.89.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.89.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33362 }
