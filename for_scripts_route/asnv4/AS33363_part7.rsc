...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33363 and dst-address=for_scripts_route/asnv4/AS33363_part7.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33363_part7.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33363 }
