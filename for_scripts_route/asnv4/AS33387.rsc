...
:if ([:len [/ip/route/find dst-address=142.111.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.111.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33387 }
...
:if ([:len [/ip/route/find dst-address=23.148.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33387 }
