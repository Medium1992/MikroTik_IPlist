...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33420 and dst-address=for_scripts_route/asnv4/AS33420.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33420.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33420 }
