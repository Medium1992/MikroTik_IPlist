...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33426 and dst-address=for_scripts_route/asnv4/AS33426.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33426.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33426 }
