...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33442 and dst-address=for_scripts_route/asnv4/AS33442.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33442.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33442 }
