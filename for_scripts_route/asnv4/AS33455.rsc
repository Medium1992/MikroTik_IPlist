...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33455 and dst-address=for_scripts_route/asnv4/AS33455.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33455.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33455 }
