...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33468 and dst-address=for_scripts_route/asnv4/AS33468.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33468.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33468 }
