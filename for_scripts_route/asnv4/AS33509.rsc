...
:if ([:len [/ip/route/find dst-address=72.19.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.0/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.0/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.16/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.16/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.3/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.3/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.4/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.4/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.51.8/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.51.8/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=72.19.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.19.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
