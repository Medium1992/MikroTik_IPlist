...
:if ([:len [/ip/route/find dst-address=38.134.234.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=38.134.234.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=38.134.234.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=38.134.234.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=38.134.234.240/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.240/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=38.134.234.242/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.242/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=38.134.234.244/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.244/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
:if ([:len [/ip/route/find dst-address=38.134.234.248/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.134.234.248/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33509 }
