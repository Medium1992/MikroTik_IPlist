...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33522 and dst-address=for_scripts_route/asnv4/AS33522.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33522.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33522 }
