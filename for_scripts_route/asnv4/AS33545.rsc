...
:if ([:len [/ip/route/find dst-address=192.246.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.246.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33545 }
:if ([:len [/ip/route/find dst-address=192.246.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.246.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33545 }
:if ([:len [/ip/route/find dst-address=192.246.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.246.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33545 }
