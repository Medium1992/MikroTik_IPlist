...
:if ([:len [/ip/route/find dst-address=104.192.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.192.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33549 }
:if ([:len [/ip/route/find dst-address=104.192.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.192.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33549 }
