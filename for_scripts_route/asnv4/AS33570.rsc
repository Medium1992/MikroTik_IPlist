...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33570 and dst-address=for_scripts_route/asnv4/AS33570.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33570.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33570 }
