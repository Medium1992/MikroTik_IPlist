...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33576 and dst-address=for_scripts_route/asnv4/AS33576.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33576.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33576 }
