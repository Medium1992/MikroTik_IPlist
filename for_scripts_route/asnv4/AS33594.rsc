...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33594 and dst-address=for_scripts_route/asnv4/AS33594.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33594.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33594 }
