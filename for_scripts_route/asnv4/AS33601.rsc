...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33601 and dst-address=for_scripts_route/asnv4/AS33601.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33601.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33601 }
