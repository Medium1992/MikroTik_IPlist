...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33602 and dst-address=for_scripts_route/asnv4/AS33602.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33602.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33602 }
