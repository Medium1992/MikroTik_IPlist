...
:if ([:len [/ip/route/find dst-address=165.204.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.204.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33619 }
...
:if ([:len [/ip/route/find dst-address=165.204.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.204.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33619 }
...
:if ([:len [/ip/route/find dst-address=165.204.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.204.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33619 }
