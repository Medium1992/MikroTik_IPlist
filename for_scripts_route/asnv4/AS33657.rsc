...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=107.1.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.1.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33657 }
...
:if ([:len [/ip/route/find dst-address=192.189.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.189.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33657 }
...
:if ([:len [/ip/route/find dst-address=50.202.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.202.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33657 }
...
:if ([:len [/ip/route/find dst-address=50.218.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.218.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33657 }
...
:if ([:len [/ip/route/find dst-address=50.226.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.226.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33657 }
