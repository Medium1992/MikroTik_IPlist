...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33674 and dst-address=for_scripts_route/asnv4/AS33674.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33674.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33674 }
