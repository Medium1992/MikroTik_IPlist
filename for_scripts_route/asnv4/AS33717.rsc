...
:if ([:len [/ip/route/find dst-address=208.70.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.70.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33717 }
...
:if ([:len [/ip/route/find dst-address=66.150.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.150.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33717 }
