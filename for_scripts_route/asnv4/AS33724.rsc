...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.152.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.152.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33724 }
:if ([:len [/ip/route/find dst-address=104.222.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.222.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33724 }
:if ([:len [/ip/route/find dst-address=104.222.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.222.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33724 }
...
:if ([:len [/ip/route/find dst-address=170.55.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.55.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33724 }
...
:if ([:len [/ip/route/find dst-address=204.9.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.9.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33724 }
...
:if ([:len [/ip/route/find dst-address=205.196.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.196.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33724 }
