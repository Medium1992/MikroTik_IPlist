...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33753 and dst-address=for_scripts_route/asnv4/AS33753.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33753.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33753 }
