...
:if ([:len [/ip/route/find dst-address=196.29.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.29.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33788 }
...
:if ([:len [/ip/route/find dst-address=196.29.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.29.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33788 }
...
:if ([:len [/ip/route/find dst-address=197.254.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.254.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33788 }
...
:if ([:len [/ip/route/find dst-address=41.202.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.202.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33788 }
:if ([:len [/ip/route/find dst-address=41.202.162.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.202.162.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33788 }
