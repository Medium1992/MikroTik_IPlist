...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33852 and dst-address=for_scripts_route/asnv4/AS33852.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33852.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33852 }
