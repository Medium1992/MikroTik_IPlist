...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33871 and dst-address=for_scripts_route/asnv4/AS33871.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33871.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33871 }
