...
:if ([:len [/ip/route/find dst-address=141.170.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.170.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33920 }
:if ([:len [/ip/route/find dst-address=141.170.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.170.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33920 }
:if ([:len [/ip/route/find dst-address=141.170.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.170.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33920 }
:if ([:len [/ip/route/find dst-address=141.170.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.170.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33920 }
