...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33930 and dst-address=for_scripts_route/asnv4/AS33930.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33930.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33930 }
