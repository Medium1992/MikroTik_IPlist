...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS33970 and dst-address=for_scripts_route/asnv4/AS33970.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS33970.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS33970 }
