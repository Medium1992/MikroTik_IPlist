...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=164.37.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.37.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3399 }
...
:if ([:len [/ip/route/find dst-address=194.14.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.14.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3399 }
:if ([:len [/ip/route/find dst-address=194.32.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.32.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3399 }
...
:if ([:len [/ip/route/find dst-address=93.164.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.164.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3399 }
