...
:if ([:len [/ip/route/find dst-address=149.143.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.143.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34119 }
:if ([:len [/ip/route/find dst-address=149.143.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.143.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34119 }
