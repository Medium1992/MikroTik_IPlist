...
:if ([:len [/ip/route/find dst-address=77.90.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.90.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34120 }
:if ([:len [/ip/route/find dst-address=77.90.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.90.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34120 }
