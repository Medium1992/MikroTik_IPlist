...
:if ([:len [/ip/route/find dst-address=185.92.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.92.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34170 }
...
:if ([:len [/ip/route/find dst-address=194.135.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.135.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34170 }
:if ([:len [/ip/route/find dst-address=212.47.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.47.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34170 }
