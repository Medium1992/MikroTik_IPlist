...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS34210 and dst-address=for_scripts_route/asnv4/AS34210.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS34210.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34210 }
