...
:if ([:len [/ip/route/find dst-address=89.238.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.238.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34240 }
:if ([:len [/ip/route/find dst-address=89.238.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.238.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34240 }
:if ([:len [/ip/route/find dst-address=89.238.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.238.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34240 }
