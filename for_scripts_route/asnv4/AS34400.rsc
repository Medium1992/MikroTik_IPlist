...
:if ([:len [/ip/route/find dst-address=37.124.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.124.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34400 }
:if ([:len [/ip/route/find dst-address=37.127.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.127.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34400 }
...
:if ([:len [/ip/route/find dst-address=37.242.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.242.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34400 }
