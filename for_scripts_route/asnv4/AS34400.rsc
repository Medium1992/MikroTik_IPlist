...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS34400 and dst-address=for_scripts_route/asnv4/AS34400.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS34400.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34400 }
