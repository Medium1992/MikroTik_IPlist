...
:if ([:len [/ip/route/find dst-address=185.49.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.49.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34412 }
...
:if ([:len [/ip/route/find dst-address=77.72.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.72.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34412 }
