...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=113.203.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.203.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34450 }
:if ([:len [/ip/route/find dst-address=113.203.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.203.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34450 }
...
:if ([:len [/ip/route/find dst-address=85.204.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.204.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34450 }
...
:if ([:len [/ip/route/find dst-address=89.43.41.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.43.41.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34450 }
...
:if ([:len [/ip/route/find dst-address=93.114.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.114.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34450 }
