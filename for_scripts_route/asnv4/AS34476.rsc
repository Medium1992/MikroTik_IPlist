...
:if ([:len [/ip/route/find dst-address=153.56.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34476 }
...
:if ([:len [/ip/route/find dst-address=45.139.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.139.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34476 }
