...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS34578 and dst-address=for_scripts_route/asnv4/AS34578.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS34578.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34578 }
