...
:if ([:len [/ip/route/find dst-address=185.167.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.167.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34606 }
...
:if ([:len [/ip/route/find dst-address=94.100.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.100.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34606 }
