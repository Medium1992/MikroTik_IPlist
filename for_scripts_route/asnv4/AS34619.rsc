...
:if ([:len [/ip/route/find dst-address=80.253.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.253.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34619 }
:if ([:len [/ip/route/find dst-address=80.253.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.253.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34619 }
