...
:if ([:len [/ip/route/find dst-address=61.224.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.224.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.226.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.226.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.227.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.227.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
:if ([:len [/ip/route/find dst-address=61.228.0.0/14 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.228.0.0/14 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3462 }
