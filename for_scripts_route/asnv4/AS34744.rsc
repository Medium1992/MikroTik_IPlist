...
:if ([:len [/ip/route/find dst-address=77.36.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.36.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34744 }
:if ([:len [/ip/route/find dst-address=77.36.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.36.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34744 }
