...
:if ([:len [/ip/route/find dst-address=85.234.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.234.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34790 }
:if ([:len [/ip/route/find dst-address=85.234.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.234.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34790 }
:if ([:len [/ip/route/find dst-address=85.234.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.234.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34790 }
