...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=193.8.63.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.8.63.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
...
:if ([:len [/ip/route/find dst-address=95.86.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
...
:if ([:len [/ip/route/find dst-address=95.86.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
:if ([:len [/ip/route/find dst-address=95.86.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
:if ([:len [/ip/route/find dst-address=95.86.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
