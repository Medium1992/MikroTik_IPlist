...
:if ([:len [/ip/route/find dst-address=95.86.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
:if ([:len [/ip/route/find dst-address=95.86.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
:if ([:len [/ip/route/find dst-address=95.86.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
