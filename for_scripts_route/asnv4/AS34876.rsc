...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=193.8.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.8.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
...
:if ([:len [/ip/route/find dst-address=95.86.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
...
:if ([:len [/ip/route/find dst-address=95.86.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.86.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34876 }
