...
:if ([:len [/ip/route/find dst-address=80.89.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.89.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34913 }
:if ([:len [/ip/route/find dst-address=80.89.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.89.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34913 }
:if ([:len [/ip/route/find dst-address=80.89.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.89.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34913 }
:if ([:len [/ip/route/find dst-address=80.89.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.89.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34913 }
