...
:if ([:len [/ip/route/find dst-address=78.108.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.108.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34918 }
...
:if ([:len [/ip/route/find dst-address=85.9.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.9.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34918 }
:if ([:len [/ip/route/find dst-address=85.9.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.9.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34918 }
