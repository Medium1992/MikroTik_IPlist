...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS34928 and dst-address=for_scripts_route/asnv4/AS34928.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS34928.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34928 }
