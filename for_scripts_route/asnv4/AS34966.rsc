...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS34966 and dst-address=for_scripts_route/asnv4/AS34966.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS34966.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS34966 }
