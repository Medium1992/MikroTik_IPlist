...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35000 and dst-address=for_scripts_route/asnv4/AS35000.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35000.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35000 }
