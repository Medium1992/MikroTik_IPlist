...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35043 and dst-address=for_scripts_route/asnv4/AS35043.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35043.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35043 }
