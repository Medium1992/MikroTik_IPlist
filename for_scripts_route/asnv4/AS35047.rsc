...
:if ([:len [/ip/route/find dst-address=185.55.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.55.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35047 }
:if ([:len [/ip/route/find dst-address=185.55.150.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.55.150.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35047 }
