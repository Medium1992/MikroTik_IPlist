...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35053 and dst-address=for_scripts_route/asnv4/AS35053.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35053.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35053 }
