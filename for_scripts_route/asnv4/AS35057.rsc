...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35057 and dst-address=for_scripts_route/asnv4/AS35057.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35057.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35057 }
