...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.20.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.20.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
...
:if ([:len [/ip/route/find dst-address=188.127.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.127.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
...
:if ([:len [/ip/route/find dst-address=188.127.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.127.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
...
:if ([:len [/ip/route/find dst-address=80.242.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.242.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
:if ([:len [/ip/route/find dst-address=80.242.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.242.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
:if ([:len [/ip/route/find dst-address=80.242.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.242.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
:if ([:len [/ip/route/find dst-address=80.242.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.242.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
:if ([:len [/ip/route/find dst-address=89.219.24.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.219.24.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
:if ([:len [/ip/route/find dst-address=89.219.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.219.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35104 }
