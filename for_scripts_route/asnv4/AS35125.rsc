...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=212.3.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.3.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35125 }
:if ([:len [/ip/route/find dst-address=212.3.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.3.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35125 }
:if ([:len [/ip/route/find dst-address=212.3.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.3.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35125 }
...
:if ([:len [/ip/route/find dst-address=212.3.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.3.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35125 }
:if ([:len [/ip/route/find dst-address=212.3.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.3.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35125 }
:if ([:len [/ip/route/find dst-address=212.3.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.3.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35125 }
