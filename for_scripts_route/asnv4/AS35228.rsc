...
:if ([:len [/ip/route/find dst-address=185.132.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.132.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35228 }
...
:if ([:len [/ip/route/find dst-address=217.137.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.137.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35228 }
:if ([:len [/ip/route/find dst-address=217.137.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.137.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35228 }
:if ([:len [/ip/route/find dst-address=217.137.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.137.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35228 }
