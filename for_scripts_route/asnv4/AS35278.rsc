...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35278 and dst-address=for_scripts_route/asnv4/AS35278.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35278.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35278 }
