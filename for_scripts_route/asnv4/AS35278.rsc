...
:if ([:len [/ip/route/find dst-address=186.246.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.246.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35278 }
:if ([:len [/ip/route/find dst-address=191.44.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.44.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35278 }
