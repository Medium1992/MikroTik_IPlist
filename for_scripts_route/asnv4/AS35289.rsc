...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35289 and dst-address=for_scripts_route/asnv4/AS35289.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35289.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35289 }
