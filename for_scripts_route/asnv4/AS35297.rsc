...
:if ([:len [/ip/route/find dst-address=5.53.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.53.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35297 }
:if ([:len [/ip/route/find dst-address=5.53.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.53.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35297 }
:if ([:len [/ip/route/find dst-address=5.53.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.53.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35297 }
