...
:if ([:len [/ip/route/find dst-address=5.23.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.23.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35382 }
...
:if ([:len [/ip/route/find dst-address=83.143.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.143.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35382 }
