...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35442 and dst-address=for_scripts_route/asnv4/AS35442.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35442.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35442 }
