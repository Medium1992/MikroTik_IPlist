...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35444 and dst-address=for_scripts_route/asnv4/AS35444.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35444.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35444 }
