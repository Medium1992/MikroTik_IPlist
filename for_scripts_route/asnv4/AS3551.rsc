...
:if ([:len [/ip/route/find dst-address=168.77.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.77.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3551 }
:if ([:len [/ip/route/find dst-address=168.77.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.77.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3551 }
:if ([:len [/ip/route/find dst-address=168.77.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.77.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3551 }
:if ([:len [/ip/route/find dst-address=168.77.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.77.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3551 }
...
:if ([:len [/ip/route/find dst-address=168.77.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.77.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3551 }
:if ([:len [/ip/route/find dst-address=168.77.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.77.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3551 }
