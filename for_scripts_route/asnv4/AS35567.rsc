...
:if ([:len [/ip/route/find dst-address=91.191.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
:if ([:len [/ip/route/find dst-address=91.191.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35567 }
