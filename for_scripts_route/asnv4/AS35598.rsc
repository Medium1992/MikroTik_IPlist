...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35598 and dst-address=for_scripts_route/asnv4/AS35598.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35598.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35598 }
