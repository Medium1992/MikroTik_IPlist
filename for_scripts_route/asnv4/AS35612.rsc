...
:if ([:len [/ip/route/find dst-address=5.157.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.240/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.240/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.248/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.248/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.250/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.250/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.122.252/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.122.252/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
:if ([:len [/ip/route/find dst-address=5.157.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.157.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35612 }
