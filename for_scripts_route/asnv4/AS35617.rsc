...
:if ([:len [/ip/route/find dst-address=193.168.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.168.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35617 }
:if ([:len [/ip/route/find dst-address=194.62.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.62.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35617 }
