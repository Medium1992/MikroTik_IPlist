...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=66.100.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.100.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.101.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.101.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.119.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.119.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.128.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.128.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.128.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.128.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.150.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.150.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.180.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.180.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.207.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.207.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.35.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.35.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
:if ([:len [/ip/route/find dst-address=66.37.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.37.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3561 }
