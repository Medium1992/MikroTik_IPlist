...
:if ([:len [/ip/route/find dst-address=51.241.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.241.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35661 }
:if ([:len [/ip/route/find dst-address=64.204.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.204.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35661 }
