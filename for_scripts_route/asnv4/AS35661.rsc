...
:if ([:len [/ip/route/find dst-address=87.76.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.76.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35661 }
...
:if ([:len [/ip/route/find dst-address=89.126.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.126.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35661 }
:if ([:len [/ip/route/find dst-address=91.210.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.210.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35661 }
