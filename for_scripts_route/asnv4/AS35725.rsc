...
:if ([:len [/ip/route/find dst-address=193.104.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.104.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35725 }
:if ([:len [/ip/route/find dst-address=85.120.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.120.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35725 }
:if ([:len [/ip/route/find dst-address=85.121.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.121.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35725 }
:if ([:len [/ip/route/find dst-address=89.33.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.33.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35725 }
:if ([:len [/ip/route/find dst-address=89.33.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.33.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35725 }
