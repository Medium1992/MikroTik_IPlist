...
:if ([:len [/ip/route/find dst-address=213.109.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.109.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35745 }
:if ([:len [/ip/route/find dst-address=213.109.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.109.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35745 }
:if ([:len [/ip/route/find dst-address=213.109.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.109.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35745 }
:if ([:len [/ip/route/find dst-address=37.131.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.131.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35745 }
:if ([:len [/ip/route/find dst-address=37.131.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.131.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35745 }
:if ([:len [/ip/route/find dst-address=37.131.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.131.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35745 }
...
:if ([:len [/ip/route/find dst-address=91.208.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.208.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35745 }
