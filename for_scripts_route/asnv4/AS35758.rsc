...
:if ([:len [/ip/route/find dst-address=147.78.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.78.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35758 }
...
:if ([:len [/ip/route/find dst-address=185.126.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.126.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35758 }
...
:if ([:len [/ip/route/find dst-address=213.169.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.169.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35758 }
...
:if ([:len [/ip/route/find dst-address=217.11.162.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.11.162.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35758 }
...
:if ([:len [/ip/route/find dst-address=62.192.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.192.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35758 }
