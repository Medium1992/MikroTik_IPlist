...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.123.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.123.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
...
:if ([:len [/ip/route/find dst-address=185.88.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.88.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
...
:if ([:len [/ip/route/find dst-address=91.197.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.197.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
