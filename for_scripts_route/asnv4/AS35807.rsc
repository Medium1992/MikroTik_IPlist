...
:if ([:len [/ip/route/find dst-address=88.201.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.201.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
:if ([:len [/ip/route/find dst-address=88.201.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.201.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
:if ([:len [/ip/route/find dst-address=88.201.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.201.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
:if ([:len [/ip/route/find dst-address=88.201.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.201.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
:if ([:len [/ip/route/find dst-address=88.201.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.201.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
:if ([:len [/ip/route/find dst-address=88.201.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.201.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35807 }
