...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35824 and dst-address=for_scripts_route/asnv4/AS35824.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35824.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35824 }
