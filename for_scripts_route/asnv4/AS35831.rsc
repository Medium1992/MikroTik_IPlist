...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35831 and dst-address=for_scripts_route/asnv4/AS35831.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35831.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35831 }
