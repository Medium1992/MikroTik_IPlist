...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35874 and dst-address=for_scripts_route/asnv4/AS35874.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35874.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35874 }
