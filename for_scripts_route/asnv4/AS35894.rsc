...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35894 and dst-address=for_scripts_route/asnv4/AS35894.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35894.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35894 }
