...
:if ([:len [/ip/route/find dst-address=98.126.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.126.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35908 }
:if ([:len [/ip/route/find dst-address=98.126.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.126.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35908 }
:if ([:len [/ip/route/find dst-address=98.126.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.126.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35908 }
:if ([:len [/ip/route/find dst-address=98.126.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.126.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35908 }
:if ([:len [/ip/route/find dst-address=98.126.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.126.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35908 }
