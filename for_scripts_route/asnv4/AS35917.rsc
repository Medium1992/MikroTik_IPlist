...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS35917 and dst-address=for_scripts_route/asnv4/AS35917.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS35917.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS35917 }
