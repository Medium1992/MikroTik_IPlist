...
:if ([:len [/ip/route/find dst-address=187.40.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.40.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36012 }
:if ([:len [/ip/route/find dst-address=187.40.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.40.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36012 }
:if ([:len [/ip/route/find dst-address=187.40.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.40.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36012 }
...
:if ([:len [/ip/route/find dst-address=66.178.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.178.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36012 }
