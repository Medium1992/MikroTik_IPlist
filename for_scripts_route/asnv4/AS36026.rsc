...
:if ([:len [/ip/route/find dst-address=160.76.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.76.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36026 }
...
:if ([:len [/ip/route/find dst-address=162.135.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.135.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36026 }
:if ([:len [/ip/route/find dst-address=162.135.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.135.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36026 }
