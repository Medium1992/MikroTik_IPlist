...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36048 and dst-address=for_scripts_route/asnv4/AS36048.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36048.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36048 }
