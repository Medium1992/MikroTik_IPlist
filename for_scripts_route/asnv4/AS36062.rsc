...
:if ([:len [/ip/route/find dst-address=38.64.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.64.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36062 }
:if ([:len [/ip/route/find dst-address=69.67.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.67.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36062 }
