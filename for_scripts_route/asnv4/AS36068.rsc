...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36068 and dst-address=for_scripts_route/asnv4/AS36068.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36068.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36068 }
