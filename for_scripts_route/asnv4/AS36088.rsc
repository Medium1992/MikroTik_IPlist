...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36088 and dst-address=for_scripts_route/asnv4/AS36088.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36088.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36088 }
