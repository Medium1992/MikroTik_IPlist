...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=69.163.68.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.163.68.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36103 }
:if ([:len [/ip/route/find dst-address=69.163.68.160/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.163.68.160/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36103 }
:if ([:len [/ip/route/find dst-address=69.163.68.177/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.163.68.177/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36103 }
:if ([:len [/ip/route/find dst-address=69.163.68.178/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.163.68.178/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36103 }
:if ([:len [/ip/route/find dst-address=69.163.68.180/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.163.68.180/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36103 }
:if ([:len [/ip/route/find dst-address=69.163.68.184/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.163.68.184/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36103 }
:if ([:len [/ip/route/find dst-address=69.163.68.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.163.68.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36103 }
