...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36146 and dst-address=for_scripts_route/asnv4/AS36146.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36146.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36146 }
