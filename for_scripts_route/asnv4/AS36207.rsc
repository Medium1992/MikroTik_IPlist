...
:if ([:len [/ip/route/find dst-address=67.130.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.32/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.32/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.36/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.36/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.38/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.38/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.40/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.40/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.164.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.164.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
:if ([:len [/ip/route/find dst-address=67.130.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.130.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36207 }
