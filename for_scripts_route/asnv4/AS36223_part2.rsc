...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=67.199.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.64/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.64/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.80/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.80/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.88/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.88/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.92/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.92/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.94/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.94/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.181.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.181.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
:if ([:len [/ip/route/find dst-address=67.199.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.199.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36223 }
