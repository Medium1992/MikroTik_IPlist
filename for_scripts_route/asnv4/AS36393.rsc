...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36393 and dst-address=for_scripts_route/asnv4/AS36393.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36393.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36393 }
