...
:if ([:len [/ip/route/find dst-address=104.134.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.134.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
:if ([:len [/ip/route/find dst-address=104.134.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.134.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
...
:if ([:len [/ip/route/find dst-address=104.135.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.135.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
...
:if ([:len [/ip/route/find dst-address=136.126.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.126.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
:if ([:len [/ip/route/find dst-address=136.126.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.126.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
:if ([:len [/ip/route/find dst-address=136.126.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.126.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
:if ([:len [/ip/route/find dst-address=136.126.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.126.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
:if ([:len [/ip/route/find dst-address=136.126.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.126.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
:if ([:len [/ip/route/find dst-address=136.126.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.126.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
