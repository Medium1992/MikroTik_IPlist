...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36411 and dst-address=for_scripts_route/asnv4/AS36411.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36411.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36411 }
