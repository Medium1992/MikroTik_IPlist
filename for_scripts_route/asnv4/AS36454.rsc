...
:if ([:len [/ip/route/find dst-address=170.39.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.39.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36454 }
...
:if ([:len [/ip/route/find dst-address=194.39.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.39.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36454 }
...
:if ([:len [/ip/route/find dst-address=65.181.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.181.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36454 }
:if ([:len [/ip/route/find dst-address=65.98.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.98.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36454 }
