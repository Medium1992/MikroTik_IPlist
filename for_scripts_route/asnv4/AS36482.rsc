...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36482 and dst-address=for_scripts_route/asnv4/AS36482.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36482.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36482 }
