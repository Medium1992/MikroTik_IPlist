...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS3653 and dst-address=for_scripts_route/asnv4/AS3653.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS3653.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3653 }
