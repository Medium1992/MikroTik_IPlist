...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36544 and dst-address=for_scripts_route/asnv4/AS36544.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36544.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36544 }
