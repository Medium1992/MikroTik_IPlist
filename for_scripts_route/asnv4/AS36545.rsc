...
:if ([:len [/ip/route/find dst-address=66.9.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.128/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.128/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.136/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.136/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.141/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.141/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.142/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.142/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.144/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.144/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.160/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.160/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.91.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.91.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
:if ([:len [/ip/route/find dst-address=66.9.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.9.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36545 }
