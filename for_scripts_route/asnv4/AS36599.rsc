...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36599 and dst-address=for_scripts_route/asnv4/AS36599.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36599.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36599 }
