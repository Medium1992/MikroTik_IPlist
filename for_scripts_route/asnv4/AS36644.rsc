...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36644 and dst-address=for_scripts_route/asnv4/AS36644.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36644.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36644 }
