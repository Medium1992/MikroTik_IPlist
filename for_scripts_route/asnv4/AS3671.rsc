...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS3671 and dst-address=for_scripts_route/asnv4/AS3671.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS3671.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3671 }
