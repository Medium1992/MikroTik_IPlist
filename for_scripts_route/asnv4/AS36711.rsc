...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36711 and dst-address=for_scripts_route/asnv4/AS36711.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36711.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36711 }
