...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36752 and dst-address=for_scripts_route/asnv4/AS36752.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36752.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36752 }
