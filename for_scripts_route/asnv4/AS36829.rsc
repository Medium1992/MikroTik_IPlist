...
:if ([:len [/ip/route/find dst-address=104.164.93.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.164.93.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36829 }
...
:if ([:len [/ip/route/find dst-address=166.88.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.88.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36829 }
...
:if ([:len [/ip/route/find dst-address=23.27.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.27.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36829 }
