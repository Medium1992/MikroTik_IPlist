...
:if ([:len [/ip/route/find dst-address=64.65.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.65.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36849 }
:if ([:len [/ip/route/find dst-address=64.65.63.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.65.63.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36849 }
