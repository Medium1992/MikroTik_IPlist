...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36868 and dst-address=for_scripts_route/asnv4/AS36868.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36868.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36868 }
