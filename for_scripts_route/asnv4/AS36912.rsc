...
:if ([:len [/ip/route/find dst-address=102.244.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.244.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36912 }
:if ([:len [/ip/route/find dst-address=102.244.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.244.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36912 }
:if ([:len [/ip/route/find dst-address=102.244.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.244.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36912 }
:if ([:len [/ip/route/find dst-address=102.244.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.244.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36912 }
