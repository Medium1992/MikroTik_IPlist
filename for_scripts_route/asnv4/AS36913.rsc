...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36913 and dst-address=for_scripts_route/asnv4/AS36913.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36913.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36913 }
