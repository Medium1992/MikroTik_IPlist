...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.216.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.216.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36925 }
:if ([:len [/ip/route/find dst-address=102.96.0.0/13 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.96.0.0/13 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36925 }
