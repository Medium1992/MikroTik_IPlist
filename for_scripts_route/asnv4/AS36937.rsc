...
:if ([:len [/ip/route/find dst-address=41.173.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36937 }
:if ([:len [/ip/route/find dst-address=41.173.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36937 }
:if ([:len [/ip/route/find dst-address=41.173.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36937 }
:if ([:len [/ip/route/find dst-address=41.173.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36937 }
:if ([:len [/ip/route/find dst-address=41.173.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36937 }
...
:if ([:len [/ip/route/find dst-address=41.173.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.173.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36937 }
