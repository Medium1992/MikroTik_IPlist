...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.201.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.201.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36947 }
...
:if ([:len [/ip/route/find dst-address=41.106.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.106.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36947 }
