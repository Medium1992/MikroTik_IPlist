...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36958 and dst-address=for_scripts_route/asnv4/AS36958.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36958.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36958 }
