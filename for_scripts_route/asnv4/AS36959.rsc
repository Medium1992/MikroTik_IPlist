...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36959 and dst-address=for_scripts_route/asnv4/AS36959.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36959.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36959 }
