...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36986 and dst-address=for_scripts_route/asnv4/AS36986.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36986.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36986 }
