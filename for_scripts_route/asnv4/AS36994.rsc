...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS36994 and dst-address=for_scripts_route/asnv4/AS36994.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS36994.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36994 }
