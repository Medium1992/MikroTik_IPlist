...
:if ([:len [/ip/route/find dst-address=154.100.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.100.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
:if ([:len [/ip/route/find dst-address=154.100.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.100.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
...
:if ([:len [/ip/route/find dst-address=41.95.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.95.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
