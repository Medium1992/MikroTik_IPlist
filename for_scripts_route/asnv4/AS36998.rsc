...
:if ([:len [/ip/route/find dst-address=154.100.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.100.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
...
:if ([:len [/ip/route/find dst-address=41.95.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.95.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS36998 }
