...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=196.61.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.61.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37012 }
:if ([:len [/ip/route/find dst-address=196.61.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.61.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37012 }
:if ([:len [/ip/route/find dst-address=196.61.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.61.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37012 }
:if ([:len [/ip/route/find dst-address=196.61.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.61.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37012 }
