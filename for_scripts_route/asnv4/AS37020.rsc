...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=196.61.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.61.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
...
:if ([:len [/ip/route/find dst-address=41.243.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
...
:if ([:len [/ip/route/find dst-address=41.243.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
...
:if ([:len [/ip/route/find dst-address=41.243.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
...
:if ([:len [/ip/route/find dst-address=41.243.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
