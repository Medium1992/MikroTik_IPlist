...
:if ([:len [/ip/route/find dst-address=41.243.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
:if ([:len [/ip/route/find dst-address=41.243.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
...
:if ([:len [/ip/route/find dst-address=41.243.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.243.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37020 }
