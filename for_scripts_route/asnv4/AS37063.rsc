...
:if ([:len [/ip/route/find dst-address=154.0.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.0.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37063 }
:if ([:len [/ip/route/find dst-address=41.191.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.191.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37063 }
