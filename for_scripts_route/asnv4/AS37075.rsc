...
:if ([:len [/ip/route/find dst-address=197.157.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.157.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
...
:if ([:len [/ip/route/find dst-address=41.221.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.221.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
:if ([:len [/ip/route/find dst-address=41.221.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.221.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
:if ([:len [/ip/route/find dst-address=41.221.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.221.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
:if ([:len [/ip/route/find dst-address=41.221.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.221.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
:if ([:len [/ip/route/find dst-address=41.221.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.221.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
:if ([:len [/ip/route/find dst-address=41.221.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.221.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
