...
:if ([:len [/ip/route/find dst-address=102.85.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.85.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
...
:if ([:len [/ip/route/find dst-address=154.229.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.229.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
:if ([:len [/ip/route/find dst-address=154.230.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.230.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37075 }
