...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37088 and dst-address=for_scripts_route/asnv4/AS37088.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37088.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37088 }
