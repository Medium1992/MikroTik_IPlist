...
:if ([:len [/ip/route/find dst-address=41.213.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.213.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37105 }
:if ([:len [/ip/route/find dst-address=41.213.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.213.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37105 }
:if ([:len [/ip/route/find dst-address=41.213.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.213.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37105 }
