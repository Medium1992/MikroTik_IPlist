...
:if ([:len [/ip/route/find dst-address=41.71.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.71.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37127 }
:if ([:len [/ip/route/find dst-address=41.71.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.71.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37127 }
