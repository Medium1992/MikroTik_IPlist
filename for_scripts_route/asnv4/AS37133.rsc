...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.212.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.212.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37133 }
...
:if ([:len [/ip/route/find dst-address=196.46.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.46.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37133 }
...
:if ([:len [/ip/route/find dst-address=197.186.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.186.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37133 }
