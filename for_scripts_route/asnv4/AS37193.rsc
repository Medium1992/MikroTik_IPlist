...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37193 and dst-address=for_scripts_route/asnv4/AS37193.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37193.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37193 }
