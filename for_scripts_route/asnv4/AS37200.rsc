...
:if ([:len [/ip/route/find dst-address=197.255.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.255.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37200 }
:if ([:len [/ip/route/find dst-address=41.78.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.78.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37200 }
