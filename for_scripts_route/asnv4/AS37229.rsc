...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37229 and dst-address=for_scripts_route/asnv4/AS37229.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37229.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37229 }
