...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37235 and dst-address=for_scripts_route/asnv4/AS37235.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37235.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37235 }
