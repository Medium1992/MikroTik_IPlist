...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37249 and dst-address=for_scripts_route/asnv4/AS37249.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37249.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37249 }
