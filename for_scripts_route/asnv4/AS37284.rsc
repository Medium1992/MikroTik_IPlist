...
:if ([:len [/ip/route/find dst-address=102.223.159.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.223.159.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37284 }
:if ([:len [/ip/route/find dst-address=102.69.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.69.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37284 }
:if ([:len [/ip/route/find dst-address=102.69.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.69.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37284 }
:if ([:len [/ip/route/find dst-address=102.69.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.69.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37284 }
...
:if ([:len [/ip/route/find dst-address=165.16.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.16.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37284 }
:if ([:len [/ip/route/find dst-address=165.16.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.16.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37284 }
:if ([:len [/ip/route/find dst-address=165.16.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.16.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37284 }
