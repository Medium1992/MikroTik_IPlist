...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS372885 and dst-address=for_scripts_route/asnv4/AS372885.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS372885.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS372885 }
