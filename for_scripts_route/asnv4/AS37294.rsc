...
:if ([:len [/ip/route/find dst-address=168.253.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37294 }
:if ([:len [/ip/route/find dst-address=168.253.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37294 }
