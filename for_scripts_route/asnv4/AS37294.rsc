...
:if ([:len [/ip/route/find dst-address=168.253.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37294 }
:if ([:len [/ip/route/find dst-address=168.253.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37294 }
:if ([:len [/ip/route/find dst-address=168.253.246.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.246.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37294 }
:if ([:len [/ip/route/find dst-address=41.222.186.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.222.186.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37294 }
