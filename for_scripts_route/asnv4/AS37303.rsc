...
:if ([:len [/ip/route/find dst-address=41.77.18.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.77.18.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37303 }
:if ([:len [/ip/route/find dst-address=41.77.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.77.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37303 }
