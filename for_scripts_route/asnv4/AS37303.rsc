...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37303 and dst-address=for_scripts_route/asnv4/AS37303.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37303.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37303 }
