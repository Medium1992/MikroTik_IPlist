...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37317 and dst-address=for_scripts_route/asnv4/AS37317.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37317.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37317 }
