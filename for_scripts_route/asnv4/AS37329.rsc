...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37329 and dst-address=for_scripts_route/asnv4/AS37329.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37329.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37329 }
