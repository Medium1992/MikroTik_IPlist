...
:if ([:len [/ip/route/find dst-address=154.118.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.118.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
:if ([:len [/ip/route/find dst-address=154.118.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.118.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
:if ([:len [/ip/route/find dst-address=154.118.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.118.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
:if ([:len [/ip/route/find dst-address=154.118.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.118.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
