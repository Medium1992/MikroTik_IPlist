...
:if ([:len [/ip/route/find dst-address=154.120.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.120.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
:if ([:len [/ip/route/find dst-address=154.120.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.120.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
:if ([:len [/ip/route/find dst-address=154.120.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.120.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
:if ([:len [/ip/route/find dst-address=154.120.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.120.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
:if ([:len [/ip/route/find dst-address=154.120.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.120.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37340 }
