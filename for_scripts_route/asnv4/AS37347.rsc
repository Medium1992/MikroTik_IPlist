...
:if ([:len [/ip/route/find dst-address=102.22.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.22.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37347 }
:if ([:len [/ip/route/find dst-address=102.221.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.221.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37347 }
