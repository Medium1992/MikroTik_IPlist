...
:if ([:len [/ip/route/find dst-address=102.216.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.216.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37347 }
:if ([:len [/ip/route/find dst-address=102.216.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.216.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37347 }
...
:if ([:len [/ip/route/find dst-address=168.253.112.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.112.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37347 }
:if ([:len [/ip/route/find dst-address=168.253.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37347 }
:if ([:len [/ip/route/find dst-address=168.253.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.253.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37347 }
