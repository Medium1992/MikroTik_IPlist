...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37350 and dst-address=for_scripts_route/asnv4/AS37350.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37350.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37350 }
