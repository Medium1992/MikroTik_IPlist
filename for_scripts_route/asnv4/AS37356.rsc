...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.134.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.134.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37356 }
...
:if ([:len [/ip/route/find dst-address=102.214.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.214.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37356 }
