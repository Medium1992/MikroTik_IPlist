...
:if ([:len [/ip/route/find dst-address=41.57.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.57.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37410 }
