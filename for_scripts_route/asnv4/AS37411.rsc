...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37411 and dst-address=for_scripts_route/asnv4/AS37411.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37411.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37411 }
