...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37420 and dst-address=for_scripts_route/asnv4/AS37420.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37420.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37420 }
