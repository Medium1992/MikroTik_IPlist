...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=105.234.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.234.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
:if ([:len [/ip/route/find dst-address=105.234.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.234.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
:if ([:len [/ip/route/find dst-address=105.234.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.234.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
:if ([:len [/ip/route/find dst-address=105.234.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.234.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
:if ([:len [/ip/route/find dst-address=105.234.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.234.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
:if ([:len [/ip/route/find dst-address=105.234.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.234.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
:if ([:len [/ip/route/find dst-address=105.234.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=105.234.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
...
:if ([:len [/ip/route/find dst-address=41.78.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.78.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37440 }
