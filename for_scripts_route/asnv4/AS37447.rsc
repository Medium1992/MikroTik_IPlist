...
:if ([:len [/ip/route/find dst-address=102.212.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.212.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37447 }
:if ([:len [/ip/route/find dst-address=102.223.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.223.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37447 }
...
:if ([:len [/ip/route/find dst-address=206.42.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.42.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37447 }
:if ([:len [/ip/route/find dst-address=206.42.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.42.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37447 }
