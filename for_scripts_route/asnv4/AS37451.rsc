...
:if ([:len [/ip/route/find dst-address=102.129.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.129.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37451 }
...
:if ([:len [/ip/route/find dst-address=102.129.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.129.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37451 }
...
:if ([:len [/ip/route/find dst-address=154.53.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.53.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37451 }
:if ([:len [/ip/route/find dst-address=154.53.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.53.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37451 }
