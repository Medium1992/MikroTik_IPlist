...
:if ([:len [/ip/route/find dst-address=197.12.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.12.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37504 }
:if ([:len [/ip/route/find dst-address=197.12.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.12.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37504 }
:if ([:len [/ip/route/find dst-address=197.12.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.12.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37504 }
