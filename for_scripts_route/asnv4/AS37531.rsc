...
:if ([:len [/ip/route/find dst-address=197.214.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.214.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37531 }
:if ([:len [/ip/route/find dst-address=197.214.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.214.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37531 }
...
:if ([:len [/ip/route/find dst-address=197.214.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.214.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37531 }
