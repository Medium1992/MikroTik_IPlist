...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37540 and dst-address=for_scripts_route/asnv4/AS37540.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37540.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37540 }
