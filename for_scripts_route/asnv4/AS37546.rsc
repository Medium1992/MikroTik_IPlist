...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37546 and dst-address=for_scripts_route/asnv4/AS37546.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37546.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37546 }
