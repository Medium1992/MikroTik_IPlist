...
:if ([:len [/ip/route/find dst-address=196.203.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.203.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37551 }
:if ([:len [/ip/route/find dst-address=196.203.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.203.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37551 }
