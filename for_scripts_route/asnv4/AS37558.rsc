...
:if ([:len [/ip/route/find dst-address=197.215.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.215.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37558 }
:if ([:len [/ip/route/find dst-address=197.215.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.215.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37558 }
...
:if ([:len [/ip/route/find dst-address=197.215.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.215.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37558 }
