...
:if ([:len [/ip/route/find dst-address=197.231.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.231.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37564 }
:if ([:len [/ip/route/find dst-address=197.231.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.231.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37564 }
