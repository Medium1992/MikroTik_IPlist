...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.0.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.0.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37616 }
:if ([:len [/ip/route/find dst-address=154.0.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.0.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37616 }
