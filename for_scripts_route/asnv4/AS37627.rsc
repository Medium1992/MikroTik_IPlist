...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37627 and dst-address=for_scripts_route/asnv4/AS37627.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37627.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37627 }
