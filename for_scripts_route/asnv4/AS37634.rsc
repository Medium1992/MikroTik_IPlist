...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37634 and dst-address=for_scripts_route/asnv4/AS37634.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37634.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37634 }
