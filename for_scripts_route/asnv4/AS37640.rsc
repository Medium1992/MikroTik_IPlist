...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS37640 and dst-address=for_scripts_route/asnv4/AS37640.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS37640.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37640 }
