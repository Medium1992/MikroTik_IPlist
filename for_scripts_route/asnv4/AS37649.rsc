...
:if ([:len [/ip/route/find dst-address=196.50.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.50.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37649 }
:if ([:len [/ip/route/find dst-address=196.50.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.50.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37649 }
:if ([:len [/ip/route/find dst-address=196.50.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.50.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37649 }
