...
:if ([:len [/ip/route/find dst-address=102.209.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.209.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37662 }
...
:if ([:len [/ip/route/find dst-address=196.250.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.250.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37662 }
