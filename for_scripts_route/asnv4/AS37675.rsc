...
:if ([:len [/ip/route/find dst-address=165.90.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.90.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37675 }
:if ([:len [/ip/route/find dst-address=165.90.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.90.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37675 }
:if ([:len [/ip/route/find dst-address=165.90.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.90.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37675 }
:if ([:len [/ip/route/find dst-address=165.90.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.90.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37675 }
