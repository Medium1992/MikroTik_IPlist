...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS3769 and dst-address=for_scripts_route/asnv4/AS3769.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS3769.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3769 }
