...
:if ([:len [/ip/route/find dst-address=197.3.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.3.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37705 }
...
:if ([:len [/ip/route/find dst-address=41.230.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.230.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS37705 }
