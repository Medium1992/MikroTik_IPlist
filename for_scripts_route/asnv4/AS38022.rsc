...
:if ([:len [/ip/route/find dst-address=163.7.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.7.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38022 }
...
:if ([:len [/ip/route/find dst-address=202.36.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.36.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38022 }
:if ([:len [/ip/route/find dst-address=202.50.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.50.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38022 }
:if ([:len [/ip/route/find dst-address=202.50.205.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.50.205.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38022 }
