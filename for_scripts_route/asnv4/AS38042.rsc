...
:if ([:len [/ip/route/find dst-address=163.128.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.128.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38042 }
:if ([:len [/ip/route/find dst-address=187.79.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.79.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38042 }
