...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38071 and dst-address=for_scripts_route/asnv4/AS38071.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38071.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38071 }
