...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38146 and dst-address=for_scripts_route/asnv4/AS38146.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38146.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38146 }
