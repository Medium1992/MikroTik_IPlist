...
:if ([:len [/ip/route/find dst-address=114.30.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.30.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38165 }
:if ([:len [/ip/route/find dst-address=114.30.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.30.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38165 }
