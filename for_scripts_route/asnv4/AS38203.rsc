...
:if ([:len [/ip/route/find dst-address=202.51.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.64/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.64/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.80/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.80/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.88/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.88/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.92/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.92/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.95/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.95/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.178.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.178.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
:if ([:len [/ip/route/find dst-address=202.51.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.51.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38203 }
