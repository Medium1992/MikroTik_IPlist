...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38228 and dst-address=for_scripts_route/asnv4/AS38228.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38228.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38228 }
