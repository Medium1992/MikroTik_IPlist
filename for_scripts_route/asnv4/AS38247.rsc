...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.129.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.129.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38247 }
...
:if ([:len [/ip/route/find dst-address=203.160.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.160.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38247 }
...
:if ([:len [/ip/route/find dst-address=59.153.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.153.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38247 }
