...
:if ([:len [/ip/route/find dst-address=123.108.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=123.108.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38325 }
:if ([:len [/ip/route/find dst-address=182.239.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=182.239.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38325 }
:if ([:len [/ip/route/find dst-address=182.239.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=182.239.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38325 }
