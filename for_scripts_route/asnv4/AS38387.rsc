...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38387 and dst-address=for_scripts_route/asnv4/AS38387.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38387.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38387 }
