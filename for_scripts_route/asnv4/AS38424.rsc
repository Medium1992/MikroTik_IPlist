...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38424 and dst-address=for_scripts_route/asnv4/AS38424.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38424.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38424 }
