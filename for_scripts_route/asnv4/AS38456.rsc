...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38456 and dst-address=for_scripts_route/asnv4/AS38456.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38456.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38456 }
