...
:if ([:len [/ip/route/find dst-address=103.137.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.137.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38571 }
:if ([:len [/ip/route/find dst-address=103.137.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.137.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38571 }
