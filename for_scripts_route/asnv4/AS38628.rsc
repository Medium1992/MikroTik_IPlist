...
:if ([:len [/ip/route/find dst-address=126.209.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=126.209.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38628 }
...
:if ([:len [/ip/route/find dst-address=219.97.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=219.97.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38628 }
:if ([:len [/ip/route/find dst-address=219.97.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=219.97.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38628 }
