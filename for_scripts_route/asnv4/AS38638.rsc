...
:if ([:len [/ip/route/find dst-address=154.83.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.83.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38638 }
...
:if ([:len [/ip/route/find dst-address=27.123.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.123.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38638 }
:if ([:len [/ip/route/find dst-address=27.123.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.123.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38638 }
:if ([:len [/ip/route/find dst-address=27.123.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.123.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38638 }
