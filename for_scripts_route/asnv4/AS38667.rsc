...
:if ([:len [/ip/route/find dst-address=61.252.186.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.252.186.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38667 }
:if ([:len [/ip/route/find dst-address=61.252.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.252.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38667 }
