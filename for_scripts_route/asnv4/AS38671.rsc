...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38671 and dst-address=for_scripts_route/asnv4/AS38671.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38671.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38671 }
