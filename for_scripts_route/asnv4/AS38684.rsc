...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38684 and dst-address=for_scripts_route/asnv4/AS38684.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38684.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38684 }
