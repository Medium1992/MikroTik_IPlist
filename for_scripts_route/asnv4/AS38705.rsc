...
:if ([:len [/ip/route/find dst-address=218.148.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.148.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38705 }
:if ([:len [/ip/route/find dst-address=220.78.113.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=220.78.113.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38705 }
...
:if ([:len [/ip/route/find dst-address=49.128.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.128.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38705 }
...
:if ([:len [/ip/route/find dst-address=59.12.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.12.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38705 }
