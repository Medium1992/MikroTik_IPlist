...
:if ([:len [/ip/route/find dst-address=116.97.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.97.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38731 }
:if ([:len [/ip/route/find dst-address=116.97.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.97.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38731 }
:if ([:len [/ip/route/find dst-address=117.1.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.1.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38731 }
:if ([:len [/ip/route/find dst-address=117.1.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.1.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38731 }
...
:if ([:len [/ip/route/find dst-address=171.226.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=171.226.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38731 }
