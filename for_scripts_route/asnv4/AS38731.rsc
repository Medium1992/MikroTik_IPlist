...
:if ([:len [/ip/route/find dst-address=27.71.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.71.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38731 }
:if ([:len [/ip/route/find dst-address=27.71.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.71.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38731 }
