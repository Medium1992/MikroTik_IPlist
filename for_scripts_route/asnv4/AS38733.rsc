...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.117.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.117.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38733 }
:if ([:len [/ip/route/find dst-address=103.188.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.188.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38733 }
...
:if ([:len [/ip/route/find dst-address=138.252.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.252.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38733 }
