...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38814 and dst-address=for_scripts_route/asnv4/AS38814.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38814.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38814 }
