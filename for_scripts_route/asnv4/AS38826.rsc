...
:if ([:len [/ip/route/find dst-address=119.15.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.15.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38826 }
...
:if ([:len [/ip/route/find dst-address=119.15.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.15.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38826 }
:if ([:len [/ip/route/find dst-address=119.15.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.15.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38826 }
