...
:if ([:len [/ip/route/find dst-address=203.14.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.14.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38858 }
:if ([:len [/ip/route/find dst-address=203.20.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.20.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38858 }
