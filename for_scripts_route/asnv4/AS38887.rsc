...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38887 and dst-address=for_scripts_route/asnv4/AS38887.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38887.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38887 }
