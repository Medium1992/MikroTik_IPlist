...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.121.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.121.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38927 }
...
:if ([:len [/ip/route/find dst-address=212.232.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.232.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38927 }
