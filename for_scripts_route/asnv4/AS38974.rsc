...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS38974 and dst-address=for_scripts_route/asnv4/AS38974.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS38974.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38974 }
