...
:if ([:len [/ip/route/find dst-address=188.126.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.126.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS38983 }
