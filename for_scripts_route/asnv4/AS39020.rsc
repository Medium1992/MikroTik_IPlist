...
:if ([:len [/ip/route/find dst-address=188.190.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.190.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39020 }
...
:if ([:len [/ip/route/find dst-address=217.61.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.61.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39020 }
