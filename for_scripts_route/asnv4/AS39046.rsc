...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39046 and dst-address=for_scripts_route/asnv4/AS39046.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39046.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39046 }
