...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39052 and dst-address=for_scripts_route/asnv4/AS39052.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39052.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39052 }
