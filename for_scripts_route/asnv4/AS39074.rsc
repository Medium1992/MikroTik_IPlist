...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=85.133.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39074 }
:if ([:len [/ip/route/find dst-address=85.133.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39074 }
:if ([:len [/ip/route/find dst-address=85.133.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39074 }
...
:if ([:len [/ip/route/find dst-address=85.133.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39074 }
:if ([:len [/ip/route/find dst-address=85.133.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39074 }
...
:if ([:len [/ip/route/find dst-address=85.133.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39074 }
...
:if ([:len [/ip/route/find dst-address=85.133.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39074 }
