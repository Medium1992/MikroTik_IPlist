...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS3909 and dst-address=for_scripts_route/asnv4/AS3909.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS3909.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3909 }
