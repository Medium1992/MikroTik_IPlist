...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39105 and dst-address=for_scripts_route/asnv4/AS39105.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39105.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39105 }
