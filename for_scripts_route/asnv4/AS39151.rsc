...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=159.253.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.253.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39151 }
:if ([:len [/ip/route/find dst-address=159.253.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.253.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39151 }
:if ([:len [/ip/route/find dst-address=159.253.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.253.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39151 }
:if ([:len [/ip/route/find dst-address=159.253.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.253.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39151 }
...
:if ([:len [/ip/route/find dst-address=185.70.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.70.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39151 }
...
:if ([:len [/ip/route/find dst-address=213.175.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.175.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39151 }
