...
:if ([:len [/ip/route/find dst-address=134.146.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.146.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3917 }
...
:if ([:len [/ip/route/find dst-address=134.146.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.146.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3917 }
...
:if ([:len [/ip/route/find dst-address=134.146.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.146.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3917 }
...
:if ([:len [/ip/route/find dst-address=134.146.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.146.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS3917 }
