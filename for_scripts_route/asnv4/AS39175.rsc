...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39175 and dst-address=for_scripts_route/asnv4/AS39175.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39175.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39175 }
