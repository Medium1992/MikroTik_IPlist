...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39242 and dst-address=for_scripts_route/asnv4/AS39242.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39242.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39242 }
