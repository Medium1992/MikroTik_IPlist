...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39263 and dst-address=for_scripts_route/asnv4/AS39263.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39263.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39263 }
