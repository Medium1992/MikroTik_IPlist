...
:if ([:len [/ip/route/find dst-address=164.139.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.139.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39290 }
:if ([:len [/ip/route/find dst-address=164.139.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.139.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39290 }
:if ([:len [/ip/route/find dst-address=164.139.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.139.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39290 }
