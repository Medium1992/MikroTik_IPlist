...
:if ([:len [/ip/route/find dst-address=199.16.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.160/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.160/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.176/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.176/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.184/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.184/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.186/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.186/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.188/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.188/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.222.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.222.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=199.16.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.16.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
