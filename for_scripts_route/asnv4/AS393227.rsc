...
:if ([:len [/ip/route/find dst-address=104.218.214.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.214.128/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.128/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.214.144/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.144/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.214.147/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.147/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.214.148/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.148/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.214.152/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.152/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.214.160/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.160/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.214.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.214.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
:if ([:len [/ip/route/find dst-address=104.218.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.218.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393227 }
