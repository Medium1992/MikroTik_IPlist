...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS393298 and dst-address=for_scripts_route/asnv4/AS393298.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS393298.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393298 }
