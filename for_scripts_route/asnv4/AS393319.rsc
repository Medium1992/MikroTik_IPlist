...
:if ([:len [/ip/route/find dst-address=77.233.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.233.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393319 }
...
:if ([:len [/ip/route/find dst-address=77.233.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.233.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393319 }
:if ([:len [/ip/route/find dst-address=77.233.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.233.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393319 }
