...
:if ([:len [/ip/route/find dst-address=5.253.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.253.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393406 }
...
:if ([:len [/ip/route/find dst-address=78.105.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.105.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393406 }
