...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=118.184.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=118.184.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393437 }
...
:if ([:len [/ip/route/find dst-address=154.91.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.91.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393437 }
:if ([:len [/ip/route/find dst-address=154.91.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.91.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393437 }
...
:if ([:len [/ip/route/find dst-address=38.64.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.64.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393437 }
