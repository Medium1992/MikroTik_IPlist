...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS393485 and dst-address=for_scripts_route/asnv4/AS393485.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS393485.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393485 }
