...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS393507 and dst-address=for_scripts_route/asnv4/AS393507.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS393507.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393507 }
