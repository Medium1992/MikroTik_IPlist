...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.104.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.104.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393508 }
...
:if ([:len [/ip/route/find dst-address=99.22.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.22.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393508 }
