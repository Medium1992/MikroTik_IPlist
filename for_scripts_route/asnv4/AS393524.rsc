...
:if ([:len [/ip/route/find dst-address=38.133.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.133.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393524 }
:if ([:len [/ip/route/find dst-address=38.81.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.81.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393524 }
