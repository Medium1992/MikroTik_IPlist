...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS393564 and dst-address=for_scripts_route/asnv4/AS393564.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS393564.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393564 }
