...
:if ([:len [/ip/route/find dst-address=199.116.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.116.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393775 }
:if ([:len [/ip/route/find dst-address=199.116.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.116.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393775 }
