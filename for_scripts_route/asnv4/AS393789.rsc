...
:if ([:len [/ip/route/find dst-address=67.7.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
:if ([:len [/ip/route/find dst-address=67.7.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.7.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393789 }
