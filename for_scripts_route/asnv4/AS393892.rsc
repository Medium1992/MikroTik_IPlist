...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS393892 and dst-address=for_scripts_route/asnv4/AS393892.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS393892.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393892 }
