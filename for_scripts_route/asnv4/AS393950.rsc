...
:if ([:len [/ip/route/find dst-address=172.98.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.98.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393950 }
:if ([:len [/ip/route/find dst-address=172.98.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.98.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393950 }
:if ([:len [/ip/route/find dst-address=172.98.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.98.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393950 }
:if ([:len [/ip/route/find dst-address=172.98.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.98.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393950 }
