...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.149.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.149.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393954 }
...
:if ([:len [/ip/route/find dst-address=198.182.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.182.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393954 }
