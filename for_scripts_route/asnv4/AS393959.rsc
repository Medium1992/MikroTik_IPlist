...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS393959 and dst-address=for_scripts_route/asnv4/AS393959.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS393959.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS393959 }
