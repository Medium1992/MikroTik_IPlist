...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394034 and dst-address=for_scripts_route/asnv4/AS394034.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394034.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394034 }
