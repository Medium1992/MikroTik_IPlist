...
:if ([:len [/ip/route/find dst-address=205.209.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.209.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394073 }
:if ([:len [/ip/route/find dst-address=205.209.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.209.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394073 }
:if ([:len [/ip/route/find dst-address=205.209.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.209.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394073 }
