...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394085 and dst-address=for_scripts_route/asnv4/AS394085.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394085.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394085 }
