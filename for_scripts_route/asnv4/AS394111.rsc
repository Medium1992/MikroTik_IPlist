...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394111 and dst-address=for_scripts_route/asnv4/AS394111.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394111.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394111 }
