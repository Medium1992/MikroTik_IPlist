...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394122 and dst-address=for_scripts_route/asnv4/AS394122.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394122.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394122 }
