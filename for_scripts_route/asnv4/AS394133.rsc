...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394133 and dst-address=for_scripts_route/asnv4/AS394133.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394133.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394133 }
