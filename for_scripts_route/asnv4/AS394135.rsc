...
:if ([:len [/ip/route/find dst-address=161.36.113.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.36.113.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394135 }
:if ([:len [/ip/route/find dst-address=161.36.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.36.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394135 }
...
:if ([:len [/ip/route/find dst-address=161.36.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.36.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394135 }
