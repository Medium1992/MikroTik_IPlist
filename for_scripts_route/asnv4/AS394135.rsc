...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=161.36.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.36.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394135 }
:if ([:len [/ip/route/find dst-address=161.36.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.36.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394135 }
