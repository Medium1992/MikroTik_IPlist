...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394142 and dst-address=for_scripts_route/asnv4/AS394142.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394142.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394142 }
