...
:if ([:len [/ip/route/find dst-address=72.13.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.129/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.129/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.130/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.130/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.132/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.132/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.136/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.136/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.144/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.144/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.160/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.160/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.28.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.28.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
