...
:if ([:len [/ip/route/find dst-address=72.13.25.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.25.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
...
:if ([:len [/ip/route/find dst-address=72.13.25.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.25.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.25.48/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.25.48/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.25.51/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.25.51/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.25.52/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.25.52/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
:if ([:len [/ip/route/find dst-address=72.13.25.56/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.13.25.56/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394147 }
