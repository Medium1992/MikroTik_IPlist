...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394169 and dst-address=for_scripts_route/asnv4/AS394169.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394169.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394169 }
