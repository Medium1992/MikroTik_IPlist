...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394205 and dst-address=for_scripts_route/asnv4/AS394205.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394205.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394205 }
