...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394229 and dst-address=for_scripts_route/asnv4/AS394229.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394229.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394229 }
