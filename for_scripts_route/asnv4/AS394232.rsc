...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394232 and dst-address=for_scripts_route/asnv4/AS394232.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394232.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394232 }
