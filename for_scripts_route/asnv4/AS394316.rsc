...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394316 and dst-address=for_scripts_route/asnv4/AS394316.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394316.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394316 }
