...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394352 and dst-address=for_scripts_route/asnv4/AS394352.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394352.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394352 }
