...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.212.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.212.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39442 }
...
:if ([:len [/ip/route/find dst-address=213.234.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.234.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39442 }
...
:if ([:len [/ip/route/find dst-address=62.122.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.122.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39442 }
