...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394432 and dst-address=for_scripts_route/asnv4/AS394432.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394432.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394432 }
