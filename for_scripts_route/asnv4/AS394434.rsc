...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394434 and dst-address=for_scripts_route/asnv4/AS394434.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394434.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394434 }
