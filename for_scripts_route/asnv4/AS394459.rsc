...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394459 and dst-address=for_scripts_route/asnv4/AS394459.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394459.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394459 }
