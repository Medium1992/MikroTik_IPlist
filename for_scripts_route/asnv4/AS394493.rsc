...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394493 and dst-address=for_scripts_route/asnv4/AS394493.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394493.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394493 }
