...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394563 and dst-address=for_scripts_route/asnv4/AS394563.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394563.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394563 }
