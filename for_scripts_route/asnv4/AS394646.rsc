...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=136.242.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.242.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394646 }
:if ([:len [/ip/route/find dst-address=136.242.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.242.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394646 }
...
:if ([:len [/ip/route/find dst-address=199.45.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.45.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394646 }
