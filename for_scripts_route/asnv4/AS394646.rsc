...
:if ([:len [/ip/route/find dst-address=199.45.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.45.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394646 }
:if ([:len [/ip/route/find dst-address=199.45.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.45.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394646 }
