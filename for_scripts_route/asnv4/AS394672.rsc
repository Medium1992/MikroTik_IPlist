...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394672 and dst-address=for_scripts_route/asnv4/AS394672.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394672.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394672 }
