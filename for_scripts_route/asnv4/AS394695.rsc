...
:if ([:len [/ip/route/find dst-address=66.116.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.116.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394695 }
:if ([:len [/ip/route/find dst-address=66.116.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.116.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394695 }
:if ([:len [/ip/route/find dst-address=66.116.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.116.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394695 }
:if ([:len [/ip/route/find dst-address=66.116.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.116.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394695 }
:if ([:len [/ip/route/find dst-address=66.116.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.116.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394695 }
:if ([:len [/ip/route/find dst-address=66.116.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.116.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394695 }
