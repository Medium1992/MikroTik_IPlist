...
:if ([:len [/ip/route/find dst-address=165.161.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.161.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394700 }
...
:if ([:len [/ip/route/find dst-address=165.161.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.161.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394700 }
:if ([:len [/ip/route/find dst-address=165.161.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.161.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394700 }
:if ([:len [/ip/route/find dst-address=165.161.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.161.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394700 }
