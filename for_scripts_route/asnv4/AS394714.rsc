...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394714 and dst-address=for_scripts_route/asnv4/AS394714.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394714.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394714 }
