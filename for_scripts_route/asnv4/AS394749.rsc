...
:if ([:len [/ip/route/find dst-address=64.191.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394749 }
...
:if ([:len [/ip/route/find dst-address=64.191.202.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.202.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394749 }
