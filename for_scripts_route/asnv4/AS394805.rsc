...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394805 and dst-address=for_scripts_route/asnv4/AS394805.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394805.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394805 }
