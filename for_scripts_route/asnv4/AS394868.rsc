...
:if ([:len [/ip/route/find dst-address=115.84.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.84.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394868 }
:if ([:len [/ip/route/find dst-address=115.84.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.84.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394868 }
...
:if ([:len [/ip/route/find dst-address=115.84.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.84.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394868 }
:if ([:len [/ip/route/find dst-address=115.84.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.84.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394868 }
:if ([:len [/ip/route/find dst-address=115.84.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.84.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394868 }
