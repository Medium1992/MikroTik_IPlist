...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394898 and dst-address=for_scripts_route/asnv4/AS394898.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394898.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394898 }
