...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394927 and dst-address=for_scripts_route/asnv4/AS394927.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394927.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394927 }
