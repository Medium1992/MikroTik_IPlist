...
:if ([:len [/ip/route/find dst-address=5.42.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.42.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39493 }
:if ([:len [/ip/route/find dst-address=5.42.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.42.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39493 }
:if ([:len [/ip/route/find dst-address=5.42.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.42.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39493 }
