...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=31.177.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.177.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=31.177.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.177.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=31.177.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.177.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
...
:if ([:len [/ip/route/find dst-address=31.177.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.177.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=31.177.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.177.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=77.222.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.222.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=77.222.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.222.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=79.174.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.174.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
...
:if ([:len [/ip/route/find dst-address=79.174.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.174.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=80.93.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.93.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
:if ([:len [/ip/route/find dst-address=89.104.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.104.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39494 }
