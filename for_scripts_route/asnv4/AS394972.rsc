...
:if ([:len [/ip/route/find dst-address=216.73.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.104/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.104/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.108/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.108/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.111/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.111/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.112/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.112/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.101.96/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.101.96/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
:if ([:len [/ip/route/find dst-address=216.73.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.73.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394972 }
