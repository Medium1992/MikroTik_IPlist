...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39498 and dst-address=for_scripts_route/asnv4/AS39498.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39498.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39498 }
