...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394981 and dst-address=for_scripts_route/asnv4/AS394981.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394981.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394981 }
