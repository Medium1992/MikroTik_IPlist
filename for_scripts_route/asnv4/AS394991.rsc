...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS394991 and dst-address=for_scripts_route/asnv4/AS394991.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS394991.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS394991 }
