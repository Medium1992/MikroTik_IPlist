...
:if ([:len [/ip/route/find dst-address=38.131.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.131.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395111 }
:if ([:len [/ip/route/find dst-address=38.131.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.131.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395111 }
:if ([:len [/ip/route/find dst-address=38.131.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.131.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395111 }
:if ([:len [/ip/route/find dst-address=38.145.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.145.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395111 }
:if ([:len [/ip/route/find dst-address=38.145.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.145.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395111 }
:if ([:len [/ip/route/find dst-address=38.145.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.145.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395111 }
...
:if ([:len [/ip/route/find dst-address=38.87.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.87.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395111 }
