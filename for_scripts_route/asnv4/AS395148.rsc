...
:if ([:len [/ip/route/find dst-address=23.149.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.149.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395148 }
:if ([:len [/ip/route/find dst-address=38.109.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.109.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395148 }
