...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395172 and dst-address=for_scripts_route/asnv4/AS395172.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395172.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395172 }
