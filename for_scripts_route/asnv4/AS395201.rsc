...
:if ([:len [/ip/route/find dst-address=38.247.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.247.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395201 }
:if ([:len [/ip/route/find dst-address=38.77.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.77.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395201 }
...
:if ([:len [/ip/route/find dst-address=45.74.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.74.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395201 }
:if ([:len [/ip/route/find dst-address=45.74.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.74.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395201 }
