...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395201 and dst-address=for_scripts_route/asnv4/AS395201.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395201.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395201 }
