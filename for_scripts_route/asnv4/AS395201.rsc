...
:if ([:len [/ip/route/find dst-address=154.222.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.222.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395201 }
...
:if ([:len [/ip/route/find dst-address=212.135.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.135.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395201 }
