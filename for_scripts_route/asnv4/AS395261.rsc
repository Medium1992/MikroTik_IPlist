...
:if ([:len [/ip/route/find dst-address=163.182.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.182.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395261 }
:if ([:len [/ip/route/find dst-address=163.182.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.182.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395261 }
...
:if ([:len [/ip/route/find dst-address=163.182.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.182.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395261 }
