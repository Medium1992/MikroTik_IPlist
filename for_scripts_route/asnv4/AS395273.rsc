...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395273 and dst-address=for_scripts_route/asnv4/AS395273.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395273.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395273 }
