...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=38.42.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.42.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395354 }
:if ([:len [/ip/route/find dst-address=38.42.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.42.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395354 }
