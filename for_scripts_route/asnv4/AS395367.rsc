...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395367 and dst-address=for_scripts_route/asnv4/AS395367.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395367.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395367 }
