...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395403 and dst-address=for_scripts_route/asnv4/AS395403.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395403.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395403 }
