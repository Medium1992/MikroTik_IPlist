...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39543 and dst-address=for_scripts_route/asnv4/AS39543.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39543.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39543 }
