...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395466 and dst-address=for_scripts_route/asnv4/AS395466.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395466.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395466 }
