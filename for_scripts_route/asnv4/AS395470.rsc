...
:if ([:len [/ip/route/find dst-address=45.87.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.87.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395470 }
:if ([:len [/ip/route/find dst-address=46.202.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.202.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395470 }
:if ([:len [/ip/route/find dst-address=5.182.35.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.182.35.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395470 }
:if ([:len [/ip/route/find dst-address=80.174.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.174.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395470 }
...
:if ([:len [/ip/route/find dst-address=89.213.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395470 }
