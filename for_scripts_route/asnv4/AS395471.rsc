...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395471 and dst-address=for_scripts_route/asnv4/AS395471.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395471.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395471 }
