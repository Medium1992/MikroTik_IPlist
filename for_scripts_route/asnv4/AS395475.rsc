...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395475 and dst-address=for_scripts_route/asnv4/AS395475.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395475.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395475 }
