...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.151.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.151.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395535 }
...
:if ([:len [/ip/route/find dst-address=38.146.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.146.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395535 }
...
:if ([:len [/ip/route/find dst-address=38.66.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.66.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395535 }
:if ([:len [/ip/route/find dst-address=38.66.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.66.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395535 }
