...
:if ([:len [/ip/route/find dst-address=162.216.68.16/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.216.68.16/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395559 }
