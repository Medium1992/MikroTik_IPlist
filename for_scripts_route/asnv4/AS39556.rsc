...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39556 and dst-address=for_scripts_route/asnv4/AS39556.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39556.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39556 }
