...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395563 and dst-address=for_scripts_route/asnv4/AS395563.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395563.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395563 }
