...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395572 and dst-address=for_scripts_route/asnv4/AS395572.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395572.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395572 }
