...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=107.150.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.150.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
...
:if ([:len [/ip/route/find dst-address=64.25.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.192/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.192/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.200/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.200/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.204/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.204/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.207/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.207/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.208/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.208/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.5.224/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.5.224/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
:if ([:len [/ip/route/find dst-address=64.25.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.25.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395748 }
