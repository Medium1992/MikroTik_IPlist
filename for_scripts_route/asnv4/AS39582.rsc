...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.17.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.17.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39582 }
:if ([:len [/ip/route/find dst-address=185.231.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.231.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39582 }
