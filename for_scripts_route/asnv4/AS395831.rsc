...
:if ([:len [/ip/route/find dst-address=158.115.134.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.115.134.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395831 }
...
:if ([:len [/ip/route/find dst-address=209.206.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.206.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395831 }
...
:if ([:len [/ip/route/find dst-address=216.157.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.157.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395831 }
