...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395831 and dst-address=for_scripts_route/asnv4/AS395831.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395831.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395831 }
