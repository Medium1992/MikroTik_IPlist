...
:if ([:len [/ip/route/find dst-address=198.144.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.144.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395848 }
:if ([:len [/ip/route/find dst-address=206.55.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.55.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395848 }
:if ([:len [/ip/route/find dst-address=206.55.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.55.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395848 }
...
:if ([:len [/ip/route/find dst-address=206.55.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.55.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395848 }
