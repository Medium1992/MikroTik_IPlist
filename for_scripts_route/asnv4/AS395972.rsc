...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS395972 and dst-address=for_scripts_route/asnv4/AS395972.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS395972.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS395972 }
