...
:if ([:len [/ip/route/find dst-address=50.86.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.86.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396010 }
...
:if ([:len [/ip/route/find dst-address=66.175.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.175.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396010 }
...
:if ([:len [/ip/route/find dst-address=66.175.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.175.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396010 }
...
:if ([:len [/ip/route/find dst-address=66.175.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.175.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396010 }
