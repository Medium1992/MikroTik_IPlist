...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396085 and dst-address=for_scripts_route/asnv4/AS396085.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396085.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396085 }
