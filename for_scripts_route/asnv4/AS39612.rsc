...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39612 and dst-address=for_scripts_route/asnv4/AS39612.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39612.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39612 }
