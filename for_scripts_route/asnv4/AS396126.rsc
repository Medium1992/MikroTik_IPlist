...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396126 and dst-address=for_scripts_route/asnv4/AS396126.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396126.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396126 }
