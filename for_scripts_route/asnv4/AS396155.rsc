...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396155 and dst-address=for_scripts_route/asnv4/AS396155.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396155.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396155 }
