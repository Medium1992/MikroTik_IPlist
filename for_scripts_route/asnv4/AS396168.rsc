...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=204.0.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.0.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396168 }
...
:if ([:len [/ip/route/find dst-address=38.124.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.124.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396168 }
...
:if ([:len [/ip/route/find dst-address=38.45.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.45.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396168 }
