...
:if ([:len [/ip/route/find dst-address=38.83.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.83.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396181 }
:if ([:len [/ip/route/find dst-address=69.5.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.5.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396181 }
