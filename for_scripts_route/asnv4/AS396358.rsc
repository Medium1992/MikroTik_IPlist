...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396358 and dst-address=for_scripts_route/asnv4/AS396358.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396358.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396358 }
