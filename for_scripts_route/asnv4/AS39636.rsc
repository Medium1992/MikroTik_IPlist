...
:if ([:len [/ip/route/find dst-address=89.184.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.184.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39636 }
:if ([:len [/ip/route/find dst-address=89.184.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.184.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39636 }
:if ([:len [/ip/route/find dst-address=89.184.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.184.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39636 }
:if ([:len [/ip/route/find dst-address=89.184.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.184.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39636 }
