...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39636 and dst-address=for_scripts_route/asnv4/AS39636.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39636.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39636 }
