...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39640 and dst-address=for_scripts_route/asnv4/AS39640.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39640.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39640 }
