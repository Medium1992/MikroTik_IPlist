...
:if ([:len [/ip/route/find dst-address=109.162.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.162.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39650 }
...
:if ([:len [/ip/route/find dst-address=185.161.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.161.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39650 }
