...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396509 and dst-address=for_scripts_route/asnv4/AS396509.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396509.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396509 }
