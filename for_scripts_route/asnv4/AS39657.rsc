...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39657 and dst-address=for_scripts_route/asnv4/AS39657.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39657.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39657 }
