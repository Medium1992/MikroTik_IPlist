...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39658 and dst-address=for_scripts_route/asnv4/AS39658.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39658.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39658 }
