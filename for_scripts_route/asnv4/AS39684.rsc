...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39684 and dst-address=for_scripts_route/asnv4/AS39684.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39684.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39684 }
