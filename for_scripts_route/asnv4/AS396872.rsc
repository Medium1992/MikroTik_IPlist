...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=130.12.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.12.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396872 }
...
:if ([:len [/ip/route/find dst-address=216.7.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.7.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396872 }
:if ([:len [/ip/route/find dst-address=216.7.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.7.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396872 }
:if ([:len [/ip/route/find dst-address=216.7.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.7.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396872 }
...
:if ([:len [/ip/route/find dst-address=216.7.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.7.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396872 }
...
:if ([:len [/ip/route/find dst-address=216.7.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.7.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396872 }
