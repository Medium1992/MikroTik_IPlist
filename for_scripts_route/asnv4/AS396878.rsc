...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396878 and dst-address=for_scripts_route/asnv4/AS396878.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396878.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396878 }
