...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396922 and dst-address=for_scripts_route/asnv4/AS396922.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396922.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396922 }
