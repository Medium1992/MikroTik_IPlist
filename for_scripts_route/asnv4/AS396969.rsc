...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS396969 and dst-address=for_scripts_route/asnv4/AS396969.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS396969.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS396969 }
