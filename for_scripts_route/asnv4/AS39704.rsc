...
:if ([:len [/ip/route/find dst-address=193.222.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.222.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39704 }
...
:if ([:len [/ip/route/find dst-address=213.132.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.132.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39704 }
