...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397041 and dst-address=for_scripts_route/asnv4/AS397041.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397041.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397041 }
