...
:if ([:len [/ip/route/find dst-address=38.148.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.148.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397162 }
:if ([:len [/ip/route/find dst-address=38.148.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.148.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397162 }
:if ([:len [/ip/route/find dst-address=38.148.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.148.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397162 }
:if ([:len [/ip/route/find dst-address=38.148.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.148.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397162 }
