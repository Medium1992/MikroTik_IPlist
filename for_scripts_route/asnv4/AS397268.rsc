...
:if ([:len [/ip/route/find dst-address=208.98.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.98.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397268 }
...
:if ([:len [/ip/route/find dst-address=45.33.218.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.33.218.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397268 }
