...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397298 and dst-address=for_scripts_route/asnv4/AS397298.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397298.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397298 }
