...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=198.52.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.52.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397347 }
...
:if ([:len [/ip/route/find dst-address=74.116.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.116.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397347 }
