...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39735 and dst-address=for_scripts_route/asnv4/AS39735.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39735.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39735 }
