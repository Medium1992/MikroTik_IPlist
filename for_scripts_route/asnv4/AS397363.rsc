...
:if ([:len [/ip/route/find dst-address=16.0.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=16.0.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397363 }
...
:if ([:len [/ip/route/find dst-address=16.7.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=16.7.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397363 }
