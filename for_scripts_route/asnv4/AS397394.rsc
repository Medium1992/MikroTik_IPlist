...
:if ([:len [/ip/route/find dst-address=204.194.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.100/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.100/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.102/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.102/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.104/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.104/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.112/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.112/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
:if ([:len [/ip/route/find dst-address=204.194.191.96/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.194.191.96/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397394 }
