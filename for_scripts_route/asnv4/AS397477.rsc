...
:if ([:len [/ip/route/find dst-address=172.110.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.110.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397477 }
...
:if ([:len [/ip/route/find dst-address=62.205.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.205.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397477 }
:if ([:len [/ip/route/find dst-address=91.200.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.200.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397477 }
...
:if ([:len [/ip/route/find dst-address=95.164.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397477 }
:if ([:len [/ip/route/find dst-address=95.164.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397477 }
:if ([:len [/ip/route/find dst-address=95.164.246.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.246.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397477 }
