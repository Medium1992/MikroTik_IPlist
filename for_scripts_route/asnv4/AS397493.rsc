...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397493 and dst-address=for_scripts_route/asnv4/AS397493.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397493.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397493 }
