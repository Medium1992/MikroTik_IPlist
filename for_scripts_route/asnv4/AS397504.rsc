...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397504 and dst-address=for_scripts_route/asnv4/AS397504.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397504.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397504 }
