...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397511 and dst-address=for_scripts_route/asnv4/AS397511.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397511.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397511 }
