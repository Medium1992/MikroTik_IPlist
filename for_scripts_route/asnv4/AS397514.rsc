...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397514 and dst-address=for_scripts_route/asnv4/AS397514.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397514.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397514 }
