...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397593 and dst-address=for_scripts_route/asnv4/AS397593.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397593.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397593 }
