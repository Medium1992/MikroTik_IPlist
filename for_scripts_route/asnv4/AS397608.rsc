...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397608 and dst-address=for_scripts_route/asnv4/AS397608.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397608.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397608 }
