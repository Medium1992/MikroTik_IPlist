...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397644 and dst-address=for_scripts_route/asnv4/AS397644.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397644.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397644 }
