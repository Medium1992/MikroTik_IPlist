...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397650 and dst-address=for_scripts_route/asnv4/AS397650.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397650.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397650 }
