...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39767 and dst-address=for_scripts_route/asnv4/AS39767.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39767.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39767 }
