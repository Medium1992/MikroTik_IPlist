...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397686 and dst-address=for_scripts_route/asnv4/AS397686.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397686.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397686 }
