...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397710 and dst-address=for_scripts_route/asnv4/AS397710.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397710.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397710 }
