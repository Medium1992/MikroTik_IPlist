...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397712 and dst-address=for_scripts_route/asnv4/AS397712.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397712.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397712 }
