...
:if ([:len [/ip/route/find dst-address=149.10.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.10.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397733 }
:if ([:len [/ip/route/find dst-address=149.10.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.10.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397733 }
