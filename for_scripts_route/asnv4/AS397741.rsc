...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397741 and dst-address=for_scripts_route/asnv4/AS397741.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397741.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397741 }
