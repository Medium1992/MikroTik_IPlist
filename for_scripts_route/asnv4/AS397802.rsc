...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397802 and dst-address=for_scripts_route/asnv4/AS397802.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397802.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397802 }
