...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397807 and dst-address=for_scripts_route/asnv4/AS397807.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397807.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397807 }
