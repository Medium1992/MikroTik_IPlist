...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39781 and dst-address=for_scripts_route/asnv4/AS39781.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39781.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39781 }
