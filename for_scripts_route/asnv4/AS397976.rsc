...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS397976 and dst-address=for_scripts_route/asnv4/AS397976.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS397976.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS397976 }
