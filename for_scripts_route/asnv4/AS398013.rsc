...
:if ([:len [/ip/route/find dst-address=199.188.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.188.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398013 }
:if ([:len [/ip/route/find dst-address=199.188.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.188.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398013 }
...
:if ([:len [/ip/route/find dst-address=38.141.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.141.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398013 }
