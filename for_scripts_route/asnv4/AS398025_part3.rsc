...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=69.1.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.234.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.234.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.234.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.234.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.234.64/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.234.64/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.234.80/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.234.80/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.234.88/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.234.88/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.234.93/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.234.93/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
:if ([:len [/ip/route/find dst-address=69.1.234.94/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.1.234.94/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398025 }
