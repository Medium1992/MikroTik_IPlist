...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398029 and dst-address=for_scripts_route/asnv4/AS398029.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398029.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398029 }
