...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398266 and dst-address=for_scripts_route/asnv4/AS398266.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398266.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398266 }
