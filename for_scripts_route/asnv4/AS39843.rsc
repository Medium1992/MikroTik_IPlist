...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39843 and dst-address=for_scripts_route/asnv4/AS39843.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39843.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39843 }
