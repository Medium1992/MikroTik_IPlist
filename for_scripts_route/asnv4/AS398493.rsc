...
:if ([:len [/ip/route/find dst-address=107.149.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.149.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398493 }
:if ([:len [/ip/route/find dst-address=108.186.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.186.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398493 }
:if ([:len [/ip/route/find dst-address=108.186.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.186.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398493 }
:if ([:len [/ip/route/find dst-address=144.225.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398493 }
...
:if ([:len [/ip/route/find dst-address=166.88.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.88.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398493 }
:if ([:len [/ip/route/find dst-address=169.128.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.128.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398493 }
