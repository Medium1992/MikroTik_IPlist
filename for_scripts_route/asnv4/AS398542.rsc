...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398542 and dst-address=for_scripts_route/asnv4/AS398542.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398542.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398542 }
