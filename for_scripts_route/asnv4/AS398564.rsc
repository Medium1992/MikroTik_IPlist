...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398564 and dst-address=for_scripts_route/asnv4/AS398564.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398564.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398564 }
