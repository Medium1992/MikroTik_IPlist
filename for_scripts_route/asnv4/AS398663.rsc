...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398663 and dst-address=for_scripts_route/asnv4/AS398663.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398663.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398663 }
