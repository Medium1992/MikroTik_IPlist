...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398836 and dst-address=for_scripts_route/asnv4/AS398836.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398836.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398836 }
