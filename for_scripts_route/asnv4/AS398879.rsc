...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398879 and dst-address=for_scripts_route/asnv4/AS398879.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398879.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398879 }
