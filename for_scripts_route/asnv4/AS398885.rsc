...
:if ([:len [/ip/route/find dst-address=209.240.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.240.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398885 }
:if ([:len [/ip/route/find dst-address=209.240.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.240.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398885 }
