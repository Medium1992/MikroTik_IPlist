...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398919 and dst-address=for_scripts_route/asnv4/AS398919.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398919.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398919 }
