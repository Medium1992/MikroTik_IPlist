...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39892 and dst-address=for_scripts_route/asnv4/AS39892.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39892.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39892 }
