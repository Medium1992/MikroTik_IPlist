...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS398960 and dst-address=for_scripts_route/asnv4/AS398960.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS398960.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398960 }
