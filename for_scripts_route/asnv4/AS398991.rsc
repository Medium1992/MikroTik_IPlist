...
:if ([:len [/ip/route/find dst-address=142.99.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.99.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398991 }
:if ([:len [/ip/route/find dst-address=142.99.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.99.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398991 }
...
:if ([:len [/ip/route/find dst-address=208.122.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.122.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398991 }
...
:if ([:len [/ip/route/find dst-address=23.231.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.231.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398991 }
...
:if ([:len [/ip/route/find dst-address=38.247.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.247.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS398991 }
