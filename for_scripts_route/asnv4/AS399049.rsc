...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.162.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.162.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399049 }
...
:if ([:len [/ip/route/find dst-address=38.246.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.246.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399049 }
