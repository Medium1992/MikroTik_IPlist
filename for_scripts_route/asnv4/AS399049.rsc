...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399049 and dst-address=for_scripts_route/asnv4/AS399049.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399049.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399049 }
