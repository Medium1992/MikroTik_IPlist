...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399102 and dst-address=for_scripts_route/asnv4/AS399102.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399102.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399102 }
