...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399110 and dst-address=for_scripts_route/asnv4/AS399110.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399110.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399110 }
