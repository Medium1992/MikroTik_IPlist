...
:if ([:len [/ip/route/find dst-address=161.115.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.115.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399122 }
...
:if ([:len [/ip/route/find dst-address=64.130.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.130.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399122 }
