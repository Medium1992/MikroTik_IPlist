...
:if ([:len [/ip/route/find dst-address=154.27.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.27.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399122 }
:if ([:len [/ip/route/find dst-address=161.115.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.115.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399122 }
...
:if ([:len [/ip/route/find dst-address=38.3.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.3.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399122 }
