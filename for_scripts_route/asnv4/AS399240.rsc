...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.188.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.188.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399240 }
:if ([:len [/ip/route/find dst-address=12.215.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.215.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399240 }
