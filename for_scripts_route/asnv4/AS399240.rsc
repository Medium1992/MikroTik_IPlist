...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399240 and dst-address=for_scripts_route/asnv4/AS399240.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399240.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399240 }
