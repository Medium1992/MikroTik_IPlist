...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399285 and dst-address=for_scripts_route/asnv4/AS399285.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399285.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399285 }
