...
:if ([:len [/ip/route/find dst-address=64.190.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.190.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399334 }
...
:if ([:len [/ip/route/find dst-address=64.52.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.52.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399334 }
