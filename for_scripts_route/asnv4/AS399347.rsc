...
:if ([:len [/ip/route/find dst-address=167.150.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.150.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399347 }
...
:if ([:len [/ip/route/find dst-address=209.135.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.135.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399347 }
:if ([:len [/ip/route/find dst-address=209.135.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.135.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399347 }
