...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=199.21.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.21.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399353 }
...
:if ([:len [/ip/route/find dst-address=38.147.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.147.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399353 }
...
:if ([:len [/ip/route/find dst-address=38.147.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.147.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399353 }
:if ([:len [/ip/route/find dst-address=38.147.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.147.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399353 }
...
:if ([:len [/ip/route/find dst-address=38.147.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.147.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399353 }
