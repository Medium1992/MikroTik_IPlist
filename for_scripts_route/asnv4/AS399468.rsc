...
:if ([:len [/ip/route/find dst-address=130.12.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.12.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399468 }
...
:if ([:len [/ip/route/find dst-address=155.103.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.103.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399468 }
:if ([:len [/ip/route/find dst-address=162.210.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.210.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399468 }
...
:if ([:len [/ip/route/find dst-address=169.128.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.128.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399468 }
