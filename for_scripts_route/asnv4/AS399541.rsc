...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399541 and dst-address=for_scripts_route/asnv4/AS399541.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399541.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399541 }
