...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39961 and dst-address=for_scripts_route/asnv4/AS39961.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39961.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39961 }
