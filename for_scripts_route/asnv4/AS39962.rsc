...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=107.161.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.161.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39962 }
:if ([:len [/ip/route/find dst-address=107.161.34.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.161.34.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39962 }
