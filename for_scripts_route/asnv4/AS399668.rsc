...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399668 and dst-address=for_scripts_route/asnv4/AS399668.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399668.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399668 }
