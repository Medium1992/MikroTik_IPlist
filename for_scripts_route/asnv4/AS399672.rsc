...
:if ([:len [/ip/route/find dst-address=134.202.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.202.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399672 }
:if ([:len [/ip/route/find dst-address=134.202.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.202.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399672 }
:if ([:len [/ip/route/find dst-address=134.202.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.202.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399672 }
:if ([:len [/ip/route/find dst-address=134.202.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.202.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399672 }
...
:if ([:len [/ip/route/find dst-address=206.174.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.174.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399672 }
