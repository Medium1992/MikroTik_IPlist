...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399707 and dst-address=for_scripts_route/asnv4/AS399707.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399707.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399707 }
