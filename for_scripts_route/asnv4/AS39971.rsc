...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39971 and dst-address=for_scripts_route/asnv4/AS39971.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39971.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39971 }
