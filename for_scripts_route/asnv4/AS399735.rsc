...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS399735 and dst-address=for_scripts_route/asnv4/AS399735.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS399735.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399735 }
