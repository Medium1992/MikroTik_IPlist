...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS39985 and dst-address=for_scripts_route/asnv4/AS39985.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS39985.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS39985 }
