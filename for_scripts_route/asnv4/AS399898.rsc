...
:if ([:len [/ip/route/find dst-address=165.188.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.188.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399898 }
:if ([:len [/ip/route/find dst-address=165.188.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.188.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399898 }
:if ([:len [/ip/route/find dst-address=165.188.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=165.188.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399898 }
