...
:if ([:len [/ip/route/find dst-address=216.46.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.46.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=65.86.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.86.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=69.33.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.33.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=74.0.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.0.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=82.38.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
:if ([:len [/ip/route/find dst-address=82.38.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
:if ([:len [/ip/route/find dst-address=82.38.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
