...
:if ([:len [/ip/route/find dst-address=109.176.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.176.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=109.176.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.176.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=124.158.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.158.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
:if ([:len [/ip/route/find dst-address=180.131.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.131.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=198.102.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.102.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
:if ([:len [/ip/route/find dst-address=209.236.207.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.236.207.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
:if ([:len [/ip/route/find dst-address=213.218.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.218.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
:if ([:len [/ip/route/find dst-address=216.183.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.183.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
...
:if ([:len [/ip/route/find dst-address=43.242.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.242.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS399989 }
