...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400060 and dst-address=for_scripts_route/asnv4/AS400060.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400060.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400060 }
