...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400063 and dst-address=for_scripts_route/asnv4/AS400063.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400063.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400063 }
