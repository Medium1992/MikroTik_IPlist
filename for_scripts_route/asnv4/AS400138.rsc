...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400138 and dst-address=for_scripts_route/asnv4/AS400138.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400138.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400138 }
