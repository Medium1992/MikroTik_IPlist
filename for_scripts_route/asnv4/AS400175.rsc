...
:if ([:len [/ip/route/find dst-address=136.148.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.148.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400175 }
...
:if ([:len [/ip/route/find dst-address=198.252.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.252.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400175 }
...
:if ([:len [/ip/route/find dst-address=64.69.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.69.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400175 }
...
:if ([:len [/ip/route/find dst-address=84.75.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.75.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400175 }
