...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400189 and dst-address=for_scripts_route/asnv4/AS400189.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400189.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400189 }
