...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=140.228.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.228.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400212 }
...
:if ([:len [/ip/route/find dst-address=206.168.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.168.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400212 }
