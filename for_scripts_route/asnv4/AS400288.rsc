...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400288 and dst-address=for_scripts_route/asnv4/AS400288.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400288.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400288 }
