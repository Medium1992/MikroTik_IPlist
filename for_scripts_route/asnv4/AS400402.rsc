...
:if ([:len [/ip/route/find dst-address=136.0.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.0.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
:if ([:len [/ip/route/find dst-address=136.0.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.0.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
...
:if ([:len [/ip/route/find dst-address=166.88.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.88.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
:if ([:len [/ip/route/find dst-address=166.88.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.88.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
:if ([:len [/ip/route/find dst-address=170.62.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.62.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
...
:if ([:len [/ip/route/find dst-address=192.225.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.225.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
...
:if ([:len [/ip/route/find dst-address=23.27.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.27.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
...
:if ([:len [/ip/route/find dst-address=23.27.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.27.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
:if ([:len [/ip/route/find dst-address=31.76.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.76.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
:if ([:len [/ip/route/find dst-address=31.76.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.76.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
...
:if ([:len [/ip/route/find dst-address=50.114.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.114.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
:if ([:len [/ip/route/find dst-address=50.114.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.114.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
:if ([:len [/ip/route/find dst-address=50.114.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.114.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
