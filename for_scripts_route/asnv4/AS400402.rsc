...
:if ([:len [/ip/route/find dst-address=144.225.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
...
:if ([:len [/ip/route/find dst-address=168.93.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.93.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400402 }
