...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400487 and dst-address=for_scripts_route/asnv4/AS400487.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400487.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400487 }
