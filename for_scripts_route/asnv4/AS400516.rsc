...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400516 and dst-address=for_scripts_route/asnv4/AS400516.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400516.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400516 }
