...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400521 and dst-address=for_scripts_route/asnv4/AS400521.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400521.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400521 }
