...
:if ([:len [/ip/route/find dst-address=143.20.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400556 }
:if ([:len [/ip/route/find dst-address=216.109.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.109.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400556 }
...
:if ([:len [/ip/route/find dst-address=82.22.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.22.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400556 }
:if ([:len [/ip/route/find dst-address=82.22.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.22.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400556 }
