...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400589 and dst-address=for_scripts_route/asnv4/AS400589.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400589.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400589 }
