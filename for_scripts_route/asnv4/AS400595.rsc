...
:if ([:len [/ip/route/find dst-address=67.21.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.32/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.32/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.34/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.34/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.36/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.36/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.40/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.40/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
:if ([:len [/ip/route/find dst-address=67.21.179.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.21.179.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400595 }
