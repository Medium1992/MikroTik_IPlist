...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS40067 and dst-address=for_scripts_route/asnv4/AS40067.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS40067.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40067 }
