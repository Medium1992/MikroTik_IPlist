...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS40068 and dst-address=for_scripts_route/asnv4/AS40068.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS40068.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40068 }
