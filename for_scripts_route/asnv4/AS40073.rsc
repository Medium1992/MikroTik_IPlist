...
:if ([:len [/ip/route/find dst-address=66.6.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.6.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40073 }
:if ([:len [/ip/route/find dst-address=66.6.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.6.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40073 }
:if ([:len [/ip/route/find dst-address=66.6.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.6.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40073 }
...
:if ([:len [/ip/route/find dst-address=66.6.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.6.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40073 }
