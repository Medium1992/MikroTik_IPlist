...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=107.180.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.180.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400754 }
:if ([:len [/ip/route/find dst-address=107.180.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.180.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400754 }
:if ([:len [/ip/route/find dst-address=107.180.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.180.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400754 }
:if ([:len [/ip/route/find dst-address=107.180.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.180.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400754 }
:if ([:len [/ip/route/find dst-address=107.180.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.180.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400754 }
:if ([:len [/ip/route/find dst-address=107.180.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.180.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400754 }
:if ([:len [/ip/route/find dst-address=132.148.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.148.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400754 }
