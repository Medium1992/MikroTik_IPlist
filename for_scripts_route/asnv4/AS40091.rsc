...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=216.115.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.115.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40091 }
:if ([:len [/ip/route/find dst-address=76.9.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40091 }
:if ([:len [/ip/route/find dst-address=76.9.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.9.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40091 }
