...
:if ([:len [/ip/route/find dst-address=217.217.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.217.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400951 }
:if ([:len [/ip/route/find dst-address=64.178.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.178.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400951 }
:if ([:len [/ip/route/find dst-address=64.178.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.178.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400951 }
:if ([:len [/ip/route/find dst-address=64.178.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.178.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400951 }
:if ([:len [/ip/route/find dst-address=64.83.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.83.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400951 }
