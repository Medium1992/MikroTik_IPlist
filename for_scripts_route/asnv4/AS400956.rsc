...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=140.99.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.99.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400956 }
:if ([:len [/ip/route/find dst-address=140.99.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.99.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400956 }
:if ([:len [/ip/route/find dst-address=140.99.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.99.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400956 }
