...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS400964 and dst-address=for_scripts_route/asnv4/AS400964.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS400964.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS400964 }
