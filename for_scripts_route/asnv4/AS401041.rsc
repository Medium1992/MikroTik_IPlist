...
:if ([:len [/ip/route/find dst-address=198.55.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.55.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401041 }
:if ([:len [/ip/route/find dst-address=198.55.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.55.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401041 }
:if ([:len [/ip/route/find dst-address=198.55.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.55.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401041 }
