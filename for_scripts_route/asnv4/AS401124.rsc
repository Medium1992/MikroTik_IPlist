...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS401124 and dst-address=for_scripts_route/asnv4/AS401124.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS401124.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401124 }
