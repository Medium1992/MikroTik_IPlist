...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS401182 and dst-address=for_scripts_route/asnv4/AS401182.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS401182.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401182 }
