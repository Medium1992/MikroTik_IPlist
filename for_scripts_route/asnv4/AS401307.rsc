...
:if ([:len [/ip/route/find dst-address=204.25.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.25.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401307 }
...
:if ([:len [/ip/route/find dst-address=35.63.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=35.63.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401307 }
