...
:if ([:len [/ip/route/find dst-address=155.117.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.117.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401418 }
:if ([:len [/ip/route/find dst-address=163.5.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.5.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401418 }
...
:if ([:len [/ip/route/find dst-address=82.21.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.21.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401418 }
