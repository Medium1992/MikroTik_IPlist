...
:if ([:len [/ip/route/find dst-address=67.227.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.227.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401430 }
:if ([:len [/ip/route/find dst-address=74.1.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.1.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401430 }
