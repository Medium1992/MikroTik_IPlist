...
:if ([:len [/ip/route/find dst-address=23.175.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.175.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401443 }
...
:if ([:len [/ip/route/find dst-address=89.213.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401443 }
