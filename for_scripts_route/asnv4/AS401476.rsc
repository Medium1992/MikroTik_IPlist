...
:if ([:len [/ip/route/find dst-address=146.103.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=146.103.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401476 }
...
:if ([:len [/ip/route/find dst-address=212.100.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.100.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401476 }
...
:if ([:len [/ip/route/find dst-address=45.13.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.13.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401476 }
...
:if ([:len [/ip/route/find dst-address=92.113.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.113.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401476 }
