...
:if ([:len [/ip/route/find dst-address=142.249.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.249.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40156 }
...
:if ([:len [/ip/route/find dst-address=193.202.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.202.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40156 }
:if ([:len [/ip/route/find dst-address=195.8.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.8.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40156 }
