...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS401561 and dst-address=for_scripts_route/asnv4/AS401561.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS401561.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401561 }
