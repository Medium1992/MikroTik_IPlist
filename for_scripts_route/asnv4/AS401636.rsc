...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=155.103.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.103.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401636 }
...
:if ([:len [/ip/route/find dst-address=199.67.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.67.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401636 }
