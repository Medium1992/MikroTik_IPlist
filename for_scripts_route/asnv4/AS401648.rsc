...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS401648 and dst-address=for_scripts_route/asnv4/AS401648.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS401648.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401648 }
