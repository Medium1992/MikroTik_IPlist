...
:if ([:len [/ip/route/find dst-address=154.201.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.201.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
:if ([:len [/ip/route/find dst-address=154.219.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.219.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
:if ([:len [/ip/route/find dst-address=154.219.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.219.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
...
:if ([:len [/ip/route/find dst-address=154.219.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.219.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
:if ([:len [/ip/route/find dst-address=154.219.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.219.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
...
:if ([:len [/ip/route/find dst-address=154.94.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.94.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
:if ([:len [/ip/route/find dst-address=154.94.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.94.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
:if ([:len [/ip/route/find dst-address=154.94.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.94.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
