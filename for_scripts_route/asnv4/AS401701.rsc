...
:if ([:len [/ip/route/find dst-address=82.158.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.158.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
:if ([:len [/ip/route/find dst-address=82.158.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.158.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
:if ([:len [/ip/route/find dst-address=82.158.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.158.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401701 }
