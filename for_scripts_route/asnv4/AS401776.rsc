...
:if ([:len [/ip/route/find dst-address=147.79.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.79.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
:if ([:len [/ip/route/find dst-address=150.241.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.241.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
:if ([:len [/ip/route/find dst-address=158.173.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.173.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=169.40.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.40.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
:if ([:len [/ip/route/find dst-address=169.40.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.40.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=192.208.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.208.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=78.108.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.108.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=82.27.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.27.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
:if ([:len [/ip/route/find dst-address=82.29.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.29.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=82.39.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.39.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
