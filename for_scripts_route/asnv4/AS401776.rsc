...
:if ([:len [/ip/route/find dst-address=154.16.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.16.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=176.102.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.102.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=189.13.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.13.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
...
:if ([:len [/ip/route/find dst-address=89.30.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.30.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401776 }
