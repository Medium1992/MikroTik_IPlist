...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS401891 and dst-address=for_scripts_route/asnv4/AS401891.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS401891.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401891 }
