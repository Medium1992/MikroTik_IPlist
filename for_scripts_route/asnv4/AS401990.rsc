...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS401990 and dst-address=for_scripts_route/asnv4/AS401990.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS401990.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS401990 }
