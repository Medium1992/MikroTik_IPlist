...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.108.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.108.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402020 }
...
:if ([:len [/ip/route/find dst-address=179.63.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.63.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402020 }
:if ([:len [/ip/route/find dst-address=179.63.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.63.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402020 }
...
:if ([:len [/ip/route/find dst-address=190.185.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.185.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402020 }
