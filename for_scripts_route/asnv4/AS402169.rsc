...
:if ([:len [/ip/route/find dst-address=186.241.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.241.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402169 }
:if ([:len [/ip/route/find dst-address=186.241.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.241.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402169 }
:if ([:len [/ip/route/find dst-address=186.241.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.241.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402169 }
:if ([:len [/ip/route/find dst-address=186.244.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.244.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402169 }
...
:if ([:len [/ip/route/find dst-address=38.165.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.165.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS402169 }
