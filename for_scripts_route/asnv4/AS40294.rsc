...
:if ([:len [/ip/route/find dst-address=47.43.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=47.43.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40294 }
:if ([:len [/ip/route/find dst-address=47.43.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=47.43.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40294 }
