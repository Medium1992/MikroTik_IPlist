...
:if ([:len [/ip/route/find dst-address=199.169.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.169.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40410 }
...
:if ([:len [/ip/route/find dst-address=199.169.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.169.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40410 }
:if ([:len [/ip/route/find dst-address=199.169.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.169.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40410 }
...
:if ([:len [/ip/route/find dst-address=199.169.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.169.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40410 }
