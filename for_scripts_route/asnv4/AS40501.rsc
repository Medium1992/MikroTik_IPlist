...
:if ([:len [/ip/route/find dst-address=216.235.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.235.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40501 }
...
:if ([:len [/ip/route/find dst-address=216.235.91.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.235.91.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40501 }
...
:if ([:len [/ip/route/find dst-address=216.235.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.235.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40501 }
