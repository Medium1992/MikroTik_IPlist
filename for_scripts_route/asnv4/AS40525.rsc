...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS40525 and dst-address=for_scripts_route/asnv4/AS40525.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS40525.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40525 }
