...
:if ([:len [/ip/route/find dst-address=38.145.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.145.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
...
:if ([:len [/ip/route/find dst-address=38.21.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.21.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.21.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.21.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.21.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.21.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
...
:if ([:len [/ip/route/find dst-address=38.27.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.27.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.39.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.39.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.70.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.70.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.77.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.77.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.77.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.77.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.77.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.77.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
:if ([:len [/ip/route/find dst-address=38.77.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.77.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40545 }
