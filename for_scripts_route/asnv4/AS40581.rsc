...
:if ([:len [/ip/route/find dst-address=192.231.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.231.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40581 }
...
:if ([:len [/ip/route/find dst-address=72.35.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.35.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40581 }
