...
:if ([:len [/ip/route/find dst-address=40.27.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=40.27.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40605 }
...
:if ([:len [/ip/route/find dst-address=40.27.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=40.27.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40605 }
