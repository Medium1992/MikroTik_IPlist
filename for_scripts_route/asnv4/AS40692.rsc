...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS40692 and dst-address=for_scripts_route/asnv4/AS40692.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS40692.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40692 }
