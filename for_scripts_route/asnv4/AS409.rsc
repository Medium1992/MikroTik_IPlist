...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=128.216.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.216.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS409 }
...
:if ([:len [/ip/route/find dst-address=131.47.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.47.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS409 }
...
:if ([:len [/ip/route/find dst-address=132.16.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.16.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS409 }
