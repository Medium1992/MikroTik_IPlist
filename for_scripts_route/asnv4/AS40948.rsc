...
:if ([:len [/ip/route/find dst-address=153.75.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.75.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40948 }
...
:if ([:len [/ip/route/find dst-address=192.77.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.77.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS40948 }
