...
:if ([:len [/ip/route/find dst-address=89.234.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.234.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41006 }
:if ([:len [/ip/route/find dst-address=89.234.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.234.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41006 }
