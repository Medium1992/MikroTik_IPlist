...
:if ([:len [/ip/route/find dst-address=195.234.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.234.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41009 }
:if ([:len [/ip/route/find dst-address=46.229.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.229.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41009 }
