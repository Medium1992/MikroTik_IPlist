...
:if ([:len [/ip/route/find dst-address=185.193.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.193.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41079 }
...
:if ([:len [/ip/route/find dst-address=193.218.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.218.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41079 }
...
:if ([:len [/ip/route/find dst-address=91.239.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.239.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41079 }
