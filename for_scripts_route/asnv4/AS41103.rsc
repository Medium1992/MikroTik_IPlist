...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS41103 and dst-address=for_scripts_route/asnv4/AS41103.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS41103.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41103 }
