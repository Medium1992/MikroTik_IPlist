...
:if ([:len [/ip/route/find dst-address=185.52.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.52.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41155 }
...
:if ([:len [/ip/route/find dst-address=45.156.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.156.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41155 }
