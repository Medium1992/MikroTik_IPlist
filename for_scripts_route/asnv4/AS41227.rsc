...
:if ([:len [/ip/route/find dst-address=185.166.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.166.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41227 }
...
:if ([:len [/ip/route/find dst-address=87.247.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.247.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41227 }
:if ([:len [/ip/route/find dst-address=87.247.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.247.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41227 }
