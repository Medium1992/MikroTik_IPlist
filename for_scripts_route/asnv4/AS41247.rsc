...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS41247 and dst-address=for_scripts_route/asnv4/AS41247.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS41247.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41247 }
