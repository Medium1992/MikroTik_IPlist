...
:if ([:len [/ip/route/find dst-address=104.132.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.132.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
...
:if ([:len [/ip/route/find dst-address=209.119.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.119.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
