...
:if ([:len [/ip/route/find dst-address=104.132.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.132.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
:if ([:len [/ip/route/find dst-address=104.132.153.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.132.153.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
...
:if ([:len [/ip/route/find dst-address=104.132.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.132.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
:if ([:len [/ip/route/find dst-address=104.132.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.132.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
:if ([:len [/ip/route/find dst-address=104.132.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.132.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
...
:if ([:len [/ip/route/find dst-address=104.132.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.132.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
...
:if ([:len [/ip/route/find dst-address=104.133.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.133.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41264 }
