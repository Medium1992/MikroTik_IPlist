...
:if ([:len [/ip/route/find dst-address=62.217.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.160/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.160/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.176/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.176/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.180/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.180/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.182/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.182/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.184/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.184/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=62.217.191.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.217.191.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
