...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=161.104.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.104.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
...
:if ([:len [/ip/route/find dst-address=195.170.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.170.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
:if ([:len [/ip/route/find dst-address=195.170.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.170.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41275 }
