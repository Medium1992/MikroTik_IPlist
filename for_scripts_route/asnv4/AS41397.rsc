...
:if ([:len [/ip/route/find dst-address=213.220.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.220.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41397 }
:if ([:len [/ip/route/find dst-address=213.220.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.220.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41397 }
:if ([:len [/ip/route/find dst-address=213.220.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.220.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41397 }
:if ([:len [/ip/route/find dst-address=213.220.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.220.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41397 }
