...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS41400 and dst-address=for_scripts_route/asnv4/AS41400.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS41400.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41400 }
