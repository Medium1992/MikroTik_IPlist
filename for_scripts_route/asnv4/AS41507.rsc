...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS41507 and dst-address=for_scripts_route/asnv4/AS41507.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS41507.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41507 }
