...
:if ([:len [/ip/route/find dst-address=89.255.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.255.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41601 }
:if ([:len [/ip/route/find dst-address=89.255.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.255.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41601 }
