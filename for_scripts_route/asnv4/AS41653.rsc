...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.121.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.121.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41653 }
:if ([:len [/ip/route/find dst-address=178.212.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.212.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41653 }
...
:if ([:len [/ip/route/find dst-address=85.8.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.8.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41653 }
