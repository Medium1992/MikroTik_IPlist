...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=194.46.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.46.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41678 }
:if ([:len [/ip/route/find dst-address=194.46.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.46.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41678 }
:if ([:len [/ip/route/find dst-address=194.46.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.46.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41678 }
...
:if ([:len [/ip/route/find dst-address=194.46.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.46.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41678 }
...
:if ([:len [/ip/route/find dst-address=194.46.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.46.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41678 }
