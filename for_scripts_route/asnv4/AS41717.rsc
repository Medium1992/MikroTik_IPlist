...
:if ([:len [/ip/route/find dst-address=103.99.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.99.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41717 }
...
:if ([:len [/ip/route/find dst-address=2.58.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.58.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41717 }
:if ([:len [/ip/route/find dst-address=2.58.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.58.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41717 }
...
:if ([:len [/ip/route/find dst-address=5.183.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.183.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41717 }
:if ([:len [/ip/route/find dst-address=5.183.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.183.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41717 }
