...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS41782 and dst-address=for_scripts_route/asnv4/AS41782.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS41782.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41782 }
