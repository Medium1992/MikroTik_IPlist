...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS41922 and dst-address=for_scripts_route/asnv4/AS41922.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS41922.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41922 }
