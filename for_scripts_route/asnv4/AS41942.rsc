...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS41942 and dst-address=for_scripts_route/asnv4/AS41942.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS41942.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS41942 }
