...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42000 and dst-address=for_scripts_route/asnv4/AS42000.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42000.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42000 }
