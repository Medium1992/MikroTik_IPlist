...
:if ([:len [/ip/route/find dst-address=193.46.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.46.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42007 }
...
:if ([:len [/ip/route/find dst-address=194.31.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.31.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42007 }
