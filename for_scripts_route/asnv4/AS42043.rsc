...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42043 and dst-address=for_scripts_route/asnv4/AS42043.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42043.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42043 }
