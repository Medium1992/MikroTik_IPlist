...
:if ([:len [/ip/route/find dst-address=95.161.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42065 }
...
:if ([:len [/ip/route/find dst-address=95.161.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42065 }
:if ([:len [/ip/route/find dst-address=95.161.20.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.20.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42065 }
:if ([:len [/ip/route/find dst-address=95.161.22.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.22.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42065 }
:if ([:len [/ip/route/find dst-address=95.161.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42065 }
:if ([:len [/ip/route/find dst-address=95.161.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.161.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42065 }
