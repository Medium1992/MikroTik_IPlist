...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42159 and dst-address=for_scripts_route/asnv4/AS42159.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42159.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42159 }
