...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42176 and dst-address=for_scripts_route/asnv4/AS42176.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42176.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42176 }
