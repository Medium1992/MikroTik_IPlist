...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42291 and dst-address=for_scripts_route/asnv4/AS42291.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42291.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42291 }
