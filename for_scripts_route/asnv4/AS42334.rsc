...
:if ([:len [/ip/route/find dst-address=185.131.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.131.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42334 }
:if ([:len [/ip/route/find dst-address=185.131.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.131.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42334 }
