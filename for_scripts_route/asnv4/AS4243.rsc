...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=159.45.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.45.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4243 }
...
:if ([:len [/ip/route/find dst-address=171.72.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=171.72.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4243 }
