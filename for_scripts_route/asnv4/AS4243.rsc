...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4243 and dst-address=for_scripts_route/asnv4/AS4243.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4243.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4243 }
