...
:if ([:len [/ip/route/find dst-address=185.78.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.78.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42437 }
...
:if ([:len [/ip/route/find dst-address=89.249.153.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.249.153.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42437 }
