...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42446 and dst-address=for_scripts_route/asnv4/AS42446.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42446.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42446 }
