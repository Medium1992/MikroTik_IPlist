...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42447 and dst-address=for_scripts_route/asnv4/AS42447.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42447.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42447 }
