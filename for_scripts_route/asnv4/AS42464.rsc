...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42464 and dst-address=for_scripts_route/asnv4/AS42464.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42464.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42464 }
