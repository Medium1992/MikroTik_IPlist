...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=217.146.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.146.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
:if ([:len [/ip/route/find dst-address=217.146.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.146.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
:if ([:len [/ip/route/find dst-address=217.146.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.146.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
:if ([:len [/ip/route/find dst-address=37.235.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.235.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
:if ([:len [/ip/route/find dst-address=37.235.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.235.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
:if ([:len [/ip/route/find dst-address=37.235.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.235.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
:if ([:len [/ip/route/find dst-address=37.252.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.252.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
:if ([:len [/ip/route/find dst-address=45.132.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.132.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42473 }
