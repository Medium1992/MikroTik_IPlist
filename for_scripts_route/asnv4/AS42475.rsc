...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42475 and dst-address=for_scripts_route/asnv4/AS42475.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42475.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42475 }
