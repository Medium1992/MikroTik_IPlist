...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42490 and dst-address=for_scripts_route/asnv4/AS42490.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42490.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42490 }
