...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42493 and dst-address=for_scripts_route/asnv4/AS42493.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42493.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42493 }
