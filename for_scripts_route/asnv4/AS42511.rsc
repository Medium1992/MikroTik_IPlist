...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42511 and dst-address=for_scripts_route/asnv4/AS42511.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42511.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42511 }
