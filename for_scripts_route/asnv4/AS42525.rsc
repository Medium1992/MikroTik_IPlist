...
:if ([:len [/ip/route/find dst-address=193.200.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.200.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42525 }
...
:if ([:len [/ip/route/find dst-address=46.32.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.32.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42525 }
