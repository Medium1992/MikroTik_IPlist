...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42567 and dst-address=for_scripts_route/asnv4/AS42567.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42567.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42567 }
