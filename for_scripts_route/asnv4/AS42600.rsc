...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42600 and dst-address=for_scripts_route/asnv4/AS42600.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42600.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42600 }
