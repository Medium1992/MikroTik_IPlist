...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42632 and dst-address=for_scripts_route/asnv4/AS42632.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42632.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42632 }
