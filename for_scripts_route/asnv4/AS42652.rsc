...
:if ([:len [/ip/route/find dst-address=89.21.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.21.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42652 }
:if ([:len [/ip/route/find dst-address=89.21.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.21.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42652 }
