...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42701 and dst-address=for_scripts_route/asnv4/AS42701.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42701.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42701 }
