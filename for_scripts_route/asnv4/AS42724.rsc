...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42724 and dst-address=for_scripts_route/asnv4/AS42724.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42724.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42724 }
