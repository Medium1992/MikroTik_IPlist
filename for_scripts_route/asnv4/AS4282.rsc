...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4282 and dst-address=for_scripts_route/asnv4/AS4282.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4282.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4282 }
