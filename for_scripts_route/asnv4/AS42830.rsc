...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42830 and dst-address=for_scripts_route/asnv4/AS42830.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42830.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42830 }
