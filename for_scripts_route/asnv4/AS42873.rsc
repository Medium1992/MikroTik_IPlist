...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42873 and dst-address=for_scripts_route/asnv4/AS42873.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42873.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42873 }
