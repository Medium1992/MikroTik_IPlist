...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42894 and dst-address=for_scripts_route/asnv4/AS42894.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42894.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42894 }
