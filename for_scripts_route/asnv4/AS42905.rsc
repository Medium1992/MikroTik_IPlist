...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42905 and dst-address=for_scripts_route/asnv4/AS42905.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42905.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42905 }
