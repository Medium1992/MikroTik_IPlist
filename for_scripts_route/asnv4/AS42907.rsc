...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42907 and dst-address=for_scripts_route/asnv4/AS42907.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42907.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42907 }
