...
:if ([:len [/ip/route/find dst-address=195.225.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.225.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42929 }
...
:if ([:len [/ip/route/find dst-address=2.56.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.56.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42929 }
