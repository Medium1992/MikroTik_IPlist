...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42944 and dst-address=for_scripts_route/asnv4/AS42944.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42944.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42944 }
