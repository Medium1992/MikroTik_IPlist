...
:if ([:len [/ip/route/find dst-address=141.11.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.11.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
...
:if ([:len [/ip/route/find dst-address=157.254.193.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.254.193.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
...
:if ([:len [/ip/route/find dst-address=163.5.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.5.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
:if ([:len [/ip/route/find dst-address=163.5.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.5.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
