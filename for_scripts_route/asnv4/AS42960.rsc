...
:if ([:len [/ip/route/find dst-address=103.39.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.39.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
...
:if ([:len [/ip/route/find dst-address=149.104.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.104.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
...
:if ([:len [/ip/route/find dst-address=38.55.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.55.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42960 }
