...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS42986 and dst-address=for_scripts_route/asnv4/AS42986.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS42986.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS42986 }
