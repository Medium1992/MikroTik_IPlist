...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.17.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.17.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43038 }
...
:if ([:len [/ip/route/find dst-address=81.195.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.195.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43038 }
