...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=130.117.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.117.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43054 }
:if ([:len [/ip/route/find dst-address=154.59.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.59.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43054 }
