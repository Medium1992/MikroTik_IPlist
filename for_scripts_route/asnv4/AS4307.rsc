...
:if ([:len [/ip/route/find dst-address=216.139.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.139.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4307 }
:if ([:len [/ip/route/find dst-address=216.139.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.139.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4307 }
:if ([:len [/ip/route/find dst-address=216.139.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.139.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4307 }
:if ([:len [/ip/route/find dst-address=216.139.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.139.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4307 }
:if ([:len [/ip/route/find dst-address=216.139.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.139.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4307 }
