...
:if ([:len [/ip/route/find dst-address=185.104.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.104.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43139 }
...
:if ([:len [/ip/route/find dst-address=194.187.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.187.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43139 }
:if ([:len [/ip/route/find dst-address=195.128.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.128.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43139 }
