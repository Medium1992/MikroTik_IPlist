...
:if ([:len [/ip/route/find dst-address=189.74.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.74.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43278 }
:if ([:len [/ip/route/find dst-address=189.74.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.74.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43278 }
:if ([:len [/ip/route/find dst-address=201.50.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.50.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43278 }
...
:if ([:len [/ip/route/find dst-address=213.109.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.109.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43278 }
