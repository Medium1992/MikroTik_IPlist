...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43284 and dst-address=for_scripts_route/asnv4/AS43284.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43284.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43284 }
