...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43292 and dst-address=for_scripts_route/asnv4/AS43292.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43292.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43292 }
