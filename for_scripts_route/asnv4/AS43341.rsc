...
:if ([:len [/ip/route/find dst-address=45.141.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.141.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43341 }
...
:if ([:len [/ip/route/find dst-address=95.156.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.156.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43341 }
