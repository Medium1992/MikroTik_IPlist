...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.237.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.237.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43391 }
...
:if ([:len [/ip/route/find dst-address=91.191.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43391 }
...
:if ([:len [/ip/route/find dst-address=91.191.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.191.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43391 }
