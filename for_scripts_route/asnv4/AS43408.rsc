...
:if ([:len [/ip/route/find dst-address=87.238.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.238.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43408 }
:if ([:len [/ip/route/find dst-address=87.238.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.238.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43408 }
