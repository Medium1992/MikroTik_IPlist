...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.237.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.237.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43515 }
...
:if ([:len [/ip/route/find dst-address=208.117.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.117.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43515 }
:if ([:len [/ip/route/find dst-address=208.117.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.117.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43515 }
...
:if ([:len [/ip/route/find dst-address=208.117.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.117.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43515 }
:if ([:len [/ip/route/find dst-address=208.117.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.117.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43515 }
