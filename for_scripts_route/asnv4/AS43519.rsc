...
:if ([:len [/ip/route/find dst-address=213.248.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.248.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43519 }
:if ([:len [/ip/route/find dst-address=213.248.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.248.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43519 }
...
:if ([:len [/ip/route/find dst-address=213.248.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.248.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43519 }
