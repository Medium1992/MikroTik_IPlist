...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43601 and dst-address=for_scripts_route/asnv4/AS43601.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43601.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43601 }
