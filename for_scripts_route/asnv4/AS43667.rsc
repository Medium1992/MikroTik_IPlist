...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43667 and dst-address=for_scripts_route/asnv4/AS43667.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43667.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43667 }
