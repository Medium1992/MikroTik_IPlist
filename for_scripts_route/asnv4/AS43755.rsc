...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43755 and dst-address=for_scripts_route/asnv4/AS43755.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43755.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43755 }
