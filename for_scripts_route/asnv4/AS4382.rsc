...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4382 and dst-address=for_scripts_route/asnv4/AS4382.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4382.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4382 }
