...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43832 and dst-address=for_scripts_route/asnv4/AS43832.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43832.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43832 }
