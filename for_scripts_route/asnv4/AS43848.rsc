...
:if ([:len [/ip/route/find dst-address=85.255.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.255.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43848 }
...
:if ([:len [/ip/route/find dst-address=85.255.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.255.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43848 }
