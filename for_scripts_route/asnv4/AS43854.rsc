...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43854 and dst-address=for_scripts_route/asnv4/AS43854.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43854.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43854 }
