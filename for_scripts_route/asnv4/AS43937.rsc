...
:if ([:len [/ip/route/find dst-address=93.89.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=93.89.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=93.89.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
