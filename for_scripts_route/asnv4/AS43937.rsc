...
:if ([:len [/ip/route/find dst-address=93.89.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=93.89.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
