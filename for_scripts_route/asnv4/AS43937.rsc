...
:if ([:len [/ip/route/find dst-address=185.6.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.6.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
...
:if ([:len [/ip/route/find dst-address=213.187.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.187.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=213.187.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.187.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
...
:if ([:len [/ip/route/find dst-address=82.116.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.116.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=82.116.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.116.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=82.116.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.116.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=82.116.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.116.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
...
:if ([:len [/ip/route/find dst-address=93.89.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=93.89.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=93.89.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
:if ([:len [/ip/route/find dst-address=93.89.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.89.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43937 }
