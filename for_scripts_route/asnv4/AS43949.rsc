...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS43949 and dst-address=for_scripts_route/asnv4/AS43949.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS43949.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43949 }
