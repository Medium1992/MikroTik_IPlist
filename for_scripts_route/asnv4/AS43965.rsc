...
:if ([:len [/ip/route/find dst-address=94.184.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43965 }
:if ([:len [/ip/route/find dst-address=94.184.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43965 }
