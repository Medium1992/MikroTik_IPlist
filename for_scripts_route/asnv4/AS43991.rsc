...
:if ([:len [/ip/route/find dst-address=189.74.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=189.74.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43991 }
:if ([:len [/ip/route/find dst-address=193.135.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.135.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43991 }
...
:if ([:len [/ip/route/find dst-address=193.228.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.228.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43991 }
