...
:if ([:len [/ip/route/find dst-address=37.10.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.10.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43996 }
:if ([:len [/ip/route/find dst-address=37.10.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.10.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS43996 }
