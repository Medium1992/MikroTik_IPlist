...
:if ([:len [/ip/route/find dst-address=185.26.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.26.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
...
:if ([:len [/ip/route/find dst-address=79.133.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.133.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
