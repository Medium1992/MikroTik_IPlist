...
:if ([:len [/ip/route/find dst-address=194.154.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.154.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
:if ([:len [/ip/route/find dst-address=194.154.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.154.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
...
:if ([:len [/ip/route/find dst-address=213.239.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.239.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
:if ([:len [/ip/route/find dst-address=217.177.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.177.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44051 }
