...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS44084 and dst-address=for_scripts_route/asnv4/AS44084.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS44084.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44084 }
