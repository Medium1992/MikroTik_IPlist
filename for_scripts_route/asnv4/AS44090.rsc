...
:if ([:len [/ip/route/find dst-address=185.129.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.129.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44090 }
:if ([:len [/ip/route/find dst-address=185.129.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.129.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44090 }
