...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS44196 and dst-address=for_scripts_route/asnv4/AS44196.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS44196.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44196 }
