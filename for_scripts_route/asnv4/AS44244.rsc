...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS44244 and dst-address=for_scripts_route/asnv4/AS44244.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS44244.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44244 }
