...
:if ([:len [/ip/route/find dst-address=5.120.0.0/14 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.120.0.0/14 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44244 }
