...
:if ([:len [/ip/route/find dst-address=37.32.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.32.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
...
:if ([:len [/ip/route/find dst-address=45.140.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.140.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
:if ([:len [/ip/route/find dst-address=45.156.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.156.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
:if ([:len [/ip/route/find dst-address=45.156.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.156.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
...
:if ([:len [/ip/route/find dst-address=85.198.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.198.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44285 }
