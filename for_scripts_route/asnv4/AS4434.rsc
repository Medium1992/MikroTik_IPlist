...
:if ([:len [/ip/route/find dst-address=202.154.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.154.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4434 }
:if ([:len [/ip/route/find dst-address=202.154.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.154.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4434 }
:if ([:len [/ip/route/find dst-address=202.154.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.154.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4434 }
...
:if ([:len [/ip/route/find dst-address=202.154.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.154.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4434 }
:if ([:len [/ip/route/find dst-address=202.154.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.154.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4434 }
