...
:if ([:len [/ip/route/find dst-address=155.103.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.103.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44382 }
:if ([:len [/ip/route/find dst-address=155.103.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.103.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44382 }
