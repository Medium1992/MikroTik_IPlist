...
:if ([:len [/ip/route/find dst-address=176.115.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.115.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44391 }
:if ([:len [/ip/route/find dst-address=176.115.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.115.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44391 }
