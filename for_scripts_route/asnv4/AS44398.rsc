...
:if ([:len [/ip/route/find dst-address=213.174.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.174.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44398 }
:if ([:len [/ip/route/find dst-address=213.174.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.174.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44398 }
:if ([:len [/ip/route/find dst-address=213.174.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.174.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44398 }
