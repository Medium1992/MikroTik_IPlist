...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4451 and dst-address=for_scripts_route/asnv4/AS4451.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4451.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4451 }
