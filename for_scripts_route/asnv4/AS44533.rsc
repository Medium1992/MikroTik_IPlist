...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS44533 and dst-address=for_scripts_route/asnv4/AS44533.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS44533.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44533 }
