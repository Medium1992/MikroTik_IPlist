...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.222.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44547 }
...
:if ([:len [/ip/route/find dst-address=37.221.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.221.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44547 }
:if ([:len [/ip/route/find dst-address=45.133.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.133.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44547 }
:if ([:len [/ip/route/find dst-address=45.141.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.141.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44547 }
