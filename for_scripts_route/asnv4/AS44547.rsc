...
:if ([:len [/ip/route/find dst-address=188.132.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.132.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44547 }
...
:if ([:len [/ip/route/find dst-address=45.195.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.195.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44547 }
