...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS44566 and dst-address=for_scripts_route/asnv4/AS44566.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS44566.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44566 }
