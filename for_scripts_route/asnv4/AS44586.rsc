...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS44586 and dst-address=for_scripts_route/asnv4/AS44586.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS44586.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44586 }
