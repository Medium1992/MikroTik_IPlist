...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4469 and dst-address=for_scripts_route/asnv4/AS4469.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4469.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4469 }
