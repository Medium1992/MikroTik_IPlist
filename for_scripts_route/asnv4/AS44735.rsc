...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.126.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.126.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44735 }
:if ([:len [/ip/route/find dst-address=149.126.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.126.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44735 }
:if ([:len [/ip/route/find dst-address=149.126.86.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.126.86.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44735 }
