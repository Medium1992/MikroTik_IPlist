...
:if ([:len [/ip/route/find dst-address=130.248.65.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.248.65.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44786 }
:if ([:len [/ip/route/find dst-address=130.248.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.248.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44786 }
