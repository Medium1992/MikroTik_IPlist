...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.143.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.143.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44789 }
...
:if ([:len [/ip/route/find dst-address=45.10.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.10.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44789 }
