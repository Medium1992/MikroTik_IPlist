...
:if ([:len [/ip/route/find dst-address=193.182.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.182.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=193.182.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.182.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=193.182.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.182.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
