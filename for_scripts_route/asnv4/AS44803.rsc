...
:if ([:len [/ip/route/find dst-address=194.231.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.231.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=194.231.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.231.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
...
:if ([:len [/ip/route/find dst-address=77.67.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.67.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=85.189.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.189.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
