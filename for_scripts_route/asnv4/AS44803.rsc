...
:if ([:len [/ip/route/find dst-address=51.146.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.146.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.146.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.146.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.146.233.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.146.233.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.146.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.146.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.194.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.194.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.194.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.194.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.194.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.194.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.194.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.194.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.194.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.194.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.241.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.241.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.241.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.241.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.241.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.241.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
:if ([:len [/ip/route/find dst-address=51.241.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=51.241.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44803 }
