...
:if ([:len [/ip/route/find dst-address=5.227.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.227.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44895 }
:if ([:len [/ip/route/find dst-address=5.227.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.227.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44895 }
