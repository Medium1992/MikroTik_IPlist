...
:if ([:len [/ip/route/find dst-address=16.217.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=16.217.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
:if ([:len [/ip/route/find dst-address=16.5.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=16.5.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
...
:if ([:len [/ip/route/find dst-address=213.176.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.176.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
:if ([:len [/ip/route/find dst-address=213.176.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.176.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
:if ([:len [/ip/route/find dst-address=213.176.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.176.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
:if ([:len [/ip/route/find dst-address=40.27.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=40.27.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
...
:if ([:len [/ip/route/find dst-address=81.30.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.30.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
:if ([:len [/ip/route/find dst-address=91.195.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.195.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
