...
:if ([:len [/ip/route/find dst-address=185.93.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.93.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
...
:if ([:len [/ip/route/find dst-address=213.177.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.177.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
:if ([:len [/ip/route/find dst-address=5.63.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.63.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44947 }
