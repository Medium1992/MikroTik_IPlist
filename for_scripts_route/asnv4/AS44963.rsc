...
:if ([:len [/ip/route/find dst-address=93.90.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.90.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44963 }
:if ([:len [/ip/route/find dst-address=93.90.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.90.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44963 }
:if ([:len [/ip/route/find dst-address=93.90.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.90.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS44963 }
