...
:if ([:len [/ip/route/find dst-address=109.204.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.204.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45014 }
...
:if ([:len [/ip/route/find dst-address=84.246.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.246.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45014 }
...
:if ([:len [/ip/route/find dst-address=92.60.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45014 }
:if ([:len [/ip/route/find dst-address=92.60.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45014 }
