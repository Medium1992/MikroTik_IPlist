...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45037 and dst-address=for_scripts_route/asnv4/AS45037.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45037.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45037 }
