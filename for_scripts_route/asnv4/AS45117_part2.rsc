...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=202.8.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.8.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=202.89.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.89.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=220.158.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=220.158.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=223.255.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.255.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=27.54.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.54.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=36.255.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=36.255.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=36.255.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=36.255.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
...
:if ([:len [/ip/route/find dst-address=43.239.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.239.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=43.239.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.239.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
...
:if ([:len [/ip/route/find dst-address=43.254.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.254.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
:if ([:len [/ip/route/find dst-address=43.254.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.254.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45117 }
