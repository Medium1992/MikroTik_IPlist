...
:if ([:len [/ip/route/find dst-address=154.84.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45194 }
:if ([:len [/ip/route/find dst-address=154.84.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45194 }
...
:if ([:len [/ip/route/find dst-address=154.84.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45194 }
:if ([:len [/ip/route/find dst-address=154.84.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45194 }
...
:if ([:len [/ip/route/find dst-address=154.84.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45194 }
