...
:if ([:len [/ip/route/find dst-address=137.59.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.59.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45194 }
...
:if ([:len [/ip/route/find dst-address=154.84.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45194 }
