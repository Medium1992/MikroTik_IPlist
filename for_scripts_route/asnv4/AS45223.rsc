...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=180.128.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.128.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45223 }
...
:if ([:len [/ip/route/find dst-address=202.44.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.44.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45223 }
