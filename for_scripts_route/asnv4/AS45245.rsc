...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45245 and dst-address=for_scripts_route/asnv4/AS45245.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45245.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45245 }
