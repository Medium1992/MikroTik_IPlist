...
:if ([:len [/ip/route/find dst-address=117.121.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.121.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45248 }
...
:if ([:len [/ip/route/find dst-address=124.197.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.197.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45248 }
