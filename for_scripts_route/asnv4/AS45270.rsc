...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45270 and dst-address=for_scripts_route/asnv4/AS45270.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45270.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45270 }
