...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=27.97.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.97.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
...
:if ([:len [/ip/route/find dst-address=49.15.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
