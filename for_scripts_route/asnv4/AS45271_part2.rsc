...
:if ([:len [/ip/route/find dst-address=49.14.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.14.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
...
:if ([:len [/ip/route/find dst-address=49.15.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.218.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.218.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
:if ([:len [/ip/route/find dst-address=49.15.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.15.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45271 }
