...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45286 and dst-address=for_scripts_route/asnv4/AS45286.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45286.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45286 }
