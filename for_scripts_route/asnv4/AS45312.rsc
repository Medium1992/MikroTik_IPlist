...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.134.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.134.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45312 }
...
:if ([:len [/ip/route/find dst-address=103.152.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.152.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45312 }
