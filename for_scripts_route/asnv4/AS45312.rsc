...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45312 and dst-address=for_scripts_route/asnv4/AS45312.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45312.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45312 }
