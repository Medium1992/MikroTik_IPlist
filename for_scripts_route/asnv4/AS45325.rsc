...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.146.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.146.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45325 }
...
:if ([:len [/ip/route/find dst-address=122.248.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=122.248.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45325 }
...
:if ([:len [/ip/route/find dst-address=122.248.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=122.248.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45325 }
