...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45347 and dst-address=for_scripts_route/asnv4/AS45347.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45347.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45347 }
