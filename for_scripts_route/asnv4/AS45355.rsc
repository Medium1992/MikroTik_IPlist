...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45355 and dst-address=for_scripts_route/asnv4/AS45355.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45355.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45355 }
