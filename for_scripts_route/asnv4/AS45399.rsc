...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=110.15.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=110.15.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45399 }
...
:if ([:len [/ip/route/find dst-address=175.197.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.197.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45399 }
...
:if ([:len [/ip/route/find dst-address=210.105.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45399 }
:if ([:len [/ip/route/find dst-address=210.105.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45399 }
:if ([:len [/ip/route/find dst-address=210.105.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45399 }
:if ([:len [/ip/route/find dst-address=210.105.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45399 }
:if ([:len [/ip/route/find dst-address=210.105.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.105.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45399 }
