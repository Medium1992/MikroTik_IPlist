...
:if ([:len [/ip/route/find dst-address=103.243.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.243.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45447 }
:if ([:len [/ip/route/find dst-address=103.30.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.30.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45447 }
