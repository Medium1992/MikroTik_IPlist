...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4546 and dst-address=for_scripts_route/asnv4/AS4546.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4546.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4546 }
