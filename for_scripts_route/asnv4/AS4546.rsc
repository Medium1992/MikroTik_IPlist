...
:if ([:len [/ip/route/find dst-address=168.116.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.116.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4546 }
:if ([:len [/ip/route/find dst-address=168.116.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.116.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4546 }
