...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45460 and dst-address=for_scripts_route/asnv4/AS45460.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45460.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45460 }
