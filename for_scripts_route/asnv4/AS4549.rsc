...
:if ([:len [/ip/route/find dst-address=45.63.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.63.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4549 }
:if ([:len [/ip/route/find dst-address=45.63.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.63.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4549 }
