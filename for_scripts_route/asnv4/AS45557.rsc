...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45557 and dst-address=for_scripts_route/asnv4/AS45557.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45557.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45557 }
