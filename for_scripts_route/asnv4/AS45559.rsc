...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45559 and dst-address=for_scripts_route/asnv4/AS45559.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45559.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45559 }
