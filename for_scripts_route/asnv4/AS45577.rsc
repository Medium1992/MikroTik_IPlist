...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45577 and dst-address=for_scripts_route/asnv4/AS45577.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45577.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45577 }
