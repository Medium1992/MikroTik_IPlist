...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45641 and dst-address=for_scripts_route/asnv4/AS45641.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45641.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45641 }
