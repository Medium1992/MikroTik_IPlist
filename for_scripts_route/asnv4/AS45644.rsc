...
:if ([:len [/ip/route/find dst-address=103.68.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.68.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45644 }
...
:if ([:len [/ip/route/find dst-address=45.121.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.121.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45644 }
