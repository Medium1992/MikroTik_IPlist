...
:if ([:len [/ip/route/find dst-address=103.20.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.20.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45691 }
...
:if ([:len [/ip/route/find dst-address=155.103.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.103.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45691 }
...
:if ([:len [/ip/route/find dst-address=160.236.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.236.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45691 }
:if ([:len [/ip/route/find dst-address=160.25.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.25.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45691 }
...
:if ([:len [/ip/route/find dst-address=192.50.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.50.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45691 }
:if ([:len [/ip/route/find dst-address=193.56.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.56.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45691 }
