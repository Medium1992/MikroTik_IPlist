...
:if ([:len [/ip/route/find dst-address=179.65.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.65.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45700 }
:if ([:len [/ip/route/find dst-address=179.65.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.65.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45700 }
...
:if ([:len [/ip/route/find dst-address=179.65.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.65.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45700 }
