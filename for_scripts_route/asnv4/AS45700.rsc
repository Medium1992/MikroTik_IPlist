...
:if ([:len [/ip/route/find dst-address=203.17.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.17.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45700 }
:if ([:len [/ip/route/find dst-address=203.17.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.17.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45700 }
