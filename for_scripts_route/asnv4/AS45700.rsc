...
:if ([:len [/ip/route/find dst-address=179.65.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.65.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45700 }
...
:if ([:len [/ip/route/find dst-address=179.65.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.65.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45700 }
