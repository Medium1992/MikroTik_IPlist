...
:if ([:len [/ip/route/find dst-address=180.214.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.214.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45727 }
...
:if ([:len [/ip/route/find dst-address=223.255.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.255.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45727 }
