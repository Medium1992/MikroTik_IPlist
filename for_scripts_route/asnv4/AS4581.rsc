...
:if ([:len [/ip/route/find dst-address=38.255.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.255.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.255.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.255.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.255.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.255.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.255.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.255.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.255.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.255.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
