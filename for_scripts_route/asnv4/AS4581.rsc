...
:if ([:len [/ip/route/find dst-address=38.110.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.110.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.110.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.110.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.2.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.2.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.2.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.2.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
...
:if ([:len [/ip/route/find dst-address=38.255.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.255.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.45.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.45.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
:if ([:len [/ip/route/find dst-address=38.69.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.69.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4581 }
