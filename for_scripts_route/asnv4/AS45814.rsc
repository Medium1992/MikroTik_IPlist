...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.104.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.104.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45814 }
:if ([:len [/ip/route/find dst-address=103.48.24.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.48.24.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45814 }
