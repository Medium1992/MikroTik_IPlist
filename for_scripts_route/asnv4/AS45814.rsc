...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.20.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.20.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45814 }
:if ([:len [/ip/route/find dst-address=111.92.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.92.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45814 }
...
:if ([:len [/ip/route/find dst-address=14.192.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45814 }
:if ([:len [/ip/route/find dst-address=14.192.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=14.192.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45814 }
