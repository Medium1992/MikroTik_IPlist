...
:if ([:len [/ip/route/find dst-address=103.54.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.54.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45815 }
...
:if ([:len [/ip/route/find dst-address=157.119.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.119.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45815 }
...
:if ([:len [/ip/route/find dst-address=5.175.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45815 }
:if ([:len [/ip/route/find dst-address=89.106.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.106.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45815 }
