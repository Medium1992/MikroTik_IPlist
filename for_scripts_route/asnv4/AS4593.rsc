...
:if ([:len [/ip/route/find dst-address=141.11.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.11.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4593 }
...
:if ([:len [/ip/route/find dst-address=178.214.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.214.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4593 }
...
:if ([:len [/ip/route/find dst-address=194.242.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.242.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4593 }
...
:if ([:len [/ip/route/find dst-address=2.26.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.26.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4593 }
...
:if ([:len [/ip/route/find dst-address=212.180.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.180.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4593 }
...
:if ([:len [/ip/route/find dst-address=87.85.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.85.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4593 }
