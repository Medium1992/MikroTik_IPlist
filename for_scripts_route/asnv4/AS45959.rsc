...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45959 and dst-address=for_scripts_route/asnv4/AS45959.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45959.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45959 }
