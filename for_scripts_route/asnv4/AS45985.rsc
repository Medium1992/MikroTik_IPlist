...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45985 and dst-address=for_scripts_route/asnv4/AS45985.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45985.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45985 }
