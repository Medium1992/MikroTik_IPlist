...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS45990 and dst-address=for_scripts_route/asnv4/AS45990.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS45990.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS45990 }
