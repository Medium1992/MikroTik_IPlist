...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46023 and dst-address=for_scripts_route/asnv4/AS46023.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46023.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46023 }
