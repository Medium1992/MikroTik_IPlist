...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=116.212.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.212.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46030 }
:if ([:len [/ip/route/find dst-address=116.212.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.212.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46030 }
