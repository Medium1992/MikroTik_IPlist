...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4608 and dst-address=for_scripts_route/asnv4/AS4608.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4608.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4608 }
