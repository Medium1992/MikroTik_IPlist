...
:if ([:len [/ip/route/find dst-address=159.26.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.26.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46082 }
:if ([:len [/ip/route/find dst-address=159.26.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.26.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46082 }
:if ([:len [/ip/route/find dst-address=159.26.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.26.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46082 }
