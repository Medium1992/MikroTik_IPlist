...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46090 and dst-address=for_scripts_route/asnv4/AS46090.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46090.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46090 }
