...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46188 and dst-address=for_scripts_route/asnv4/AS46188.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46188.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46188 }
