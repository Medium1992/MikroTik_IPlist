...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46215 and dst-address=for_scripts_route/asnv4/AS46215.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46215.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46215 }
