...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46246 and dst-address=for_scripts_route/asnv4/AS46246.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46246.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46246 }
