...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46259 and dst-address=for_scripts_route/asnv4/AS46259.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46259.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46259 }
