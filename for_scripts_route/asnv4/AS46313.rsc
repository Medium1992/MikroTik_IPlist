...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=156.89.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.89.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46313 }
...
:if ([:len [/ip/route/find dst-address=161.165.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.165.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46313 }
...
:if ([:len [/ip/route/find dst-address=161.170.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.170.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46313 }
...
:if ([:len [/ip/route/find dst-address=161.170.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.170.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46313 }
