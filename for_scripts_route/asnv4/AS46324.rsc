...
:if ([:len [/ip/route/find dst-address=64.49.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.49.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46324 }
:if ([:len [/ip/route/find dst-address=74.122.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.122.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46324 }
:if ([:len [/ip/route/find dst-address=74.122.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.122.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46324 }
