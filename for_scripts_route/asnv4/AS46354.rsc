...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46354 and dst-address=for_scripts_route/asnv4/AS46354.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46354.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46354 }
