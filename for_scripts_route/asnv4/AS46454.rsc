...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.201.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.201.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46454 }
...
:if ([:len [/ip/route/find dst-address=66.218.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.218.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46454 }
:if ([:len [/ip/route/find dst-address=66.218.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.218.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46454 }
...
:if ([:len [/ip/route/find dst-address=68.64.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.64.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46454 }
