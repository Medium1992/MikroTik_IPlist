...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46461 and dst-address=for_scripts_route/asnv4/AS46461.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46461.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46461 }
