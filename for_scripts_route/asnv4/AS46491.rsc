...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46491 and dst-address=for_scripts_route/asnv4/AS46491.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46491.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46491 }
