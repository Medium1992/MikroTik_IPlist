...
:if ([:len [/ip/route/find dst-address=199.101.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.101.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46506 }
...
:if ([:len [/ip/route/find dst-address=67.58.77.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.58.77.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46506 }
:if ([:len [/ip/route/find dst-address=67.58.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.58.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46506 }
...
:if ([:len [/ip/route/find dst-address=74.51.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.51.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46506 }
