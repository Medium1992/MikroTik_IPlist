...
:if ([:len [/ip/route/find dst-address=156.45.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.45.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46513 }
:if ([:len [/ip/route/find dst-address=156.45.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.45.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46513 }
:if ([:len [/ip/route/find dst-address=156.45.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.45.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46513 }
:if ([:len [/ip/route/find dst-address=156.45.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.45.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46513 }
