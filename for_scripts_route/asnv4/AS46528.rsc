...
:if ([:len [/ip/route/find dst-address=151.113.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.113.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46528 }
:if ([:len [/ip/route/find dst-address=151.113.207.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.113.207.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46528 }
:if ([:len [/ip/route/find dst-address=151.113.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.113.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46528 }
