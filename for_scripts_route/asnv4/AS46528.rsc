...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46528 and dst-address=for_scripts_route/asnv4/AS46528.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46528.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46528 }
