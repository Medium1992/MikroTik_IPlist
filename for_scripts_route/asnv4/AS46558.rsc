...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46558 and dst-address=for_scripts_route/asnv4/AS46558.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46558.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46558 }
