...
:if ([:len [/ip/route/find dst-address=23.228.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.228.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46573 }
:if ([:len [/ip/route/find dst-address=23.228.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.228.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46573 }
:if ([:len [/ip/route/find dst-address=23.228.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.228.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46573 }
...
:if ([:len [/ip/route/find dst-address=23.228.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.228.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46573 }
