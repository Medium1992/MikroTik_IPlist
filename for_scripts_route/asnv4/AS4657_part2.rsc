...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=203.117.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.117.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4657 }
:if ([:len [/ip/route/find dst-address=203.117.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.117.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4657 }
:if ([:len [/ip/route/find dst-address=203.117.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.117.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4657 }
:if ([:len [/ip/route/find dst-address=203.117.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.117.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4657 }
:if ([:len [/ip/route/find dst-address=203.117.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.117.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4657 }
:if ([:len [/ip/route/find dst-address=203.117.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.117.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4657 }
