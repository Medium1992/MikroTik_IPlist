...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=192.33.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.33.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46634 }
...
:if ([:len [/ip/route/find dst-address=216.25.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.25.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46634 }
