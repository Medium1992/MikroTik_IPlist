...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=32.223.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.48.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.48.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.48.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.48.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.48.160/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.48.160/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.48.176/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.48.176/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.48.184/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.48.184/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.48.189/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.48.189/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
:if ([:len [/ip/route/find dst-address=32.223.48.190/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=32.223.48.190/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46690 }
