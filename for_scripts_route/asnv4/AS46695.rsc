...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46695 and dst-address=for_scripts_route/asnv4/AS46695.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46695.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46695 }
