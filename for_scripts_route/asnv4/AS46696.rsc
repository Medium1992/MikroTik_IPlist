...
:if ([:len [/ip/route/find dst-address=192.31.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.31.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46696 }
...
:if ([:len [/ip/route/find dst-address=23.137.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.137.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46696 }
