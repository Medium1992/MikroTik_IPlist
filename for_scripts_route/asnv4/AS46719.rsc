...
:if ([:len [/ip/route/find dst-address=204.154.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.154.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46719 }
