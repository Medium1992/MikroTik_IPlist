...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46754 and dst-address=for_scripts_route/asnv4/AS46754.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46754.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46754 }
