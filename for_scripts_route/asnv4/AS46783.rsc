...
:if ([:len [/ip/route/find dst-address=199.245.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.245.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
...
:if ([:len [/ip/route/find dst-address=38.114.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.114.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
:if ([:len [/ip/route/find dst-address=38.123.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.123.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
...
:if ([:len [/ip/route/find dst-address=38.20.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.20.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
...
:if ([:len [/ip/route/find dst-address=38.45.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.45.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
...
:if ([:len [/ip/route/find dst-address=38.64.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.64.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
