...
:if ([:len [/ip/route/find dst-address=38.57.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.57.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
...
:if ([:len [/ip/route/find dst-address=38.65.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.65.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
:if ([:len [/ip/route/find dst-address=38.65.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.65.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
...
:if ([:len [/ip/route/find dst-address=50.118.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=50.118.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46783 }
