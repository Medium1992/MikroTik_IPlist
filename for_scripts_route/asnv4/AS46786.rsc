...
:if ([:len [/ip/route/find dst-address=204.26.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.26.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46786 }
:if ([:len [/ip/route/find dst-address=204.26.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.26.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46786 }
