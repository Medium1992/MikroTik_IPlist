...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46796 and dst-address=for_scripts_route/asnv4/AS46796.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46796.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46796 }
