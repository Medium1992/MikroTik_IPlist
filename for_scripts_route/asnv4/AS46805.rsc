...
:if ([:len [/ip/route/find dst-address=196.243.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.243.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46805 }
...
:if ([:len [/ip/route/find dst-address=196.58.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.58.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46805 }
