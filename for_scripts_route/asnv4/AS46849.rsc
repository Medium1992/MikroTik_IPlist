...
:if ([:len [/ip/route/find dst-address=172.98.250.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.98.250.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46849 }
