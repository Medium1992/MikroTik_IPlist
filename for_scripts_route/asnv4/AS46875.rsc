...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46875 and dst-address=for_scripts_route/asnv4/AS46875.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46875.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46875 }
