...
:if ([:len [/ip/route/find dst-address=38.159.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46957 }
:if ([:len [/ip/route/find dst-address=38.34.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.34.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46957 }
