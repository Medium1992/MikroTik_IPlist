...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS46957 and dst-address=for_scripts_route/asnv4/AS46957.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS46957.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS46957 }
