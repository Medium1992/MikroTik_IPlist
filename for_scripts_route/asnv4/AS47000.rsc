...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47000 and dst-address=for_scripts_route/asnv4/AS47000.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47000.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47000 }
