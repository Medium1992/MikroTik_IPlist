...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47015 and dst-address=for_scripts_route/asnv4/AS47015.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47015.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47015 }
