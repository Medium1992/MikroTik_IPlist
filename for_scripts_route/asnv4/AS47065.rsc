...
:if ([:len [/ip/route/find dst-address=184.164.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=184.164.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47065 }
...
:if ([:len [/ip/route/find dst-address=184.164.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=184.164.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47065 }
