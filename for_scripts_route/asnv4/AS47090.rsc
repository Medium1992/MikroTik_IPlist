...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47090 and dst-address=for_scripts_route/asnv4/AS47090.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47090.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47090 }
