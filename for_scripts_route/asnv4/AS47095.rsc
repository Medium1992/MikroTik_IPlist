...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47095 and dst-address=for_scripts_route/asnv4/AS47095.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47095.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47095 }
