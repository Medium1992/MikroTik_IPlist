...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4711 and dst-address=for_scripts_route/asnv4/AS4711.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4711.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4711 }
