...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47111 and dst-address=for_scripts_route/asnv4/AS47111.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47111.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47111 }
