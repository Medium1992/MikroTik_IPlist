...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47116 and dst-address=for_scripts_route/asnv4/AS47116.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47116.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47116 }
