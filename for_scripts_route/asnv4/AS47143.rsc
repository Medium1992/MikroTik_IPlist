...
:if ([:len [/ip/route/find dst-address=178.214.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.214.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47143 }
...
:if ([:len [/ip/route/find dst-address=91.205.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.205.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47143 }
:if ([:len [/ip/route/find dst-address=91.205.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.205.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47143 }
