...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47156 and dst-address=for_scripts_route/asnv4/AS47156.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47156.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47156 }
