...
:if ([:len [/ip/route/find dst-address=45.112.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.112.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47160 }
...
:if ([:len [/ip/route/find dst-address=81.201.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.201.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47160 }
