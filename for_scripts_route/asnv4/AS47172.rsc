...
:if ([:len [/ip/route/find dst-address=82.163.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.163.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47172 }
...
:if ([:len [/ip/route/find dst-address=87.76.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.76.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47172 }
