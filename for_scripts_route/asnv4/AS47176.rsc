...
:if ([:len [/ip/route/find dst-address=185.213.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.213.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47176 }
:if ([:len [/ip/route/find dst-address=185.238.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.238.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47176 }
:if ([:len [/ip/route/find dst-address=185.238.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.238.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47176 }
