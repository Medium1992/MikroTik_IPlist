...
:if ([:len [/ip/route/find dst-address=212.103.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.103.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47217 }
...
:if ([:len [/ip/route/find dst-address=5.100.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.100.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47217 }
...
:if ([:len [/ip/route/find dst-address=94.142.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.142.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47217 }
