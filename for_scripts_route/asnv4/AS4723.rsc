...
:if ([:len [/ip/route/find dst-address=210.189.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.189.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4723 }
:if ([:len [/ip/route/find dst-address=210.189.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.189.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4723 }
:if ([:len [/ip/route/find dst-address=210.189.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.189.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4723 }
:if ([:len [/ip/route/find dst-address=210.189.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.189.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4723 }
