...
:if ([:len [/ip/route/find dst-address=194.58.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.58.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47253 }
...
:if ([:len [/ip/route/find dst-address=194.58.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.58.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47253 }
:if ([:len [/ip/route/find dst-address=194.58.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.58.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47253 }
...
:if ([:len [/ip/route/find dst-address=46.18.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.18.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47253 }
