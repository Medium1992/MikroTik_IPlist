...
:if ([:len [/ip/route/find dst-address=212.99.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.99.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47309 }
:if ([:len [/ip/route/find dst-address=212.99.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.99.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47309 }
:if ([:len [/ip/route/find dst-address=212.99.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.99.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47309 }
