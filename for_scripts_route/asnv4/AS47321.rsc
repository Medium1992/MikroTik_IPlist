...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47321 and dst-address=for_scripts_route/asnv4/AS47321.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47321.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47321 }
