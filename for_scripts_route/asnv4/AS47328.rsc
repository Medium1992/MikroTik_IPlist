...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.58.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.58.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47328 }
...
:if ([:len [/ip/route/find dst-address=72.56.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.56.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47328 }
