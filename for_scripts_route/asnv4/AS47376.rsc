...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.215.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.215.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47376 }
...
:if ([:len [/ip/route/find dst-address=185.187.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.187.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47376 }
...
:if ([:len [/ip/route/find dst-address=195.234.191.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.234.191.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47376 }
...
:if ([:len [/ip/route/find dst-address=195.238.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.238.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47376 }
...
:if ([:len [/ip/route/find dst-address=85.8.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.8.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47376 }
