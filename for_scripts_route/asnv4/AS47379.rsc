...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47379 and dst-address=for_scripts_route/asnv4/AS47379.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47379.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47379 }
