...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47381 and dst-address=for_scripts_route/asnv4/AS47381.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47381.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47381 }
