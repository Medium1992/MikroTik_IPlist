...
:if ([:len [/ip/route/find dst-address=210.246.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.246.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4741 }
:if ([:len [/ip/route/find dst-address=210.246.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.246.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4741 }
:if ([:len [/ip/route/find dst-address=210.246.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.246.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4741 }
:if ([:len [/ip/route/find dst-address=210.246.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.246.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4741 }
...
:if ([:len [/ip/route/find dst-address=210.246.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.246.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4741 }
...
:if ([:len [/ip/route/find dst-address=210.246.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.246.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4741 }
