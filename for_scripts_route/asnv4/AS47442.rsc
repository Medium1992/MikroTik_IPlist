...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47442 and dst-address=for_scripts_route/asnv4/AS47442.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47442.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47442 }
