...
:if ([:len [/ip/route/find dst-address=94.54.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.54.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.54.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
