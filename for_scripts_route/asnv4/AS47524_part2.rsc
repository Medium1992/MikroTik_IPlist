...
:if ([:len [/ip/route/find dst-address=94.54.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
...
:if ([:len [/ip/route/find dst-address=94.54.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.54.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.54.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
...
:if ([:len [/ip/route/find dst-address=94.55.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
