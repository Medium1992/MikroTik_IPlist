...
:if ([:len [/ip/route/find dst-address=46.197.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.197.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
...
:if ([:len [/ip/route/find dst-address=94.54.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.54.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
...
:if ([:len [/ip/route/find dst-address=94.54.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.54.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.54.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
...
:if ([:len [/ip/route/find dst-address=94.55.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.55.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.55.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.55.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.55.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.55.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.55.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
:if ([:len [/ip/route/find dst-address=94.55.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.55.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47524 }
