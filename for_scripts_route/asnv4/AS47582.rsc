...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47582 and dst-address=for_scripts_route/asnv4/AS47582.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47582.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47582 }
