...
:if ([:len [/ip/route/find dst-address=62.150.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.150.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47589 }
...
:if ([:len [/ip/route/find dst-address=62.150.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.150.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47589 }
:if ([:len [/ip/route/find dst-address=62.150.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.150.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47589 }
:if ([:len [/ip/route/find dst-address=62.150.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.150.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47589 }
