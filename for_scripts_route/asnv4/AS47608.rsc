...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47608 and dst-address=for_scripts_route/asnv4/AS47608.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47608.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47608 }
