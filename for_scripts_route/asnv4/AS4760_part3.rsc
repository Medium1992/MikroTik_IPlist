...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=42.3.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.3.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4760 }
...
:if ([:len [/ip/route/find dst-address=45.192.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.192.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4760 }
:if ([:len [/ip/route/find dst-address=45.192.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.192.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4760 }
:if ([:len [/ip/route/find dst-address=45.192.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.192.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4760 }
:if ([:len [/ip/route/find dst-address=45.202.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.202.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4760 }
