...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=42.200.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=42.200.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4760 }
...
:if ([:len [/ip/route/find dst-address=45.192.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.192.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4760 }
