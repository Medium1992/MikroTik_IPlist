...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47689 and dst-address=for_scripts_route/asnv4/AS47689.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47689.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47689 }
