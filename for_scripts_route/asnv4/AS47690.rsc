...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.101.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.101.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
:if ([:len [/ip/route/find dst-address=104.222.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.222.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
...
:if ([:len [/ip/route/find dst-address=143.20.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
:if ([:len [/ip/route/find dst-address=143.20.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
:if ([:len [/ip/route/find dst-address=143.20.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
:if ([:len [/ip/route/find dst-address=143.20.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
:if ([:len [/ip/route/find dst-address=143.20.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.20.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
...
:if ([:len [/ip/route/find dst-address=151.246.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.246.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
...
:if ([:len [/ip/route/find dst-address=151.246.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.246.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
:if ([:len [/ip/route/find dst-address=151.246.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.246.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
...
:if ([:len [/ip/route/find dst-address=45.43.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.43.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47690 }
