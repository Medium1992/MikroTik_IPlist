...
:if ([:len [/ip/route/find dst-address=194.8.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.8.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47696 }
:if ([:len [/ip/route/find dst-address=194.8.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.8.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47696 }
:if ([:len [/ip/route/find dst-address=194.8.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.8.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47696 }
...
:if ([:len [/ip/route/find dst-address=194.8.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.8.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47696 }
