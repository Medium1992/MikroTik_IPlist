...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47747 and dst-address=for_scripts_route/asnv4/AS47747.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47747.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47747 }
