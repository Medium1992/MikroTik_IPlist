...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47753 and dst-address=for_scripts_route/asnv4/AS47753.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47753.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47753 }
