...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47782 and dst-address=for_scripts_route/asnv4/AS47782.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47782.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47782 }
