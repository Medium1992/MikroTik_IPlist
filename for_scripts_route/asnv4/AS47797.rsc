...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47797 and dst-address=for_scripts_route/asnv4/AS47797.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47797.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47797 }
