...
:if ([:len [/ip/route/find dst-address=79.132.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.132.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47817 }
