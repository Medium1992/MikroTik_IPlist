...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47833 and dst-address=for_scripts_route/asnv4/AS47833.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47833.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47833 }
