...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47862 and dst-address=for_scripts_route/asnv4/AS47862.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47862.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47862 }
