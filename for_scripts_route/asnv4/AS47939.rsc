...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47939 and dst-address=for_scripts_route/asnv4/AS47939.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47939.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47939 }
