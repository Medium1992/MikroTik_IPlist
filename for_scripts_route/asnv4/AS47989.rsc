...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS47989 and dst-address=for_scripts_route/asnv4/AS47989.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS47989.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS47989 }
