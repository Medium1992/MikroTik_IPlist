...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48008 and dst-address=for_scripts_route/asnv4/AS48008.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48008.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48008 }
