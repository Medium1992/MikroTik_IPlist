...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48057 and dst-address=for_scripts_route/asnv4/AS48057.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48057.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48057 }
