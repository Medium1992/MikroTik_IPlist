...
:if ([:len [/ip/route/find dst-address=46.213.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.213.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
:if ([:len [/ip/route/find dst-address=46.213.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.213.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
...
:if ([:len [/ip/route/find dst-address=46.213.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.213.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
...
:if ([:len [/ip/route/find dst-address=46.213.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.213.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
...
:if ([:len [/ip/route/find dst-address=94.252.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.252.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
:if ([:len [/ip/route/find dst-address=94.252.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.252.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
