...
:if ([:len [/ip/route/find dst-address=46.213.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.213.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
:if ([:len [/ip/route/find dst-address=46.213.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.213.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
...
:if ([:len [/ip/route/find dst-address=46.213.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.213.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48065 }
