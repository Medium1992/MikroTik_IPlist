...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48082 and dst-address=for_scripts_route/asnv4/AS48082.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48082.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48082 }
