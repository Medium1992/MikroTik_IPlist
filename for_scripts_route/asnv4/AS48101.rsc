...
:if ([:len [/ip/route/find dst-address=146.103.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=146.103.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48101 }
...
:if ([:len [/ip/route/find dst-address=81.85.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.85.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48101 }
