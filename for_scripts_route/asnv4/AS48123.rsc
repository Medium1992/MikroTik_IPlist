...
:if ([:len [/ip/route/find dst-address=81.195.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.195.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48123 }
...
:if ([:len [/ip/route/find dst-address=94.243.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.243.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48123 }
:if ([:len [/ip/route/find dst-address=94.243.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.243.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48123 }
