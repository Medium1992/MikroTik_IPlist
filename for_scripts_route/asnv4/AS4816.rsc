...
:if ([:len [/ip/route/find dst-address=103.216.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.216.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
...
:if ([:len [/ip/route/find dst-address=160.250.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.250.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
...
:if ([:len [/ip/route/find dst-address=211.161.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.161.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
:if ([:len [/ip/route/find dst-address=211.161.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.161.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
:if ([:len [/ip/route/find dst-address=211.161.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.161.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
:if ([:len [/ip/route/find dst-address=211.161.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.161.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
