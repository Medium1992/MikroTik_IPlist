...
:if ([:len [/ip/route/find dst-address=211.161.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.161.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
...
:if ([:len [/ip/route/find dst-address=45.250.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.250.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
:if ([:len [/ip/route/find dst-address=45.250.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.250.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4816 }
