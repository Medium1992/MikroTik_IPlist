...
:if ([:len [/ip/route/find dst-address=87.120.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.120.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48181 }
:if ([:len [/ip/route/find dst-address=91.92.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.92.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48181 }
