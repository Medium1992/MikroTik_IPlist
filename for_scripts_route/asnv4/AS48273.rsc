...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.237.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.237.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48273 }
...
:if ([:len [/ip/route/find dst-address=80.73.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.73.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48273 }
...
:if ([:len [/ip/route/find dst-address=94.198.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.198.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48273 }
