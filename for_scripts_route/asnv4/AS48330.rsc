...
:if ([:len [/ip/route/find dst-address=178.159.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.159.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
...
:if ([:len [/ip/route/find dst-address=78.158.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.158.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=78.158.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.158.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=78.158.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.158.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
