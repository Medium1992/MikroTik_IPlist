...
:if ([:len [/ip/route/find dst-address=178.159.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.159.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
...
:if ([:len [/ip/route/find dst-address=46.172.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
...
:if ([:len [/ip/route/find dst-address=46.172.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
