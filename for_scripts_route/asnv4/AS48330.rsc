...
:if ([:len [/ip/route/find dst-address=46.172.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
:if ([:len [/ip/route/find dst-address=46.172.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.172.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
...
:if ([:len [/ip/route/find dst-address=78.158.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.158.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48330 }
