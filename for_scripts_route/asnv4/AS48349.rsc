...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48349 and dst-address=for_scripts_route/asnv4/AS48349.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48349.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48349 }
