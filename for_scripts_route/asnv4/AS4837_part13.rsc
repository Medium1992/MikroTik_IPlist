...
:if ([:len [/ip/route/find dst-address=61.243.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
:if ([:len [/ip/route/find dst-address=61.243.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
:if ([:len [/ip/route/find dst-address=61.243.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
:if ([:len [/ip/route/find dst-address=61.243.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
:if ([:len [/ip/route/find dst-address=61.243.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
:if ([:len [/ip/route/find dst-address=61.243.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
:if ([:len [/ip/route/find dst-address=61.243.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
:if ([:len [/ip/route/find dst-address=61.243.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.243.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4837 }
