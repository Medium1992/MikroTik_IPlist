...
:if ([:len [/ip/route/find dst-address=81.90.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.90.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48407 }
:if ([:len [/ip/route/find dst-address=81.90.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.90.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48407 }
...
:if ([:len [/ip/route/find dst-address=93.94.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.94.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48407 }
