...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48430 and dst-address=for_scripts_route/asnv4/AS48430.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48430.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48430 }
