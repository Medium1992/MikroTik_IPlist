...
:if ([:len [/ip/route/find dst-address=78.41.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.41.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48434 }
:if ([:len [/ip/route/find dst-address=94.184.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48434 }
