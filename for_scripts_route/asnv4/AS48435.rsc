...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48435 and dst-address=for_scripts_route/asnv4/AS48435.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48435.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48435 }
