...
:if ([:len [/ip/route/find dst-address=94.26.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48452 }
...
:if ([:len [/ip/route/find dst-address=94.26.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48452 }
...
:if ([:len [/ip/route/find dst-address=94.26.33.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.33.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48452 }
:if ([:len [/ip/route/find dst-address=94.26.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48452 }
...
:if ([:len [/ip/route/find dst-address=94.26.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48452 }
:if ([:len [/ip/route/find dst-address=94.26.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.26.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48452 }
