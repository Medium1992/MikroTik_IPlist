...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48507 and dst-address=for_scripts_route/asnv4/AS48507.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48507.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48507 }
