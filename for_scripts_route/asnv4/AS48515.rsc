...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48515 and dst-address=for_scripts_route/asnv4/AS48515.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48515.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48515 }
