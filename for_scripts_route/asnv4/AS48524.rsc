...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48524 and dst-address=for_scripts_route/asnv4/AS48524.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48524.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48524 }
