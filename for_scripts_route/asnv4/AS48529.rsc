...
:if ([:len [/ip/route/find dst-address=217.60.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48529 }
:if ([:len [/ip/route/find dst-address=217.60.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48529 }
