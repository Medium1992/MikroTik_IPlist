...
:if ([:len [/ip/route/find dst-address=185.236.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.236.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48551 }
:if ([:len [/ip/route/find dst-address=185.236.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.236.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48551 }
...
:if ([:len [/ip/route/find dst-address=45.159.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.159.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48551 }
:if ([:len [/ip/route/find dst-address=45.159.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.159.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48551 }
