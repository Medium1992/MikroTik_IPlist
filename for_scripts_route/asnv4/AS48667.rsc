...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48667 and dst-address=for_scripts_route/asnv4/AS48667.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48667.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48667 }
