...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.17.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.17.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
:if ([:len [/ip/route/find dst-address=103.17.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.17.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
...
:if ([:len [/ip/route/find dst-address=103.23.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.23.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
...
:if ([:len [/ip/route/find dst-address=37.186.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.186.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
:if ([:len [/ip/route/find dst-address=37.186.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.186.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
