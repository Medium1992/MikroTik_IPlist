...
:if ([:len [/ip/route/find dst-address=103.23.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.23.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
...
:if ([:len [/ip/route/find dst-address=212.70.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.70.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
...
:if ([:len [/ip/route/find dst-address=80.76.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.76.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48728 }
