...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.162.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.162.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48763 }
...
:if ([:len [/ip/route/find dst-address=193.8.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.8.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48763 }
...
:if ([:len [/ip/route/find dst-address=82.114.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.114.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48763 }
:if ([:len [/ip/route/find dst-address=82.114.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.114.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48763 }
