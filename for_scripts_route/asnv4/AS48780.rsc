...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48780 and dst-address=for_scripts_route/asnv4/AS48780.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48780.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48780 }
