...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.28.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.28.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48832 }
:if ([:len [/ip/route/find dst-address=176.28.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.28.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48832 }
:if ([:len [/ip/route/find dst-address=176.28.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.28.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48832 }
:if ([:len [/ip/route/find dst-address=176.28.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.28.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48832 }
:if ([:len [/ip/route/find dst-address=176.28.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.28.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48832 }
:if ([:len [/ip/route/find dst-address=176.28.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.28.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48832 }
:if ([:len [/ip/route/find dst-address=176.28.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.28.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48832 }
