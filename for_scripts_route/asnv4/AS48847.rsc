...
:if ([:len [/ip/route/find dst-address=185.83.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.83.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48847 }
...
:if ([:len [/ip/route/find dst-address=38.77.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.77.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48847 }
