...
:if ([:len [/ip/route/find dst-address=185.104.32.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.104.32.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48881 }
...
:if ([:len [/ip/route/find dst-address=80.97.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.97.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48881 }
