...
:if ([:len [/ip/route/find dst-address=217.146.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.146.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48885 }
:if ([:len [/ip/route/find dst-address=217.146.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.146.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48885 }
:if ([:len [/ip/route/find dst-address=217.146.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.146.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48885 }
:if ([:len [/ip/route/find dst-address=217.146.55.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.146.55.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48885 }
