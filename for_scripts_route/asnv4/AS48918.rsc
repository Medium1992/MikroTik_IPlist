...
:if ([:len [/ip/route/find dst-address=80.66.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.66.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48918 }
...
:if ([:len [/ip/route/find dst-address=80.66.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.66.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48918 }
:if ([:len [/ip/route/find dst-address=80.66.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.66.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48918 }
