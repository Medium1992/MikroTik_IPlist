...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.50.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.50.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48942 }
:if ([:len [/ip/route/find dst-address=192.165.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.165.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48942 }
:if ([:len [/ip/route/find dst-address=193.234.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.234.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48942 }
