...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS48964 and dst-address=for_scripts_route/asnv4/AS48964.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS48964.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48964 }
