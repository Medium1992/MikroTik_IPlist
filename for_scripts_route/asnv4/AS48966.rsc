...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.88.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.88.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48966 }
...
:if ([:len [/ip/route/find dst-address=95.130.91.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.130.91.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS48966 }
