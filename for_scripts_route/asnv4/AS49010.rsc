...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49010 and dst-address=for_scripts_route/asnv4/AS49010.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49010.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49010 }
