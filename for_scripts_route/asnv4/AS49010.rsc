...
:if ([:len [/ip/route/find dst-address=151.216.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.216.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49010 }
...
:if ([:len [/ip/route/find dst-address=193.162.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.162.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49010 }
