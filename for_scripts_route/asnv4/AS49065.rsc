...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49065 and dst-address=for_scripts_route/asnv4/AS49065.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49065.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49065 }
