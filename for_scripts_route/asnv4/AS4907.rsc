...
:if ([:len [/ip/route/find dst-address=186.240.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
