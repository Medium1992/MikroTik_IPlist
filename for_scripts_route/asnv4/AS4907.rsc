...
:if ([:len [/ip/route/find dst-address=186.240.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.248.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.248.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
