...
:if ([:len [/ip/route/find dst-address=163.52.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.52.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.252.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.252.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
:if ([:len [/ip/route/find dst-address=186.240.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.240.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4907 }
