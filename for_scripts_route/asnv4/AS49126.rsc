...
:if ([:len [/ip/route/find dst-address=185.95.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.95.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49126 }
:if ([:len [/ip/route/find dst-address=185.95.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.95.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49126 }
:if ([:len [/ip/route/find dst-address=94.102.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.102.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49126 }
