...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49154 and dst-address=for_scripts_route/asnv4/AS49154.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49154.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49154 }
