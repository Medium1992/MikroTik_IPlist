...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4917 and dst-address=for_scripts_route/asnv4/AS4917.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4917.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4917 }
