...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49188 and dst-address=for_scripts_route/asnv4/AS49188.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49188.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49188 }
