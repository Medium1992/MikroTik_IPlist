...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49250 and dst-address=for_scripts_route/asnv4/AS49250.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49250.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49250 }
