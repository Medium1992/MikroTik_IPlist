...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS4926 and dst-address=for_scripts_route/asnv4/AS4926.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS4926.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4926 }
