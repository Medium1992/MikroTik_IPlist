...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49273 and dst-address=for_scripts_route/asnv4/AS49273.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49273.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49273 }
