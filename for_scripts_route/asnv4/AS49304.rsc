...
:if ([:len [/ip/route/find dst-address=46.232.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.232.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49304 }
:if ([:len [/ip/route/find dst-address=46.232.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.232.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49304 }
:if ([:len [/ip/route/find dst-address=46.232.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.232.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49304 }
