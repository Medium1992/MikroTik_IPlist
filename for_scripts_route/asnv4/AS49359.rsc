...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49359 and dst-address=for_scripts_route/asnv4/AS49359.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49359.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49359 }
