...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49375 and dst-address=for_scripts_route/asnv4/AS49375.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49375.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49375 }
