...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=193.164.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.164.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49408 }
:if ([:len [/ip/route/find dst-address=193.164.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.164.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49408 }
