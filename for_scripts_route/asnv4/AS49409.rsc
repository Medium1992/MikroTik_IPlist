...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49409 and dst-address=for_scripts_route/asnv4/AS49409.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49409.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49409 }
