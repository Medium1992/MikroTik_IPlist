...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49420 and dst-address=for_scripts_route/asnv4/AS49420.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49420.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49420 }
