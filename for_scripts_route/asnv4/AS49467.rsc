...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=37.152.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.152.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49467 }
...
:if ([:len [/ip/route/find dst-address=85.95.247.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.95.247.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49467 }
