...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=95.213.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
:if ([:len [/ip/route/find dst-address=95.213.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
:if ([:len [/ip/route/find dst-address=95.213.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
:if ([:len [/ip/route/find dst-address=95.213.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
:if ([:len [/ip/route/find dst-address=95.213.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
:if ([:len [/ip/route/find dst-address=95.213.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
:if ([:len [/ip/route/find dst-address=95.213.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
:if ([:len [/ip/route/find dst-address=95.213.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.213.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49505 }
