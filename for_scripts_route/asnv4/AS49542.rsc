...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49542 and dst-address=for_scripts_route/asnv4/AS49542.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49542.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49542 }
