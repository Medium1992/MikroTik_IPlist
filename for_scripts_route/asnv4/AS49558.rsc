...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49558 and dst-address=for_scripts_route/asnv4/AS49558.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49558.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49558 }
