...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49566 and dst-address=for_scripts_route/asnv4/AS49566.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49566.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49566 }
