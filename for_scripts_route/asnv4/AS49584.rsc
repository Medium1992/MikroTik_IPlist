...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49584 and dst-address=for_scripts_route/asnv4/AS49584.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49584.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49584 }
