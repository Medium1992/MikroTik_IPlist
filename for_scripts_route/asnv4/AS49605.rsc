...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49605 and dst-address=for_scripts_route/asnv4/AS49605.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49605.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49605 }
