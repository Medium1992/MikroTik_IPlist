...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49645 and dst-address=for_scripts_route/asnv4/AS49645.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49645.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49645 }
