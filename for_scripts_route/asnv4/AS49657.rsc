...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49657 and dst-address=for_scripts_route/asnv4/AS49657.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49657.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49657 }
