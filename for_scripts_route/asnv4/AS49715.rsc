...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49715 and dst-address=for_scripts_route/asnv4/AS49715.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49715.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49715 }
