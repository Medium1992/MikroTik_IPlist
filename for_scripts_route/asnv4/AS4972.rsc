...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=156.134.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.134.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4972 }
:if ([:len [/ip/route/find dst-address=156.134.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.134.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS4972 }
