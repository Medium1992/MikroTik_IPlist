...
:if ([:len [/ip/route/find dst-address=185.32.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.32.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49775 }
:if ([:len [/ip/route/find dst-address=185.32.54.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.32.54.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49775 }
