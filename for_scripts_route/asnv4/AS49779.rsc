...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49779 and dst-address=for_scripts_route/asnv4/AS49779.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49779.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49779 }
