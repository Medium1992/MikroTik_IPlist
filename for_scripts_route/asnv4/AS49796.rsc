...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49796 and dst-address=for_scripts_route/asnv4/AS49796.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49796.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49796 }
