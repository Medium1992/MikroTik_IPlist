...
:if ([:len [/ip/route/find dst-address=37.186.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.186.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49800 }
:if ([:len [/ip/route/find dst-address=37.186.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.186.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49800 }
:if ([:len [/ip/route/find dst-address=37.186.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.186.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49800 }
