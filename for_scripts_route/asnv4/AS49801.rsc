...
:if ([:len [/ip/route/find dst-address=194.34.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.34.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49801 }
:if ([:len [/ip/route/find dst-address=46.245.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.245.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49801 }
