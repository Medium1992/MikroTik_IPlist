...
:if ([:len [/ip/route/find dst-address=45.140.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.140.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49870 }
:if ([:len [/ip/route/find dst-address=45.80.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.80.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49870 }
