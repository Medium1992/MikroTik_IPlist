...
:if ([:len [/ip/route/find dst-address=196.61.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.61.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49870 }
...
:if ([:len [/ip/route/find dst-address=45.95.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.95.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49870 }
:if ([:len [/ip/route/find dst-address=45.95.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.95.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49870 }
