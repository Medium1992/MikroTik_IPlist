...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49910 and dst-address=for_scripts_route/asnv4/AS49910.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49910.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49910 }
