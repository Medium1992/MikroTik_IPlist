...
:if ([:len [/ip/route/find dst-address=152.236.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
...
:if ([:len [/ip/route/find dst-address=152.236.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
