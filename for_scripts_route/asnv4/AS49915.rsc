...
:if ([:len [/ip/route/find dst-address=152.236.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
...
:if ([:len [/ip/route/find dst-address=152.236.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=152.236.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
