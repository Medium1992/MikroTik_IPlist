...
:if ([:len [/ip/route/find dst-address=162.43.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.43.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=162.43.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.43.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=162.43.174.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.43.174.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
