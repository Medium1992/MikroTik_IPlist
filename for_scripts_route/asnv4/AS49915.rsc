...
:if ([:len [/ip/route/find dst-address=144.225.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.225.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
...
:if ([:len [/ip/route/find dst-address=152.236.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=152.236.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=152.236.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=152.236.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=152.236.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
:if ([:len [/ip/route/find dst-address=152.236.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=152.236.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
...
:if ([:len [/ip/route/find dst-address=162.43.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.43.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
...
:if ([:len [/ip/route/find dst-address=162.43.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.43.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49915 }
