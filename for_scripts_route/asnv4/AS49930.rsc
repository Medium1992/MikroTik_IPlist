...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS49930 and dst-address=for_scripts_route/asnv4/AS49930.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS49930.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS49930 }
