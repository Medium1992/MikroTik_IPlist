...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50057 and dst-address=for_scripts_route/asnv4/AS50057.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50057.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50057 }
