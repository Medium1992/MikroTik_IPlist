...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50077 and dst-address=for_scripts_route/asnv4/AS50077.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50077.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50077 }
