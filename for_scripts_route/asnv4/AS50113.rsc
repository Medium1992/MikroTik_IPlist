...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=132.243.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=132.243.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50113 }
...
:if ([:len [/ip/route/find dst-address=194.63.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.63.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50113 }
:if ([:len [/ip/route/find dst-address=194.63.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.63.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50113 }
