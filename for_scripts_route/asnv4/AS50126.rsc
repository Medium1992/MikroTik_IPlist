...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50126 and dst-address=for_scripts_route/asnv4/AS50126.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50126.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50126 }
