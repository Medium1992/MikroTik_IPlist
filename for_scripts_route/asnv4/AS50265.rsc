...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50265 and dst-address=for_scripts_route/asnv4/AS50265.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50265.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50265 }
