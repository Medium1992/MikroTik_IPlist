...
:if ([:len [/ip/route/find dst-address=193.104.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.104.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50311 }
...
:if ([:len [/ip/route/find dst-address=83.174.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.174.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50311 }
