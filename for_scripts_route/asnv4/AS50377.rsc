...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50377 and dst-address=for_scripts_route/asnv4/AS50377.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50377.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50377 }
