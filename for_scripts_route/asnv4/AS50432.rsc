...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50432 and dst-address=for_scripts_route/asnv4/AS50432.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50432.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50432 }
