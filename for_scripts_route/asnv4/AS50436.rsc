...
:if ([:len [/ip/route/find dst-address=77.64.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.64.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
...
:if ([:len [/ip/route/find dst-address=77.64.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.64.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
...
:if ([:len [/ip/route/find dst-address=77.64.199.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.64.199.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
...
:if ([:len [/ip/route/find dst-address=77.64.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.64.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
:if ([:len [/ip/route/find dst-address=77.64.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.64.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
:if ([:len [/ip/route/find dst-address=82.119.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.119.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
:if ([:len [/ip/route/find dst-address=83.221.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.221.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
...
:if ([:len [/ip/route/find dst-address=89.186.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.186.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
...
:if ([:len [/ip/route/find dst-address=92.206.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.206.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50436 }
