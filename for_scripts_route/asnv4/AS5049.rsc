...
:if ([:len [/ip/route/find dst-address=170.74.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.74.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5049 }
:if ([:len [/ip/route/find dst-address=170.74.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.74.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5049 }
