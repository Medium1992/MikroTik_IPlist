...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50543 and dst-address=for_scripts_route/asnv4/AS50543.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50543.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50543 }
