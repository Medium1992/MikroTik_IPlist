...
:if ([:len [/ip/route/find dst-address=109.234.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.234.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50544 }
...
:if ([:len [/ip/route/find dst-address=217.117.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.117.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50544 }
...
:if ([:len [/ip/route/find dst-address=217.74.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.74.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50544 }
