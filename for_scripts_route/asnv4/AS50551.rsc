...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50551 and dst-address=for_scripts_route/asnv4/AS50551.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50551.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50551 }
