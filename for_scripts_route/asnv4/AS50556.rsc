...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50556 and dst-address=for_scripts_route/asnv4/AS50556.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50556.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50556 }
