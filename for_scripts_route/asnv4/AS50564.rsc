...
:if ([:len [/ip/route/find dst-address=185.182.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.182.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50564 }
...
:if ([:len [/ip/route/find dst-address=45.158.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.158.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50564 }
