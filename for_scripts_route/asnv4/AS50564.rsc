...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50564 and dst-address=for_scripts_route/asnv4/AS50564.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50564.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50564 }
