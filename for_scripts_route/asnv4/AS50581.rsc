...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.122.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.122.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50581 }
...
:if ([:len [/ip/route/find dst-address=176.122.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.122.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50581 }
...
:if ([:len [/ip/route/find dst-address=91.215.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.215.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50581 }
:if ([:len [/ip/route/find dst-address=91.215.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.215.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50581 }
