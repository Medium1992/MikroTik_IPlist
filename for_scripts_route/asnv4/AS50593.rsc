...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50593 and dst-address=for_scripts_route/asnv4/AS50593.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50593.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50593 }
