...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50606 and dst-address=for_scripts_route/asnv4/AS50606.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50606.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50606 }
