...
:if ([:len [/ip/route/find dst-address=195.253.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.253.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50611 }
:if ([:len [/ip/route/find dst-address=195.253.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.253.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50611 }
