...
:if ([:len [/ip/route/find dst-address=185.194.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.194.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50628 }
...
:if ([:len [/ip/route/find dst-address=45.144.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.144.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50628 }
