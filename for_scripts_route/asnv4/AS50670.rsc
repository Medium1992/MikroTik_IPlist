...
:if ([:len [/ip/route/find dst-address=81.21.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50670 }
:if ([:len [/ip/route/find dst-address=81.21.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50670 }
:if ([:len [/ip/route/find dst-address=81.21.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50670 }
