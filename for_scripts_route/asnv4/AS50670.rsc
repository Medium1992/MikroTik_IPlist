...
:if ([:len [/ip/route/find dst-address=62.72.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.72.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50670 }
...
:if ([:len [/ip/route/find dst-address=77.91.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50670 }
:if ([:len [/ip/route/find dst-address=77.91.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50670 }
