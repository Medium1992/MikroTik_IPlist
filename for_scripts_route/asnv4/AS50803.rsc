...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50803 and dst-address=for_scripts_route/asnv4/AS50803.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50803.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50803 }
