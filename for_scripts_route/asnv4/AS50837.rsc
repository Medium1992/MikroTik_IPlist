...
:if ([:len [/ip/route/find dst-address=185.12.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.12.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50837 }
:if ([:len [/ip/route/find dst-address=185.12.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.12.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50837 }
...
:if ([:len [/ip/route/find dst-address=212.87.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.87.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50837 }
...
:if ([:len [/ip/route/find dst-address=45.88.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.88.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50837 }
...
:if ([:len [/ip/route/find dst-address=87.120.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.120.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50837 }
