...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=86.18.223.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.223.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.18.223.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.223.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.18.223.224/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.223.224/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.18.223.228/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.223.228/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.18.223.231/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.223.231/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.18.223.232/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.223.232/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.18.223.240/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.223.240/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.18.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.18.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
:if ([:len [/ip/route/find dst-address=86.19.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.19.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5089 }
