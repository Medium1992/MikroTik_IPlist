...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS50905 and dst-address=for_scripts_route/asnv4/AS50905.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS50905.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS50905 }
