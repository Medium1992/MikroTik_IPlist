...
:if ([:len [/ip/route/find dst-address=87.107.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
...
:if ([:len [/ip/route/find dst-address=87.107.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
