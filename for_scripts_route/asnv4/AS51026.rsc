...
:if ([:len [/ip/route/find dst-address=45.129.39.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.129.39.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
:if ([:len [/ip/route/find dst-address=5.56.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.56.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
:if ([:len [/ip/route/find dst-address=62.220.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.220.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
...
:if ([:len [/ip/route/find dst-address=81.12.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.12.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
:if ([:len [/ip/route/find dst-address=87.107.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
...
:if ([:len [/ip/route/find dst-address=87.107.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
:if ([:len [/ip/route/find dst-address=87.107.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.107.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51026 }
