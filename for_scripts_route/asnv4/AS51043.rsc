...
:if ([:len [/ip/route/find dst-address=194.238.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.238.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51043 }
...
:if ([:len [/ip/route/find dst-address=77.73.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.73.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51043 }
