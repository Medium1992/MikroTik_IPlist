...
:if ([:len [/ip/route/find dst-address=45.88.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.88.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51048 }
...
:if ([:len [/ip/route/find dst-address=91.207.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.207.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51048 }
