...
:if ([:len [/ip/route/find dst-address=31.184.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.184.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
:if ([:len [/ip/route/find dst-address=31.184.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.184.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
:if ([:len [/ip/route/find dst-address=31.184.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.184.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
:if ([:len [/ip/route/find dst-address=31.184.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.184.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
...
:if ([:len [/ip/route/find dst-address=31.184.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.184.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
:if ([:len [/ip/route/find dst-address=31.184.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.184.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
