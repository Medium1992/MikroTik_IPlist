...
:if ([:len [/ip/route/find dst-address=185.115.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.115.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
...
:if ([:len [/ip/route/find dst-address=37.130.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.130.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51074 }
