...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51093 and dst-address=for_scripts_route/asnv4/AS51093.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51093.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51093 }
