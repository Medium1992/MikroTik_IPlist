...
:if ([:len [/ip/route/find dst-address=193.181.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.181.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51132 }
...
:if ([:len [/ip/route/find dst-address=83.68.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.68.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51132 }
...
:if ([:len [/ip/route/find dst-address=83.68.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.68.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51132 }
:if ([:len [/ip/route/find dst-address=83.68.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.68.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51132 }
