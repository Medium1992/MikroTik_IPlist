...
:if ([:len [/ip/route/find dst-address=83.68.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.68.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51132 }
:if ([:len [/ip/route/find dst-address=91.145.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.145.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51132 }
