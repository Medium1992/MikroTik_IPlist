...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51153 and dst-address=for_scripts_route/asnv4/AS51153.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51153.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51153 }
