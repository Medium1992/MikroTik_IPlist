...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51185 and dst-address=for_scripts_route/asnv4/AS51185.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51185.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51185 }
