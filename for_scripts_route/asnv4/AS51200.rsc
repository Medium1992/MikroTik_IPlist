...
:if ([:len [/ip/route/find dst-address=193.135.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.135.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51200 }
...
:if ([:len [/ip/route/find dst-address=193.232.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.232.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51200 }
...
:if ([:len [/ip/route/find dst-address=195.18.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.18.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51200 }
...
:if ([:len [/ip/route/find dst-address=212.192.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.192.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51200 }
...
:if ([:len [/ip/route/find dst-address=212.193.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.193.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51200 }
