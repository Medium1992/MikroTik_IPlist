...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51218 and dst-address=for_scripts_route/asnv4/AS51218.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51218.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51218 }
