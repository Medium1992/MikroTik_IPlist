...
:if ([:len [/ip/route/find dst-address=111.88.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=111.88.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51219 }
...
:if ([:len [/ip/route/find dst-address=193.233.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51219 }
...
:if ([:len [/ip/route/find dst-address=195.208.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.208.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51219 }
