...
:if ([:len [/ip/route/find dst-address=153.56.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51247 }
:if ([:len [/ip/route/find dst-address=153.56.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51247 }
