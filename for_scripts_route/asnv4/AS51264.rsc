...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=159.200.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.200.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51264 }
:if ([:len [/ip/route/find dst-address=159.200.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.200.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51264 }
...
:if ([:len [/ip/route/find dst-address=91.202.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.202.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51264 }
:if ([:len [/ip/route/find dst-address=91.202.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.202.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51264 }
