...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS5133 and dst-address=for_scripts_route/asnv4/AS5133.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS5133.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5133 }
