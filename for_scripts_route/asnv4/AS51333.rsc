...
:if ([:len [/ip/route/find dst-address=188.65.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.65.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51333 }
:if ([:len [/ip/route/find dst-address=188.65.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.65.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51333 }
:if ([:len [/ip/route/find dst-address=188.65.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.65.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51333 }
