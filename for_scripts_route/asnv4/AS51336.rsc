...
:if ([:len [/ip/route/find dst-address=178.215.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.215.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51336 }
:if ([:len [/ip/route/find dst-address=178.215.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.215.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51336 }
:if ([:len [/ip/route/find dst-address=178.215.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.215.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51336 }
