...
:if ([:len [/ip/route/find dst-address=194.154.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.154.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51395 }
...
:if ([:len [/ip/route/find dst-address=213.177.189.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.177.189.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51395 }
...
:if ([:len [/ip/route/find dst-address=89.127.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.127.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51395 }
