...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=138.249.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.249.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
:if ([:len [/ip/route/find dst-address=138.249.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.249.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
...
:if ([:len [/ip/route/find dst-address=176.65.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.65.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
...
:if ([:len [/ip/route/find dst-address=185.235.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.235.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
...
:if ([:len [/ip/route/find dst-address=195.96.148.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.96.148.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
...
:if ([:len [/ip/route/find dst-address=217.60.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
:if ([:len [/ip/route/find dst-address=217.60.241.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.241.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
:if ([:len [/ip/route/find dst-address=217.60.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.60.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
...
:if ([:len [/ip/route/find dst-address=31.57.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
...
:if ([:len [/ip/route/find dst-address=85.133.236.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.236.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
:if ([:len [/ip/route/find dst-address=85.133.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.133.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51396 }
