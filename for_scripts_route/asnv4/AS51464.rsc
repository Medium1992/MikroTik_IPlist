...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51464 and dst-address=for_scripts_route/asnv4/AS51464.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51464.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51464 }
