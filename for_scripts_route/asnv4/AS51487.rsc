...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51487 and dst-address=for_scripts_route/asnv4/AS51487.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51487.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51487 }
