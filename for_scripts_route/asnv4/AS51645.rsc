...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51645 and dst-address=for_scripts_route/asnv4/AS51645.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51645.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51645 }
