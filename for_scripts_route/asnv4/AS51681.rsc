...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51681 and dst-address=for_scripts_route/asnv4/AS51681.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51681.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51681 }
