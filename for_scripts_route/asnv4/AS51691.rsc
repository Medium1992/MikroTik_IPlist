...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51691 and dst-address=for_scripts_route/asnv4/AS51691.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51691.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51691 }
