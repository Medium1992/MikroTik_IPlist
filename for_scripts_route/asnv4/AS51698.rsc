...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51698 and dst-address=for_scripts_route/asnv4/AS51698.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51698.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51698 }
