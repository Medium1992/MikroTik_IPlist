...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51705 and dst-address=for_scripts_route/asnv4/AS51705.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51705.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51705 }
