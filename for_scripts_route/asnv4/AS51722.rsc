...
:if ([:len [/ip/route/find dst-address=31.56.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.56.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51722 }
:if ([:len [/ip/route/find dst-address=38.107.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.107.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51722 }
