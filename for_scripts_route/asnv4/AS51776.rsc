...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.132.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.132.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51776 }
...
:if ([:len [/ip/route/find dst-address=91.201.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.201.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51776 }
