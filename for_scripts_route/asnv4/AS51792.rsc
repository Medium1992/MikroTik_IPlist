...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=83.175.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.175.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51792 }
:if ([:len [/ip/route/find dst-address=83.175.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.175.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51792 }
:if ([:len [/ip/route/find dst-address=83.175.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.175.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51792 }
:if ([:len [/ip/route/find dst-address=83.175.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.175.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51792 }
