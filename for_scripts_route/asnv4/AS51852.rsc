...
:if ([:len [/ip/route/find dst-address=176.65.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.65.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51852 }
...
:if ([:len [/ip/route/find dst-address=89.39.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.39.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51852 }
