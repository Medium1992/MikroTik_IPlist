...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51892 and dst-address=for_scripts_route/asnv4/AS51892.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51892.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51892 }
