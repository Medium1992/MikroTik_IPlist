...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS51925 and dst-address=for_scripts_route/asnv4/AS51925.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS51925.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS51925 }
