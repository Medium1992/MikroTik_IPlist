...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.222.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52000 }
...
:if ([:len [/ip/route/find dst-address=194.147.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.147.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52000 }
...
:if ([:len [/ip/route/find dst-address=194.242.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.242.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52000 }
