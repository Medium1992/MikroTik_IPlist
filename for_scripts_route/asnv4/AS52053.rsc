...
:if ([:len [/ip/route/find dst-address=178.93.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.93.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52053 }
...
:if ([:len [/ip/route/find dst-address=45.137.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.137.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52053 }
