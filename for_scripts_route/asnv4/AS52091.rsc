...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52091 and dst-address=for_scripts_route/asnv4/AS52091.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52091.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52091 }
