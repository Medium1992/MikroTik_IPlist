...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52106 and dst-address=for_scripts_route/asnv4/AS52106.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52106.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52106 }
