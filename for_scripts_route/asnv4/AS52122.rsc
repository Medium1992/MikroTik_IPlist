...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52122 and dst-address=for_scripts_route/asnv4/AS52122.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52122.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52122 }
