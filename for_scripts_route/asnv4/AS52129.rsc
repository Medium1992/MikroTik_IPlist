...
:if ([:len [/ip/route/find dst-address=208.56.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.56.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52129 }
:if ([:len [/ip/route/find dst-address=208.56.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.56.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52129 }
