...
:if ([:len [/ip/route/find dst-address=185.169.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.169.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52129 }
:if ([:len [/ip/route/find dst-address=185.169.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.169.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52129 }
