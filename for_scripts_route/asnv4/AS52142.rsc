...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52142 and dst-address=for_scripts_route/asnv4/AS52142.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52142.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52142 }
