...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.202.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.202.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52194 }
:if ([:len [/ip/route/find dst-address=185.43.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.43.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52194 }
...
:if ([:len [/ip/route/find dst-address=77.91.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.91.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52194 }
