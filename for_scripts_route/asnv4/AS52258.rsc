...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52258 and dst-address=for_scripts_route/asnv4/AS52258.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52258.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52258 }
