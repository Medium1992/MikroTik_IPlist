...
:if ([:len [/ip/route/find dst-address=170.150.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.150.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52263 }
...
:if ([:len [/ip/route/find dst-address=186.121.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.121.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52263 }
:if ([:len [/ip/route/find dst-address=186.121.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.121.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52263 }
...
:if ([:len [/ip/route/find dst-address=200.229.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.229.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52263 }
