...
:if ([:len [/ip/route/find dst-address=200.85.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.85.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52270 }
:if ([:len [/ip/route/find dst-address=200.85.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.85.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52270 }
:if ([:len [/ip/route/find dst-address=200.85.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.85.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52270 }
