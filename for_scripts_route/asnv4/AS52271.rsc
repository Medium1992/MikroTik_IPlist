...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52271 and dst-address=for_scripts_route/asnv4/AS52271.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52271.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52271 }
