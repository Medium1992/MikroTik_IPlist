...
:if ([:len [/ip/route/find dst-address=38.159.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52307 }
:if ([:len [/ip/route/find dst-address=38.159.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52307 }
:if ([:len [/ip/route/find dst-address=38.159.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52307 }
:if ([:len [/ip/route/find dst-address=38.159.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.159.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52307 }
