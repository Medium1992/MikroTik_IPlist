...
:if ([:len [/ip/route/find dst-address=181.16.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.16.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52323 }
...
:if ([:len [/ip/route/find dst-address=181.16.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.16.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52323 }
