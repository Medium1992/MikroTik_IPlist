...
:if ([:len [/ip/route/find dst-address=190.107.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.107.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52339 }
:if ([:len [/ip/route/find dst-address=190.107.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.107.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52339 }
