...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=162.217.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.217.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52347 }
...
:if ([:len [/ip/route/find dst-address=186.177.244.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.177.244.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52347 }
