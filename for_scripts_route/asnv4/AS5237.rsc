...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=205.113.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.113.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
...
:if ([:len [/ip/route/find dst-address=205.59.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
:if ([:len [/ip/route/find dst-address=205.60.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.60.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
...
:if ([:len [/ip/route/find dst-address=205.74.192.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.74.192.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
