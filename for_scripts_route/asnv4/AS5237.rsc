...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS5237 and dst-address=for_scripts_route/asnv4/AS5237.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS5237.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
