...
:if ([:len [/ip/route/find dst-address=205.71.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.71.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
...
:if ([:len [/ip/route/find dst-address=205.89.160.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.89.160.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
