...
:if ([:len [/ip/route/find dst-address=205.91.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.91.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
:if ([:len [/ip/route/find dst-address=205.91.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.91.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
:if ([:len [/ip/route/find dst-address=205.91.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.91.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5237 }
