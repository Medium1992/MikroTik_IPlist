...
:if ([:len [/ip/route/find dst-address=186.5.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.5.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52465 }
:if ([:len [/ip/route/find dst-address=186.5.186.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.5.186.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52465 }
