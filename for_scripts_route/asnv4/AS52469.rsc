...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52469 and dst-address=for_scripts_route/asnv4/AS52469.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52469.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52469 }
