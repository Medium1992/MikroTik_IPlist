...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52471 and dst-address=for_scripts_route/asnv4/AS52471.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52471.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52471 }
