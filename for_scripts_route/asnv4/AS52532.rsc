...
:if ([:len [/ip/route/find dst-address=201.49.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.49.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52532 }
:if ([:len [/ip/route/find dst-address=201.49.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.49.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52532 }
