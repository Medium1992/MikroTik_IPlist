...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52554 and dst-address=for_scripts_route/asnv4/AS52554.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52554.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52554 }
