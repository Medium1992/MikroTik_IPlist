...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52708 and dst-address=for_scripts_route/asnv4/AS52708.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52708.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52708 }
