...
:if ([:len [/ip/route/find dst-address=138.94.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.94.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52721 }
:if ([:len [/ip/route/find dst-address=143.208.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.208.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52721 }
