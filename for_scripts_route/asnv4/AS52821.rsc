...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52821 and dst-address=for_scripts_route/asnv4/AS52821.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52821.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52821 }
