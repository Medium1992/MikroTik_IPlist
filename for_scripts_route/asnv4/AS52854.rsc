...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52854 and dst-address=for_scripts_route/asnv4/AS52854.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52854.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52854 }
