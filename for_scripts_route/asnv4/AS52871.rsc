...
:if ([:len [/ip/route/find dst-address=201.157.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.157.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52871 }
...
:if ([:len [/ip/route/find dst-address=201.157.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.157.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52871 }
