...
:if ([:len [/ip/route/find dst-address=177.131.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.131.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52875 }
:if ([:len [/ip/route/find dst-address=179.63.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.63.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52875 }
