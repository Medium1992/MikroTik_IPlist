...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52971 and dst-address=for_scripts_route/asnv4/AS52971.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52971.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52971 }
