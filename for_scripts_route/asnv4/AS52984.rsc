...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS52984 and dst-address=for_scripts_route/asnv4/AS52984.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS52984.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS52984 }
