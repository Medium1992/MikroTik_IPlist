...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53038 and dst-address=for_scripts_route/asnv4/AS53038.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53038.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53038 }
