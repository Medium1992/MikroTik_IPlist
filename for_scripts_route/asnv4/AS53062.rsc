...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.0.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.0.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53062 }
...
:if ([:len [/ip/route/find dst-address=177.131.111.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.131.111.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53062 }
...
:if ([:len [/ip/route/find dst-address=45.164.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.164.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53062 }
