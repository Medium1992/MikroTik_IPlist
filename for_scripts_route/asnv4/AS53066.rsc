...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53066 and dst-address=for_scripts_route/asnv4/AS53066.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53066.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53066 }
