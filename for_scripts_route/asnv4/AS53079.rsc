...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53079 and dst-address=for_scripts_route/asnv4/AS53079.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53079.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53079 }
