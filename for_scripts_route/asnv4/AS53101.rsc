...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53101 and dst-address=for_scripts_route/asnv4/AS53101.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53101.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53101 }
