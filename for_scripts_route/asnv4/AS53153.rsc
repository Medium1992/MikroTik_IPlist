...
:if ([:len [/ip/route/find dst-address=187.61.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.61.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
...
:if ([:len [/ip/route/find dst-address=187.61.110.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=187.61.110.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53153 }
