...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53158 and dst-address=for_scripts_route/asnv4/AS53158.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53158.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53158 }
