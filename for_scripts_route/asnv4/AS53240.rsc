...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53240 and dst-address=for_scripts_route/asnv4/AS53240.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53240.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53240 }
