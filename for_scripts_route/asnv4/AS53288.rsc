...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53288 and dst-address=for_scripts_route/asnv4/AS53288.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53288.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53288 }
