...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53359 and dst-address=for_scripts_route/asnv4/AS53359.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53359.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53359 }
