...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53398 and dst-address=for_scripts_route/asnv4/AS53398.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53398.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53398 }
