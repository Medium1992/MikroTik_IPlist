...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53486 and dst-address=for_scripts_route/asnv4/AS53486.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53486.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53486 }
