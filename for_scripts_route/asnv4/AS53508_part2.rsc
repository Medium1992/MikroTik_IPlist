...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=24.244.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.244.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=24.89.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.89.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=24.89.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.89.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=24.89.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.89.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=24.89.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=24.89.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=69.50.224.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.50.224.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=69.50.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.50.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=69.50.227.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.50.227.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=69.50.227.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.50.227.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
:if ([:len [/ip/route/find dst-address=69.50.227.160/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.50.227.160/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53508 }
