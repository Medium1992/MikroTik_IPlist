...
:if ([:len [/ip/route/find dst-address=128.177.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.177.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53533 }
...
:if ([:len [/ip/route/find dst-address=38.98.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.98.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53533 }
