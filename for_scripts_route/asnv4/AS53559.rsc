...
:if ([:len [/ip/route/find dst-address=192.238.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.238.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53559 }
:if ([:len [/ip/route/find dst-address=192.238.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.238.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53559 }
...
:if ([:len [/ip/route/find dst-address=216.41.141.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.41.141.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53559 }
