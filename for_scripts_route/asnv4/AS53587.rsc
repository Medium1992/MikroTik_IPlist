...
:if ([:len [/ip/route/find dst-address=43.250.184.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.250.184.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53587 }
...
:if ([:len [/ip/route/find dst-address=45.61.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.61.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53587 }
