...
:if ([:len [/ip/route/find dst-address=23.183.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.183.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53667 }
:if ([:len [/ip/route/find dst-address=23.183.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.183.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53667 }
