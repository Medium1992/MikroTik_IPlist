...
:if ([:len [/ip/route/find dst-address=38.57.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.57.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53764 }
:if ([:len [/ip/route/find dst-address=38.57.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.57.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53764 }
