...
:if ([:len [/ip/route/find dst-address=161.38.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.38.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53764 }
:if ([:len [/ip/route/find dst-address=161.38.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.38.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53764 }
...
:if ([:len [/ip/route/find dst-address=72.249.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.249.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53764 }
:if ([:len [/ip/route/find dst-address=72.249.210.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.249.210.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53764 }
:if ([:len [/ip/route/find dst-address=72.249.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.249.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53764 }
