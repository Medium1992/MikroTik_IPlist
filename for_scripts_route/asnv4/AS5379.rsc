...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=194.149.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.149.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5379 }
:if ([:len [/ip/route/find dst-address=194.149.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.149.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5379 }
:if ([:len [/ip/route/find dst-address=194.149.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.149.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5379 }
