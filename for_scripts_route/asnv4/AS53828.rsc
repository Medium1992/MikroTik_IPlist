...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53828 and dst-address=for_scripts_route/asnv4/AS53828.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53828.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
