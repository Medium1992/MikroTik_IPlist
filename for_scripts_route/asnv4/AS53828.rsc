...
:if ([:len [/ip/route/find dst-address=216.152.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.152.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
...
:if ([:len [/ip/route/find dst-address=64.191.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
:if ([:len [/ip/route/find dst-address=64.191.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
:if ([:len [/ip/route/find dst-address=64.191.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
:if ([:len [/ip/route/find dst-address=64.191.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
:if ([:len [/ip/route/find dst-address=64.191.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
:if ([:len [/ip/route/find dst-address=64.191.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.191.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53828 }
