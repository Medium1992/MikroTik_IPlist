...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS53855 and dst-address=for_scripts_route/asnv4/AS53855.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS53855.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53855 }
