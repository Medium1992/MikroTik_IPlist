...
:if ([:len [/ip/route/find dst-address=91.222.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.222.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53856 }
...
:if ([:len [/ip/route/find dst-address=91.242.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.242.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53856 }
...
:if ([:len [/ip/route/find dst-address=95.164.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53856 }
...
:if ([:len [/ip/route/find dst-address=95.164.240.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.240.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53856 }
:if ([:len [/ip/route/find dst-address=95.164.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53856 }
