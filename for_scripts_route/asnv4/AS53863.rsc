...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=142.202.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=142.202.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53863 }
:if ([:len [/ip/route/find dst-address=208.73.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.73.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53863 }
...
:if ([:len [/ip/route/find dst-address=38.69.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.69.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS53863 }
