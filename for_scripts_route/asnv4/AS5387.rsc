...
:if ([:len [/ip/route/find dst-address=84.237.40.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.237.40.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5387 }
...
:if ([:len [/ip/route/find dst-address=84.237.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.237.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5387 }
:if ([:len [/ip/route/find dst-address=84.237.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.237.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5387 }
