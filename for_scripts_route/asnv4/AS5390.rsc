...
:if ([:len [/ip/route/find dst-address=85.148.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.148.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5390 }
:if ([:len [/ip/route/find dst-address=85.149.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.149.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5390 }
