...
:if ([:len [/ip/route/find dst-address=155.203.204.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.203.204.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54036 }
:if ([:len [/ip/route/find dst-address=155.203.207.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.203.207.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54036 }
:if ([:len [/ip/route/find dst-address=155.203.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.203.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54036 }
