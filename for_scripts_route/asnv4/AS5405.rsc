...
:if ([:len [/ip/route/find dst-address=185.238.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.238.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5405 }
...
:if ([:len [/ip/route/find dst-address=81.27.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.27.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5405 }
