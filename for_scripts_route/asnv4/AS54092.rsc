...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54092 and dst-address=for_scripts_route/asnv4/AS54092.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54092.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54092 }
