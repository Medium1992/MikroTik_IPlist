...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54143 and dst-address=for_scripts_route/asnv4/AS54143.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54143.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54143 }
