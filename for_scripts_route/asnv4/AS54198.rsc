...
:if ([:len [/ip/route/find dst-address=104.158.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.158.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=104.158.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.158.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
...
:if ([:len [/ip/route/find dst-address=38.192.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.192.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=38.192.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.192.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=38.192.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.192.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=38.192.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.192.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=45.44.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=45.44.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=45.44.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
...
:if ([:len [/ip/route/find dst-address=45.44.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=45.44.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
...
:if ([:len [/ip/route/find dst-address=45.44.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=45.44.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=45.44.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
:if ([:len [/ip/route/find dst-address=45.44.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.44.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54198 }
