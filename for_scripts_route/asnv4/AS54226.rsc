...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54226 and dst-address=for_scripts_route/asnv4/AS54226.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54226.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54226 }
