...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54249 and dst-address=for_scripts_route/asnv4/AS54249.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54249.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54249 }
