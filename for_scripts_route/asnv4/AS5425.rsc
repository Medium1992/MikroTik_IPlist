...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS5425 and dst-address=for_scripts_route/asnv4/AS5425.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS5425.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5425 }
