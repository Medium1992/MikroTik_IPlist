...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=204.4.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.4.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54407 }
...
:if ([:len [/ip/route/find dst-address=204.4.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.4.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54407 }
