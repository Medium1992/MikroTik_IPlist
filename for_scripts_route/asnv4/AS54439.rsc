...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54439 and dst-address=for_scripts_route/asnv4/AS54439.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54439.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54439 }
