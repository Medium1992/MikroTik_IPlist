...
:if ([:len [/ip/route/find dst-address=137.83.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.224/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.224/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.232/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.232/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.235/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.235/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.236/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.236/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
:if ([:len [/ip/route/find dst-address=137.83.47.240/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=137.83.47.240/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54501 }
