...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54502 and dst-address=for_scripts_route/asnv4/AS54502.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54502.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54502 }
