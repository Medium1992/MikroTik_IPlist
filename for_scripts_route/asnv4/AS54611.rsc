...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54611 and dst-address=for_scripts_route/asnv4/AS54611.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54611.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54611 }
