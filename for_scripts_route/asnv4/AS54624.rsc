...
:if ([:len [/ip/route/find dst-address=149.24.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.24.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54624 }
:if ([:len [/ip/route/find dst-address=149.24.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.24.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54624 }
