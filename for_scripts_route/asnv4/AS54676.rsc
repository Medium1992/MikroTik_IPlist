...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54676 and dst-address=for_scripts_route/asnv4/AS54676.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54676.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54676 }
