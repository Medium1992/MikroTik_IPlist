...
:if ([:len [/ip/route/find dst-address=108.175.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.175.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54706 }
:if ([:len [/ip/route/find dst-address=108.175.218.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.175.218.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54706 }
:if ([:len [/ip/route/find dst-address=108.175.220.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.175.220.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54706 }
