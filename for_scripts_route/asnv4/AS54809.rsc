...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.14.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.14.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54809 }
:if ([:len [/ip/route/find dst-address=12.22.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.22.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54809 }
...
:if ([:len [/ip/route/find dst-address=207.243.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.243.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54809 }
