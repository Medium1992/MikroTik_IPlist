...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=84.3.104.220/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.104.220/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.104.224/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.104.224/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
:if ([:len [/ip/route/find dst-address=84.3.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.3.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5483 }
