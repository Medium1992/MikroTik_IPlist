...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS54989 and dst-address=for_scripts_route/asnv4/AS54989.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS54989.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS54989 }
