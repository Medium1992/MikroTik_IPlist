...
:if ([:len [/ip/route/find dst-address=204.57.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.57.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55039 }
...
:if ([:len [/ip/route/find dst-address=206.109.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.109.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55039 }
