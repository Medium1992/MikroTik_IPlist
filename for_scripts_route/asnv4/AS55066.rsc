...
:if ([:len [/ip/route/find dst-address=154.21.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.21.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
:if ([:len [/ip/route/find dst-address=154.30.156.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.30.156.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
:if ([:len [/ip/route/find dst-address=154.37.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.37.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
:if ([:len [/ip/route/find dst-address=154.50.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.50.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
:if ([:len [/ip/route/find dst-address=154.50.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.50.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
:if ([:len [/ip/route/find dst-address=154.50.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.50.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
...
:if ([:len [/ip/route/find dst-address=154.9.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.9.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
...
:if ([:len [/ip/route/find dst-address=38.128.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
:if ([:len [/ip/route/find dst-address=38.128.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55066 }
