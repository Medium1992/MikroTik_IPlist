...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.155.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.155.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
...
:if ([:len [/ip/route/find dst-address=170.205.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.205.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
...
:if ([:len [/ip/route/find dst-address=209.177.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.177.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
...
:if ([:len [/ip/route/find dst-address=209.205.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.205.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
:if ([:len [/ip/route/find dst-address=209.205.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.205.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
...
:if ([:len [/ip/route/find dst-address=23.191.200.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.191.200.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
...
:if ([:len [/ip/route/find dst-address=94.74.187.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.74.187.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55081 }
