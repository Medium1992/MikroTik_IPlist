...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55124 and dst-address=for_scripts_route/asnv4/AS55124.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55124.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55124 }
