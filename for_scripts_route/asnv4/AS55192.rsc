...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55192 and dst-address=for_scripts_route/asnv4/AS55192.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55192.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55192 }
