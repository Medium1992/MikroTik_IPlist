...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55209 and dst-address=for_scripts_route/asnv4/AS55209.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55209.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55209 }
