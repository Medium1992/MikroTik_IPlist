...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=175.176.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.176.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55328 }
:if ([:len [/ip/route/find dst-address=175.176.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.176.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55328 }
