...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55330 and dst-address=for_scripts_route/asnv4/AS55330.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55330.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55330 }
