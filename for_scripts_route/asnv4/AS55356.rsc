...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55356 and dst-address=for_scripts_route/asnv4/AS55356.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55356.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55356 }
