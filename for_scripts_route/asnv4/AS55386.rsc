...
:if ([:len [/ip/route/find dst-address=133.162.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=133.162.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55386 }
...
:if ([:len [/ip/route/find dst-address=175.184.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.184.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55386 }
