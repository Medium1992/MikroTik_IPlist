...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55387 and dst-address=for_scripts_route/asnv4/AS55387.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55387.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55387 }
