...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55415 and dst-address=for_scripts_route/asnv4/AS55415.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55415.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55415 }
