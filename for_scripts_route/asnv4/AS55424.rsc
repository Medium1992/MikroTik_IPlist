...
:if ([:len [/ip/route/find dst-address=175.106.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.106.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55424 }
:if ([:len [/ip/route/find dst-address=175.106.63.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=175.106.63.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55424 }
