...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55448 and dst-address=for_scripts_route/asnv4/AS55448.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55448.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55448 }
