...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55541 and dst-address=for_scripts_route/asnv4/AS55541.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55541.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55541 }
