...
:if ([:len [/ip/route/find dst-address=119.2.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.2.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
...
:if ([:len [/ip/route/find dst-address=43.252.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.252.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
