...
:if ([:len [/ip/route/find dst-address=103.17.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.17.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=103.247.120.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.247.120.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=103.247.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.247.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
...
:if ([:len [/ip/route/find dst-address=116.254.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.254.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=116.254.114.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.254.114.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=116.254.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.254.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=119.2.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.2.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=119.2.52.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.2.52.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
...
:if ([:len [/ip/route/find dst-address=49.128.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.128.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=49.128.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.128.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
:if ([:len [/ip/route/find dst-address=49.128.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.128.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55666 }
