...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55698 and dst-address=for_scripts_route/asnv4/AS55698.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55698.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55698 }
