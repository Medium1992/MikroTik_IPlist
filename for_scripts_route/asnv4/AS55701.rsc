...
:if ([:len [/ip/route/find dst-address=103.213.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.213.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55701 }
...
:if ([:len [/ip/route/find dst-address=154.41.81.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.41.81.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55701 }
