...
:if ([:len [/ip/route/find dst-address=59.153.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.153.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55720 }
...
:if ([:len [/ip/route/find dst-address=61.4.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.4.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55720 }
:if ([:len [/ip/route/find dst-address=61.4.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.4.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55720 }
...
:if ([:len [/ip/route/find dst-address=98.159.104.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.159.104.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55720 }
