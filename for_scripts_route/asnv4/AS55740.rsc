...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55740 and dst-address=for_scripts_route/asnv4/AS55740.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55740.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55740 }
