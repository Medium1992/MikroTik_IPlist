...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55814 and dst-address=for_scripts_route/asnv4/AS55814.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55814.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55814 }
