...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55816 and dst-address=for_scripts_route/asnv4/AS55816.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55816.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55816 }
