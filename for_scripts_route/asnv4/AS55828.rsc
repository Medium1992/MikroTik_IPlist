...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55828 and dst-address=for_scripts_route/asnv4/AS55828.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55828.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55828 }
