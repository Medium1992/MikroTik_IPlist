...
:if ([:len [/ip/route/find dst-address=103.234.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.234.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
:if ([:len [/ip/route/find dst-address=103.234.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.234.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
