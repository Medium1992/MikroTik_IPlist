...
:if ([:len [/ip/route/find dst-address=202.131.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.131.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
:if ([:len [/ip/route/find dst-address=202.131.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.131.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
