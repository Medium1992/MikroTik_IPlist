...
:if ([:len [/ip/route/find dst-address=103.51.235.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.51.235.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
...
:if ([:len [/ip/route/find dst-address=43.245.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.245.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
:if ([:len [/ip/route/find dst-address=43.245.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.245.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
