...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55839 and dst-address=for_scripts_route/asnv4/AS55839.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55839.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55839 }
