...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS55844 and dst-address=for_scripts_route/asnv4/AS55844.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS55844.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55844 }
