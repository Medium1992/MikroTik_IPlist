...
:if ([:len [/ip/route/find dst-address=104.222.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.222.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55900 }
:if ([:len [/ip/route/find dst-address=104.222.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.222.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55900 }
:if ([:len [/ip/route/find dst-address=104.222.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.222.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55900 }
...
:if ([:len [/ip/route/find dst-address=172.97.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.97.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55900 }
