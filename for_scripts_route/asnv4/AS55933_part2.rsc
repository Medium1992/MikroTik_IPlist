...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=38.47.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=38.47.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=38.47.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.47.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=43.243.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.243.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=43.251.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.251.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=43.252.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.252.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=43.254.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.254.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=45.10.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.10.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
:if ([:len [/ip/route/find dst-address=45.11.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.11.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
...
:if ([:len [/ip/route/find dst-address=45.125.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.125.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
...
:if ([:len [/ip/route/find dst-address=45.251.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.251.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
...
:if ([:len [/ip/route/find dst-address=93.187.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.187.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55933 }
