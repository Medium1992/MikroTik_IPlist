...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.254.225.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.254.225.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55943 }
:if ([:len [/ip/route/find dst-address=103.254.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.254.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55943 }
...
:if ([:len [/ip/route/find dst-address=64.140.158.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.140.158.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS55943 }
