...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56035 and dst-address=for_scripts_route/asnv4/AS56035.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56035.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56035 }
