...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=39.134.72.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=39.134.72.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56046 }
:if ([:len [/ip/route/find dst-address=39.134.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=39.134.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56046 }
