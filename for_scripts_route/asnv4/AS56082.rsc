...
:if ([:len [/ip/route/find dst-address=122.115.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=122.115.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56082 }
:if ([:len [/ip/route/find dst-address=122.14.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=122.14.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56082 }
...
:if ([:len [/ip/route/find dst-address=122.14.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=122.14.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56082 }
