...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56172 and dst-address=for_scripts_route/asnv4/AS56172.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56172.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56172 }
