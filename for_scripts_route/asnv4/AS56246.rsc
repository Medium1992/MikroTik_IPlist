...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.10.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.10.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56246 }
:if ([:len [/ip/route/find dst-address=103.10.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.10.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56246 }
...
:if ([:len [/ip/route/find dst-address=116.68.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.68.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56246 }
:if ([:len [/ip/route/find dst-address=116.68.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.68.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56246 }
