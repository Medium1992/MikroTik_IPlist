...
:if ([:len [/ip/route/find dst-address=82.152.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.152.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56264 }
:if ([:len [/ip/route/find dst-address=82.152.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.152.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56264 }
:if ([:len [/ip/route/find dst-address=82.152.202.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.152.202.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56264 }
:if ([:len [/ip/route/find dst-address=82.152.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.152.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56264 }
