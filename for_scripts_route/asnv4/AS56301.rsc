...
:if ([:len [/ip/route/find dst-address=160.236.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.236.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56301 }
:if ([:len [/ip/route/find dst-address=183.81.170.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=183.81.170.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56301 }
:if ([:len [/ip/route/find dst-address=202.37.109.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.37.109.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56301 }
