...
:if ([:len [/ip/route/find dst-address=180.240.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.240.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56308 }
:if ([:len [/ip/route/find dst-address=180.240.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.240.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56308 }
