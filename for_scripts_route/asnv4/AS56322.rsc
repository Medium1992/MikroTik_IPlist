...
:if ([:len [/ip/route/find dst-address=195.20.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.20.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56322 }
...
:if ([:len [/ip/route/find dst-address=93.114.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.114.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56322 }
