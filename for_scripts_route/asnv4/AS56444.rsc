...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56444 and dst-address=for_scripts_route/asnv4/AS56444.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56444.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56444 }
