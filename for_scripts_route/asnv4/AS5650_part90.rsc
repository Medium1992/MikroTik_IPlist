...
:if ([:len [/ip/route/find dst-address=94.101.103.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.101.103.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5650 }
...
:if ([:len [/ip/route/find dst-address=95.134.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5650 }
:if ([:len [/ip/route/find dst-address=95.134.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5650 }
:if ([:len [/ip/route/find dst-address=95.134.155.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.155.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5650 }
:if ([:len [/ip/route/find dst-address=95.134.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5650 }
:if ([:len [/ip/route/find dst-address=95.134.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5650 }
...
:if ([:len [/ip/route/find dst-address=96.47.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.47.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5650 }
