...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.210.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.210.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
:if ([:len [/ip/route/find dst-address=178.210.162.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.210.162.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
...
:if ([:len [/ip/route/find dst-address=178.210.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.210.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
...
:if ([:len [/ip/route/find dst-address=185.23.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.23.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
