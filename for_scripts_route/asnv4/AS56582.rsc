...
:if ([:len [/ip/route/find dst-address=212.87.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.87.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
...
:if ([:len [/ip/route/find dst-address=31.169.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.169.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
:if ([:len [/ip/route/find dst-address=31.169.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.169.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
