...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.222.216.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.216.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
:if ([:len [/ip/route/find dst-address=131.222.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
:if ([:len [/ip/route/find dst-address=131.222.228.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.222.228.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
...
:if ([:len [/ip/route/find dst-address=212.21.100.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.21.100.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
...
:if ([:len [/ip/route/find dst-address=31.169.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.169.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
...
:if ([:len [/ip/route/find dst-address=45.74.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.74.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
...
:if ([:len [/ip/route/find dst-address=5.133.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.133.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56582 }
