...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=13.141.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.141.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56655 }
...
:if ([:len [/ip/route/find dst-address=191.222.248.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=191.222.248.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56655 }
:if ([:len [/ip/route/find dst-address=193.200.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.200.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56655 }
...
:if ([:len [/ip/route/find dst-address=200.102.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.102.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56655 }
...
:if ([:len [/ip/route/find dst-address=91.149.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.149.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56655 }
:if ([:len [/ip/route/find dst-address=91.217.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.217.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56655 }
