...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56683 and dst-address=for_scripts_route/asnv4/AS56683.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56683.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56683 }
