...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=197.221.253.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=197.221.253.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56696 }
...
:if ([:len [/ip/route/find dst-address=217.74.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.74.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56696 }
