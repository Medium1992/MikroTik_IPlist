...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56728 and dst-address=for_scripts_route/asnv4/AS56728.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56728.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56728 }
