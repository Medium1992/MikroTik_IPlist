...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56729 and dst-address=for_scripts_route/asnv4/AS56729.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56729.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56729 }
