...
:if ([:len [/ip/route/find dst-address=178.172.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.172.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56740 }
...
:if ([:len [/ip/route/find dst-address=80.94.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.94.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56740 }
