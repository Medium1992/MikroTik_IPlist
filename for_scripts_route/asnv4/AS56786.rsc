...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56786 and dst-address=for_scripts_route/asnv4/AS56786.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56786.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56786 }
