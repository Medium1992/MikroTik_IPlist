...
:if ([:len [/ip/route/find dst-address=84.232.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.232.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
:if ([:len [/ip/route/find dst-address=84.232.49.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.232.49.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
:if ([:len [/ip/route/find dst-address=84.232.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.232.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
...
:if ([:len [/ip/route/find dst-address=84.236.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
:if ([:len [/ip/route/find dst-address=84.236.169.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.169.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
:if ([:len [/ip/route/find dst-address=84.236.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
:if ([:len [/ip/route/find dst-address=84.236.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
:if ([:len [/ip/route/find dst-address=84.236.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.236.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
:if ([:len [/ip/route/find dst-address=88.148.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.148.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56882 }
