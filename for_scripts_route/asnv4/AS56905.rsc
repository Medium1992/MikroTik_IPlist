...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56905 and dst-address=for_scripts_route/asnv4/AS56905.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56905.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56905 }
