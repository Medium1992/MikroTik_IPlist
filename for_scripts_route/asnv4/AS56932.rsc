...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56932 and dst-address=for_scripts_route/asnv4/AS56932.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56932.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56932 }
