...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56958 and dst-address=for_scripts_route/asnv4/AS56958.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56958.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56958 }
