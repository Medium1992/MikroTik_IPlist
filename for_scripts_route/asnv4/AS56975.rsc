...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS56975 and dst-address=for_scripts_route/asnv4/AS56975.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS56975.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS56975 }
