...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57021 and dst-address=for_scripts_route/asnv4/AS57021.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57021.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57021 }
