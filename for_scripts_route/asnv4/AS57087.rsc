...
:if ([:len [/ip/route/find dst-address=193.163.41.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.163.41.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57087 }
...
:if ([:len [/ip/route/find dst-address=5.182.129.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.182.129.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57087 }
