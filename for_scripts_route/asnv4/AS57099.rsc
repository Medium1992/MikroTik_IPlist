...
:if ([:len [/ip/route/find dst-address=91.209.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.209.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57099 }
...
:if ([:len [/ip/route/find dst-address=91.229.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.229.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57099 }
