...
:if ([:len [/ip/route/find dst-address=185.44.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.44.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57099 }
:if ([:len [/ip/route/find dst-address=185.44.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.44.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57099 }
