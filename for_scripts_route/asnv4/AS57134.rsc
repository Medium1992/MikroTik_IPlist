...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57134 and dst-address=for_scripts_route/asnv4/AS57134.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57134.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57134 }
