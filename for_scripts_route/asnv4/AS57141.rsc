...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57141 and dst-address=for_scripts_route/asnv4/AS57141.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57141.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57141 }
