...
:if ([:len [/ip/route/find dst-address=109.235.148.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.235.148.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57168 }
:if ([:len [/ip/route/find dst-address=109.235.151.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.235.151.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57168 }
...
:if ([:len [/ip/route/find dst-address=185.3.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.3.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57168 }
