...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS572 and dst-address=for_scripts_route/asnv4/AS572.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS572.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS572 }
