...
:if ([:len [/ip/route/find dst-address=168.176.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.176.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5722 }
...
:if ([:len [/ip/route/find dst-address=168.176.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.176.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5722 }
:if ([:len [/ip/route/find dst-address=168.176.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.176.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5722 }
...
:if ([:len [/ip/route/find dst-address=200.24.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.24.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5722 }
