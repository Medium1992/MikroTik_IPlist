...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57304 and dst-address=for_scripts_route/asnv4/AS57304.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57304.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57304 }
