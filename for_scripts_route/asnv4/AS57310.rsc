...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57310 and dst-address=for_scripts_route/asnv4/AS57310.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57310.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57310 }
