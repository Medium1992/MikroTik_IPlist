...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57321 and dst-address=for_scripts_route/asnv4/AS57321.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57321.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57321 }
