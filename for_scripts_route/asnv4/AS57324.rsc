...
:if ([:len [/ip/route/find dst-address=202.164.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.164.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57324 }
:if ([:len [/ip/route/find dst-address=202.164.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.164.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57324 }
:if ([:len [/ip/route/find dst-address=202.164.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.164.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57324 }
...
:if ([:len [/ip/route/find dst-address=86.111.146.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=86.111.146.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57324 }
