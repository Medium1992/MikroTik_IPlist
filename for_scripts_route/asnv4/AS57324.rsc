...
:if ([:len [/ip/route/find dst-address=202.164.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.164.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57324 }
:if ([:len [/ip/route/find dst-address=202.164.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.164.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57324 }
