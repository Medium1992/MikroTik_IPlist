...
:if ([:len [/ip/route/find dst-address=158.58.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.58.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
:if ([:len [/ip/route/find dst-address=158.58.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.58.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
:if ([:len [/ip/route/find dst-address=158.58.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=158.58.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
...
:if ([:len [/ip/route/find dst-address=5.63.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.63.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
...
:if ([:len [/ip/route/find dst-address=5.63.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.63.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
