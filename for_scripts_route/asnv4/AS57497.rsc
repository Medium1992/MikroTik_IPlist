...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57497 and dst-address=for_scripts_route/asnv4/AS57497.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57497.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
