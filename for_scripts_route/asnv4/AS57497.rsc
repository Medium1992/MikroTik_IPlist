...
:if ([:len [/ip/route/find dst-address=185.2.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.2.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
:if ([:len [/ip/route/find dst-address=185.2.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.2.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57497 }
