...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57508 and dst-address=for_scripts_route/asnv4/AS57508.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57508.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57508 }
