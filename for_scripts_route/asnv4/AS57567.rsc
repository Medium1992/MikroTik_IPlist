...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57567 and dst-address=for_scripts_route/asnv4/AS57567.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57567.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57567 }
