...
:if ([:len [/ip/route/find dst-address=185.170.145.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.170.145.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57588 }
:if ([:len [/ip/route/find dst-address=38.66.194.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.66.194.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57588 }
