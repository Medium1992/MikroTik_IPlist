...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=70.80.63.240/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.80.63.240/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=70.80.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.80.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=70.81.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.81.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=70.82.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=70.82.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=74.56.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.56.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=74.56.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.56.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=74.56.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.56.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=74.56.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.56.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
:if ([:len [/ip/route/find dst-address=74.56.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.56.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
...
:if ([:len [/ip/route/find dst-address=74.58.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.58.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5769 }
