...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57705 and dst-address=for_scripts_route/asnv4/AS57705.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57705.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57705 }
