...
:if ([:len [/ip/route/find dst-address=45.80.36.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.80.36.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57717 }
...
:if ([:len [/ip/route/find dst-address=95.135.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.135.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57717 }
