...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=153.80.233.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.80.233.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57724 }
...
:if ([:len [/ip/route/find dst-address=45.10.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.10.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57724 }
...
:if ([:len [/ip/route/find dst-address=91.192.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.192.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57724 }
...
:if ([:len [/ip/route/find dst-address=95.129.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.129.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57724 }
