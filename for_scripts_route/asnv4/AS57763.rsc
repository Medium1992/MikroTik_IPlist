...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57763 and dst-address=for_scripts_route/asnv4/AS57763.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57763.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57763 }
