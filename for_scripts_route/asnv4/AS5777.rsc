...
:if ([:len [/ip/route/find dst-address=147.234.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.234.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5777 }
:if ([:len [/ip/route/find dst-address=147.234.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.234.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5777 }
