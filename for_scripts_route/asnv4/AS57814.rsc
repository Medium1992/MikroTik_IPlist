...
:if ([:len [/ip/route/find dst-address=185.139.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.139.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57814 }
:if ([:len [/ip/route/find dst-address=185.139.58.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.139.58.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57814 }
...
:if ([:len [/ip/route/find dst-address=80.75.215.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.75.215.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57814 }
