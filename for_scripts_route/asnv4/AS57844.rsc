...
:if ([:len [/ip/route/find dst-address=178.20.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.20.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57844 }
:if ([:len [/ip/route/find dst-address=185.118.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.118.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57844 }
...
:if ([:len [/ip/route/find dst-address=37.123.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.123.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57844 }
...
:if ([:len [/ip/route/find dst-address=37.123.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.123.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57844 }
