...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=139.28.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.28.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57844 }
:if ([:len [/ip/route/find dst-address=139.28.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.28.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57844 }
