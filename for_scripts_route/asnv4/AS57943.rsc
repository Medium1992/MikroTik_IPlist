...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS57943 and dst-address=for_scripts_route/asnv4/AS57943.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS57943.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS57943 }
