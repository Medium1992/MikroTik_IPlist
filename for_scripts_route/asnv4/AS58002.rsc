...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=37.208.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.208.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58002 }
:if ([:len [/ip/route/find dst-address=37.208.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.208.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58002 }
:if ([:len [/ip/route/find dst-address=37.208.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.208.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58002 }
...
:if ([:len [/ip/route/find dst-address=92.241.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.241.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58002 }
