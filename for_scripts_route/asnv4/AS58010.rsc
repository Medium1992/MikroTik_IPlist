...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58010 and dst-address=for_scripts_route/asnv4/AS58010.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58010.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58010 }
