...
:if ([:len [/ip/route/find dst-address=143.246.178.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.246.178.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58057 }
...
:if ([:len [/ip/route/find dst-address=199.104.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.104.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58057 }
