...
:if ([:len [/ip/route/find dst-address=153.56.200.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.200.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58172 }
:if ([:len [/ip/route/find dst-address=153.56.203.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.56.203.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58172 }
...
:if ([:len [/ip/route/find dst-address=94.131.60.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.131.60.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58172 }
:if ([:len [/ip/route/find dst-address=94.131.62.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.131.62.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58172 }
