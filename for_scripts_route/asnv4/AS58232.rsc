...
:if ([:len [/ip/route/find dst-address=2.27.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.27.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58232 }
...
:if ([:len [/ip/route/find dst-address=79.172.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=79.172.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58232 }
:if ([:len [/ip/route/find dst-address=94.183.160.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.183.160.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58232 }
...
:if ([:len [/ip/route/find dst-address=94.184.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.184.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58232 }
