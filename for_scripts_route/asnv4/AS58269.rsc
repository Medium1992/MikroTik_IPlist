...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58269 and dst-address=for_scripts_route/asnv4/AS58269.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58269.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58269 }
