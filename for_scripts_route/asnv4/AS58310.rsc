...
:if ([:len [/ip/route/find dst-address=91.109.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.109.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58310 }
