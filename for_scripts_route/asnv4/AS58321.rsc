...
:if ([:len [/ip/route/find dst-address=185.84.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.84.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58321 }
:if ([:len [/ip/route/find dst-address=193.218.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.218.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58321 }
...
:if ([:len [/ip/route/find dst-address=194.169.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.169.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58321 }
