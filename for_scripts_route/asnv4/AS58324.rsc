...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58324 and dst-address=for_scripts_route/asnv4/AS58324.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58324.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58324 }
