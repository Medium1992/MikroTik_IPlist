...
:if ([:len [/ip/route/find dst-address=185.224.94.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.224.94.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58327 }
...
:if ([:len [/ip/route/find dst-address=81.172.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.172.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58327 }
