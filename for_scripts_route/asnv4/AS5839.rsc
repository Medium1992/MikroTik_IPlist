...
:if ([:len [/ip/route/find dst-address=205.59.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.59.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.59.95.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.95.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.60.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.60.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.71.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.71.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.74.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.74.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.75.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.75.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.76.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.76.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.90.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.90.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.92.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.92.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
