...
:if ([:len [/ip/route/find dst-address=205.68.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.68.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.71.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.71.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
