...
:if ([:len [/ip/route/find dst-address=205.103.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.103.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.59.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.59.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.59.51.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.51.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.59.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.59.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.59.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.68.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.68.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.71.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.71.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.91.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.91.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.91.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.91.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.91.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.91.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.91.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.91.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
