...
:if ([:len [/ip/route/find dst-address=205.107.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.107.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.56.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.56.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.89.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.89.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.89.36.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.89.36.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
