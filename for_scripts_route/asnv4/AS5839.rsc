...
:if ([:len [/ip/route/find dst-address=205.59.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.59.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
...
:if ([:len [/ip/route/find dst-address=205.78.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.78.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
:if ([:len [/ip/route/find dst-address=205.78.44.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.78.44.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5839 }
