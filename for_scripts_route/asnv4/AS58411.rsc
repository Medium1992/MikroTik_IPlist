...
:if ([:len [/ip/route/find dst-address=103.210.240.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.210.240.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58411 }
:if ([:len [/ip/route/find dst-address=103.210.242.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.210.242.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58411 }
