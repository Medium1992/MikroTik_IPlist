...
:if ([:len [/ip/route/find dst-address=119.160.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.160.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58470 }
...
:if ([:len [/ip/route/find dst-address=119.73.19.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.73.19.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58470 }
:if ([:len [/ip/route/find dst-address=119.73.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.73.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58470 }
...
:if ([:len [/ip/route/find dst-address=119.73.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.73.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58470 }
:if ([:len [/ip/route/find dst-address=119.73.8.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=119.73.8.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58470 }
