...
:if ([:len [/ip/route/find dst-address=143.92.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.92.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
...
:if ([:len [/ip/route/find dst-address=148.222.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.222.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
:if ([:len [/ip/route/find dst-address=148.222.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.222.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
...
:if ([:len [/ip/route/find dst-address=202.181.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.181.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
:if ([:len [/ip/route/find dst-address=202.181.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.181.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
...
:if ([:len [/ip/route/find dst-address=202.81.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.81.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
