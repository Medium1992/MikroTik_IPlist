...
:if ([:len [/ip/route/find dst-address=143.92.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.92.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
...
:if ([:len [/ip/route/find dst-address=148.222.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.222.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
:if ([:len [/ip/route/find dst-address=148.222.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.222.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
:if ([:len [/ip/route/find dst-address=148.222.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=148.222.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58521 }
