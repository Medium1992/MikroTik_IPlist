...
:if ([:len [/ip/route/find dst-address=103.11.30.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.11.30.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
:if ([:len [/ip/route/find dst-address=202.47.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.47.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
...
:if ([:len [/ip/route/find dst-address=202.72.205.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.72.205.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
