...
:if ([:len [/ip/route/find dst-address=103.162.233.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.162.233.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
...
:if ([:len [/ip/route/find dst-address=116.68.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.68.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
:if ([:len [/ip/route/find dst-address=116.68.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.68.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
...
:if ([:len [/ip/route/find dst-address=202.72.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.72.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
...
:if ([:len [/ip/route/find dst-address=202.72.207.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.72.207.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
:if ([:len [/ip/route/find dst-address=43.240.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.240.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58552 }
