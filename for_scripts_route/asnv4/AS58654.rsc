...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58654 and dst-address=for_scripts_route/asnv4/AS58654.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58654.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58654 }
