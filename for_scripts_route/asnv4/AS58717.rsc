...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58717 and dst-address=for_scripts_route/asnv4/AS58717.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58717.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58717 }
