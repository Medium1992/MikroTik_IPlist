...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58736 and dst-address=for_scripts_route/asnv4/AS58736.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58736.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58736 }
