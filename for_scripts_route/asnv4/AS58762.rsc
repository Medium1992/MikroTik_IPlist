...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.138.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.138.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58762 }
...
:if ([:len [/ip/route/find dst-address=103.69.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.69.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58762 }
...
:if ([:len [/ip/route/find dst-address=45.117.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.117.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58762 }
