...
:if ([:len [/ip/route/find dst-address=157.7.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.7.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
:if ([:len [/ip/route/find dst-address=160.236.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.236.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
...
:if ([:len [/ip/route/find dst-address=160.251.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.251.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
...
:if ([:len [/ip/route/find dst-address=163.44.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.44.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
...
:if ([:len [/ip/route/find dst-address=210.172.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.172.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
:if ([:len [/ip/route/find dst-address=211.125.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=211.125.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
:if ([:len [/ip/route/find dst-address=219.97.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=219.97.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
:if ([:len [/ip/route/find dst-address=219.97.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=219.97.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
:if ([:len [/ip/route/find dst-address=219.97.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=219.97.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58791 }
