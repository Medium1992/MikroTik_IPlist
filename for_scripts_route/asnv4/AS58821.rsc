...
:if ([:len [/ip/route/find dst-address=103.156.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.156.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
...
:if ([:len [/ip/route/find dst-address=103.188.168.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.188.168.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
...
:if ([:len [/ip/route/find dst-address=151.158.84.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.158.84.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
...
:if ([:len [/ip/route/find dst-address=160.236.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.236.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
...
:if ([:len [/ip/route/find dst-address=38.58.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.58.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
:if ([:len [/ip/route/find dst-address=38.58.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.58.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
:if ([:len [/ip/route/find dst-address=38.58.124.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.58.124.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
:if ([:len [/ip/route/find dst-address=38.58.126.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.58.126.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
