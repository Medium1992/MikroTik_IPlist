...
:if ([:len [/ip/route/find dst-address=38.58.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.58.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
:if ([:len [/ip/route/find dst-address=38.58.116.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.58.116.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58821 }
