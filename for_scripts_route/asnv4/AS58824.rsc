...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58824 and dst-address=for_scripts_route/asnv4/AS58824.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58824.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58824 }
