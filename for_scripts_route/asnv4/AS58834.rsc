...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.27.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.27.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
...
:if ([:len [/ip/route/find dst-address=124.240.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=124.240.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
...
:if ([:len [/ip/route/find dst-address=49.239.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.239.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
