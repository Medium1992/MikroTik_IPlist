...
:if ([:len [/ip/route/find dst-address=202.168.162.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.168.162.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
:if ([:len [/ip/route/find dst-address=202.168.168.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.168.168.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
:if ([:len [/ip/route/find dst-address=202.168.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.168.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
:if ([:len [/ip/route/find dst-address=202.168.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.168.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
:if ([:len [/ip/route/find dst-address=202.168.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.168.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58834 }
