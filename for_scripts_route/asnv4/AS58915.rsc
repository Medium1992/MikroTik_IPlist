...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58915 and dst-address=for_scripts_route/asnv4/AS58915.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58915.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58915 }
