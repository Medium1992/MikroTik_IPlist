...
:if ([:len [/ip/route/find dst-address=103.185.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.185.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58945 }
...
:if ([:len [/ip/route/find dst-address=59.152.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.152.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58945 }
