...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS58952 and dst-address=for_scripts_route/asnv4/AS58952.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS58952.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS58952 }
