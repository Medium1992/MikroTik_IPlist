...
:if ([:len [/ip/route/find dst-address=202.243.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.240/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.240/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.248/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.248/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.251/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.251/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.81.252/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.81.252/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.82.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.82.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
:if ([:len [/ip/route/find dst-address=202.243.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.243.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59108 }
