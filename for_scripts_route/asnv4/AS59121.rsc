...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS59121 and dst-address=for_scripts_route/asnv4/AS59121.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS59121.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59121 }
