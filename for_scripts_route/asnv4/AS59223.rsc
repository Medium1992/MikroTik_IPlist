...
:if ([:len [/ip/route/find dst-address=110.167.255.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=110.167.255.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59223 }
...
:if ([:len [/ip/route/find dst-address=118.213.92.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=118.213.92.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59223 }
...
:if ([:len [/ip/route/find dst-address=125.72.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=125.72.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59223 }
