...
:if ([:len [/ip/route/find dst-address=117.134.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
