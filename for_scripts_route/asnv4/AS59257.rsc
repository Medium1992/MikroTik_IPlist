...
:if ([:len [/ip/route/find dst-address=203.189.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.189.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
...
:if ([:len [/ip/route/find dst-address=223.123.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
:if ([:len [/ip/route/find dst-address=223.123.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
