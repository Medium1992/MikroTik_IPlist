...
:if ([:len [/ip/route/find dst-address=117.134.222.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.134.222.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
...
:if ([:len [/ip/route/find dst-address=203.189.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.189.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
...
:if ([:len [/ip/route/find dst-address=223.123.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
:if ([:len [/ip/route/find dst-address=223.123.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.123.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59257 }
