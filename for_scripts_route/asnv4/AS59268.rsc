...
:if ([:len [/ip/route/find dst-address=49.128.84.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.128.84.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59268 }
:if ([:len [/ip/route/find dst-address=49.128.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.128.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59268 }
