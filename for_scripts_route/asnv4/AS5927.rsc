...
:if ([:len [/ip/route/find dst-address=192.240.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.240.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5927 }
:if ([:len [/ip/route/find dst-address=192.240.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.240.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5927 }
