...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.229.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.229.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59288 }
...
:if ([:len [/ip/route/find dst-address=27.0.196.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.0.196.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59288 }
