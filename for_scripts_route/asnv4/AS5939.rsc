...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS5939 and dst-address=for_scripts_route/asnv4/AS5939.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS5939.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS5939 }
