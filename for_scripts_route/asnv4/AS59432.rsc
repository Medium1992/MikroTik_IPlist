...
:if ([:len [/ip/route/find dst-address=145.79.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=145.79.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59432 }
...
:if ([:len [/ip/route/find dst-address=178.239.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.239.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59432 }
...
:if ([:len [/ip/route/find dst-address=31.58.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.58.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59432 }
...
:if ([:len [/ip/route/find dst-address=78.108.60.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.108.60.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59432 }
