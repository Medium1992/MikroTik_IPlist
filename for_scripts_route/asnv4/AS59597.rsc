...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS59597 and dst-address=for_scripts_route/asnv4/AS59597.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS59597.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59597 }
