...
:if ([:len [/ip/route/find dst-address=154.84.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.84.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
:if ([:len [/ip/route/find dst-address=169.40.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.40.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
...
:if ([:len [/ip/route/find dst-address=212.60.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.60.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
...
:if ([:len [/ip/route/find dst-address=84.32.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.32.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
...
:if ([:len [/ip/route/find dst-address=88.216.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.216.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
...
:if ([:len [/ip/route/find dst-address=94.194.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.194.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
:if ([:len [/ip/route/find dst-address=94.194.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.194.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
