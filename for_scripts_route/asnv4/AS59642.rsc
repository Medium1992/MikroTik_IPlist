...
:if ([:len [/ip/route/find dst-address=147.90.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.90.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
:if ([:len [/ip/route/find dst-address=147.90.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=147.90.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59642 }
