...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=181.214.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.214.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59692 }
...
:if ([:len [/ip/route/find dst-address=31.57.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.57.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59692 }
...
:if ([:len [/ip/route/find dst-address=89.125.171.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.125.171.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59692 }
:if ([:len [/ip/route/find dst-address=89.219.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.219.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59692 }
