...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=82.25.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.25.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59711 }
:if ([:len [/ip/route/find dst-address=82.25.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.25.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59711 }
