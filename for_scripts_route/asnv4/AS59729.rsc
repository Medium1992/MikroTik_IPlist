...
:if ([:len [/ip/route/find dst-address=62.171.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.171.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59729 }
:if ([:len [/ip/route/find dst-address=82.118.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.118.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59729 }
