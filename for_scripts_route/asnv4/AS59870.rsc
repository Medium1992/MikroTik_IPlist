...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS59870 and dst-address=for_scripts_route/asnv4/AS59870.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS59870.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59870 }
