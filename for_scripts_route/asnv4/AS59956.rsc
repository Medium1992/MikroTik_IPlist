...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=194.145.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.145.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59956 }
...
:if ([:len [/ip/route/find dst-address=5.53.116.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.53.116.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59956 }
