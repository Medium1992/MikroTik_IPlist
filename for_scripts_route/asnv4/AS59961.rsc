...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS59961 and dst-address=for_scripts_route/asnv4/AS59961.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS59961.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS59961 }
