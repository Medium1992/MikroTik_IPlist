...
:if ([:len [/ip/route/find dst-address=41.79.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6 }
:if ([:len [/ip/route/find dst-address=41.79.234.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.234.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6 }
