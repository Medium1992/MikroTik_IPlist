...
:if ([:len [/ip/route/find dst-address=103.252.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.252.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60064 }
...
:if ([:len [/ip/route/find dst-address=192.142.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.142.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60064 }
...
:if ([:len [/ip/route/find dst-address=84.75.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=84.75.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60064 }
