...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60092 and dst-address=for_scripts_route/asnv4/AS60092.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60092.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60092 }
