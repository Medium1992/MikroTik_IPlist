...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=109.206.243.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.206.243.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60117 }
...
:if ([:len [/ip/route/find dst-address=185.218.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.218.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60117 }
...
:if ([:len [/ip/route/find dst-address=85.31.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.31.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60117 }
...
:if ([:len [/ip/route/find dst-address=91.92.21.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.92.21.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60117 }
