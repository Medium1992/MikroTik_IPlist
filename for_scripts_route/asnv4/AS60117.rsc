...
:if ([:len [/ip/route/find dst-address=185.253.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.253.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60117 }
...
:if ([:len [/ip/route/find dst-address=85.232.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.232.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60117 }
