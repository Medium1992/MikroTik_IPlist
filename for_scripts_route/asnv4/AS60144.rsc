...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60144 and dst-address=for_scripts_route/asnv4/AS60144.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60144.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60144 }
