...
:if ([:len [/ip/route/find dst-address=2.178.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.178.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
:if ([:len [/ip/route/find dst-address=2.179.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.179.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
:if ([:len [/ip/route/find dst-address=2.180.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.180.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
...
:if ([:len [/ip/route/find dst-address=78.39.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.39.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
:if ([:len [/ip/route/find dst-address=78.39.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.39.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
:if ([:len [/ip/route/find dst-address=78.39.221.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.39.221.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
