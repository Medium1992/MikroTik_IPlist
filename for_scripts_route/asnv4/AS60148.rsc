...
:if ([:len [/ip/route/find dst-address=78.39.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.39.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
