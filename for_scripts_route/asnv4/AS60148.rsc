...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60148 and dst-address=for_scripts_route/asnv4/AS60148.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60148.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60148 }
