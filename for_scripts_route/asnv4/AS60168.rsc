...
:if ([:len [/ip/route/find dst-address=88.80.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.80.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60168 }
:if ([:len [/ip/route/find dst-address=88.80.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.80.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60168 }
