...
:if ([:len [/ip/route/find dst-address=5.32.128.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.32.128.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60168 }
:if ([:len [/ip/route/find dst-address=5.32.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.32.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60168 }
