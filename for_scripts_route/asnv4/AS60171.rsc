...
:if ([:len [/ip/route/find dst-address=102.177.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.177.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60171 }
...
:if ([:len [/ip/route/find dst-address=102.177.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.177.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60171 }
:if ([:len [/ip/route/find dst-address=102.177.153.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.177.153.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60171 }
:if ([:len [/ip/route/find dst-address=102.177.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.177.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60171 }
