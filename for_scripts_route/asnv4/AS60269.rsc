...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60269 and dst-address=for_scripts_route/asnv4/AS60269.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60269.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60269 }
