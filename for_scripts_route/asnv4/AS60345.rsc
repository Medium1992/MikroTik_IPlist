...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60345 and dst-address=for_scripts_route/asnv4/AS60345.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60345.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60345 }
