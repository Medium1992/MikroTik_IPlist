...
:if ([:len [/ip/route/find dst-address=193.182.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.182.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60345 }
:if ([:len [/ip/route/find dst-address=193.182.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.182.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60345 }
...
:if ([:len [/ip/route/find dst-address=83.219.99.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.219.99.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60345 }
...
:if ([:len [/ip/route/find dst-address=91.92.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.92.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60345 }
