...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60352 and dst-address=for_scripts_route/asnv4/AS60352.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60352.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60352 }
