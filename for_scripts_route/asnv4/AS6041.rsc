...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=130.16.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.16.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6041 }
:if ([:len [/ip/route/find dst-address=130.16.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.16.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6041 }
:if ([:len [/ip/route/find dst-address=130.16.34.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.16.34.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6041 }
:if ([:len [/ip/route/find dst-address=130.16.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=130.16.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6041 }
