...
:if ([:len [/ip/route/find dst-address=95.169.208.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.169.208.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60441 }
:if ([:len [/ip/route/find dst-address=95.169.211.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.169.211.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60441 }
