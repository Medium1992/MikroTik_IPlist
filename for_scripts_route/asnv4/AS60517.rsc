...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60517 and dst-address=for_scripts_route/asnv4/AS60517.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60517.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60517 }
