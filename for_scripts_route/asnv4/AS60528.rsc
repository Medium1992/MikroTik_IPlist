...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60528 and dst-address=for_scripts_route/asnv4/AS60528.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60528.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60528 }
