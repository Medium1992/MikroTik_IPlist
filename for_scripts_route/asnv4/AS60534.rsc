...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60534 and dst-address=for_scripts_route/asnv4/AS60534.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60534.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60534 }
