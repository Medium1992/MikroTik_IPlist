...
:if ([:len [/ip/route/find dst-address=178.248.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.248.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60542 }
...
:if ([:len [/ip/route/find dst-address=217.217.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=217.217.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60542 }
