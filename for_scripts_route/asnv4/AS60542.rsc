...
:if ([:len [/ip/route/find dst-address=194.180.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.180.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60542 }
...
:if ([:len [/ip/route/find dst-address=45.139.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.139.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60542 }
