...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60567 and dst-address=for_scripts_route/asnv4/AS60567.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60567.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60567 }
