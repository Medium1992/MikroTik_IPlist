...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60582 and dst-address=for_scripts_route/asnv4/AS60582.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60582.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60582 }
