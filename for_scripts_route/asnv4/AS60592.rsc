...
:if ([:len [/ip/route/find dst-address=185.38.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.38.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60592 }
:if ([:len [/ip/route/find dst-address=185.38.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.38.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60592 }
...
:if ([:len [/ip/route/find dst-address=23.26.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.26.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60592 }
