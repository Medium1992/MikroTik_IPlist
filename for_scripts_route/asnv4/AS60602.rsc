...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=154.16.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.16.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60602 }
...
:if ([:len [/ip/route/find dst-address=157.254.206.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.254.206.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60602 }
...
:if ([:len [/ip/route/find dst-address=163.5.216.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.5.216.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60602 }
...
:if ([:len [/ip/route/find dst-address=194.77.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.77.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60602 }
:if ([:len [/ip/route/find dst-address=205.186.118.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.186.118.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60602 }
...
:if ([:len [/ip/route/find dst-address=83.245.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=83.245.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60602 }
