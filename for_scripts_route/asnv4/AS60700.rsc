...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60700 and dst-address=for_scripts_route/asnv4/AS60700.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60700.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60700 }
