...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60701 and dst-address=for_scripts_route/asnv4/AS60701.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60701.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60701 }
