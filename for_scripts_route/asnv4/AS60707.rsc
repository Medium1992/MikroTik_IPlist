...
:if ([:len [/ip/route/find dst-address=80.253.244.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.253.244.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60707 }
...
:if ([:len [/ip/route/find dst-address=91.228.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.228.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60707 }
:if ([:len [/ip/route/find dst-address=91.228.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.228.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60707 }
