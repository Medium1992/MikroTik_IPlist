...
:if ([:len [/ip/route/find dst-address=212.7.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.7.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60713 }
...
:if ([:len [/ip/route/find dst-address=213.239.130.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.239.130.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60713 }
:if ([:len [/ip/route/find dst-address=213.239.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.239.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60713 }
