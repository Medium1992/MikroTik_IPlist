...
:if ([:len [/ip/route/find dst-address=223.29.239.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.29.239.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60721 }
...
:if ([:len [/ip/route/find dst-address=77.47.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=77.47.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60721 }
