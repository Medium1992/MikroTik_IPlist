...
:if ([:len [/ip/route/find dst-address=95.47.112.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.47.112.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60754 }
:if ([:len [/ip/route/find dst-address=95.47.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.47.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60754 }
