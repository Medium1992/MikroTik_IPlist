...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60774 and dst-address=for_scripts_route/asnv4/AS60774.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60774.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60774 }
