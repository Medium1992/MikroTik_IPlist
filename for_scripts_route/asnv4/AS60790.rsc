...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60790 and dst-address=for_scripts_route/asnv4/AS60790.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60790.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60790 }
