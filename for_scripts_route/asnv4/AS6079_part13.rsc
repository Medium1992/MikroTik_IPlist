...
:if ([:len [/ip/route/find dst-address=91.238.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.238.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6079 }
...
:if ([:len [/ip/route/find dst-address=92.112.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.112.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6079 }
...
:if ([:len [/ip/route/find dst-address=95.134.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6079 }
...
:if ([:len [/ip/route/find dst-address=95.134.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6079 }
:if ([:len [/ip/route/find dst-address=95.134.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.134.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6079 }
