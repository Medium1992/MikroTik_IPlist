...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60806 and dst-address=for_scripts_route/asnv4/AS60806.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60806.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60806 }
