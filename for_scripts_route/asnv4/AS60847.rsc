...
:if ([:len [/ip/route/find dst-address=185.218.219.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.218.219.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60847 }
...
:if ([:len [/ip/route/find dst-address=93.93.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.93.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60847 }
