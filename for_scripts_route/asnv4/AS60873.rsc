...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60873 and dst-address=for_scripts_route/asnv4/AS60873.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60873.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60873 }
