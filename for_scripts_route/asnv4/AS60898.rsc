...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60898 and dst-address=for_scripts_route/asnv4/AS60898.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60898.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60898 }
