...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60931 and dst-address=for_scripts_route/asnv4/AS60931.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60931.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60931 }
