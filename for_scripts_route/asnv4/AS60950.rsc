...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS60950 and dst-address=for_scripts_route/asnv4/AS60950.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS60950.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS60950 }
