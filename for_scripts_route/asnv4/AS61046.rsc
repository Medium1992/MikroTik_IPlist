...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61046 and dst-address=for_scripts_route/asnv4/AS61046.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61046.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61046 }
