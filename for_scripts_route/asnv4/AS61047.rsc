...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61047 and dst-address=for_scripts_route/asnv4/AS61047.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61047.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61047 }
