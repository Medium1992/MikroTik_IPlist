...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.111.180.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.111.180.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61053 }
...
:if ([:len [/ip/route/find dst-address=185.172.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.172.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61053 }
...
:if ([:len [/ip/route/find dst-address=94.176.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.176.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61053 }
