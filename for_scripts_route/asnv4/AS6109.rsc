...
:if ([:len [/ip/route/find dst-address=206.227.226.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.227.226.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6109 }
:if ([:len [/ip/route/find dst-address=206.227.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.227.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6109 }
