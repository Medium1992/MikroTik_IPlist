...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61092 and dst-address=for_scripts_route/asnv4/AS61092.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61092.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61092 }
