...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=138.124.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.124.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61098 }
:if ([:len [/ip/route/find dst-address=151.145.192.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.145.192.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61098 }
:if ([:len [/ip/route/find dst-address=151.145.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.145.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61098 }
...
:if ([:len [/ip/route/find dst-address=161.104.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=161.104.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61098 }
