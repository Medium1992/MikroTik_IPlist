...
:if ([:len [/ip/route/find dst-address=128.254.205.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=128.254.205.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61138 }
...
:if ([:len [/ip/route/find dst-address=185.121.179.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.121.179.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61138 }
