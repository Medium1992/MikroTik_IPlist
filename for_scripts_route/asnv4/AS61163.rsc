...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61163 and dst-address=for_scripts_route/asnv4/AS61163.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61163.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61163 }
