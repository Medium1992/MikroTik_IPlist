...
:if ([:len [/ip/route/find dst-address=185.4.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.4.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61173 }
:if ([:len [/ip/route/find dst-address=185.4.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.4.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61173 }
...
:if ([:len [/ip/route/find dst-address=193.141.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.141.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61173 }
...
:if ([:len [/ip/route/find dst-address=85.208.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.208.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61173 }
