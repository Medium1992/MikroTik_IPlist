...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61177 and dst-address=for_scripts_route/asnv4/AS61177.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61177.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61177 }
