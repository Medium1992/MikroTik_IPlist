...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61183 and dst-address=for_scripts_route/asnv4/AS61183.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61183.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61183 }
