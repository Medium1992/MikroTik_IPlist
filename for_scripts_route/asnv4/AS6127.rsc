...
:if ([:len [/ip/route/find dst-address=163.121.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.121.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6127 }
...
:if ([:len [/ip/route/find dst-address=163.121.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.121.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6127 }
