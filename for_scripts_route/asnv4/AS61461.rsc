...
:if ([:len [/ip/route/find dst-address=156.255.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.255.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61461 }
:if ([:len [/ip/route/find dst-address=156.255.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.255.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61461 }
:if ([:len [/ip/route/find dst-address=156.255.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.255.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61461 }
...
:if ([:len [/ip/route/find dst-address=206.62.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.62.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61461 }
:if ([:len [/ip/route/find dst-address=38.166.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.166.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61461 }
:if ([:len [/ip/route/find dst-address=38.166.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.166.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61461 }
