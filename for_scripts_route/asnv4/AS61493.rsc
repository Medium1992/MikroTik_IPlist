...
:if ([:len [/ip/route/find dst-address=181.119.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.119.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61493 }
:if ([:len [/ip/route/find dst-address=181.119.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=181.119.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61493 }
