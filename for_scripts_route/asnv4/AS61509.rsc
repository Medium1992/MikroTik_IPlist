...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61509 and dst-address=for_scripts_route/asnv4/AS61509.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61509.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61509 }
