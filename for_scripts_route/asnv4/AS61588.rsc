...
:if ([:len [/ip/route/find dst-address=138.121.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.121.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61588 }
:if ([:len [/ip/route/find dst-address=138.185.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.185.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61588 }
...
:if ([:len [/ip/route/find dst-address=143.255.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=143.255.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61588 }
...
:if ([:len [/ip/route/find dst-address=170.233.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.233.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61588 }
...
:if ([:len [/ip/route/find dst-address=170.246.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.246.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61588 }
...
:if ([:len [/ip/route/find dst-address=201.148.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.148.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61588 }
...
:if ([:len [/ip/route/find dst-address=45.179.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.179.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61588 }
