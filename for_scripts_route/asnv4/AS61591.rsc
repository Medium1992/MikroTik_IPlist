...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61591 and dst-address=for_scripts_route/asnv4/AS61591.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61591.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61591 }
