...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61613 and dst-address=for_scripts_route/asnv4/AS61613.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61613.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61613 }
