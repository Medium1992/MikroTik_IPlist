...
:if ([:len [/ip/route/find dst-address=97.232.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.232.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.176.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.176.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.128/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.128/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.144/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.144/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.152/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.152/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.156/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.156/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.158/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.158/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.160/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.160/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
:if ([:len [/ip/route/find dst-address=97.233.180.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=97.233.180.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6167 }
