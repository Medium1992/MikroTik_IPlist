...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61792 and dst-address=for_scripts_route/asnv4/AS61792.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61792.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61792 }
