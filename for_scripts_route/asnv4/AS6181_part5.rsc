...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=74.83.96.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.83.96.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6181 }
:if ([:len [/ip/route/find dst-address=74.83.96.100/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.83.96.100/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6181 }
