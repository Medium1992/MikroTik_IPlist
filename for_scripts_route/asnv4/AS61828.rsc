...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61828 and dst-address=for_scripts_route/asnv4/AS61828.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61828.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61828 }
