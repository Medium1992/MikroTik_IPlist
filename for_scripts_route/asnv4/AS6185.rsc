...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=17.253.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6185 }
...
:if ([:len [/ip/route/find dst-address=17.253.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6185 }
