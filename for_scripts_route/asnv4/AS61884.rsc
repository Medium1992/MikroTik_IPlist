...
:if ([:len [/ip/route/find dst-address=177.129.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.129.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61884 }
:if ([:len [/ip/route/find dst-address=201.182.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.182.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61884 }
