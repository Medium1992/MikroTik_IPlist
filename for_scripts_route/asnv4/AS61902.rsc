...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS61902 and dst-address=for_scripts_route/asnv4/AS61902.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS61902.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61902 }
