...
:if ([:len [/ip/route/find dst-address=198.202.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.202.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61961 }
...
:if ([:len [/ip/route/find dst-address=23.151.132.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.151.132.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS61961 }
