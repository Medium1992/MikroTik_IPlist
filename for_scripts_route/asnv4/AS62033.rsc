...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.127.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.127.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62033 }
:if ([:len [/ip/route/find dst-address=188.130.183.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.130.183.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62033 }
