...
:if ([:len [/ip/route/find dst-address=87.121.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.121.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62033 }
:if ([:len [/ip/route/find dst-address=91.92.248.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.92.248.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62033 }
