...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62040 and dst-address=for_scripts_route/asnv4/AS62040.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62040.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62040 }
