...
:if ([:len [/ip/route/find dst-address=104.247.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.247.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6205 }
...
:if ([:len [/ip/route/find dst-address=185.157.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.157.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6205 }
...
:if ([:len [/ip/route/find dst-address=46.45.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.45.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6205 }
