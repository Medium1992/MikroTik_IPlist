...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62064 and dst-address=for_scripts_route/asnv4/AS62064.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62064.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62064 }
