...
:if ([:len [/ip/route/find dst-address=151.246.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.246.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62068 }
:if ([:len [/ip/route/find dst-address=167.148.123.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.148.123.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62068 }
...
:if ([:len [/ip/route/find dst-address=89.19.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.19.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62068 }
