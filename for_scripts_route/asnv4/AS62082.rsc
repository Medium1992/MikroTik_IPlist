...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=177.28.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=177.28.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62082 }
...
:if ([:len [/ip/route/find dst-address=185.2.50.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.2.50.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62082 }
