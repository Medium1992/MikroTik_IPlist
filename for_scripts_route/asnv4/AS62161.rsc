...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62161 and dst-address=for_scripts_route/asnv4/AS62161.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62161.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62161 }
