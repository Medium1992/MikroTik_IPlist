...
:if ([:len [/ip/route/find dst-address=109.238.94.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.238.94.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62212 }
:if ([:len [/ip/route/find dst-address=141.133.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.133.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62212 }
:if ([:len [/ip/route/find dst-address=159.200.240.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.200.240.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62212 }
...
:if ([:len [/ip/route/find dst-address=193.124.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.124.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62212 }
:if ([:len [/ip/route/find dst-address=85.137.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.137.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62212 }
