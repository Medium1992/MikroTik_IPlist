...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62255 and dst-address=for_scripts_route/asnv4/AS62255.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62255.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62255 }
