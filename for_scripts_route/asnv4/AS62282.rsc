...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.140.231.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.140.231.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62282 }
...
:if ([:len [/ip/route/find dst-address=89.47.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.47.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62282 }
:if ([:len [/ip/route/find dst-address=89.47.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.47.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62282 }
