...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=178.212.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=178.212.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62300 }
...
:if ([:len [/ip/route/find dst-address=186.246.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.246.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62300 }
...
:if ([:len [/ip/route/find dst-address=62.204.32.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.204.32.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62300 }
