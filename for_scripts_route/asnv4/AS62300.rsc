...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=170.168.119.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.168.119.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62300 }
:if ([:len [/ip/route/find dst-address=170.168.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.168.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62300 }
...
:if ([:len [/ip/route/find dst-address=45.135.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.135.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62300 }
