...
:if ([:len [/ip/route/find dst-address=89.20.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.20.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62314 }
:if ([:len [/ip/route/find dst-address=89.20.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.20.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62314 }
