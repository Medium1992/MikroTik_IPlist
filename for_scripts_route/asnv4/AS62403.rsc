...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62403 and dst-address=for_scripts_route/asnv4/AS62403.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62403.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62403 }
