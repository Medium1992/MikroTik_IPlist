...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62417 and dst-address=for_scripts_route/asnv4/AS62417.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62417.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62417 }
