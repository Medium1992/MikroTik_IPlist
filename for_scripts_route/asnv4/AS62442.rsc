...
:if ([:len [/ip/route/find dst-address=89.221.92.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.221.92.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62442 }
...
:if ([:len [/ip/route/find dst-address=95.38.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.38.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62442 }
