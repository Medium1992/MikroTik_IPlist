...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.250.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.250.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
...
:if ([:len [/ip/route/find dst-address=107.151.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.151.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
:if ([:len [/ip/route/find dst-address=107.151.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.151.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
:if ([:len [/ip/route/find dst-address=107.151.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.151.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
...
:if ([:len [/ip/route/find dst-address=156.239.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.239.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
...
:if ([:len [/ip/route/find dst-address=198.44.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.44.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
:if ([:len [/ip/route/find dst-address=198.44.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=198.44.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
:if ([:len [/ip/route/find dst-address=23.148.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.148.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
...
:if ([:len [/ip/route/find dst-address=69.165.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.165.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
