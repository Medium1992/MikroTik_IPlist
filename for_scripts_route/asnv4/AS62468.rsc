...
:if ([:len [/ip/route/find dst-address=103.68.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.68.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
:if ([:len [/ip/route/find dst-address=121.54.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=121.54.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
...
:if ([:len [/ip/route/find dst-address=43.254.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.254.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62468 }
