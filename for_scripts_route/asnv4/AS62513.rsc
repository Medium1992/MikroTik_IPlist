...
:if ([:len [/ip/route/find dst-address=153.76.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.76.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62513 }
:if ([:len [/ip/route/find dst-address=153.76.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.76.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62513 }
