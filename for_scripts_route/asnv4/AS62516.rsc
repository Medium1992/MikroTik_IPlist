...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=169.128.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.128.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
...
:if ([:len [/ip/route/find dst-address=38.128.164.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
:if ([:len [/ip/route/find dst-address=38.128.164.128/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.128/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
:if ([:len [/ip/route/find dst-address=38.128.164.192/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.192/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
:if ([:len [/ip/route/find dst-address=38.128.164.195/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.195/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
:if ([:len [/ip/route/find dst-address=38.128.164.196/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.196/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
:if ([:len [/ip/route/find dst-address=38.128.164.200/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.200/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
:if ([:len [/ip/route/find dst-address=38.128.164.208/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.208/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
:if ([:len [/ip/route/find dst-address=38.128.164.224/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.128.164.224/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62516 }
