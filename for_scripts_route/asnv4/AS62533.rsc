...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62533 and dst-address=for_scripts_route/asnv4/AS62533.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62533.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62533 }
