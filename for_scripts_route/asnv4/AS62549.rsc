...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62549 and dst-address=for_scripts_route/asnv4/AS62549.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62549.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62549 }
