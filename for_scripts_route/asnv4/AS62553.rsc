...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=172.82.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.82.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62553 }
...
:if ([:len [/ip/route/find dst-address=216.109.176.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.109.176.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62553 }
:if ([:len [/ip/route/find dst-address=216.109.178.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.109.178.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62553 }
