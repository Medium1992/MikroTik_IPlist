...
:if ([:len [/ip/route/find dst-address=65.228.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.228.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6256 }
:if ([:len [/ip/route/find dst-address=65.228.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.228.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6256 }
...
:if ([:len [/ip/route/find dst-address=65.229.126.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.229.126.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6256 }
:if ([:len [/ip/route/find dst-address=65.229.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.229.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6256 }
:if ([:len [/ip/route/find dst-address=65.229.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.229.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6256 }
:if ([:len [/ip/route/find dst-address=65.229.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.229.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6256 }
:if ([:len [/ip/route/find dst-address=65.229.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.229.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6256 }
