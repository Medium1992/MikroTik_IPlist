...
:if ([:len [/ip/route/find dst-address=156.233.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=156.233.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62563 }
...
:if ([:len [/ip/route/find dst-address=216.152.147.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.152.147.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62563 }
...
:if ([:len [/ip/route/find dst-address=66.163.124.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.163.124.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62563 }
