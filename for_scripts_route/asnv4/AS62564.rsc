...
:if ([:len [/ip/route/find dst-address=141.140.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.140.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62564 }
:if ([:len [/ip/route/find dst-address=141.140.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=141.140.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62564 }
...
:if ([:len [/ip/route/find dst-address=23.95.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.95.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62564 }
