...
:if ([:len [/ip/route/find dst-address=163.114.212.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.114.212.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62597 }
:if ([:len [/ip/route/find dst-address=163.114.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.114.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62597 }
...
:if ([:len [/ip/route/find dst-address=163.114.234.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=163.114.234.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62597 }
