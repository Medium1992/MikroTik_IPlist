...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62620 and dst-address=for_scripts_route/asnv4/AS62620.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62620.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62620 }
