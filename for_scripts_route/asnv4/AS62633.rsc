...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62633 and dst-address=for_scripts_route/asnv4/AS62633.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62633.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62633 }
