...
:if ([:len [/ip/route/find dst-address=108.161.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.100/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.100/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.104/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.104/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.112/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.112/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.64/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.64/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.96/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.96/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.52.98/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.52.98/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.53.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.53.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
:if ([:len [/ip/route/find dst-address=108.161.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.161.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62643 }
