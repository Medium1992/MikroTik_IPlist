...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62676 and dst-address=for_scripts_route/asnv4/AS62676.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62676.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62676 }
