...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6269 and dst-address=for_scripts_route/asnv4/AS6269.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6269.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6269 }
