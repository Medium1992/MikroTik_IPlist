...
:if ([:len [/ip/route/find dst-address=168.92.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.92.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62728 }
