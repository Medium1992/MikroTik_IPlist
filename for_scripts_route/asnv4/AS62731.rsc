...
:if ([:len [/ip/route/find dst-address=169.197.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.197.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62731 }
:if ([:len [/ip/route/find dst-address=169.197.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=169.197.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62731 }
