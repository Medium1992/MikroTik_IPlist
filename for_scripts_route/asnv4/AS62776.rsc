...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62776 and dst-address=for_scripts_route/asnv4/AS62776.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62776.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62776 }
