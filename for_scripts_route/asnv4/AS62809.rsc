...
:if ([:len [/ip/route/find dst-address=136.175.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.0/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.0/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.16/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.16/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.4/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.4/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.6/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.6/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.30.8/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.30.8/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
:if ([:len [/ip/route/find dst-address=136.175.31.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=136.175.31.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
...
:if ([:len [/ip/route/find dst-address=207.174.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.174.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62809 }
