...
:if ([:len [/ip/route/find dst-address=216.248.70.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.248.70.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
...
:if ([:len [/ip/route/find dst-address=216.51.160.0/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.0/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
:if ([:len [/ip/route/find dst-address=216.51.160.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
:if ([:len [/ip/route/find dst-address=216.51.160.64/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.64/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
:if ([:len [/ip/route/find dst-address=216.51.160.72/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.72/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
:if ([:len [/ip/route/find dst-address=216.51.160.77/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.77/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
:if ([:len [/ip/route/find dst-address=216.51.160.78/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.78/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
:if ([:len [/ip/route/find dst-address=216.51.160.80/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.80/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
:if ([:len [/ip/route/find dst-address=216.51.160.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.51.160.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62825 }
