...
:if ([:len [/ip/route/find dst-address=207.182.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.182.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62833 }
:if ([:len [/ip/route/find dst-address=207.182.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.182.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62833 }
:if ([:len [/ip/route/find dst-address=207.182.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.182.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62833 }
