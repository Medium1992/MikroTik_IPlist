...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62838 and dst-address=for_scripts_route/asnv4/AS62838.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62838.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62838 }
