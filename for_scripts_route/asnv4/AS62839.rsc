...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62839 and dst-address=for_scripts_route/asnv4/AS62839.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62839.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62839 }
