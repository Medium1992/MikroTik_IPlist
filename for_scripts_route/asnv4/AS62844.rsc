...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62844 and dst-address=for_scripts_route/asnv4/AS62844.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62844.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62844 }
