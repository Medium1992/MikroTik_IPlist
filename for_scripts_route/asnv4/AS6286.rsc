...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6286 and dst-address=for_scripts_route/asnv4/AS6286.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6286.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6286 }
