...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.143.180.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.143.180.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62887 }
...
:if ([:len [/ip/route/find dst-address=108.169.198.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=108.169.198.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62887 }
...
:if ([:len [/ip/route/find dst-address=67.222.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.222.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62887 }
:if ([:len [/ip/route/find dst-address=67.222.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.222.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62887 }
