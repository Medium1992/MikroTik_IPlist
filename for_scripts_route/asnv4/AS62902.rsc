...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS62902 and dst-address=for_scripts_route/asnv4/AS62902.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS62902.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62902 }
