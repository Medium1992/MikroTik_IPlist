...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.219.29.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.219.29.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62913 }
:if ([:len [/ip/route/find dst-address=104.219.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.219.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS62913 }
