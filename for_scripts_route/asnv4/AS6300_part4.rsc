...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=76.164.68.96/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.164.68.96/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6300 }
:if ([:len [/ip/route/find dst-address=76.164.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.164.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6300 }
:if ([:len [/ip/route/find dst-address=76.164.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=76.164.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6300 }
