...
:if ([:len [/ip/route/find dst-address=186.185.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.185.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6306 }
...
:if ([:len [/ip/route/find dst-address=200.35.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.35.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6306 }
:if ([:len [/ip/route/find dst-address=200.35.120.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.35.120.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6306 }
:if ([:len [/ip/route/find dst-address=200.35.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.35.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6306 }
