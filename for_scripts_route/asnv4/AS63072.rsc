...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63072 and dst-address=for_scripts_route/asnv4/AS63072.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63072.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63072 }
