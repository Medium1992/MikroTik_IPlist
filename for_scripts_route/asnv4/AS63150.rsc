...
:if ([:len [/ip/route/find dst-address=209.33.144.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.33.144.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63150 }
...
:if ([:len [/ip/route/find dst-address=85.149.208.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.149.208.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63150 }
:if ([:len [/ip/route/find dst-address=85.149.212.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.149.212.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63150 }
:if ([:len [/ip/route/find dst-address=85.149.214.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.149.214.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63150 }
