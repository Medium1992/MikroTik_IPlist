...
:if ([:len [/ip/route/find dst-address=68.69.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.69.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6315 }
:if ([:len [/ip/route/find dst-address=68.69.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.69.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6315 }
:if ([:len [/ip/route/find dst-address=68.69.166.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.69.166.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6315 }
:if ([:len [/ip/route/find dst-address=68.69.167.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.69.167.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6315 }
:if ([:len [/ip/route/find dst-address=68.69.167.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=68.69.167.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6315 }
