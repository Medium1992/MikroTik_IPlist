...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63303 and dst-address=for_scripts_route/asnv4/AS63303.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63303.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63303 }
