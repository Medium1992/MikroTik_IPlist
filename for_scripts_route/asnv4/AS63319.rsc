...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63319 and dst-address=for_scripts_route/asnv4/AS63319.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63319.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63319 }
