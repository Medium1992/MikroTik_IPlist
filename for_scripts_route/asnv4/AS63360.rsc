...
:if ([:len [/ip/route/find dst-address=168.225.40.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.225.40.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63360 }
:if ([:len [/ip/route/find dst-address=168.225.48.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.225.48.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63360 }
