...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63386 and dst-address=for_scripts_route/asnv4/AS63386.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63386.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63386 }
