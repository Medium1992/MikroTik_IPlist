...
:if ([:len [/ip/route/find dst-address=153.116.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.116.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63440 }
...
:if ([:len [/ip/route/find dst-address=185.246.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.246.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63440 }
