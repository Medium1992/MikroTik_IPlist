...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63483 and dst-address=for_scripts_route/asnv4/AS63483.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63483.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63483 }
