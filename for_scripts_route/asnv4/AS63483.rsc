...
:if ([:len [/ip/route/find dst-address=168.235.168.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.235.168.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63483 }
:if ([:len [/ip/route/find dst-address=168.235.172.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.235.172.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63483 }
:if ([:len [/ip/route/find dst-address=168.235.174.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=168.235.174.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63483 }
