...
:if ([:len [/ip/route/find dst-address=170.74.10.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.74.10.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6352 }
...
:if ([:len [/ip/route/find dst-address=170.74.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.74.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6352 }
