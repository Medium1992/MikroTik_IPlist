...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63583 and dst-address=for_scripts_route/asnv4/AS63583.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63583.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63583 }
