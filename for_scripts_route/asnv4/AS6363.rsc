...
:if ([:len [/ip/route/find dst-address=134.141.188.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.141.188.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6363 }
...
:if ([:len [/ip/route/find dst-address=134.141.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.141.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6363 }
:if ([:len [/ip/route/find dst-address=134.141.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=134.141.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6363 }
