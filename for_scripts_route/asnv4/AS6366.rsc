...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6366 and dst-address=for_scripts_route/asnv4/AS6366.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6366.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6366 }
