...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63731 and dst-address=for_scripts_route/asnv4/AS63731.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63731.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63731 }
