...
:if ([:len [/ip/route/find dst-address=103.231.57.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.231.57.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63902 }
...
:if ([:len [/ip/route/find dst-address=65.181.181.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.181.181.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63902 }
:if ([:len [/ip/route/find dst-address=65.181.182.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.181.182.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63902 }
