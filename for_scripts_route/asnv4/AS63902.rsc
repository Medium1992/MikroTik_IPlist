...
:if ([:len [/ip/route/find dst-address=65.181.180.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=65.181.180.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63902 }
:if ([:len [/ip/route/find dst-address=81.168.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.168.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63902 }
:if ([:len [/ip/route/find dst-address=81.168.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.168.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63902 }
...
:if ([:len [/ip/route/find dst-address=96.62.152.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.62.152.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63902 }
