...
:if ([:len [/ip/route/find dst-address=27.122.56.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.56.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
:if ([:len [/ip/route/find dst-address=27.122.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.122.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
