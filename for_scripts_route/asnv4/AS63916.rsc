...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.1.154.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.1.154.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
:if ([:len [/ip/route/find dst-address=103.209.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.209.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
...
:if ([:len [/ip/route/find dst-address=103.42.213.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.42.213.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
:if ([:len [/ip/route/find dst-address=103.42.214.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.42.214.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
...
:if ([:len [/ip/route/find dst-address=103.70.59.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.70.59.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
...
:if ([:len [/ip/route/find dst-address=43.245.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.245.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
