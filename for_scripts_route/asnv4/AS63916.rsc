...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.113.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.113.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
:if ([:len [/ip/route/find dst-address=103.35.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.35.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
...
:if ([:len [/ip/route/find dst-address=202.144.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.144.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
...
:if ([:len [/ip/route/find dst-address=43.239.156.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.239.156.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
:if ([:len [/ip/route/find dst-address=43.245.196.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.245.196.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
...
:if ([:len [/ip/route/find dst-address=43.245.222.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.245.222.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
:if ([:len [/ip/route/find dst-address=43.251.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.251.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63916 }
