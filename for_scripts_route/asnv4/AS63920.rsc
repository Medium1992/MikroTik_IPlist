...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.208.164.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.208.164.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63920 }
...
:if ([:len [/ip/route/find dst-address=103.44.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.44.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63920 }
...
:if ([:len [/ip/route/find dst-address=43.225.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.225.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63920 }
