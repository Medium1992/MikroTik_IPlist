...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS63951 and dst-address=for_scripts_route/asnv4/AS63951.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS63951.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63951 }
