...
:if ([:len [/ip/route/find dst-address=103.84.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.84.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63961 }
...
:if ([:len [/ip/route/find dst-address=203.96.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.96.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63961 }
