...
:if ([:len [/ip/route/find dst-address=103.245.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.245.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63989 }
...
:if ([:len [/ip/route/find dst-address=43.228.87.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.228.87.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63989 }
