...
:if ([:len [/ip/route/find dst-address=104.254.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.254.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63989 }
...
:if ([:len [/ip/route/find dst-address=172.83.177.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.83.177.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63989 }
:if ([:len [/ip/route/find dst-address=172.97.71.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.97.71.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63989 }
...
:if ([:len [/ip/route/find dst-address=23.191.72.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.191.72.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS63989 }
