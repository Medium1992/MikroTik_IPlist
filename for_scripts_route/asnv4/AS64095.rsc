...
:if ([:len [/ip/route/find dst-address=203.80.62.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.80.62.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64095 }
:if ([:len [/ip/route/find dst-address=27.111.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=27.111.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64095 }
