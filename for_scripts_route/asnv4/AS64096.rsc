...
:if ([:len [/ip/route/find dst-address=151.242.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.242.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64096 }
...
:if ([:len [/ip/route/find dst-address=31.132.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.132.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64096 }
:if ([:len [/ip/route/find dst-address=31.132.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.132.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64096 }
