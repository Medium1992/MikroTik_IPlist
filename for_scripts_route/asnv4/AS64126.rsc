...
:if ([:len [/ip/route/find dst-address=154.88.170.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.88.170.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64126 }
...
:if ([:len [/ip/route/find dst-address=154.88.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.88.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64126 }
