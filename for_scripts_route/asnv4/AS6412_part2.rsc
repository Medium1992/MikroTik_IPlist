...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=80.184.20.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.184.20.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6412 }
:if ([:len [/ip/route/find dst-address=80.184.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.184.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6412 }
:if ([:len [/ip/route/find dst-address=80.184.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.184.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6412 }
...
:if ([:len [/ip/route/find dst-address=80.184.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.184.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6412 }
