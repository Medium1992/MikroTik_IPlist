...
:if ([:len [/ip/route/find dst-address=167.249.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=167.249.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64139 }
...
:if ([:len [/ip/route/find dst-address=38.211.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.211.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64139 }
