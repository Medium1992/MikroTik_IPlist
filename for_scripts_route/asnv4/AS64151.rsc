...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64151 and dst-address=for_scripts_route/asnv4/AS64151.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64151.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64151 }
