...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64212 and dst-address=for_scripts_route/asnv4/AS64212.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64212.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64212 }
