...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=206.103.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.103.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6423 }
:if ([:len [/ip/route/find dst-address=209.162.220.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.162.220.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6423 }
