...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64231 and dst-address=for_scripts_route/asnv4/AS64231.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64231.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64231 }
