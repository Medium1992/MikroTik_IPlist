...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.145.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.145.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64245 }
...
:if ([:len [/ip/route/find dst-address=104.145.230.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.145.230.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64245 }
...
:if ([:len [/ip/route/find dst-address=155.103.195.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=155.103.195.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64245 }
:if ([:len [/ip/route/find dst-address=185.145.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.145.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64245 }
