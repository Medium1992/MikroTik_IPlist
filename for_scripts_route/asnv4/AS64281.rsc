...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64281 and dst-address=for_scripts_route/asnv4/AS64281.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64281.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64281 }
