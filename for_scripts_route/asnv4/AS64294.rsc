...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64294 and dst-address=for_scripts_route/asnv4/AS64294.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64294.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64294 }
