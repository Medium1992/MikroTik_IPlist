...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=12.106.32.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=12.106.32.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6431 }
...
:if ([:len [/ip/route/find dst-address=207.140.168.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.140.168.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6431 }
