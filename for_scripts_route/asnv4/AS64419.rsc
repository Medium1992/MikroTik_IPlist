...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64419 and dst-address=for_scripts_route/asnv4/AS64419.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64419.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64419 }
