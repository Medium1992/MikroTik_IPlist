...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64437 and dst-address=for_scripts_route/asnv4/AS64437.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64437.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64437 }
