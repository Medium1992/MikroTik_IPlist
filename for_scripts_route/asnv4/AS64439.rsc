...
:if ([:len [/ip/route/find dst-address=94.232.40.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.232.40.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64439 }
:if ([:len [/ip/route/find dst-address=94.232.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.232.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64439 }
