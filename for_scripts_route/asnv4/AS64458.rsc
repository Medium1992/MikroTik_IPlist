...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS64458 and dst-address=for_scripts_route/asnv4/AS64458.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS64458.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS64458 }
