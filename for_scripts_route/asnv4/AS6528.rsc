...
:if ([:len [/ip/route/find dst-address=67.213.193.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.213.193.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6528 }
...
:if ([:len [/ip/route/find dst-address=67.213.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.213.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6528 }
...
:if ([:len [/ip/route/find dst-address=67.213.204.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.213.204.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6528 }
:if ([:len [/ip/route/find dst-address=67.213.206.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=67.213.206.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6528 }
