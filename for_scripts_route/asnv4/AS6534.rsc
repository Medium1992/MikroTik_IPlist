...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6534 and dst-address=for_scripts_route/asnv4/AS6534.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6534.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6534 }
