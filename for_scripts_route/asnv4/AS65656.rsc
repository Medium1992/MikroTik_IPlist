...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS65656 and dst-address=for_scripts_route/asnv4/AS65656.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS65656.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS65656 }
