...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6569 and dst-address=for_scripts_route/asnv4/AS6569.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6569.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6569 }
