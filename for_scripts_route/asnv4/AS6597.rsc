...
:if ([:len [/ip/route/find dst-address=207.15.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.15.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6597 }
...
:if ([:len [/ip/route/find dst-address=208.26.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.26.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6597 }
