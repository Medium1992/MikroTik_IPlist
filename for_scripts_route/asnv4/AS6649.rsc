...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6649 and dst-address=for_scripts_route/asnv4/AS6649.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6649.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6649 }
