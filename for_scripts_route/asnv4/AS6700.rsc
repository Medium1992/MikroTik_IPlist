...
:if ([:len [/ip/route/find dst-address=195.252.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.252.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
:if ([:len [/ip/route/find dst-address=195.252.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.252.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
:if ([:len [/ip/route/find dst-address=195.252.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.252.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
:if ([:len [/ip/route/find dst-address=195.252.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.252.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
:if ([:len [/ip/route/find dst-address=195.252.89.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.252.89.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
:if ([:len [/ip/route/find dst-address=195.252.90.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.252.90.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
:if ([:len [/ip/route/find dst-address=195.252.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.252.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
...
:if ([:len [/ip/route/find dst-address=62.108.105.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.108.105.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6700 }
