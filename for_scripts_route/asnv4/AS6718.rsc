...
:if ([:len [/ip/route/find dst-address=85.120.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.120.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6718 }
:if ([:len [/ip/route/find dst-address=85.120.228.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.120.228.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6718 }
