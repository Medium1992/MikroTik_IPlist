...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6747 and dst-address=for_scripts_route/asnv4/AS6747.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6747.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6747 }
