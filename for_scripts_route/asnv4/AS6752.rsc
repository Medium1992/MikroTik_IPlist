...
:if ([:len [/ip/route/find dst-address=2.152.216.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.152.216.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6752 }
:if ([:len [/ip/route/find dst-address=213.236.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.236.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6752 }
