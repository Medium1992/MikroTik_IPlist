...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=102.176.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.176.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6774 }
:if ([:len [/ip/route/find dst-address=102.176.139.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.176.139.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6774 }
:if ([:len [/ip/route/find dst-address=102.176.140.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=102.176.140.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6774 }
