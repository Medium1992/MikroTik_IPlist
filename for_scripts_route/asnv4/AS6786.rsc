...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.156.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.156.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6786 }
:if ([:len [/ip/route/find dst-address=185.39.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.39.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6786 }
...
:if ([:len [/ip/route/find dst-address=85.214.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.214.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6786 }
:if ([:len [/ip/route/find dst-address=85.214.9.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.214.9.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6786 }
:if ([:len [/ip/route/find dst-address=85.215.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.215.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6786 }
