...
:if ([:len [/ip/route/find dst-address=144.206.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.206.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6801 }
:if ([:len [/ip/route/find dst-address=144.206.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=144.206.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6801 }
