...
:if ([:len [/ip/route/find dst-address=94.194.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.194.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6830 }
:if ([:len [/ip/route/find dst-address=94.194.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.194.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6830 }
:if ([:len [/ip/route/find dst-address=94.194.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.194.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6830 }
:if ([:len [/ip/route/find dst-address=94.194.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.194.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6830 }
