...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS6948 and dst-address=for_scripts_route/asnv4/AS6948.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS6948.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6948 }
