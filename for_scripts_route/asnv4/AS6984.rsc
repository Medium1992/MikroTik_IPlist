...
:if ([:len [/ip/route/find dst-address=207.88.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.88.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6984 }
...
:if ([:len [/ip/route/find dst-address=64.220.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.220.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6984 }
