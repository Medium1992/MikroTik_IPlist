...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=151.214.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.214.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6998 }
:if ([:len [/ip/route/find dst-address=151.214.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=151.214.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS6998 }
