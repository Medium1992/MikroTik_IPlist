...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=99.97.210.80/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.97.210.80/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7018 }
:if ([:len [/ip/route/find dst-address=99.97.210.83/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.97.210.83/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7018 }
:if ([:len [/ip/route/find dst-address=99.97.210.84/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.97.210.84/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7018 }
:if ([:len [/ip/route/find dst-address=99.97.210.88/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.97.210.88/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7018 }
