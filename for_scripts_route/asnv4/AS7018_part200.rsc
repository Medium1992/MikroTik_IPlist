...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=99.93.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.93.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7018 }
:if ([:len [/ip/route/find dst-address=99.94.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.94.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7018 }
...
:if ([:len [/ip/route/find dst-address=99.96.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.96.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7018 }
