...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=62.190.86.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.190.86.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS702 }
:if ([:len [/ip/route/find dst-address=62.190.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.190.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS702 }
:if ([:len [/ip/route/find dst-address=62.190.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.190.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS702 }
