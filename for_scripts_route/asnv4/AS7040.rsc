...
:if ([:len [/ip/route/find dst-address=104.255.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.255.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7040 }
:if ([:len [/ip/route/find dst-address=162.254.132.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.254.132.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7040 }
