...
:if ([:len [/ip/route/find dst-address=199.167.136.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.167.136.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7040 }
...
:if ([:len [/ip/route/find dst-address=199.66.88.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=199.66.88.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7040 }
