...
:if ([:len [/ip/route/find dst-address=207.53.202.192/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.53.202.192/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7055 }
:if ([:len [/ip/route/find dst-address=207.53.202.224/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.53.202.224/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7055 }
:if ([:len [/ip/route/find dst-address=207.53.202.240/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.53.202.240/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7055 }
:if ([:len [/ip/route/find dst-address=207.53.202.248/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.53.202.248/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7055 }
:if ([:len [/ip/route/find dst-address=207.53.202.250/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.53.202.250/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7055 }
:if ([:len [/ip/route/find dst-address=207.53.202.252/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.53.202.252/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7055 }
