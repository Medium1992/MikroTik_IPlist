...
:if ([:len [/ip/route/find dst-address=192.56.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.56.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS71 }
...
:if ([:len [/ip/route/find dst-address=192.56.17.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.56.17.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS71 }
:if ([:len [/ip/route/find dst-address=192.56.40.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=192.56.40.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS71 }
