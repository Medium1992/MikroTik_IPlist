...
:if ([:len [/ip/route/find dst-address=205.203.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
:if ([:len [/ip/route/find dst-address=205.203.132.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.132.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
...
:if ([:len [/ip/route/find dst-address=205.203.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
