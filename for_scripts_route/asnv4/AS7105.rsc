...
:if ([:len [/ip/route/find dst-address=205.203.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
:if ([:len [/ip/route/find dst-address=205.203.130.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.130.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
:if ([:len [/ip/route/find dst-address=205.203.133.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.133.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
...
:if ([:len [/ip/route/find dst-address=205.203.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
:if ([:len [/ip/route/find dst-address=205.203.150.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.203.150.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
...
:if ([:len [/ip/route/find dst-address=208.144.115.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.144.115.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7105 }
