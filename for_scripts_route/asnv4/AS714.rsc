...
:if ([:len [/ip/route/find dst-address=17.253.40.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.40.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
:if ([:len [/ip/route/find dst-address=17.253.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
