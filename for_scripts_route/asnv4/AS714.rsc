...
:if ([:len [/ip/route/find dst-address=17.253.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
:if ([:len [/ip/route/find dst-address=17.253.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
...
:if ([:len [/ip/route/find dst-address=17.253.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
...
:if ([:len [/ip/route/find dst-address=17.253.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
:if ([:len [/ip/route/find dst-address=17.253.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
:if ([:len [/ip/route/find dst-address=17.253.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=17.253.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS714 }
