...
:if ([:len [/ip/route/find dst-address=200.25.101.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.25.101.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7195 }
:if ([:len [/ip/route/find dst-address=200.25.102.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=200.25.102.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7195 }
