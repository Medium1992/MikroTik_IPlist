...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=1.178.184.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.178.184.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7224 }
...
:if ([:len [/ip/route/find dst-address=47.228.4.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=47.228.4.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7224 }
...
:if ([:len [/ip/route/find dst-address=69.76.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.76.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7224 }
