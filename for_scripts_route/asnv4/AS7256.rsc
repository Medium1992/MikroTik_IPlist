...
:if ([:len [/ip/route/find dst-address=166.77.10.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.77.10.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7256 }
...
:if ([:len [/ip/route/find dst-address=166.77.23.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.77.23.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7256 }
:if ([:len [/ip/route/find dst-address=166.77.24.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.77.24.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7256 }
:if ([:len [/ip/route/find dst-address=166.77.26.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.77.26.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7256 }
...
:if ([:len [/ip/route/find dst-address=166.77.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=166.77.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7256 }
