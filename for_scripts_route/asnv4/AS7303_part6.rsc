...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=201.212.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.212.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.16.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.16.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.25.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.25.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.26.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.26.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
:if ([:len [/ip/route/find dst-address=201.213.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.213.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7303 }
