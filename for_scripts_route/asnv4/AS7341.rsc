...
:if ([:len [/ip/route/find dst-address=64.83.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.83.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7341 }
:if ([:len [/ip/route/find dst-address=64.83.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.83.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7341 }
:if ([:len [/ip/route/find dst-address=64.83.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.83.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7341 }
:if ([:len [/ip/route/find dst-address=64.83.140.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.83.140.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7341 }
