...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7366 and dst-address=for_scripts_route/asnv4/AS7366.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7366.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7366 }
