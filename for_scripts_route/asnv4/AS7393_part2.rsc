...
:if ([:len [/ip/route/find dst-address=66.154.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.154.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7393 }
...
:if ([:len [/ip/route/find dst-address=66.154.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.154.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7393 }
