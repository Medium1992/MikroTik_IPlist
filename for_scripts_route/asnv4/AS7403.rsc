...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7403 and dst-address=for_scripts_route/asnv4/AS7403.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7403.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7403 }
