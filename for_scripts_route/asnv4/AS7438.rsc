...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7438 and dst-address=for_scripts_route/asnv4/AS7438.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7438.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7438 }
