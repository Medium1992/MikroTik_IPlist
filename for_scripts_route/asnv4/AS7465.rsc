...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7465 and dst-address=for_scripts_route/asnv4/AS7465.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7465.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7465 }
