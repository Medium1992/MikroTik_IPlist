...
:if ([:len [/ip/route/find dst-address=103.183.154.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.183.154.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7483 }
...
:if ([:len [/ip/route/find dst-address=103.188.120.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.188.120.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7483 }
:if ([:len [/ip/route/find dst-address=103.189.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.189.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7483 }
...
:if ([:len [/ip/route/find dst-address=223.26.11.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.26.11.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7483 }
:if ([:len [/ip/route/find dst-address=223.26.14.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.26.14.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7483 }
