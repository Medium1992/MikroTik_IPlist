...
:if ([:len [/ip/route/find dst-address=223.26.12.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.26.12.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7483 }
:if ([:len [/ip/route/find dst-address=223.26.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=223.26.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7483 }
