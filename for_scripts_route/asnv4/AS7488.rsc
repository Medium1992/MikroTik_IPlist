...
:if ([:len [/ip/route/find dst-address=38.87.69.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.87.69.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7488 }
:if ([:len [/ip/route/find dst-address=38.87.70.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.87.70.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7488 }
:if ([:len [/ip/route/find dst-address=38.92.208.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.92.208.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7488 }
...
:if ([:len [/ip/route/find dst-address=82.38.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7488 }
:if ([:len [/ip/route/find dst-address=82.38.112.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.112.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7488 }
:if ([:len [/ip/route/find dst-address=82.38.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7488 }
:if ([:len [/ip/route/find dst-address=82.38.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.38.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7488 }
