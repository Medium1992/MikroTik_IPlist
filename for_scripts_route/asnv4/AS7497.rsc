...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=101.252.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=101.252.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7497 }
...
:if ([:len [/ip/route/find dst-address=210.72.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.72.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7497 }
