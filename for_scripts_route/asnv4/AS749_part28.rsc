...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=6.77.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=6.77.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS749 }
:if ([:len [/ip/route/find dst-address=6.77.32.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=6.77.32.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS749 }
:if ([:len [/ip/route/find dst-address=6.77.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=6.77.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS749 }
:if ([:len [/ip/route/find dst-address=6.77.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=6.77.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS749 }
:if ([:len [/ip/route/find dst-address=6.77.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=6.77.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS749 }
:if ([:len [/ip/route/find dst-address=6.77.58.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=6.77.58.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS749 }
:if ([:len [/ip/route/find dst-address=6.77.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=6.77.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS749 }
