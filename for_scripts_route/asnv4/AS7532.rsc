...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7532 and dst-address=for_scripts_route/asnv4/AS7532.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7532.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7532 }
