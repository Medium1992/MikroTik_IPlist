...
:if ([:len [/ip/route/find dst-address=103.198.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.198.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7536 }
...
:if ([:len [/ip/route/find dst-address=107.149.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=107.149.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7536 }
...
:if ([:len [/ip/route/find dst-address=87.82.242.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.82.242.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7536 }
:if ([:len [/ip/route/find dst-address=87.84.131.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.84.131.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7536 }
