...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=171.246.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=171.246.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7552 }
:if ([:len [/ip/route/find dst-address=171.248.0.0/13 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=171.248.0.0/13 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7552 }
:if ([:len [/ip/route/find dst-address=203.113.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.113.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7552 }
