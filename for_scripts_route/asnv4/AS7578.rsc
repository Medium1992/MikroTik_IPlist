...
:if ([:len [/ip/route/find dst-address=202.165.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.165.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7578 }
...
:if ([:len [/ip/route/find dst-address=38.57.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.57.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7578 }
