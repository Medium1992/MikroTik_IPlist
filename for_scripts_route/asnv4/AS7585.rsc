...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7585 and dst-address=for_scripts_route/asnv4/AS7585.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7585.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7585 }
