...
:if ([:len [/ip/route/find dst-address=210.56.18.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.56.18.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7590 }
...
:if ([:len [/ip/route/find dst-address=210.56.20.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=210.56.20.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7590 }
