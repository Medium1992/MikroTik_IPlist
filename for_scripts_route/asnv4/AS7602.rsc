...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.200.60.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.200.60.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=116.118.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.118.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=180.93.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.104.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.104.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.112.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.112.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=180.93.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=180.93.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.93.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
