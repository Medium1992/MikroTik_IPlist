...
:if ([:len [/ip/route/find dst-address=116.118.0.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.118.0.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
...
:if ([:len [/ip/route/find dst-address=221.133.0.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=221.133.0.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=221.133.16.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=221.133.16.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
:if ([:len [/ip/route/find dst-address=221.133.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=221.133.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7602 }
