...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7686 and dst-address=for_scripts_route/asnv4/AS7686.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7686.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7686 }
