...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7690 and dst-address=for_scripts_route/asnv4/AS7690.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7690.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7690 }
