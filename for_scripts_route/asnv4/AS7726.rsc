...
:if ([:len [/ip/route/find dst-address=170.170.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=170.170.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7726 }
...
:if ([:len [/ip/route/find dst-address=204.135.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.135.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7726 }
:if ([:len [/ip/route/find dst-address=204.135.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.135.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7726 }
:if ([:len [/ip/route/find dst-address=204.135.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.135.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7726 }
:if ([:len [/ip/route/find dst-address=204.135.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.135.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7726 }
...
:if ([:len [/ip/route/find dst-address=209.50.122.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.50.122.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7726 }
