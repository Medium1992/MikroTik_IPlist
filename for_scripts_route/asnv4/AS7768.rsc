...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=205.159.1.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=205.159.1.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7768 }
...
:if ([:len [/ip/route/find dst-address=206.209.216.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.209.216.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7768 }
