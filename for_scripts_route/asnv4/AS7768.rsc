...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7768 and dst-address=for_scripts_route/asnv4/AS7768.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7768.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7768 }
