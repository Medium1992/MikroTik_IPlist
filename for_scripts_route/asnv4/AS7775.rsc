...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7775 and dst-address=for_scripts_route/asnv4/AS7775.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7775.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7775 }
