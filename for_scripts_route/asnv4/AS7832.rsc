...
:if ([:len [/ip/route/find dst-address=216.229.36.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.36.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.36.32/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.32/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.36.40/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.40/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.36.44/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.44/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.36.47/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.47/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.36.48/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.48/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.36.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.36.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
:if ([:len [/ip/route/find dst-address=216.229.37.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.229.37.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7832 }
