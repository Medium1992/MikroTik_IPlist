...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS7859 and dst-address=for_scripts_route/asnv4/AS7859.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS7859.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7859 }
