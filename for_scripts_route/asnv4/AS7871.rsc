...
:if ([:len [/ip/route/find dst-address=206.162.204.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.160/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.160/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.162/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.162/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.164/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.164/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.168/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.168/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
