...
:if ([:len [/ip/route/find dst-address=206.162.204.192/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.192/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.196/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.196/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.199/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.199/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.200/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.200/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
