...
:if ([:len [/ip/route/find dst-address=206.162.204.192/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.192/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.208/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.208/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.212/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.212/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.215/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.215/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
:if ([:len [/ip/route/find dst-address=206.162.204.216/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.162.204.216/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7871 }
