...
:if ([:len [/ip/route/find dst-address=207.62.160.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.62.160.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7960 }
:if ([:len [/ip/route/find dst-address=207.62.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.62.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7960 }
:if ([:len [/ip/route/find dst-address=207.62.164.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.62.164.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7960 }
