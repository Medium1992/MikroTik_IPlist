...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=69.41.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.41.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7979 }
...
:if ([:len [/ip/route/find dst-address=96.46.176.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.46.176.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS7979 }
