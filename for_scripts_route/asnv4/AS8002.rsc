...
:if ([:len [/ip/route/find dst-address=207.251.64.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.251.64.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8002 }
:if ([:len [/ip/route/find dst-address=207.251.80.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.251.80.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8002 }
:if ([:len [/ip/route/find dst-address=207.251.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.251.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8002 }
:if ([:len [/ip/route/find dst-address=207.251.84.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.251.84.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8002 }
:if ([:len [/ip/route/find dst-address=207.251.88.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.251.88.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8002 }
