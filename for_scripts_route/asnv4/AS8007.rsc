...
:if ([:len [/ip/route/find dst-address=207.249.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.249.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8007 }
:if ([:len [/ip/route/find dst-address=207.249.74.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.249.74.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8007 }
:if ([:len [/ip/route/find dst-address=207.249.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.249.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8007 }
...
:if ([:len [/ip/route/find dst-address=207.249.82.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=207.249.82.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8007 }
