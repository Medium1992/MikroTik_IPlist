...
:if ([:len [/ip/route/find dst-address=159.41.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.41.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
:if ([:len [/ip/route/find dst-address=159.41.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.41.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
:if ([:len [/ip/route/find dst-address=159.41.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.41.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
:if ([:len [/ip/route/find dst-address=159.41.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=159.41.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
...
:if ([:len [/ip/route/find dst-address=218.254.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.254.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
...
:if ([:len [/ip/route/find dst-address=218.254.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.254.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
...
:if ([:len [/ip/route/find dst-address=31.88.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.88.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
:if ([:len [/ip/route/find dst-address=31.89.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.89.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
...
:if ([:len [/ip/route/find dst-address=89.195.32.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.195.32.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8011 }
