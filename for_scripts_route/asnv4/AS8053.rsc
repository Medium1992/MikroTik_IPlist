...
:if ([:len [/ip/route/find dst-address=206.135.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8053 }
:if ([:len [/ip/route/find dst-address=206.135.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=206.135.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8053 }
:if ([:len [/ip/route/find dst-address=64.139.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.139.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8053 }
