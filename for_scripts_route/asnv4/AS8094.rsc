...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS8094 and dst-address=for_scripts_route/asnv4/AS8094.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS8094.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8094 }
