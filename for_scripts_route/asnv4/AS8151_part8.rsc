...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=201.96.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.96.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.96.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.96.149.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.149.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.96.150.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.150.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.96.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.96.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.96.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.96.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
:if ([:len [/ip/route/find dst-address=201.97.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.97.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8151 }
