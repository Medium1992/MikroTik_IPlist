...
:if ([:len [/ip/route/find dst-address=46.28.64.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.28.64.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8254 }
:if ([:len [/ip/route/find dst-address=46.28.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.28.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8254 }
