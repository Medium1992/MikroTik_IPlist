...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS8273 and dst-address=for_scripts_route/asnv4/AS8273.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS8273.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8273 }
