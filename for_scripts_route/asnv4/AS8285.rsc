...
:if ([:len [/ip/route/find dst-address=185.220.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.220.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8285 }
...
:if ([:len [/ip/route/find dst-address=193.68.80.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.68.80.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8285 }
...
:if ([:len [/ip/route/find dst-address=213.21.227.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.21.227.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8285 }
:if ([:len [/ip/route/find dst-address=213.21.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.21.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8285 }
...
:if ([:len [/ip/route/find dst-address=213.21.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.21.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8285 }
:if ([:len [/ip/route/find dst-address=213.21.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.21.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8285 }
...
:if ([:len [/ip/route/find dst-address=89.223.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.223.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8285 }
