...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=195.187.143.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.143.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
:if ([:len [/ip/route/find dst-address=195.187.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
:if ([:len [/ip/route/find dst-address=195.187.152.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.152.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
:if ([:len [/ip/route/find dst-address=195.187.159.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.159.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
:if ([:len [/ip/route/find dst-address=195.187.161.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.161.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
...
:if ([:len [/ip/route/find dst-address=195.187.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
:if ([:len [/ip/route/find dst-address=195.187.52.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.52.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
:if ([:len [/ip/route/find dst-address=195.187.54.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.54.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
:if ([:len [/ip/route/find dst-address=195.187.56.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.187.56.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8308 }
