...
:if ([:len [/ip/route/find dst-address=193.28.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.28.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8319 }
:if ([:len [/ip/route/find dst-address=194.0.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.0.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8319 }
...
:if ([:len [/ip/route/find dst-address=195.158.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.158.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8319 }
