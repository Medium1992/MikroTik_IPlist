...
:if ([:len [/ip/route/find dst-address=196.1.96.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.1.96.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8346 }
:if ([:len [/ip/route/find dst-address=196.1.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=196.1.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8346 }
...
:if ([:len [/ip/route/find dst-address=80.15.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.15.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8346 }
