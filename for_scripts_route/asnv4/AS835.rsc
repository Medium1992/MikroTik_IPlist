...
:if ([:len [/ip/route/find dst-address=153.76.0.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.76.0.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS835 }
:if ([:len [/ip/route/find dst-address=153.76.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.76.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS835 }
:if ([:len [/ip/route/find dst-address=153.76.6.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=153.76.6.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS835 }
...
:if ([:len [/ip/route/find dst-address=23.246.184.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.246.184.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS835 }
