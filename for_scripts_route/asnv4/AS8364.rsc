...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS8364 and dst-address=for_scripts_route/asnv4/AS8364.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS8364.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8364 }
