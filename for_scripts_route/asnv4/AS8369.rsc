...
:if ([:len [/ip/route/find dst-address=193.105.156.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.105.156.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8369 }
...
:if ([:len [/ip/route/find dst-address=195.114.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.114.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8369 }
