...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=149.200.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.200.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=149.200.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.200.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=149.200.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.200.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=149.200.185.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.200.185.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=149.200.186.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.200.186.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=149.200.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.200.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=149.200.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=149.200.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
