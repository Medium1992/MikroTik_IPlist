...
:if ([:len [/ip/route/find dst-address=37.202.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=37.202.73.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.73.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=37.202.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=37.202.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=37.202.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
:if ([:len [/ip/route/find dst-address=37.202.96.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.202.96.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8376 }
