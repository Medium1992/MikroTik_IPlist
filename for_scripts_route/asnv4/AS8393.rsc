...
:if ([:len [/ip/route/find dst-address=193.193.224.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.193.224.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8393 }
:if ([:len [/ip/route/find dst-address=193.193.229.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.193.229.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8393 }
:if ([:len [/ip/route/find dst-address=193.193.230.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.193.230.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8393 }
:if ([:len [/ip/route/find dst-address=193.193.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.193.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8393 }
:if ([:len [/ip/route/find dst-address=193.193.240.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.193.240.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8393 }
...
:if ([:len [/ip/route/find dst-address=93.183.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.183.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8393 }
