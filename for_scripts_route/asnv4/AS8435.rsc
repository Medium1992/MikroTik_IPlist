...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS8435 and dst-address=for_scripts_route/asnv4/AS8435.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS8435.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8435 }
