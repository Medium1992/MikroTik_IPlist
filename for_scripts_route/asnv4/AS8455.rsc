...
:if ([:len [/ip/route/find dst-address=31.22.80.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.22.80.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8455 }
:if ([:len [/ip/route/find dst-address=31.22.85.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.22.85.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8455 }
:if ([:len [/ip/route/find dst-address=31.22.86.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=31.22.86.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8455 }
...
:if ([:len [/ip/route/find dst-address=91.242.244.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.242.244.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8455 }
