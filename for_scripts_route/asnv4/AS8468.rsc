...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS8468 and dst-address=for_scripts_route/asnv4/AS8468.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS8468.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8468 }
