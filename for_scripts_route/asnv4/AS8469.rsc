...
:if ([:len [/ip/route/find dst-address=195.94.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.94.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8469 }
...
:if ([:len [/ip/route/find dst-address=62.40.0.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.40.0.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8469 }
