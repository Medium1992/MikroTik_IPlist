...
:if ([:len [/ip/route/find dst-address=188.95.192.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=188.95.192.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8529 }
:if ([:len [/ip/route/find dst-address=2.18.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=2.18.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8529 }
