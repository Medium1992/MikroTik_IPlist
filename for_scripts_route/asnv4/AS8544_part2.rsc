...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS8544 and dst-address=for_scripts_route/asnv4/AS8544_part2.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS8544_part2.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8544 }
