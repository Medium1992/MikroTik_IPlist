...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.95.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.95.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8561 }
...
:if ([:len [/ip/route/find dst-address=195.253.88.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.253.88.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8561 }
:if ([:len [/ip/route/find dst-address=195.253.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.253.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8561 }
