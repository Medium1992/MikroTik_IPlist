...
:if ([:len [/ip/route/find dst-address=195.114.224.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.114.224.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8587 }
:if ([:len [/ip/route/find dst-address=195.114.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.114.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8587 }
:if ([:len [/ip/route/find dst-address=195.114.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.114.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8587 }
