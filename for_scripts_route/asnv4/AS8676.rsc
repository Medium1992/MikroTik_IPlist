...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS8676 and dst-address=for_scripts_route/asnv4/AS8676.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS8676.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8676 }
