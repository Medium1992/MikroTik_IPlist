...
:if ([:len [/ip/route/find dst-address=93.91.172.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.91.172.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8711 }
:if ([:len [/ip/route/find dst-address=95.181.128.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.181.128.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8711 }
