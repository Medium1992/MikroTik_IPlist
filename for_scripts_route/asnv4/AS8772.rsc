...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=176.121.224.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.121.224.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
:if ([:len [/ip/route/find dst-address=185.230.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.230.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
...
:if ([:len [/ip/route/find dst-address=193.104.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.104.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
:if ([:len [/ip/route/find dst-address=195.214.212.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=195.214.212.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
:if ([:len [/ip/route/find dst-address=62.205.128.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.205.128.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
...
:if ([:len [/ip/route/find dst-address=94.131.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.131.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
...
:if ([:len [/ip/route/find dst-address=95.164.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
:if ([:len [/ip/route/find dst-address=95.164.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
