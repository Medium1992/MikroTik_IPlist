...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.234.254.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.234.254.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
...
:if ([:len [/ip/route/find dst-address=95.164.47.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.164.47.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8772 }
