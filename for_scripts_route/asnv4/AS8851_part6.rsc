...
:if ([:len [/ip/route/find dst-address=89.213.75.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.75.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8851 }
:if ([:len [/ip/route/find dst-address=89.213.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8851 }
:if ([:len [/ip/route/find dst-address=89.213.78.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.213.78.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8851 }
...
:if ([:len [/ip/route/find dst-address=89.31.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.31.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8851 }
:if ([:len [/ip/route/find dst-address=89.31.238.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.31.238.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8851 }
