...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=95.43.240.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.43.240.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8866 }
:if ([:len [/ip/route/find dst-address=95.43.248.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.43.248.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8866 }
:if ([:len [/ip/route/find dst-address=95.43.250.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.43.250.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8866 }
:if ([:len [/ip/route/find dst-address=95.43.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.43.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8866 }
