...
:if ([:len [/ip/route/find dst-address=212.138.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=212.138.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8895 }
