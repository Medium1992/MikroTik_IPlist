...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=185.56.44.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.56.44.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8916 }
:if ([:len [/ip/route/find dst-address=185.87.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.87.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8916 }
