...
:if ([:len [/ip/route/find dst-address=46.255.76.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.255.76.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8943 }
:if ([:len [/ip/route/find dst-address=46.255.79.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.255.79.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8943 }
