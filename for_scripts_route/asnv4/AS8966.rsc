...
:if ([:len [/ip/route/find dst-address=5.192.24.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.192.24.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8966 }
...
:if ([:len [/ip/route/find dst-address=5.195.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.195.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8966 }
...
:if ([:len [/ip/route/find dst-address=94.58.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.58.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8966 }
