...
:if ([:len [/ip/route/find dst-address=95.143.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.143.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8968 }
:if ([:len [/ip/route/find dst-address=95.143.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.143.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8968 }
:if ([:len [/ip/route/find dst-address=95.143.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.143.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8968 }
:if ([:len [/ip/route/find dst-address=95.143.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.143.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8968 }
:if ([:len [/ip/route/find dst-address=95.143.110.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.143.110.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8968 }
:if ([:len [/ip/route/find dst-address=95.143.97.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.143.97.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8968 }
:if ([:len [/ip/route/find dst-address=95.143.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.143.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS8968 }
