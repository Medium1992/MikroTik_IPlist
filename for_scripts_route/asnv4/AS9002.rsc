...
:if ([:len [/ip/route/find dst-address=104.233.6.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.233.6.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9002 }
...
:if ([:len [/ip/route/find dst-address=45.39.107.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.39.107.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9002 }
:if ([:len [/ip/route/find dst-address=45.39.108.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.39.108.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9002 }
