...
:if ([:len [/ip/route/find dst-address=37.230.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=37.230.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9049 }
...
:if ([:len [/ip/route/find dst-address=88.204.106.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=88.204.106.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9049 }
