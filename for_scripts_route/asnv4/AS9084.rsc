...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9084 and dst-address=for_scripts_route/asnv4/AS9084.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9084.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9084 }
