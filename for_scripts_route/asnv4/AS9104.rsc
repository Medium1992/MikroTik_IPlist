...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9104 and dst-address=for_scripts_route/asnv4/AS9104.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9104.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9104 }
