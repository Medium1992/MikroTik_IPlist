...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9136 and dst-address=for_scripts_route/asnv4/AS9136.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9136.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9136 }
