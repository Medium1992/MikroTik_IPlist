...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9144 and dst-address=for_scripts_route/asnv4/AS9144.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9144.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9144 }
