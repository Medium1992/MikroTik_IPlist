...
:if ([:len [/ip/route/find dst-address=46.248.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.248.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9153 }
:if ([:len [/ip/route/find dst-address=46.248.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.248.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9153 }
:if ([:len [/ip/route/find dst-address=46.248.108.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.248.108.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9153 }
:if ([:len [/ip/route/find dst-address=46.248.116.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.248.116.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9153 }
:if ([:len [/ip/route/find dst-address=46.248.124.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.248.124.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9153 }
