...
:if ([:len [/ip/route/find dst-address=46.248.120.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.248.120.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9153 }
:if ([:len [/ip/route/find dst-address=46.248.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.248.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9153 }
