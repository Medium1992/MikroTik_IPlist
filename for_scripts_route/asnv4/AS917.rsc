...
:if ([:len [/ip/route/find dst-address=38.175.100.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.175.100.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS917 }
:if ([:len [/ip/route/find dst-address=38.175.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.175.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS917 }
:if ([:len [/ip/route/find dst-address=38.175.104.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.175.104.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS917 }
...
:if ([:len [/ip/route/find dst-address=38.175.96.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.175.96.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS917 }
