...
:if ([:len [/ip/route/find dst-address=201.78.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.78.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS917 }
...
:if ([:len [/ip/route/find dst-address=38.175.96.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.175.96.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS917 }
