...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9183 and dst-address=for_scripts_route/asnv4/AS9183.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9183.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9183 }
