...
:if ([:len [/ip/route/find dst-address=213.35.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.35.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9193 }
:if ([:len [/ip/route/find dst-address=213.35.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.35.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9193 }
...
:if ([:len [/ip/route/find dst-address=62.32.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=62.32.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9193 }
