...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9211 and dst-address=for_scripts_route/asnv4/AS9211.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9211.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9211 }
