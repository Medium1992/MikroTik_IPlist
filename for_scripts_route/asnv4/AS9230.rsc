...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.129.245.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.129.245.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9230 }
:if ([:len [/ip/route/find dst-address=103.129.246.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.129.246.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9230 }
...
:if ([:len [/ip/route/find dst-address=150.129.16.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.129.16.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9230 }
