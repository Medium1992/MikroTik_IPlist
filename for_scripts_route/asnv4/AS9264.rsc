...
:if ([:len [/ip/route/find dst-address=117.103.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.103.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9264 }
:if ([:len [/ip/route/find dst-address=117.103.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=117.103.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9264 }
