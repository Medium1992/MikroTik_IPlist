...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9271 and dst-address=for_scripts_route/asnv4/AS9271.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9271.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9271 }
