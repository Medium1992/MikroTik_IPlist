...
:if ([:len [/ip/route/find dst-address=201.50.36.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.50.36.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9312 }
:if ([:len [/ip/route/find dst-address=201.50.40.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.50.40.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9312 }
:if ([:len [/ip/route/find dst-address=201.50.44.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=201.50.44.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9312 }
