...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=61.255.197.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.255.197.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9318 }
...
:if ([:len [/ip/route/find dst-address=61.255.64.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.255.64.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9318 }
