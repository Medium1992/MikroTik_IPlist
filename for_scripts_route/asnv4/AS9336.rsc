...
:if ([:len [/ip/route/find dst-address=218.185.232.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.232.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.0/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.0/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.16/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.16/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.4/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.4/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.6/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.6/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.236.8/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.236.8/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.237.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.237.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
:if ([:len [/ip/route/find dst-address=218.185.238.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=218.185.238.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9336 }
