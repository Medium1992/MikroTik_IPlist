...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.142.251.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.142.251.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9340 }
:if ([:len [/ip/route/find dst-address=103.15.12.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.15.12.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9340 }
:if ([:len [/ip/route/find dst-address=103.163.22.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.163.22.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9340 }
:if ([:len [/ip/route/find dst-address=103.164.252.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.164.252.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9340 }
:if ([:len [/ip/route/find dst-address=103.196.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.196.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9340 }
:if ([:len [/ip/route/find dst-address=103.196.45.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.196.45.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9340 }
