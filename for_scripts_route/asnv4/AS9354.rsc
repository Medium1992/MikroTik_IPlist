...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9354 and dst-address=for_scripts_route/asnv4/AS9354.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9354.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9354 }
