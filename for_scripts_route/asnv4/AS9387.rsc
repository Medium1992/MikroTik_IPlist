...
:if ([:len [/ip/route/find dst-address=180.178.137.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.178.137.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9387 }
:if ([:len [/ip/route/find dst-address=180.178.138.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.178.138.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9387 }
...
:if ([:len [/ip/route/find dst-address=180.178.175.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=180.178.175.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9387 }
