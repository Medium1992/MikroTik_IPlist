...
:if ([:len [/ip/route/find dst-address=113.49.16.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.49.16.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9389 }
...
:if ([:len [/ip/route/find dst-address=118.65.0.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=118.65.0.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9389 }
