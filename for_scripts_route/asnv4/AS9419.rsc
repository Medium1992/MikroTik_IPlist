...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9419 and dst-address=for_scripts_route/asnv4/AS9419.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9419.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9419 }
