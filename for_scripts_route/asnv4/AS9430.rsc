...
:if ([:len [/ip/route/find dst-address=203.100.66.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.100.66.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
:if ([:len [/ip/route/find dst-address=203.100.68.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.100.68.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
...
:if ([:len [/ip/route/find dst-address=203.190.136.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.190.136.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
