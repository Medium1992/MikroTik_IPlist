...
:if ([:len [/ip/route/find dst-address=164.164.190.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=164.164.190.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
...
:if ([:len [/ip/route/find dst-address=203.100.64.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.100.64.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
...
:if ([:len [/ip/route/find dst-address=203.190.128.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.190.128.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
:if ([:len [/ip/route/find dst-address=203.190.136.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.190.136.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
:if ([:len [/ip/route/find dst-address=203.190.140.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.190.140.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
:if ([:len [/ip/route/find dst-address=203.190.142.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.190.142.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
...
:if ([:len [/ip/route/find dst-address=45.120.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.120.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9430 }
