...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9431 and dst-address=for_scripts_route/asnv4/AS9431.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9431.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9431 }
