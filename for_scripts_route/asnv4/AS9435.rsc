...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=202.5.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.5.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9435 }
...
:if ([:len [/ip/route/find dst-address=203.0.209.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.0.209.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9435 }
