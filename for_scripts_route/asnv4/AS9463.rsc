...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=202.74.128.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.74.128.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9463 }
:if ([:len [/ip/route/find dst-address=202.74.136.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.74.136.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9463 }
