...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9491 and dst-address=for_scripts_route/asnv4/AS9491.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9491.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9491 }
