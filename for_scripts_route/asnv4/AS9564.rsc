...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9564 and dst-address=for_scripts_route/asnv4/AS9564.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9564.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9564 }
