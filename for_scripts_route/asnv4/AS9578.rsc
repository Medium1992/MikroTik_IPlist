...
:if ([:len [/ip/route/find dst-address=115.92.14.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.92.14.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9578 }
...
:if ([:len [/ip/route/find dst-address=61.101.38.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.101.38.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9578 }
