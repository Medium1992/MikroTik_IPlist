...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=49.97.204.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.97.204.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9605 }
:if ([:len [/ip/route/find dst-address=49.97.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.97.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9605 }
:if ([:len [/ip/route/find dst-address=49.97.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.97.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9605 }
:if ([:len [/ip/route/find dst-address=49.97.28.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.97.28.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9605 }
