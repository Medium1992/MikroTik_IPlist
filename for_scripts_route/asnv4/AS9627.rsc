...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=116.193.194.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.193.194.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9627 }
:if ([:len [/ip/route/find dst-address=116.193.196.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.193.196.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9627 }
:if ([:len [/ip/route/find dst-address=116.193.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=116.193.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9627 }
