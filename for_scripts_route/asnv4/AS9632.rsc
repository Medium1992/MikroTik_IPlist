...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9632 and dst-address=for_scripts_route/asnv4/AS9632.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9632.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9632 }
