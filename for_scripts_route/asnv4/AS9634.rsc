...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9634 and dst-address=for_scripts_route/asnv4/AS9634.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9634.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9634 }
