...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=131.226.2.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.226.2.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS965 }
:if ([:len [/ip/route/find dst-address=131.226.4.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=131.226.4.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS965 }
...
:if ([:len [/ip/route/find dst-address=194.177.13.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=194.177.13.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS965 }
...
:if ([:len [/ip/route/find dst-address=216.252.232.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.252.232.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS965 }
...
:if ([:len [/ip/route/find dst-address=23.172.138.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=23.172.138.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS965 }
