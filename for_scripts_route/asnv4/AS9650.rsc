...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9650 and dst-address=for_scripts_route/asnv4/AS9650.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9650.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9650 }
