...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9738 and dst-address=for_scripts_route/asnv4/AS9738.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9738.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9738 }
