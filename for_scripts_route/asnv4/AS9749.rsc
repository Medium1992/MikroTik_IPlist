...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.251.144.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.251.144.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9749 }
:if ([:len [/ip/route/find dst-address=103.27.188.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.27.188.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9749 }
...
:if ([:len [/ip/route/find dst-address=202.61.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.61.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9749 }
