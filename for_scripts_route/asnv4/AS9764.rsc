...
:if ([:len [/ip/route/find dst-address=113.29.184.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.29.184.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9764 }
:if ([:len [/ip/route/find dst-address=113.29.188.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.29.188.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9764 }
:if ([:len [/ip/route/find dst-address=113.29.190.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=113.29.190.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9764 }
