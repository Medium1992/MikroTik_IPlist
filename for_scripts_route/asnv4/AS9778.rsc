...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=AS9778 and dst-address=for_scripts_route/asnv4/AS9778.rsc]] = 0) do={ add dst-address=for_scripts_route/asnv4/AS9778.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9778 }
