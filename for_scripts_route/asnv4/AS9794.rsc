...
:if ([:len [/ip/route/find dst-address=115.178.135.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=115.178.135.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9794 }
...
:if ([:len [/ip/route/find dst-address=203.201.160.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.201.160.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9794 }
:if ([:len [/ip/route/find dst-address=203.201.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.201.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9794 }
:if ([:len [/ip/route/find dst-address=203.201.166.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=203.201.166.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9794 }
