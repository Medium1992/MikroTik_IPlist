...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=59.90.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.90.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
:if ([:len [/ip/route/find dst-address=59.91.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.91.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
:if ([:len [/ip/route/find dst-address=59.92.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.92.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
:if ([:len [/ip/route/find dst-address=59.92.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.92.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
:if ([:len [/ip/route/find dst-address=59.92.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.92.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
:if ([:len [/ip/route/find dst-address=59.92.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.92.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
:if ([:len [/ip/route/find dst-address=59.92.76.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.92.76.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
:if ([:len [/ip/route/find dst-address=59.92.78.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=59.92.78.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9829 }
