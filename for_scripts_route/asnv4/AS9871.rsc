...
:if ([:len [/ip/route/find dst-address=114.128.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=114.128.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9871 }
...
:if ([:len [/ip/route/find dst-address=204.187.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=204.187.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9871 }
