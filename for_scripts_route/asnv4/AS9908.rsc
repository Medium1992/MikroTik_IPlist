...
:if ([:len [/ip/route/find dst-address=61.15.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.15.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
:if ([:len [/ip/route/find dst-address=61.15.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.15.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
