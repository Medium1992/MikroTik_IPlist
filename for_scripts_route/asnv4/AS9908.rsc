...
:if ([:len [/ip/route/find dst-address=61.15.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.15.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
:if ([:len [/ip/route/find dst-address=61.15.104.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.15.104.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
...
:if ([:len [/ip/route/find dst-address=61.15.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.15.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
:if ([:len [/ip/route/find dst-address=61.15.98.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.15.98.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
...
:if ([:len [/ip/route/find dst-address=72.57.128.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.57.128.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
