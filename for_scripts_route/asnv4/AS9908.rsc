...
:if ([:len [/ip/route/find dst-address=61.15.108.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.15.108.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
...
:if ([:len [/ip/route/find dst-address=72.57.176.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.57.176.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
:if ([:len [/ip/route/find dst-address=72.57.192.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=72.57.192.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9908 }
