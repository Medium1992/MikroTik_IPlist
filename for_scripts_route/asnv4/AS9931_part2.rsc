...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=61.19.220.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.19.220.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9931 }
:if ([:len [/ip/route/find dst-address=61.19.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.19.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9931 }
:if ([:len [/ip/route/find dst-address=61.19.224.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.19.224.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9931 }
:if ([:len [/ip/route/find dst-address=61.19.226.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.19.226.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9931 }
:if ([:len [/ip/route/find dst-address=61.19.228.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.19.228.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9931 }
:if ([:len [/ip/route/find dst-address=61.19.232.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.19.232.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9931 }
...
:if ([:len [/ip/route/find dst-address=61.7.192.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=61.7.192.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9931 }
