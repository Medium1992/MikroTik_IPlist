...
:if ([:len [/ip/route/find dst-address=202.179.24.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.179.24.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9934 }
:if ([:len [/ip/route/find dst-address=202.179.28.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.179.28.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9934 }
:if ([:len [/ip/route/find dst-address=202.179.30.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=202.179.30.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9934 }
