...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=1.201.134.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.201.134.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
:if ([:len [/ip/route/find dst-address=1.201.182.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.201.182.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
:if ([:len [/ip/route/find dst-address=1.201.210.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.201.210.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
:if ([:len [/ip/route/find dst-address=1.201.42.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=1.201.42.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
...
:if ([:len [/ip/route/find dst-address=139.150.217.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.150.217.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
:if ([:len [/ip/route/find dst-address=139.150.223.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=139.150.223.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
:if ([:len [/ip/route/find dst-address=182.161.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=182.161.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
...
:if ([:len [/ip/route/find dst-address=49.50.48.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.50.48.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
:if ([:len [/ip/route/find dst-address=49.50.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.50.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
:if ([:len [/ip/route/find dst-address=49.50.52.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=49.50.52.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9957 }
