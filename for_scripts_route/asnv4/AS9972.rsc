...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=103.52.200.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=103.52.200.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9972 }
...
:if ([:len [/ip/route/find dst-address=45.113.48.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.113.48.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS9972 }
