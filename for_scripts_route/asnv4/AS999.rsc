...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=208.89.72.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.89.72.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS999 }
...
:if ([:len [/ip/route/find dst-address=38.57.117.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.57.117.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS999 }
:if ([:len [/ip/route/find dst-address=38.57.118.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=38.57.118.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=AS999 }
