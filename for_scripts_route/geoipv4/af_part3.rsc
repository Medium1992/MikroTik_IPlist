...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=af and dst-address=for_scripts_route/geoipv4/af_part3.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/af_part3.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=af }
