...
:if ([:len [/ip/route/find dst-address=92.246.142.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.246.142.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=am }
...
:if ([:len [/ip/route/find dst-address=93.185.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.185.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=am }
...
:if ([:len [/ip/route/find dst-address=94.141.100.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.141.100.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=am }
:if ([:len [/ip/route/find dst-address=94.154.127.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.154.127.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=am }
...
:if ([:len [/ip/route/find dst-address=95.142.113.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.142.113.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=am }
:if ([:len [/ip/route/find dst-address=95.174.121.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.174.121.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=am }
:if ([:len [/ip/route/find dst-address=95.174.122.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.174.122.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=am }
