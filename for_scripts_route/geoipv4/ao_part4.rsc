...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=ao and dst-address=for_scripts_route/geoipv4/ao_part4.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/ao_part4.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ao }
