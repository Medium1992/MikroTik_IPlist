...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=94.16.27.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.16.27.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=at }
:if ([:len [/ip/route/find dst-address=94.16.28.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.16.28.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=at }
:if ([:len [/ip/route/find dst-address=94.16.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.16.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=at }
...
:if ([:len [/ip/route/find dst-address=94.199.102.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.199.102.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=at }
...
:if ([:len [/ip/route/find dst-address=94.228.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.228.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=at }
:if ([:len [/ip/route/find dst-address=94.228.165.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.228.165.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=at }
...
:if ([:len [/ip/route/find dst-address=95.171.236.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.171.236.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=at }
