...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=be and dst-address=for_scripts_route/geoipv4/be_part56.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/be_part56.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=be }
