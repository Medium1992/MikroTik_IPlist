...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=41.79.219.12/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.219.12/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
:if ([:len [/ip/route/find dst-address=41.79.219.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.219.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
:if ([:len [/ip/route/find dst-address=41.79.219.15/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.219.15/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
:if ([:len [/ip/route/find dst-address=41.79.219.16/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.219.16/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
:if ([:len [/ip/route/find dst-address=41.79.219.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.219.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
:if ([:len [/ip/route/find dst-address=41.79.219.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.219.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
:if ([:len [/ip/route/find dst-address=41.79.219.8/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.79.219.8/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
