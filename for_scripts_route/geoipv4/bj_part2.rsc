...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=bj and dst-address=for_scripts_route/geoipv4/bj_part2.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/bj_part2.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bj }
