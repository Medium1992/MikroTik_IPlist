...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=96.6.123.188/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.188/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.198/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.198/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.204/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.204/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.206/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.206/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.212/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.212/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.221/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.221/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.222/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.222/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.228/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.228/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.236/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.236/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.244/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.244/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.123.247/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.123.247/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.158.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.158.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
:if ([:len [/ip/route/find dst-address=96.6.208.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.6.208.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=br }
