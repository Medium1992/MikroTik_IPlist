...
:if ([:len [/ip/route/find dst-address=179.65.114.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=179.65.114.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bt }
...
:if ([:len [/ip/route/find dst-address=43.226.8.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=43.226.8.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bt }
...
:if ([:len [/ip/route/find dst-address=45.15.177.116/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.15.177.116/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bt }
:if ([:len [/ip/route/find dst-address=45.15.177.52/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.15.177.52/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bt }
...
:if ([:len [/ip/route/find dst-address=45.89.99.116/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.89.99.116/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bt }
:if ([:len [/ip/route/find dst-address=45.89.99.52/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.89.99.52/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bt }
