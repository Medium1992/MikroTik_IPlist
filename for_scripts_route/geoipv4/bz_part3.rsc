...
:if ([:len [/ip/route/find dst-address=91.212.150.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.212.150.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bz }
...
:if ([:len [/ip/route/find dst-address=94.74.164.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.74.164.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bz }
