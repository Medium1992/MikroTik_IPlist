...
:if ([:len [/ip/route/find dst-address=99.240.0.0/13 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.240.0.0/13 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.248.0.0/15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.248.0.0/15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.128.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.128.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.144.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.144.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.128/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.128/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.160/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.160/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.162/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.162/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.164/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.164/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.168/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.168/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.145.192/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.145.192/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.146.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.146.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.148.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.148.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.152.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.152.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.250.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.250.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
