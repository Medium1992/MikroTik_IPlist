...
:if ([:len [/ip/route/find dst-address=99.224.0.0/14 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.224.0.0/14 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
:if ([:len [/ip/route/find dst-address=99.228.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.228.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ca }
