...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=cc and dst-address=for_scripts_route/geoipv4/cc.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/cc.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
