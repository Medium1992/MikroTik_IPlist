...
:if ([:len [/ip/route/find dst-address=150.48.183.36/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.183.36/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=150.48.187.16/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.187.16/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=150.48.189.100/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.189.100/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=150.48.189.70/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.189.70/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=150.48.189.72/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.189.72/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=150.48.189.80/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.189.80/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=150.48.189.96/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.189.96/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=157.5.101.186/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.5.101.186/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=157.5.109.186/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.5.109.186/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=157.5.123.149/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.5.123.149/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
:if ([:len [/ip/route/find dst-address=157.5.123.150/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.5.123.150/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cc }
