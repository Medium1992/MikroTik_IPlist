...
:if ([:len [/ip/route/find dst-address=5.62.62.97/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.62.62.97/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cd }
:if ([:len [/ip/route/find dst-address=5.62.62.98/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.62.62.98/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cd }
...
:if ([:len [/ip/route/find dst-address=81.199.83.176/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.199.83.176/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cd }
