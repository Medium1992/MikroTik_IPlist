...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=cloudflare and dst-address=for_scripts_route/geoipv4/cloudflare_part7.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/cloudflare_part7.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cloudflare }
