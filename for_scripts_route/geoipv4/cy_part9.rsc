...
:if ([:len [/ip/route/find dst-address=94.78.67.0/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.0/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
:if ([:len [/ip/route/find dst-address=94.78.67.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
:if ([:len [/ip/route/find dst-address=94.78.67.16/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.16/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
:if ([:len [/ip/route/find dst-address=94.78.67.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
:if ([:len [/ip/route/find dst-address=94.78.67.4/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.4/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
:if ([:len [/ip/route/find dst-address=94.78.67.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
:if ([:len [/ip/route/find dst-address=94.78.67.7/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.7/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
:if ([:len [/ip/route/find dst-address=94.78.67.8/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.78.67.8/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cy }
