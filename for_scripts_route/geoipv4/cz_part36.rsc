...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=95.46.157.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.46.157.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
...
:if ([:len [/ip/route/find dst-address=95.46.198.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.46.198.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
...
:if ([:len [/ip/route/find dst-address=95.46.224.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.46.224.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
...
:if ([:len [/ip/route/find dst-address=95.85.236.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.236.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
...
:if ([:len [/ip/route/find dst-address=95.85.249.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.249.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
:if ([:len [/ip/route/find dst-address=95.85.250.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.250.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
:if ([:len [/ip/route/find dst-address=95.85.252.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.252.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
