...
:if ([:len [/ip/route/find dst-address=95.47.96.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.47.96.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
:if ([:len [/ip/route/find dst-address=95.47.98.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.47.98.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
...
:if ([:len [/ip/route/find dst-address=95.85.192.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.85.192.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cz }
