...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=dk and dst-address=for_scripts_route/geoipv4/dk_part37.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/dk_part37.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=dk }
