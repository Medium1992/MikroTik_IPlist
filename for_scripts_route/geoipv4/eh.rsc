...
:if ([:len [/ip/route/find dst-address=150.48.150.80/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.150.80/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=150.48.185.134/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.185.134/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=150.48.185.136/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.185.136/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=150.48.185.144/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.185.144/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=150.48.185.160/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.185.160/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=150.48.185.164/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.185.164/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=150.48.186.242/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.186.242/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=150.48.186.244/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=150.48.186.244/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=154.150.4.198/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=154.150.4.198/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=157.5.101.46/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.5.101.46/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=157.5.109.46/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=157.5.109.46/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
:if ([:len [/ip/route/find dst-address=160.176.122.156/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=160.176.122.156/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=eh }
