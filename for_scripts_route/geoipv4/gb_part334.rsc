...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=gb and dst-address=for_scripts_route/geoipv4/gb_part334.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/gb_part334.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gb }
