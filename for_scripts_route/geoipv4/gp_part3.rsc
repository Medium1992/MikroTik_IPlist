...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=81.248.128.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.248.128.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gp }
...
:if ([:len [/ip/route/find dst-address=82.197.107.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.197.107.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gp }
:if ([:len [/ip/route/find dst-address=82.197.107.16/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.197.107.16/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gp }
:if ([:len [/ip/route/find dst-address=82.197.107.2/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.197.107.2/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gp }
:if ([:len [/ip/route/find dst-address=82.197.107.32/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.197.107.32/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gp }
