...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=gt and dst-address=for_scripts_route/geoipv4/gt_part6.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/gt_part6.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=gt }
