...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=id and dst-address=for_scripts_route/geoipv4/id_part63.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/id_part63.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=id }
