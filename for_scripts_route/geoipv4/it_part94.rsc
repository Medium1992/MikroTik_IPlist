...
:if ([:len [/ip/route/find dst-address=96.45.41.113/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.45.41.113/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=it }
