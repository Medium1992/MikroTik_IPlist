...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=80.90.160.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=80.90.160.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=81.21.0.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.0.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=81.21.3.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.3.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=81.21.4.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.4.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=81.21.7.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.7.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=81.21.8.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=81.21.8.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
...
:if ([:len [/ip/route/find dst-address=91.106.96.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=91.106.96.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
...
:if ([:len [/ip/route/find dst-address=92.253.0.0/17 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.253.0.0/17 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=93.114.12.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.114.12.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=93.115.15.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.115.15.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=93.115.2.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.115.2.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=93.191.176.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.191.176.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=93.93.144.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.93.144.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=93.95.200.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=93.95.200.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=94.127.208.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.127.208.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
:if ([:len [/ip/route/find dst-address=94.142.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=94.142.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jo }
