...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=ke and dst-address=for_scripts_route/geoipv4/ke_part9.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/ke_part9.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ke }
