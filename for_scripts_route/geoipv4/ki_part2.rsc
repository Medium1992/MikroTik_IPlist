...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=ki and dst-address=for_scripts_route/geoipv4/ki_part2.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/ki_part2.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ki }
