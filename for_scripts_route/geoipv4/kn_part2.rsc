...
:if ([:len [/ip/route/find dst-address=209.59.91.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.91.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
