...
:if ([:len [/ip/route/find dst-address=209.59.90.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.90.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.91.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.91.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
...
:if ([:len [/ip/route/find dst-address=5.175.190.199/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.175.190.199/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
