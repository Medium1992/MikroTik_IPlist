...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=209.59.112.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.112.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.64.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.64.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.72.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.72.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.74.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.74.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.74.128/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.74.128/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.74.136/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.74.136/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.74.140/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.74.140/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.74.142/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.74.142/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
:if ([:len [/ip/route/find dst-address=209.59.74.144/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.59.74.144/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
...
:if ([:len [/ip/route/find dst-address=69.57.254.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=69.57.254.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kn }
