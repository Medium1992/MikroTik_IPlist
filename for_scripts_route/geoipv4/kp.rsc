...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=kp and dst-address=for_scripts_route/geoipv4/kp.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/kp.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kp }
