...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=lv and dst-address=for_scripts_route/geoipv4/lv_part12.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/lv_part12.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=lv }
