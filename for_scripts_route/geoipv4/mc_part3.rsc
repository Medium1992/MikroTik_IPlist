...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=mc and dst-address=for_scripts_route/geoipv4/mc_part3.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/mc_part3.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mc }
