...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=mu and dst-address=for_scripts_route/geoipv4/mu_part8.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/mu_part8.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
