...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=45.206.46.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.46.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.48.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.48.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.56.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.56.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.61.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.61.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.64.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.64.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.67.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.67.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.74.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.74.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.76.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.76.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.8.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.8.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.206.80.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.206.80.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.207.163.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.207.163.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.207.167.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.207.167.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
...
:if ([:len [/ip/route/find dst-address=45.207.172.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.207.172.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
...
:if ([:len [/ip/route/find dst-address=45.207.42.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.207.42.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
:if ([:len [/ip/route/find dst-address=45.207.46.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=45.207.46.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mu }
