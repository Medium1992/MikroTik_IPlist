...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=my and dst-address=for_scripts_route/geoipv4/my_part24.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/my_part24.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=my }
