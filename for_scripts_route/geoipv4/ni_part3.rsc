...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=209.124.106.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.124.106.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ni }
:if ([:len [/ip/route/find dst-address=209.161.125.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=209.161.125.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ni }
...
:if ([:len [/ip/route/find dst-address=66.234.155.0/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=66.234.155.0/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ni }
