...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=no and dst-address=for_scripts_route/geoipv4/no_part31.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/no_part31.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=no }
