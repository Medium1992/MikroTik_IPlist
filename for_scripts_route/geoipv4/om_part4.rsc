...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=om and dst-address=for_scripts_route/geoipv4/om_part4.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/om_part4.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=om }
