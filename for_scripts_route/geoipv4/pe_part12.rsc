...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=pe and dst-address=for_scripts_route/geoipv4/pe_part12.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/pe_part12.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=pe }
