...
:if ([:len [/ip/route/find dst-address=8.48.6.100/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.48.6.100/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=pr }
:if ([:len [/ip/route/find dst-address=8.48.6.104/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.48.6.104/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=pr }
:if ([:len [/ip/route/find dst-address=8.48.6.112/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=8.48.6.112/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=pr }
