...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=private and dst-address=for_scripts_route/geoipv4/private.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/private.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=private }
