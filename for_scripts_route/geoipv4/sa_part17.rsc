...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=sa and dst-address=for_scripts_route/geoipv4/sa_part17.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/sa_part17.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sa }
