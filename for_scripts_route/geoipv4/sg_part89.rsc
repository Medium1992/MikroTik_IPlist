...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=sg and dst-address=for_scripts_route/geoipv4/sg_part89.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/sg_part89.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sg }
