...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=sh and dst-address=for_scripts_route/geoipv4/sh.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/sh.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sh }
