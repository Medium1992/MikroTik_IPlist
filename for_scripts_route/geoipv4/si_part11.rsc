...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=92.42.201.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.42.201.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
...
:if ([:len [/ip/route/find dst-address=92.60.64.0/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.0/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.64.128/25 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.128/25 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.64.32/28 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.32/28 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.64.48/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.48/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.64.56/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.56/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.64.60/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.60/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.64.62/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.62/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.64.64/26 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.64.64/26 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.65.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.65.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.66.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.66.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
:if ([:len [/ip/route/find dst-address=92.60.68.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=92.60.68.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
