...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=si and dst-address=for_scripts_route/geoipv4/si_part12.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/si_part12.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=si }
