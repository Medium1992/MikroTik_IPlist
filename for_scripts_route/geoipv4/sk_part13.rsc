...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=sk and dst-address=for_scripts_route/geoipv4/sk_part13.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/sk_part13.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sk }
