...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=213.156.255.4/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=213.156.255.4/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=td }
...
:if ([:len [/ip/route/find dst-address=74.244.68.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=74.244.68.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=td }
