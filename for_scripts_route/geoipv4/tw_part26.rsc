...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=tw and dst-address=for_scripts_route/geoipv4/tw_part26.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/tw_part26.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=tw }
