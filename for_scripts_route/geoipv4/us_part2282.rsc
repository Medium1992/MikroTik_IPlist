...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=us and dst-address=for_scripts_route/geoipv4/us_part2282.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/us_part2282.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=us }
