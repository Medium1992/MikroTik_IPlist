...
:if ([:len [/ip/route/find dst-address=82.86.88.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.86.88.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ve }
:if ([:len [/ip/route/find dst-address=82.86.90.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.86.90.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ve }
:if ([:len [/ip/route/find dst-address=82.86.92.0/22 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.86.92.0/22 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ve }
