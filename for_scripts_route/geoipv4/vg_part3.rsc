...
:if ([:len [/ip/route/find dst-address=89.38.152.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.38.152.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vg }
...
:if ([:len [/ip/route/find dst-address=89.44.83.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=89.44.83.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vg }
