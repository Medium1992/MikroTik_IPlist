...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=98.142.163.120/30 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.142.163.120/30 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
...
:if ([:len [/ip/route/find dst-address=98.97.50.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=98.97.50.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
