...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=vi and dst-address=for_scripts_route/geoipv4/vi_part3.rsc]] = 0) do={ add dst-address=for_scripts_route/geoipv4/vi_part3.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vi }
