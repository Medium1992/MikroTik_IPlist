...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=41.175.155.76/31 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.175.155.76/31 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=zw }
...
:if ([:len [/ip/route/find dst-address=41.175.186.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.175.186.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=zw }
...
:if ([:len [/ip/route/find dst-address=41.60.32.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=41.60.32.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=zw }
