...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=anilibria.tv and dst-address=for_scripts_route/iplistCIDRv4/anilibria.tv.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/anilibria.tv.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=anilibria.tv }
