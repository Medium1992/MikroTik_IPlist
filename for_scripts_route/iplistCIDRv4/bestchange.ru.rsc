...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.20.17.195/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.20.17.195/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
:if ([:len [/ip/route/find dst-address=109.238.88.180/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=109.238.88.180/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
:if ([:len [/ip/route/find dst-address=138.249.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=138.249.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
...
:if ([:len [/ip/route/find dst-address=172.66.145.174/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.66.145.174/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
:if ([:len [/ip/route/find dst-address=185.137.232.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.137.232.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
:if ([:len [/ip/route/find dst-address=186.2.165.47/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.2.165.47/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
:if ([:len [/ip/route/find dst-address=186.2.165.82/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=186.2.165.82/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
...
:if ([:len [/ip/route/find dst-address=193.187.173.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.187.173.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
