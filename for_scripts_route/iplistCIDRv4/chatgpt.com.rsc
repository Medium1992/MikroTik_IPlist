...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=chatgpt.com and dst-address=for_scripts_route/iplistCIDRv4/chatgpt.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/chatgpt.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=chatgpt.com }
