...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=chess.com and dst-address=for_scripts_route/iplistCIDRv4/chess.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/chess.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=chess.com }
