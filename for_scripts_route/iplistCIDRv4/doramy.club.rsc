...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=doramy.club and dst-address=for_scripts_route/iplistCIDRv4/doramy.club.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/doramy.club.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=doramy.club }
