...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.21.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.21.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
:if ([:len [/ip/route/find dst-address=162.210.192.0/21 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.210.192.0/21 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
...
:if ([:len [/ip/route/find dst-address=172.67.209.224/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.67.209.224/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
:if ([:len [/ip/route/find dst-address=173.234.144.0/20 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=173.234.144.0/20 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
...
:if ([:len [/ip/route/find dst-address=44.233.250.75/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=44.233.250.75/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
...
:if ([:len [/ip/route/find dst-address=52.38.196.63/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=52.38.196.63/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
:if ([:len [/ip/route/find dst-address=64.120.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.120.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
:if ([:len [/ip/route/find dst-address=64.31.0.0/18 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=64.31.0.0/18 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
...
:if ([:len [/ip/route/find dst-address=78.157.209.168/29 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=78.157.209.168/29 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
:if ([:len [/ip/route/find dst-address=82.192.80.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=82.192.80.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
:if ([:len [/ip/route/find dst-address=85.17.5.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=85.17.5.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
:if ([:len [/ip/route/find dst-address=95.211.136.160/27 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.211.136.160/27 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=fmhy.net }
