...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=grok.com and dst-address=for_scripts_route/iplistCIDRv4/grok.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/grok.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=grok.com }
