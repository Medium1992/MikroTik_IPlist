...
:if ([:len [/ip/route/find dst-address=13.48.0.0/13 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=13.48.0.0/13 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=grok.com }
