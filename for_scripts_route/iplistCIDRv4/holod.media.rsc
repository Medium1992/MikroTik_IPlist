...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=holod.media and dst-address=for_scripts_route/iplistCIDRv4/holod.media.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/holod.media.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=holod.media }
