...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=jetbrains%40cdn and dst-address=for_scripts_route/iplistCIDRv4/jetbrains%40cdn.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/jetbrains%40cdn.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jetbrains%40cdn }
