...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=jut.su and dst-address=for_scripts_route/iplistCIDRv4/jut.su_part3.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/jut.su_part3.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=jut.su }
