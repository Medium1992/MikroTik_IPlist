...
:if ([:len [/ip/route/find dst-address=87.236.16.19/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=87.236.16.19/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kara.su }
