...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=kasparov.ru and dst-address=for_scripts_route/iplistCIDRv4/kasparov.ru.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/kasparov.ru.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kasparov.ru }
