...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=kavkaz-uzel.eu and dst-address=for_scripts_route/iplistCIDRv4/kavkaz-uzel.eu.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/kavkaz-uzel.eu.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kavkaz-uzel.eu }
