...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=kino.pub and dst-address=for_scripts_route/iplistCIDRv4/kino.pub.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/kino.pub.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kino.pub }
