...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=kinozal.me and dst-address=for_scripts_route/iplistCIDRv4/kinozal.me.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/kinozal.me.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kinozal.me }
