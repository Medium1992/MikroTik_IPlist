...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=linktr.ee and dst-address=for_scripts_route/iplistCIDRv4/linktr.ee.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/linktr.ee.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=linktr.ee }
