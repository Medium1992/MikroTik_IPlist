...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=make.com and dst-address=for_scripts_route/iplistCIDRv4/make.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/make.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=make.com }
