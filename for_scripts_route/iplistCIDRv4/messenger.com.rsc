...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=messenger.com and dst-address=for_scripts_route/iplistCIDRv4/messenger.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/messenger.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=messenger.com }
