...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.20.26.66/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.20.26.66/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=navalny.com }
...
:if ([:len [/ip/route/find dst-address=172.66.156.251/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.66.156.251/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=navalny.com }
