...
:if ([:len [/ip/route/find dst-address=104.20.34.97/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.20.34.97/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=novayagazeta.ru }
...
:if ([:len [/ip/route/find dst-address=172.66.169.237/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.66.169.237/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=novayagazeta.ru }
