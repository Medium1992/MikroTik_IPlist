...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=pixiv.net and dst-address=for_scripts_route/iplistCIDRv4/pixiv.net.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/pixiv.net.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=pixiv.net }
