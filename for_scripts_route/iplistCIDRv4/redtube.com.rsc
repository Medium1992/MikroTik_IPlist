...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=208.99.64.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=208.99.64.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=redtube.com }
:if ([:len [/ip/route/find dst-address=216.18.160.0/19 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=216.18.160.0/19 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=redtube.com }
