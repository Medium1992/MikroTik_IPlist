...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=refactoring.guru and dst-address=for_scripts_route/iplistCIDRv4/refactoring.guru.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/refactoring.guru.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=refactoring.guru }
