...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=rutor.info and dst-address=for_scripts_route/iplistCIDRv4/rutor.info.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/rutor.info.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rutor.info }
