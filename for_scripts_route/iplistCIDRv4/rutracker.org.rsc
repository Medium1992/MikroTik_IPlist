...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=rutracker.org and dst-address=for_scripts_route/iplistCIDRv4/rutracker.org.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/rutracker.org.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rutracker.org }
