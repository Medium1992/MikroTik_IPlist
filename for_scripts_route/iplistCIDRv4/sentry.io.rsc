...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=sentry.io and dst-address=for_scripts_route/iplistCIDRv4/sentry.io.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/sentry.io.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=sentry.io }
