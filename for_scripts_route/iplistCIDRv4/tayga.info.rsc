...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=tayga.info and dst-address=for_scripts_route/iplistCIDRv4/tayga.info.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/tayga.info.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=tayga.info }
