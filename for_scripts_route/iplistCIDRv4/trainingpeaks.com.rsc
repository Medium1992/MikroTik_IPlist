...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=trainingpeaks.com and dst-address=for_scripts_route/iplistCIDRv4/trainingpeaks.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/trainingpeaks.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=trainingpeaks.com }
