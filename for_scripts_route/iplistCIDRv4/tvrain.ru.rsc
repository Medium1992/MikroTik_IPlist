...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=tvrain.ru and dst-address=for_scripts_route/iplistCIDRv4/tvrain.ru.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/tvrain.ru.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=tvrain.ru }
