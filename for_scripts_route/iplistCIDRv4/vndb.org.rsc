...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=vndb.org and dst-address=for_scripts_route/iplistCIDRv4/vndb.org.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/vndb.org.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vndb.org }
