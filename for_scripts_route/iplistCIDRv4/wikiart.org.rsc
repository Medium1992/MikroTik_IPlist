...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=wikiart.org and dst-address=for_scripts_route/iplistCIDRv4/wikiart.org.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/wikiart.org.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=wikiart.org }
