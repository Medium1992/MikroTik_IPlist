...
:global GateWay
/ip route
:if ([:len [/ip/route/find dst-address=104.18.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=104.18.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
...
:if ([:len [/ip/route/find dst-address=140.248.0.0/16 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=140.248.0.0/16 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
...
:if ([:len [/ip/route/find dst-address=162.159.140.229/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=162.159.140.229/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
:if ([:len [/ip/route/find dst-address=172.64.148.197/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.64.148.197/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
:if ([:len [/ip/route/find dst-address=172.64.150.129/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.64.150.129/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
:if ([:len [/ip/route/find dst-address=172.64.151.110/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.64.151.110/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
:if ([:len [/ip/route/find dst-address=172.66.0.227/32 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.66.0.227/32 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
