...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=x.com and dst-address=for_scripts_route/iplistCIDRv4/x.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistCIDRv4/x.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=x.com }
