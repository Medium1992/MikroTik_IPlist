...
:if ([:len [/ip/route/find dst-address=176.58.38.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.58.38.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=yummyanime.tv }
:if ([:len [/ip/route/find dst-address=176.58.48.0/23 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.58.48.0/23 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=yummyanime.tv }
:if ([:len [/ip/route/find dst-address=176.58.56.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=176.58.56.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=yummyanime.tv }
...
:if ([:len [/ip/route/find dst-address=190.115.16.0/24 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=190.115.16.0/24 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=yummyanime.tv }
