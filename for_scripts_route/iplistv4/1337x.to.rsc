...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=1337x.to and dst-address=for_scripts_route/iplistv4/1337x.to.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/1337x.to.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=1337x.to }
