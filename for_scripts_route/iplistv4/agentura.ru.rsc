...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=agentura.ru and dst-address=for_scripts_route/iplistv4/agentura.ru.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/agentura.ru.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=agentura.ru }
