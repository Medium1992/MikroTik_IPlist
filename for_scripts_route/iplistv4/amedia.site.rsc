...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=amedia.site and dst-address=for_scripts_route/iplistv4/amedia.site.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/amedia.site.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=amedia.site }
