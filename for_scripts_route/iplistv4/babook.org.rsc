...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=babook.org and dst-address=for_scripts_route/iplistv4/babook.org.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/babook.org.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=babook.org }
