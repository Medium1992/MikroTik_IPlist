...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=bato.to and dst-address=for_scripts_route/iplistv4/bato.to.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/bato.to.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bato.to }
