...
:if ([:len [/ip/route/find dst-address=99.86.89.162 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=99.86.89.162 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bbc.com }
