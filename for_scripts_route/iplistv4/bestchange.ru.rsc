...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=bestchange.ru and dst-address=for_scripts_route/iplistv4/bestchange.ru.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/bestchange.ru.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=bestchange.ru }
