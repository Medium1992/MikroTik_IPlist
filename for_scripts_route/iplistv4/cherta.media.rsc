...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=cherta.media and dst-address=for_scripts_route/iplistv4/cherta.media.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/cherta.media.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=cherta.media }
