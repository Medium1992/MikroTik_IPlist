...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=combotech and dst-address=for_scripts_route/iplistv4/combotech.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/combotech.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=combotech }
