...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=connect.garmin.com and dst-address=for_scripts_route/iplistv4/connect.garmin.com.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/connect.garmin.com.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=connect.garmin.com }
