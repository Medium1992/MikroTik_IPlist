...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=discord.media and dst-address=for_scripts_route/iplistv4/discord.media.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/discord.media.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=discord.media }
