...
:if ([:len [/ip/route/find dst-address=193.233.63.15 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=193.233.63.15 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=doramy.club }
:if ([:len [/ip/route/find dst-address=5.252.32.173 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=5.252.32.173 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=doramy.club }
