...
:if ([:len [/ip/route/find dst-address=46.224.0.219 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.224.0.219 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=echofm.online }
:if ([:len [/ip/route/find dst-address=46.224.109.214 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=46.224.109.214 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=echofm.online }
