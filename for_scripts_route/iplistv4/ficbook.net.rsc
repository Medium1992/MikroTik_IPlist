...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=ficbook.net and dst-address=for_scripts_route/iplistv4/ficbook.net.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/ficbook.net.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ficbook.net }
