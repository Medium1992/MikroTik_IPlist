...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=filmitorrent.net and dst-address=for_scripts_route/iplistv4/filmitorrent.net.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/filmitorrent.net.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=filmitorrent.net }
