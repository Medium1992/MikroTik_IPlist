...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=filmix.fm and dst-address=for_scripts_route/iplistv4/filmix.fm.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/filmix.fm.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=filmix.fm }
