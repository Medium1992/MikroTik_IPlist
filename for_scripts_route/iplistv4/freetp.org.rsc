...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=freetp.org and dst-address=for_scripts_route/iplistv4/freetp.org.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/freetp.org.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=freetp.org }
