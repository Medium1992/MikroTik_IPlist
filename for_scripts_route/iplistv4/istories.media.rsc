...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=istories.media and dst-address=for_scripts_route/iplistv4/istories.media.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/istories.media.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=istories.media }
