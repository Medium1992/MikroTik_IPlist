...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=kinobase.org and dst-address=for_scripts_route/iplistv4/kinobase.org.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/kinobase.org.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kinobase.org }
