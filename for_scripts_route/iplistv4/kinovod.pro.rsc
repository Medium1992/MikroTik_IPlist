...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=kinovod.pro and dst-address=for_scripts_route/iplistv4/kinovod.pro.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/kinovod.pro.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kinovod.pro }
