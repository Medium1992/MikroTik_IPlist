...
:if ([:len [/ip/route/find dst-address=185.93.104.177 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=185.93.104.177 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=kinovod.pro }
