...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=make.com and dst-address=for_scripts_route/iplistv4/make.com_part16.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/make.com_part16.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=make.com }
