...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=mangapark.net and dst-address=for_scripts_route/iplistv4/mangapark.net.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/mangapark.net.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mangapark.net }
