...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=meduza.io and dst-address=for_scripts_route/iplistv4/meduza.io.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/meduza.io.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=meduza.io }
