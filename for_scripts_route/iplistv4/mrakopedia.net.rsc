...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=mrakopedia.net and dst-address=for_scripts_route/iplistv4/mrakopedia.net.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/mrakopedia.net.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=mrakopedia.net }
