...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=newtimes.ru and dst-address=for_scripts_route/iplistv4/newtimes.ru.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/newtimes.ru.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=newtimes.ru }
