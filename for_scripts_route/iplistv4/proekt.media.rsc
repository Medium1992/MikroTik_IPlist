...
:if ([:len [/ip/route/find dst-address=172.234.24.211 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.234.24.211 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=proekt.media }
:if ([:len [/ip/route/find dst-address=172.239.57.117 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=172.239.57.117 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=proekt.media }
