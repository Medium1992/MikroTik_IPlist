...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=prostovpn.org and dst-address=for_scripts_route/iplistv4/prostovpn.org.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/prostovpn.org.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=prostovpn.org }
