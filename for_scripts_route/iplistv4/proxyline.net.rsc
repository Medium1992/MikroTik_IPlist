...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=proxyline.net and dst-address=for_scripts_route/iplistv4/proxyline.net.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/proxyline.net.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=proxyline.net }
