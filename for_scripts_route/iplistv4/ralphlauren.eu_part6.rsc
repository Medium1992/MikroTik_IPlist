...
:if ([:len [/ip/route/find dst-address=95.101.74.92 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=95.101.74.92 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ralphlauren.eu }
...
:if ([:len [/ip/route/find dst-address=96.16.248.163 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.16.248.163 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ralphlauren.eu }
...
:if ([:len [/ip/route/find dst-address=96.17.150.154 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.17.150.154 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ralphlauren.eu }
:if ([:len [/ip/route/find dst-address=96.17.150.162 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.17.150.162 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ralphlauren.eu }
:if ([:len [/ip/route/find dst-address=96.7.218.218 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.7.218.218 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ralphlauren.eu }
:if ([:len [/ip/route/find dst-address=96.7.218.241 and gateway=$GateWay and routing-table=$RouteTab]] = 0) do={ add dst-address=96.7.218.241 gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=ralphlauren.eu }
