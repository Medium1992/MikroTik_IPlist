...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=rule34.xxx and dst-address=for_scripts_route/iplistv4/rule34.xxx.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/rule34.xxx.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=rule34.xxx }
