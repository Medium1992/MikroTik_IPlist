...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=svoboda.org and dst-address=for_scripts_route/iplistv4/svoboda.org_part16.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/svoboda.org_part16.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=svoboda.org }
