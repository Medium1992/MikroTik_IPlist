...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=verstka.media and dst-address=for_scripts_route/iplistv4/verstka.media.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/verstka.media.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=verstka.media }
