...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=viber.com and dst-address=for_scripts_route/iplistv4/viber.com_part123.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/viber.com_part123.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=viber.com }
