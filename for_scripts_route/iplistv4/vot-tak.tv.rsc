...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=vot-tak.tv and dst-address=for_scripts_route/iplistv4/vot-tak.tv.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/vot-tak.tv.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=vot-tak.tv }
