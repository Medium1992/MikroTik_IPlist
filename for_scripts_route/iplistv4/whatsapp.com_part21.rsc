...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=whatsapp.com and dst-address=for_scripts_route/iplistv4/whatsapp.com_part21.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/whatsapp.com_part21.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=whatsapp.com }
