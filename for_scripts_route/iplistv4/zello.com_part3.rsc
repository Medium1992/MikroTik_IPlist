...
:global GateWay
/ip route
:if ([:len [/ip/route/find comment=zello.com and dst-address=for_scripts_route/iplistv4/zello.com_part3.rsc]] = 0) do={ add dst-address=for_scripts_route/iplistv4/zello.com_part3.rsc gateway=$GateWay routing-table=$RouteTab distance=$Distance comment=zello.com }
